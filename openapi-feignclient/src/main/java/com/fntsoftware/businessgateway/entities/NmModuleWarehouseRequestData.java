...
import com.fntsoftware.businessgateway.entities.NmModuleWarehouseEntityRestriction;
...
/**
 * NmModuleWarehouseRequestData
 */
@JsonPropertyOrder({
  NmModuleWarehouseRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  NmModuleWarehouseRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  NmModuleWarehouseRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  NmModuleWarehouseRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-03-04T13:31:32.601557352Z[Etc/UTC]")
public class NmModuleWarehouseRequestData {
  ...
  private NmModuleWarehouseEntityRestriction entityRestrictions;
  ...
  public NmModuleWarehouseRequestData() {
  }

  public NmModuleWarehouseRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public NmModuleWarehouseRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public NmModuleWarehouseRequestData entityRestrictions(NmModuleWarehouseEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public NmModuleWarehouseEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(NmModuleWarehouseEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public NmModuleWarehouseRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public NmModuleWarehouseRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public NmModuleWarehouseRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    NmModuleWarehouseRequestData nmModuleWarehouseRequestData = (NmModuleWarehouseRequestData) o;
    return Objects.equals(this.returnEntityAttributes, nmModuleWarehouseRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, nmModuleWarehouseRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, nmModuleWarehouseRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, nmModuleWarehouseRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class NmModuleWarehouseRequestData {\n");
