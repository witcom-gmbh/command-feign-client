...
import com.fntsoftware.businessgateway.entities.HostnameDomainEntityRestriction;
...
/**
 * HostnameDomainRequestData
 */
@JsonPropertyOrder({
  HostnameDomainRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  HostnameDomainRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  HostnameDomainRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  HostnameDomainRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-02-26T11:20:24.990023935Z[Etc/UTC]")
public class HostnameDomainRequestData {
  ...
  private HostnameDomainEntityRestriction entityRestrictions;
  ...
  public HostnameDomainRequestData() {
  }

  public HostnameDomainRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public HostnameDomainRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public HostnameDomainRequestData entityRestrictions(HostnameDomainEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public HostnameDomainEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(HostnameDomainEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public HostnameDomainRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public HostnameDomainRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public HostnameDomainRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    HostnameDomainRequestData hostnameDomainRequestData = (HostnameDomainRequestData) o;
    return Objects.equals(this.returnEntityAttributes, hostnameDomainRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, hostnameDomainRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, hostnameDomainRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, hostnameDomainRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class HostnameDomainRequestData {\n");
