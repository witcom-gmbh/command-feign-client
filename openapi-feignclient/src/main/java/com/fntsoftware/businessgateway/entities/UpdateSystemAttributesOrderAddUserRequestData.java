...
/**
 * UpdateSystemAttributesOrderAddUserRequestData
 */
@JsonPropertyOrder({
  UpdateSystemAttributesOrderAddUserRequestData.JSON_PROPERTY_MODIFY_PLAN,
  UpdateSystemAttributesOrderAddUserRequestData.JSON_PROPERTY_DELETE_REAL,
  UpdateSystemAttributesOrderAddUserRequestData.JSON_PROPERTY_READ_PLAN,
  UpdateSystemAttributesOrderAddUserRequestData.JSON_PROPERTY_MANDANT_ID,
  UpdateSystemAttributesOrderAddUserRequestData.JSON_PROPERTY_USER_ELID,
  UpdateSystemAttributesOrderAddUserRequestData.JSON_PROPERTY_MODIFY_REAL,
  UpdateSystemAttributesOrderAddUserRequestData.JSON_PROPERTY_READ_REAL,
  UpdateSystemAttributesOrderAddUserRequestData.JSON_PROPERTY_DELETE_PLAN
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-03-04T13:31:32.601557352Z[Etc/UTC]")
public class UpdateSystemAttributesOrderAddUserRequestData {
  ...
  public UpdateSystemAttributesOrderAddUserRequestData() {
  }

  public UpdateSystemAttributesOrderAddUserRequestData modifyPlan(Boolean modifyPlan) {
  ...
  **/
  ...
  public UpdateSystemAttributesOrderAddUserRequestData deleteReal(Boolean deleteReal) {
  ...
  **/
  ...
  public UpdateSystemAttributesOrderAddUserRequestData readPlan(Boolean readPlan) {
  ...
  **/
  ...
  public UpdateSystemAttributesOrderAddUserRequestData mandantId(BigDecimal mandantId) {
  ...
  **/
  ...
  public UpdateSystemAttributesOrderAddUserRequestData userElid(String userElid) {
  ...
  **/
  ...
  public UpdateSystemAttributesOrderAddUserRequestData modifyReal(Boolean modifyReal) {
  ...
  **/
  ...
  public UpdateSystemAttributesOrderAddUserRequestData readReal(Boolean readReal) {
  ...
  **/
  ...
  public UpdateSystemAttributesOrderAddUserRequestData deletePlan(Boolean deletePlan) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    UpdateSystemAttributesOrderAddUserRequestData updateSystemAttributesOrderAddUserRequestData = (UpdateSystemAttributesOrderAddUserRequestData) o;
    return Objects.equals(this.modifyPlan, updateSystemAttributesOrderAddUserRequestData.modifyPlan) &&
        Objects.equals(this.deleteReal, updateSystemAttributesOrderAddUserRequestData.deleteReal) &&
        Objects.equals(this.readPlan, updateSystemAttributesOrderAddUserRequestData.readPlan) &&
        Objects.equals(this.mandantId, updateSystemAttributesOrderAddUserRequestData.mandantId) &&
        Objects.equals(this.userElid, updateSystemAttributesOrderAddUserRequestData.userElid) &&
        Objects.equals(this.modifyReal, updateSystemAttributesOrderAddUserRequestData.modifyReal) &&
        Objects.equals(this.readReal, updateSystemAttributesOrderAddUserRequestData.readReal) &&
        Objects.equals(this.deletePlan, updateSystemAttributesOrderAddUserRequestData.deletePlan);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateSystemAttributesOrderAddUserRequestData {\n");
