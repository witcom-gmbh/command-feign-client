...
import com.fntsoftware.businessgateway.entities.LogicalPortCustomSvidCVlanEntityRestriction;
...
/**
 * LogicalPortCustomSvidCVlanRequestData
 */
@JsonPropertyOrder({
  LogicalPortCustomSvidCVlanRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  LogicalPortCustomSvidCVlanRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  LogicalPortCustomSvidCVlanRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  LogicalPortCustomSvidCVlanRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-02-26T11:20:24.990023935Z[Etc/UTC]")
public class LogicalPortCustomSvidCVlanRequestData {
  ...
  private LogicalPortCustomSvidCVlanEntityRestriction entityRestrictions;
  ...
  public LogicalPortCustomSvidCVlanRequestData() {
  }

  public LogicalPortCustomSvidCVlanRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public LogicalPortCustomSvidCVlanRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public LogicalPortCustomSvidCVlanRequestData entityRestrictions(LogicalPortCustomSvidCVlanEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public LogicalPortCustomSvidCVlanEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(LogicalPortCustomSvidCVlanEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public LogicalPortCustomSvidCVlanRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public LogicalPortCustomSvidCVlanRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public LogicalPortCustomSvidCVlanRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    LogicalPortCustomSvidCVlanRequestData logicalPortCustomSvidCVlanRequestData = (LogicalPortCustomSvidCVlanRequestData) o;
    return Objects.equals(this.returnEntityAttributes, logicalPortCustomSvidCVlanRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, logicalPortCustomSvidCVlanRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, logicalPortCustomSvidCVlanRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, logicalPortCustomSvidCVlanRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class LogicalPortCustomSvidCVlanRequestData {\n");
