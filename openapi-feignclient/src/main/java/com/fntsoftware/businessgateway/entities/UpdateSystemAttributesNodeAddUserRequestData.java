...
/**
 * UpdateSystemAttributesNodeAddUserRequestData
 */
@JsonPropertyOrder({
  UpdateSystemAttributesNodeAddUserRequestData.JSON_PROPERTY_MODIFY_PLAN,
  UpdateSystemAttributesNodeAddUserRequestData.JSON_PROPERTY_DELETE_REAL,
  UpdateSystemAttributesNodeAddUserRequestData.JSON_PROPERTY_READ_PLAN,
  UpdateSystemAttributesNodeAddUserRequestData.JSON_PROPERTY_MANDANT_ID,
  UpdateSystemAttributesNodeAddUserRequestData.JSON_PROPERTY_USER_ELID,
  UpdateSystemAttributesNodeAddUserRequestData.JSON_PROPERTY_MODIFY_REAL,
  UpdateSystemAttributesNodeAddUserRequestData.JSON_PROPERTY_READ_REAL,
  UpdateSystemAttributesNodeAddUserRequestData.JSON_PROPERTY_DELETE_PLAN
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-02-26T11:20:24.990023935Z[Etc/UTC]")
public class UpdateSystemAttributesNodeAddUserRequestData {
  ...
  public UpdateSystemAttributesNodeAddUserRequestData() {
  }

  public UpdateSystemAttributesNodeAddUserRequestData modifyPlan(Boolean modifyPlan) {
  ...
  **/
  ...
  public UpdateSystemAttributesNodeAddUserRequestData deleteReal(Boolean deleteReal) {
  ...
  **/
  ...
  public UpdateSystemAttributesNodeAddUserRequestData readPlan(Boolean readPlan) {
  ...
  **/
  ...
  public UpdateSystemAttributesNodeAddUserRequestData mandantId(BigDecimal mandantId) {
  ...
  **/
  ...
  public UpdateSystemAttributesNodeAddUserRequestData userElid(String userElid) {
  ...
  **/
  ...
  public UpdateSystemAttributesNodeAddUserRequestData modifyReal(Boolean modifyReal) {
  ...
  **/
  ...
  public UpdateSystemAttributesNodeAddUserRequestData readReal(Boolean readReal) {
  ...
  **/
  ...
  public UpdateSystemAttributesNodeAddUserRequestData deletePlan(Boolean deletePlan) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    UpdateSystemAttributesNodeAddUserRequestData updateSystemAttributesNodeAddUserRequestData = (UpdateSystemAttributesNodeAddUserRequestData) o;
    return Objects.equals(this.modifyPlan, updateSystemAttributesNodeAddUserRequestData.modifyPlan) &&
        Objects.equals(this.deleteReal, updateSystemAttributesNodeAddUserRequestData.deleteReal) &&
        Objects.equals(this.readPlan, updateSystemAttributesNodeAddUserRequestData.readPlan) &&
        Objects.equals(this.mandantId, updateSystemAttributesNodeAddUserRequestData.mandantId) &&
        Objects.equals(this.userElid, updateSystemAttributesNodeAddUserRequestData.userElid) &&
        Objects.equals(this.modifyReal, updateSystemAttributesNodeAddUserRequestData.modifyReal) &&
        Objects.equals(this.readReal, updateSystemAttributesNodeAddUserRequestData.readReal) &&
        Objects.equals(this.deletePlan, updateSystemAttributesNodeAddUserRequestData.deletePlan);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateSystemAttributesNodeAddUserRequestData {\n");
