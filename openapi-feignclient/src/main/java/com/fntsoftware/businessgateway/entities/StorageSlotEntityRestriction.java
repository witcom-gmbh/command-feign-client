...
/**
 * StorageSlotEntityRestriction
 */
@JsonPropertyOrder({
  StorageSlotEntityRestriction.JSON_PROPERTY_CLIMATE_RELEVANT,
  StorageSlotEntityRestriction.JSON_PROPERTY_POWER_CONSUMPTION,
  StorageSlotEntityRestriction.JSON_PROPERTY_POWER_SWITCHING_STATUS,
  StorageSlotEntityRestriction.JSON_PROPERTY_PLAN_STATUS,
  StorageSlotEntityRestriction.JSON_PROPERTY_SYSTEM_RUNTIME,
  StorageSlotEntityRestriction.JSON_PROPERTY_WEIGHT,
  StorageSlotEntityRestriction.JSON_PROPERTY_REMARK,
  StorageSlotEntityRestriction.JSON_PROPERTY_ELID,
  StorageSlotEntityRestriction.JSON_PROPERTY_LAST_SEEN,
  StorageSlotEntityRestriction.JSON_PROPERTY_TYPE_ELID,
  StorageSlotEntityRestriction.JSON_PROPERTY_VISIBLE_ID,
  StorageSlotEntityRestriction.JSON_PROPERTY_ID,
  StorageSlotEntityRestriction.JSON_PROPERTY_HEAT_EMISSION
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-03-04T13:31:32.601557352Z[Etc/UTC]")
public class StorageSlotEntityRestriction {
  ...
  public StorageSlotEntityRestriction() {
  }

  public StorageSlotEntityRestriction climateRelevant(RestrictionsBoolean climateRelevant) {
  ...
  **/
  ...
  public StorageSlotEntityRestriction powerConsumption(RestrictionsNumeric powerConsumption) {
  ...
  **/
  ...
  public StorageSlotEntityRestriction powerSwitchingStatus(RestrictionsString powerSwitchingStatus) {
  ...
  **/
  ...
  public StorageSlotEntityRestriction planStatus(RestrictionsString planStatus) {
  ...
  **/
  ...
  public StorageSlotEntityRestriction systemRuntime(RestrictionsNumeric systemRuntime) {
  ...
  **/
  ...
  public StorageSlotEntityRestriction weight(RestrictionsNumeric weight) {
  ...
  **/
  ...
  public StorageSlotEntityRestriction remark(RestrictionsString remark) {
  ...
  **/
  ...
  public StorageSlotEntityRestriction elid(RestrictionsString elid) {
  ...
  **/
  ...
  public StorageSlotEntityRestriction lastSeen(RestrictionsDate lastSeen) {
  ...
  **/
  ...
  public StorageSlotEntityRestriction typeElid(RestrictionsString typeElid) {
  ...
  **/
  ...
  public StorageSlotEntityRestriction visibleId(RestrictionsString visibleId) {
  ...
  **/
  ...
  public StorageSlotEntityRestriction id(RestrictionsString id) {
  ...
  **/
  ...
  public StorageSlotEntityRestriction heatEmission(RestrictionsNumeric heatEmission) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    StorageSlotEntityRestriction storageSlotEntityRestriction = (StorageSlotEntityRestriction) o;
    return Objects.equals(this.climateRelevant, storageSlotEntityRestriction.climateRelevant) &&
        Objects.equals(this.powerConsumption, storageSlotEntityRestriction.powerConsumption) &&
        Objects.equals(this.powerSwitchingStatus, storageSlotEntityRestriction.powerSwitchingStatus) &&
        Objects.equals(this.planStatus, storageSlotEntityRestriction.planStatus) &&
        Objects.equals(this.systemRuntime, storageSlotEntityRestriction.systemRuntime) &&
        Objects.equals(this.weight, storageSlotEntityRestriction.weight) &&
        Objects.equals(this.remark, storageSlotEntityRestriction.remark) &&
        Objects.equals(this.elid, storageSlotEntityRestriction.elid) &&
        Objects.equals(this.lastSeen, storageSlotEntityRestriction.lastSeen) &&
        Objects.equals(this.typeElid, storageSlotEntityRestriction.typeElid) &&
        Objects.equals(this.visibleId, storageSlotEntityRestriction.visibleId) &&
        Objects.equals(this.id, storageSlotEntityRestriction.id) &&
        Objects.equals(this.heatEmission, storageSlotEntityRestriction.heatEmission);
  }
  ...
  public String toString() {
    ...
    sb.append("class StorageSlotEntityRestriction {\n");
