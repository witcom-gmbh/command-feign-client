...
import com.fntsoftware.businessgateway.entities.DeviceAllZoneEntityRestriction;
...
/**
 * DeviceAllZoneRequestData
 */
@JsonPropertyOrder({
  DeviceAllZoneRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  DeviceAllZoneRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  DeviceAllZoneRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  DeviceAllZoneRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-01-31T11:10:37.320689708Z[Etc/UTC]")
public class DeviceAllZoneRequestData {
  ...
  private DeviceAllZoneEntityRestriction entityRestrictions;
  ...
  public DeviceAllZoneRequestData() {
  }

  public DeviceAllZoneRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public DeviceAllZoneRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public DeviceAllZoneRequestData entityRestrictions(DeviceAllZoneEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public DeviceAllZoneEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(DeviceAllZoneEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public DeviceAllZoneRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public DeviceAllZoneRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public DeviceAllZoneRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    DeviceAllZoneRequestData deviceAllZoneRequestData = (DeviceAllZoneRequestData) o;
    return Objects.equals(this.returnEntityAttributes, deviceAllZoneRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, deviceAllZoneRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, deviceAllZoneRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, deviceAllZoneRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeviceAllZoneRequestData {\n");
