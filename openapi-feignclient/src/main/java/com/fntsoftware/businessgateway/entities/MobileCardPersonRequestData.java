...
import com.fntsoftware.businessgateway.entities.MobileCardPersonEntityRestriction;
...
/**
 * MobileCardPersonRequestData
 */
@JsonPropertyOrder({
  MobileCardPersonRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  MobileCardPersonRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  MobileCardPersonRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  MobileCardPersonRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-02-26T11:20:24.990023935Z[Etc/UTC]")
public class MobileCardPersonRequestData {
  ...
  private MobileCardPersonEntityRestriction entityRestrictions;
  ...
  public MobileCardPersonRequestData() {
  }

  public MobileCardPersonRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public MobileCardPersonRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public MobileCardPersonRequestData entityRestrictions(MobileCardPersonEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public MobileCardPersonEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(MobileCardPersonEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public MobileCardPersonRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public MobileCardPersonRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public MobileCardPersonRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    MobileCardPersonRequestData mobileCardPersonRequestData = (MobileCardPersonRequestData) o;
    return Objects.equals(this.returnEntityAttributes, mobileCardPersonRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, mobileCardPersonRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, mobileCardPersonRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, mobileCardPersonRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class MobileCardPersonRequestData {\n");
