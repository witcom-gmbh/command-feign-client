...
import com.fntsoftware.businessgateway.entities.DeviceMasterAntennaAntennasEntityRestriction;
...
/**
 * DeviceMasterAntennaAntennasRequestData
 */
@JsonPropertyOrder({
  DeviceMasterAntennaAntennasRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  DeviceMasterAntennaAntennasRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  DeviceMasterAntennaAntennasRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  DeviceMasterAntennaAntennasRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-03-04T13:31:32.601557352Z[Etc/UTC]")
public class DeviceMasterAntennaAntennasRequestData {
  ...
  private DeviceMasterAntennaAntennasEntityRestriction entityRestrictions;
  ...
  public DeviceMasterAntennaAntennasRequestData() {
  }

  public DeviceMasterAntennaAntennasRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public DeviceMasterAntennaAntennasRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public DeviceMasterAntennaAntennasRequestData entityRestrictions(DeviceMasterAntennaAntennasEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public DeviceMasterAntennaAntennasEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(DeviceMasterAntennaAntennasEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public DeviceMasterAntennaAntennasRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public DeviceMasterAntennaAntennasRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public DeviceMasterAntennaAntennasRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    DeviceMasterAntennaAntennasRequestData deviceMasterAntennaAntennasRequestData = (DeviceMasterAntennaAntennasRequestData) o;
    return Objects.equals(this.returnEntityAttributes, deviceMasterAntennaAntennasRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, deviceMasterAntennaAntennasRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, deviceMasterAntennaAntennasRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, deviceMasterAntennaAntennasRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeviceMasterAntennaAntennasRequestData {\n");
