...
/**
 * CellCellEnhancerEntityRestriction
 */
@JsonPropertyOrder({
  CellCellEnhancerEntityRestriction.JSON_PROPERTY_CLIMATE_RELEVANT,
  CellCellEnhancerEntityRestriction.JSON_PROPERTY_POWER_CONSUMPTION,
  CellCellEnhancerEntityRestriction.JSON_PROPERTY_POWER_SWITCHING_STATUS,
  CellCellEnhancerEntityRestriction.JSON_PROPERTY_PLAN_STATUS,
  CellCellEnhancerEntityRestriction.JSON_PROPERTY_SYSTEM_RUNTIME,
  CellCellEnhancerEntityRestriction.JSON_PROPERTY_WEIGHT,
  CellCellEnhancerEntityRestriction.JSON_PROPERTY_REMARK,
  CellCellEnhancerEntityRestriction.JSON_PROPERTY_ELID,
  CellCellEnhancerEntityRestriction.JSON_PROPERTY_LAST_SEEN,
  CellCellEnhancerEntityRestriction.JSON_PROPERTY_TYPE_ELID,
  CellCellEnhancerEntityRestriction.JSON_PROPERTY_VISIBLE_ID,
  CellCellEnhancerEntityRestriction.JSON_PROPERTY_ID,
  CellCellEnhancerEntityRestriction.JSON_PROPERTY_HEAT_EMISSION
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-01-31T11:10:37.320689708Z[Etc/UTC]")
public class CellCellEnhancerEntityRestriction {
  ...
  public CellCellEnhancerEntityRestriction() {
  }

  public CellCellEnhancerEntityRestriction climateRelevant(RestrictionsBoolean climateRelevant) {
  ...
  **/
  ...
  public CellCellEnhancerEntityRestriction powerConsumption(RestrictionsNumeric powerConsumption) {
  ...
  **/
  ...
  public CellCellEnhancerEntityRestriction powerSwitchingStatus(RestrictionsString powerSwitchingStatus) {
  ...
  **/
  ...
  public CellCellEnhancerEntityRestriction planStatus(RestrictionsString planStatus) {
  ...
  **/
  ...
  public CellCellEnhancerEntityRestriction systemRuntime(RestrictionsNumeric systemRuntime) {
  ...
  **/
  ...
  public CellCellEnhancerEntityRestriction weight(RestrictionsNumeric weight) {
  ...
  **/
  ...
  public CellCellEnhancerEntityRestriction remark(RestrictionsString remark) {
  ...
  **/
  ...
  public CellCellEnhancerEntityRestriction elid(RestrictionsString elid) {
  ...
  **/
  ...
  public CellCellEnhancerEntityRestriction lastSeen(RestrictionsDate lastSeen) {
  ...
  **/
  ...
  public CellCellEnhancerEntityRestriction typeElid(RestrictionsString typeElid) {
  ...
  **/
  ...
  public CellCellEnhancerEntityRestriction visibleId(RestrictionsString visibleId) {
  ...
  **/
  ...
  public CellCellEnhancerEntityRestriction id(RestrictionsString id) {
  ...
  **/
  ...
  public CellCellEnhancerEntityRestriction heatEmission(RestrictionsNumeric heatEmission) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    CellCellEnhancerEntityRestriction cellCellEnhancerEntityRestriction = (CellCellEnhancerEntityRestriction) o;
    return Objects.equals(this.climateRelevant, cellCellEnhancerEntityRestriction.climateRelevant) &&
        Objects.equals(this.powerConsumption, cellCellEnhancerEntityRestriction.powerConsumption) &&
        Objects.equals(this.powerSwitchingStatus, cellCellEnhancerEntityRestriction.powerSwitchingStatus) &&
        Objects.equals(this.planStatus, cellCellEnhancerEntityRestriction.planStatus) &&
        Objects.equals(this.systemRuntime, cellCellEnhancerEntityRestriction.systemRuntime) &&
        Objects.equals(this.weight, cellCellEnhancerEntityRestriction.weight) &&
        Objects.equals(this.remark, cellCellEnhancerEntityRestriction.remark) &&
        Objects.equals(this.elid, cellCellEnhancerEntityRestriction.elid) &&
        Objects.equals(this.lastSeen, cellCellEnhancerEntityRestriction.lastSeen) &&
        Objects.equals(this.typeElid, cellCellEnhancerEntityRestriction.typeElid) &&
        Objects.equals(this.visibleId, cellCellEnhancerEntityRestriction.visibleId) &&
        Objects.equals(this.id, cellCellEnhancerEntityRestriction.id) &&
        Objects.equals(this.heatEmission, cellCellEnhancerEntityRestriction.heatEmission);
  }
  ...
  public String toString() {
    ...
    sb.append("class CellCellEnhancerEntityRestriction {\n");
