...
import com.fntsoftware.businessgateway.entities.AntennaVlansEntityRestriction;
import com.fntsoftware.businessgateway.entities.AntennaVlansRelationRestriction;
...
/**
 * AntennaVlansRequestData
 */
@JsonPropertyOrder({
  AntennaVlansRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  AntennaVlansRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  AntennaVlansRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  AntennaVlansRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-01-31T11:10:37.320689708Z[Etc/UTC]")
public class AntennaVlansRequestData {
  ...
  private AntennaVlansEntityRestriction entityRestrictions;

  public static final String JSON_PROPERTY_RELATION_RESTRICTIONS = "relationRestrictions";
  private AntennaVlansRelationRestriction relationRestrictions;
  ...
  public AntennaVlansRequestData() {
  }

  public AntennaVlansRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public AntennaVlansRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public AntennaVlansRequestData entityRestrictions(AntennaVlansEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public AntennaVlansEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(AntennaVlansEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public AntennaVlansRequestData relationRestrictions(AntennaVlansRelationRestriction relationRestrictions) {
  ...
  **/
  ...
  public AntennaVlansRelationRestriction getRelationRestrictions() {
    return relationRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_RELATION_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRelationRestrictions(AntennaVlansRelationRestriction relationRestrictions) {
    this.relationRestrictions = relationRestrictions;
  }


  public AntennaVlansRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public AntennaVlansRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    AntennaVlansRequestData antennaVlansRequestData = (AntennaVlansRequestData) o;
    return Objects.equals(this.returnEntityAttributes, antennaVlansRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, antennaVlansRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, antennaVlansRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, antennaVlansRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class AntennaVlansRequestData {\n");
