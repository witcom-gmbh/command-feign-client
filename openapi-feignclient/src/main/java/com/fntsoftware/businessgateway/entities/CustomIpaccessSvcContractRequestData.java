...
import com.fntsoftware.businessgateway.entities.CustomIpaccessSvcContractEntityRestriction;
...
/**
 * CustomIpaccessSvcContractRequestData
 */
@JsonPropertyOrder({
  CustomIpaccessSvcContractRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  CustomIpaccessSvcContractRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  CustomIpaccessSvcContractRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  CustomIpaccessSvcContractRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-03-04T13:31:32.601557352Z[Etc/UTC]")
public class CustomIpaccessSvcContractRequestData {
  ...
  private CustomIpaccessSvcContractEntityRestriction entityRestrictions;
  ...
  public CustomIpaccessSvcContractRequestData() {
  }

  public CustomIpaccessSvcContractRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public CustomIpaccessSvcContractRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public CustomIpaccessSvcContractRequestData entityRestrictions(CustomIpaccessSvcContractEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public CustomIpaccessSvcContractEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(CustomIpaccessSvcContractEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public CustomIpaccessSvcContractRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public CustomIpaccessSvcContractRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public CustomIpaccessSvcContractRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    CustomIpaccessSvcContractRequestData customIpaccessSvcContractRequestData = (CustomIpaccessSvcContractRequestData) o;
    return Objects.equals(this.returnEntityAttributes, customIpaccessSvcContractRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, customIpaccessSvcContractRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, customIpaccessSvcContractRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, customIpaccessSvcContractRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class CustomIpaccessSvcContractRequestData {\n");
