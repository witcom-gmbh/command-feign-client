...
import com.fntsoftware.businessgateway.entities.ServiceTelcoPathEndZoneEntityRestriction;
...
/**
 * ServiceTelcoPathEndZoneRequestData
 */
@JsonPropertyOrder({
  ServiceTelcoPathEndZoneRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  ServiceTelcoPathEndZoneRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  ServiceTelcoPathEndZoneRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  ServiceTelcoPathEndZoneRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-03-04T13:31:32.601557352Z[Etc/UTC]")
public class ServiceTelcoPathEndZoneRequestData {
  ...
  private ServiceTelcoPathEndZoneEntityRestriction entityRestrictions;
  ...
  public ServiceTelcoPathEndZoneRequestData() {
  }

  public ServiceTelcoPathEndZoneRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public ServiceTelcoPathEndZoneRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public ServiceTelcoPathEndZoneRequestData entityRestrictions(ServiceTelcoPathEndZoneEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public ServiceTelcoPathEndZoneEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(ServiceTelcoPathEndZoneEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public ServiceTelcoPathEndZoneRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public ServiceTelcoPathEndZoneRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public ServiceTelcoPathEndZoneRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ServiceTelcoPathEndZoneRequestData serviceTelcoPathEndZoneRequestData = (ServiceTelcoPathEndZoneRequestData) o;
    return Objects.equals(this.returnEntityAttributes, serviceTelcoPathEndZoneRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, serviceTelcoPathEndZoneRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, serviceTelcoPathEndZoneRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, serviceTelcoPathEndZoneRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class ServiceTelcoPathEndZoneRequestData {\n");
