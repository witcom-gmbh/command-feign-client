...
import com.fntsoftware.businessgateway.entities.DeviceAllSlotEntityRestriction;
import com.fntsoftware.businessgateway.entities.DeviceAllSlotRelationRestriction;
...
/**
 * DeviceAllSlotRequestData
 */
@JsonPropertyOrder({
  DeviceAllSlotRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  DeviceAllSlotRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  DeviceAllSlotRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  DeviceAllSlotRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-02-26T11:20:24.990023935Z[Etc/UTC]")
public class DeviceAllSlotRequestData {
  ...
  private DeviceAllSlotEntityRestriction entityRestrictions;

  public static final String JSON_PROPERTY_RELATION_RESTRICTIONS = "relationRestrictions";
  private DeviceAllSlotRelationRestriction relationRestrictions;
  ...
  public DeviceAllSlotRequestData() {
  }

  public DeviceAllSlotRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public DeviceAllSlotRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public DeviceAllSlotRequestData entityRestrictions(DeviceAllSlotEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public DeviceAllSlotEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(DeviceAllSlotEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public DeviceAllSlotRequestData relationRestrictions(DeviceAllSlotRelationRestriction relationRestrictions) {
  ...
  **/
  ...
  public DeviceAllSlotRelationRestriction getRelationRestrictions() {
    return relationRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_RELATION_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRelationRestrictions(DeviceAllSlotRelationRestriction relationRestrictions) {
    this.relationRestrictions = relationRestrictions;
  }


  public DeviceAllSlotRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public DeviceAllSlotRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    DeviceAllSlotRequestData deviceAllSlotRequestData = (DeviceAllSlotRequestData) o;
    return Objects.equals(this.returnEntityAttributes, deviceAllSlotRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, deviceAllSlotRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, deviceAllSlotRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, deviceAllSlotRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeviceAllSlotRequestData {\n");
