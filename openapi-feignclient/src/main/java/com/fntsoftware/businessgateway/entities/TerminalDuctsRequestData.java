...
import com.fntsoftware.businessgateway.entities.TerminalDuctsEntityRestriction;
import com.fntsoftware.businessgateway.entities.TerminalDuctsRelationRestriction;
...
/**
 * TerminalDuctsRequestData
 */
@JsonPropertyOrder({
  TerminalDuctsRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  TerminalDuctsRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  TerminalDuctsRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  TerminalDuctsRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-01-31T11:10:37.320689708Z[Etc/UTC]")
public class TerminalDuctsRequestData {
  ...
  private TerminalDuctsEntityRestriction entityRestrictions;

  public static final String JSON_PROPERTY_RELATION_RESTRICTIONS = "relationRestrictions";
  private TerminalDuctsRelationRestriction relationRestrictions;
  ...
  public TerminalDuctsRequestData() {
  }

  public TerminalDuctsRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public TerminalDuctsRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public TerminalDuctsRequestData entityRestrictions(TerminalDuctsEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public TerminalDuctsEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(TerminalDuctsEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public TerminalDuctsRequestData relationRestrictions(TerminalDuctsRelationRestriction relationRestrictions) {
  ...
  **/
  ...
  public TerminalDuctsRelationRestriction getRelationRestrictions() {
    return relationRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_RELATION_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRelationRestrictions(TerminalDuctsRelationRestriction relationRestrictions) {
    this.relationRestrictions = relationRestrictions;
  }


  public TerminalDuctsRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public TerminalDuctsRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    TerminalDuctsRequestData terminalDuctsRequestData = (TerminalDuctsRequestData) o;
    return Objects.equals(this.returnEntityAttributes, terminalDuctsRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, terminalDuctsRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, terminalDuctsRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, terminalDuctsRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class TerminalDuctsRequestData {\n");
