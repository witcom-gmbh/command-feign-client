...
import com.fntsoftware.businessgateway.entities.AntennaWarehouseEntityRestriction;
...
/**
 * AntennaWarehouseRequestData
 */
@JsonPropertyOrder({
  AntennaWarehouseRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  AntennaWarehouseRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  AntennaWarehouseRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  AntennaWarehouseRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-01-31T11:10:37.320689708Z[Etc/UTC]")
public class AntennaWarehouseRequestData {
  ...
  private AntennaWarehouseEntityRestriction entityRestrictions;
  ...
  public AntennaWarehouseRequestData() {
  }

  public AntennaWarehouseRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public AntennaWarehouseRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public AntennaWarehouseRequestData entityRestrictions(AntennaWarehouseEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public AntennaWarehouseEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(AntennaWarehouseEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public AntennaWarehouseRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public AntennaWarehouseRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public AntennaWarehouseRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    AntennaWarehouseRequestData antennaWarehouseRequestData = (AntennaWarehouseRequestData) o;
    return Objects.equals(this.returnEntityAttributes, antennaWarehouseRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, antennaWarehouseRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, antennaWarehouseRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, antennaWarehouseRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class AntennaWarehouseRequestData {\n");
