...
import com.fntsoftware.businessgateway.entities.Ipv4NetworkDomainEntityRestriction;
...
/**
 * Ipv4NetworkDomainRequestData
 */
@JsonPropertyOrder({
  Ipv4NetworkDomainRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  Ipv4NetworkDomainRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  Ipv4NetworkDomainRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  Ipv4NetworkDomainRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-03-04T13:31:32.601557352Z[Etc/UTC]")
public class Ipv4NetworkDomainRequestData {
  ...
  private Ipv4NetworkDomainEntityRestriction entityRestrictions;
  ...
  public Ipv4NetworkDomainRequestData() {
  }

  public Ipv4NetworkDomainRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public Ipv4NetworkDomainRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public Ipv4NetworkDomainRequestData entityRestrictions(Ipv4NetworkDomainEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public Ipv4NetworkDomainEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(Ipv4NetworkDomainEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public Ipv4NetworkDomainRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public Ipv4NetworkDomainRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public Ipv4NetworkDomainRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    Ipv4NetworkDomainRequestData ipv4NetworkDomainRequestData = (Ipv4NetworkDomainRequestData) o;
    return Objects.equals(this.returnEntityAttributes, ipv4NetworkDomainRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, ipv4NetworkDomainRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, ipv4NetworkDomainRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, ipv4NetworkDomainRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class Ipv4NetworkDomainRequestData {\n");
