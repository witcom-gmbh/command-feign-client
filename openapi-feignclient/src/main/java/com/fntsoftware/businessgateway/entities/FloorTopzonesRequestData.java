...
import com.fntsoftware.businessgateway.entities.FloorTopzonesEntityRestriction;
import com.fntsoftware.businessgateway.entities.FloorTopzonesRelationRestriction;
...
/**
 * FloorTopzonesRequestData
 */
@JsonPropertyOrder({
  FloorTopzonesRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  FloorTopzonesRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  FloorTopzonesRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  FloorTopzonesRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-01-31T11:10:37.320689708Z[Etc/UTC]")
public class FloorTopzonesRequestData {
  ...
  private FloorTopzonesEntityRestriction entityRestrictions;

  public static final String JSON_PROPERTY_RELATION_RESTRICTIONS = "relationRestrictions";
  private FloorTopzonesRelationRestriction relationRestrictions;
  ...
  public FloorTopzonesRequestData() {
  }

  public FloorTopzonesRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public FloorTopzonesRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public FloorTopzonesRequestData entityRestrictions(FloorTopzonesEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public FloorTopzonesEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(FloorTopzonesEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public FloorTopzonesRequestData relationRestrictions(FloorTopzonesRelationRestriction relationRestrictions) {
  ...
  **/
  ...
  public FloorTopzonesRelationRestriction getRelationRestrictions() {
    return relationRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_RELATION_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRelationRestrictions(FloorTopzonesRelationRestriction relationRestrictions) {
    this.relationRestrictions = relationRestrictions;
  }


  public FloorTopzonesRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public FloorTopzonesRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    FloorTopzonesRequestData floorTopzonesRequestData = (FloorTopzonesRequestData) o;
    return Objects.equals(this.returnEntityAttributes, floorTopzonesRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, floorTopzonesRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, floorTopzonesRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, floorTopzonesRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class FloorTopzonesRequestData {\n");
