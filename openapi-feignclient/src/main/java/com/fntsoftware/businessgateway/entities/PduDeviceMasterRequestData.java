...
import com.fntsoftware.businessgateway.entities.PduDeviceMasterEntityRestriction;
...
/**
 * PduDeviceMasterRequestData
 */
@JsonPropertyOrder({
  PduDeviceMasterRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  PduDeviceMasterRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  PduDeviceMasterRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  PduDeviceMasterRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-03-04T13:31:32.601557352Z[Etc/UTC]")
public class PduDeviceMasterRequestData {
  ...
  private PduDeviceMasterEntityRestriction entityRestrictions;
  ...
  public PduDeviceMasterRequestData() {
  }

  public PduDeviceMasterRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public PduDeviceMasterRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public PduDeviceMasterRequestData entityRestrictions(PduDeviceMasterEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public PduDeviceMasterEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(PduDeviceMasterEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public PduDeviceMasterRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public PduDeviceMasterRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public PduDeviceMasterRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    PduDeviceMasterRequestData pduDeviceMasterRequestData = (PduDeviceMasterRequestData) o;
    return Objects.equals(this.returnEntityAttributes, pduDeviceMasterRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, pduDeviceMasterRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, pduDeviceMasterRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, pduDeviceMasterRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class PduDeviceMasterRequestData {\n");
