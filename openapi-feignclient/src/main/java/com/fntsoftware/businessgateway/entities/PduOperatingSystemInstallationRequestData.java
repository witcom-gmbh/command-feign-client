...
import com.fntsoftware.businessgateway.entities.PduOperatingSystemInstallationEntityRestriction;
...
/**
 * PduOperatingSystemInstallationRequestData
 */
@JsonPropertyOrder({
  PduOperatingSystemInstallationRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  PduOperatingSystemInstallationRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  PduOperatingSystemInstallationRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  PduOperatingSystemInstallationRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-01-31T11:10:37.320689708Z[Etc/UTC]")
public class PduOperatingSystemInstallationRequestData {
  ...
  private PduOperatingSystemInstallationEntityRestriction entityRestrictions;
  ...
  public PduOperatingSystemInstallationRequestData() {
  }

  public PduOperatingSystemInstallationRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public PduOperatingSystemInstallationRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public PduOperatingSystemInstallationRequestData entityRestrictions(PduOperatingSystemInstallationEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public PduOperatingSystemInstallationEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(PduOperatingSystemInstallationEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public PduOperatingSystemInstallationRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public PduOperatingSystemInstallationRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public PduOperatingSystemInstallationRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    PduOperatingSystemInstallationRequestData pduOperatingSystemInstallationRequestData = (PduOperatingSystemInstallationRequestData) o;
    return Objects.equals(this.returnEntityAttributes, pduOperatingSystemInstallationRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, pduOperatingSystemInstallationRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, pduOperatingSystemInstallationRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, pduOperatingSystemInstallationRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class PduOperatingSystemInstallationRequestData {\n");
