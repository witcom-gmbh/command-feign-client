...
import com.fntsoftware.businessgateway.entities.ChassisPhysicalPortsPowerEntityRestriction;
...
/**
 * ChassisPhysicalPortsPowerRequestData
 */
@JsonPropertyOrder({
  ChassisPhysicalPortsPowerRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  ChassisPhysicalPortsPowerRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  ChassisPhysicalPortsPowerRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  ChassisPhysicalPortsPowerRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-01-31T11:10:37.320689708Z[Etc/UTC]")
public class ChassisPhysicalPortsPowerRequestData {
  ...
  private ChassisPhysicalPortsPowerEntityRestriction entityRestrictions;
  ...
  public ChassisPhysicalPortsPowerRequestData() {
  }

  public ChassisPhysicalPortsPowerRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public ChassisPhysicalPortsPowerRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public ChassisPhysicalPortsPowerRequestData entityRestrictions(ChassisPhysicalPortsPowerEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public ChassisPhysicalPortsPowerEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(ChassisPhysicalPortsPowerEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public ChassisPhysicalPortsPowerRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public ChassisPhysicalPortsPowerRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public ChassisPhysicalPortsPowerRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ChassisPhysicalPortsPowerRequestData chassisPhysicalPortsPowerRequestData = (ChassisPhysicalPortsPowerRequestData) o;
    return Objects.equals(this.returnEntityAttributes, chassisPhysicalPortsPowerRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, chassisPhysicalPortsPowerRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, chassisPhysicalPortsPowerRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, chassisPhysicalPortsPowerRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class ChassisPhysicalPortsPowerRequestData {\n");
