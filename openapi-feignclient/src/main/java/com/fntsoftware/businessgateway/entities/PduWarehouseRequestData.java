...
import com.fntsoftware.businessgateway.entities.PduWarehouseEntityRestriction;
...
/**
 * PduWarehouseRequestData
 */
@JsonPropertyOrder({
  PduWarehouseRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  PduWarehouseRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  PduWarehouseRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  PduWarehouseRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-01-31T11:10:37.320689708Z[Etc/UTC]")
public class PduWarehouseRequestData {
  ...
  private PduWarehouseEntityRestriction entityRestrictions;
  ...
  public PduWarehouseRequestData() {
  }

  public PduWarehouseRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public PduWarehouseRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public PduWarehouseRequestData entityRestrictions(PduWarehouseEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public PduWarehouseEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(PduWarehouseEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public PduWarehouseRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public PduWarehouseRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public PduWarehouseRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    PduWarehouseRequestData pduWarehouseRequestData = (PduWarehouseRequestData) o;
    return Objects.equals(this.returnEntityAttributes, pduWarehouseRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, pduWarehouseRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, pduWarehouseRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, pduWarehouseRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class PduWarehouseRequestData {\n");
