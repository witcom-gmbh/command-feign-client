...
import com.fntsoftware.businessgateway.entities.CustomKeyCustomKeyringEntityRestriction;
...
/**
 * CustomKeyCustomKeyringRequestData
 */
@JsonPropertyOrder({
  CustomKeyCustomKeyringRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  CustomKeyCustomKeyringRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  CustomKeyCustomKeyringRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  CustomKeyCustomKeyringRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-01-31T11:10:37.320689708Z[Etc/UTC]")
public class CustomKeyCustomKeyringRequestData {
  ...
  private CustomKeyCustomKeyringEntityRestriction entityRestrictions;
  ...
  public CustomKeyCustomKeyringRequestData() {
  }

  public CustomKeyCustomKeyringRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public CustomKeyCustomKeyringRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public CustomKeyCustomKeyringRequestData entityRestrictions(CustomKeyCustomKeyringEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public CustomKeyCustomKeyringEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(CustomKeyCustomKeyringEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public CustomKeyCustomKeyringRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public CustomKeyCustomKeyringRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public CustomKeyCustomKeyringRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    CustomKeyCustomKeyringRequestData customKeyCustomKeyringRequestData = (CustomKeyCustomKeyringRequestData) o;
    return Objects.equals(this.returnEntityAttributes, customKeyCustomKeyringRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, customKeyCustomKeyringRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, customKeyCustomKeyringRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, customKeyCustomKeyringRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class CustomKeyCustomKeyringRequestData {\n");
