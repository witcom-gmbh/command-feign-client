...
import com.fntsoftware.businessgateway.entities.StorageVlansEntityRestriction;
import com.fntsoftware.businessgateway.entities.StorageVlansRelationRestriction;
...
/**
 * StorageVlansRequestData
 */
@JsonPropertyOrder({
  StorageVlansRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  StorageVlansRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  StorageVlansRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  StorageVlansRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-01-31T11:10:37.320689708Z[Etc/UTC]")
public class StorageVlansRequestData {
  ...
  private StorageVlansEntityRestriction entityRestrictions;

  public static final String JSON_PROPERTY_RELATION_RESTRICTIONS = "relationRestrictions";
  private StorageVlansRelationRestriction relationRestrictions;
  ...
  public StorageVlansRequestData() {
  }

  public StorageVlansRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public StorageVlansRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public StorageVlansRequestData entityRestrictions(StorageVlansEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public StorageVlansEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(StorageVlansEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public StorageVlansRequestData relationRestrictions(StorageVlansRelationRestriction relationRestrictions) {
  ...
  **/
  ...
  public StorageVlansRelationRestriction getRelationRestrictions() {
    return relationRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_RELATION_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRelationRestrictions(StorageVlansRelationRestriction relationRestrictions) {
    this.relationRestrictions = relationRestrictions;
  }


  public StorageVlansRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public StorageVlansRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    StorageVlansRequestData storageVlansRequestData = (StorageVlansRequestData) o;
    return Objects.equals(this.returnEntityAttributes, storageVlansRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, storageVlansRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, storageVlansRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, storageVlansRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class StorageVlansRequestData {\n");
