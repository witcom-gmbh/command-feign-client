...
import com.fntsoftware.businessgateway.entities.FloorBuildingEntityRestriction;
...
/**
 * FloorBuildingRequestData
 */
@JsonPropertyOrder({
  FloorBuildingRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  FloorBuildingRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  FloorBuildingRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  FloorBuildingRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-01-31T11:10:37.320689708Z[Etc/UTC]")
public class FloorBuildingRequestData {
  ...
  private FloorBuildingEntityRestriction entityRestrictions;
  ...
  public FloorBuildingRequestData() {
  }

  public FloorBuildingRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public FloorBuildingRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public FloorBuildingRequestData entityRestrictions(FloorBuildingEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public FloorBuildingEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(FloorBuildingEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public FloorBuildingRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public FloorBuildingRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public FloorBuildingRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    FloorBuildingRequestData floorBuildingRequestData = (FloorBuildingRequestData) o;
    return Objects.equals(this.returnEntityAttributes, floorBuildingRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, floorBuildingRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, floorBuildingRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, floorBuildingRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class FloorBuildingRequestData {\n");
