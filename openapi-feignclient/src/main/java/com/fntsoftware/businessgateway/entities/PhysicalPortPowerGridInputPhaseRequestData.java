...
import com.fntsoftware.businessgateway.entities.PhysicalPortPowerGridInputPhaseEntityRestriction;
...
/**
 * PhysicalPortPowerGridInputPhaseRequestData
 */
@JsonPropertyOrder({
  PhysicalPortPowerGridInputPhaseRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  PhysicalPortPowerGridInputPhaseRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  PhysicalPortPowerGridInputPhaseRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  PhysicalPortPowerGridInputPhaseRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-01-31T11:10:37.320689708Z[Etc/UTC]")
public class PhysicalPortPowerGridInputPhaseRequestData {
  ...
  private PhysicalPortPowerGridInputPhaseEntityRestriction entityRestrictions;
  ...
  public PhysicalPortPowerGridInputPhaseRequestData() {
  }

  public PhysicalPortPowerGridInputPhaseRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public PhysicalPortPowerGridInputPhaseRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public PhysicalPortPowerGridInputPhaseRequestData entityRestrictions(PhysicalPortPowerGridInputPhaseEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public PhysicalPortPowerGridInputPhaseEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(PhysicalPortPowerGridInputPhaseEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public PhysicalPortPowerGridInputPhaseRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public PhysicalPortPowerGridInputPhaseRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public PhysicalPortPowerGridInputPhaseRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    PhysicalPortPowerGridInputPhaseRequestData physicalPortPowerGridInputPhaseRequestData = (PhysicalPortPowerGridInputPhaseRequestData) o;
    return Objects.equals(this.returnEntityAttributes, physicalPortPowerGridInputPhaseRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, physicalPortPowerGridInputPhaseRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, physicalPortPowerGridInputPhaseRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, physicalPortPowerGridInputPhaseRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class PhysicalPortPowerGridInputPhaseRequestData {\n");
