...
/**
 * StorageBaseSlotEntityRestriction
 */
@JsonPropertyOrder({
  StorageBaseSlotEntityRestriction.JSON_PROPERTY_CLIMATE_RELEVANT,
  StorageBaseSlotEntityRestriction.JSON_PROPERTY_POWER_CONSUMPTION,
  StorageBaseSlotEntityRestriction.JSON_PROPERTY_POWER_SWITCHING_STATUS,
  StorageBaseSlotEntityRestriction.JSON_PROPERTY_PLAN_STATUS,
  StorageBaseSlotEntityRestriction.JSON_PROPERTY_SYSTEM_RUNTIME,
  StorageBaseSlotEntityRestriction.JSON_PROPERTY_WEIGHT,
  StorageBaseSlotEntityRestriction.JSON_PROPERTY_REMARK,
  StorageBaseSlotEntityRestriction.JSON_PROPERTY_ELID,
  StorageBaseSlotEntityRestriction.JSON_PROPERTY_LAST_SEEN,
  StorageBaseSlotEntityRestriction.JSON_PROPERTY_TYPE_ELID,
  StorageBaseSlotEntityRestriction.JSON_PROPERTY_VISIBLE_ID,
  StorageBaseSlotEntityRestriction.JSON_PROPERTY_ID,
  StorageBaseSlotEntityRestriction.JSON_PROPERTY_HEAT_EMISSION
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-01-31T11:10:37.320689708Z[Etc/UTC]")
public class StorageBaseSlotEntityRestriction {
  ...
  public StorageBaseSlotEntityRestriction() {
  }

  public StorageBaseSlotEntityRestriction climateRelevant(RestrictionsBoolean climateRelevant) {
  ...
  **/
  ...
  public StorageBaseSlotEntityRestriction powerConsumption(RestrictionsNumeric powerConsumption) {
  ...
  **/
  ...
  public StorageBaseSlotEntityRestriction powerSwitchingStatus(RestrictionsString powerSwitchingStatus) {
  ...
  **/
  ...
  public StorageBaseSlotEntityRestriction planStatus(RestrictionsString planStatus) {
  ...
  **/
  ...
  public StorageBaseSlotEntityRestriction systemRuntime(RestrictionsNumeric systemRuntime) {
  ...
  **/
  ...
  public StorageBaseSlotEntityRestriction weight(RestrictionsNumeric weight) {
  ...
  **/
  ...
  public StorageBaseSlotEntityRestriction remark(RestrictionsString remark) {
  ...
  **/
  ...
  public StorageBaseSlotEntityRestriction elid(RestrictionsString elid) {
  ...
  **/
  ...
  public StorageBaseSlotEntityRestriction lastSeen(RestrictionsDate lastSeen) {
  ...
  **/
  ...
  public StorageBaseSlotEntityRestriction typeElid(RestrictionsString typeElid) {
  ...
  **/
  ...
  public StorageBaseSlotEntityRestriction visibleId(RestrictionsString visibleId) {
  ...
  **/
  ...
  public StorageBaseSlotEntityRestriction id(RestrictionsString id) {
  ...
  **/
  ...
  public StorageBaseSlotEntityRestriction heatEmission(RestrictionsNumeric heatEmission) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    StorageBaseSlotEntityRestriction storageBaseSlotEntityRestriction = (StorageBaseSlotEntityRestriction) o;
    return Objects.equals(this.climateRelevant, storageBaseSlotEntityRestriction.climateRelevant) &&
        Objects.equals(this.powerConsumption, storageBaseSlotEntityRestriction.powerConsumption) &&
        Objects.equals(this.powerSwitchingStatus, storageBaseSlotEntityRestriction.powerSwitchingStatus) &&
        Objects.equals(this.planStatus, storageBaseSlotEntityRestriction.planStatus) &&
        Objects.equals(this.systemRuntime, storageBaseSlotEntityRestriction.systemRuntime) &&
        Objects.equals(this.weight, storageBaseSlotEntityRestriction.weight) &&
        Objects.equals(this.remark, storageBaseSlotEntityRestriction.remark) &&
        Objects.equals(this.elid, storageBaseSlotEntityRestriction.elid) &&
        Objects.equals(this.lastSeen, storageBaseSlotEntityRestriction.lastSeen) &&
        Objects.equals(this.typeElid, storageBaseSlotEntityRestriction.typeElid) &&
        Objects.equals(this.visibleId, storageBaseSlotEntityRestriction.visibleId) &&
        Objects.equals(this.id, storageBaseSlotEntityRestriction.id) &&
        Objects.equals(this.heatEmission, storageBaseSlotEntityRestriction.heatEmission);
  }
  ...
  public String toString() {
    ...
    sb.append("class StorageBaseSlotEntityRestriction {\n");
