...
import com.fntsoftware.businessgateway.entities.JunctionBoxFistZoneEntityRestriction;
...
/**
 * JunctionBoxFistZoneRequestData
 */
@JsonPropertyOrder({
  JunctionBoxFistZoneRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  JunctionBoxFistZoneRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  JunctionBoxFistZoneRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  JunctionBoxFistZoneRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-02-26T11:20:24.990023935Z[Etc/UTC]")
public class JunctionBoxFistZoneRequestData {
  ...
  private JunctionBoxFistZoneEntityRestriction entityRestrictions;
  ...
  public JunctionBoxFistZoneRequestData() {
  }

  public JunctionBoxFistZoneRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public JunctionBoxFistZoneRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public JunctionBoxFistZoneRequestData entityRestrictions(JunctionBoxFistZoneEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public JunctionBoxFistZoneEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(JunctionBoxFistZoneEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public JunctionBoxFistZoneRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public JunctionBoxFistZoneRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public JunctionBoxFistZoneRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    JunctionBoxFistZoneRequestData junctionBoxFistZoneRequestData = (JunctionBoxFistZoneRequestData) o;
    return Objects.equals(this.returnEntityAttributes, junctionBoxFistZoneRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, junctionBoxFistZoneRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, junctionBoxFistZoneRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, junctionBoxFistZoneRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class JunctionBoxFistZoneRequestData {\n");
