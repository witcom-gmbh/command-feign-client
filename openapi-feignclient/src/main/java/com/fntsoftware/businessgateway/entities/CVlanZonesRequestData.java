...
import com.fntsoftware.businessgateway.entities.CVlanZonesEntityRestriction;
import com.fntsoftware.businessgateway.entities.CVlanZonesRelationRestriction;
...
/**
 * CVlanZonesRequestData
 */
@JsonPropertyOrder({
  CVlanZonesRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  CVlanZonesRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  CVlanZonesRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  CVlanZonesRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-02-26T11:20:24.990023935Z[Etc/UTC]")
public class CVlanZonesRequestData {
  ...
  private CVlanZonesEntityRestriction entityRestrictions;

  public static final String JSON_PROPERTY_RELATION_RESTRICTIONS = "relationRestrictions";
  private CVlanZonesRelationRestriction relationRestrictions;
  ...
  public CVlanZonesRequestData() {
  }

  public CVlanZonesRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public CVlanZonesRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public CVlanZonesRequestData entityRestrictions(CVlanZonesEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public CVlanZonesEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(CVlanZonesEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public CVlanZonesRequestData relationRestrictions(CVlanZonesRelationRestriction relationRestrictions) {
  ...
  **/
  ...
  public CVlanZonesRelationRestriction getRelationRestrictions() {
    return relationRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_RELATION_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRelationRestrictions(CVlanZonesRelationRestriction relationRestrictions) {
    this.relationRestrictions = relationRestrictions;
  }


  public CVlanZonesRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public CVlanZonesRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    CVlanZonesRequestData cvlanZonesRequestData = (CVlanZonesRequestData) o;
    return Objects.equals(this.returnEntityAttributes, cvlanZonesRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, cvlanZonesRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, cvlanZonesRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, cvlanZonesRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class CVlanZonesRequestData {\n");
