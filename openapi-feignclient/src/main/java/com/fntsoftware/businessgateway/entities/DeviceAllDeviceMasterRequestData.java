...
import com.fntsoftware.businessgateway.entities.DeviceAllDeviceMasterEntityRestriction;
...
/**
 * DeviceAllDeviceMasterRequestData
 */
@JsonPropertyOrder({
  DeviceAllDeviceMasterRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  DeviceAllDeviceMasterRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  DeviceAllDeviceMasterRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  DeviceAllDeviceMasterRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-03-04T13:31:32.601557352Z[Etc/UTC]")
public class DeviceAllDeviceMasterRequestData {
  ...
  private DeviceAllDeviceMasterEntityRestriction entityRestrictions;
  ...
  public DeviceAllDeviceMasterRequestData() {
  }

  public DeviceAllDeviceMasterRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public DeviceAllDeviceMasterRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public DeviceAllDeviceMasterRequestData entityRestrictions(DeviceAllDeviceMasterEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public DeviceAllDeviceMasterEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(DeviceAllDeviceMasterEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public DeviceAllDeviceMasterRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public DeviceAllDeviceMasterRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public DeviceAllDeviceMasterRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    DeviceAllDeviceMasterRequestData deviceAllDeviceMasterRequestData = (DeviceAllDeviceMasterRequestData) o;
    return Objects.equals(this.returnEntityAttributes, deviceAllDeviceMasterRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, deviceAllDeviceMasterRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, deviceAllDeviceMasterRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, deviceAllDeviceMasterRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeviceAllDeviceMasterRequestData {\n");
