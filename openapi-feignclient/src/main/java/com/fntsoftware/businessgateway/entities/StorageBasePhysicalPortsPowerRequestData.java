...
import com.fntsoftware.businessgateway.entities.StorageBasePhysicalPortsPowerEntityRestriction;
...
/**
 * StorageBasePhysicalPortsPowerRequestData
 */
@JsonPropertyOrder({
  StorageBasePhysicalPortsPowerRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  StorageBasePhysicalPortsPowerRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  StorageBasePhysicalPortsPowerRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  StorageBasePhysicalPortsPowerRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-01-31T11:10:37.320689708Z[Etc/UTC]")
public class StorageBasePhysicalPortsPowerRequestData {
  ...
  private StorageBasePhysicalPortsPowerEntityRestriction entityRestrictions;
  ...
  public StorageBasePhysicalPortsPowerRequestData() {
  }

  public StorageBasePhysicalPortsPowerRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public StorageBasePhysicalPortsPowerRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public StorageBasePhysicalPortsPowerRequestData entityRestrictions(StorageBasePhysicalPortsPowerEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public StorageBasePhysicalPortsPowerEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(StorageBasePhysicalPortsPowerEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public StorageBasePhysicalPortsPowerRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public StorageBasePhysicalPortsPowerRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public StorageBasePhysicalPortsPowerRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    StorageBasePhysicalPortsPowerRequestData storageBasePhysicalPortsPowerRequestData = (StorageBasePhysicalPortsPowerRequestData) o;
    return Objects.equals(this.returnEntityAttributes, storageBasePhysicalPortsPowerRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, storageBasePhysicalPortsPowerRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, storageBasePhysicalPortsPowerRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, storageBasePhysicalPortsPowerRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class StorageBasePhysicalPortsPowerRequestData {\n");
