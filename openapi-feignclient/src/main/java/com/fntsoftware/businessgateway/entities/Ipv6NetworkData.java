 ...
 */
@JsonPropertyOrder({
  Ipv6NetworkData.JSON_PROPERTY_LOOKUP,
  Ipv6NetworkData.JSON_PROPERTY_DHCP_SCOPE_TYPE,
  Ipv6NetworkData.JSON_PROPERTY_REMARK,
  Ipv6NetworkData.JSON_PROPERTY_ELID,
  Ipv6NetworkData.JSON_PROPERTY_NET_CLIENT_ELID,
  Ipv6NetworkData.JSON_PROPERTY_PREFIX_LENGTH,
  Ipv6NetworkData.JSON_PROPERTY_DHCP_LEASE_TIME,
  Ipv6NetworkData.JSON_PROPERTY_DOMAIN_ELID,
  Ipv6NetworkData.JSON_PROPERTY_NETRANGE_NAME_ELID,
  Ipv6NetworkData.JSON_PROPERTY_BLOCKED,
  Ipv6NetworkData.JSON_PROPERTY_FUNCTION,
  Ipv6NetworkData.JSON_PROPERTY_NAME,
  Ipv6NetworkData.JSON_PROPERTY_PRIMARY_SCOPE_ELID,
  Ipv6NetworkData.JSON_PROPERTY_DHCP_SCOPE_NAME,
  Ipv6NetworkData.JSON_PROPERTY_GATEWAY_IP_ADDRESS_ELID,
  Ipv6NetworkData.JSON_PROPERTY_FULL_ID,
  Ipv6NetworkData.JSON_PROPERTY_ID,
  Ipv6NetworkData.JSON_PROPERTY_DHCP
})
@JsonTypeName("ipv6NetworkData")
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-01-31T11:10:37.320689708Z[Etc/UTC]")
public class Ipv6NetworkData {
  ...
  public Ipv6NetworkData() {
  }

  public Ipv6NetworkData lookup(Boolean lookup) {
  ...
  **/
  ...
  public Ipv6NetworkData dhcpScopeType(String dhcpScopeType) {
  ...
  **/
  ...
  public Ipv6NetworkData remark(String remark) {
  ...
  **/
  ...
  public Ipv6NetworkData elid(String elid) {
  ...
  **/
  ...
  public Ipv6NetworkData netClientElid(String netClientElid) {
  ...
  **/
  ...
  public Ipv6NetworkData prefixLength(BigDecimal prefixLength) {
  ...
  **/
  ...
  public Ipv6NetworkData dhcpLeaseTime(String dhcpLeaseTime) {
  ...
  **/
  ...
  public Ipv6NetworkData domainElid(String domainElid) {
  ...
  **/
  ...
  public Ipv6NetworkData netrangeNameElid(String netrangeNameElid) {
  ...
  **/
  ...
  public Ipv6NetworkData blocked(Boolean blocked) {
  ...
  **/
  ...
  public Ipv6NetworkData function(String function) {
  ...
  **/
  ...
  public Ipv6NetworkData name(String name) {
  ...
  **/
  ...
  public Ipv6NetworkData primaryScopeElid(String primaryScopeElid) {
  ...
  **/
  ...
  public Ipv6NetworkData dhcpScopeName(String dhcpScopeName) {
  ...
  **/
  ...
  public Ipv6NetworkData gatewayIpAddressElid(String gatewayIpAddressElid) {
  ...
  **/
  ...
  public Ipv6NetworkData fullId(String fullId) {
  ...
  **/
  ...
  public Ipv6NetworkData id(String id) {
  ...
  **/
  ...
  public Ipv6NetworkData dhcp(Boolean dhcp) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    Ipv6NetworkData ipv6NetworkData = (Ipv6NetworkData) o;
    return Objects.equals(this.lookup, ipv6NetworkData.lookup) &&
        Objects.equals(this.dhcpScopeType, ipv6NetworkData.dhcpScopeType) &&
        Objects.equals(this.remark, ipv6NetworkData.remark) &&
        Objects.equals(this.elid, ipv6NetworkData.elid) &&
        Objects.equals(this.netClientElid, ipv6NetworkData.netClientElid) &&
        Objects.equals(this.prefixLength, ipv6NetworkData.prefixLength) &&
        Objects.equals(this.dhcpLeaseTime, ipv6NetworkData.dhcpLeaseTime) &&
        Objects.equals(this.domainElid, ipv6NetworkData.domainElid) &&
        Objects.equals(this.netrangeNameElid, ipv6NetworkData.netrangeNameElid) &&
        Objects.equals(this.blocked, ipv6NetworkData.blocked) &&
        Objects.equals(this.function, ipv6NetworkData.function) &&
        Objects.equals(this.name, ipv6NetworkData.name) &&
        Objects.equals(this.primaryScopeElid, ipv6NetworkData.primaryScopeElid) &&
        Objects.equals(this.dhcpScopeName, ipv6NetworkData.dhcpScopeName) &&
        Objects.equals(this.gatewayIpAddressElid, ipv6NetworkData.gatewayIpAddressElid) &&
        Objects.equals(this.fullId, ipv6NetworkData.fullId) &&
        Objects.equals(this.id, ipv6NetworkData.id) &&
        Objects.equals(this.dhcp, ipv6NetworkData.dhcp);
  }
  ...
  public String toString() {
    ...
    sb.append("class Ipv6NetworkData {\n");
