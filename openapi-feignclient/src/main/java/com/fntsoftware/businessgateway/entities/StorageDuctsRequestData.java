...
import com.fntsoftware.businessgateway.entities.StorageDuctsEntityRestriction;
import com.fntsoftware.businessgateway.entities.StorageDuctsRelationRestriction;
...
/**
 * StorageDuctsRequestData
 */
@JsonPropertyOrder({
  StorageDuctsRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  StorageDuctsRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  StorageDuctsRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  StorageDuctsRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-03-04T13:31:32.601557352Z[Etc/UTC]")
public class StorageDuctsRequestData {
  ...
  private StorageDuctsEntityRestriction entityRestrictions;

  public static final String JSON_PROPERTY_RELATION_RESTRICTIONS = "relationRestrictions";
  private StorageDuctsRelationRestriction relationRestrictions;
  ...
  public StorageDuctsRequestData() {
  }

  public StorageDuctsRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public StorageDuctsRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public StorageDuctsRequestData entityRestrictions(StorageDuctsEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public StorageDuctsEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(StorageDuctsEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public StorageDuctsRequestData relationRestrictions(StorageDuctsRelationRestriction relationRestrictions) {
  ...
  **/
  ...
  public StorageDuctsRelationRestriction getRelationRestrictions() {
    return relationRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_RELATION_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRelationRestrictions(StorageDuctsRelationRestriction relationRestrictions) {
    this.relationRestrictions = relationRestrictions;
  }


  public StorageDuctsRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public StorageDuctsRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    StorageDuctsRequestData storageDuctsRequestData = (StorageDuctsRequestData) o;
    return Objects.equals(this.returnEntityAttributes, storageDuctsRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, storageDuctsRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, storageDuctsRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, storageDuctsRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class StorageDuctsRequestData {\n");
