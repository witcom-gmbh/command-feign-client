...
import com.fntsoftware.businessgateway.entities.ModulePersonsEntityRestriction;
import com.fntsoftware.businessgateway.entities.ModulePersonsRelationRestriction;
...
/**
 * ModulePersonsRequestData
 */
@JsonPropertyOrder({
  ModulePersonsRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  ModulePersonsRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  ModulePersonsRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  ModulePersonsRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-02-26T11:20:24.990023935Z[Etc/UTC]")
public class ModulePersonsRequestData {
  ...
  private ModulePersonsEntityRestriction entityRestrictions;

  public static final String JSON_PROPERTY_RELATION_RESTRICTIONS = "relationRestrictions";
  private ModulePersonsRelationRestriction relationRestrictions;
  ...
  public ModulePersonsRequestData() {
  }

  public ModulePersonsRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public ModulePersonsRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public ModulePersonsRequestData entityRestrictions(ModulePersonsEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public ModulePersonsEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(ModulePersonsEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public ModulePersonsRequestData relationRestrictions(ModulePersonsRelationRestriction relationRestrictions) {
  ...
  **/
  ...
  public ModulePersonsRelationRestriction getRelationRestrictions() {
    return relationRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_RELATION_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRelationRestrictions(ModulePersonsRelationRestriction relationRestrictions) {
    this.relationRestrictions = relationRestrictions;
  }


  public ModulePersonsRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public ModulePersonsRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ModulePersonsRequestData modulePersonsRequestData = (ModulePersonsRequestData) o;
    return Objects.equals(this.returnEntityAttributes, modulePersonsRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, modulePersonsRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, modulePersonsRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, modulePersonsRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class ModulePersonsRequestData {\n");
