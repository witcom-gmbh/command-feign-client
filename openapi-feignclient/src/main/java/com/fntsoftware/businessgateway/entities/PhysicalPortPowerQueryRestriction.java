...
/**
 * PhysicalPortPowerQueryRestriction
 */
@JsonPropertyOrder({
  PhysicalPortPowerQueryRestriction.JSON_PROPERTY_SOCKET_NAME_SPC,
  PhysicalPortPowerQueryRestriction.JSON_PROPERTY_BORDER_COLOR,
  PhysicalPortPowerQueryRestriction.JSON_PROPERTY_DEVICE_ALL_ELID,
  PhysicalPortPowerQueryRestriction.JSON_PROPERTY_SOCKET_NAME,
  PhysicalPortPowerQueryRestriction.JSON_PROPERTY_PORT_IDENTIFIER,
  PhysicalPortPowerQueryRestriction.JSON_PROPERTY_WIRE_TYPE,
  PhysicalPortPowerQueryRestriction.JSON_PROPERTY_PORT_NETWORK_CATEGORY,
  PhysicalPortPowerQueryRestriction.JSON_PROPERTY_PORT_CATEGORY,
  PhysicalPortPowerQueryRestriction.JSON_PROPERTY_SOCKET_NO,
  PhysicalPortPowerQueryRestriction.JSON_PROPERTY_MEDIUM,
  PhysicalPortPowerQueryRestriction.JSON_PROPERTY_CONNECTOR,
  PhysicalPortPowerQueryRestriction.JSON_PROPERTY_SOCKET_SIDE,
  PhysicalPortPowerQueryRestriction.JSON_PROPERTY_SOCKET_SUB_NO,
  PhysicalPortPowerQueryRestriction.JSON_PROPERTY_STATUS_REMARK,
  PhysicalPortPowerQueryRestriction.JSON_PROPERTY_DEVICE_ALL_ID,
  PhysicalPortPowerQueryRestriction.JSON_PROPERTY_PLAN_PORT_NETWORK_CATEGORY,
  PhysicalPortPowerQueryRestriction.JSON_PROPERTY_STATUS
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-02-26T11:20:24.990023935Z[Etc/UTC]")
public class PhysicalPortPowerQueryRestriction {
  ...
  public PhysicalPortPowerQueryRestriction() {
  }

  public PhysicalPortPowerQueryRestriction socketNameSpc(RestrictionsString socketNameSpc) {
  ...
  **/
  ...
  public PhysicalPortPowerQueryRestriction borderColor(RestrictionsString borderColor) {
  ...
  **/
  ...
  public PhysicalPortPowerQueryRestriction deviceAllElid(RestrictionsString deviceAllElid) {
  ...
  **/
  ...
  public PhysicalPortPowerQueryRestriction socketName(RestrictionsString socketName) {
  ...
  **/
  ...
  public PhysicalPortPowerQueryRestriction portIdentifier(RestrictionsString portIdentifier) {
  ...
  **/
  ...
  public PhysicalPortPowerQueryRestriction wireType(RestrictionsString wireType) {
  ...
  **/
  ...
  public PhysicalPortPowerQueryRestriction portNetworkCategory(RestrictionsString portNetworkCategory) {
  ...
  **/
  ...
  public PhysicalPortPowerQueryRestriction portCategory(RestrictionsString portCategory) {
  ...
  **/
  ...
  public PhysicalPortPowerQueryRestriction socketNo(RestrictionsNumeric socketNo) {
  ...
  **/
  ...
  public PhysicalPortPowerQueryRestriction medium(RestrictionsString medium) {
  ...
  **/
  ...
  public PhysicalPortPowerQueryRestriction connector(RestrictionsString connector) {
  ...
  **/
  ...
  public PhysicalPortPowerQueryRestriction socketSide(RestrictionsString socketSide) {
  ...
  **/
  ...
  public PhysicalPortPowerQueryRestriction socketSubNo(RestrictionsNumeric socketSubNo) {
  ...
  **/
  ...
  public PhysicalPortPowerQueryRestriction statusRemark(RestrictionsString statusRemark) {
  ...
  **/
  ...
  public PhysicalPortPowerQueryRestriction deviceAllId(RestrictionsString deviceAllId) {
  ...
  **/
  ...
  public PhysicalPortPowerQueryRestriction planPortNetworkCategory(RestrictionsString planPortNetworkCategory) {
  ...
  **/
  ...
  public PhysicalPortPowerQueryRestriction status(RestrictionsString status) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    PhysicalPortPowerQueryRestriction physicalPortPowerQueryRestriction = (PhysicalPortPowerQueryRestriction) o;
    return Objects.equals(this.socketNameSpc, physicalPortPowerQueryRestriction.socketNameSpc) &&
        Objects.equals(this.borderColor, physicalPortPowerQueryRestriction.borderColor) &&
        Objects.equals(this.deviceAllElid, physicalPortPowerQueryRestriction.deviceAllElid) &&
        Objects.equals(this.socketName, physicalPortPowerQueryRestriction.socketName) &&
        Objects.equals(this.portIdentifier, physicalPortPowerQueryRestriction.portIdentifier) &&
        Objects.equals(this.wireType, physicalPortPowerQueryRestriction.wireType) &&
        Objects.equals(this.portNetworkCategory, physicalPortPowerQueryRestriction.portNetworkCategory) &&
        Objects.equals(this.portCategory, physicalPortPowerQueryRestriction.portCategory) &&
        Objects.equals(this.socketNo, physicalPortPowerQueryRestriction.socketNo) &&
        Objects.equals(this.medium, physicalPortPowerQueryRestriction.medium) &&
        Objects.equals(this.connector, physicalPortPowerQueryRestriction.connector) &&
        Objects.equals(this.socketSide, physicalPortPowerQueryRestriction.socketSide) &&
        Objects.equals(this.socketSubNo, physicalPortPowerQueryRestriction.socketSubNo) &&
        Objects.equals(this.statusRemark, physicalPortPowerQueryRestriction.statusRemark) &&
        Objects.equals(this.deviceAllId, physicalPortPowerQueryRestriction.deviceAllId) &&
        Objects.equals(this.planPortNetworkCategory, physicalPortPowerQueryRestriction.planPortNetworkCategory) &&
        Objects.equals(this.status, physicalPortPowerQueryRestriction.status);
  }
  ...
  public String toString() {
    ...
    sb.append("class PhysicalPortPowerQueryRestriction {\n");
