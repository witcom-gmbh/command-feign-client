...
import com.fntsoftware.businessgateway.entities.LogicalPortNetworkElementEntityRestriction;
...
/**
 * LogicalPortNetworkElementRequestData
 */
@JsonPropertyOrder({
  LogicalPortNetworkElementRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  LogicalPortNetworkElementRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  LogicalPortNetworkElementRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  LogicalPortNetworkElementRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-03-04T13:31:32.601557352Z[Etc/UTC]")
public class LogicalPortNetworkElementRequestData {
  ...
  private LogicalPortNetworkElementEntityRestriction entityRestrictions;
  ...
  public LogicalPortNetworkElementRequestData() {
  }

  public LogicalPortNetworkElementRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public LogicalPortNetworkElementRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public LogicalPortNetworkElementRequestData entityRestrictions(LogicalPortNetworkElementEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public LogicalPortNetworkElementEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(LogicalPortNetworkElementEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public LogicalPortNetworkElementRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public LogicalPortNetworkElementRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public LogicalPortNetworkElementRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    LogicalPortNetworkElementRequestData logicalPortNetworkElementRequestData = (LogicalPortNetworkElementRequestData) o;
    return Objects.equals(this.returnEntityAttributes, logicalPortNetworkElementRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, logicalPortNetworkElementRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, logicalPortNetworkElementRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, logicalPortNetworkElementRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class LogicalPortNetworkElementRequestData {\n");
