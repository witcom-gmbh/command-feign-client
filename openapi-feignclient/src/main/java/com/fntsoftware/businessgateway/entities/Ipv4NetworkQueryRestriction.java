...
/**
 * Ipv4NetworkQueryRestriction
 */
@JsonPropertyOrder({
  Ipv4NetworkQueryRestriction.JSON_PROPERTY_NET_CLIENT,
  Ipv4NetworkQueryRestriction.JSON_PROPERTY_START_IP,
  Ipv4NetworkQueryRestriction.JSON_PROPERTY_C_ADMIN_PERSON_ID,
  Ipv4NetworkQueryRestriction.JSON_PROPERTY_CIDR_ID,
  Ipv4NetworkQueryRestriction.JSON_PROPERTY_REMARK,
  Ipv4NetworkQueryRestriction.JSON_PROPERTY_PREFIX_LENGTH,
  Ipv4NetworkQueryRestriction.JSON_PROPERTY_DHCP_LEASE_TIME,
  Ipv4NetworkQueryRestriction.JSON_PROPERTY_HAS_FREE_FOLLOWING_NET,
  Ipv4NetworkQueryRestriction.JSON_PROPERTY_FUNCTION,
  Ipv4NetworkQueryRestriction.JSON_PROPERTY_PRIMARY_SCOPE_ELID,
  Ipv4NetworkQueryRestriction.JSON_PROPERTY_DHCP_SCOPE_NAME,
  Ipv4NetworkQueryRestriction.JSON_PROPERTY_C_ORG_NR,
  Ipv4NetworkQueryRestriction.JSON_PROPERTY_ID,
  Ipv4NetworkQueryRestriction.JSON_PROPERTY_SUBNETMASK,
  Ipv4NetworkQueryRestriction.JSON_PROPERTY_DHCP,
  Ipv4NetworkQueryRestriction.JSON_PROPERTY_C_RIR_DOCUMENTATION_REQ,
  Ipv4NetworkQueryRestriction.JSON_PROPERTY_END_IP,
  Ipv4NetworkQueryRestriction.JSON_PROPERTY_LOOKUP,
  Ipv4NetworkQueryRestriction.JSON_PROPERTY_USE_BROADCAST_IP,
  Ipv4NetworkQueryRestriction.JSON_PROPERTY_DHCP_SERVER,
  Ipv4NetworkQueryRestriction.JSON_PROPERTY_DHCP_SCOPE_TYPE,
  Ipv4NetworkQueryRestriction.JSON_PROPERTY_ELID,
  Ipv4NetworkQueryRestriction.JSON_PROPERTY_NET_CLIENT_ELID,
  Ipv4NetworkQueryRestriction.JSON_PROPERTY_DOMAIN_ELID,
  Ipv4NetworkQueryRestriction.JSON_PROPERTY_NETRANGE_NAME_ELID,
  Ipv4NetworkQueryRestriction.JSON_PROPERTY_USE_NET_IP,
  Ipv4NetworkQueryRestriction.JSON_PROPERTY_NAME,
  Ipv4NetworkQueryRestriction.JSON_PROPERTY_GATEWAY_IP_ADDRESS_ELID,
  Ipv4NetworkQueryRestriction.JSON_PROPERTY_FIRST
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-03-04T13:31:32.601557352Z[Etc/UTC]")
public class Ipv4NetworkQueryRestriction {
  ...
  public Ipv4NetworkQueryRestriction() {
  }

  public Ipv4NetworkQueryRestriction netClient(RestrictionsString netClient) {
  ...
  **/
  ...
  public Ipv4NetworkQueryRestriction startIp(RestrictionsString startIp) {
  ...
  **/
  ...
  public Ipv4NetworkQueryRestriction cAdminPersonId(RestrictionsString cAdminPersonId) {
  ...
  **/
  ...
  public Ipv4NetworkQueryRestriction cidrId(RestrictionsString cidrId) {
  ...
  **/
  ...
  public Ipv4NetworkQueryRestriction remark(RestrictionsString remark) {
  ...
  **/
  ...
  public Ipv4NetworkQueryRestriction prefixLength(RestrictionsNumeric prefixLength) {
  ...
  **/
  ...
  public Ipv4NetworkQueryRestriction dhcpLeaseTime(RestrictionsString dhcpLeaseTime) {
  ...
  **/
  ...
  public Ipv4NetworkQueryRestriction hasFreeFollowingNet(RestrictionsBoolean hasFreeFollowingNet) {
  ...
  **/
  ...
  public Ipv4NetworkQueryRestriction function(RestrictionsString function) {
  ...
  **/
  ...
  public Ipv4NetworkQueryRestriction primaryScopeElid(RestrictionsString primaryScopeElid) {
  ...
  **/
  ...
  public Ipv4NetworkQueryRestriction dhcpScopeName(RestrictionsString dhcpScopeName) {
  ...
  **/
  ...
  public Ipv4NetworkQueryRestriction cOrgNr(RestrictionsString cOrgNr) {
  ...
  **/
  ...
  public Ipv4NetworkQueryRestriction id(RestrictionsString id) {
  ...
  **/
  ...
  public Ipv4NetworkQueryRestriction subnetmask(RestrictionsString subnetmask) {
  ...
  **/
  ...
  public Ipv4NetworkQueryRestriction dhcp(RestrictionsBoolean dhcp) {
  ...
  **/
  ...
  public Ipv4NetworkQueryRestriction cRirDocumentationReq(RestrictionsString cRirDocumentationReq) {
  ...
  **/
  ...
  public Ipv4NetworkQueryRestriction endIp(RestrictionsString endIp) {
  ...
  **/
  ...
  public Ipv4NetworkQueryRestriction lookup(RestrictionsBoolean lookup) {
  ...
  **/
  ...
  public Ipv4NetworkQueryRestriction useBroadcastIp(RestrictionsBoolean useBroadcastIp) {
  ...
  **/
  ...
  public Ipv4NetworkQueryRestriction dhcpServer(RestrictionsString dhcpServer) {
  ...
  **/
  ...
  public Ipv4NetworkQueryRestriction dhcpScopeType(RestrictionsString dhcpScopeType) {
  ...
  **/
  ...
  public Ipv4NetworkQueryRestriction elid(RestrictionsString elid) {
  ...
  **/
  ...
  public Ipv4NetworkQueryRestriction netClientElid(RestrictionsString netClientElid) {
  ...
  **/
  ...
  public Ipv4NetworkQueryRestriction domainElid(RestrictionsString domainElid) {
  ...
  **/
  ...
  public Ipv4NetworkQueryRestriction netrangeNameElid(RestrictionsString netrangeNameElid) {
  ...
  **/
  ...
  public Ipv4NetworkQueryRestriction useNetIp(RestrictionsBoolean useNetIp) {
  ...
  **/
  ...
  public Ipv4NetworkQueryRestriction name(RestrictionsString name) {
  ...
  **/
  ...
  public Ipv4NetworkQueryRestriction gatewayIpAddressElid(RestrictionsString gatewayIpAddressElid) {
  ...
  **/
  ...
  public Ipv4NetworkQueryRestriction first(RestrictionsNumeric first) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    Ipv4NetworkQueryRestriction ipv4NetworkQueryRestriction = (Ipv4NetworkQueryRestriction) o;
    return Objects.equals(this.netClient, ipv4NetworkQueryRestriction.netClient) &&
        Objects.equals(this.startIp, ipv4NetworkQueryRestriction.startIp) &&
        Objects.equals(this.cAdminPersonId, ipv4NetworkQueryRestriction.cAdminPersonId) &&
        Objects.equals(this.cidrId, ipv4NetworkQueryRestriction.cidrId) &&
        Objects.equals(this.remark, ipv4NetworkQueryRestriction.remark) &&
        Objects.equals(this.prefixLength, ipv4NetworkQueryRestriction.prefixLength) &&
        Objects.equals(this.dhcpLeaseTime, ipv4NetworkQueryRestriction.dhcpLeaseTime) &&
        Objects.equals(this.hasFreeFollowingNet, ipv4NetworkQueryRestriction.hasFreeFollowingNet) &&
        Objects.equals(this.function, ipv4NetworkQueryRestriction.function) &&
        Objects.equals(this.primaryScopeElid, ipv4NetworkQueryRestriction.primaryScopeElid) &&
        Objects.equals(this.dhcpScopeName, ipv4NetworkQueryRestriction.dhcpScopeName) &&
        Objects.equals(this.cOrgNr, ipv4NetworkQueryRestriction.cOrgNr) &&
        Objects.equals(this.id, ipv4NetworkQueryRestriction.id) &&
        Objects.equals(this.subnetmask, ipv4NetworkQueryRestriction.subnetmask) &&
        Objects.equals(this.dhcp, ipv4NetworkQueryRestriction.dhcp) &&
        Objects.equals(this.cRirDocumentationReq, ipv4NetworkQueryRestriction.cRirDocumentationReq) &&
        Objects.equals(this.endIp, ipv4NetworkQueryRestriction.endIp) &&
        Objects.equals(this.lookup, ipv4NetworkQueryRestriction.lookup) &&
        Objects.equals(this.useBroadcastIp, ipv4NetworkQueryRestriction.useBroadcastIp) &&
        Objects.equals(this.dhcpServer, ipv4NetworkQueryRestriction.dhcpServer) &&
        Objects.equals(this.dhcpScopeType, ipv4NetworkQueryRestriction.dhcpScopeType) &&
        Objects.equals(this.elid, ipv4NetworkQueryRestriction.elid) &&
        Objects.equals(this.netClientElid, ipv4NetworkQueryRestriction.netClientElid) &&
        Objects.equals(this.domainElid, ipv4NetworkQueryRestriction.domainElid) &&
        Objects.equals(this.netrangeNameElid, ipv4NetworkQueryRestriction.netrangeNameElid) &&
        Objects.equals(this.useNetIp, ipv4NetworkQueryRestriction.useNetIp) &&
        Objects.equals(this.name, ipv4NetworkQueryRestriction.name) &&
        Objects.equals(this.gatewayIpAddressElid, ipv4NetworkQueryRestriction.gatewayIpAddressElid) &&
        Objects.equals(this.first, ipv4NetworkQueryRestriction.first);
  }

  @Override
  public int hashCode() {
    return Objects.hash(netClient, startIp, cAdminPersonId, cidrId, remark, prefixLength, dhcpLeaseTime, hasFreeFollowingNet, function, primaryScopeElid, dhcpScopeName, cOrgNr, id, subnetmask, dhcp, cRirDocumentationReq, endIp, lookup, useBroadcastIp, dhcpServer, dhcpScopeType, elid, netClientElid, domainElid, netrangeNameElid, useNetIp, name, gatewayIpAddressElid, first);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class Ipv4NetworkQueryRestriction {\n");
