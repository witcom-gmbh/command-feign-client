...
import com.fntsoftware.businessgateway.entities.TerminalDeviceMasterEntityRestriction;
...
/**
 * TerminalDeviceMasterRequestData
 */
@JsonPropertyOrder({
  TerminalDeviceMasterRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  TerminalDeviceMasterRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  TerminalDeviceMasterRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  TerminalDeviceMasterRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-03-04T13:31:32.601557352Z[Etc/UTC]")
public class TerminalDeviceMasterRequestData {
  ...
  private TerminalDeviceMasterEntityRestriction entityRestrictions;
  ...
  public TerminalDeviceMasterRequestData() {
  }

  public TerminalDeviceMasterRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public TerminalDeviceMasterRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public TerminalDeviceMasterRequestData entityRestrictions(TerminalDeviceMasterEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public TerminalDeviceMasterEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(TerminalDeviceMasterEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public TerminalDeviceMasterRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public TerminalDeviceMasterRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public TerminalDeviceMasterRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    TerminalDeviceMasterRequestData terminalDeviceMasterRequestData = (TerminalDeviceMasterRequestData) o;
    return Objects.equals(this.returnEntityAttributes, terminalDeviceMasterRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, terminalDeviceMasterRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, terminalDeviceMasterRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, terminalDeviceMasterRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class TerminalDeviceMasterRequestData {\n");
