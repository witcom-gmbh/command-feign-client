...
import com.fntsoftware.businessgateway.entities.PhysicalConnectionDataToPortEntityRestriction;
...
/**
 * PhysicalConnectionDataToPortRequestData
 */
@JsonPropertyOrder({
  PhysicalConnectionDataToPortRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  PhysicalConnectionDataToPortRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  PhysicalConnectionDataToPortRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  PhysicalConnectionDataToPortRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-03-04T13:31:32.601557352Z[Etc/UTC]")
public class PhysicalConnectionDataToPortRequestData {
  ...
  private PhysicalConnectionDataToPortEntityRestriction entityRestrictions;
  ...
  public PhysicalConnectionDataToPortRequestData() {
  }

  public PhysicalConnectionDataToPortRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public PhysicalConnectionDataToPortRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public PhysicalConnectionDataToPortRequestData entityRestrictions(PhysicalConnectionDataToPortEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public PhysicalConnectionDataToPortEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(PhysicalConnectionDataToPortEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public PhysicalConnectionDataToPortRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public PhysicalConnectionDataToPortRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public PhysicalConnectionDataToPortRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    PhysicalConnectionDataToPortRequestData physicalConnectionDataToPortRequestData = (PhysicalConnectionDataToPortRequestData) o;
    return Objects.equals(this.returnEntityAttributes, physicalConnectionDataToPortRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, physicalConnectionDataToPortRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, physicalConnectionDataToPortRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, physicalConnectionDataToPortRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class PhysicalConnectionDataToPortRequestData {\n");
