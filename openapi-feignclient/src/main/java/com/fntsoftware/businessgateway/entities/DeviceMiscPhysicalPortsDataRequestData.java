...
import com.fntsoftware.businessgateway.entities.DeviceMiscPhysicalPortsDataEntityRestriction;
...
/**
 * DeviceMiscPhysicalPortsDataRequestData
 */
@JsonPropertyOrder({
  DeviceMiscPhysicalPortsDataRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  DeviceMiscPhysicalPortsDataRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  DeviceMiscPhysicalPortsDataRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  DeviceMiscPhysicalPortsDataRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-03-04T13:31:32.601557352Z[Etc/UTC]")
public class DeviceMiscPhysicalPortsDataRequestData {
  ...
  private DeviceMiscPhysicalPortsDataEntityRestriction entityRestrictions;
  ...
  public DeviceMiscPhysicalPortsDataRequestData() {
  }

  public DeviceMiscPhysicalPortsDataRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public DeviceMiscPhysicalPortsDataRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public DeviceMiscPhysicalPortsDataRequestData entityRestrictions(DeviceMiscPhysicalPortsDataEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public DeviceMiscPhysicalPortsDataEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(DeviceMiscPhysicalPortsDataEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public DeviceMiscPhysicalPortsDataRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public DeviceMiscPhysicalPortsDataRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public DeviceMiscPhysicalPortsDataRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    DeviceMiscPhysicalPortsDataRequestData deviceMiscPhysicalPortsDataRequestData = (DeviceMiscPhysicalPortsDataRequestData) o;
    return Objects.equals(this.returnEntityAttributes, deviceMiscPhysicalPortsDataRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, deviceMiscPhysicalPortsDataRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, deviceMiscPhysicalPortsDataRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, deviceMiscPhysicalPortsDataRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeviceMiscPhysicalPortsDataRequestData {\n");
