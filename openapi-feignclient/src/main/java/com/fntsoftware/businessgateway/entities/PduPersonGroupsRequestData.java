...
import com.fntsoftware.businessgateway.entities.PduPersonGroupsEntityRestriction;
import com.fntsoftware.businessgateway.entities.PduPersonGroupsRelationRestriction;
...
/**
 * PduPersonGroupsRequestData
 */
@JsonPropertyOrder({
  PduPersonGroupsRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  PduPersonGroupsRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  PduPersonGroupsRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  PduPersonGroupsRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-02-26T11:20:24.990023935Z[Etc/UTC]")
public class PduPersonGroupsRequestData {
  ...
  private PduPersonGroupsEntityRestriction entityRestrictions;

  public static final String JSON_PROPERTY_RELATION_RESTRICTIONS = "relationRestrictions";
  private PduPersonGroupsRelationRestriction relationRestrictions;
  ...
  public PduPersonGroupsRequestData() {
  }

  public PduPersonGroupsRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public PduPersonGroupsRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public PduPersonGroupsRequestData entityRestrictions(PduPersonGroupsEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public PduPersonGroupsEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(PduPersonGroupsEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public PduPersonGroupsRequestData relationRestrictions(PduPersonGroupsRelationRestriction relationRestrictions) {
  ...
  **/
  ...
  public PduPersonGroupsRelationRestriction getRelationRestrictions() {
    return relationRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_RELATION_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRelationRestrictions(PduPersonGroupsRelationRestriction relationRestrictions) {
    this.relationRestrictions = relationRestrictions;
  }


  public PduPersonGroupsRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public PduPersonGroupsRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    PduPersonGroupsRequestData pduPersonGroupsRequestData = (PduPersonGroupsRequestData) o;
    return Objects.equals(this.returnEntityAttributes, pduPersonGroupsRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, pduPersonGroupsRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, pduPersonGroupsRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, pduPersonGroupsRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class PduPersonGroupsRequestData {\n");
