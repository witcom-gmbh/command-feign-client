...
import com.fntsoftware.businessgateway.entities.UpdateSiteResponseData;
 ...
 */
@JsonPropertyOrder({
  UpdateSiteResponse.JSON_PROPERTY_RETURN_DATA,
  UpdateSiteResponse.JSON_PROPERTY_STATUS
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-01-31T11:10:37.320689708Z[Etc/UTC]")
public class UpdateSiteResponse {
  public static final String JSON_PROPERTY_RETURN_DATA = "returnData";
  private UpdateSiteResponseData returnData;
  ...
  public UpdateSiteResponse returnData(UpdateSiteResponseData returnData) {
  ...
  **/
  ...
  public UpdateSiteResponseData getReturnData() {
    return returnData;
  }
  ...
  @JsonProperty(JSON_PROPERTY_RETURN_DATA)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setReturnData(UpdateSiteResponseData returnData) {
    this.returnData = returnData;
  }


  public UpdateSiteResponse status(ServiceStatusData status) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.returnData, updateSiteResponse.returnData) &&
