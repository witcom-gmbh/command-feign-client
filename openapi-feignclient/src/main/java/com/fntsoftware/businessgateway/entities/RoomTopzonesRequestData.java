...
import com.fntsoftware.businessgateway.entities.RoomTopzonesEntityRestriction;
import com.fntsoftware.businessgateway.entities.RoomTopzonesRelationRestriction;
...
/**
 * RoomTopzonesRequestData
 */
@JsonPropertyOrder({
  RoomTopzonesRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  RoomTopzonesRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  RoomTopzonesRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  RoomTopzonesRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-01-31T11:10:37.320689708Z[Etc/UTC]")
public class RoomTopzonesRequestData {
  ...
  private RoomTopzonesEntityRestriction entityRestrictions;

  public static final String JSON_PROPERTY_RELATION_RESTRICTIONS = "relationRestrictions";
  private RoomTopzonesRelationRestriction relationRestrictions;
  ...
  public RoomTopzonesRequestData() {
  }

  public RoomTopzonesRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public RoomTopzonesRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public RoomTopzonesRequestData entityRestrictions(RoomTopzonesEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public RoomTopzonesEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(RoomTopzonesEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public RoomTopzonesRequestData relationRestrictions(RoomTopzonesRelationRestriction relationRestrictions) {
  ...
  **/
  ...
  public RoomTopzonesRelationRestriction getRelationRestrictions() {
    return relationRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_RELATION_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRelationRestrictions(RoomTopzonesRelationRestriction relationRestrictions) {
    this.relationRestrictions = relationRestrictions;
  }


  public RoomTopzonesRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public RoomTopzonesRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    RoomTopzonesRequestData roomTopzonesRequestData = (RoomTopzonesRequestData) o;
    return Objects.equals(this.returnEntityAttributes, roomTopzonesRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, roomTopzonesRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, roomTopzonesRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, roomTopzonesRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class RoomTopzonesRequestData {\n");
