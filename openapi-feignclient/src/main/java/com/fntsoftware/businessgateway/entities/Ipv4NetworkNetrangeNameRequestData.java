...
import com.fntsoftware.businessgateway.entities.Ipv4NetworkNetrangeNameEntityRestriction;
...
/**
 * Ipv4NetworkNetrangeNameRequestData
 */
@JsonPropertyOrder({
  Ipv4NetworkNetrangeNameRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  Ipv4NetworkNetrangeNameRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  Ipv4NetworkNetrangeNameRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  Ipv4NetworkNetrangeNameRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-02-26T11:20:24.990023935Z[Etc/UTC]")
public class Ipv4NetworkNetrangeNameRequestData {
  ...
  private Ipv4NetworkNetrangeNameEntityRestriction entityRestrictions;
  ...
  public Ipv4NetworkNetrangeNameRequestData() {
  }

  public Ipv4NetworkNetrangeNameRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public Ipv4NetworkNetrangeNameRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public Ipv4NetworkNetrangeNameRequestData entityRestrictions(Ipv4NetworkNetrangeNameEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public Ipv4NetworkNetrangeNameEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(Ipv4NetworkNetrangeNameEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public Ipv4NetworkNetrangeNameRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public Ipv4NetworkNetrangeNameRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public Ipv4NetworkNetrangeNameRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    Ipv4NetworkNetrangeNameRequestData ipv4NetworkNetrangeNameRequestData = (Ipv4NetworkNetrangeNameRequestData) o;
    return Objects.equals(this.returnEntityAttributes, ipv4NetworkNetrangeNameRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, ipv4NetworkNetrangeNameRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, ipv4NetworkNetrangeNameRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, ipv4NetworkNetrangeNameRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class Ipv4NetworkNetrangeNameRequestData {\n");
