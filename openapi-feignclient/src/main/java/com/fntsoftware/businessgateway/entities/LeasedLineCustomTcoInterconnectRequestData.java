...
import com.fntsoftware.businessgateway.entities.LeasedLineCustomTcoInterconnectEntityRestriction;
...
/**
 * LeasedLineCustomTcoInterconnectRequestData
 */
@JsonPropertyOrder({
  LeasedLineCustomTcoInterconnectRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  LeasedLineCustomTcoInterconnectRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  LeasedLineCustomTcoInterconnectRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  LeasedLineCustomTcoInterconnectRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-02-26T11:20:24.990023935Z[Etc/UTC]")
public class LeasedLineCustomTcoInterconnectRequestData {
  ...
  private LeasedLineCustomTcoInterconnectEntityRestriction entityRestrictions;
  ...
  public LeasedLineCustomTcoInterconnectRequestData() {
  }

  public LeasedLineCustomTcoInterconnectRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public LeasedLineCustomTcoInterconnectRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public LeasedLineCustomTcoInterconnectRequestData entityRestrictions(LeasedLineCustomTcoInterconnectEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public LeasedLineCustomTcoInterconnectEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(LeasedLineCustomTcoInterconnectEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public LeasedLineCustomTcoInterconnectRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public LeasedLineCustomTcoInterconnectRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public LeasedLineCustomTcoInterconnectRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    LeasedLineCustomTcoInterconnectRequestData leasedLineCustomTcoInterconnectRequestData = (LeasedLineCustomTcoInterconnectRequestData) o;
    return Objects.equals(this.returnEntityAttributes, leasedLineCustomTcoInterconnectRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, leasedLineCustomTcoInterconnectRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, leasedLineCustomTcoInterconnectRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, leasedLineCustomTcoInterconnectRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class LeasedLineCustomTcoInterconnectRequestData {\n");
