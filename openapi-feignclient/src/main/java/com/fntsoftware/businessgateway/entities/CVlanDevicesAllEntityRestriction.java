...
/**
 * CVlanDevicesAllEntityRestriction
 */
@JsonPropertyOrder({
  CVlanDevicesAllEntityRestriction.JSON_PROPERTY_CLIMATE_RELEVANT,
  CVlanDevicesAllEntityRestriction.JSON_PROPERTY_POWER_CONSUMPTION,
  CVlanDevicesAllEntityRestriction.JSON_PROPERTY_POWER_SWITCHING_STATUS,
  CVlanDevicesAllEntityRestriction.JSON_PROPERTY_PLAN_STATUS,
  CVlanDevicesAllEntityRestriction.JSON_PROPERTY_SYSTEM_RUNTIME,
  CVlanDevicesAllEntityRestriction.JSON_PROPERTY_WEIGHT,
  CVlanDevicesAllEntityRestriction.JSON_PROPERTY_REMARK,
  CVlanDevicesAllEntityRestriction.JSON_PROPERTY_ELID,
  CVlanDevicesAllEntityRestriction.JSON_PROPERTY_LAST_SEEN,
  CVlanDevicesAllEntityRestriction.JSON_PROPERTY_TYPE_ELID,
  CVlanDevicesAllEntityRestriction.JSON_PROPERTY_VISIBLE_ID,
  CVlanDevicesAllEntityRestriction.JSON_PROPERTY_ID,
  CVlanDevicesAllEntityRestriction.JSON_PROPERTY_HEAT_EMISSION
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-01-31T11:10:37.320689708Z[Etc/UTC]")
public class CVlanDevicesAllEntityRestriction {
  ...
  public CVlanDevicesAllEntityRestriction() {
  }

  public CVlanDevicesAllEntityRestriction climateRelevant(RestrictionsBoolean climateRelevant) {
  ...
  **/
  ...
  public CVlanDevicesAllEntityRestriction powerConsumption(RestrictionsNumeric powerConsumption) {
  ...
  **/
  ...
  public CVlanDevicesAllEntityRestriction powerSwitchingStatus(RestrictionsString powerSwitchingStatus) {
  ...
  **/
  ...
  public CVlanDevicesAllEntityRestriction planStatus(RestrictionsString planStatus) {
  ...
  **/
  ...
  public CVlanDevicesAllEntityRestriction systemRuntime(RestrictionsNumeric systemRuntime) {
  ...
  **/
  ...
  public CVlanDevicesAllEntityRestriction weight(RestrictionsNumeric weight) {
  ...
  **/
  ...
  public CVlanDevicesAllEntityRestriction remark(RestrictionsString remark) {
  ...
  **/
  ...
  public CVlanDevicesAllEntityRestriction elid(RestrictionsString elid) {
  ...
  **/
  ...
  public CVlanDevicesAllEntityRestriction lastSeen(RestrictionsDate lastSeen) {
  ...
  **/
  ...
  public CVlanDevicesAllEntityRestriction typeElid(RestrictionsString typeElid) {
  ...
  **/
  ...
  public CVlanDevicesAllEntityRestriction visibleId(RestrictionsString visibleId) {
  ...
  **/
  ...
  public CVlanDevicesAllEntityRestriction id(RestrictionsString id) {
  ...
  **/
  ...
  public CVlanDevicesAllEntityRestriction heatEmission(RestrictionsNumeric heatEmission) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    CVlanDevicesAllEntityRestriction cvlanDevicesAllEntityRestriction = (CVlanDevicesAllEntityRestriction) o;
    return Objects.equals(this.climateRelevant, cvlanDevicesAllEntityRestriction.climateRelevant) &&
        Objects.equals(this.powerConsumption, cvlanDevicesAllEntityRestriction.powerConsumption) &&
        Objects.equals(this.powerSwitchingStatus, cvlanDevicesAllEntityRestriction.powerSwitchingStatus) &&
        Objects.equals(this.planStatus, cvlanDevicesAllEntityRestriction.planStatus) &&
        Objects.equals(this.systemRuntime, cvlanDevicesAllEntityRestriction.systemRuntime) &&
        Objects.equals(this.weight, cvlanDevicesAllEntityRestriction.weight) &&
        Objects.equals(this.remark, cvlanDevicesAllEntityRestriction.remark) &&
        Objects.equals(this.elid, cvlanDevicesAllEntityRestriction.elid) &&
        Objects.equals(this.lastSeen, cvlanDevicesAllEntityRestriction.lastSeen) &&
        Objects.equals(this.typeElid, cvlanDevicesAllEntityRestriction.typeElid) &&
        Objects.equals(this.visibleId, cvlanDevicesAllEntityRestriction.visibleId) &&
        Objects.equals(this.id, cvlanDevicesAllEntityRestriction.id) &&
        Objects.equals(this.heatEmission, cvlanDevicesAllEntityRestriction.heatEmission);
  }
  ...
  public String toString() {
    ...
    sb.append("class CVlanDevicesAllEntityRestriction {\n");
