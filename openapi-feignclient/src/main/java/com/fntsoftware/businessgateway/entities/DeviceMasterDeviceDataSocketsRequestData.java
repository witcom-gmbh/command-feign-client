...
import com.fntsoftware.businessgateway.entities.DeviceMasterDeviceDataSocketsEntityRestriction;
...
/**
 * DeviceMasterDeviceDataSocketsRequestData
 */
@JsonPropertyOrder({
  DeviceMasterDeviceDataSocketsRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  DeviceMasterDeviceDataSocketsRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  DeviceMasterDeviceDataSocketsRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  DeviceMasterDeviceDataSocketsRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-01-31T11:10:37.320689708Z[Etc/UTC]")
public class DeviceMasterDeviceDataSocketsRequestData {
  ...
  private DeviceMasterDeviceDataSocketsEntityRestriction entityRestrictions;
  ...
  public DeviceMasterDeviceDataSocketsRequestData() {
  }

  public DeviceMasterDeviceDataSocketsRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public DeviceMasterDeviceDataSocketsRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public DeviceMasterDeviceDataSocketsRequestData entityRestrictions(DeviceMasterDeviceDataSocketsEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public DeviceMasterDeviceDataSocketsEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(DeviceMasterDeviceDataSocketsEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public DeviceMasterDeviceDataSocketsRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public DeviceMasterDeviceDataSocketsRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public DeviceMasterDeviceDataSocketsRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    DeviceMasterDeviceDataSocketsRequestData deviceMasterDeviceDataSocketsRequestData = (DeviceMasterDeviceDataSocketsRequestData) o;
    return Objects.equals(this.returnEntityAttributes, deviceMasterDeviceDataSocketsRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, deviceMasterDeviceDataSocketsRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, deviceMasterDeviceDataSocketsRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, deviceMasterDeviceDataSocketsRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeviceMasterDeviceDataSocketsRequestData {\n");
