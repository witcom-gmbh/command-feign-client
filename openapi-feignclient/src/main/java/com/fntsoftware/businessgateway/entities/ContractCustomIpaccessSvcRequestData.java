...
import com.fntsoftware.businessgateway.entities.ContractCustomIpaccessSvcEntityRestriction;
...
/**
 * ContractCustomIpaccessSvcRequestData
 */
@JsonPropertyOrder({
  ContractCustomIpaccessSvcRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  ContractCustomIpaccessSvcRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  ContractCustomIpaccessSvcRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  ContractCustomIpaccessSvcRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-02-26T11:20:24.990023935Z[Etc/UTC]")
public class ContractCustomIpaccessSvcRequestData {
  ...
  private ContractCustomIpaccessSvcEntityRestriction entityRestrictions;
  ...
  public ContractCustomIpaccessSvcRequestData() {
  }

  public ContractCustomIpaccessSvcRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public ContractCustomIpaccessSvcRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public ContractCustomIpaccessSvcRequestData entityRestrictions(ContractCustomIpaccessSvcEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public ContractCustomIpaccessSvcEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(ContractCustomIpaccessSvcEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public ContractCustomIpaccessSvcRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public ContractCustomIpaccessSvcRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public ContractCustomIpaccessSvcRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ContractCustomIpaccessSvcRequestData contractCustomIpaccessSvcRequestData = (ContractCustomIpaccessSvcRequestData) o;
    return Objects.equals(this.returnEntityAttributes, contractCustomIpaccessSvcRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, contractCustomIpaccessSvcRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, contractCustomIpaccessSvcRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, contractCustomIpaccessSvcRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class ContractCustomIpaccessSvcRequestData {\n");
