...
import com.fntsoftware.businessgateway.entities.VirtualServerResourceGroupEntityRestriction;
...
/**
 * VirtualServerResourceGroupRequestData
 */
@JsonPropertyOrder({
  VirtualServerResourceGroupRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  VirtualServerResourceGroupRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  VirtualServerResourceGroupRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  VirtualServerResourceGroupRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-03-04T13:31:32.601557352Z[Etc/UTC]")
public class VirtualServerResourceGroupRequestData {
  ...
  private VirtualServerResourceGroupEntityRestriction entityRestrictions;
  ...
  public VirtualServerResourceGroupRequestData() {
  }

  public VirtualServerResourceGroupRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public VirtualServerResourceGroupRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public VirtualServerResourceGroupRequestData entityRestrictions(VirtualServerResourceGroupEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public VirtualServerResourceGroupEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(VirtualServerResourceGroupEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public VirtualServerResourceGroupRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public VirtualServerResourceGroupRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public VirtualServerResourceGroupRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    VirtualServerResourceGroupRequestData virtualServerResourceGroupRequestData = (VirtualServerResourceGroupRequestData) o;
    return Objects.equals(this.returnEntityAttributes, virtualServerResourceGroupRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, virtualServerResourceGroupRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, virtualServerResourceGroupRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, virtualServerResourceGroupRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class VirtualServerResourceGroupRequestData {\n");
