...
import com.fntsoftware.businessgateway.entities.MoveToZoneStorageCreateLinkZoneRequestData;
import com.fasterxml.jackson.annotation.JsonPropertyOrder;
import com.fasterxml.jackson.annotation.JsonTypeName;

/**
 * MoveToZoneStorageRequestData
 */
@JsonPropertyOrder({
  MoveToZoneStorageRequestData.JSON_PROPERTY_RELEASE_SIGNALPATH,
  MoveToZoneStorageRequestData.JSON_PROPERTY_RELEASE_CONNECTIONS,
  MoveToZoneStorageRequestData.JSON_PROPERTY_RELEASE_SERVICE,
  MoveToZoneStorageRequestData.JSON_PROPERTY_RELEASE_SUPPORTS,
  MoveToZoneStorageRequestData.JSON_PROPERTY_RELEASE_PATCHES,
  MoveToZoneStorageRequestData.JSON_PROPERTY_CREATE_LINK_ZONE
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-02-26T11:20:24.990023935Z[Etc/UTC]")
public class MoveToZoneStorageRequestData {
  ...
  private MoveToZoneStorageCreateLinkZoneRequestData createLinkZone;

  public MoveToZoneStorageRequestData() {
  }

  public MoveToZoneStorageRequestData releaseSignalpath(Boolean releaseSignalpath) {
  ...
  **/
  ...
  public MoveToZoneStorageRequestData releaseConnections(Boolean releaseConnections) {
  ...
  **/
  ...
  public MoveToZoneStorageRequestData releaseService(Boolean releaseService) {
  ...
  **/
  ...
  public MoveToZoneStorageRequestData releaseSupports(Boolean releaseSupports) {
  ...
  **/
  ...
  public MoveToZoneStorageRequestData releasePatches(Boolean releasePatches) {
  ...
  **/
  ...
  public MoveToZoneStorageRequestData createLinkZone(MoveToZoneStorageCreateLinkZoneRequestData createLinkZone) {
  ...
  **/
  ...
  public MoveToZoneStorageCreateLinkZoneRequestData getCreateLinkZone() {
    return createLinkZone;
  }
  ...
  @JsonProperty(JSON_PROPERTY_CREATE_LINK_ZONE)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setCreateLinkZone(MoveToZoneStorageCreateLinkZoneRequestData createLinkZone) {
    this.createLinkZone = createLinkZone;
  }
  ...
  public boolean equals(Object o) {
    ...
    MoveToZoneStorageRequestData moveToZoneStorageRequestData = (MoveToZoneStorageRequestData) o;
    return Objects.equals(this.releaseSignalpath, moveToZoneStorageRequestData.releaseSignalpath) &&
        Objects.equals(this.releaseConnections, moveToZoneStorageRequestData.releaseConnections) &&
        Objects.equals(this.releaseService, moveToZoneStorageRequestData.releaseService) &&
        Objects.equals(this.releaseSupports, moveToZoneStorageRequestData.releaseSupports) &&
        Objects.equals(this.releasePatches, moveToZoneStorageRequestData.releasePatches) &&
        Objects.equals(this.createLinkZone, moveToZoneStorageRequestData.createLinkZone);
  }
  ...
  public String toString() {
    ...
    sb.append("class MoveToZoneStorageRequestData {\n");
