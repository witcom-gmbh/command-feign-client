...
import com.fntsoftware.businessgateway.entities.PassiveModulePhysicalPortsDataEntityRestriction;
...
/**
 * PassiveModulePhysicalPortsDataRequestData
 */
@JsonPropertyOrder({
  PassiveModulePhysicalPortsDataRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  PassiveModulePhysicalPortsDataRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  PassiveModulePhysicalPortsDataRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  PassiveModulePhysicalPortsDataRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-03-04T13:31:32.601557352Z[Etc/UTC]")
public class PassiveModulePhysicalPortsDataRequestData {
  ...
  private PassiveModulePhysicalPortsDataEntityRestriction entityRestrictions;
  ...
  public PassiveModulePhysicalPortsDataRequestData() {
  }

  public PassiveModulePhysicalPortsDataRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public PassiveModulePhysicalPortsDataRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public PassiveModulePhysicalPortsDataRequestData entityRestrictions(PassiveModulePhysicalPortsDataEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public PassiveModulePhysicalPortsDataEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(PassiveModulePhysicalPortsDataEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public PassiveModulePhysicalPortsDataRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public PassiveModulePhysicalPortsDataRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public PassiveModulePhysicalPortsDataRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    PassiveModulePhysicalPortsDataRequestData passiveModulePhysicalPortsDataRequestData = (PassiveModulePhysicalPortsDataRequestData) o;
    return Objects.equals(this.returnEntityAttributes, passiveModulePhysicalPortsDataRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, passiveModulePhysicalPortsDataRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, passiveModulePhysicalPortsDataRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, passiveModulePhysicalPortsDataRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class PassiveModulePhysicalPortsDataRequestData {\n");
