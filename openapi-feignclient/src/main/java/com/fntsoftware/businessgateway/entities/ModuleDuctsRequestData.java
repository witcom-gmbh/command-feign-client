...
import com.fntsoftware.businessgateway.entities.ModuleDuctsEntityRestriction;
import com.fntsoftware.businessgateway.entities.ModuleDuctsRelationRestriction;
...
/**
 * ModuleDuctsRequestData
 */
@JsonPropertyOrder({
  ModuleDuctsRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  ModuleDuctsRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  ModuleDuctsRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  ModuleDuctsRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-01-31T11:10:37.320689708Z[Etc/UTC]")
public class ModuleDuctsRequestData {
  ...
  private ModuleDuctsEntityRestriction entityRestrictions;

  public static final String JSON_PROPERTY_RELATION_RESTRICTIONS = "relationRestrictions";
  private ModuleDuctsRelationRestriction relationRestrictions;
  ...
  public ModuleDuctsRequestData() {
  }

  public ModuleDuctsRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public ModuleDuctsRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public ModuleDuctsRequestData entityRestrictions(ModuleDuctsEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public ModuleDuctsEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(ModuleDuctsEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public ModuleDuctsRequestData relationRestrictions(ModuleDuctsRelationRestriction relationRestrictions) {
  ...
  **/
  ...
  public ModuleDuctsRelationRestriction getRelationRestrictions() {
    return relationRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_RELATION_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRelationRestrictions(ModuleDuctsRelationRestriction relationRestrictions) {
    this.relationRestrictions = relationRestrictions;
  }


  public ModuleDuctsRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public ModuleDuctsRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ModuleDuctsRequestData moduleDuctsRequestData = (ModuleDuctsRequestData) o;
    return Objects.equals(this.returnEntityAttributes, moduleDuctsRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, moduleDuctsRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, moduleDuctsRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, moduleDuctsRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class ModuleDuctsRequestData {\n");
