...
import com.fntsoftware.businessgateway.entities.TerminalPhysicalPortsDataEntityRestriction;
...
/**
 * TerminalPhysicalPortsDataRequestData
 */
@JsonPropertyOrder({
  TerminalPhysicalPortsDataRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  TerminalPhysicalPortsDataRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  TerminalPhysicalPortsDataRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  TerminalPhysicalPortsDataRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-03-04T13:31:32.601557352Z[Etc/UTC]")
public class TerminalPhysicalPortsDataRequestData {
  ...
  private TerminalPhysicalPortsDataEntityRestriction entityRestrictions;
  ...
  public TerminalPhysicalPortsDataRequestData() {
  }

  public TerminalPhysicalPortsDataRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public TerminalPhysicalPortsDataRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public TerminalPhysicalPortsDataRequestData entityRestrictions(TerminalPhysicalPortsDataEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public TerminalPhysicalPortsDataEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(TerminalPhysicalPortsDataEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public TerminalPhysicalPortsDataRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public TerminalPhysicalPortsDataRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public TerminalPhysicalPortsDataRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    TerminalPhysicalPortsDataRequestData terminalPhysicalPortsDataRequestData = (TerminalPhysicalPortsDataRequestData) o;
    return Objects.equals(this.returnEntityAttributes, terminalPhysicalPortsDataRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, terminalPhysicalPortsDataRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, terminalPhysicalPortsDataRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, terminalPhysicalPortsDataRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class TerminalPhysicalPortsDataRequestData {\n");
