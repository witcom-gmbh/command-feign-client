...
/**
 * HardDiskFileSystemsEntityRestriction
 */
@JsonPropertyOrder({
  HardDiskFileSystemsEntityRestriction.JSON_PROPERTY_LIFECYCLE_STATUS_DATE,
  HardDiskFileSystemsEntityRestriction.JSON_PROPERTY_USED_GB,
  HardDiskFileSystemsEntityRestriction.JSON_PROPERTY_LIFECYCLE_STATUS,
  HardDiskFileSystemsEntityRestriction.JSON_PROPERTY_CAPACITY_GB,
  HardDiskFileSystemsEntityRestriction.JSON_PROPERTY_VISIBLE_ID,
  HardDiskFileSystemsEntityRestriction.JSON_PROPERTY_ID,
  HardDiskFileSystemsEntityRestriction.JSON_PROPERTY_ELID,
  HardDiskFileSystemsEntityRestriction.JSON_PROPERTY_FS_TYPE,
  HardDiskFileSystemsEntityRestriction.JSON_PROPERTY_MOUNTPOINT
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-01-31T11:10:37.320689708Z[Etc/UTC]")
public class HardDiskFileSystemsEntityRestriction {
  ...
  public HardDiskFileSystemsEntityRestriction() {
  }

  public HardDiskFileSystemsEntityRestriction lifecycleStatusDate(RestrictionsDate lifecycleStatusDate) {
  ...
  **/
  ...
  public HardDiskFileSystemsEntityRestriction usedGb(RestrictionsNumeric usedGb) {
  ...
  **/
  ...
  public HardDiskFileSystemsEntityRestriction lifecycleStatus(RestrictionsString lifecycleStatus) {
  ...
  **/
  ...
  public HardDiskFileSystemsEntityRestriction capacityGb(RestrictionsNumeric capacityGb) {
  ...
  **/
  ...
  public HardDiskFileSystemsEntityRestriction visibleId(RestrictionsString visibleId) {
  ...
  **/
  ...
  public HardDiskFileSystemsEntityRestriction id(RestrictionsString id) {
  ...
  **/
  ...
  public HardDiskFileSystemsEntityRestriction elid(RestrictionsString elid) {
  ...
  **/
  ...
  public HardDiskFileSystemsEntityRestriction fsType(RestrictionsString fsType) {
  ...
  **/
  ...
  public HardDiskFileSystemsEntityRestriction mountpoint(RestrictionsString mountpoint) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    HardDiskFileSystemsEntityRestriction hardDiskFileSystemsEntityRestriction = (HardDiskFileSystemsEntityRestriction) o;
    return Objects.equals(this.lifecycleStatusDate, hardDiskFileSystemsEntityRestriction.lifecycleStatusDate) &&
        Objects.equals(this.usedGb, hardDiskFileSystemsEntityRestriction.usedGb) &&
        Objects.equals(this.lifecycleStatus, hardDiskFileSystemsEntityRestriction.lifecycleStatus) &&
        Objects.equals(this.capacityGb, hardDiskFileSystemsEntityRestriction.capacityGb) &&
        Objects.equals(this.visibleId, hardDiskFileSystemsEntityRestriction.visibleId) &&
        Objects.equals(this.id, hardDiskFileSystemsEntityRestriction.id) &&
        Objects.equals(this.elid, hardDiskFileSystemsEntityRestriction.elid) &&
        Objects.equals(this.fsType, hardDiskFileSystemsEntityRestriction.fsType) &&
        Objects.equals(this.mountpoint, hardDiskFileSystemsEntityRestriction.mountpoint);
  }
  ...
  public String toString() {
    ...
    sb.append("class HardDiskFileSystemsEntityRestriction {\n");
