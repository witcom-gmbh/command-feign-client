...
import com.fntsoftware.businessgateway.entities.AntennaDuctsEntityRestriction;
import com.fntsoftware.businessgateway.entities.AntennaDuctsRelationRestriction;
...
/**
 * AntennaDuctsRequestData
 */
@JsonPropertyOrder({
  AntennaDuctsRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  AntennaDuctsRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  AntennaDuctsRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  AntennaDuctsRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-03-04T13:31:32.601557352Z[Etc/UTC]")
public class AntennaDuctsRequestData {
  ...
  private AntennaDuctsEntityRestriction entityRestrictions;

  public static final String JSON_PROPERTY_RELATION_RESTRICTIONS = "relationRestrictions";
  private AntennaDuctsRelationRestriction relationRestrictions;
  ...
  public AntennaDuctsRequestData() {
  }

  public AntennaDuctsRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public AntennaDuctsRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public AntennaDuctsRequestData entityRestrictions(AntennaDuctsEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public AntennaDuctsEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(AntennaDuctsEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public AntennaDuctsRequestData relationRestrictions(AntennaDuctsRelationRestriction relationRestrictions) {
  ...
  **/
  ...
  public AntennaDuctsRelationRestriction getRelationRestrictions() {
    return relationRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_RELATION_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRelationRestrictions(AntennaDuctsRelationRestriction relationRestrictions) {
    this.relationRestrictions = relationRestrictions;
  }


  public AntennaDuctsRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public AntennaDuctsRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    AntennaDuctsRequestData antennaDuctsRequestData = (AntennaDuctsRequestData) o;
    return Objects.equals(this.returnEntityAttributes, antennaDuctsRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, antennaDuctsRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, antennaDuctsRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, antennaDuctsRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class AntennaDuctsRequestData {\n");
