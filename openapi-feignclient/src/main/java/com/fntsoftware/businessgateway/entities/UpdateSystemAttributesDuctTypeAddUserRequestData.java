...
/**
 * UpdateSystemAttributesDuctTypeAddUserRequestData
 */
@JsonPropertyOrder({
  UpdateSystemAttributesDuctTypeAddUserRequestData.JSON_PROPERTY_MODIFY_PLAN,
  UpdateSystemAttributesDuctTypeAddUserRequestData.JSON_PROPERTY_DELETE_REAL,
  UpdateSystemAttributesDuctTypeAddUserRequestData.JSON_PROPERTY_READ_PLAN,
  UpdateSystemAttributesDuctTypeAddUserRequestData.JSON_PROPERTY_MANDANT_ID,
  UpdateSystemAttributesDuctTypeAddUserRequestData.JSON_PROPERTY_USER_ELID,
  UpdateSystemAttributesDuctTypeAddUserRequestData.JSON_PROPERTY_MODIFY_REAL,
  UpdateSystemAttributesDuctTypeAddUserRequestData.JSON_PROPERTY_READ_REAL,
  UpdateSystemAttributesDuctTypeAddUserRequestData.JSON_PROPERTY_DELETE_PLAN
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-02-26T11:20:24.990023935Z[Etc/UTC]")
public class UpdateSystemAttributesDuctTypeAddUserRequestData {
  ...
  public UpdateSystemAttributesDuctTypeAddUserRequestData() {
  }

  public UpdateSystemAttributesDuctTypeAddUserRequestData modifyPlan(Boolean modifyPlan) {
  ...
  **/
  ...
  public UpdateSystemAttributesDuctTypeAddUserRequestData deleteReal(Boolean deleteReal) {
  ...
  **/
  ...
  public UpdateSystemAttributesDuctTypeAddUserRequestData readPlan(Boolean readPlan) {
  ...
  **/
  ...
  public UpdateSystemAttributesDuctTypeAddUserRequestData mandantId(BigDecimal mandantId) {
  ...
  **/
  ...
  public UpdateSystemAttributesDuctTypeAddUserRequestData userElid(String userElid) {
  ...
  **/
  ...
  public UpdateSystemAttributesDuctTypeAddUserRequestData modifyReal(Boolean modifyReal) {
  ...
  **/
  ...
  public UpdateSystemAttributesDuctTypeAddUserRequestData readReal(Boolean readReal) {
  ...
  **/
  ...
  public UpdateSystemAttributesDuctTypeAddUserRequestData deletePlan(Boolean deletePlan) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    UpdateSystemAttributesDuctTypeAddUserRequestData updateSystemAttributesDuctTypeAddUserRequestData = (UpdateSystemAttributesDuctTypeAddUserRequestData) o;
    return Objects.equals(this.modifyPlan, updateSystemAttributesDuctTypeAddUserRequestData.modifyPlan) &&
        Objects.equals(this.deleteReal, updateSystemAttributesDuctTypeAddUserRequestData.deleteReal) &&
        Objects.equals(this.readPlan, updateSystemAttributesDuctTypeAddUserRequestData.readPlan) &&
        Objects.equals(this.mandantId, updateSystemAttributesDuctTypeAddUserRequestData.mandantId) &&
        Objects.equals(this.userElid, updateSystemAttributesDuctTypeAddUserRequestData.userElid) &&
        Objects.equals(this.modifyReal, updateSystemAttributesDuctTypeAddUserRequestData.modifyReal) &&
        Objects.equals(this.readReal, updateSystemAttributesDuctTypeAddUserRequestData.readReal) &&
        Objects.equals(this.deletePlan, updateSystemAttributesDuctTypeAddUserRequestData.deletePlan);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateSystemAttributesDuctTypeAddUserRequestData {\n");
