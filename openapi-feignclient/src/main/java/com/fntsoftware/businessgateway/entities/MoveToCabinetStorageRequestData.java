...
import com.fntsoftware.businessgateway.entities.MoveToCabinetStorageCreateLinkSwitchCabinetRequestData;
import com.fasterxml.jackson.annotation.JsonPropertyOrder;
import com.fasterxml.jackson.annotation.JsonTypeName;

/**
 * MoveToCabinetStorageRequestData
 */
@JsonPropertyOrder({
  MoveToCabinetStorageRequestData.JSON_PROPERTY_RELEASE_SIGNALPATH,
  MoveToCabinetStorageRequestData.JSON_PROPERTY_RELEASE_CONNECTIONS,
  MoveToCabinetStorageRequestData.JSON_PROPERTY_RELEASE_SERVICE,
  MoveToCabinetStorageRequestData.JSON_PROPERTY_RELEASE_SUPPORTS,
  MoveToCabinetStorageRequestData.JSON_PROPERTY_RELEASE_PATCHES,
  MoveToCabinetStorageRequestData.JSON_PROPERTY_CREATE_LINK_SWITCH_CABINET
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-02-26T11:20:24.990023935Z[Etc/UTC]")
public class MoveToCabinetStorageRequestData {
  ...
  private MoveToCabinetStorageCreateLinkSwitchCabinetRequestData createLinkSwitchCabinet;

  public MoveToCabinetStorageRequestData() {
  }

  public MoveToCabinetStorageRequestData releaseSignalpath(Boolean releaseSignalpath) {
  ...
  **/
  ...
  public MoveToCabinetStorageRequestData releaseConnections(Boolean releaseConnections) {
  ...
  **/
  ...
  public MoveToCabinetStorageRequestData releaseService(Boolean releaseService) {
  ...
  **/
  ...
  public MoveToCabinetStorageRequestData releaseSupports(Boolean releaseSupports) {
  ...
  **/
  ...
  public MoveToCabinetStorageRequestData releasePatches(Boolean releasePatches) {
  ...
  **/
  ...
  public MoveToCabinetStorageRequestData createLinkSwitchCabinet(MoveToCabinetStorageCreateLinkSwitchCabinetRequestData createLinkSwitchCabinet) {
  ...
  **/
  ...
  public MoveToCabinetStorageCreateLinkSwitchCabinetRequestData getCreateLinkSwitchCabinet() {
    return createLinkSwitchCabinet;
  }
  ...
  @JsonProperty(JSON_PROPERTY_CREATE_LINK_SWITCH_CABINET)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setCreateLinkSwitchCabinet(MoveToCabinetStorageCreateLinkSwitchCabinetRequestData createLinkSwitchCabinet) {
    this.createLinkSwitchCabinet = createLinkSwitchCabinet;
  }
  ...
  public boolean equals(Object o) {
    ...
    MoveToCabinetStorageRequestData moveToCabinetStorageRequestData = (MoveToCabinetStorageRequestData) o;
    return Objects.equals(this.releaseSignalpath, moveToCabinetStorageRequestData.releaseSignalpath) &&
        Objects.equals(this.releaseConnections, moveToCabinetStorageRequestData.releaseConnections) &&
        Objects.equals(this.releaseService, moveToCabinetStorageRequestData.releaseService) &&
        Objects.equals(this.releaseSupports, moveToCabinetStorageRequestData.releaseSupports) &&
        Objects.equals(this.releasePatches, moveToCabinetStorageRequestData.releasePatches) &&
        Objects.equals(this.createLinkSwitchCabinet, moveToCabinetStorageRequestData.createLinkSwitchCabinet);
  }
  ...
  public String toString() {
    ...
    sb.append("class MoveToCabinetStorageRequestData {\n");
