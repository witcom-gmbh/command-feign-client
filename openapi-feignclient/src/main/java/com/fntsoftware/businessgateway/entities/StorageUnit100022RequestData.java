...
import com.fntsoftware.businessgateway.entities.StorageUnit100022EntityRestriction;
...
/**
 * StorageUnit100022RequestData
 */
@JsonPropertyOrder({
  StorageUnit100022RequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  StorageUnit100022RequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  StorageUnit100022RequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  StorageUnit100022RequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-02-26T11:20:24.990023935Z[Etc/UTC]")
public class StorageUnit100022RequestData {
  ...
  private StorageUnit100022EntityRestriction entityRestrictions;
  ...
  public StorageUnit100022RequestData() {
  }

  public StorageUnit100022RequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public StorageUnit100022RequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public StorageUnit100022RequestData entityRestrictions(StorageUnit100022EntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public StorageUnit100022EntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(StorageUnit100022EntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public StorageUnit100022RequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public StorageUnit100022RequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public StorageUnit100022RequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    StorageUnit100022RequestData storageUnit100022RequestData = (StorageUnit100022RequestData) o;
    return Objects.equals(this.returnEntityAttributes, storageUnit100022RequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, storageUnit100022RequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, storageUnit100022RequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, storageUnit100022RequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class StorageUnit100022RequestData {\n");
