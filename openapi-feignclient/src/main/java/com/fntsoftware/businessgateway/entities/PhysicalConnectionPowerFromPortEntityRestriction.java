...
/**
 * PhysicalConnectionPowerFromPortEntityRestriction
 */
@JsonPropertyOrder({
  PhysicalConnectionPowerFromPortEntityRestriction.JSON_PROPERTY_SOCKET_NAME_SPC,
  PhysicalConnectionPowerFromPortEntityRestriction.JSON_PROPERTY_BORDER_COLOR,
  PhysicalConnectionPowerFromPortEntityRestriction.JSON_PROPERTY_DEVICE_ALL_ELID,
  PhysicalConnectionPowerFromPortEntityRestriction.JSON_PROPERTY_SOCKET_NAME,
  PhysicalConnectionPowerFromPortEntityRestriction.JSON_PROPERTY_PORT_IDENTIFIER,
  PhysicalConnectionPowerFromPortEntityRestriction.JSON_PROPERTY_WIRE_TYPE,
  PhysicalConnectionPowerFromPortEntityRestriction.JSON_PROPERTY_PORT_NETWORK_CATEGORY,
  PhysicalConnectionPowerFromPortEntityRestriction.JSON_PROPERTY_PORT_CATEGORY,
  PhysicalConnectionPowerFromPortEntityRestriction.JSON_PROPERTY_SOCKET_NO,
  PhysicalConnectionPowerFromPortEntityRestriction.JSON_PROPERTY_MEDIUM,
  PhysicalConnectionPowerFromPortEntityRestriction.JSON_PROPERTY_CONNECTOR,
  PhysicalConnectionPowerFromPortEntityRestriction.JSON_PROPERTY_SOCKET_SIDE,
  PhysicalConnectionPowerFromPortEntityRestriction.JSON_PROPERTY_SOCKET_SUB_NO,
  PhysicalConnectionPowerFromPortEntityRestriction.JSON_PROPERTY_STATUS_REMARK,
  PhysicalConnectionPowerFromPortEntityRestriction.JSON_PROPERTY_DEVICE_ALL_ID,
  PhysicalConnectionPowerFromPortEntityRestriction.JSON_PROPERTY_PLAN_PORT_NETWORK_CATEGORY,
  PhysicalConnectionPowerFromPortEntityRestriction.JSON_PROPERTY_STATUS
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-02-26T11:20:24.990023935Z[Etc/UTC]")
public class PhysicalConnectionPowerFromPortEntityRestriction {
  ...
  public PhysicalConnectionPowerFromPortEntityRestriction() {
  }

  public PhysicalConnectionPowerFromPortEntityRestriction socketNameSpc(RestrictionsString socketNameSpc) {
  ...
  **/
  ...
  public PhysicalConnectionPowerFromPortEntityRestriction borderColor(RestrictionsString borderColor) {
  ...
  **/
  ...
  public PhysicalConnectionPowerFromPortEntityRestriction deviceAllElid(RestrictionsString deviceAllElid) {
  ...
  **/
  ...
  public PhysicalConnectionPowerFromPortEntityRestriction socketName(RestrictionsString socketName) {
  ...
  **/
  ...
  public PhysicalConnectionPowerFromPortEntityRestriction portIdentifier(RestrictionsString portIdentifier) {
  ...
  **/
  ...
  public PhysicalConnectionPowerFromPortEntityRestriction wireType(RestrictionsString wireType) {
  ...
  **/
  ...
  public PhysicalConnectionPowerFromPortEntityRestriction portNetworkCategory(RestrictionsString portNetworkCategory) {
  ...
  **/
  ...
  public PhysicalConnectionPowerFromPortEntityRestriction portCategory(RestrictionsString portCategory) {
  ...
  **/
  ...
  public PhysicalConnectionPowerFromPortEntityRestriction socketNo(RestrictionsNumeric socketNo) {
  ...
  **/
  ...
  public PhysicalConnectionPowerFromPortEntityRestriction medium(RestrictionsString medium) {
  ...
  **/
  ...
  public PhysicalConnectionPowerFromPortEntityRestriction connector(RestrictionsString connector) {
  ...
  **/
  ...
  public PhysicalConnectionPowerFromPortEntityRestriction socketSide(RestrictionsString socketSide) {
  ...
  **/
  ...
  public PhysicalConnectionPowerFromPortEntityRestriction socketSubNo(RestrictionsNumeric socketSubNo) {
  ...
  **/
  ...
  public PhysicalConnectionPowerFromPortEntityRestriction statusRemark(RestrictionsString statusRemark) {
  ...
  **/
  ...
  public PhysicalConnectionPowerFromPortEntityRestriction deviceAllId(RestrictionsString deviceAllId) {
  ...
  **/
  ...
  public PhysicalConnectionPowerFromPortEntityRestriction planPortNetworkCategory(RestrictionsString planPortNetworkCategory) {
  ...
  **/
  ...
  public PhysicalConnectionPowerFromPortEntityRestriction status(RestrictionsString status) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    PhysicalConnectionPowerFromPortEntityRestriction physicalConnectionPowerFromPortEntityRestriction = (PhysicalConnectionPowerFromPortEntityRestriction) o;
    return Objects.equals(this.socketNameSpc, physicalConnectionPowerFromPortEntityRestriction.socketNameSpc) &&
        Objects.equals(this.borderColor, physicalConnectionPowerFromPortEntityRestriction.borderColor) &&
        Objects.equals(this.deviceAllElid, physicalConnectionPowerFromPortEntityRestriction.deviceAllElid) &&
        Objects.equals(this.socketName, physicalConnectionPowerFromPortEntityRestriction.socketName) &&
        Objects.equals(this.portIdentifier, physicalConnectionPowerFromPortEntityRestriction.portIdentifier) &&
        Objects.equals(this.wireType, physicalConnectionPowerFromPortEntityRestriction.wireType) &&
        Objects.equals(this.portNetworkCategory, physicalConnectionPowerFromPortEntityRestriction.portNetworkCategory) &&
        Objects.equals(this.portCategory, physicalConnectionPowerFromPortEntityRestriction.portCategory) &&
        Objects.equals(this.socketNo, physicalConnectionPowerFromPortEntityRestriction.socketNo) &&
        Objects.equals(this.medium, physicalConnectionPowerFromPortEntityRestriction.medium) &&
        Objects.equals(this.connector, physicalConnectionPowerFromPortEntityRestriction.connector) &&
        Objects.equals(this.socketSide, physicalConnectionPowerFromPortEntityRestriction.socketSide) &&
        Objects.equals(this.socketSubNo, physicalConnectionPowerFromPortEntityRestriction.socketSubNo) &&
        Objects.equals(this.statusRemark, physicalConnectionPowerFromPortEntityRestriction.statusRemark) &&
        Objects.equals(this.deviceAllId, physicalConnectionPowerFromPortEntityRestriction.deviceAllId) &&
        Objects.equals(this.planPortNetworkCategory, physicalConnectionPowerFromPortEntityRestriction.planPortNetworkCategory) &&
        Objects.equals(this.status, physicalConnectionPowerFromPortEntityRestriction.status);
  }
  ...
  public String toString() {
    ...
    sb.append("class PhysicalConnectionPowerFromPortEntityRestriction {\n");
