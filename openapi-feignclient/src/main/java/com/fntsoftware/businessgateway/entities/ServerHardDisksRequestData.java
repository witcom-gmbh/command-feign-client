...
import com.fntsoftware.businessgateway.entities.ServerHardDisksEntityRestriction;
import com.fntsoftware.businessgateway.entities.ServerHardDisksRelationRestriction;
...
/**
 * ServerHardDisksRequestData
 */
@JsonPropertyOrder({
  ServerHardDisksRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  ServerHardDisksRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  ServerHardDisksRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  ServerHardDisksRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-02-26T11:20:24.990023935Z[Etc/UTC]")
public class ServerHardDisksRequestData {
  ...
  private ServerHardDisksEntityRestriction entityRestrictions;

  public static final String JSON_PROPERTY_RELATION_RESTRICTIONS = "relationRestrictions";
  private ServerHardDisksRelationRestriction relationRestrictions;
  ...
  public ServerHardDisksRequestData() {
  }

  public ServerHardDisksRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public ServerHardDisksRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public ServerHardDisksRequestData entityRestrictions(ServerHardDisksEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public ServerHardDisksEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(ServerHardDisksEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public ServerHardDisksRequestData relationRestrictions(ServerHardDisksRelationRestriction relationRestrictions) {
  ...
  **/
  ...
  public ServerHardDisksRelationRestriction getRelationRestrictions() {
    return relationRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_RELATION_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRelationRestrictions(ServerHardDisksRelationRestriction relationRestrictions) {
    this.relationRestrictions = relationRestrictions;
  }


  public ServerHardDisksRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public ServerHardDisksRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ServerHardDisksRequestData serverHardDisksRequestData = (ServerHardDisksRequestData) o;
    return Objects.equals(this.returnEntityAttributes, serverHardDisksRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, serverHardDisksRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, serverHardDisksRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, serverHardDisksRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class ServerHardDisksRequestData {\n");
