...
import com.fntsoftware.businessgateway.entities.StorageBasePhysicalPortsDataEntityRestriction;
...
/**
 * StorageBasePhysicalPortsDataRequestData
 */
@JsonPropertyOrder({
  StorageBasePhysicalPortsDataRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  StorageBasePhysicalPortsDataRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  StorageBasePhysicalPortsDataRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  StorageBasePhysicalPortsDataRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-01-31T11:10:37.320689708Z[Etc/UTC]")
public class StorageBasePhysicalPortsDataRequestData {
  ...
  private StorageBasePhysicalPortsDataEntityRestriction entityRestrictions;
  ...
  public StorageBasePhysicalPortsDataRequestData() {
  }

  public StorageBasePhysicalPortsDataRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public StorageBasePhysicalPortsDataRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public StorageBasePhysicalPortsDataRequestData entityRestrictions(StorageBasePhysicalPortsDataEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public StorageBasePhysicalPortsDataEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(StorageBasePhysicalPortsDataEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public StorageBasePhysicalPortsDataRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public StorageBasePhysicalPortsDataRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public StorageBasePhysicalPortsDataRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    StorageBasePhysicalPortsDataRequestData storageBasePhysicalPortsDataRequestData = (StorageBasePhysicalPortsDataRequestData) o;
    return Objects.equals(this.returnEntityAttributes, storageBasePhysicalPortsDataRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, storageBasePhysicalPortsDataRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, storageBasePhysicalPortsDataRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, storageBasePhysicalPortsDataRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class StorageBasePhysicalPortsDataRequestData {\n");
