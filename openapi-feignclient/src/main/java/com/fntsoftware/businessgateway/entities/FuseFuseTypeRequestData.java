...
import com.fntsoftware.businessgateway.entities.FuseFuseTypeEntityRestriction;
...
/**
 * FuseFuseTypeRequestData
 */
@JsonPropertyOrder({
  FuseFuseTypeRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  FuseFuseTypeRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  FuseFuseTypeRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  FuseFuseTypeRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-03-04T13:31:32.601557352Z[Etc/UTC]")
public class FuseFuseTypeRequestData {
  ...
  private FuseFuseTypeEntityRestriction entityRestrictions;
  ...
  public FuseFuseTypeRequestData() {
  }

  public FuseFuseTypeRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public FuseFuseTypeRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public FuseFuseTypeRequestData entityRestrictions(FuseFuseTypeEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public FuseFuseTypeEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(FuseFuseTypeEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public FuseFuseTypeRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public FuseFuseTypeRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public FuseFuseTypeRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    FuseFuseTypeRequestData fuseFuseTypeRequestData = (FuseFuseTypeRequestData) o;
    return Objects.equals(this.returnEntityAttributes, fuseFuseTypeRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, fuseFuseTypeRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, fuseFuseTypeRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, fuseFuseTypeRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class FuseFuseTypeRequestData {\n");
