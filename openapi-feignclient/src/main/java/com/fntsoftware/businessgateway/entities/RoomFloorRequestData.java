...
import com.fntsoftware.businessgateway.entities.RoomFloorEntityRestriction;
...
/**
 * RoomFloorRequestData
 */
@JsonPropertyOrder({
  RoomFloorRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  RoomFloorRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  RoomFloorRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  RoomFloorRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-01-31T11:10:37.320689708Z[Etc/UTC]")
public class RoomFloorRequestData {
  ...
  private RoomFloorEntityRestriction entityRestrictions;
  ...
  public RoomFloorRequestData() {
  }

  public RoomFloorRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public RoomFloorRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public RoomFloorRequestData entityRestrictions(RoomFloorEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public RoomFloorEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(RoomFloorEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public RoomFloorRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public RoomFloorRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public RoomFloorRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    RoomFloorRequestData roomFloorRequestData = (RoomFloorRequestData) o;
    return Objects.equals(this.returnEntityAttributes, roomFloorRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, roomFloorRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, roomFloorRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, roomFloorRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class RoomFloorRequestData {\n");
