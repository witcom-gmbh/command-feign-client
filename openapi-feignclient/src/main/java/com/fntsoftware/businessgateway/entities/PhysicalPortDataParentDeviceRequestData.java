...
import com.fntsoftware.businessgateway.entities.PhysicalPortDataParentDeviceEntityRestriction;
...
/**
 * PhysicalPortDataParentDeviceRequestData
 */
@JsonPropertyOrder({
  PhysicalPortDataParentDeviceRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  PhysicalPortDataParentDeviceRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  PhysicalPortDataParentDeviceRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  PhysicalPortDataParentDeviceRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-03-04T13:31:32.601557352Z[Etc/UTC]")
public class PhysicalPortDataParentDeviceRequestData {
  ...
  private PhysicalPortDataParentDeviceEntityRestriction entityRestrictions;
  ...
  public PhysicalPortDataParentDeviceRequestData() {
  }

  public PhysicalPortDataParentDeviceRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public PhysicalPortDataParentDeviceRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public PhysicalPortDataParentDeviceRequestData entityRestrictions(PhysicalPortDataParentDeviceEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public PhysicalPortDataParentDeviceEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(PhysicalPortDataParentDeviceEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public PhysicalPortDataParentDeviceRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public PhysicalPortDataParentDeviceRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public PhysicalPortDataParentDeviceRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    PhysicalPortDataParentDeviceRequestData physicalPortDataParentDeviceRequestData = (PhysicalPortDataParentDeviceRequestData) o;
    return Objects.equals(this.returnEntityAttributes, physicalPortDataParentDeviceRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, physicalPortDataParentDeviceRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, physicalPortDataParentDeviceRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, physicalPortDataParentDeviceRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class PhysicalPortDataParentDeviceRequestData {\n");
