...
/**
 * PhysicalPortDataQueryRestriction
 */
@JsonPropertyOrder({
  PhysicalPortDataQueryRestriction.JSON_PROPERTY_SOCKET_NAME_SPC,
  PhysicalPortDataQueryRestriction.JSON_PROPERTY_BORDER_COLOR,
  PhysicalPortDataQueryRestriction.JSON_PROPERTY_WWN_ADDRESS,
  PhysicalPortDataQueryRestriction.JSON_PROPERTY_NOTES,
  PhysicalPortDataQueryRestriction.JSON_PROPERTY_PORT_STATE,
  PhysicalPortDataQueryRestriction.JSON_PROPERTY_SOCKET_NAME,
  PhysicalPortDataQueryRestriction.JSON_PROPERTY_WIRE_TYPE,
  PhysicalPortDataQueryRestriction.JSON_PROPERTY_MEDIUM,
  PhysicalPortDataQueryRestriction.JSON_PROPERTY_VLAN,
  PhysicalPortDataQueryRestriction.JSON_PROPERTY_SOCKET_SUB_NO,
  PhysicalPortDataQueryRestriction.JSON_PROPERTY_PORT_SPEED,
  PhysicalPortDataQueryRestriction.JSON_PROPERTY_STATUS_REMARK,
  PhysicalPortDataQueryRestriction.JSON_PROPERTY_VLAN_TYPE,
  PhysicalPortDataQueryRestriction.JSON_PROPERTY_DEVICE_ALL_ELID,
  PhysicalPortDataQueryRestriction.JSON_PROPERTY_PORT_IDENTIFIER,
  PhysicalPortDataQueryRestriction.JSON_PROPERTY_VLAN_ID,
  PhysicalPortDataQueryRestriction.JSON_PROPERTY_PORT_NETWORK_CATEGORY,
  PhysicalPortDataQueryRestriction.JSON_PROPERTY_SOCKET_NO,
  PhysicalPortDataQueryRestriction.JSON_PROPERTY_VTP_DOMAIN,
  PhysicalPortDataQueryRestriction.JSON_PROPERTY_CONNECTOR,
  PhysicalPortDataQueryRestriction.JSON_PROPERTY_PORT_DUPLEX,
  PhysicalPortDataQueryRestriction.JSON_PROPERTY_SOCKET_SIDE,
  PhysicalPortDataQueryRestriction.JSON_PROPERTY_DEVICE_ALL_ID,
  PhysicalPortDataQueryRestriction.JSON_PROPERTY_COAX_NET,
  PhysicalPortDataQueryRestriction.JSON_PROPERTY_STATUS
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-01-31T11:10:37.320689708Z[Etc/UTC]")
public class PhysicalPortDataQueryRestriction {
  ...
  public PhysicalPortDataQueryRestriction() {
  }

  public PhysicalPortDataQueryRestriction socketNameSpc(RestrictionsString socketNameSpc) {
  ...
  **/
  ...
  public PhysicalPortDataQueryRestriction borderColor(RestrictionsString borderColor) {
  ...
  **/
  ...
  public PhysicalPortDataQueryRestriction wwnAddress(RestrictionsString wwnAddress) {
  ...
  **/
  ...
  public PhysicalPortDataQueryRestriction notes(RestrictionsString notes) {
  ...
  **/
  ...
  public PhysicalPortDataQueryRestriction portState(RestrictionsString portState) {
  ...
  **/
  ...
  public PhysicalPortDataQueryRestriction socketName(RestrictionsString socketName) {
  ...
  **/
  ...
  public PhysicalPortDataQueryRestriction wireType(RestrictionsString wireType) {
  ...
  **/
  ...
  public PhysicalPortDataQueryRestriction medium(RestrictionsString medium) {
  ...
  **/
  ...
  public PhysicalPortDataQueryRestriction vlan(RestrictionsString vlan) {
  ...
  **/
  ...
  public PhysicalPortDataQueryRestriction socketSubNo(RestrictionsNumeric socketSubNo) {
  ...
  **/
  ...
  public PhysicalPortDataQueryRestriction portSpeed(RestrictionsString portSpeed) {
  ...
  **/
  ...
  public PhysicalPortDataQueryRestriction statusRemark(RestrictionsString statusRemark) {
  ...
  **/
  ...
  public PhysicalPortDataQueryRestriction vlanType(RestrictionsString vlanType) {
  ...
  **/
  ...
  public PhysicalPortDataQueryRestriction deviceAllElid(RestrictionsString deviceAllElid) {
  ...
  **/
  ...
  public PhysicalPortDataQueryRestriction portIdentifier(RestrictionsString portIdentifier) {
  ...
  **/
  ...
  public PhysicalPortDataQueryRestriction vlanId(RestrictionsNumeric vlanId) {
  ...
  **/
  ...
  public PhysicalPortDataQueryRestriction portNetworkCategory(RestrictionsString portNetworkCategory) {
  ...
  **/
  ...
  public PhysicalPortDataQueryRestriction socketNo(RestrictionsNumeric socketNo) {
  ...
  **/
  ...
  public PhysicalPortDataQueryRestriction vtpDomain(RestrictionsString vtpDomain) {
  ...
  **/
  ...
  public PhysicalPortDataQueryRestriction connector(RestrictionsString connector) {
  ...
  **/
  ...
  public PhysicalPortDataQueryRestriction portDuplex(RestrictionsString portDuplex) {
  ...
  **/
  ...
  public PhysicalPortDataQueryRestriction socketSide(RestrictionsString socketSide) {
  ...
  **/
  ...
  public PhysicalPortDataQueryRestriction deviceAllId(RestrictionsString deviceAllId) {
  ...
  **/
  ...
  public PhysicalPortDataQueryRestriction coaxNet(RestrictionsString coaxNet) {
  ...
  **/
  ...
  public PhysicalPortDataQueryRestriction status(RestrictionsString status) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    PhysicalPortDataQueryRestriction physicalPortDataQueryRestriction = (PhysicalPortDataQueryRestriction) o;
    return Objects.equals(this.socketNameSpc, physicalPortDataQueryRestriction.socketNameSpc) &&
        Objects.equals(this.borderColor, physicalPortDataQueryRestriction.borderColor) &&
        Objects.equals(this.wwnAddress, physicalPortDataQueryRestriction.wwnAddress) &&
        Objects.equals(this.notes, physicalPortDataQueryRestriction.notes) &&
        Objects.equals(this.portState, physicalPortDataQueryRestriction.portState) &&
        Objects.equals(this.socketName, physicalPortDataQueryRestriction.socketName) &&
        Objects.equals(this.wireType, physicalPortDataQueryRestriction.wireType) &&
        Objects.equals(this.medium, physicalPortDataQueryRestriction.medium) &&
        Objects.equals(this.vlan, physicalPortDataQueryRestriction.vlan) &&
        Objects.equals(this.socketSubNo, physicalPortDataQueryRestriction.socketSubNo) &&
        Objects.equals(this.portSpeed, physicalPortDataQueryRestriction.portSpeed) &&
        Objects.equals(this.statusRemark, physicalPortDataQueryRestriction.statusRemark) &&
        Objects.equals(this.vlanType, physicalPortDataQueryRestriction.vlanType) &&
        Objects.equals(this.deviceAllElid, physicalPortDataQueryRestriction.deviceAllElid) &&
        Objects.equals(this.portIdentifier, physicalPortDataQueryRestriction.portIdentifier) &&
        Objects.equals(this.vlanId, physicalPortDataQueryRestriction.vlanId) &&
        Objects.equals(this.portNetworkCategory, physicalPortDataQueryRestriction.portNetworkCategory) &&
        Objects.equals(this.socketNo, physicalPortDataQueryRestriction.socketNo) &&
        Objects.equals(this.vtpDomain, physicalPortDataQueryRestriction.vtpDomain) &&
        Objects.equals(this.connector, physicalPortDataQueryRestriction.connector) &&
        Objects.equals(this.portDuplex, physicalPortDataQueryRestriction.portDuplex) &&
        Objects.equals(this.socketSide, physicalPortDataQueryRestriction.socketSide) &&
        Objects.equals(this.deviceAllId, physicalPortDataQueryRestriction.deviceAllId) &&
        Objects.equals(this.coaxNet, physicalPortDataQueryRestriction.coaxNet) &&
        Objects.equals(this.status, physicalPortDataQueryRestriction.status);
  }
  ...
  public String toString() {
    ...
    sb.append("class PhysicalPortDataQueryRestriction {\n");
