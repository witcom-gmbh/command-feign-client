...
/**
 * ServerDevicesAllEntityRestriction
 */
@JsonPropertyOrder({
  ServerDevicesAllEntityRestriction.JSON_PROPERTY_CLIMATE_RELEVANT,
  ServerDevicesAllEntityRestriction.JSON_PROPERTY_POWER_CONSUMPTION,
  ServerDevicesAllEntityRestriction.JSON_PROPERTY_POWER_SWITCHING_STATUS,
  ServerDevicesAllEntityRestriction.JSON_PROPERTY_PLAN_STATUS,
  ServerDevicesAllEntityRestriction.JSON_PROPERTY_SYSTEM_RUNTIME,
  ServerDevicesAllEntityRestriction.JSON_PROPERTY_WEIGHT,
  ServerDevicesAllEntityRestriction.JSON_PROPERTY_REMARK,
  ServerDevicesAllEntityRestriction.JSON_PROPERTY_ELID,
  ServerDevicesAllEntityRestriction.JSON_PROPERTY_LAST_SEEN,
  ServerDevicesAllEntityRestriction.JSON_PROPERTY_TYPE_ELID,
  ServerDevicesAllEntityRestriction.JSON_PROPERTY_VISIBLE_ID,
  ServerDevicesAllEntityRestriction.JSON_PROPERTY_ID,
  ServerDevicesAllEntityRestriction.JSON_PROPERTY_HEAT_EMISSION
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-03-04T13:31:32.601557352Z[Etc/UTC]")
public class ServerDevicesAllEntityRestriction {
  ...
  public ServerDevicesAllEntityRestriction() {
  }

  public ServerDevicesAllEntityRestriction climateRelevant(RestrictionsBoolean climateRelevant) {
  ...
  **/
  ...
  public ServerDevicesAllEntityRestriction powerConsumption(RestrictionsNumeric powerConsumption) {
  ...
  **/
  ...
  public ServerDevicesAllEntityRestriction powerSwitchingStatus(RestrictionsString powerSwitchingStatus) {
  ...
  **/
  ...
  public ServerDevicesAllEntityRestriction planStatus(RestrictionsString planStatus) {
  ...
  **/
  ...
  public ServerDevicesAllEntityRestriction systemRuntime(RestrictionsNumeric systemRuntime) {
  ...
  **/
  ...
  public ServerDevicesAllEntityRestriction weight(RestrictionsNumeric weight) {
  ...
  **/
  ...
  public ServerDevicesAllEntityRestriction remark(RestrictionsString remark) {
  ...
  **/
  ...
  public ServerDevicesAllEntityRestriction elid(RestrictionsString elid) {
  ...
  **/
  ...
  public ServerDevicesAllEntityRestriction lastSeen(RestrictionsDate lastSeen) {
  ...
  **/
  ...
  public ServerDevicesAllEntityRestriction typeElid(RestrictionsString typeElid) {
  ...
  **/
  ...
  public ServerDevicesAllEntityRestriction visibleId(RestrictionsString visibleId) {
  ...
  **/
  ...
  public ServerDevicesAllEntityRestriction id(RestrictionsString id) {
  ...
  **/
  ...
  public ServerDevicesAllEntityRestriction heatEmission(RestrictionsNumeric heatEmission) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ServerDevicesAllEntityRestriction serverDevicesAllEntityRestriction = (ServerDevicesAllEntityRestriction) o;
    return Objects.equals(this.climateRelevant, serverDevicesAllEntityRestriction.climateRelevant) &&
        Objects.equals(this.powerConsumption, serverDevicesAllEntityRestriction.powerConsumption) &&
        Objects.equals(this.powerSwitchingStatus, serverDevicesAllEntityRestriction.powerSwitchingStatus) &&
        Objects.equals(this.planStatus, serverDevicesAllEntityRestriction.planStatus) &&
        Objects.equals(this.systemRuntime, serverDevicesAllEntityRestriction.systemRuntime) &&
        Objects.equals(this.weight, serverDevicesAllEntityRestriction.weight) &&
        Objects.equals(this.remark, serverDevicesAllEntityRestriction.remark) &&
        Objects.equals(this.elid, serverDevicesAllEntityRestriction.elid) &&
        Objects.equals(this.lastSeen, serverDevicesAllEntityRestriction.lastSeen) &&
        Objects.equals(this.typeElid, serverDevicesAllEntityRestriction.typeElid) &&
        Objects.equals(this.visibleId, serverDevicesAllEntityRestriction.visibleId) &&
        Objects.equals(this.id, serverDevicesAllEntityRestriction.id) &&
        Objects.equals(this.heatEmission, serverDevicesAllEntityRestriction.heatEmission);
  }
  ...
  public String toString() {
    ...
    sb.append("class ServerDevicesAllEntityRestriction {\n");
