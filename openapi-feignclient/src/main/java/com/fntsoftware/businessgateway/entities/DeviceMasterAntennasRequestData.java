...
import com.fntsoftware.businessgateway.entities.DeviceMasterAntennasEntityRestriction;
...
/**
 * DeviceMasterAntennasRequestData
 */
@JsonPropertyOrder({
  DeviceMasterAntennasRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  DeviceMasterAntennasRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  DeviceMasterAntennasRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  DeviceMasterAntennasRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-01-31T11:10:37.320689708Z[Etc/UTC]")
public class DeviceMasterAntennasRequestData {
  ...
  private DeviceMasterAntennasEntityRestriction entityRestrictions;
  ...
  public DeviceMasterAntennasRequestData() {
  }

  public DeviceMasterAntennasRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public DeviceMasterAntennasRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public DeviceMasterAntennasRequestData entityRestrictions(DeviceMasterAntennasEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public DeviceMasterAntennasEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(DeviceMasterAntennasEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public DeviceMasterAntennasRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public DeviceMasterAntennasRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public DeviceMasterAntennasRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    DeviceMasterAntennasRequestData deviceMasterAntennasRequestData = (DeviceMasterAntennasRequestData) o;
    return Objects.equals(this.returnEntityAttributes, deviceMasterAntennasRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, deviceMasterAntennasRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, deviceMasterAntennasRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, deviceMasterAntennasRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeviceMasterAntennasRequestData {\n");
