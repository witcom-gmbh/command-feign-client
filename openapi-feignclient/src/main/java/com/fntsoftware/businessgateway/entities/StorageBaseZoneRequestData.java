...
import com.fntsoftware.businessgateway.entities.StorageBaseZoneEntityRestriction;
...
/**
 * StorageBaseZoneRequestData
 */
@JsonPropertyOrder({
  StorageBaseZoneRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  StorageBaseZoneRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  StorageBaseZoneRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  StorageBaseZoneRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-01-31T11:10:37.320689708Z[Etc/UTC]")
public class StorageBaseZoneRequestData {
  ...
  private StorageBaseZoneEntityRestriction entityRestrictions;
  ...
  public StorageBaseZoneRequestData() {
  }

  public StorageBaseZoneRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public StorageBaseZoneRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public StorageBaseZoneRequestData entityRestrictions(StorageBaseZoneEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public StorageBaseZoneEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(StorageBaseZoneEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public StorageBaseZoneRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public StorageBaseZoneRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public StorageBaseZoneRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    StorageBaseZoneRequestData storageBaseZoneRequestData = (StorageBaseZoneRequestData) o;
    return Objects.equals(this.returnEntityAttributes, storageBaseZoneRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, storageBaseZoneRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, storageBaseZoneRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, storageBaseZoneRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class StorageBaseZoneRequestData {\n");
