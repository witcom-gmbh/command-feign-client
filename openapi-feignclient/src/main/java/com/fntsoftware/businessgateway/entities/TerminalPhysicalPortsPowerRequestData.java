...
import com.fntsoftware.businessgateway.entities.TerminalPhysicalPortsPowerEntityRestriction;
...
/**
 * TerminalPhysicalPortsPowerRequestData
 */
@JsonPropertyOrder({
  TerminalPhysicalPortsPowerRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  TerminalPhysicalPortsPowerRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  TerminalPhysicalPortsPowerRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  TerminalPhysicalPortsPowerRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-01-31T11:10:37.320689708Z[Etc/UTC]")
public class TerminalPhysicalPortsPowerRequestData {
  ...
  private TerminalPhysicalPortsPowerEntityRestriction entityRestrictions;
  ...
  public TerminalPhysicalPortsPowerRequestData() {
  }

  public TerminalPhysicalPortsPowerRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public TerminalPhysicalPortsPowerRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public TerminalPhysicalPortsPowerRequestData entityRestrictions(TerminalPhysicalPortsPowerEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public TerminalPhysicalPortsPowerEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(TerminalPhysicalPortsPowerEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public TerminalPhysicalPortsPowerRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public TerminalPhysicalPortsPowerRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public TerminalPhysicalPortsPowerRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    TerminalPhysicalPortsPowerRequestData terminalPhysicalPortsPowerRequestData = (TerminalPhysicalPortsPowerRequestData) o;
    return Objects.equals(this.returnEntityAttributes, terminalPhysicalPortsPowerRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, terminalPhysicalPortsPowerRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, terminalPhysicalPortsPowerRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, terminalPhysicalPortsPowerRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class TerminalPhysicalPortsPowerRequestData {\n");
