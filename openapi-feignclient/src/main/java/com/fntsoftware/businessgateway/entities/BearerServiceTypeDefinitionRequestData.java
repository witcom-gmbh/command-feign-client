...
import com.fntsoftware.businessgateway.entities.BearerServiceTypeDefinitionEntityRestriction;
...
/**
 * BearerServiceTypeDefinitionRequestData
 */
@JsonPropertyOrder({
  BearerServiceTypeDefinitionRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  BearerServiceTypeDefinitionRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  BearerServiceTypeDefinitionRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  BearerServiceTypeDefinitionRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-01-31T11:10:37.320689708Z[Etc/UTC]")
public class BearerServiceTypeDefinitionRequestData {
  ...
  private BearerServiceTypeDefinitionEntityRestriction entityRestrictions;
  ...
  public BearerServiceTypeDefinitionRequestData() {
  }

  public BearerServiceTypeDefinitionRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public BearerServiceTypeDefinitionRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public BearerServiceTypeDefinitionRequestData entityRestrictions(BearerServiceTypeDefinitionEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public BearerServiceTypeDefinitionEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(BearerServiceTypeDefinitionEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public BearerServiceTypeDefinitionRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public BearerServiceTypeDefinitionRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public BearerServiceTypeDefinitionRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    BearerServiceTypeDefinitionRequestData bearerServiceTypeDefinitionRequestData = (BearerServiceTypeDefinitionRequestData) o;
    return Objects.equals(this.returnEntityAttributes, bearerServiceTypeDefinitionRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, bearerServiceTypeDefinitionRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, bearerServiceTypeDefinitionRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, bearerServiceTypeDefinitionRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class BearerServiceTypeDefinitionRequestData {\n");
