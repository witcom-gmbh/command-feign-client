...
/**
 * PduPhysicalPortsPowerEntityRestriction
 */
@JsonPropertyOrder({
  PduPhysicalPortsPowerEntityRestriction.JSON_PROPERTY_SOCKET_NAME_SPC,
  PduPhysicalPortsPowerEntityRestriction.JSON_PROPERTY_BORDER_COLOR,
  PduPhysicalPortsPowerEntityRestriction.JSON_PROPERTY_DEVICE_ALL_ELID,
  PduPhysicalPortsPowerEntityRestriction.JSON_PROPERTY_SOCKET_NAME,
  PduPhysicalPortsPowerEntityRestriction.JSON_PROPERTY_PORT_IDENTIFIER,
  PduPhysicalPortsPowerEntityRestriction.JSON_PROPERTY_WIRE_TYPE,
  PduPhysicalPortsPowerEntityRestriction.JSON_PROPERTY_PORT_NETWORK_CATEGORY,
  PduPhysicalPortsPowerEntityRestriction.JSON_PROPERTY_PORT_CATEGORY,
  PduPhysicalPortsPowerEntityRestriction.JSON_PROPERTY_SOCKET_NO,
  PduPhysicalPortsPowerEntityRestriction.JSON_PROPERTY_MEDIUM,
  PduPhysicalPortsPowerEntityRestriction.JSON_PROPERTY_CONNECTOR,
  PduPhysicalPortsPowerEntityRestriction.JSON_PROPERTY_SOCKET_SIDE,
  PduPhysicalPortsPowerEntityRestriction.JSON_PROPERTY_SOCKET_SUB_NO,
  PduPhysicalPortsPowerEntityRestriction.JSON_PROPERTY_STATUS_REMARK,
  PduPhysicalPortsPowerEntityRestriction.JSON_PROPERTY_DEVICE_ALL_ID,
  PduPhysicalPortsPowerEntityRestriction.JSON_PROPERTY_PLAN_PORT_NETWORK_CATEGORY,
  PduPhysicalPortsPowerEntityRestriction.JSON_PROPERTY_STATUS
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-02-26T11:20:24.990023935Z[Etc/UTC]")
public class PduPhysicalPortsPowerEntityRestriction {
  ...
  public PduPhysicalPortsPowerEntityRestriction() {
  }

  public PduPhysicalPortsPowerEntityRestriction socketNameSpc(RestrictionsString socketNameSpc) {
  ...
  **/
  ...
  public PduPhysicalPortsPowerEntityRestriction borderColor(RestrictionsString borderColor) {
  ...
  **/
  ...
  public PduPhysicalPortsPowerEntityRestriction deviceAllElid(RestrictionsString deviceAllElid) {
  ...
  **/
  ...
  public PduPhysicalPortsPowerEntityRestriction socketName(RestrictionsString socketName) {
  ...
  **/
  ...
  public PduPhysicalPortsPowerEntityRestriction portIdentifier(RestrictionsString portIdentifier) {
  ...
  **/
  ...
  public PduPhysicalPortsPowerEntityRestriction wireType(RestrictionsString wireType) {
  ...
  **/
  ...
  public PduPhysicalPortsPowerEntityRestriction portNetworkCategory(RestrictionsString portNetworkCategory) {
  ...
  **/
  ...
  public PduPhysicalPortsPowerEntityRestriction portCategory(RestrictionsString portCategory) {
  ...
  **/
  ...
  public PduPhysicalPortsPowerEntityRestriction socketNo(RestrictionsNumeric socketNo) {
  ...
  **/
  ...
  public PduPhysicalPortsPowerEntityRestriction medium(RestrictionsString medium) {
  ...
  **/
  ...
  public PduPhysicalPortsPowerEntityRestriction connector(RestrictionsString connector) {
  ...
  **/
  ...
  public PduPhysicalPortsPowerEntityRestriction socketSide(RestrictionsString socketSide) {
  ...
  **/
  ...
  public PduPhysicalPortsPowerEntityRestriction socketSubNo(RestrictionsNumeric socketSubNo) {
  ...
  **/
  ...
  public PduPhysicalPortsPowerEntityRestriction statusRemark(RestrictionsString statusRemark) {
  ...
  **/
  ...
  public PduPhysicalPortsPowerEntityRestriction deviceAllId(RestrictionsString deviceAllId) {
  ...
  **/
  ...
  public PduPhysicalPortsPowerEntityRestriction planPortNetworkCategory(RestrictionsString planPortNetworkCategory) {
  ...
  **/
  ...
  public PduPhysicalPortsPowerEntityRestriction status(RestrictionsString status) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    PduPhysicalPortsPowerEntityRestriction pduPhysicalPortsPowerEntityRestriction = (PduPhysicalPortsPowerEntityRestriction) o;
    return Objects.equals(this.socketNameSpc, pduPhysicalPortsPowerEntityRestriction.socketNameSpc) &&
        Objects.equals(this.borderColor, pduPhysicalPortsPowerEntityRestriction.borderColor) &&
        Objects.equals(this.deviceAllElid, pduPhysicalPortsPowerEntityRestriction.deviceAllElid) &&
        Objects.equals(this.socketName, pduPhysicalPortsPowerEntityRestriction.socketName) &&
        Objects.equals(this.portIdentifier, pduPhysicalPortsPowerEntityRestriction.portIdentifier) &&
        Objects.equals(this.wireType, pduPhysicalPortsPowerEntityRestriction.wireType) &&
        Objects.equals(this.portNetworkCategory, pduPhysicalPortsPowerEntityRestriction.portNetworkCategory) &&
        Objects.equals(this.portCategory, pduPhysicalPortsPowerEntityRestriction.portCategory) &&
        Objects.equals(this.socketNo, pduPhysicalPortsPowerEntityRestriction.socketNo) &&
        Objects.equals(this.medium, pduPhysicalPortsPowerEntityRestriction.medium) &&
        Objects.equals(this.connector, pduPhysicalPortsPowerEntityRestriction.connector) &&
        Objects.equals(this.socketSide, pduPhysicalPortsPowerEntityRestriction.socketSide) &&
        Objects.equals(this.socketSubNo, pduPhysicalPortsPowerEntityRestriction.socketSubNo) &&
        Objects.equals(this.statusRemark, pduPhysicalPortsPowerEntityRestriction.statusRemark) &&
        Objects.equals(this.deviceAllId, pduPhysicalPortsPowerEntityRestriction.deviceAllId) &&
        Objects.equals(this.planPortNetworkCategory, pduPhysicalPortsPowerEntityRestriction.planPortNetworkCategory) &&
        Objects.equals(this.status, pduPhysicalPortsPowerEntityRestriction.status);
  }
  ...
  public String toString() {
    ...
    sb.append("class PduPhysicalPortsPowerEntityRestriction {\n");
