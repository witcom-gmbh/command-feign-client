...
/**
 * AntennaSlotEntityRestriction
 */
@JsonPropertyOrder({
  AntennaSlotEntityRestriction.JSON_PROPERTY_CLIMATE_RELEVANT,
  AntennaSlotEntityRestriction.JSON_PROPERTY_POWER_CONSUMPTION,
  AntennaSlotEntityRestriction.JSON_PROPERTY_POWER_SWITCHING_STATUS,
  AntennaSlotEntityRestriction.JSON_PROPERTY_PLAN_STATUS,
  AntennaSlotEntityRestriction.JSON_PROPERTY_SYSTEM_RUNTIME,
  AntennaSlotEntityRestriction.JSON_PROPERTY_WEIGHT,
  AntennaSlotEntityRestriction.JSON_PROPERTY_REMARK,
  AntennaSlotEntityRestriction.JSON_PROPERTY_ELID,
  AntennaSlotEntityRestriction.JSON_PROPERTY_LAST_SEEN,
  AntennaSlotEntityRestriction.JSON_PROPERTY_TYPE_ELID,
  AntennaSlotEntityRestriction.JSON_PROPERTY_VISIBLE_ID,
  AntennaSlotEntityRestriction.JSON_PROPERTY_ID,
  AntennaSlotEntityRestriction.JSON_PROPERTY_HEAT_EMISSION
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-01-31T11:10:37.320689708Z[Etc/UTC]")
public class AntennaSlotEntityRestriction {
  ...
  public AntennaSlotEntityRestriction() {
  }

  public AntennaSlotEntityRestriction climateRelevant(RestrictionsBoolean climateRelevant) {
  ...
  **/
  ...
  public AntennaSlotEntityRestriction powerConsumption(RestrictionsNumeric powerConsumption) {
  ...
  **/
  ...
  public AntennaSlotEntityRestriction powerSwitchingStatus(RestrictionsString powerSwitchingStatus) {
  ...
  **/
  ...
  public AntennaSlotEntityRestriction planStatus(RestrictionsString planStatus) {
  ...
  **/
  ...
  public AntennaSlotEntityRestriction systemRuntime(RestrictionsNumeric systemRuntime) {
  ...
  **/
  ...
  public AntennaSlotEntityRestriction weight(RestrictionsNumeric weight) {
  ...
  **/
  ...
  public AntennaSlotEntityRestriction remark(RestrictionsString remark) {
  ...
  **/
  ...
  public AntennaSlotEntityRestriction elid(RestrictionsString elid) {
  ...
  **/
  ...
  public AntennaSlotEntityRestriction lastSeen(RestrictionsDate lastSeen) {
  ...
  **/
  ...
  public AntennaSlotEntityRestriction typeElid(RestrictionsString typeElid) {
  ...
  **/
  ...
  public AntennaSlotEntityRestriction visibleId(RestrictionsString visibleId) {
  ...
  **/
  ...
  public AntennaSlotEntityRestriction id(RestrictionsString id) {
  ...
  **/
  ...
  public AntennaSlotEntityRestriction heatEmission(RestrictionsNumeric heatEmission) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    AntennaSlotEntityRestriction antennaSlotEntityRestriction = (AntennaSlotEntityRestriction) o;
    return Objects.equals(this.climateRelevant, antennaSlotEntityRestriction.climateRelevant) &&
        Objects.equals(this.powerConsumption, antennaSlotEntityRestriction.powerConsumption) &&
        Objects.equals(this.powerSwitchingStatus, antennaSlotEntityRestriction.powerSwitchingStatus) &&
        Objects.equals(this.planStatus, antennaSlotEntityRestriction.planStatus) &&
        Objects.equals(this.systemRuntime, antennaSlotEntityRestriction.systemRuntime) &&
        Objects.equals(this.weight, antennaSlotEntityRestriction.weight) &&
        Objects.equals(this.remark, antennaSlotEntityRestriction.remark) &&
        Objects.equals(this.elid, antennaSlotEntityRestriction.elid) &&
        Objects.equals(this.lastSeen, antennaSlotEntityRestriction.lastSeen) &&
        Objects.equals(this.typeElid, antennaSlotEntityRestriction.typeElid) &&
        Objects.equals(this.visibleId, antennaSlotEntityRestriction.visibleId) &&
        Objects.equals(this.id, antennaSlotEntityRestriction.id) &&
        Objects.equals(this.heatEmission, antennaSlotEntityRestriction.heatEmission);
  }
  ...
  public String toString() {
    ...
    sb.append("class AntennaSlotEntityRestriction {\n");
