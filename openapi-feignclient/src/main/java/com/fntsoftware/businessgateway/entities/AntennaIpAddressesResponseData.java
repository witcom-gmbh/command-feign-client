...
/**
 * AntennaIpAddressesResponseData
 */
@JsonPropertyOrder({
  AntennaIpAddressesResponseData.JSON_PROPERTY_ASSIGNED_DIRECTLY,
  AntennaIpAddressesResponseData.JSON_PROPERTY_INTERFACE,
  AntennaIpAddressesResponseData.JSON_PROPERTY_PORTS,
  AntennaIpAddressesResponseData.JSON_PROPERTY_OBJECT_ELID,
  AntennaIpAddressesResponseData.JSON_PROPERTY_OBJECT_ID
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-03-04T13:31:32.601557352Z[Etc/UTC]")
public class AntennaIpAddressesResponseData {
  ...
  public AntennaIpAddressesResponseData() {
  }

  public AntennaIpAddressesResponseData assignedDirectly(Boolean assignedDirectly) {
  ...
  **/
  ...
  public AntennaIpAddressesResponseData _interface(InterfaceinterfaceWithAddressData _interface) {
  ...
  **/
  ...
  public AntennaIpAddressesResponseData ports(List<PhysicalPortDataphysicalPortDataInfo> ports) {
    
    this.ports = ports;
    return this;
  }

  public AntennaIpAddressesResponseData addPortsItem(PhysicalPortDataphysicalPortDataInfo portsItem) {
    if (this.ports == null) {
  ...
  **/
  ...
  public AntennaIpAddressesResponseData objectElid(String objectElid) {
  ...
  **/
  ...
  public AntennaIpAddressesResponseData objectId(String objectId) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    AntennaIpAddressesResponseData antennaIpAddressesResponseData = (AntennaIpAddressesResponseData) o;
    return Objects.equals(this.assignedDirectly, antennaIpAddressesResponseData.assignedDirectly) &&
        Objects.equals(this._interface, antennaIpAddressesResponseData._interface) &&
        Objects.equals(this.ports, antennaIpAddressesResponseData.ports) &&
        Objects.equals(this.objectElid, antennaIpAddressesResponseData.objectElid) &&
        Objects.equals(this.objectId, antennaIpAddressesResponseData.objectId);
  }
  ...
  public String toString() {
    ...
    sb.append("class AntennaIpAddressesResponseData {\n");
