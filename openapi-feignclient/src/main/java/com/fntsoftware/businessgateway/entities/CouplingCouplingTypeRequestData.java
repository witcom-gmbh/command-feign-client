...
import com.fntsoftware.businessgateway.entities.CouplingCouplingTypeEntityRestriction;
...
/**
 * CouplingCouplingTypeRequestData
 */
@JsonPropertyOrder({
  CouplingCouplingTypeRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  CouplingCouplingTypeRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  CouplingCouplingTypeRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  CouplingCouplingTypeRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-01-31T11:10:37.320689708Z[Etc/UTC]")
public class CouplingCouplingTypeRequestData {
  ...
  private CouplingCouplingTypeEntityRestriction entityRestrictions;
  ...
  public CouplingCouplingTypeRequestData() {
  }

  public CouplingCouplingTypeRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public CouplingCouplingTypeRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public CouplingCouplingTypeRequestData entityRestrictions(CouplingCouplingTypeEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public CouplingCouplingTypeEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(CouplingCouplingTypeEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public CouplingCouplingTypeRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public CouplingCouplingTypeRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public CouplingCouplingTypeRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    CouplingCouplingTypeRequestData couplingCouplingTypeRequestData = (CouplingCouplingTypeRequestData) o;
    return Objects.equals(this.returnEntityAttributes, couplingCouplingTypeRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, couplingCouplingTypeRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, couplingCouplingTypeRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, couplingCouplingTypeRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class CouplingCouplingTypeRequestData {\n");
