...
/**
 * DeleteAntennaRequestData
 */
@JsonPropertyOrder({
  DeleteAntennaRequestData.JSON_PROPERTY_RELEASE_SIGNALPATH,
  DeleteAntennaRequestData.JSON_PROPERTY_RELEASE_CONNECTIONS,
  DeleteAntennaRequestData.JSON_PROPERTY_RELEASE_SERVICE,
  DeleteAntennaRequestData.JSON_PROPERTY_CONTEXT_ID,
  DeleteAntennaRequestData.JSON_PROPERTY_RELEASE_PATCHES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-02-26T11:20:24.990023935Z[Etc/UTC]")
public class DeleteAntennaRequestData {
  ...
  public DeleteAntennaRequestData() {
  }

  public DeleteAntennaRequestData releaseSignalpath(Boolean releaseSignalpath) {
  ...
  **/
  ...
  public DeleteAntennaRequestData releaseConnections(Boolean releaseConnections) {
  ...
  **/
  ...
  public DeleteAntennaRequestData releaseService(Boolean releaseService) {
  ...
  **/
  ...
  public DeleteAntennaRequestData contextId(String contextId) {
  ...
  **/
  ...
  public DeleteAntennaRequestData releasePatches(Boolean releasePatches) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    DeleteAntennaRequestData deleteAntennaRequestData = (DeleteAntennaRequestData) o;
    return Objects.equals(this.releaseSignalpath, deleteAntennaRequestData.releaseSignalpath) &&
        Objects.equals(this.releaseConnections, deleteAntennaRequestData.releaseConnections) &&
        Objects.equals(this.releaseService, deleteAntennaRequestData.releaseService) &&
        Objects.equals(this.contextId, deleteAntennaRequestData.contextId) &&
        Objects.equals(this.releasePatches, deleteAntennaRequestData.releasePatches);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeleteAntennaRequestData {\n");
