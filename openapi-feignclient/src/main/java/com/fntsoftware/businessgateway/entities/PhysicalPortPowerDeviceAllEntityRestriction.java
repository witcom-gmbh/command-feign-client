...
/**
 * PhysicalPortPowerDeviceAllEntityRestriction
 */
@JsonPropertyOrder({
  PhysicalPortPowerDeviceAllEntityRestriction.JSON_PROPERTY_CLIMATE_RELEVANT,
  PhysicalPortPowerDeviceAllEntityRestriction.JSON_PROPERTY_POWER_CONSUMPTION,
  PhysicalPortPowerDeviceAllEntityRestriction.JSON_PROPERTY_POWER_SWITCHING_STATUS,
  PhysicalPortPowerDeviceAllEntityRestriction.JSON_PROPERTY_PLAN_STATUS,
  PhysicalPortPowerDeviceAllEntityRestriction.JSON_PROPERTY_SYSTEM_RUNTIME,
  PhysicalPortPowerDeviceAllEntityRestriction.JSON_PROPERTY_WEIGHT,
  PhysicalPortPowerDeviceAllEntityRestriction.JSON_PROPERTY_REMARK,
  PhysicalPortPowerDeviceAllEntityRestriction.JSON_PROPERTY_ELID,
  PhysicalPortPowerDeviceAllEntityRestriction.JSON_PROPERTY_LAST_SEEN,
  PhysicalPortPowerDeviceAllEntityRestriction.JSON_PROPERTY_TYPE_ELID,
  PhysicalPortPowerDeviceAllEntityRestriction.JSON_PROPERTY_VISIBLE_ID,
  PhysicalPortPowerDeviceAllEntityRestriction.JSON_PROPERTY_ID,
  PhysicalPortPowerDeviceAllEntityRestriction.JSON_PROPERTY_HEAT_EMISSION
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-01-31T11:10:37.320689708Z[Etc/UTC]")
public class PhysicalPortPowerDeviceAllEntityRestriction {
  ...
  public PhysicalPortPowerDeviceAllEntityRestriction() {
  }

  public PhysicalPortPowerDeviceAllEntityRestriction climateRelevant(RestrictionsBoolean climateRelevant) {
  ...
  **/
  ...
  public PhysicalPortPowerDeviceAllEntityRestriction powerConsumption(RestrictionsNumeric powerConsumption) {
  ...
  **/
  ...
  public PhysicalPortPowerDeviceAllEntityRestriction powerSwitchingStatus(RestrictionsString powerSwitchingStatus) {
  ...
  **/
  ...
  public PhysicalPortPowerDeviceAllEntityRestriction planStatus(RestrictionsString planStatus) {
  ...
  **/
  ...
  public PhysicalPortPowerDeviceAllEntityRestriction systemRuntime(RestrictionsNumeric systemRuntime) {
  ...
  **/
  ...
  public PhysicalPortPowerDeviceAllEntityRestriction weight(RestrictionsNumeric weight) {
  ...
  **/
  ...
  public PhysicalPortPowerDeviceAllEntityRestriction remark(RestrictionsString remark) {
  ...
  **/
  ...
  public PhysicalPortPowerDeviceAllEntityRestriction elid(RestrictionsString elid) {
  ...
  **/
  ...
  public PhysicalPortPowerDeviceAllEntityRestriction lastSeen(RestrictionsDate lastSeen) {
  ...
  **/
  ...
  public PhysicalPortPowerDeviceAllEntityRestriction typeElid(RestrictionsString typeElid) {
  ...
  **/
  ...
  public PhysicalPortPowerDeviceAllEntityRestriction visibleId(RestrictionsString visibleId) {
  ...
  **/
  ...
  public PhysicalPortPowerDeviceAllEntityRestriction id(RestrictionsString id) {
  ...
  **/
  ...
  public PhysicalPortPowerDeviceAllEntityRestriction heatEmission(RestrictionsNumeric heatEmission) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    PhysicalPortPowerDeviceAllEntityRestriction physicalPortPowerDeviceAllEntityRestriction = (PhysicalPortPowerDeviceAllEntityRestriction) o;
    return Objects.equals(this.climateRelevant, physicalPortPowerDeviceAllEntityRestriction.climateRelevant) &&
        Objects.equals(this.powerConsumption, physicalPortPowerDeviceAllEntityRestriction.powerConsumption) &&
        Objects.equals(this.powerSwitchingStatus, physicalPortPowerDeviceAllEntityRestriction.powerSwitchingStatus) &&
        Objects.equals(this.planStatus, physicalPortPowerDeviceAllEntityRestriction.planStatus) &&
        Objects.equals(this.systemRuntime, physicalPortPowerDeviceAllEntityRestriction.systemRuntime) &&
        Objects.equals(this.weight, physicalPortPowerDeviceAllEntityRestriction.weight) &&
        Objects.equals(this.remark, physicalPortPowerDeviceAllEntityRestriction.remark) &&
        Objects.equals(this.elid, physicalPortPowerDeviceAllEntityRestriction.elid) &&
        Objects.equals(this.lastSeen, physicalPortPowerDeviceAllEntityRestriction.lastSeen) &&
        Objects.equals(this.typeElid, physicalPortPowerDeviceAllEntityRestriction.typeElid) &&
        Objects.equals(this.visibleId, physicalPortPowerDeviceAllEntityRestriction.visibleId) &&
        Objects.equals(this.id, physicalPortPowerDeviceAllEntityRestriction.id) &&
        Objects.equals(this.heatEmission, physicalPortPowerDeviceAllEntityRestriction.heatEmission);
  }
  ...
  public String toString() {
    ...
    sb.append("class PhysicalPortPowerDeviceAllEntityRestriction {\n");
