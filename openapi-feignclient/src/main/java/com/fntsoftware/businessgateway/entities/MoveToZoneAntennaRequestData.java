...
import com.fntsoftware.businessgateway.entities.MoveToZoneAntennaCreateLinkZoneRequestData;
import com.fasterxml.jackson.annotation.JsonPropertyOrder;
import com.fasterxml.jackson.annotation.JsonTypeName;

/**
 * MoveToZoneAntennaRequestData
 */
@JsonPropertyOrder({
  MoveToZoneAntennaRequestData.JSON_PROPERTY_RELEASE_SIGNALPATH,
  MoveToZoneAntennaRequestData.JSON_PROPERTY_RELEASE_CONNECTIONS,
  MoveToZoneAntennaRequestData.JSON_PROPERTY_RELEASE_SERVICE,
  MoveToZoneAntennaRequestData.JSON_PROPERTY_RELEASE_SUPPORTS,
  MoveToZoneAntennaRequestData.JSON_PROPERTY_RELEASE_PATCHES,
  MoveToZoneAntennaRequestData.JSON_PROPERTY_CREATE_LINK_ZONE
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-02-26T11:20:24.990023935Z[Etc/UTC]")
public class MoveToZoneAntennaRequestData {
  ...
  private MoveToZoneAntennaCreateLinkZoneRequestData createLinkZone;

  public MoveToZoneAntennaRequestData() {
  }

  public MoveToZoneAntennaRequestData releaseSignalpath(Boolean releaseSignalpath) {
  ...
  **/
  ...
  public MoveToZoneAntennaRequestData releaseConnections(Boolean releaseConnections) {
  ...
  **/
  ...
  public MoveToZoneAntennaRequestData releaseService(Boolean releaseService) {
  ...
  **/
  ...
  public MoveToZoneAntennaRequestData releaseSupports(Boolean releaseSupports) {
  ...
  **/
  ...
  public MoveToZoneAntennaRequestData releasePatches(Boolean releasePatches) {
  ...
  **/
  ...
  public MoveToZoneAntennaRequestData createLinkZone(MoveToZoneAntennaCreateLinkZoneRequestData createLinkZone) {
  ...
  **/
  ...
  public MoveToZoneAntennaCreateLinkZoneRequestData getCreateLinkZone() {
    return createLinkZone;
  }
  ...
  @JsonProperty(JSON_PROPERTY_CREATE_LINK_ZONE)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setCreateLinkZone(MoveToZoneAntennaCreateLinkZoneRequestData createLinkZone) {
    this.createLinkZone = createLinkZone;
  }
  ...
  public boolean equals(Object o) {
    ...
    MoveToZoneAntennaRequestData moveToZoneAntennaRequestData = (MoveToZoneAntennaRequestData) o;
    return Objects.equals(this.releaseSignalpath, moveToZoneAntennaRequestData.releaseSignalpath) &&
        Objects.equals(this.releaseConnections, moveToZoneAntennaRequestData.releaseConnections) &&
        Objects.equals(this.releaseService, moveToZoneAntennaRequestData.releaseService) &&
        Objects.equals(this.releaseSupports, moveToZoneAntennaRequestData.releaseSupports) &&
        Objects.equals(this.releasePatches, moveToZoneAntennaRequestData.releasePatches) &&
        Objects.equals(this.createLinkZone, moveToZoneAntennaRequestData.createLinkZone);
  }
  ...
  public String toString() {
    ...
    sb.append("class MoveToZoneAntennaRequestData {\n");
