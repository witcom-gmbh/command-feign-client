...
import com.fntsoftware.businessgateway.entities.FileSystemServerEntityRestriction;
...
/**
 * FileSystemServerRequestData
 */
@JsonPropertyOrder({
  FileSystemServerRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  FileSystemServerRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  FileSystemServerRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  FileSystemServerRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-03-04T13:31:32.601557352Z[Etc/UTC]")
public class FileSystemServerRequestData {
  ...
  private FileSystemServerEntityRestriction entityRestrictions;
  ...
  public FileSystemServerRequestData() {
  }

  public FileSystemServerRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public FileSystemServerRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public FileSystemServerRequestData entityRestrictions(FileSystemServerEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public FileSystemServerEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(FileSystemServerEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public FileSystemServerRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public FileSystemServerRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public FileSystemServerRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    FileSystemServerRequestData fileSystemServerRequestData = (FileSystemServerRequestData) o;
    return Objects.equals(this.returnEntityAttributes, fileSystemServerRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, fileSystemServerRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, fileSystemServerRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, fileSystemServerRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class FileSystemServerRequestData {\n");
