...
import com.fntsoftware.businessgateway.entities.VlanVlanPoolEntityRestriction;
...
/**
 * VlanVlanPoolRequestData
 */
@JsonPropertyOrder({
  VlanVlanPoolRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  VlanVlanPoolRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  VlanVlanPoolRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  VlanVlanPoolRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-02-26T11:20:24.990023935Z[Etc/UTC]")
public class VlanVlanPoolRequestData {
  ...
  private VlanVlanPoolEntityRestriction entityRestrictions;
  ...
  public VlanVlanPoolRequestData() {
  }

  public VlanVlanPoolRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public VlanVlanPoolRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public VlanVlanPoolRequestData entityRestrictions(VlanVlanPoolEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public VlanVlanPoolEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(VlanVlanPoolEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public VlanVlanPoolRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public VlanVlanPoolRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public VlanVlanPoolRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    VlanVlanPoolRequestData vlanVlanPoolRequestData = (VlanVlanPoolRequestData) o;
    return Objects.equals(this.returnEntityAttributes, vlanVlanPoolRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, vlanVlanPoolRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, vlanVlanPoolRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, vlanVlanPoolRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class VlanVlanPoolRequestData {\n");
