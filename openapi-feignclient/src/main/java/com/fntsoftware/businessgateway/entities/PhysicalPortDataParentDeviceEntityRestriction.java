...
/**
 * PhysicalPortDataParentDeviceEntityRestriction
 */
@JsonPropertyOrder({
  PhysicalPortDataParentDeviceEntityRestriction.JSON_PROPERTY_CLIMATE_RELEVANT,
  PhysicalPortDataParentDeviceEntityRestriction.JSON_PROPERTY_POWER_CONSUMPTION,
  PhysicalPortDataParentDeviceEntityRestriction.JSON_PROPERTY_POWER_SWITCHING_STATUS,
  PhysicalPortDataParentDeviceEntityRestriction.JSON_PROPERTY_PLAN_STATUS,
  PhysicalPortDataParentDeviceEntityRestriction.JSON_PROPERTY_SYSTEM_RUNTIME,
  PhysicalPortDataParentDeviceEntityRestriction.JSON_PROPERTY_WEIGHT,
  PhysicalPortDataParentDeviceEntityRestriction.JSON_PROPERTY_REMARK,
  PhysicalPortDataParentDeviceEntityRestriction.JSON_PROPERTY_ELID,
  PhysicalPortDataParentDeviceEntityRestriction.JSON_PROPERTY_LAST_SEEN,
  PhysicalPortDataParentDeviceEntityRestriction.JSON_PROPERTY_TYPE_ELID,
  PhysicalPortDataParentDeviceEntityRestriction.JSON_PROPERTY_VISIBLE_ID,
  PhysicalPortDataParentDeviceEntityRestriction.JSON_PROPERTY_ID,
  PhysicalPortDataParentDeviceEntityRestriction.JSON_PROPERTY_HEAT_EMISSION
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-03-04T13:31:32.601557352Z[Etc/UTC]")
public class PhysicalPortDataParentDeviceEntityRestriction {
  ...
  public PhysicalPortDataParentDeviceEntityRestriction() {
  }

  public PhysicalPortDataParentDeviceEntityRestriction climateRelevant(RestrictionsBoolean climateRelevant) {
  ...
  **/
  ...
  public PhysicalPortDataParentDeviceEntityRestriction powerConsumption(RestrictionsNumeric powerConsumption) {
  ...
  **/
  ...
  public PhysicalPortDataParentDeviceEntityRestriction powerSwitchingStatus(RestrictionsString powerSwitchingStatus) {
  ...
  **/
  ...
  public PhysicalPortDataParentDeviceEntityRestriction planStatus(RestrictionsString planStatus) {
  ...
  **/
  ...
  public PhysicalPortDataParentDeviceEntityRestriction systemRuntime(RestrictionsNumeric systemRuntime) {
  ...
  **/
  ...
  public PhysicalPortDataParentDeviceEntityRestriction weight(RestrictionsNumeric weight) {
  ...
  **/
  ...
  public PhysicalPortDataParentDeviceEntityRestriction remark(RestrictionsString remark) {
  ...
  **/
  ...
  public PhysicalPortDataParentDeviceEntityRestriction elid(RestrictionsString elid) {
  ...
  **/
  ...
  public PhysicalPortDataParentDeviceEntityRestriction lastSeen(RestrictionsDate lastSeen) {
  ...
  **/
  ...
  public PhysicalPortDataParentDeviceEntityRestriction typeElid(RestrictionsString typeElid) {
  ...
  **/
  ...
  public PhysicalPortDataParentDeviceEntityRestriction visibleId(RestrictionsString visibleId) {
  ...
  **/
  ...
  public PhysicalPortDataParentDeviceEntityRestriction id(RestrictionsString id) {
  ...
  **/
  ...
  public PhysicalPortDataParentDeviceEntityRestriction heatEmission(RestrictionsNumeric heatEmission) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    PhysicalPortDataParentDeviceEntityRestriction physicalPortDataParentDeviceEntityRestriction = (PhysicalPortDataParentDeviceEntityRestriction) o;
    return Objects.equals(this.climateRelevant, physicalPortDataParentDeviceEntityRestriction.climateRelevant) &&
        Objects.equals(this.powerConsumption, physicalPortDataParentDeviceEntityRestriction.powerConsumption) &&
        Objects.equals(this.powerSwitchingStatus, physicalPortDataParentDeviceEntityRestriction.powerSwitchingStatus) &&
        Objects.equals(this.planStatus, physicalPortDataParentDeviceEntityRestriction.planStatus) &&
        Objects.equals(this.systemRuntime, physicalPortDataParentDeviceEntityRestriction.systemRuntime) &&
        Objects.equals(this.weight, physicalPortDataParentDeviceEntityRestriction.weight) &&
        Objects.equals(this.remark, physicalPortDataParentDeviceEntityRestriction.remark) &&
        Objects.equals(this.elid, physicalPortDataParentDeviceEntityRestriction.elid) &&
        Objects.equals(this.lastSeen, physicalPortDataParentDeviceEntityRestriction.lastSeen) &&
        Objects.equals(this.typeElid, physicalPortDataParentDeviceEntityRestriction.typeElid) &&
        Objects.equals(this.visibleId, physicalPortDataParentDeviceEntityRestriction.visibleId) &&
        Objects.equals(this.id, physicalPortDataParentDeviceEntityRestriction.id) &&
        Objects.equals(this.heatEmission, physicalPortDataParentDeviceEntityRestriction.heatEmission);
  }
  ...
  public String toString() {
    ...
    sb.append("class PhysicalPortDataParentDeviceEntityRestriction {\n");
