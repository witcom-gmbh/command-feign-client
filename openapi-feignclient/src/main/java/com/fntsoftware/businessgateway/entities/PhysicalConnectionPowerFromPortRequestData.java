...
import com.fntsoftware.businessgateway.entities.PhysicalConnectionPowerFromPortEntityRestriction;
...
/**
 * PhysicalConnectionPowerFromPortRequestData
 */
@JsonPropertyOrder({
  PhysicalConnectionPowerFromPortRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  PhysicalConnectionPowerFromPortRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  PhysicalConnectionPowerFromPortRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  PhysicalConnectionPowerFromPortRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-02-26T11:20:24.990023935Z[Etc/UTC]")
public class PhysicalConnectionPowerFromPortRequestData {
  ...
  private PhysicalConnectionPowerFromPortEntityRestriction entityRestrictions;
  ...
  public PhysicalConnectionPowerFromPortRequestData() {
  }

  public PhysicalConnectionPowerFromPortRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public PhysicalConnectionPowerFromPortRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public PhysicalConnectionPowerFromPortRequestData entityRestrictions(PhysicalConnectionPowerFromPortEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public PhysicalConnectionPowerFromPortEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(PhysicalConnectionPowerFromPortEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public PhysicalConnectionPowerFromPortRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public PhysicalConnectionPowerFromPortRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public PhysicalConnectionPowerFromPortRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    PhysicalConnectionPowerFromPortRequestData physicalConnectionPowerFromPortRequestData = (PhysicalConnectionPowerFromPortRequestData) o;
    return Objects.equals(this.returnEntityAttributes, physicalConnectionPowerFromPortRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, physicalConnectionPowerFromPortRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, physicalConnectionPowerFromPortRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, physicalConnectionPowerFromPortRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class PhysicalConnectionPowerFromPortRequestData {\n");
