...
/**
 * TelcoProductDevicesAllEntityRestriction
 */
@JsonPropertyOrder({
  TelcoProductDevicesAllEntityRestriction.JSON_PROPERTY_CLIMATE_RELEVANT,
  TelcoProductDevicesAllEntityRestriction.JSON_PROPERTY_POWER_CONSUMPTION,
  TelcoProductDevicesAllEntityRestriction.JSON_PROPERTY_POWER_SWITCHING_STATUS,
  TelcoProductDevicesAllEntityRestriction.JSON_PROPERTY_PLAN_STATUS,
  TelcoProductDevicesAllEntityRestriction.JSON_PROPERTY_SYSTEM_RUNTIME,
  TelcoProductDevicesAllEntityRestriction.JSON_PROPERTY_WEIGHT,
  TelcoProductDevicesAllEntityRestriction.JSON_PROPERTY_REMARK,
  TelcoProductDevicesAllEntityRestriction.JSON_PROPERTY_ELID,
  TelcoProductDevicesAllEntityRestriction.JSON_PROPERTY_LAST_SEEN,
  TelcoProductDevicesAllEntityRestriction.JSON_PROPERTY_TYPE_ELID,
  TelcoProductDevicesAllEntityRestriction.JSON_PROPERTY_VISIBLE_ID,
  TelcoProductDevicesAllEntityRestriction.JSON_PROPERTY_ID,
  TelcoProductDevicesAllEntityRestriction.JSON_PROPERTY_HEAT_EMISSION
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-01-31T11:10:37.320689708Z[Etc/UTC]")
public class TelcoProductDevicesAllEntityRestriction {
  ...
  public TelcoProductDevicesAllEntityRestriction() {
  }

  public TelcoProductDevicesAllEntityRestriction climateRelevant(RestrictionsBoolean climateRelevant) {
  ...
  **/
  ...
  public TelcoProductDevicesAllEntityRestriction powerConsumption(RestrictionsNumeric powerConsumption) {
  ...
  **/
  ...
  public TelcoProductDevicesAllEntityRestriction powerSwitchingStatus(RestrictionsString powerSwitchingStatus) {
  ...
  **/
  ...
  public TelcoProductDevicesAllEntityRestriction planStatus(RestrictionsString planStatus) {
  ...
  **/
  ...
  public TelcoProductDevicesAllEntityRestriction systemRuntime(RestrictionsNumeric systemRuntime) {
  ...
  **/
  ...
  public TelcoProductDevicesAllEntityRestriction weight(RestrictionsNumeric weight) {
  ...
  **/
  ...
  public TelcoProductDevicesAllEntityRestriction remark(RestrictionsString remark) {
  ...
  **/
  ...
  public TelcoProductDevicesAllEntityRestriction elid(RestrictionsString elid) {
  ...
  **/
  ...
  public TelcoProductDevicesAllEntityRestriction lastSeen(RestrictionsDate lastSeen) {
  ...
  **/
  ...
  public TelcoProductDevicesAllEntityRestriction typeElid(RestrictionsString typeElid) {
  ...
  **/
  ...
  public TelcoProductDevicesAllEntityRestriction visibleId(RestrictionsString visibleId) {
  ...
  **/
  ...
  public TelcoProductDevicesAllEntityRestriction id(RestrictionsString id) {
  ...
  **/
  ...
  public TelcoProductDevicesAllEntityRestriction heatEmission(RestrictionsNumeric heatEmission) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    TelcoProductDevicesAllEntityRestriction telcoProductDevicesAllEntityRestriction = (TelcoProductDevicesAllEntityRestriction) o;
    return Objects.equals(this.climateRelevant, telcoProductDevicesAllEntityRestriction.climateRelevant) &&
        Objects.equals(this.powerConsumption, telcoProductDevicesAllEntityRestriction.powerConsumption) &&
        Objects.equals(this.powerSwitchingStatus, telcoProductDevicesAllEntityRestriction.powerSwitchingStatus) &&
        Objects.equals(this.planStatus, telcoProductDevicesAllEntityRestriction.planStatus) &&
        Objects.equals(this.systemRuntime, telcoProductDevicesAllEntityRestriction.systemRuntime) &&
        Objects.equals(this.weight, telcoProductDevicesAllEntityRestriction.weight) &&
        Objects.equals(this.remark, telcoProductDevicesAllEntityRestriction.remark) &&
        Objects.equals(this.elid, telcoProductDevicesAllEntityRestriction.elid) &&
        Objects.equals(this.lastSeen, telcoProductDevicesAllEntityRestriction.lastSeen) &&
        Objects.equals(this.typeElid, telcoProductDevicesAllEntityRestriction.typeElid) &&
        Objects.equals(this.visibleId, telcoProductDevicesAllEntityRestriction.visibleId) &&
        Objects.equals(this.id, telcoProductDevicesAllEntityRestriction.id) &&
        Objects.equals(this.heatEmission, telcoProductDevicesAllEntityRestriction.heatEmission);
  }
  ...
  public String toString() {
    ...
    sb.append("class TelcoProductDevicesAllEntityRestriction {\n");
