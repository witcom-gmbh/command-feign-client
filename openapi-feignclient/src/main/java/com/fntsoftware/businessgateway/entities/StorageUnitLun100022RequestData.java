...
import com.fntsoftware.businessgateway.entities.StorageUnitLun100022EntityRestriction;
...
/**
 * StorageUnitLun100022RequestData
 */
@JsonPropertyOrder({
  StorageUnitLun100022RequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  StorageUnitLun100022RequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  StorageUnitLun100022RequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  StorageUnitLun100022RequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-03-04T13:31:32.601557352Z[Etc/UTC]")
public class StorageUnitLun100022RequestData {
  ...
  private StorageUnitLun100022EntityRestriction entityRestrictions;
  ...
  public StorageUnitLun100022RequestData() {
  }

  public StorageUnitLun100022RequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public StorageUnitLun100022RequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public StorageUnitLun100022RequestData entityRestrictions(StorageUnitLun100022EntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public StorageUnitLun100022EntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(StorageUnitLun100022EntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public StorageUnitLun100022RequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public StorageUnitLun100022RequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public StorageUnitLun100022RequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    StorageUnitLun100022RequestData storageUnitLun100022RequestData = (StorageUnitLun100022RequestData) o;
    return Objects.equals(this.returnEntityAttributes, storageUnitLun100022RequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, storageUnitLun100022RequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, storageUnitLun100022RequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, storageUnitLun100022RequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class StorageUnitLun100022RequestData {\n");
