...
import com.fntsoftware.businessgateway.entities.PersonBearersEntityRestriction;
import com.fntsoftware.businessgateway.entities.PersonBearersRelationRestriction;
...
/**
 * PersonBearersRequestData
 */
@JsonPropertyOrder({
  PersonBearersRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  PersonBearersRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  PersonBearersRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  PersonBearersRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-02-26T11:20:24.990023935Z[Etc/UTC]")
public class PersonBearersRequestData {
  ...
  private PersonBearersEntityRestriction entityRestrictions;

  public static final String JSON_PROPERTY_RELATION_RESTRICTIONS = "relationRestrictions";
  private PersonBearersRelationRestriction relationRestrictions;
  ...
  public PersonBearersRequestData() {
  }

  public PersonBearersRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public PersonBearersRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public PersonBearersRequestData entityRestrictions(PersonBearersEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public PersonBearersEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(PersonBearersEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public PersonBearersRequestData relationRestrictions(PersonBearersRelationRestriction relationRestrictions) {
  ...
  **/
  ...
  public PersonBearersRelationRestriction getRelationRestrictions() {
    return relationRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_RELATION_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRelationRestrictions(PersonBearersRelationRestriction relationRestrictions) {
    this.relationRestrictions = relationRestrictions;
  }


  public PersonBearersRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public PersonBearersRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    PersonBearersRequestData personBearersRequestData = (PersonBearersRequestData) o;
    return Objects.equals(this.returnEntityAttributes, personBearersRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, personBearersRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, personBearersRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, personBearersRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class PersonBearersRequestData {\n");
