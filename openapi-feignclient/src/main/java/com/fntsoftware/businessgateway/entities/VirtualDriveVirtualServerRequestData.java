...
import com.fntsoftware.businessgateway.entities.VirtualDriveVirtualServerEntityRestriction;
...
/**
 * VirtualDriveVirtualServerRequestData
 */
@JsonPropertyOrder({
  VirtualDriveVirtualServerRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  VirtualDriveVirtualServerRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  VirtualDriveVirtualServerRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  VirtualDriveVirtualServerRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-03-04T13:31:32.601557352Z[Etc/UTC]")
public class VirtualDriveVirtualServerRequestData {
  ...
  private VirtualDriveVirtualServerEntityRestriction entityRestrictions;
  ...
  public VirtualDriveVirtualServerRequestData() {
  }

  public VirtualDriveVirtualServerRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public VirtualDriveVirtualServerRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public VirtualDriveVirtualServerRequestData entityRestrictions(VirtualDriveVirtualServerEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public VirtualDriveVirtualServerEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(VirtualDriveVirtualServerEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public VirtualDriveVirtualServerRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public VirtualDriveVirtualServerRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public VirtualDriveVirtualServerRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    VirtualDriveVirtualServerRequestData virtualDriveVirtualServerRequestData = (VirtualDriveVirtualServerRequestData) o;
    return Objects.equals(this.returnEntityAttributes, virtualDriveVirtualServerRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, virtualDriveVirtualServerRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, virtualDriveVirtualServerRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, virtualDriveVirtualServerRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class VirtualDriveVirtualServerRequestData {\n");
