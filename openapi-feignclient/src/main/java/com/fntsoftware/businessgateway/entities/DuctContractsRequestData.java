...
import com.fntsoftware.businessgateway.entities.DuctContractsEntityRestriction;
import com.fntsoftware.businessgateway.entities.DuctContractsRelationRestriction;
...
/**
 * DuctContractsRequestData
 */
@JsonPropertyOrder({
  DuctContractsRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  DuctContractsRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  DuctContractsRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  DuctContractsRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-01-31T11:10:37.320689708Z[Etc/UTC]")
public class DuctContractsRequestData {
  ...
  private DuctContractsEntityRestriction entityRestrictions;

  public static final String JSON_PROPERTY_RELATION_RESTRICTIONS = "relationRestrictions";
  private DuctContractsRelationRestriction relationRestrictions;
  ...
  public DuctContractsRequestData() {
  }

  public DuctContractsRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public DuctContractsRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public DuctContractsRequestData entityRestrictions(DuctContractsEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public DuctContractsEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(DuctContractsEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public DuctContractsRequestData relationRestrictions(DuctContractsRelationRestriction relationRestrictions) {
  ...
  **/
  ...
  public DuctContractsRelationRestriction getRelationRestrictions() {
    return relationRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_RELATION_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRelationRestrictions(DuctContractsRelationRestriction relationRestrictions) {
    this.relationRestrictions = relationRestrictions;
  }


  public DuctContractsRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public DuctContractsRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    DuctContractsRequestData ductContractsRequestData = (DuctContractsRequestData) o;
    return Objects.equals(this.returnEntityAttributes, ductContractsRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, ductContractsRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, ductContractsRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, ductContractsRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class DuctContractsRequestData {\n");
