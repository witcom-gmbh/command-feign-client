...
import com.fntsoftware.businessgateway.entities.FloorPersonsEntityRestriction;
import com.fntsoftware.businessgateway.entities.FloorPersonsRelationRestriction;
...
/**
 * FloorPersonsRequestData
 */
@JsonPropertyOrder({
  FloorPersonsRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  FloorPersonsRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  FloorPersonsRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  FloorPersonsRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-01-31T11:10:37.320689708Z[Etc/UTC]")
public class FloorPersonsRequestData {
  ...
  private FloorPersonsEntityRestriction entityRestrictions;

  public static final String JSON_PROPERTY_RELATION_RESTRICTIONS = "relationRestrictions";
  private FloorPersonsRelationRestriction relationRestrictions;
  ...
  public FloorPersonsRequestData() {
  }

  public FloorPersonsRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public FloorPersonsRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public FloorPersonsRequestData entityRestrictions(FloorPersonsEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public FloorPersonsEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(FloorPersonsEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public FloorPersonsRequestData relationRestrictions(FloorPersonsRelationRestriction relationRestrictions) {
  ...
  **/
  ...
  public FloorPersonsRelationRestriction getRelationRestrictions() {
    return relationRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_RELATION_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRelationRestrictions(FloorPersonsRelationRestriction relationRestrictions) {
    this.relationRestrictions = relationRestrictions;
  }


  public FloorPersonsRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public FloorPersonsRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    FloorPersonsRequestData floorPersonsRequestData = (FloorPersonsRequestData) o;
    return Objects.equals(this.returnEntityAttributes, floorPersonsRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, floorPersonsRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, floorPersonsRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, floorPersonsRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class FloorPersonsRequestData {\n");
