...
import com.fntsoftware.businessgateway.entities.FloorRoomsEntityRestriction;
...
/**
 * FloorRoomsRequestData
 */
@JsonPropertyOrder({
  FloorRoomsRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  FloorRoomsRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  FloorRoomsRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  FloorRoomsRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-02-26T11:20:24.990023935Z[Etc/UTC]")
public class FloorRoomsRequestData {
  ...
  private FloorRoomsEntityRestriction entityRestrictions;
  ...
  public FloorRoomsRequestData() {
  }

  public FloorRoomsRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public FloorRoomsRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public FloorRoomsRequestData entityRestrictions(FloorRoomsEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public FloorRoomsEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(FloorRoomsEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public FloorRoomsRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public FloorRoomsRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public FloorRoomsRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    FloorRoomsRequestData floorRoomsRequestData = (FloorRoomsRequestData) o;
    return Objects.equals(this.returnEntityAttributes, floorRoomsRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, floorRoomsRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, floorRoomsRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, floorRoomsRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class FloorRoomsRequestData {\n");
