...
import com.fntsoftware.businessgateway.entities.DeviceMasterDeviceServersBaseEntityRestriction;
...
/**
 * DeviceMasterDeviceServersBaseRequestData
 */
@JsonPropertyOrder({
  DeviceMasterDeviceServersBaseRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  DeviceMasterDeviceServersBaseRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  DeviceMasterDeviceServersBaseRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  DeviceMasterDeviceServersBaseRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-01-31T11:10:37.320689708Z[Etc/UTC]")
public class DeviceMasterDeviceServersBaseRequestData {
  ...
  private DeviceMasterDeviceServersBaseEntityRestriction entityRestrictions;
  ...
  public DeviceMasterDeviceServersBaseRequestData() {
  }

  public DeviceMasterDeviceServersBaseRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public DeviceMasterDeviceServersBaseRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public DeviceMasterDeviceServersBaseRequestData entityRestrictions(DeviceMasterDeviceServersBaseEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public DeviceMasterDeviceServersBaseEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(DeviceMasterDeviceServersBaseEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public DeviceMasterDeviceServersBaseRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public DeviceMasterDeviceServersBaseRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public DeviceMasterDeviceServersBaseRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    DeviceMasterDeviceServersBaseRequestData deviceMasterDeviceServersBaseRequestData = (DeviceMasterDeviceServersBaseRequestData) o;
    return Objects.equals(this.returnEntityAttributes, deviceMasterDeviceServersBaseRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, deviceMasterDeviceServersBaseRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, deviceMasterDeviceServersBaseRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, deviceMasterDeviceServersBaseRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeviceMasterDeviceServersBaseRequestData {\n");
