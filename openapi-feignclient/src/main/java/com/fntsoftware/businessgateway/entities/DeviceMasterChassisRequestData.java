...
import com.fntsoftware.businessgateway.entities.DeviceMasterChassisEntityRestriction;
...
/**
 * DeviceMasterChassisRequestData
 */
@JsonPropertyOrder({
  DeviceMasterChassisRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  DeviceMasterChassisRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  DeviceMasterChassisRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  DeviceMasterChassisRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-03-04T13:31:32.601557352Z[Etc/UTC]")
public class DeviceMasterChassisRequestData {
  ...
  private DeviceMasterChassisEntityRestriction entityRestrictions;
  ...
  public DeviceMasterChassisRequestData() {
  }

  public DeviceMasterChassisRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public DeviceMasterChassisRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public DeviceMasterChassisRequestData entityRestrictions(DeviceMasterChassisEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public DeviceMasterChassisEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(DeviceMasterChassisEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public DeviceMasterChassisRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public DeviceMasterChassisRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public DeviceMasterChassisRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    DeviceMasterChassisRequestData deviceMasterChassisRequestData = (DeviceMasterChassisRequestData) o;
    return Objects.equals(this.returnEntityAttributes, deviceMasterChassisRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, deviceMasterChassisRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, deviceMasterChassisRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, deviceMasterChassisRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeviceMasterChassisRequestData {\n");
