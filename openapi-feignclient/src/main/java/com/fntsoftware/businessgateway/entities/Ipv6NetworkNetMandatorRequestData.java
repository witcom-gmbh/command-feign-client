...
import com.fntsoftware.businessgateway.entities.Ipv6NetworkNetMandatorEntityRestriction;
...
/**
 * Ipv6NetworkNetMandatorRequestData
 */
@JsonPropertyOrder({
  Ipv6NetworkNetMandatorRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  Ipv6NetworkNetMandatorRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  Ipv6NetworkNetMandatorRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  Ipv6NetworkNetMandatorRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-03-04T13:31:32.601557352Z[Etc/UTC]")
public class Ipv6NetworkNetMandatorRequestData {
  ...
  private Ipv6NetworkNetMandatorEntityRestriction entityRestrictions;
  ...
  public Ipv6NetworkNetMandatorRequestData() {
  }

  public Ipv6NetworkNetMandatorRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public Ipv6NetworkNetMandatorRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public Ipv6NetworkNetMandatorRequestData entityRestrictions(Ipv6NetworkNetMandatorEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public Ipv6NetworkNetMandatorEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(Ipv6NetworkNetMandatorEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public Ipv6NetworkNetMandatorRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public Ipv6NetworkNetMandatorRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public Ipv6NetworkNetMandatorRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    Ipv6NetworkNetMandatorRequestData ipv6NetworkNetMandatorRequestData = (Ipv6NetworkNetMandatorRequestData) o;
    return Objects.equals(this.returnEntityAttributes, ipv6NetworkNetMandatorRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, ipv6NetworkNetMandatorRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, ipv6NetworkNetMandatorRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, ipv6NetworkNetMandatorRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class Ipv6NetworkNetMandatorRequestData {\n");
