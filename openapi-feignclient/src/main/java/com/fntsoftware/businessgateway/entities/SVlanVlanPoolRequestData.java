...
import com.fntsoftware.businessgateway.entities.SVlanVlanPoolEntityRestriction;
...
/**
 * SVlanVlanPoolRequestData
 */
@JsonPropertyOrder({
  SVlanVlanPoolRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  SVlanVlanPoolRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  SVlanVlanPoolRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  SVlanVlanPoolRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-03-04T13:31:32.601557352Z[Etc/UTC]")
public class SVlanVlanPoolRequestData {
  ...
  private SVlanVlanPoolEntityRestriction entityRestrictions;
  ...
  public SVlanVlanPoolRequestData() {
  }

  public SVlanVlanPoolRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public SVlanVlanPoolRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public SVlanVlanPoolRequestData entityRestrictions(SVlanVlanPoolEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public SVlanVlanPoolEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(SVlanVlanPoolEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public SVlanVlanPoolRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public SVlanVlanPoolRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public SVlanVlanPoolRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    SVlanVlanPoolRequestData svlanVlanPoolRequestData = (SVlanVlanPoolRequestData) o;
    return Objects.equals(this.returnEntityAttributes, svlanVlanPoolRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, svlanVlanPoolRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, svlanVlanPoolRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, svlanVlanPoolRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class SVlanVlanPoolRequestData {\n");
