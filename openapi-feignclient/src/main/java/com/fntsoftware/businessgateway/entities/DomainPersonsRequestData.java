...
import com.fntsoftware.businessgateway.entities.DomainPersonsEntityRestriction;
import com.fntsoftware.businessgateway.entities.DomainPersonsRelationRestriction;
...
/**
 * DomainPersonsRequestData
 */
@JsonPropertyOrder({
  DomainPersonsRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  DomainPersonsRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  DomainPersonsRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  DomainPersonsRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-02-26T11:20:24.990023935Z[Etc/UTC]")
public class DomainPersonsRequestData {
  ...
  private DomainPersonsEntityRestriction entityRestrictions;

  public static final String JSON_PROPERTY_RELATION_RESTRICTIONS = "relationRestrictions";
  private DomainPersonsRelationRestriction relationRestrictions;
  ...
  public DomainPersonsRequestData() {
  }

  public DomainPersonsRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public DomainPersonsRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public DomainPersonsRequestData entityRestrictions(DomainPersonsEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public DomainPersonsEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(DomainPersonsEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public DomainPersonsRequestData relationRestrictions(DomainPersonsRelationRestriction relationRestrictions) {
  ...
  **/
  ...
  public DomainPersonsRelationRestriction getRelationRestrictions() {
    return relationRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_RELATION_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRelationRestrictions(DomainPersonsRelationRestriction relationRestrictions) {
    this.relationRestrictions = relationRestrictions;
  }


  public DomainPersonsRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public DomainPersonsRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    DomainPersonsRequestData domainPersonsRequestData = (DomainPersonsRequestData) o;
    return Objects.equals(this.returnEntityAttributes, domainPersonsRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, domainPersonsRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, domainPersonsRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, domainPersonsRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class DomainPersonsRequestData {\n");
