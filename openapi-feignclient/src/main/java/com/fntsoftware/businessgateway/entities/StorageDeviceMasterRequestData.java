...
import com.fntsoftware.businessgateway.entities.StorageDeviceMasterEntityRestriction;
...
/**
 * StorageDeviceMasterRequestData
 */
@JsonPropertyOrder({
  StorageDeviceMasterRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  StorageDeviceMasterRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  StorageDeviceMasterRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  StorageDeviceMasterRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-02-26T11:20:24.990023935Z[Etc/UTC]")
public class StorageDeviceMasterRequestData {
  ...
  private StorageDeviceMasterEntityRestriction entityRestrictions;
  ...
  public StorageDeviceMasterRequestData() {
  }

  public StorageDeviceMasterRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public StorageDeviceMasterRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public StorageDeviceMasterRequestData entityRestrictions(StorageDeviceMasterEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public StorageDeviceMasterEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(StorageDeviceMasterEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public StorageDeviceMasterRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public StorageDeviceMasterRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public StorageDeviceMasterRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    StorageDeviceMasterRequestData storageDeviceMasterRequestData = (StorageDeviceMasterRequestData) o;
    return Objects.equals(this.returnEntityAttributes, storageDeviceMasterRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, storageDeviceMasterRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, storageDeviceMasterRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, storageDeviceMasterRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class StorageDeviceMasterRequestData {\n");
