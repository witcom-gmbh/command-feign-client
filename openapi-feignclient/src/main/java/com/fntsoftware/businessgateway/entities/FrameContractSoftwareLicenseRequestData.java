...
import com.fntsoftware.businessgateway.entities.FrameContractSoftwareLicenseEntityRestriction;
...
/**
 * FrameContractSoftwareLicenseRequestData
 */
@JsonPropertyOrder({
  FrameContractSoftwareLicenseRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  FrameContractSoftwareLicenseRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  FrameContractSoftwareLicenseRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  FrameContractSoftwareLicenseRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-03-04T13:31:32.601557352Z[Etc/UTC]")
public class FrameContractSoftwareLicenseRequestData {
  ...
  private FrameContractSoftwareLicenseEntityRestriction entityRestrictions;
  ...
  public FrameContractSoftwareLicenseRequestData() {
  }

  public FrameContractSoftwareLicenseRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public FrameContractSoftwareLicenseRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public FrameContractSoftwareLicenseRequestData entityRestrictions(FrameContractSoftwareLicenseEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public FrameContractSoftwareLicenseEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(FrameContractSoftwareLicenseEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public FrameContractSoftwareLicenseRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public FrameContractSoftwareLicenseRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public FrameContractSoftwareLicenseRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    FrameContractSoftwareLicenseRequestData frameContractSoftwareLicenseRequestData = (FrameContractSoftwareLicenseRequestData) o;
    return Objects.equals(this.returnEntityAttributes, frameContractSoftwareLicenseRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, frameContractSoftwareLicenseRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, frameContractSoftwareLicenseRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, frameContractSoftwareLicenseRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class FrameContractSoftwareLicenseRequestData {\n");
