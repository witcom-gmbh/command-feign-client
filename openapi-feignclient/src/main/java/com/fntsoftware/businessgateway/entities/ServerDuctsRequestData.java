...
import com.fntsoftware.businessgateway.entities.ServerDuctsEntityRestriction;
import com.fntsoftware.businessgateway.entities.ServerDuctsRelationRestriction;
...
/**
 * ServerDuctsRequestData
 */
@JsonPropertyOrder({
  ServerDuctsRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  ServerDuctsRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  ServerDuctsRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  ServerDuctsRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-03-04T13:31:32.601557352Z[Etc/UTC]")
public class ServerDuctsRequestData {
  ...
  private ServerDuctsEntityRestriction entityRestrictions;

  public static final String JSON_PROPERTY_RELATION_RESTRICTIONS = "relationRestrictions";
  private ServerDuctsRelationRestriction relationRestrictions;
  ...
  public ServerDuctsRequestData() {
  }

  public ServerDuctsRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public ServerDuctsRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public ServerDuctsRequestData entityRestrictions(ServerDuctsEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public ServerDuctsEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(ServerDuctsEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public ServerDuctsRequestData relationRestrictions(ServerDuctsRelationRestriction relationRestrictions) {
  ...
  **/
  ...
  public ServerDuctsRelationRestriction getRelationRestrictions() {
    return relationRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_RELATION_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRelationRestrictions(ServerDuctsRelationRestriction relationRestrictions) {
    this.relationRestrictions = relationRestrictions;
  }


  public ServerDuctsRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public ServerDuctsRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ServerDuctsRequestData serverDuctsRequestData = (ServerDuctsRequestData) o;
    return Objects.equals(this.returnEntityAttributes, serverDuctsRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, serverDuctsRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, serverDuctsRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, serverDuctsRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class ServerDuctsRequestData {\n");
