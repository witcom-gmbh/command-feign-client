...
import com.fntsoftware.businessgateway.entities.DeviceAllPhysicalPortsPowerEntityRestriction;
...
/**
 * DeviceAllPhysicalPortsPowerRequestData
 */
@JsonPropertyOrder({
  DeviceAllPhysicalPortsPowerRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  DeviceAllPhysicalPortsPowerRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  DeviceAllPhysicalPortsPowerRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  DeviceAllPhysicalPortsPowerRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-02-26T11:20:24.990023935Z[Etc/UTC]")
public class DeviceAllPhysicalPortsPowerRequestData {
  ...
  private DeviceAllPhysicalPortsPowerEntityRestriction entityRestrictions;
  ...
  public DeviceAllPhysicalPortsPowerRequestData() {
  }

  public DeviceAllPhysicalPortsPowerRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public DeviceAllPhysicalPortsPowerRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public DeviceAllPhysicalPortsPowerRequestData entityRestrictions(DeviceAllPhysicalPortsPowerEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public DeviceAllPhysicalPortsPowerEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(DeviceAllPhysicalPortsPowerEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public DeviceAllPhysicalPortsPowerRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public DeviceAllPhysicalPortsPowerRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public DeviceAllPhysicalPortsPowerRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    DeviceAllPhysicalPortsPowerRequestData deviceAllPhysicalPortsPowerRequestData = (DeviceAllPhysicalPortsPowerRequestData) o;
    return Objects.equals(this.returnEntityAttributes, deviceAllPhysicalPortsPowerRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, deviceAllPhysicalPortsPowerRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, deviceAllPhysicalPortsPowerRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, deviceAllPhysicalPortsPowerRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeviceAllPhysicalPortsPowerRequestData {\n");
