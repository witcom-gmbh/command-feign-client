...
import com.fntsoftware.businessgateway.entities.DeviceAllWarehouseEntityRestriction;
...
/**
 * DeviceAllWarehouseRequestData
 */
@JsonPropertyOrder({
  DeviceAllWarehouseRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  DeviceAllWarehouseRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  DeviceAllWarehouseRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  DeviceAllWarehouseRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-03-04T13:31:32.601557352Z[Etc/UTC]")
public class DeviceAllWarehouseRequestData {
  ...
  private DeviceAllWarehouseEntityRestriction entityRestrictions;
  ...
  public DeviceAllWarehouseRequestData() {
  }

  public DeviceAllWarehouseRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public DeviceAllWarehouseRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public DeviceAllWarehouseRequestData entityRestrictions(DeviceAllWarehouseEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public DeviceAllWarehouseEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(DeviceAllWarehouseEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public DeviceAllWarehouseRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public DeviceAllWarehouseRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public DeviceAllWarehouseRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    DeviceAllWarehouseRequestData deviceAllWarehouseRequestData = (DeviceAllWarehouseRequestData) o;
    return Objects.equals(this.returnEntityAttributes, deviceAllWarehouseRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, deviceAllWarehouseRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, deviceAllWarehouseRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, deviceAllWarehouseRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeviceAllWarehouseRequestData {\n");
