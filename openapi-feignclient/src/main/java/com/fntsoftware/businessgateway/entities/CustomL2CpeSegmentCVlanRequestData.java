...
import com.fntsoftware.businessgateway.entities.CustomL2CpeSegmentCVlanEntityRestriction;
...
/**
 * CustomL2CpeSegmentCVlanRequestData
 */
@JsonPropertyOrder({
  CustomL2CpeSegmentCVlanRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  CustomL2CpeSegmentCVlanRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  CustomL2CpeSegmentCVlanRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  CustomL2CpeSegmentCVlanRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-02-26T11:20:24.990023935Z[Etc/UTC]")
public class CustomL2CpeSegmentCVlanRequestData {
  ...
  private CustomL2CpeSegmentCVlanEntityRestriction entityRestrictions;
  ...
  public CustomL2CpeSegmentCVlanRequestData() {
  }

  public CustomL2CpeSegmentCVlanRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public CustomL2CpeSegmentCVlanRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public CustomL2CpeSegmentCVlanRequestData entityRestrictions(CustomL2CpeSegmentCVlanEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public CustomL2CpeSegmentCVlanEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(CustomL2CpeSegmentCVlanEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public CustomL2CpeSegmentCVlanRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public CustomL2CpeSegmentCVlanRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public CustomL2CpeSegmentCVlanRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    CustomL2CpeSegmentCVlanRequestData customL2CpeSegmentCVlanRequestData = (CustomL2CpeSegmentCVlanRequestData) o;
    return Objects.equals(this.returnEntityAttributes, customL2CpeSegmentCVlanRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, customL2CpeSegmentCVlanRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, customL2CpeSegmentCVlanRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, customL2CpeSegmentCVlanRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class CustomL2CpeSegmentCVlanRequestData {\n");
