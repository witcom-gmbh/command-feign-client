...
/**
 * DeviceAllIpAddressesResponseData
 */
@JsonPropertyOrder({
  DeviceAllIpAddressesResponseData.JSON_PROPERTY_ASSIGNED_DIRECTLY,
  DeviceAllIpAddressesResponseData.JSON_PROPERTY_INTERFACE,
  DeviceAllIpAddressesResponseData.JSON_PROPERTY_PORTS,
  DeviceAllIpAddressesResponseData.JSON_PROPERTY_OBJECT_ELID,
  DeviceAllIpAddressesResponseData.JSON_PROPERTY_OBJECT_ID
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-02-26T11:20:24.990023935Z[Etc/UTC]")
public class DeviceAllIpAddressesResponseData {
  ...
  public DeviceAllIpAddressesResponseData() {
  }

  public DeviceAllIpAddressesResponseData assignedDirectly(Boolean assignedDirectly) {
  ...
  **/
  ...
  public DeviceAllIpAddressesResponseData _interface(InterfaceinterfaceWithAddressData _interface) {
  ...
  **/
  ...
  public DeviceAllIpAddressesResponseData ports(List<PhysicalPortDataphysicalPortDataInfo> ports) {
    
    this.ports = ports;
    return this;
  }

  public DeviceAllIpAddressesResponseData addPortsItem(PhysicalPortDataphysicalPortDataInfo portsItem) {
    if (this.ports == null) {
  ...
  **/
  ...
  public DeviceAllIpAddressesResponseData objectElid(String objectElid) {
  ...
  **/
  ...
  public DeviceAllIpAddressesResponseData objectId(String objectId) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    DeviceAllIpAddressesResponseData deviceAllIpAddressesResponseData = (DeviceAllIpAddressesResponseData) o;
    return Objects.equals(this.assignedDirectly, deviceAllIpAddressesResponseData.assignedDirectly) &&
        Objects.equals(this._interface, deviceAllIpAddressesResponseData._interface) &&
        Objects.equals(this.ports, deviceAllIpAddressesResponseData.ports) &&
        Objects.equals(this.objectElid, deviceAllIpAddressesResponseData.objectElid) &&
        Objects.equals(this.objectId, deviceAllIpAddressesResponseData.objectId);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeviceAllIpAddressesResponseData {\n");
