...
import com.fntsoftware.businessgateway.entities.DataSocketPhysicalPortsPowerEntityRestriction;
...
/**
 * DataSocketPhysicalPortsPowerRequestData
 */
@JsonPropertyOrder({
  DataSocketPhysicalPortsPowerRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  DataSocketPhysicalPortsPowerRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  DataSocketPhysicalPortsPowerRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  DataSocketPhysicalPortsPowerRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-03-04T13:31:32.601557352Z[Etc/UTC]")
public class DataSocketPhysicalPortsPowerRequestData {
  ...
  private DataSocketPhysicalPortsPowerEntityRestriction entityRestrictions;
  ...
  public DataSocketPhysicalPortsPowerRequestData() {
  }

  public DataSocketPhysicalPortsPowerRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public DataSocketPhysicalPortsPowerRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public DataSocketPhysicalPortsPowerRequestData entityRestrictions(DataSocketPhysicalPortsPowerEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public DataSocketPhysicalPortsPowerEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(DataSocketPhysicalPortsPowerEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public DataSocketPhysicalPortsPowerRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public DataSocketPhysicalPortsPowerRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public DataSocketPhysicalPortsPowerRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    DataSocketPhysicalPortsPowerRequestData dataSocketPhysicalPortsPowerRequestData = (DataSocketPhysicalPortsPowerRequestData) o;
    return Objects.equals(this.returnEntityAttributes, dataSocketPhysicalPortsPowerRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, dataSocketPhysicalPortsPowerRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, dataSocketPhysicalPortsPowerRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, dataSocketPhysicalPortsPowerRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class DataSocketPhysicalPortsPowerRequestData {\n");
