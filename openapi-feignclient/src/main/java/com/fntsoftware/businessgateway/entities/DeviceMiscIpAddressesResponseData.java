...
/**
 * DeviceMiscIpAddressesResponseData
 */
@JsonPropertyOrder({
  DeviceMiscIpAddressesResponseData.JSON_PROPERTY_ASSIGNED_DIRECTLY,
  DeviceMiscIpAddressesResponseData.JSON_PROPERTY_INTERFACE,
  DeviceMiscIpAddressesResponseData.JSON_PROPERTY_PORTS,
  DeviceMiscIpAddressesResponseData.JSON_PROPERTY_OBJECT_ELID,
  DeviceMiscIpAddressesResponseData.JSON_PROPERTY_OBJECT_ID
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-01-31T11:10:37.320689708Z[Etc/UTC]")
public class DeviceMiscIpAddressesResponseData {
  ...
  public DeviceMiscIpAddressesResponseData() {
  }

  public DeviceMiscIpAddressesResponseData assignedDirectly(Boolean assignedDirectly) {
  ...
  **/
  ...
  public DeviceMiscIpAddressesResponseData _interface(InterfaceinterfaceWithAddressData _interface) {
  ...
  **/
  ...
  public DeviceMiscIpAddressesResponseData ports(List<PhysicalPortDataphysicalPortDataInfo> ports) {
    
    this.ports = ports;
    return this;
  }

  public DeviceMiscIpAddressesResponseData addPortsItem(PhysicalPortDataphysicalPortDataInfo portsItem) {
    if (this.ports == null) {
  ...
  **/
  ...
  public DeviceMiscIpAddressesResponseData objectElid(String objectElid) {
  ...
  **/
  ...
  public DeviceMiscIpAddressesResponseData objectId(String objectId) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    DeviceMiscIpAddressesResponseData deviceMiscIpAddressesResponseData = (DeviceMiscIpAddressesResponseData) o;
    return Objects.equals(this.assignedDirectly, deviceMiscIpAddressesResponseData.assignedDirectly) &&
        Objects.equals(this._interface, deviceMiscIpAddressesResponseData._interface) &&
        Objects.equals(this.ports, deviceMiscIpAddressesResponseData.ports) &&
        Objects.equals(this.objectElid, deviceMiscIpAddressesResponseData.objectElid) &&
        Objects.equals(this.objectId, deviceMiscIpAddressesResponseData.objectId);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeviceMiscIpAddressesResponseData {\n");
