...
import com.fntsoftware.businessgateway.entities.MoveToZoneChassisCreateLinkZoneRequestData;
import com.fasterxml.jackson.annotation.JsonPropertyOrder;
import com.fasterxml.jackson.annotation.JsonTypeName;

/**
 * MoveToZoneChassisRequestData
 */
@JsonPropertyOrder({
  MoveToZoneChassisRequestData.JSON_PROPERTY_RELEASE_SIGNALPATH,
  MoveToZoneChassisRequestData.JSON_PROPERTY_RELEASE_CONNECTIONS,
  MoveToZoneChassisRequestData.JSON_PROPERTY_RELEASE_SERVICE,
  MoveToZoneChassisRequestData.JSON_PROPERTY_RELEASE_SUPPORTS,
  MoveToZoneChassisRequestData.JSON_PROPERTY_RELEASE_PATCHES,
  MoveToZoneChassisRequestData.JSON_PROPERTY_CREATE_LINK_ZONE
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-02-26T11:20:24.990023935Z[Etc/UTC]")
public class MoveToZoneChassisRequestData {
  ...
  private MoveToZoneChassisCreateLinkZoneRequestData createLinkZone;

  public MoveToZoneChassisRequestData() {
  }

  public MoveToZoneChassisRequestData releaseSignalpath(Boolean releaseSignalpath) {
  ...
  **/
  ...
  public MoveToZoneChassisRequestData releaseConnections(Boolean releaseConnections) {
  ...
  **/
  ...
  public MoveToZoneChassisRequestData releaseService(Boolean releaseService) {
  ...
  **/
  ...
  public MoveToZoneChassisRequestData releaseSupports(Boolean releaseSupports) {
  ...
  **/
  ...
  public MoveToZoneChassisRequestData releasePatches(Boolean releasePatches) {
  ...
  **/
  ...
  public MoveToZoneChassisRequestData createLinkZone(MoveToZoneChassisCreateLinkZoneRequestData createLinkZone) {
  ...
  **/
  ...
  public MoveToZoneChassisCreateLinkZoneRequestData getCreateLinkZone() {
    return createLinkZone;
  }
  ...
  @JsonProperty(JSON_PROPERTY_CREATE_LINK_ZONE)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setCreateLinkZone(MoveToZoneChassisCreateLinkZoneRequestData createLinkZone) {
    this.createLinkZone = createLinkZone;
  }
  ...
  public boolean equals(Object o) {
    ...
    MoveToZoneChassisRequestData moveToZoneChassisRequestData = (MoveToZoneChassisRequestData) o;
    return Objects.equals(this.releaseSignalpath, moveToZoneChassisRequestData.releaseSignalpath) &&
        Objects.equals(this.releaseConnections, moveToZoneChassisRequestData.releaseConnections) &&
        Objects.equals(this.releaseService, moveToZoneChassisRequestData.releaseService) &&
        Objects.equals(this.releaseSupports, moveToZoneChassisRequestData.releaseSupports) &&
        Objects.equals(this.releasePatches, moveToZoneChassisRequestData.releasePatches) &&
        Objects.equals(this.createLinkZone, moveToZoneChassisRequestData.createLinkZone);
  }
  ...
  public String toString() {
    ...
    sb.append("class MoveToZoneChassisRequestData {\n");
