...
/**
 * ShareStorageUnitEntityRestriction
 */
@JsonPropertyOrder({
  ShareStorageUnitEntityRestriction.JSON_PROPERTY_LIFECYCLE_STATUS_DATE,
  ShareStorageUnitEntityRestriction.JSON_PROPERTY_USED_GB,
  ShareStorageUnitEntityRestriction.JSON_PROPERTY_C_POOL_NAME,
  ShareStorageUnitEntityRestriction.JSON_PROPERTY_LIFECYCLE_STATUS,
  ShareStorageUnitEntityRestriction.JSON_PROPERTY_REDUNDANCY_CLASS,
  ShareStorageUnitEntityRestriction.JSON_PROPERTY_C_STORAGE_CLASS,
  ShareStorageUnitEntityRestriction.JSON_PROPERTY_CAPACITY_GB,
  ShareStorageUnitEntityRestriction.JSON_PROPERTY_REMARK,
  ShareStorageUnitEntityRestriction.JSON_PROPERTY_VISIBLE_ID,
  ShareStorageUnitEntityRestriction.JSON_PROPERTY_ID,
  ShareStorageUnitEntityRestriction.JSON_PROPERTY_REDUNDANCY,
  ShareStorageUnitEntityRestriction.JSON_PROPERTY_ELID
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-03-04T13:31:32.601557352Z[Etc/UTC]")
public class ShareStorageUnitEntityRestriction {
  ...
  public ShareStorageUnitEntityRestriction() {
  }

  public ShareStorageUnitEntityRestriction lifecycleStatusDate(RestrictionsDate lifecycleStatusDate) {
  ...
  **/
  ...
  public ShareStorageUnitEntityRestriction usedGb(RestrictionsNumeric usedGb) {
  ...
  **/
  ...
  public ShareStorageUnitEntityRestriction cPoolName(RestrictionsString cPoolName) {
  ...
  **/
  ...
  public ShareStorageUnitEntityRestriction lifecycleStatus(RestrictionsString lifecycleStatus) {
  ...
  **/
  ...
  public ShareStorageUnitEntityRestriction redundancyClass(RestrictionsString redundancyClass) {
  ...
  **/
  ...
  public ShareStorageUnitEntityRestriction cStorageClass(RestrictionsString cStorageClass) {
  ...
  **/
  ...
  public ShareStorageUnitEntityRestriction capacityGb(RestrictionsNumeric capacityGb) {
  ...
  **/
  ...
  public ShareStorageUnitEntityRestriction remark(RestrictionsString remark) {
  ...
  **/
  ...
  public ShareStorageUnitEntityRestriction visibleId(RestrictionsString visibleId) {
  ...
  **/
  ...
  public ShareStorageUnitEntityRestriction id(RestrictionsString id) {
  ...
  **/
  ...
  public ShareStorageUnitEntityRestriction redundancy(RestrictionsBoolean redundancy) {
  ...
  **/
  ...
  public ShareStorageUnitEntityRestriction elid(RestrictionsString elid) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ShareStorageUnitEntityRestriction shareStorageUnitEntityRestriction = (ShareStorageUnitEntityRestriction) o;
    return Objects.equals(this.lifecycleStatusDate, shareStorageUnitEntityRestriction.lifecycleStatusDate) &&
        Objects.equals(this.usedGb, shareStorageUnitEntityRestriction.usedGb) &&
        Objects.equals(this.cPoolName, shareStorageUnitEntityRestriction.cPoolName) &&
        Objects.equals(this.lifecycleStatus, shareStorageUnitEntityRestriction.lifecycleStatus) &&
        Objects.equals(this.redundancyClass, shareStorageUnitEntityRestriction.redundancyClass) &&
        Objects.equals(this.cStorageClass, shareStorageUnitEntityRestriction.cStorageClass) &&
        Objects.equals(this.capacityGb, shareStorageUnitEntityRestriction.capacityGb) &&
        Objects.equals(this.remark, shareStorageUnitEntityRestriction.remark) &&
        Objects.equals(this.visibleId, shareStorageUnitEntityRestriction.visibleId) &&
        Objects.equals(this.id, shareStorageUnitEntityRestriction.id) &&
        Objects.equals(this.redundancy, shareStorageUnitEntityRestriction.redundancy) &&
        Objects.equals(this.elid, shareStorageUnitEntityRestriction.elid);
  }
  ...
  public String toString() {
    ...
    sb.append("class ShareStorageUnitEntityRestriction {\n");
