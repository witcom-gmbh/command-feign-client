...
import com.fntsoftware.businessgateway.entities.VirtualClientServerEntityRestriction;
...
/**
 * VirtualClientServerRequestData
 */
@JsonPropertyOrder({
  VirtualClientServerRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  VirtualClientServerRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  VirtualClientServerRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  VirtualClientServerRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-02-26T11:20:24.990023935Z[Etc/UTC]")
public class VirtualClientServerRequestData {
  ...
  private VirtualClientServerEntityRestriction entityRestrictions;
  ...
  public VirtualClientServerRequestData() {
  }

  public VirtualClientServerRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public VirtualClientServerRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public VirtualClientServerRequestData entityRestrictions(VirtualClientServerEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public VirtualClientServerEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(VirtualClientServerEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public VirtualClientServerRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public VirtualClientServerRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public VirtualClientServerRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    VirtualClientServerRequestData virtualClientServerRequestData = (VirtualClientServerRequestData) o;
    return Objects.equals(this.returnEntityAttributes, virtualClientServerRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, virtualClientServerRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, virtualClientServerRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, virtualClientServerRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class VirtualClientServerRequestData {\n");
