...
import com.fntsoftware.businessgateway.entities.UpdateIpv4NetworkCreateLinkVirtualClientRequestData;
...
import com.fntsoftware.businessgateway.entities.UpdateIpv4NetworkDeleteLinkVirtualClientRequestData;
...
@JsonPropertyOrder({
  ...
  UpdateIpv4NetworkRequestData.JSON_PROPERTY_CREATE_LINK_VIRTUAL_CLIENT,
  ...
  UpdateIpv4NetworkRequestData.JSON_PROPERTY_DELETE_LINK_VIRTUAL_CLIENT,
...
public class UpdateIpv4NetworkRequestData {
  ...
  private List<UpdateIpv4NetworkCreateLinkVirtualClientRequestData> createLinkVirtualClient;
  ...
  private List<UpdateIpv4NetworkDeleteLinkVirtualClientRequestData> deleteLinkVirtualClient;
  ...
  **/
  ...
  public UpdateIpv4NetworkRequestData createLinkVirtualClient(List<UpdateIpv4NetworkCreateLinkVirtualClientRequestData> createLinkVirtualClient) {
    
    this.createLinkVirtualClient = createLinkVirtualClient;
    return this;
  }

  public UpdateIpv4NetworkRequestData addCreateLinkVirtualClientItem(UpdateIpv4NetworkCreateLinkVirtualClientRequestData createLinkVirtualClientItem) {
  ...
  **/
  ...
  public List<UpdateIpv4NetworkCreateLinkVirtualClientRequestData> getCreateLinkVirtualClient() {
    return createLinkVirtualClient;
  }
  ...
  @JsonProperty(JSON_PROPERTY_CREATE_LINK_VIRTUAL_CLIENT)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setCreateLinkVirtualClient(List<UpdateIpv4NetworkCreateLinkVirtualClientRequestData> createLinkVirtualClient) {
    this.createLinkVirtualClient = createLinkVirtualClient;
  }
  ...
  **/
  ...
  public UpdateIpv4NetworkRequestData deleteLinkVirtualClient(List<UpdateIpv4NetworkDeleteLinkVirtualClientRequestData> deleteLinkVirtualClient) {
    
    this.deleteLinkVirtualClient = deleteLinkVirtualClient;
    return this;
  }

  public UpdateIpv4NetworkRequestData addDeleteLinkVirtualClientItem(UpdateIpv4NetworkDeleteLinkVirtualClientRequestData deleteLinkVirtualClientItem) {
  ...
  **/
  ...
  public List<UpdateIpv4NetworkDeleteLinkVirtualClientRequestData> getDeleteLinkVirtualClient() {
    return deleteLinkVirtualClient;
  }
  ...
  @JsonProperty(JSON_PROPERTY_DELETE_LINK_VIRTUAL_CLIENT)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setDeleteLinkVirtualClient(List<UpdateIpv4NetworkDeleteLinkVirtualClientRequestData> deleteLinkVirtualClient) {
    this.deleteLinkVirtualClient = deleteLinkVirtualClient;
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.cRirDocumentationReq, updateIpv4NetworkRequestData.cRirDocumentationReq) &&
        ...
        Objects.equals(this.createLinkVirtualClient, updateIpv4NetworkRequestData.createLinkVirtualClient) &&
        ...
        Objects.equals(this.deleteLinkVirtualClient, updateIpv4NetworkRequestData.deleteLinkVirtualClient) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(cRirDocumentationReq, lookup, useBroadcastIp, cAdminPersonId, dhcpServer, dhcpScopeType, contextId, remark, dhcpLeaseTime, function, useNetIp, name, primaryScopeElid, dhcpScopeName, cOrgNr, dhcp, createLinkContract, createLinkCustomIpaccessSvc, createLinkCustomL2CpeSegment, createLinkDeviceAll, createLinkFrameContract, createLinkGateway, createLinkMaintenanceContract, createLinkOrganization, createLinkPerson, createLinkPersonGroup, createLinkVirtualClient, createLinkVirtualNasServer, createLinkVirtualSwitch, createLinkZone, deleteLinkContract, deleteLinkCustomIpaccessSvc, deleteLinkDeviceAll, deleteLinkFrameContract, deleteLinkMaintenanceContract, deleteLinkOrganization, deleteLinkPerson, deleteLinkPersonGroup, deleteLinkVirtualClient, deleteLinkVirtualNasServer, deleteLinkVirtualSwitch, deleteLinkZone, swapLinkDomain, swapLinkNetMandator, swapLinkNetrangeName, updateLinkCustomIpaccessSvc, updateLinkOrganization, updateLinkPerson, updateLinkPersonGroup);
  }
