...
import com.fntsoftware.businessgateway.entities.PhysicalConnectionPowerCableEntityRestriction;
...
/**
 * PhysicalConnectionPowerCableRequestData
 */
@JsonPropertyOrder({
  PhysicalConnectionPowerCableRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  PhysicalConnectionPowerCableRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  PhysicalConnectionPowerCableRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  PhysicalConnectionPowerCableRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-03-04T13:31:32.601557352Z[Etc/UTC]")
public class PhysicalConnectionPowerCableRequestData {
  ...
  private PhysicalConnectionPowerCableEntityRestriction entityRestrictions;
  ...
  public PhysicalConnectionPowerCableRequestData() {
  }

  public PhysicalConnectionPowerCableRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public PhysicalConnectionPowerCableRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public PhysicalConnectionPowerCableRequestData entityRestrictions(PhysicalConnectionPowerCableEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public PhysicalConnectionPowerCableEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(PhysicalConnectionPowerCableEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public PhysicalConnectionPowerCableRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public PhysicalConnectionPowerCableRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public PhysicalConnectionPowerCableRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    PhysicalConnectionPowerCableRequestData physicalConnectionPowerCableRequestData = (PhysicalConnectionPowerCableRequestData) o;
    return Objects.equals(this.returnEntityAttributes, physicalConnectionPowerCableRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, physicalConnectionPowerCableRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, physicalConnectionPowerCableRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, physicalConnectionPowerCableRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class PhysicalConnectionPowerCableRequestData {\n");
