...
import com.fntsoftware.businessgateway.entities.JunctionBoxZoneEntityRestriction;
...
/**
 * JunctionBoxZoneRequestData
 */
@JsonPropertyOrder({
  JunctionBoxZoneRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  JunctionBoxZoneRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  JunctionBoxZoneRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  JunctionBoxZoneRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-01-31T11:10:37.320689708Z[Etc/UTC]")
public class JunctionBoxZoneRequestData {
  ...
  private JunctionBoxZoneEntityRestriction entityRestrictions;
  ...
  public JunctionBoxZoneRequestData() {
  }

  public JunctionBoxZoneRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public JunctionBoxZoneRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public JunctionBoxZoneRequestData entityRestrictions(JunctionBoxZoneEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public JunctionBoxZoneEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(JunctionBoxZoneEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public JunctionBoxZoneRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public JunctionBoxZoneRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public JunctionBoxZoneRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    JunctionBoxZoneRequestData junctionBoxZoneRequestData = (JunctionBoxZoneRequestData) o;
    return Objects.equals(this.returnEntityAttributes, junctionBoxZoneRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, junctionBoxZoneRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, junctionBoxZoneRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, junctionBoxZoneRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class JunctionBoxZoneRequestData {\n");
