...
/**
 * SessionIsAliveRequest
 */
@JsonPropertyOrder({
  SessionIsAliveRequest.JSON_PROPERTY_RETURN_ATTRIBUTES,
  SessionIsAliveRequest.JSON_PROPERTY_RESTRICTIONS
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-01-31T11:10:37.320689708Z[Etc/UTC]")
public class SessionIsAliveRequest {
  ...
  public SessionIsAliveRequest() {
  }

  public SessionIsAliveRequest returnAttributes(List<String> returnAttributes) {
    
    this.returnAttributes = returnAttributes;
    return this;
  }

  public SessionIsAliveRequest addReturnAttributesItem(String returnAttributesItem) {
  ...
  **/
  ...
  public SessionIsAliveRequest restrictions(Object restrictions) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    SessionIsAliveRequest sessionIsAliveRequest = (SessionIsAliveRequest) o;
    return Objects.equals(this.returnAttributes, sessionIsAliveRequest.returnAttributes) &&
        Objects.equals(this.restrictions, sessionIsAliveRequest.restrictions);
  }
  ...
  public String toString() {
    ...
    sb.append("class SessionIsAliveRequest {\n");
