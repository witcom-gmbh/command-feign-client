...
import com.fntsoftware.businessgateway.entities.FusePhysicalPortsPowerEntityRestriction;
...
/**
 * FusePhysicalPortsPowerRequestData
 */
@JsonPropertyOrder({
  FusePhysicalPortsPowerRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  FusePhysicalPortsPowerRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  FusePhysicalPortsPowerRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  FusePhysicalPortsPowerRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-02-26T11:20:24.990023935Z[Etc/UTC]")
public class FusePhysicalPortsPowerRequestData {
  ...
  private FusePhysicalPortsPowerEntityRestriction entityRestrictions;
  ...
  public FusePhysicalPortsPowerRequestData() {
  }

  public FusePhysicalPortsPowerRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public FusePhysicalPortsPowerRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public FusePhysicalPortsPowerRequestData entityRestrictions(FusePhysicalPortsPowerEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public FusePhysicalPortsPowerEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(FusePhysicalPortsPowerEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public FusePhysicalPortsPowerRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public FusePhysicalPortsPowerRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public FusePhysicalPortsPowerRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    FusePhysicalPortsPowerRequestData fusePhysicalPortsPowerRequestData = (FusePhysicalPortsPowerRequestData) o;
    return Objects.equals(this.returnEntityAttributes, fusePhysicalPortsPowerRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, fusePhysicalPortsPowerRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, fusePhysicalPortsPowerRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, fusePhysicalPortsPowerRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class FusePhysicalPortsPowerRequestData {\n");
