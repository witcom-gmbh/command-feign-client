...
import com.fntsoftware.businessgateway.entities.StorageBaseDeviceMasterEntityRestriction;
...
/**
 * StorageBaseDeviceMasterRequestData
 */
@JsonPropertyOrder({
  StorageBaseDeviceMasterRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  StorageBaseDeviceMasterRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  StorageBaseDeviceMasterRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  StorageBaseDeviceMasterRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-03-04T13:31:32.601557352Z[Etc/UTC]")
public class StorageBaseDeviceMasterRequestData {
  ...
  private StorageBaseDeviceMasterEntityRestriction entityRestrictions;
  ...
  public StorageBaseDeviceMasterRequestData() {
  }

  public StorageBaseDeviceMasterRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public StorageBaseDeviceMasterRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public StorageBaseDeviceMasterRequestData entityRestrictions(StorageBaseDeviceMasterEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public StorageBaseDeviceMasterEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(StorageBaseDeviceMasterEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public StorageBaseDeviceMasterRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public StorageBaseDeviceMasterRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public StorageBaseDeviceMasterRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    StorageBaseDeviceMasterRequestData storageBaseDeviceMasterRequestData = (StorageBaseDeviceMasterRequestData) o;
    return Objects.equals(this.returnEntityAttributes, storageBaseDeviceMasterRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, storageBaseDeviceMasterRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, storageBaseDeviceMasterRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, storageBaseDeviceMasterRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class StorageBaseDeviceMasterRequestData {\n");
