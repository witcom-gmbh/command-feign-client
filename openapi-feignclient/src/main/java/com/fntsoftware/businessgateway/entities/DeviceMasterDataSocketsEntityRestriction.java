...
/**
 * DeviceMasterDataSocketsEntityRestriction
 */
@JsonPropertyOrder({
  DeviceMasterDataSocketsEntityRestriction.JSON_PROPERTY_CLIMATE_RELEVANT,
  DeviceMasterDataSocketsEntityRestriction.JSON_PROPERTY_POWER_CONSUMPTION,
  DeviceMasterDataSocketsEntityRestriction.JSON_PROPERTY_POWER_SWITCHING_STATUS,
  DeviceMasterDataSocketsEntityRestriction.JSON_PROPERTY_PLAN_STATUS,
  DeviceMasterDataSocketsEntityRestriction.JSON_PROPERTY_SYSTEM_RUNTIME,
  DeviceMasterDataSocketsEntityRestriction.JSON_PROPERTY_WEIGHT,
  DeviceMasterDataSocketsEntityRestriction.JSON_PROPERTY_REMARK,
  DeviceMasterDataSocketsEntityRestriction.JSON_PROPERTY_ELID,
  DeviceMasterDataSocketsEntityRestriction.JSON_PROPERTY_LAST_SEEN,
  DeviceMasterDataSocketsEntityRestriction.JSON_PROPERTY_TYPE_ELID,
  DeviceMasterDataSocketsEntityRestriction.JSON_PROPERTY_VISIBLE_ID,
  DeviceMasterDataSocketsEntityRestriction.JSON_PROPERTY_ID,
  DeviceMasterDataSocketsEntityRestriction.JSON_PROPERTY_HEAT_EMISSION
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-03-04T13:31:32.601557352Z[Etc/UTC]")
public class DeviceMasterDataSocketsEntityRestriction {
  ...
  public DeviceMasterDataSocketsEntityRestriction() {
  }

  public DeviceMasterDataSocketsEntityRestriction climateRelevant(RestrictionsBoolean climateRelevant) {
  ...
  **/
  ...
  public DeviceMasterDataSocketsEntityRestriction powerConsumption(RestrictionsNumeric powerConsumption) {
  ...
  **/
  ...
  public DeviceMasterDataSocketsEntityRestriction powerSwitchingStatus(RestrictionsString powerSwitchingStatus) {
  ...
  **/
  ...
  public DeviceMasterDataSocketsEntityRestriction planStatus(RestrictionsString planStatus) {
  ...
  **/
  ...
  public DeviceMasterDataSocketsEntityRestriction systemRuntime(RestrictionsNumeric systemRuntime) {
  ...
  **/
  ...
  public DeviceMasterDataSocketsEntityRestriction weight(RestrictionsNumeric weight) {
  ...
  **/
  ...
  public DeviceMasterDataSocketsEntityRestriction remark(RestrictionsString remark) {
  ...
  **/
  ...
  public DeviceMasterDataSocketsEntityRestriction elid(RestrictionsString elid) {
  ...
  **/
  ...
  public DeviceMasterDataSocketsEntityRestriction lastSeen(RestrictionsDate lastSeen) {
  ...
  **/
  ...
  public DeviceMasterDataSocketsEntityRestriction typeElid(RestrictionsString typeElid) {
  ...
  **/
  ...
  public DeviceMasterDataSocketsEntityRestriction visibleId(RestrictionsString visibleId) {
  ...
  **/
  ...
  public DeviceMasterDataSocketsEntityRestriction id(RestrictionsString id) {
  ...
  **/
  ...
  public DeviceMasterDataSocketsEntityRestriction heatEmission(RestrictionsNumeric heatEmission) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    DeviceMasterDataSocketsEntityRestriction deviceMasterDataSocketsEntityRestriction = (DeviceMasterDataSocketsEntityRestriction) o;
    return Objects.equals(this.climateRelevant, deviceMasterDataSocketsEntityRestriction.climateRelevant) &&
        Objects.equals(this.powerConsumption, deviceMasterDataSocketsEntityRestriction.powerConsumption) &&
        Objects.equals(this.powerSwitchingStatus, deviceMasterDataSocketsEntityRestriction.powerSwitchingStatus) &&
        Objects.equals(this.planStatus, deviceMasterDataSocketsEntityRestriction.planStatus) &&
        Objects.equals(this.systemRuntime, deviceMasterDataSocketsEntityRestriction.systemRuntime) &&
        Objects.equals(this.weight, deviceMasterDataSocketsEntityRestriction.weight) &&
        Objects.equals(this.remark, deviceMasterDataSocketsEntityRestriction.remark) &&
        Objects.equals(this.elid, deviceMasterDataSocketsEntityRestriction.elid) &&
        Objects.equals(this.lastSeen, deviceMasterDataSocketsEntityRestriction.lastSeen) &&
        Objects.equals(this.typeElid, deviceMasterDataSocketsEntityRestriction.typeElid) &&
        Objects.equals(this.visibleId, deviceMasterDataSocketsEntityRestriction.visibleId) &&
        Objects.equals(this.id, deviceMasterDataSocketsEntityRestriction.id) &&
        Objects.equals(this.heatEmission, deviceMasterDataSocketsEntityRestriction.heatEmission);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeviceMasterDataSocketsEntityRestriction {\n");
