...
/**
 * UpdateSystemAttributesDriveAddUserRequestData
 */
@JsonPropertyOrder({
  UpdateSystemAttributesDriveAddUserRequestData.JSON_PROPERTY_MODIFY_PLAN,
  UpdateSystemAttributesDriveAddUserRequestData.JSON_PROPERTY_DELETE_REAL,
  UpdateSystemAttributesDriveAddUserRequestData.JSON_PROPERTY_READ_PLAN,
  UpdateSystemAttributesDriveAddUserRequestData.JSON_PROPERTY_MANDANT_ID,
  UpdateSystemAttributesDriveAddUserRequestData.JSON_PROPERTY_USER_ELID,
  UpdateSystemAttributesDriveAddUserRequestData.JSON_PROPERTY_MODIFY_REAL,
  UpdateSystemAttributesDriveAddUserRequestData.JSON_PROPERTY_READ_REAL,
  UpdateSystemAttributesDriveAddUserRequestData.JSON_PROPERTY_DELETE_PLAN
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-02-26T11:20:24.990023935Z[Etc/UTC]")
public class UpdateSystemAttributesDriveAddUserRequestData {
  ...
  public UpdateSystemAttributesDriveAddUserRequestData() {
  }

  public UpdateSystemAttributesDriveAddUserRequestData modifyPlan(Boolean modifyPlan) {
  ...
  **/
  ...
  public UpdateSystemAttributesDriveAddUserRequestData deleteReal(Boolean deleteReal) {
  ...
  **/
  ...
  public UpdateSystemAttributesDriveAddUserRequestData readPlan(Boolean readPlan) {
  ...
  **/
  ...
  public UpdateSystemAttributesDriveAddUserRequestData mandantId(BigDecimal mandantId) {
  ...
  **/
  ...
  public UpdateSystemAttributesDriveAddUserRequestData userElid(String userElid) {
  ...
  **/
  ...
  public UpdateSystemAttributesDriveAddUserRequestData modifyReal(Boolean modifyReal) {
  ...
  **/
  ...
  public UpdateSystemAttributesDriveAddUserRequestData readReal(Boolean readReal) {
  ...
  **/
  ...
  public UpdateSystemAttributesDriveAddUserRequestData deletePlan(Boolean deletePlan) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    UpdateSystemAttributesDriveAddUserRequestData updateSystemAttributesDriveAddUserRequestData = (UpdateSystemAttributesDriveAddUserRequestData) o;
    return Objects.equals(this.modifyPlan, updateSystemAttributesDriveAddUserRequestData.modifyPlan) &&
        Objects.equals(this.deleteReal, updateSystemAttributesDriveAddUserRequestData.deleteReal) &&
        Objects.equals(this.readPlan, updateSystemAttributesDriveAddUserRequestData.readPlan) &&
        Objects.equals(this.mandantId, updateSystemAttributesDriveAddUserRequestData.mandantId) &&
        Objects.equals(this.userElid, updateSystemAttributesDriveAddUserRequestData.userElid) &&
        Objects.equals(this.modifyReal, updateSystemAttributesDriveAddUserRequestData.modifyReal) &&
        Objects.equals(this.readReal, updateSystemAttributesDriveAddUserRequestData.readReal) &&
        Objects.equals(this.deletePlan, updateSystemAttributesDriveAddUserRequestData.deletePlan);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateSystemAttributesDriveAddUserRequestData {\n");
