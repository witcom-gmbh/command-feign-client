...
/**
 * UpdateSystemAttributesPersonAddUserRequestData
 */
@JsonPropertyOrder({
  UpdateSystemAttributesPersonAddUserRequestData.JSON_PROPERTY_MODIFY_PLAN,
  UpdateSystemAttributesPersonAddUserRequestData.JSON_PROPERTY_DELETE_REAL,
  UpdateSystemAttributesPersonAddUserRequestData.JSON_PROPERTY_READ_PLAN,
  UpdateSystemAttributesPersonAddUserRequestData.JSON_PROPERTY_MANDANT_ID,
  UpdateSystemAttributesPersonAddUserRequestData.JSON_PROPERTY_USER_ELID,
  UpdateSystemAttributesPersonAddUserRequestData.JSON_PROPERTY_MODIFY_REAL,
  UpdateSystemAttributesPersonAddUserRequestData.JSON_PROPERTY_READ_REAL,
  UpdateSystemAttributesPersonAddUserRequestData.JSON_PROPERTY_DELETE_PLAN
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-01-31T11:10:37.320689708Z[Etc/UTC]")
public class UpdateSystemAttributesPersonAddUserRequestData {
  ...
  public UpdateSystemAttributesPersonAddUserRequestData() {
  }

  public UpdateSystemAttributesPersonAddUserRequestData modifyPlan(Boolean modifyPlan) {
  ...
  **/
  ...
  public UpdateSystemAttributesPersonAddUserRequestData deleteReal(Boolean deleteReal) {
  ...
  **/
  ...
  public UpdateSystemAttributesPersonAddUserRequestData readPlan(Boolean readPlan) {
  ...
  **/
  ...
  public UpdateSystemAttributesPersonAddUserRequestData mandantId(BigDecimal mandantId) {
  ...
  **/
  ...
  public UpdateSystemAttributesPersonAddUserRequestData userElid(String userElid) {
  ...
  **/
  ...
  public UpdateSystemAttributesPersonAddUserRequestData modifyReal(Boolean modifyReal) {
  ...
  **/
  ...
  public UpdateSystemAttributesPersonAddUserRequestData readReal(Boolean readReal) {
  ...
  **/
  ...
  public UpdateSystemAttributesPersonAddUserRequestData deletePlan(Boolean deletePlan) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    UpdateSystemAttributesPersonAddUserRequestData updateSystemAttributesPersonAddUserRequestData = (UpdateSystemAttributesPersonAddUserRequestData) o;
    return Objects.equals(this.modifyPlan, updateSystemAttributesPersonAddUserRequestData.modifyPlan) &&
        Objects.equals(this.deleteReal, updateSystemAttributesPersonAddUserRequestData.deleteReal) &&
        Objects.equals(this.readPlan, updateSystemAttributesPersonAddUserRequestData.readPlan) &&
        Objects.equals(this.mandantId, updateSystemAttributesPersonAddUserRequestData.mandantId) &&
        Objects.equals(this.userElid, updateSystemAttributesPersonAddUserRequestData.userElid) &&
        Objects.equals(this.modifyReal, updateSystemAttributesPersonAddUserRequestData.modifyReal) &&
        Objects.equals(this.readReal, updateSystemAttributesPersonAddUserRequestData.readReal) &&
        Objects.equals(this.deletePlan, updateSystemAttributesPersonAddUserRequestData.deletePlan);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateSystemAttributesPersonAddUserRequestData {\n");
