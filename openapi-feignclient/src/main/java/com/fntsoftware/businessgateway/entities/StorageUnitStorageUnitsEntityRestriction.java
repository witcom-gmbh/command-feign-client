...
/**
 * StorageUnitStorageUnitsEntityRestriction
 */
@JsonPropertyOrder({
  StorageUnitStorageUnitsEntityRestriction.JSON_PROPERTY_LIFECYCLE_STATUS_DATE,
  StorageUnitStorageUnitsEntityRestriction.JSON_PROPERTY_USED_GB,
  StorageUnitStorageUnitsEntityRestriction.JSON_PROPERTY_C_POOL_NAME,
  StorageUnitStorageUnitsEntityRestriction.JSON_PROPERTY_LIFECYCLE_STATUS,
  StorageUnitStorageUnitsEntityRestriction.JSON_PROPERTY_REDUNDANCY_CLASS,
  StorageUnitStorageUnitsEntityRestriction.JSON_PROPERTY_C_STORAGE_CLASS,
  StorageUnitStorageUnitsEntityRestriction.JSON_PROPERTY_CAPACITY_GB,
  StorageUnitStorageUnitsEntityRestriction.JSON_PROPERTY_REMARK,
  StorageUnitStorageUnitsEntityRestriction.JSON_PROPERTY_VISIBLE_ID,
  StorageUnitStorageUnitsEntityRestriction.JSON_PROPERTY_ID,
  StorageUnitStorageUnitsEntityRestriction.JSON_PROPERTY_REDUNDANCY,
  StorageUnitStorageUnitsEntityRestriction.JSON_PROPERTY_ELID
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-02-26T11:20:24.990023935Z[Etc/UTC]")
public class StorageUnitStorageUnitsEntityRestriction {
  ...
  public StorageUnitStorageUnitsEntityRestriction() {
  }

  public StorageUnitStorageUnitsEntityRestriction lifecycleStatusDate(RestrictionsDate lifecycleStatusDate) {
  ...
  **/
  ...
  public StorageUnitStorageUnitsEntityRestriction usedGb(RestrictionsNumeric usedGb) {
  ...
  **/
  ...
  public StorageUnitStorageUnitsEntityRestriction cPoolName(RestrictionsString cPoolName) {
  ...
  **/
  ...
  public StorageUnitStorageUnitsEntityRestriction lifecycleStatus(RestrictionsString lifecycleStatus) {
  ...
  **/
  ...
  public StorageUnitStorageUnitsEntityRestriction redundancyClass(RestrictionsString redundancyClass) {
  ...
  **/
  ...
  public StorageUnitStorageUnitsEntityRestriction cStorageClass(RestrictionsString cStorageClass) {
  ...
  **/
  ...
  public StorageUnitStorageUnitsEntityRestriction capacityGb(RestrictionsNumeric capacityGb) {
  ...
  **/
  ...
  public StorageUnitStorageUnitsEntityRestriction remark(RestrictionsString remark) {
  ...
  **/
  ...
  public StorageUnitStorageUnitsEntityRestriction visibleId(RestrictionsString visibleId) {
  ...
  **/
  ...
  public StorageUnitStorageUnitsEntityRestriction id(RestrictionsString id) {
  ...
  **/
  ...
  public StorageUnitStorageUnitsEntityRestriction redundancy(RestrictionsBoolean redundancy) {
  ...
  **/
  ...
  public StorageUnitStorageUnitsEntityRestriction elid(RestrictionsString elid) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    StorageUnitStorageUnitsEntityRestriction storageUnitStorageUnitsEntityRestriction = (StorageUnitStorageUnitsEntityRestriction) o;
    return Objects.equals(this.lifecycleStatusDate, storageUnitStorageUnitsEntityRestriction.lifecycleStatusDate) &&
        Objects.equals(this.usedGb, storageUnitStorageUnitsEntityRestriction.usedGb) &&
        Objects.equals(this.cPoolName, storageUnitStorageUnitsEntityRestriction.cPoolName) &&
        Objects.equals(this.lifecycleStatus, storageUnitStorageUnitsEntityRestriction.lifecycleStatus) &&
        Objects.equals(this.redundancyClass, storageUnitStorageUnitsEntityRestriction.redundancyClass) &&
        Objects.equals(this.cStorageClass, storageUnitStorageUnitsEntityRestriction.cStorageClass) &&
        Objects.equals(this.capacityGb, storageUnitStorageUnitsEntityRestriction.capacityGb) &&
        Objects.equals(this.remark, storageUnitStorageUnitsEntityRestriction.remark) &&
        Objects.equals(this.visibleId, storageUnitStorageUnitsEntityRestriction.visibleId) &&
        Objects.equals(this.id, storageUnitStorageUnitsEntityRestriction.id) &&
        Objects.equals(this.redundancy, storageUnitStorageUnitsEntityRestriction.redundancy) &&
        Objects.equals(this.elid, storageUnitStorageUnitsEntityRestriction.elid);
  }
  ...
  public String toString() {
    ...
    sb.append("class StorageUnitStorageUnitsEntityRestriction {\n");
