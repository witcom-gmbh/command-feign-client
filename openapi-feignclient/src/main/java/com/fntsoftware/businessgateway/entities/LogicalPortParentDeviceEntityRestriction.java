...
/**
 * LogicalPortParentDeviceEntityRestriction
 */
@JsonPropertyOrder({
  LogicalPortParentDeviceEntityRestriction.JSON_PROPERTY_CLIMATE_RELEVANT,
  LogicalPortParentDeviceEntityRestriction.JSON_PROPERTY_POWER_CONSUMPTION,
  LogicalPortParentDeviceEntityRestriction.JSON_PROPERTY_POWER_SWITCHING_STATUS,
  LogicalPortParentDeviceEntityRestriction.JSON_PROPERTY_PLAN_STATUS,
  LogicalPortParentDeviceEntityRestriction.JSON_PROPERTY_SYSTEM_RUNTIME,
  LogicalPortParentDeviceEntityRestriction.JSON_PROPERTY_WEIGHT,
  LogicalPortParentDeviceEntityRestriction.JSON_PROPERTY_REMARK,
  LogicalPortParentDeviceEntityRestriction.JSON_PROPERTY_ELID,
  LogicalPortParentDeviceEntityRestriction.JSON_PROPERTY_LAST_SEEN,
  LogicalPortParentDeviceEntityRestriction.JSON_PROPERTY_TYPE_ELID,
  LogicalPortParentDeviceEntityRestriction.JSON_PROPERTY_VISIBLE_ID,
  LogicalPortParentDeviceEntityRestriction.JSON_PROPERTY_ID,
  LogicalPortParentDeviceEntityRestriction.JSON_PROPERTY_HEAT_EMISSION
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-03-04T13:31:32.601557352Z[Etc/UTC]")
public class LogicalPortParentDeviceEntityRestriction {
  ...
  public LogicalPortParentDeviceEntityRestriction() {
  }

  public LogicalPortParentDeviceEntityRestriction climateRelevant(RestrictionsBoolean climateRelevant) {
  ...
  **/
  ...
  public LogicalPortParentDeviceEntityRestriction powerConsumption(RestrictionsNumeric powerConsumption) {
  ...
  **/
  ...
  public LogicalPortParentDeviceEntityRestriction powerSwitchingStatus(RestrictionsString powerSwitchingStatus) {
  ...
  **/
  ...
  public LogicalPortParentDeviceEntityRestriction planStatus(RestrictionsString planStatus) {
  ...
  **/
  ...
  public LogicalPortParentDeviceEntityRestriction systemRuntime(RestrictionsNumeric systemRuntime) {
  ...
  **/
  ...
  public LogicalPortParentDeviceEntityRestriction weight(RestrictionsNumeric weight) {
  ...
  **/
  ...
  public LogicalPortParentDeviceEntityRestriction remark(RestrictionsString remark) {
  ...
  **/
  ...
  public LogicalPortParentDeviceEntityRestriction elid(RestrictionsString elid) {
  ...
  **/
  ...
  public LogicalPortParentDeviceEntityRestriction lastSeen(RestrictionsDate lastSeen) {
  ...
  **/
  ...
  public LogicalPortParentDeviceEntityRestriction typeElid(RestrictionsString typeElid) {
  ...
  **/
  ...
  public LogicalPortParentDeviceEntityRestriction visibleId(RestrictionsString visibleId) {
  ...
  **/
  ...
  public LogicalPortParentDeviceEntityRestriction id(RestrictionsString id) {
  ...
  **/
  ...
  public LogicalPortParentDeviceEntityRestriction heatEmission(RestrictionsNumeric heatEmission) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    LogicalPortParentDeviceEntityRestriction logicalPortParentDeviceEntityRestriction = (LogicalPortParentDeviceEntityRestriction) o;
    return Objects.equals(this.climateRelevant, logicalPortParentDeviceEntityRestriction.climateRelevant) &&
        Objects.equals(this.powerConsumption, logicalPortParentDeviceEntityRestriction.powerConsumption) &&
        Objects.equals(this.powerSwitchingStatus, logicalPortParentDeviceEntityRestriction.powerSwitchingStatus) &&
        Objects.equals(this.planStatus, logicalPortParentDeviceEntityRestriction.planStatus) &&
        Objects.equals(this.systemRuntime, logicalPortParentDeviceEntityRestriction.systemRuntime) &&
        Objects.equals(this.weight, logicalPortParentDeviceEntityRestriction.weight) &&
        Objects.equals(this.remark, logicalPortParentDeviceEntityRestriction.remark) &&
        Objects.equals(this.elid, logicalPortParentDeviceEntityRestriction.elid) &&
        Objects.equals(this.lastSeen, logicalPortParentDeviceEntityRestriction.lastSeen) &&
        Objects.equals(this.typeElid, logicalPortParentDeviceEntityRestriction.typeElid) &&
        Objects.equals(this.visibleId, logicalPortParentDeviceEntityRestriction.visibleId) &&
        Objects.equals(this.id, logicalPortParentDeviceEntityRestriction.id) &&
        Objects.equals(this.heatEmission, logicalPortParentDeviceEntityRestriction.heatEmission);
  }
  ...
  public String toString() {
    ...
    sb.append("class LogicalPortParentDeviceEntityRestriction {\n");
