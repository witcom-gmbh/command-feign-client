...
import com.fntsoftware.businessgateway.entities.ChassisDeviceMasterEntityRestriction;
...
/**
 * ChassisDeviceMasterRequestData
 */
@JsonPropertyOrder({
  ChassisDeviceMasterRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  ChassisDeviceMasterRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  ChassisDeviceMasterRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  ChassisDeviceMasterRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-03-04T13:31:32.601557352Z[Etc/UTC]")
public class ChassisDeviceMasterRequestData {
  ...
  private ChassisDeviceMasterEntityRestriction entityRestrictions;
  ...
  public ChassisDeviceMasterRequestData() {
  }

  public ChassisDeviceMasterRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public ChassisDeviceMasterRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public ChassisDeviceMasterRequestData entityRestrictions(ChassisDeviceMasterEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public ChassisDeviceMasterEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(ChassisDeviceMasterEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public ChassisDeviceMasterRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public ChassisDeviceMasterRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public ChassisDeviceMasterRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ChassisDeviceMasterRequestData chassisDeviceMasterRequestData = (ChassisDeviceMasterRequestData) o;
    return Objects.equals(this.returnEntityAttributes, chassisDeviceMasterRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, chassisDeviceMasterRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, chassisDeviceMasterRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, chassisDeviceMasterRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class ChassisDeviceMasterRequestData {\n");
