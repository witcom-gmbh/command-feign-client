...
import com.fntsoftware.businessgateway.entities.TraySectionTraySectionTypeEntityRestriction;
...
/**
 * TraySectionTraySectionTypeRequestData
 */
@JsonPropertyOrder({
  TraySectionTraySectionTypeRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  TraySectionTraySectionTypeRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  TraySectionTraySectionTypeRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  TraySectionTraySectionTypeRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-03-04T13:31:32.601557352Z[Etc/UTC]")
public class TraySectionTraySectionTypeRequestData {
  ...
  private TraySectionTraySectionTypeEntityRestriction entityRestrictions;
  ...
  public TraySectionTraySectionTypeRequestData() {
  }

  public TraySectionTraySectionTypeRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public TraySectionTraySectionTypeRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public TraySectionTraySectionTypeRequestData entityRestrictions(TraySectionTraySectionTypeEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public TraySectionTraySectionTypeEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(TraySectionTraySectionTypeEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public TraySectionTraySectionTypeRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public TraySectionTraySectionTypeRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public TraySectionTraySectionTypeRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    TraySectionTraySectionTypeRequestData traySectionTraySectionTypeRequestData = (TraySectionTraySectionTypeRequestData) o;
    return Objects.equals(this.returnEntityAttributes, traySectionTraySectionTypeRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, traySectionTraySectionTypeRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, traySectionTraySectionTypeRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, traySectionTraySectionTypeRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class TraySectionTraySectionTypeRequestData {\n");
