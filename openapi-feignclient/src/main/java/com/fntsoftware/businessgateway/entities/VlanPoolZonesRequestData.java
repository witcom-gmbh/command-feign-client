...
import com.fntsoftware.businessgateway.entities.VlanPoolZonesEntityRestriction;
import com.fntsoftware.businessgateway.entities.VlanPoolZonesRelationRestriction;
...
/**
 * VlanPoolZonesRequestData
 */
@JsonPropertyOrder({
  VlanPoolZonesRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  VlanPoolZonesRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  VlanPoolZonesRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  VlanPoolZonesRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-03-04T13:31:32.601557352Z[Etc/UTC]")
public class VlanPoolZonesRequestData {
  ...
  private VlanPoolZonesEntityRestriction entityRestrictions;

  public static final String JSON_PROPERTY_RELATION_RESTRICTIONS = "relationRestrictions";
  private VlanPoolZonesRelationRestriction relationRestrictions;
  ...
  public VlanPoolZonesRequestData() {
  }

  public VlanPoolZonesRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public VlanPoolZonesRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public VlanPoolZonesRequestData entityRestrictions(VlanPoolZonesEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public VlanPoolZonesEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(VlanPoolZonesEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public VlanPoolZonesRequestData relationRestrictions(VlanPoolZonesRelationRestriction relationRestrictions) {
  ...
  **/
  ...
  public VlanPoolZonesRelationRestriction getRelationRestrictions() {
    return relationRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_RELATION_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRelationRestrictions(VlanPoolZonesRelationRestriction relationRestrictions) {
    this.relationRestrictions = relationRestrictions;
  }


  public VlanPoolZonesRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public VlanPoolZonesRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    VlanPoolZonesRequestData vlanPoolZonesRequestData = (VlanPoolZonesRequestData) o;
    return Objects.equals(this.returnEntityAttributes, vlanPoolZonesRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, vlanPoolZonesRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, vlanPoolZonesRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, vlanPoolZonesRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class VlanPoolZonesRequestData {\n");
