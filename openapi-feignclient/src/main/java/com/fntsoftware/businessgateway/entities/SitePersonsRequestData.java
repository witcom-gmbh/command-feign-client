...
import com.fntsoftware.businessgateway.entities.SitePersonsEntityRestriction;
import com.fntsoftware.businessgateway.entities.SitePersonsRelationRestriction;
...
/**
 * SitePersonsRequestData
 */
@JsonPropertyOrder({
  SitePersonsRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  SitePersonsRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  SitePersonsRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  SitePersonsRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-03-04T13:31:32.601557352Z[Etc/UTC]")
public class SitePersonsRequestData {
  ...
  private SitePersonsEntityRestriction entityRestrictions;

  public static final String JSON_PROPERTY_RELATION_RESTRICTIONS = "relationRestrictions";
  private SitePersonsRelationRestriction relationRestrictions;
  ...
  public SitePersonsRequestData() {
  }

  public SitePersonsRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public SitePersonsRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public SitePersonsRequestData entityRestrictions(SitePersonsEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public SitePersonsEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(SitePersonsEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public SitePersonsRequestData relationRestrictions(SitePersonsRelationRestriction relationRestrictions) {
  ...
  **/
  ...
  public SitePersonsRelationRestriction getRelationRestrictions() {
    return relationRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_RELATION_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRelationRestrictions(SitePersonsRelationRestriction relationRestrictions) {
    this.relationRestrictions = relationRestrictions;
  }


  public SitePersonsRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public SitePersonsRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    SitePersonsRequestData sitePersonsRequestData = (SitePersonsRequestData) o;
    return Objects.equals(this.returnEntityAttributes, sitePersonsRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, sitePersonsRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, sitePersonsRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, sitePersonsRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class SitePersonsRequestData {\n");
