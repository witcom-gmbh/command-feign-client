...
import com.fntsoftware.businessgateway.entities.ModuleSlotEntityRestriction;
import com.fntsoftware.businessgateway.entities.ModuleSlotRelationRestriction;
...
/**
 * ModuleSlotRequestData
 */
@JsonPropertyOrder({
  ModuleSlotRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  ModuleSlotRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  ModuleSlotRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  ModuleSlotRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-02-26T11:20:24.990023935Z[Etc/UTC]")
public class ModuleSlotRequestData {
  ...
  private ModuleSlotEntityRestriction entityRestrictions;

  public static final String JSON_PROPERTY_RELATION_RESTRICTIONS = "relationRestrictions";
  private ModuleSlotRelationRestriction relationRestrictions;
  ...
  public ModuleSlotRequestData() {
  }

  public ModuleSlotRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public ModuleSlotRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public ModuleSlotRequestData entityRestrictions(ModuleSlotEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public ModuleSlotEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(ModuleSlotEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public ModuleSlotRequestData relationRestrictions(ModuleSlotRelationRestriction relationRestrictions) {
  ...
  **/
  ...
  public ModuleSlotRelationRestriction getRelationRestrictions() {
    return relationRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_RELATION_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRelationRestrictions(ModuleSlotRelationRestriction relationRestrictions) {
    this.relationRestrictions = relationRestrictions;
  }


  public ModuleSlotRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public ModuleSlotRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ModuleSlotRequestData moduleSlotRequestData = (ModuleSlotRequestData) o;
    return Objects.equals(this.returnEntityAttributes, moduleSlotRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, moduleSlotRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, moduleSlotRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, moduleSlotRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class ModuleSlotRequestData {\n");
