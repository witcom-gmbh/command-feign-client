...
import com.fntsoftware.businessgateway.entities.DeviceMasterTerminalsEntityRestriction;
...
/**
 * DeviceMasterTerminalsRequestData
 */
@JsonPropertyOrder({
  DeviceMasterTerminalsRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  DeviceMasterTerminalsRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  DeviceMasterTerminalsRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  DeviceMasterTerminalsRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-03-04T13:31:32.601557352Z[Etc/UTC]")
public class DeviceMasterTerminalsRequestData {
  ...
  private DeviceMasterTerminalsEntityRestriction entityRestrictions;
  ...
  public DeviceMasterTerminalsRequestData() {
  }

  public DeviceMasterTerminalsRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public DeviceMasterTerminalsRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public DeviceMasterTerminalsRequestData entityRestrictions(DeviceMasterTerminalsEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public DeviceMasterTerminalsEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(DeviceMasterTerminalsEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public DeviceMasterTerminalsRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public DeviceMasterTerminalsRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public DeviceMasterTerminalsRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    DeviceMasterTerminalsRequestData deviceMasterTerminalsRequestData = (DeviceMasterTerminalsRequestData) o;
    return Objects.equals(this.returnEntityAttributes, deviceMasterTerminalsRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, deviceMasterTerminalsRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, deviceMasterTerminalsRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, deviceMasterTerminalsRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeviceMasterTerminalsRequestData {\n");
