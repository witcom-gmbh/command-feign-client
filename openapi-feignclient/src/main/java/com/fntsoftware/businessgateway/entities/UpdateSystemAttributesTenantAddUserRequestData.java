...
/**
 * UpdateSystemAttributesTenantAddUserRequestData
 */
@JsonPropertyOrder({
  UpdateSystemAttributesTenantAddUserRequestData.JSON_PROPERTY_MODIFY_PLAN,
  UpdateSystemAttributesTenantAddUserRequestData.JSON_PROPERTY_DELETE_REAL,
  UpdateSystemAttributesTenantAddUserRequestData.JSON_PROPERTY_READ_PLAN,
  UpdateSystemAttributesTenantAddUserRequestData.JSON_PROPERTY_MANDANT_ID,
  UpdateSystemAttributesTenantAddUserRequestData.JSON_PROPERTY_USER_ELID,
  UpdateSystemAttributesTenantAddUserRequestData.JSON_PROPERTY_MODIFY_REAL,
  UpdateSystemAttributesTenantAddUserRequestData.JSON_PROPERTY_READ_REAL,
  UpdateSystemAttributesTenantAddUserRequestData.JSON_PROPERTY_DELETE_PLAN
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-03-04T13:31:32.601557352Z[Etc/UTC]")
public class UpdateSystemAttributesTenantAddUserRequestData {
  ...
  public UpdateSystemAttributesTenantAddUserRequestData() {
  }

  public UpdateSystemAttributesTenantAddUserRequestData modifyPlan(Boolean modifyPlan) {
  ...
  **/
  ...
  public UpdateSystemAttributesTenantAddUserRequestData deleteReal(Boolean deleteReal) {
  ...
  **/
  ...
  public UpdateSystemAttributesTenantAddUserRequestData readPlan(Boolean readPlan) {
  ...
  **/
  ...
  public UpdateSystemAttributesTenantAddUserRequestData mandantId(BigDecimal mandantId) {
  ...
  **/
  ...
  public UpdateSystemAttributesTenantAddUserRequestData userElid(String userElid) {
  ...
  **/
  ...
  public UpdateSystemAttributesTenantAddUserRequestData modifyReal(Boolean modifyReal) {
  ...
  **/
  ...
  public UpdateSystemAttributesTenantAddUserRequestData readReal(Boolean readReal) {
  ...
  **/
  ...
  public UpdateSystemAttributesTenantAddUserRequestData deletePlan(Boolean deletePlan) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    UpdateSystemAttributesTenantAddUserRequestData updateSystemAttributesTenantAddUserRequestData = (UpdateSystemAttributesTenantAddUserRequestData) o;
    return Objects.equals(this.modifyPlan, updateSystemAttributesTenantAddUserRequestData.modifyPlan) &&
        Objects.equals(this.deleteReal, updateSystemAttributesTenantAddUserRequestData.deleteReal) &&
        Objects.equals(this.readPlan, updateSystemAttributesTenantAddUserRequestData.readPlan) &&
        Objects.equals(this.mandantId, updateSystemAttributesTenantAddUserRequestData.mandantId) &&
        Objects.equals(this.userElid, updateSystemAttributesTenantAddUserRequestData.userElid) &&
        Objects.equals(this.modifyReal, updateSystemAttributesTenantAddUserRequestData.modifyReal) &&
        Objects.equals(this.readReal, updateSystemAttributesTenantAddUserRequestData.readReal) &&
        Objects.equals(this.deletePlan, updateSystemAttributesTenantAddUserRequestData.deletePlan);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateSystemAttributesTenantAddUserRequestData {\n");
