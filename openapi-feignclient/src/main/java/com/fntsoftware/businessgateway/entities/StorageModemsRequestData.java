...
import com.fntsoftware.businessgateway.entities.StorageModemsEntityRestriction;
import com.fntsoftware.businessgateway.entities.StorageModemsRelationRestriction;
...
/**
 * StorageModemsRequestData
 */
@JsonPropertyOrder({
  StorageModemsRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  StorageModemsRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  StorageModemsRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  StorageModemsRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-01-31T11:10:37.320689708Z[Etc/UTC]")
public class StorageModemsRequestData {
  ...
  private StorageModemsEntityRestriction entityRestrictions;

  public static final String JSON_PROPERTY_RELATION_RESTRICTIONS = "relationRestrictions";
  private StorageModemsRelationRestriction relationRestrictions;
  ...
  public StorageModemsRequestData() {
  }

  public StorageModemsRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public StorageModemsRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public StorageModemsRequestData entityRestrictions(StorageModemsEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public StorageModemsEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(StorageModemsEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public StorageModemsRequestData relationRestrictions(StorageModemsRelationRestriction relationRestrictions) {
  ...
  **/
  ...
  public StorageModemsRelationRestriction getRelationRestrictions() {
    return relationRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_RELATION_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRelationRestrictions(StorageModemsRelationRestriction relationRestrictions) {
    this.relationRestrictions = relationRestrictions;
  }


  public StorageModemsRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public StorageModemsRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    StorageModemsRequestData storageModemsRequestData = (StorageModemsRequestData) o;
    return Objects.equals(this.returnEntityAttributes, storageModemsRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, storageModemsRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, storageModemsRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, storageModemsRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class StorageModemsRequestData {\n");
