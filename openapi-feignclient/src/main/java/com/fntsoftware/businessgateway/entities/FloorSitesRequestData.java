...
import com.fntsoftware.businessgateway.entities.FloorSitesEntityRestriction;
import com.fntsoftware.businessgateway.entities.FloorSitesRelationRestriction;
...
/**
 * FloorSitesRequestData
 */
@JsonPropertyOrder({
  FloorSitesRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  FloorSitesRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  FloorSitesRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  FloorSitesRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-03-04T13:31:32.601557352Z[Etc/UTC]")
public class FloorSitesRequestData {
  ...
  private FloorSitesEntityRestriction entityRestrictions;

  public static final String JSON_PROPERTY_RELATION_RESTRICTIONS = "relationRestrictions";
  private FloorSitesRelationRestriction relationRestrictions;
  ...
  public FloorSitesRequestData() {
  }

  public FloorSitesRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public FloorSitesRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public FloorSitesRequestData entityRestrictions(FloorSitesEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public FloorSitesEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(FloorSitesEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public FloorSitesRequestData relationRestrictions(FloorSitesRelationRestriction relationRestrictions) {
  ...
  **/
  ...
  public FloorSitesRelationRestriction getRelationRestrictions() {
    return relationRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_RELATION_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRelationRestrictions(FloorSitesRelationRestriction relationRestrictions) {
    this.relationRestrictions = relationRestrictions;
  }


  public FloorSitesRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public FloorSitesRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    FloorSitesRequestData floorSitesRequestData = (FloorSitesRequestData) o;
    return Objects.equals(this.returnEntityAttributes, floorSitesRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, floorSitesRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, floorSitesRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, floorSitesRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class FloorSitesRequestData {\n");
