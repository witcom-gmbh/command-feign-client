...
import com.fntsoftware.businessgateway.entities.DuctFromDeviceAllEntityRestriction;
...
/**
 * DuctFromDeviceAllRequestData
 */
@JsonPropertyOrder({
  DuctFromDeviceAllRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  DuctFromDeviceAllRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  DuctFromDeviceAllRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  DuctFromDeviceAllRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-01-31T11:10:37.320689708Z[Etc/UTC]")
public class DuctFromDeviceAllRequestData {
  ...
  private DuctFromDeviceAllEntityRestriction entityRestrictions;
  ...
  public DuctFromDeviceAllRequestData() {
  }

  public DuctFromDeviceAllRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public DuctFromDeviceAllRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public DuctFromDeviceAllRequestData entityRestrictions(DuctFromDeviceAllEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public DuctFromDeviceAllEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(DuctFromDeviceAllEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public DuctFromDeviceAllRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public DuctFromDeviceAllRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public DuctFromDeviceAllRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    DuctFromDeviceAllRequestData ductFromDeviceAllRequestData = (DuctFromDeviceAllRequestData) o;
    return Objects.equals(this.returnEntityAttributes, ductFromDeviceAllRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, ductFromDeviceAllRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, ductFromDeviceAllRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, ductFromDeviceAllRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class DuctFromDeviceAllRequestData {\n");
