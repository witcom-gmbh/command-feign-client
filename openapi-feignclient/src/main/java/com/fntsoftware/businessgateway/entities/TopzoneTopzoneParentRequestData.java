...
import com.fntsoftware.businessgateway.entities.TopzoneTopzoneParentEntityRestriction;
...
/**
 * TopzoneTopzoneParentRequestData
 */
@JsonPropertyOrder({
  TopzoneTopzoneParentRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  TopzoneTopzoneParentRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  TopzoneTopzoneParentRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  TopzoneTopzoneParentRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-03-04T13:31:32.601557352Z[Etc/UTC]")
public class TopzoneTopzoneParentRequestData {
  ...
  private TopzoneTopzoneParentEntityRestriction entityRestrictions;
  ...
  public TopzoneTopzoneParentRequestData() {
  }

  public TopzoneTopzoneParentRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public TopzoneTopzoneParentRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public TopzoneTopzoneParentRequestData entityRestrictions(TopzoneTopzoneParentEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public TopzoneTopzoneParentEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(TopzoneTopzoneParentEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public TopzoneTopzoneParentRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public TopzoneTopzoneParentRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public TopzoneTopzoneParentRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    TopzoneTopzoneParentRequestData topzoneTopzoneParentRequestData = (TopzoneTopzoneParentRequestData) o;
    return Objects.equals(this.returnEntityAttributes, topzoneTopzoneParentRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, topzoneTopzoneParentRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, topzoneTopzoneParentRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, topzoneTopzoneParentRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class TopzoneTopzoneParentRequestData {\n");
