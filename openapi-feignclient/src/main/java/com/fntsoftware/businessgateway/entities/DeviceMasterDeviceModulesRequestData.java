...
import com.fntsoftware.businessgateway.entities.DeviceMasterDeviceModulesEntityRestriction;
...
/**
 * DeviceMasterDeviceModulesRequestData
 */
@JsonPropertyOrder({
  DeviceMasterDeviceModulesRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  DeviceMasterDeviceModulesRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  DeviceMasterDeviceModulesRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  DeviceMasterDeviceModulesRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-03-04T13:31:32.601557352Z[Etc/UTC]")
public class DeviceMasterDeviceModulesRequestData {
  ...
  private DeviceMasterDeviceModulesEntityRestriction entityRestrictions;
  ...
  public DeviceMasterDeviceModulesRequestData() {
  }

  public DeviceMasterDeviceModulesRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public DeviceMasterDeviceModulesRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public DeviceMasterDeviceModulesRequestData entityRestrictions(DeviceMasterDeviceModulesEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public DeviceMasterDeviceModulesEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(DeviceMasterDeviceModulesEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public DeviceMasterDeviceModulesRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public DeviceMasterDeviceModulesRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public DeviceMasterDeviceModulesRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    DeviceMasterDeviceModulesRequestData deviceMasterDeviceModulesRequestData = (DeviceMasterDeviceModulesRequestData) o;
    return Objects.equals(this.returnEntityAttributes, deviceMasterDeviceModulesRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, deviceMasterDeviceModulesRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, deviceMasterDeviceModulesRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, deviceMasterDeviceModulesRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeviceMasterDeviceModulesRequestData {\n");
