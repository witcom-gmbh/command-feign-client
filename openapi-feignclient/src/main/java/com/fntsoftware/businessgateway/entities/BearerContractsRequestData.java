...
import com.fntsoftware.businessgateway.entities.BearerContractsEntityRestriction;
import com.fntsoftware.businessgateway.entities.BearerContractsRelationRestriction;
...
/**
 * BearerContractsRequestData
 */
@JsonPropertyOrder({
  BearerContractsRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  BearerContractsRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  BearerContractsRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  BearerContractsRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-02-26T11:20:24.990023935Z[Etc/UTC]")
public class BearerContractsRequestData {
  ...
  private BearerContractsEntityRestriction entityRestrictions;

  public static final String JSON_PROPERTY_RELATION_RESTRICTIONS = "relationRestrictions";
  private BearerContractsRelationRestriction relationRestrictions;
  ...
  public BearerContractsRequestData() {
  }

  public BearerContractsRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public BearerContractsRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public BearerContractsRequestData entityRestrictions(BearerContractsEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public BearerContractsEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(BearerContractsEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public BearerContractsRequestData relationRestrictions(BearerContractsRelationRestriction relationRestrictions) {
  ...
  **/
  ...
  public BearerContractsRelationRestriction getRelationRestrictions() {
    return relationRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_RELATION_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRelationRestrictions(BearerContractsRelationRestriction relationRestrictions) {
    this.relationRestrictions = relationRestrictions;
  }


  public BearerContractsRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public BearerContractsRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    BearerContractsRequestData bearerContractsRequestData = (BearerContractsRequestData) o;
    return Objects.equals(this.returnEntityAttributes, bearerContractsRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, bearerContractsRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, bearerContractsRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, bearerContractsRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class BearerContractsRequestData {\n");
