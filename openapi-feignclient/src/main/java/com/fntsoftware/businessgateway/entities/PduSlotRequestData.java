...
import com.fntsoftware.businessgateway.entities.PduSlotEntityRestriction;
import com.fntsoftware.businessgateway.entities.PduSlotRelationRestriction;
 ...
 */
@JsonPropertyOrder({
  PduSlotRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  PduSlotRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  PduSlotRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  PduSlotRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-01-31T11:10:37.320689708Z[Etc/UTC]")
public class PduSlotRequestData {
  ...
  private PduSlotEntityRestriction entityRestrictions;

  public static final String JSON_PROPERTY_RELATION_RESTRICTIONS = "relationRestrictions";
  private PduSlotRelationRestriction relationRestrictions;
  ...
  public PduSlotRequestData() {
  }

  public PduSlotRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public PduSlotRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public PduSlotRequestData entityRestrictions(PduSlotEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public PduSlotEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(PduSlotEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public PduSlotRequestData relationRestrictions(PduSlotRelationRestriction relationRestrictions) {
  ...
  **/
  ...
  public PduSlotRelationRestriction getRelationRestrictions() {
    return relationRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_RELATION_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRelationRestrictions(PduSlotRelationRestriction relationRestrictions) {
    this.relationRestrictions = relationRestrictions;
  }


  public PduSlotRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public PduSlotRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    PduSlotRequestData pduSlotRequestData = (PduSlotRequestData) o;
    return Objects.equals(this.returnEntityAttributes, pduSlotRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, pduSlotRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, pduSlotRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, pduSlotRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class PduSlotRequestData {\n");
