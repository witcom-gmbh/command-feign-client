...
import com.fntsoftware.businessgateway.entities.NetworkElementMasterDeviceEntityRestriction;
...
/**
 * NetworkElementMasterDeviceRequestData
 */
@JsonPropertyOrder({
  NetworkElementMasterDeviceRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  NetworkElementMasterDeviceRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  NetworkElementMasterDeviceRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  NetworkElementMasterDeviceRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-01-31T11:10:37.320689708Z[Etc/UTC]")
public class NetworkElementMasterDeviceRequestData {
  ...
  private NetworkElementMasterDeviceEntityRestriction entityRestrictions;
  ...
  public NetworkElementMasterDeviceRequestData() {
  }

  public NetworkElementMasterDeviceRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public NetworkElementMasterDeviceRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public NetworkElementMasterDeviceRequestData entityRestrictions(NetworkElementMasterDeviceEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public NetworkElementMasterDeviceEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(NetworkElementMasterDeviceEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public NetworkElementMasterDeviceRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public NetworkElementMasterDeviceRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public NetworkElementMasterDeviceRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    NetworkElementMasterDeviceRequestData networkElementMasterDeviceRequestData = (NetworkElementMasterDeviceRequestData) o;
    return Objects.equals(this.returnEntityAttributes, networkElementMasterDeviceRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, networkElementMasterDeviceRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, networkElementMasterDeviceRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, networkElementMasterDeviceRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class NetworkElementMasterDeviceRequestData {\n");
