...
import com.fntsoftware.businessgateway.entities.NmModuleVlansEntityRestriction;
import com.fntsoftware.businessgateway.entities.NmModuleVlansRelationRestriction;
...
/**
 * NmModuleVlansRequestData
 */
@JsonPropertyOrder({
  NmModuleVlansRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  NmModuleVlansRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  NmModuleVlansRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  NmModuleVlansRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-02-26T11:20:24.990023935Z[Etc/UTC]")
public class NmModuleVlansRequestData {
  ...
  private NmModuleVlansEntityRestriction entityRestrictions;

  public static final String JSON_PROPERTY_RELATION_RESTRICTIONS = "relationRestrictions";
  private NmModuleVlansRelationRestriction relationRestrictions;
  ...
  public NmModuleVlansRequestData() {
  }

  public NmModuleVlansRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public NmModuleVlansRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public NmModuleVlansRequestData entityRestrictions(NmModuleVlansEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public NmModuleVlansEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(NmModuleVlansEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public NmModuleVlansRequestData relationRestrictions(NmModuleVlansRelationRestriction relationRestrictions) {
  ...
  **/
  ...
  public NmModuleVlansRelationRestriction getRelationRestrictions() {
    return relationRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_RELATION_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRelationRestrictions(NmModuleVlansRelationRestriction relationRestrictions) {
    this.relationRestrictions = relationRestrictions;
  }


  public NmModuleVlansRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public NmModuleVlansRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    NmModuleVlansRequestData nmModuleVlansRequestData = (NmModuleVlansRequestData) o;
    return Objects.equals(this.returnEntityAttributes, nmModuleVlansRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, nmModuleVlansRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, nmModuleVlansRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, nmModuleVlansRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class NmModuleVlansRequestData {\n");
