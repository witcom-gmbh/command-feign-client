...
import com.fntsoftware.businessgateway.entities.DataSocketVlansEntityRestriction;
import com.fntsoftware.businessgateway.entities.DataSocketVlansRelationRestriction;
...
/**
 * DataSocketVlansRequestData
 */
@JsonPropertyOrder({
  DataSocketVlansRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  DataSocketVlansRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  DataSocketVlansRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  DataSocketVlansRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-02-26T11:20:24.990023935Z[Etc/UTC]")
public class DataSocketVlansRequestData {
  ...
  private DataSocketVlansEntityRestriction entityRestrictions;

  public static final String JSON_PROPERTY_RELATION_RESTRICTIONS = "relationRestrictions";
  private DataSocketVlansRelationRestriction relationRestrictions;
  ...
  public DataSocketVlansRequestData() {
  }

  public DataSocketVlansRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public DataSocketVlansRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public DataSocketVlansRequestData entityRestrictions(DataSocketVlansEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public DataSocketVlansEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(DataSocketVlansEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public DataSocketVlansRequestData relationRestrictions(DataSocketVlansRelationRestriction relationRestrictions) {
  ...
  **/
  ...
  public DataSocketVlansRelationRestriction getRelationRestrictions() {
    return relationRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_RELATION_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRelationRestrictions(DataSocketVlansRelationRestriction relationRestrictions) {
    this.relationRestrictions = relationRestrictions;
  }


  public DataSocketVlansRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public DataSocketVlansRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    DataSocketVlansRequestData dataSocketVlansRequestData = (DataSocketVlansRequestData) o;
    return Objects.equals(this.returnEntityAttributes, dataSocketVlansRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, dataSocketVlansRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, dataSocketVlansRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, dataSocketVlansRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class DataSocketVlansRequestData {\n");
