...
import com.fntsoftware.businessgateway.entities.CellContractsEntityRestriction;
import com.fntsoftware.businessgateway.entities.CellContractsRelationRestriction;
...
/**
 * CellContractsRequestData
 */
@JsonPropertyOrder({
  CellContractsRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  CellContractsRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  CellContractsRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  CellContractsRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-03-04T13:31:32.601557352Z[Etc/UTC]")
public class CellContractsRequestData {
  ...
  private CellContractsEntityRestriction entityRestrictions;

  public static final String JSON_PROPERTY_RELATION_RESTRICTIONS = "relationRestrictions";
  private CellContractsRelationRestriction relationRestrictions;
  ...
  public CellContractsRequestData() {
  }

  public CellContractsRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public CellContractsRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public CellContractsRequestData entityRestrictions(CellContractsEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public CellContractsEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(CellContractsEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public CellContractsRequestData relationRestrictions(CellContractsRelationRestriction relationRestrictions) {
  ...
  **/
  ...
  public CellContractsRelationRestriction getRelationRestrictions() {
    return relationRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_RELATION_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRelationRestrictions(CellContractsRelationRestriction relationRestrictions) {
    this.relationRestrictions = relationRestrictions;
  }


  public CellContractsRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public CellContractsRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    CellContractsRequestData cellContractsRequestData = (CellContractsRequestData) o;
    return Objects.equals(this.returnEntityAttributes, cellContractsRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, cellContractsRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, cellContractsRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, cellContractsRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class CellContractsRequestData {\n");
