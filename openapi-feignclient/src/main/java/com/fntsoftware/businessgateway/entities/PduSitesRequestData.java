...
import com.fntsoftware.businessgateway.entities.PduSitesEntityRestriction;
import com.fntsoftware.businessgateway.entities.PduSitesRelationRestriction;
 ...
 */
@JsonPropertyOrder({
  PduSitesRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  PduSitesRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  PduSitesRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  PduSitesRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-01-31T11:10:37.320689708Z[Etc/UTC]")
public class PduSitesRequestData {
  ...
  private PduSitesEntityRestriction entityRestrictions;

  public static final String JSON_PROPERTY_RELATION_RESTRICTIONS = "relationRestrictions";
  private PduSitesRelationRestriction relationRestrictions;
  ...
  public PduSitesRequestData() {
  }

  public PduSitesRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public PduSitesRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public PduSitesRequestData entityRestrictions(PduSitesEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public PduSitesEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(PduSitesEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public PduSitesRequestData relationRestrictions(PduSitesRelationRestriction relationRestrictions) {
  ...
  **/
  ...
  public PduSitesRelationRestriction getRelationRestrictions() {
    return relationRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_RELATION_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRelationRestrictions(PduSitesRelationRestriction relationRestrictions) {
    this.relationRestrictions = relationRestrictions;
  }


  public PduSitesRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public PduSitesRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    PduSitesRequestData pduSitesRequestData = (PduSitesRequestData) o;
    return Objects.equals(this.returnEntityAttributes, pduSitesRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, pduSitesRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, pduSitesRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, pduSitesRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class PduSitesRequestData {\n");
