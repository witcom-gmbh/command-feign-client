...
import com.fntsoftware.businessgateway.entities.SwitchCabinetDeviceMasterEntityRestriction;
...
/**
 * SwitchCabinetDeviceMasterRequestData
 */
@JsonPropertyOrder({
  SwitchCabinetDeviceMasterRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  SwitchCabinetDeviceMasterRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  SwitchCabinetDeviceMasterRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  SwitchCabinetDeviceMasterRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-02-26T11:20:24.990023935Z[Etc/UTC]")
public class SwitchCabinetDeviceMasterRequestData {
  ...
  private SwitchCabinetDeviceMasterEntityRestriction entityRestrictions;
  ...
  public SwitchCabinetDeviceMasterRequestData() {
  }

  public SwitchCabinetDeviceMasterRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public SwitchCabinetDeviceMasterRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public SwitchCabinetDeviceMasterRequestData entityRestrictions(SwitchCabinetDeviceMasterEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public SwitchCabinetDeviceMasterEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(SwitchCabinetDeviceMasterEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public SwitchCabinetDeviceMasterRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public SwitchCabinetDeviceMasterRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public SwitchCabinetDeviceMasterRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    SwitchCabinetDeviceMasterRequestData switchCabinetDeviceMasterRequestData = (SwitchCabinetDeviceMasterRequestData) o;
    return Objects.equals(this.returnEntityAttributes, switchCabinetDeviceMasterRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, switchCabinetDeviceMasterRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, switchCabinetDeviceMasterRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, switchCabinetDeviceMasterRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class SwitchCabinetDeviceMasterRequestData {\n");
