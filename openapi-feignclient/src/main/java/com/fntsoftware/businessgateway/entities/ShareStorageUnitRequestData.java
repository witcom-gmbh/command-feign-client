...
import com.fntsoftware.businessgateway.entities.ShareStorageUnitEntityRestriction;
...
/**
 * ShareStorageUnitRequestData
 */
@JsonPropertyOrder({
  ShareStorageUnitRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  ShareStorageUnitRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  ShareStorageUnitRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  ShareStorageUnitRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-03-04T13:31:32.601557352Z[Etc/UTC]")
public class ShareStorageUnitRequestData {
  ...
  private ShareStorageUnitEntityRestriction entityRestrictions;
  ...
  public ShareStorageUnitRequestData() {
  }

  public ShareStorageUnitRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public ShareStorageUnitRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public ShareStorageUnitRequestData entityRestrictions(ShareStorageUnitEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public ShareStorageUnitEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(ShareStorageUnitEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public ShareStorageUnitRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public ShareStorageUnitRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public ShareStorageUnitRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ShareStorageUnitRequestData shareStorageUnitRequestData = (ShareStorageUnitRequestData) o;
    return Objects.equals(this.returnEntityAttributes, shareStorageUnitRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, shareStorageUnitRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, shareStorageUnitRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, shareStorageUnitRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class ShareStorageUnitRequestData {\n");
