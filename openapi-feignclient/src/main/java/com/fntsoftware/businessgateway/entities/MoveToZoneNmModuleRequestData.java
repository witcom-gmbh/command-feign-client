...
import com.fntsoftware.businessgateway.entities.MoveToZoneNmModuleCreateLinkZoneRequestData;
import com.fasterxml.jackson.annotation.JsonPropertyOrder;
import com.fasterxml.jackson.annotation.JsonTypeName;

/**
 * MoveToZoneNmModuleRequestData
 */
@JsonPropertyOrder({
  MoveToZoneNmModuleRequestData.JSON_PROPERTY_RELEASE_SIGNALPATH,
  MoveToZoneNmModuleRequestData.JSON_PROPERTY_RELEASE_CONNECTIONS,
  MoveToZoneNmModuleRequestData.JSON_PROPERTY_RELEASE_SERVICE,
  MoveToZoneNmModuleRequestData.JSON_PROPERTY_RELEASE_SUPPORTS,
  MoveToZoneNmModuleRequestData.JSON_PROPERTY_RELEASE_PATCHES,
  MoveToZoneNmModuleRequestData.JSON_PROPERTY_CREATE_LINK_ZONE
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-02-26T11:20:24.990023935Z[Etc/UTC]")
public class MoveToZoneNmModuleRequestData {
  ...
  private MoveToZoneNmModuleCreateLinkZoneRequestData createLinkZone;

  public MoveToZoneNmModuleRequestData() {
  }

  public MoveToZoneNmModuleRequestData releaseSignalpath(Boolean releaseSignalpath) {
  ...
  **/
  ...
  public MoveToZoneNmModuleRequestData releaseConnections(Boolean releaseConnections) {
  ...
  **/
  ...
  public MoveToZoneNmModuleRequestData releaseService(Boolean releaseService) {
  ...
  **/
  ...
  public MoveToZoneNmModuleRequestData releaseSupports(Boolean releaseSupports) {
  ...
  **/
  ...
  public MoveToZoneNmModuleRequestData releasePatches(Boolean releasePatches) {
  ...
  **/
  ...
  public MoveToZoneNmModuleRequestData createLinkZone(MoveToZoneNmModuleCreateLinkZoneRequestData createLinkZone) {
  ...
  **/
  ...
  public MoveToZoneNmModuleCreateLinkZoneRequestData getCreateLinkZone() {
    return createLinkZone;
  }
  ...
  @JsonProperty(JSON_PROPERTY_CREATE_LINK_ZONE)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setCreateLinkZone(MoveToZoneNmModuleCreateLinkZoneRequestData createLinkZone) {
    this.createLinkZone = createLinkZone;
  }
  ...
  public boolean equals(Object o) {
    ...
    MoveToZoneNmModuleRequestData moveToZoneNmModuleRequestData = (MoveToZoneNmModuleRequestData) o;
    return Objects.equals(this.releaseSignalpath, moveToZoneNmModuleRequestData.releaseSignalpath) &&
        Objects.equals(this.releaseConnections, moveToZoneNmModuleRequestData.releaseConnections) &&
        Objects.equals(this.releaseService, moveToZoneNmModuleRequestData.releaseService) &&
        Objects.equals(this.releaseSupports, moveToZoneNmModuleRequestData.releaseSupports) &&
        Objects.equals(this.releasePatches, moveToZoneNmModuleRequestData.releasePatches) &&
        Objects.equals(this.createLinkZone, moveToZoneNmModuleRequestData.createLinkZone);
  }
  ...
  public String toString() {
    ...
    sb.append("class MoveToZoneNmModuleRequestData {\n");
