...
import com.fntsoftware.businessgateway.entities.ServerOperatingSystemInstallationEntityRestriction;
...
/**
 * ServerOperatingSystemInstallationRequestData
 */
@JsonPropertyOrder({
  ServerOperatingSystemInstallationRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  ServerOperatingSystemInstallationRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  ServerOperatingSystemInstallationRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  ServerOperatingSystemInstallationRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-02-26T11:20:24.990023935Z[Etc/UTC]")
public class ServerOperatingSystemInstallationRequestData {
  ...
  private ServerOperatingSystemInstallationEntityRestriction entityRestrictions;
  ...
  public ServerOperatingSystemInstallationRequestData() {
  }

  public ServerOperatingSystemInstallationRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public ServerOperatingSystemInstallationRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public ServerOperatingSystemInstallationRequestData entityRestrictions(ServerOperatingSystemInstallationEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public ServerOperatingSystemInstallationEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(ServerOperatingSystemInstallationEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public ServerOperatingSystemInstallationRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public ServerOperatingSystemInstallationRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public ServerOperatingSystemInstallationRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ServerOperatingSystemInstallationRequestData serverOperatingSystemInstallationRequestData = (ServerOperatingSystemInstallationRequestData) o;
    return Objects.equals(this.returnEntityAttributes, serverOperatingSystemInstallationRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, serverOperatingSystemInstallationRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, serverOperatingSystemInstallationRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, serverOperatingSystemInstallationRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class ServerOperatingSystemInstallationRequestData {\n");
