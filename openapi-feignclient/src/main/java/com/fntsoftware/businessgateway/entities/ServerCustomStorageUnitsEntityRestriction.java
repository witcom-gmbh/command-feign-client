...
/**
 * ServerCustomStorageUnitsEntityRestriction
 */
@JsonPropertyOrder({
  ServerCustomStorageUnitsEntityRestriction.JSON_PROPERTY_LIFECYCLE_STATUS_DATE,
  ServerCustomStorageUnitsEntityRestriction.JSON_PROPERTY_USED_GB,
  ServerCustomStorageUnitsEntityRestriction.JSON_PROPERTY_C_POOL_NAME,
  ServerCustomStorageUnitsEntityRestriction.JSON_PROPERTY_LIFECYCLE_STATUS,
  ServerCustomStorageUnitsEntityRestriction.JSON_PROPERTY_REDUNDANCY_CLASS,
  ServerCustomStorageUnitsEntityRestriction.JSON_PROPERTY_C_STORAGE_CLASS,
  ServerCustomStorageUnitsEntityRestriction.JSON_PROPERTY_CAPACITY_GB,
  ServerCustomStorageUnitsEntityRestriction.JSON_PROPERTY_REMARK,
  ServerCustomStorageUnitsEntityRestriction.JSON_PROPERTY_VISIBLE_ID,
  ServerCustomStorageUnitsEntityRestriction.JSON_PROPERTY_ID,
  ServerCustomStorageUnitsEntityRestriction.JSON_PROPERTY_REDUNDANCY,
  ServerCustomStorageUnitsEntityRestriction.JSON_PROPERTY_ELID
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-01-31T11:10:37.320689708Z[Etc/UTC]")
public class ServerCustomStorageUnitsEntityRestriction {
  ...
  public ServerCustomStorageUnitsEntityRestriction() {
  }

  public ServerCustomStorageUnitsEntityRestriction lifecycleStatusDate(RestrictionsDate lifecycleStatusDate) {
  ...
  **/
  ...
  public ServerCustomStorageUnitsEntityRestriction usedGb(RestrictionsNumeric usedGb) {
  ...
  **/
  ...
  public ServerCustomStorageUnitsEntityRestriction cPoolName(RestrictionsString cPoolName) {
  ...
  **/
  ...
  public ServerCustomStorageUnitsEntityRestriction lifecycleStatus(RestrictionsString lifecycleStatus) {
  ...
  **/
  ...
  public ServerCustomStorageUnitsEntityRestriction redundancyClass(RestrictionsString redundancyClass) {
  ...
  **/
  ...
  public ServerCustomStorageUnitsEntityRestriction cStorageClass(RestrictionsString cStorageClass) {
  ...
  **/
  ...
  public ServerCustomStorageUnitsEntityRestriction capacityGb(RestrictionsNumeric capacityGb) {
  ...
  **/
  ...
  public ServerCustomStorageUnitsEntityRestriction remark(RestrictionsString remark) {
  ...
  **/
  ...
  public ServerCustomStorageUnitsEntityRestriction visibleId(RestrictionsString visibleId) {
  ...
  **/
  ...
  public ServerCustomStorageUnitsEntityRestriction id(RestrictionsString id) {
  ...
  **/
  ...
  public ServerCustomStorageUnitsEntityRestriction redundancy(RestrictionsBoolean redundancy) {
  ...
  **/
  ...
  public ServerCustomStorageUnitsEntityRestriction elid(RestrictionsString elid) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ServerCustomStorageUnitsEntityRestriction serverCustomStorageUnitsEntityRestriction = (ServerCustomStorageUnitsEntityRestriction) o;
    return Objects.equals(this.lifecycleStatusDate, serverCustomStorageUnitsEntityRestriction.lifecycleStatusDate) &&
        Objects.equals(this.usedGb, serverCustomStorageUnitsEntityRestriction.usedGb) &&
        Objects.equals(this.cPoolName, serverCustomStorageUnitsEntityRestriction.cPoolName) &&
        Objects.equals(this.lifecycleStatus, serverCustomStorageUnitsEntityRestriction.lifecycleStatus) &&
        Objects.equals(this.redundancyClass, serverCustomStorageUnitsEntityRestriction.redundancyClass) &&
        Objects.equals(this.cStorageClass, serverCustomStorageUnitsEntityRestriction.cStorageClass) &&
        Objects.equals(this.capacityGb, serverCustomStorageUnitsEntityRestriction.capacityGb) &&
        Objects.equals(this.remark, serverCustomStorageUnitsEntityRestriction.remark) &&
        Objects.equals(this.visibleId, serverCustomStorageUnitsEntityRestriction.visibleId) &&
        Objects.equals(this.id, serverCustomStorageUnitsEntityRestriction.id) &&
        Objects.equals(this.redundancy, serverCustomStorageUnitsEntityRestriction.redundancy) &&
        Objects.equals(this.elid, serverCustomStorageUnitsEntityRestriction.elid);
  }
  ...
  public String toString() {
    ...
    sb.append("class ServerCustomStorageUnitsEntityRestriction {\n");
