...
/**
 * UpdateSystemAttributesBearerAddUserRequestData
 */
@JsonPropertyOrder({
  UpdateSystemAttributesBearerAddUserRequestData.JSON_PROPERTY_MODIFY_PLAN,
  UpdateSystemAttributesBearerAddUserRequestData.JSON_PROPERTY_DELETE_REAL,
  UpdateSystemAttributesBearerAddUserRequestData.JSON_PROPERTY_READ_PLAN,
  UpdateSystemAttributesBearerAddUserRequestData.JSON_PROPERTY_MANDANT_ID,
  UpdateSystemAttributesBearerAddUserRequestData.JSON_PROPERTY_USER_ELID,
  UpdateSystemAttributesBearerAddUserRequestData.JSON_PROPERTY_MODIFY_REAL,
  UpdateSystemAttributesBearerAddUserRequestData.JSON_PROPERTY_READ_REAL,
  UpdateSystemAttributesBearerAddUserRequestData.JSON_PROPERTY_DELETE_PLAN
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-02-26T11:20:24.990023935Z[Etc/UTC]")
public class UpdateSystemAttributesBearerAddUserRequestData {
  ...
  public UpdateSystemAttributesBearerAddUserRequestData() {
  }

  public UpdateSystemAttributesBearerAddUserRequestData modifyPlan(Boolean modifyPlan) {
  ...
  **/
  ...
  public UpdateSystemAttributesBearerAddUserRequestData deleteReal(Boolean deleteReal) {
  ...
  **/
  ...
  public UpdateSystemAttributesBearerAddUserRequestData readPlan(Boolean readPlan) {
  ...
  **/
  ...
  public UpdateSystemAttributesBearerAddUserRequestData mandantId(BigDecimal mandantId) {
  ...
  **/
  ...
  public UpdateSystemAttributesBearerAddUserRequestData userElid(String userElid) {
  ...
  **/
  ...
  public UpdateSystemAttributesBearerAddUserRequestData modifyReal(Boolean modifyReal) {
  ...
  **/
  ...
  public UpdateSystemAttributesBearerAddUserRequestData readReal(Boolean readReal) {
  ...
  **/
  ...
  public UpdateSystemAttributesBearerAddUserRequestData deletePlan(Boolean deletePlan) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    UpdateSystemAttributesBearerAddUserRequestData updateSystemAttributesBearerAddUserRequestData = (UpdateSystemAttributesBearerAddUserRequestData) o;
    return Objects.equals(this.modifyPlan, updateSystemAttributesBearerAddUserRequestData.modifyPlan) &&
        Objects.equals(this.deleteReal, updateSystemAttributesBearerAddUserRequestData.deleteReal) &&
        Objects.equals(this.readPlan, updateSystemAttributesBearerAddUserRequestData.readPlan) &&
        Objects.equals(this.mandantId, updateSystemAttributesBearerAddUserRequestData.mandantId) &&
        Objects.equals(this.userElid, updateSystemAttributesBearerAddUserRequestData.userElid) &&
        Objects.equals(this.modifyReal, updateSystemAttributesBearerAddUserRequestData.modifyReal) &&
        Objects.equals(this.readReal, updateSystemAttributesBearerAddUserRequestData.readReal) &&
        Objects.equals(this.deletePlan, updateSystemAttributesBearerAddUserRequestData.deletePlan);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateSystemAttributesBearerAddUserRequestData {\n");
