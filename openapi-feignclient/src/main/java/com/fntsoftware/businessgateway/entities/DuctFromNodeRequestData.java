...
import com.fntsoftware.businessgateway.entities.DuctFromNodeEntityRestriction;
import com.fntsoftware.businessgateway.entities.DuctFromNodeRelationRestriction;
...
/**
 * DuctFromNodeRequestData
 */
@JsonPropertyOrder({
  DuctFromNodeRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  DuctFromNodeRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  DuctFromNodeRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  DuctFromNodeRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-03-04T13:31:32.601557352Z[Etc/UTC]")
public class DuctFromNodeRequestData {
  ...
  private DuctFromNodeEntityRestriction entityRestrictions;

  public static final String JSON_PROPERTY_RELATION_RESTRICTIONS = "relationRestrictions";
  private DuctFromNodeRelationRestriction relationRestrictions;
  ...
  public DuctFromNodeRequestData() {
  }

  public DuctFromNodeRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public DuctFromNodeRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public DuctFromNodeRequestData entityRestrictions(DuctFromNodeEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public DuctFromNodeEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(DuctFromNodeEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public DuctFromNodeRequestData relationRestrictions(DuctFromNodeRelationRestriction relationRestrictions) {
  ...
  **/
  ...
  public DuctFromNodeRelationRestriction getRelationRestrictions() {
    return relationRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_RELATION_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRelationRestrictions(DuctFromNodeRelationRestriction relationRestrictions) {
    this.relationRestrictions = relationRestrictions;
  }


  public DuctFromNodeRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public DuctFromNodeRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    DuctFromNodeRequestData ductFromNodeRequestData = (DuctFromNodeRequestData) o;
    return Objects.equals(this.returnEntityAttributes, ductFromNodeRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, ductFromNodeRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, ductFromNodeRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, ductFromNodeRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class DuctFromNodeRequestData {\n");
