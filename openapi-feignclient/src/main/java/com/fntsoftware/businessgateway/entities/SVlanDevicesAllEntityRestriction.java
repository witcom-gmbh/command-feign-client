...
/**
 * SVlanDevicesAllEntityRestriction
 */
@JsonPropertyOrder({
  SVlanDevicesAllEntityRestriction.JSON_PROPERTY_CLIMATE_RELEVANT,
  SVlanDevicesAllEntityRestriction.JSON_PROPERTY_POWER_CONSUMPTION,
  SVlanDevicesAllEntityRestriction.JSON_PROPERTY_POWER_SWITCHING_STATUS,
  SVlanDevicesAllEntityRestriction.JSON_PROPERTY_PLAN_STATUS,
  SVlanDevicesAllEntityRestriction.JSON_PROPERTY_SYSTEM_RUNTIME,
  SVlanDevicesAllEntityRestriction.JSON_PROPERTY_WEIGHT,
  SVlanDevicesAllEntityRestriction.JSON_PROPERTY_REMARK,
  SVlanDevicesAllEntityRestriction.JSON_PROPERTY_ELID,
  SVlanDevicesAllEntityRestriction.JSON_PROPERTY_LAST_SEEN,
  SVlanDevicesAllEntityRestriction.JSON_PROPERTY_TYPE_ELID,
  SVlanDevicesAllEntityRestriction.JSON_PROPERTY_VISIBLE_ID,
  SVlanDevicesAllEntityRestriction.JSON_PROPERTY_ID,
  SVlanDevicesAllEntityRestriction.JSON_PROPERTY_HEAT_EMISSION
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-01-31T11:10:37.320689708Z[Etc/UTC]")
public class SVlanDevicesAllEntityRestriction {
  ...
  public SVlanDevicesAllEntityRestriction() {
  }

  public SVlanDevicesAllEntityRestriction climateRelevant(RestrictionsBoolean climateRelevant) {
  ...
  **/
  ...
  public SVlanDevicesAllEntityRestriction powerConsumption(RestrictionsNumeric powerConsumption) {
  ...
  **/
  ...
  public SVlanDevicesAllEntityRestriction powerSwitchingStatus(RestrictionsString powerSwitchingStatus) {
  ...
  **/
  ...
  public SVlanDevicesAllEntityRestriction planStatus(RestrictionsString planStatus) {
  ...
  **/
  ...
  public SVlanDevicesAllEntityRestriction systemRuntime(RestrictionsNumeric systemRuntime) {
  ...
  **/
  ...
  public SVlanDevicesAllEntityRestriction weight(RestrictionsNumeric weight) {
  ...
  **/
  ...
  public SVlanDevicesAllEntityRestriction remark(RestrictionsString remark) {
  ...
  **/
  ...
  public SVlanDevicesAllEntityRestriction elid(RestrictionsString elid) {
  ...
  **/
  ...
  public SVlanDevicesAllEntityRestriction lastSeen(RestrictionsDate lastSeen) {
  ...
  **/
  ...
  public SVlanDevicesAllEntityRestriction typeElid(RestrictionsString typeElid) {
  ...
  **/
  ...
  public SVlanDevicesAllEntityRestriction visibleId(RestrictionsString visibleId) {
  ...
  **/
  ...
  public SVlanDevicesAllEntityRestriction id(RestrictionsString id) {
  ...
  **/
  ...
  public SVlanDevicesAllEntityRestriction heatEmission(RestrictionsNumeric heatEmission) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    SVlanDevicesAllEntityRestriction svlanDevicesAllEntityRestriction = (SVlanDevicesAllEntityRestriction) o;
    return Objects.equals(this.climateRelevant, svlanDevicesAllEntityRestriction.climateRelevant) &&
        Objects.equals(this.powerConsumption, svlanDevicesAllEntityRestriction.powerConsumption) &&
        Objects.equals(this.powerSwitchingStatus, svlanDevicesAllEntityRestriction.powerSwitchingStatus) &&
        Objects.equals(this.planStatus, svlanDevicesAllEntityRestriction.planStatus) &&
        Objects.equals(this.systemRuntime, svlanDevicesAllEntityRestriction.systemRuntime) &&
        Objects.equals(this.weight, svlanDevicesAllEntityRestriction.weight) &&
        Objects.equals(this.remark, svlanDevicesAllEntityRestriction.remark) &&
        Objects.equals(this.elid, svlanDevicesAllEntityRestriction.elid) &&
        Objects.equals(this.lastSeen, svlanDevicesAllEntityRestriction.lastSeen) &&
        Objects.equals(this.typeElid, svlanDevicesAllEntityRestriction.typeElid) &&
        Objects.equals(this.visibleId, svlanDevicesAllEntityRestriction.visibleId) &&
        Objects.equals(this.id, svlanDevicesAllEntityRestriction.id) &&
        Objects.equals(this.heatEmission, svlanDevicesAllEntityRestriction.heatEmission);
  }
  ...
  public String toString() {
    ...
    sb.append("class SVlanDevicesAllEntityRestriction {\n");
