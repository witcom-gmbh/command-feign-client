...
import com.fntsoftware.businessgateway.entities.TerminalPhysicalPortsPowerData;
 ...
 */
@JsonPropertyOrder({
  TerminalPhysicalPortsPowerResponseData.JSON_PROPERTY_RETURN_DATA,
...
public class TerminalPhysicalPortsPowerResponseData {
  ...
  private List<TerminalPhysicalPortsPowerData> returnData;
  ...
  public TerminalPhysicalPortsPowerResponseData returnData(List<TerminalPhysicalPortsPowerData> returnData) {
    
    this.returnData = returnData;
    return this;
  }

  public TerminalPhysicalPortsPowerResponseData addReturnDataItem(TerminalPhysicalPortsPowerData returnDataItem) {
  ...
  **/
  ...
  public List<TerminalPhysicalPortsPowerData> getReturnData() {
    return returnData;
  }
  ...
  @JsonProperty(JSON_PROPERTY_RETURN_DATA)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setReturnData(List<TerminalPhysicalPortsPowerData> returnData) {
    this.returnData = returnData;
  }


  public TerminalPhysicalPortsPowerResponseData status(ServiceStatusData status) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.returnData, terminalPhysicalPortsPowerResponseData.returnData) &&
