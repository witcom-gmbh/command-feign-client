...
import com.fntsoftware.businessgateway.entities.VlanPoolVlansEntityRestriction;
import com.fntsoftware.businessgateway.entities.VlanPoolVlansRelationRestriction;
...
/**
 * VlanPoolVlansRequestData
 */
@JsonPropertyOrder({
  VlanPoolVlansRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  VlanPoolVlansRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  VlanPoolVlansRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  VlanPoolVlansRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-02-26T11:20:24.990023935Z[Etc/UTC]")
public class VlanPoolVlansRequestData {
  ...
  private VlanPoolVlansEntityRestriction entityRestrictions;

  public static final String JSON_PROPERTY_RELATION_RESTRICTIONS = "relationRestrictions";
  private VlanPoolVlansRelationRestriction relationRestrictions;
  ...
  public VlanPoolVlansRequestData() {
  }

  public VlanPoolVlansRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public VlanPoolVlansRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public VlanPoolVlansRequestData entityRestrictions(VlanPoolVlansEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public VlanPoolVlansEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(VlanPoolVlansEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public VlanPoolVlansRequestData relationRestrictions(VlanPoolVlansRelationRestriction relationRestrictions) {
  ...
  **/
  ...
  public VlanPoolVlansRelationRestriction getRelationRestrictions() {
    return relationRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_RELATION_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRelationRestrictions(VlanPoolVlansRelationRestriction relationRestrictions) {
    this.relationRestrictions = relationRestrictions;
  }


  public VlanPoolVlansRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public VlanPoolVlansRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    VlanPoolVlansRequestData vlanPoolVlansRequestData = (VlanPoolVlansRequestData) o;
    return Objects.equals(this.returnEntityAttributes, vlanPoolVlansRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, vlanPoolVlansRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, vlanPoolVlansRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, vlanPoolVlansRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class VlanPoolVlansRequestData {\n");
