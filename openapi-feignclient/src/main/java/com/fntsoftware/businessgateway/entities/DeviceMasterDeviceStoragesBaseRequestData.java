...
import com.fntsoftware.businessgateway.entities.DeviceMasterDeviceStoragesBaseEntityRestriction;
...
/**
 * DeviceMasterDeviceStoragesBaseRequestData
 */
@JsonPropertyOrder({
  DeviceMasterDeviceStoragesBaseRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  DeviceMasterDeviceStoragesBaseRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  DeviceMasterDeviceStoragesBaseRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  DeviceMasterDeviceStoragesBaseRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-01-31T11:10:37.320689708Z[Etc/UTC]")
public class DeviceMasterDeviceStoragesBaseRequestData {
  ...
  private DeviceMasterDeviceStoragesBaseEntityRestriction entityRestrictions;
  ...
  public DeviceMasterDeviceStoragesBaseRequestData() {
  }

  public DeviceMasterDeviceStoragesBaseRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public DeviceMasterDeviceStoragesBaseRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public DeviceMasterDeviceStoragesBaseRequestData entityRestrictions(DeviceMasterDeviceStoragesBaseEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public DeviceMasterDeviceStoragesBaseEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(DeviceMasterDeviceStoragesBaseEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public DeviceMasterDeviceStoragesBaseRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public DeviceMasterDeviceStoragesBaseRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public DeviceMasterDeviceStoragesBaseRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    DeviceMasterDeviceStoragesBaseRequestData deviceMasterDeviceStoragesBaseRequestData = (DeviceMasterDeviceStoragesBaseRequestData) o;
    return Objects.equals(this.returnEntityAttributes, deviceMasterDeviceStoragesBaseRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, deviceMasterDeviceStoragesBaseRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, deviceMasterDeviceStoragesBaseRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, deviceMasterDeviceStoragesBaseRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeviceMasterDeviceStoragesBaseRequestData {\n");
