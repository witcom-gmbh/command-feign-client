...
import com.fntsoftware.businessgateway.entities.Ipv4NetworkNetMandatorEntityRestriction;
...
/**
 * Ipv4NetworkNetMandatorRequestData
 */
@JsonPropertyOrder({
  Ipv4NetworkNetMandatorRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  Ipv4NetworkNetMandatorRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  Ipv4NetworkNetMandatorRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  Ipv4NetworkNetMandatorRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-02-26T11:20:24.990023935Z[Etc/UTC]")
public class Ipv4NetworkNetMandatorRequestData {
  ...
  private Ipv4NetworkNetMandatorEntityRestriction entityRestrictions;
  ...
  public Ipv4NetworkNetMandatorRequestData() {
  }

  public Ipv4NetworkNetMandatorRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public Ipv4NetworkNetMandatorRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public Ipv4NetworkNetMandatorRequestData entityRestrictions(Ipv4NetworkNetMandatorEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public Ipv4NetworkNetMandatorEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(Ipv4NetworkNetMandatorEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public Ipv4NetworkNetMandatorRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public Ipv4NetworkNetMandatorRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public Ipv4NetworkNetMandatorRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    Ipv4NetworkNetMandatorRequestData ipv4NetworkNetMandatorRequestData = (Ipv4NetworkNetMandatorRequestData) o;
    return Objects.equals(this.returnEntityAttributes, ipv4NetworkNetMandatorRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, ipv4NetworkNetMandatorRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, ipv4NetworkNetMandatorRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, ipv4NetworkNetMandatorRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class Ipv4NetworkNetMandatorRequestData {\n");
