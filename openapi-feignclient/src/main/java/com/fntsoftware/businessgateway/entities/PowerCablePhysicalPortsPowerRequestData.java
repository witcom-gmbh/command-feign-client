...
import com.fntsoftware.businessgateway.entities.PowerCablePhysicalPortsPowerEntityRestriction;
...
/**
 * PowerCablePhysicalPortsPowerRequestData
 */
@JsonPropertyOrder({
  PowerCablePhysicalPortsPowerRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  PowerCablePhysicalPortsPowerRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  PowerCablePhysicalPortsPowerRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  PowerCablePhysicalPortsPowerRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-03-04T13:31:32.601557352Z[Etc/UTC]")
public class PowerCablePhysicalPortsPowerRequestData {
  ...
  private PowerCablePhysicalPortsPowerEntityRestriction entityRestrictions;
  ...
  public PowerCablePhysicalPortsPowerRequestData() {
  }

  public PowerCablePhysicalPortsPowerRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public PowerCablePhysicalPortsPowerRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public PowerCablePhysicalPortsPowerRequestData entityRestrictions(PowerCablePhysicalPortsPowerEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public PowerCablePhysicalPortsPowerEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(PowerCablePhysicalPortsPowerEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public PowerCablePhysicalPortsPowerRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public PowerCablePhysicalPortsPowerRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public PowerCablePhysicalPortsPowerRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    PowerCablePhysicalPortsPowerRequestData powerCablePhysicalPortsPowerRequestData = (PowerCablePhysicalPortsPowerRequestData) o;
    return Objects.equals(this.returnEntityAttributes, powerCablePhysicalPortsPowerRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, powerCablePhysicalPortsPowerRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, powerCablePhysicalPortsPowerRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, powerCablePhysicalPortsPowerRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class PowerCablePhysicalPortsPowerRequestData {\n");
