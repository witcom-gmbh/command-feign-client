...
import com.fntsoftware.businessgateway.entities.DeviceMasterDevicePowerGridEntityRestriction;
...
/**
 * DeviceMasterDevicePowerGridRequestData
 */
@JsonPropertyOrder({
  DeviceMasterDevicePowerGridRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  DeviceMasterDevicePowerGridRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  DeviceMasterDevicePowerGridRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  DeviceMasterDevicePowerGridRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-03-04T13:31:32.601557352Z[Etc/UTC]")
public class DeviceMasterDevicePowerGridRequestData {
  ...
  private DeviceMasterDevicePowerGridEntityRestriction entityRestrictions;
  ...
  public DeviceMasterDevicePowerGridRequestData() {
  }

  public DeviceMasterDevicePowerGridRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public DeviceMasterDevicePowerGridRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public DeviceMasterDevicePowerGridRequestData entityRestrictions(DeviceMasterDevicePowerGridEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public DeviceMasterDevicePowerGridEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(DeviceMasterDevicePowerGridEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public DeviceMasterDevicePowerGridRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public DeviceMasterDevicePowerGridRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public DeviceMasterDevicePowerGridRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    DeviceMasterDevicePowerGridRequestData deviceMasterDevicePowerGridRequestData = (DeviceMasterDevicePowerGridRequestData) o;
    return Objects.equals(this.returnEntityAttributes, deviceMasterDevicePowerGridRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, deviceMasterDevicePowerGridRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, deviceMasterDevicePowerGridRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, deviceMasterDevicePowerGridRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeviceMasterDevicePowerGridRequestData {\n");
