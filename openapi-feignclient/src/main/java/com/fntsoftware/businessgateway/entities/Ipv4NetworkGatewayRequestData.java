...
import com.fntsoftware.businessgateway.entities.Ipv4NetworkGatewayEntityRestriction;
...
/**
 * Ipv4NetworkGatewayRequestData
 */
@JsonPropertyOrder({
  Ipv4NetworkGatewayRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  Ipv4NetworkGatewayRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  Ipv4NetworkGatewayRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  Ipv4NetworkGatewayRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-01-31T11:10:37.320689708Z[Etc/UTC]")
public class Ipv4NetworkGatewayRequestData {
  ...
  private Ipv4NetworkGatewayEntityRestriction entityRestrictions;
  ...
  public Ipv4NetworkGatewayRequestData() {
  }

  public Ipv4NetworkGatewayRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public Ipv4NetworkGatewayRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public Ipv4NetworkGatewayRequestData entityRestrictions(Ipv4NetworkGatewayEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public Ipv4NetworkGatewayEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(Ipv4NetworkGatewayEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public Ipv4NetworkGatewayRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public Ipv4NetworkGatewayRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public Ipv4NetworkGatewayRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    Ipv4NetworkGatewayRequestData ipv4NetworkGatewayRequestData = (Ipv4NetworkGatewayRequestData) o;
    return Objects.equals(this.returnEntityAttributes, ipv4NetworkGatewayRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, ipv4NetworkGatewayRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, ipv4NetworkGatewayRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, ipv4NetworkGatewayRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class Ipv4NetworkGatewayRequestData {\n");
