...
import com.fntsoftware.businessgateway.entities.PowerTerminalPhysicalPortsPowerEntityRestriction;
...
/**
 * PowerTerminalPhysicalPortsPowerRequestData
 */
@JsonPropertyOrder({
  PowerTerminalPhysicalPortsPowerRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  PowerTerminalPhysicalPortsPowerRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  PowerTerminalPhysicalPortsPowerRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  PowerTerminalPhysicalPortsPowerRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-02-26T11:20:24.990023935Z[Etc/UTC]")
public class PowerTerminalPhysicalPortsPowerRequestData {
  ...
  private PowerTerminalPhysicalPortsPowerEntityRestriction entityRestrictions;
  ...
  public PowerTerminalPhysicalPortsPowerRequestData() {
  }

  public PowerTerminalPhysicalPortsPowerRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public PowerTerminalPhysicalPortsPowerRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public PowerTerminalPhysicalPortsPowerRequestData entityRestrictions(PowerTerminalPhysicalPortsPowerEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public PowerTerminalPhysicalPortsPowerEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(PowerTerminalPhysicalPortsPowerEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public PowerTerminalPhysicalPortsPowerRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public PowerTerminalPhysicalPortsPowerRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public PowerTerminalPhysicalPortsPowerRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    PowerTerminalPhysicalPortsPowerRequestData powerTerminalPhysicalPortsPowerRequestData = (PowerTerminalPhysicalPortsPowerRequestData) o;
    return Objects.equals(this.returnEntityAttributes, powerTerminalPhysicalPortsPowerRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, powerTerminalPhysicalPortsPowerRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, powerTerminalPhysicalPortsPowerRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, powerTerminalPhysicalPortsPowerRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class PowerTerminalPhysicalPortsPowerRequestData {\n");
