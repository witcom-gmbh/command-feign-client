...
import com.fntsoftware.businessgateway.entities.NmModuleDuctsEntityRestriction;
import com.fntsoftware.businessgateway.entities.NmModuleDuctsRelationRestriction;
...
/**
 * NmModuleDuctsRequestData
 */
@JsonPropertyOrder({
  NmModuleDuctsRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  NmModuleDuctsRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  NmModuleDuctsRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  NmModuleDuctsRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-01-31T11:10:37.320689708Z[Etc/UTC]")
public class NmModuleDuctsRequestData {
  ...
  private NmModuleDuctsEntityRestriction entityRestrictions;

  public static final String JSON_PROPERTY_RELATION_RESTRICTIONS = "relationRestrictions";
  private NmModuleDuctsRelationRestriction relationRestrictions;
  ...
  public NmModuleDuctsRequestData() {
  }

  public NmModuleDuctsRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public NmModuleDuctsRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public NmModuleDuctsRequestData entityRestrictions(NmModuleDuctsEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public NmModuleDuctsEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(NmModuleDuctsEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public NmModuleDuctsRequestData relationRestrictions(NmModuleDuctsRelationRestriction relationRestrictions) {
  ...
  **/
  ...
  public NmModuleDuctsRelationRestriction getRelationRestrictions() {
    return relationRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_RELATION_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRelationRestrictions(NmModuleDuctsRelationRestriction relationRestrictions) {
    this.relationRestrictions = relationRestrictions;
  }


  public NmModuleDuctsRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public NmModuleDuctsRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    NmModuleDuctsRequestData nmModuleDuctsRequestData = (NmModuleDuctsRequestData) o;
    return Objects.equals(this.returnEntityAttributes, nmModuleDuctsRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, nmModuleDuctsRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, nmModuleDuctsRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, nmModuleDuctsRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class NmModuleDuctsRequestData {\n");
