...
import com.fntsoftware.businessgateway.entities.FileSystem100033EntityRestriction;
...
/**
 * FileSystem100033RequestData
 */
@JsonPropertyOrder({
  FileSystem100033RequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  FileSystem100033RequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  FileSystem100033RequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  FileSystem100033RequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-01-31T11:10:37.320689708Z[Etc/UTC]")
public class FileSystem100033RequestData {
  ...
  private FileSystem100033EntityRestriction entityRestrictions;
  ...
  public FileSystem100033RequestData() {
  }

  public FileSystem100033RequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public FileSystem100033RequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public FileSystem100033RequestData entityRestrictions(FileSystem100033EntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public FileSystem100033EntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(FileSystem100033EntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public FileSystem100033RequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public FileSystem100033RequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public FileSystem100033RequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    FileSystem100033RequestData fileSystem100033RequestData = (FileSystem100033RequestData) o;
    return Objects.equals(this.returnEntityAttributes, fileSystem100033RequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, fileSystem100033RequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, fileSystem100033RequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, fileSystem100033RequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class FileSystem100033RequestData {\n");
