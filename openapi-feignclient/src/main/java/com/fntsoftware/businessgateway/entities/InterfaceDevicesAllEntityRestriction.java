...
/**
 * InterfaceDevicesAllEntityRestriction
 */
@JsonPropertyOrder({
  InterfaceDevicesAllEntityRestriction.JSON_PROPERTY_CLIMATE_RELEVANT,
  InterfaceDevicesAllEntityRestriction.JSON_PROPERTY_POWER_CONSUMPTION,
  InterfaceDevicesAllEntityRestriction.JSON_PROPERTY_POWER_SWITCHING_STATUS,
  InterfaceDevicesAllEntityRestriction.JSON_PROPERTY_PLAN_STATUS,
  InterfaceDevicesAllEntityRestriction.JSON_PROPERTY_SYSTEM_RUNTIME,
  InterfaceDevicesAllEntityRestriction.JSON_PROPERTY_WEIGHT,
  InterfaceDevicesAllEntityRestriction.JSON_PROPERTY_REMARK,
  InterfaceDevicesAllEntityRestriction.JSON_PROPERTY_ELID,
  InterfaceDevicesAllEntityRestriction.JSON_PROPERTY_LAST_SEEN,
  InterfaceDevicesAllEntityRestriction.JSON_PROPERTY_TYPE_ELID,
  InterfaceDevicesAllEntityRestriction.JSON_PROPERTY_VISIBLE_ID,
  InterfaceDevicesAllEntityRestriction.JSON_PROPERTY_ID,
  InterfaceDevicesAllEntityRestriction.JSON_PROPERTY_HEAT_EMISSION
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-01-31T11:10:37.320689708Z[Etc/UTC]")
public class InterfaceDevicesAllEntityRestriction {
  ...
  public InterfaceDevicesAllEntityRestriction() {
  }

  public InterfaceDevicesAllEntityRestriction climateRelevant(RestrictionsBoolean climateRelevant) {
  ...
  **/
  ...
  public InterfaceDevicesAllEntityRestriction powerConsumption(RestrictionsNumeric powerConsumption) {
  ...
  **/
  ...
  public InterfaceDevicesAllEntityRestriction powerSwitchingStatus(RestrictionsString powerSwitchingStatus) {
  ...
  **/
  ...
  public InterfaceDevicesAllEntityRestriction planStatus(RestrictionsString planStatus) {
  ...
  **/
  ...
  public InterfaceDevicesAllEntityRestriction systemRuntime(RestrictionsNumeric systemRuntime) {
  ...
  **/
  ...
  public InterfaceDevicesAllEntityRestriction weight(RestrictionsNumeric weight) {
  ...
  **/
  ...
  public InterfaceDevicesAllEntityRestriction remark(RestrictionsString remark) {
  ...
  **/
  ...
  public InterfaceDevicesAllEntityRestriction elid(RestrictionsString elid) {
  ...
  **/
  ...
  public InterfaceDevicesAllEntityRestriction lastSeen(RestrictionsDate lastSeen) {
  ...
  **/
  ...
  public InterfaceDevicesAllEntityRestriction typeElid(RestrictionsString typeElid) {
  ...
  **/
  ...
  public InterfaceDevicesAllEntityRestriction visibleId(RestrictionsString visibleId) {
  ...
  **/
  ...
  public InterfaceDevicesAllEntityRestriction id(RestrictionsString id) {
  ...
  **/
  ...
  public InterfaceDevicesAllEntityRestriction heatEmission(RestrictionsNumeric heatEmission) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    InterfaceDevicesAllEntityRestriction interfaceDevicesAllEntityRestriction = (InterfaceDevicesAllEntityRestriction) o;
    return Objects.equals(this.climateRelevant, interfaceDevicesAllEntityRestriction.climateRelevant) &&
        Objects.equals(this.powerConsumption, interfaceDevicesAllEntityRestriction.powerConsumption) &&
        Objects.equals(this.powerSwitchingStatus, interfaceDevicesAllEntityRestriction.powerSwitchingStatus) &&
        Objects.equals(this.planStatus, interfaceDevicesAllEntityRestriction.planStatus) &&
        Objects.equals(this.systemRuntime, interfaceDevicesAllEntityRestriction.systemRuntime) &&
        Objects.equals(this.weight, interfaceDevicesAllEntityRestriction.weight) &&
        Objects.equals(this.remark, interfaceDevicesAllEntityRestriction.remark) &&
        Objects.equals(this.elid, interfaceDevicesAllEntityRestriction.elid) &&
        Objects.equals(this.lastSeen, interfaceDevicesAllEntityRestriction.lastSeen) &&
        Objects.equals(this.typeElid, interfaceDevicesAllEntityRestriction.typeElid) &&
        Objects.equals(this.visibleId, interfaceDevicesAllEntityRestriction.visibleId) &&
        Objects.equals(this.id, interfaceDevicesAllEntityRestriction.id) &&
        Objects.equals(this.heatEmission, interfaceDevicesAllEntityRestriction.heatEmission);
  }
  ...
  public String toString() {
    ...
    sb.append("class InterfaceDevicesAllEntityRestriction {\n");
