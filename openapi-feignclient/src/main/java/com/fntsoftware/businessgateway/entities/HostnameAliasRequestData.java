...
import com.fntsoftware.businessgateway.entities.HostnameAliasEntityRestriction;
import com.fntsoftware.businessgateway.entities.HostnameAliasRelationRestriction;
...
/**
 * HostnameAliasRequestData
 */
@JsonPropertyOrder({
  HostnameAliasRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  HostnameAliasRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  HostnameAliasRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  HostnameAliasRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-03-04T13:31:32.601557352Z[Etc/UTC]")
public class HostnameAliasRequestData {
  ...
  private HostnameAliasEntityRestriction entityRestrictions;

  public static final String JSON_PROPERTY_RELATION_RESTRICTIONS = "relationRestrictions";
  private HostnameAliasRelationRestriction relationRestrictions;
  ...
  public HostnameAliasRequestData() {
  }

  public HostnameAliasRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public HostnameAliasRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public HostnameAliasRequestData entityRestrictions(HostnameAliasEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public HostnameAliasEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(HostnameAliasEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public HostnameAliasRequestData relationRestrictions(HostnameAliasRelationRestriction relationRestrictions) {
  ...
  **/
  ...
  public HostnameAliasRelationRestriction getRelationRestrictions() {
    return relationRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_RELATION_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRelationRestrictions(HostnameAliasRelationRestriction relationRestrictions) {
    this.relationRestrictions = relationRestrictions;
  }


  public HostnameAliasRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public HostnameAliasRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    HostnameAliasRequestData hostnameAliasRequestData = (HostnameAliasRequestData) o;
    return Objects.equals(this.returnEntityAttributes, hostnameAliasRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, hostnameAliasRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, hostnameAliasRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, hostnameAliasRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class HostnameAliasRequestData {\n");
