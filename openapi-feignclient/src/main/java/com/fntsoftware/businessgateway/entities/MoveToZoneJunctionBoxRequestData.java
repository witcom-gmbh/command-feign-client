...
import com.fntsoftware.businessgateway.entities.MoveToZoneJunctionBoxCreateLinkZoneRequestData;
import com.fasterxml.jackson.annotation.JsonPropertyOrder;
import com.fasterxml.jackson.annotation.JsonTypeName;

/**
 * MoveToZoneJunctionBoxRequestData
 */
@JsonPropertyOrder({
  MoveToZoneJunctionBoxRequestData.JSON_PROPERTY_RELEASE_SIGNALPATH,
  MoveToZoneJunctionBoxRequestData.JSON_PROPERTY_RELEASE_CONNECTIONS,
  MoveToZoneJunctionBoxRequestData.JSON_PROPERTY_RELEASE_SERVICE,
  MoveToZoneJunctionBoxRequestData.JSON_PROPERTY_RELEASE_SUPPORTS,
  MoveToZoneJunctionBoxRequestData.JSON_PROPERTY_RELEASE_PATCHES,
  MoveToZoneJunctionBoxRequestData.JSON_PROPERTY_CREATE_LINK_ZONE
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-02-26T11:20:24.990023935Z[Etc/UTC]")
public class MoveToZoneJunctionBoxRequestData {
  ...
  private MoveToZoneJunctionBoxCreateLinkZoneRequestData createLinkZone;

  public MoveToZoneJunctionBoxRequestData() {
  }

  public MoveToZoneJunctionBoxRequestData releaseSignalpath(Boolean releaseSignalpath) {
  ...
  **/
  ...
  public MoveToZoneJunctionBoxRequestData releaseConnections(Boolean releaseConnections) {
  ...
  **/
  ...
  public MoveToZoneJunctionBoxRequestData releaseService(Boolean releaseService) {
  ...
  **/
  ...
  public MoveToZoneJunctionBoxRequestData releaseSupports(Boolean releaseSupports) {
  ...
  **/
  ...
  public MoveToZoneJunctionBoxRequestData releasePatches(Boolean releasePatches) {
  ...
  **/
  ...
  public MoveToZoneJunctionBoxRequestData createLinkZone(MoveToZoneJunctionBoxCreateLinkZoneRequestData createLinkZone) {
  ...
  **/
  ...
  public MoveToZoneJunctionBoxCreateLinkZoneRequestData getCreateLinkZone() {
    return createLinkZone;
  }
  ...
  @JsonProperty(JSON_PROPERTY_CREATE_LINK_ZONE)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setCreateLinkZone(MoveToZoneJunctionBoxCreateLinkZoneRequestData createLinkZone) {
    this.createLinkZone = createLinkZone;
  }
  ...
  public boolean equals(Object o) {
    ...
    MoveToZoneJunctionBoxRequestData moveToZoneJunctionBoxRequestData = (MoveToZoneJunctionBoxRequestData) o;
    return Objects.equals(this.releaseSignalpath, moveToZoneJunctionBoxRequestData.releaseSignalpath) &&
        Objects.equals(this.releaseConnections, moveToZoneJunctionBoxRequestData.releaseConnections) &&
        Objects.equals(this.releaseService, moveToZoneJunctionBoxRequestData.releaseService) &&
        Objects.equals(this.releaseSupports, moveToZoneJunctionBoxRequestData.releaseSupports) &&
        Objects.equals(this.releasePatches, moveToZoneJunctionBoxRequestData.releasePatches) &&
        Objects.equals(this.createLinkZone, moveToZoneJunctionBoxRequestData.createLinkZone);
  }
  ...
  public String toString() {
    ...
    sb.append("class MoveToZoneJunctionBoxRequestData {\n");
