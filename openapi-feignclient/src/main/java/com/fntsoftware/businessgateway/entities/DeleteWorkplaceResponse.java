 ...
 */
@JsonPropertyOrder({
  DeleteWorkplaceResponse.JSON_PROPERTY_STATUS
})
...
public class DeleteWorkplaceResponse {
  ...
  public DeleteWorkplaceResponse status(ServiceStatusData status) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    DeleteWorkplaceResponse deleteWorkplaceResponse = (DeleteWorkplaceResponse) o;
    return Objects.equals(this.status, deleteWorkplaceResponse.status);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeleteWorkplaceResponse {\n");
