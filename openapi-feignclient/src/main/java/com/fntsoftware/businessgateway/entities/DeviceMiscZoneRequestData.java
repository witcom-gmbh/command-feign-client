...
import com.fntsoftware.businessgateway.entities.DeviceMiscZoneEntityRestriction;
...
/**
 * DeviceMiscZoneRequestData
 */
@JsonPropertyOrder({
  DeviceMiscZoneRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  DeviceMiscZoneRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  DeviceMiscZoneRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  DeviceMiscZoneRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-02-26T11:20:24.990023935Z[Etc/UTC]")
public class DeviceMiscZoneRequestData {
  ...
  private DeviceMiscZoneEntityRestriction entityRestrictions;
  ...
  public DeviceMiscZoneRequestData() {
  }

  public DeviceMiscZoneRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public DeviceMiscZoneRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public DeviceMiscZoneRequestData entityRestrictions(DeviceMiscZoneEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public DeviceMiscZoneEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(DeviceMiscZoneEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public DeviceMiscZoneRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public DeviceMiscZoneRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public DeviceMiscZoneRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    DeviceMiscZoneRequestData deviceMiscZoneRequestData = (DeviceMiscZoneRequestData) o;
    return Objects.equals(this.returnEntityAttributes, deviceMiscZoneRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, deviceMiscZoneRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, deviceMiscZoneRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, deviceMiscZoneRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeviceMiscZoneRequestData {\n");
