...
/**
 * UpdateSystemAttributesShareAddUserRequestData
 */
@JsonPropertyOrder({
  UpdateSystemAttributesShareAddUserRequestData.JSON_PROPERTY_MODIFY_PLAN,
  UpdateSystemAttributesShareAddUserRequestData.JSON_PROPERTY_DELETE_REAL,
  UpdateSystemAttributesShareAddUserRequestData.JSON_PROPERTY_READ_PLAN,
  UpdateSystemAttributesShareAddUserRequestData.JSON_PROPERTY_MANDANT_ID,
  UpdateSystemAttributesShareAddUserRequestData.JSON_PROPERTY_USER_ELID,
  UpdateSystemAttributesShareAddUserRequestData.JSON_PROPERTY_MODIFY_REAL,
  UpdateSystemAttributesShareAddUserRequestData.JSON_PROPERTY_READ_REAL,
  UpdateSystemAttributesShareAddUserRequestData.JSON_PROPERTY_DELETE_PLAN
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-01-31T11:10:37.320689708Z[Etc/UTC]")
public class UpdateSystemAttributesShareAddUserRequestData {
  ...
  public UpdateSystemAttributesShareAddUserRequestData() {
  }

  public UpdateSystemAttributesShareAddUserRequestData modifyPlan(Boolean modifyPlan) {
  ...
  **/
  ...
  public UpdateSystemAttributesShareAddUserRequestData deleteReal(Boolean deleteReal) {
  ...
  **/
  ...
  public UpdateSystemAttributesShareAddUserRequestData readPlan(Boolean readPlan) {
  ...
  **/
  ...
  public UpdateSystemAttributesShareAddUserRequestData mandantId(BigDecimal mandantId) {
  ...
  **/
  ...
  public UpdateSystemAttributesShareAddUserRequestData userElid(String userElid) {
  ...
  **/
  ...
  public UpdateSystemAttributesShareAddUserRequestData modifyReal(Boolean modifyReal) {
  ...
  **/
  ...
  public UpdateSystemAttributesShareAddUserRequestData readReal(Boolean readReal) {
  ...
  **/
  ...
  public UpdateSystemAttributesShareAddUserRequestData deletePlan(Boolean deletePlan) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    UpdateSystemAttributesShareAddUserRequestData updateSystemAttributesShareAddUserRequestData = (UpdateSystemAttributesShareAddUserRequestData) o;
    return Objects.equals(this.modifyPlan, updateSystemAttributesShareAddUserRequestData.modifyPlan) &&
        Objects.equals(this.deleteReal, updateSystemAttributesShareAddUserRequestData.deleteReal) &&
        Objects.equals(this.readPlan, updateSystemAttributesShareAddUserRequestData.readPlan) &&
        Objects.equals(this.mandantId, updateSystemAttributesShareAddUserRequestData.mandantId) &&
        Objects.equals(this.userElid, updateSystemAttributesShareAddUserRequestData.userElid) &&
        Objects.equals(this.modifyReal, updateSystemAttributesShareAddUserRequestData.modifyReal) &&
        Objects.equals(this.readReal, updateSystemAttributesShareAddUserRequestData.readReal) &&
        Objects.equals(this.deletePlan, updateSystemAttributesShareAddUserRequestData.deletePlan);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateSystemAttributesShareAddUserRequestData {\n");
