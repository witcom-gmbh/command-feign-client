...
import com.fntsoftware.businessgateway.entities.UserUserGroupsEntityRestriction;
...
/**
 * UserUserGroupsRequestData
 */
@JsonPropertyOrder({
  UserUserGroupsRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  UserUserGroupsRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  UserUserGroupsRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  UserUserGroupsRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-01-31T11:10:37.320689708Z[Etc/UTC]")
public class UserUserGroupsRequestData {
  ...
  private UserUserGroupsEntityRestriction entityRestrictions;
  ...
  public UserUserGroupsRequestData() {
  }

  public UserUserGroupsRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public UserUserGroupsRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public UserUserGroupsRequestData entityRestrictions(UserUserGroupsEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public UserUserGroupsEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(UserUserGroupsEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public UserUserGroupsRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public UserUserGroupsRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public UserUserGroupsRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    UserUserGroupsRequestData userUserGroupsRequestData = (UserUserGroupsRequestData) o;
    return Objects.equals(this.returnEntityAttributes, userUserGroupsRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, userUserGroupsRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, userUserGroupsRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, userUserGroupsRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class UserUserGroupsRequestData {\n");
