...
import com.fntsoftware.businessgateway.entities.SVlanPersonsEntityRestriction;
import com.fntsoftware.businessgateway.entities.SVlanPersonsRelationRestriction;
...
/**
 * SVlanPersonsRequestData
 */
@JsonPropertyOrder({
  SVlanPersonsRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  SVlanPersonsRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  SVlanPersonsRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  SVlanPersonsRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-02-26T11:20:24.990023935Z[Etc/UTC]")
public class SVlanPersonsRequestData {
  ...
  private SVlanPersonsEntityRestriction entityRestrictions;

  public static final String JSON_PROPERTY_RELATION_RESTRICTIONS = "relationRestrictions";
  private SVlanPersonsRelationRestriction relationRestrictions;
  ...
  public SVlanPersonsRequestData() {
  }

  public SVlanPersonsRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public SVlanPersonsRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public SVlanPersonsRequestData entityRestrictions(SVlanPersonsEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public SVlanPersonsEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(SVlanPersonsEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public SVlanPersonsRequestData relationRestrictions(SVlanPersonsRelationRestriction relationRestrictions) {
  ...
  **/
  ...
  public SVlanPersonsRelationRestriction getRelationRestrictions() {
    return relationRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_RELATION_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRelationRestrictions(SVlanPersonsRelationRestriction relationRestrictions) {
    this.relationRestrictions = relationRestrictions;
  }


  public SVlanPersonsRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public SVlanPersonsRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    SVlanPersonsRequestData svlanPersonsRequestData = (SVlanPersonsRequestData) o;
    return Objects.equals(this.returnEntityAttributes, svlanPersonsRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, svlanPersonsRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, svlanPersonsRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, svlanPersonsRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class SVlanPersonsRequestData {\n");
