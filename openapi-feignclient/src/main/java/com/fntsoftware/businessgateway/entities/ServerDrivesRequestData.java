...
import com.fntsoftware.businessgateway.entities.ServerDrivesEntityRestriction;
import com.fntsoftware.businessgateway.entities.ServerDrivesRelationRestriction;
...
/**
 * ServerDrivesRequestData
 */
@JsonPropertyOrder({
  ServerDrivesRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  ServerDrivesRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  ServerDrivesRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  ServerDrivesRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-01-31T11:10:37.320689708Z[Etc/UTC]")
public class ServerDrivesRequestData {
  ...
  private ServerDrivesEntityRestriction entityRestrictions;

  public static final String JSON_PROPERTY_RELATION_RESTRICTIONS = "relationRestrictions";
  private ServerDrivesRelationRestriction relationRestrictions;
  ...
  public ServerDrivesRequestData() {
  }

  public ServerDrivesRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public ServerDrivesRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public ServerDrivesRequestData entityRestrictions(ServerDrivesEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public ServerDrivesEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(ServerDrivesEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public ServerDrivesRequestData relationRestrictions(ServerDrivesRelationRestriction relationRestrictions) {
  ...
  **/
  ...
  public ServerDrivesRelationRestriction getRelationRestrictions() {
    return relationRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_RELATION_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRelationRestrictions(ServerDrivesRelationRestriction relationRestrictions) {
    this.relationRestrictions = relationRestrictions;
  }


  public ServerDrivesRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public ServerDrivesRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ServerDrivesRequestData serverDrivesRequestData = (ServerDrivesRequestData) o;
    return Objects.equals(this.returnEntityAttributes, serverDrivesRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, serverDrivesRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, serverDrivesRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, serverDrivesRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class ServerDrivesRequestData {\n");
