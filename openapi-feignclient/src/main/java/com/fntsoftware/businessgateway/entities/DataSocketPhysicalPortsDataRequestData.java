...
import com.fntsoftware.businessgateway.entities.DataSocketPhysicalPortsDataEntityRestriction;
...
/**
 * DataSocketPhysicalPortsDataRequestData
 */
@JsonPropertyOrder({
  DataSocketPhysicalPortsDataRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  DataSocketPhysicalPortsDataRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  DataSocketPhysicalPortsDataRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  DataSocketPhysicalPortsDataRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-01-31T11:10:37.320689708Z[Etc/UTC]")
public class DataSocketPhysicalPortsDataRequestData {
  ...
  private DataSocketPhysicalPortsDataEntityRestriction entityRestrictions;
  ...
  public DataSocketPhysicalPortsDataRequestData() {
  }

  public DataSocketPhysicalPortsDataRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public DataSocketPhysicalPortsDataRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public DataSocketPhysicalPortsDataRequestData entityRestrictions(DataSocketPhysicalPortsDataEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public DataSocketPhysicalPortsDataEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(DataSocketPhysicalPortsDataEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public DataSocketPhysicalPortsDataRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public DataSocketPhysicalPortsDataRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public DataSocketPhysicalPortsDataRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    DataSocketPhysicalPortsDataRequestData dataSocketPhysicalPortsDataRequestData = (DataSocketPhysicalPortsDataRequestData) o;
    return Objects.equals(this.returnEntityAttributes, dataSocketPhysicalPortsDataRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, dataSocketPhysicalPortsDataRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, dataSocketPhysicalPortsDataRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, dataSocketPhysicalPortsDataRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class DataSocketPhysicalPortsDataRequestData {\n");
