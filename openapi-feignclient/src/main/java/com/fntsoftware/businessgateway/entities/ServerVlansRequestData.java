...
import com.fntsoftware.businessgateway.entities.ServerVlansEntityRestriction;
import com.fntsoftware.businessgateway.entities.ServerVlansRelationRestriction;
...
/**
 * ServerVlansRequestData
 */
@JsonPropertyOrder({
  ServerVlansRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  ServerVlansRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  ServerVlansRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  ServerVlansRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-01-31T11:10:37.320689708Z[Etc/UTC]")
public class ServerVlansRequestData {
  ...
  private ServerVlansEntityRestriction entityRestrictions;

  public static final String JSON_PROPERTY_RELATION_RESTRICTIONS = "relationRestrictions";
  private ServerVlansRelationRestriction relationRestrictions;
  ...
  public ServerVlansRequestData() {
  }

  public ServerVlansRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public ServerVlansRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public ServerVlansRequestData entityRestrictions(ServerVlansEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public ServerVlansEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(ServerVlansEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public ServerVlansRequestData relationRestrictions(ServerVlansRelationRestriction relationRestrictions) {
  ...
  **/
  ...
  public ServerVlansRelationRestriction getRelationRestrictions() {
    return relationRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_RELATION_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRelationRestrictions(ServerVlansRelationRestriction relationRestrictions) {
    this.relationRestrictions = relationRestrictions;
  }


  public ServerVlansRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public ServerVlansRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ServerVlansRequestData serverVlansRequestData = (ServerVlansRequestData) o;
    return Objects.equals(this.returnEntityAttributes, serverVlansRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, serverVlansRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, serverVlansRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, serverVlansRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class ServerVlansRequestData {\n");
