...
import com.fntsoftware.businessgateway.entities.BuildingCampusEntityRestriction;
...
/**
 * BuildingCampusRequestData
 */
@JsonPropertyOrder({
  BuildingCampusRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  BuildingCampusRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  BuildingCampusRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  BuildingCampusRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-03-04T13:31:32.601557352Z[Etc/UTC]")
public class BuildingCampusRequestData {
  ...
  private BuildingCampusEntityRestriction entityRestrictions;
  ...
  public BuildingCampusRequestData() {
  }

  public BuildingCampusRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public BuildingCampusRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public BuildingCampusRequestData entityRestrictions(BuildingCampusEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public BuildingCampusEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(BuildingCampusEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public BuildingCampusRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public BuildingCampusRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public BuildingCampusRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    BuildingCampusRequestData buildingCampusRequestData = (BuildingCampusRequestData) o;
    return Objects.equals(this.returnEntityAttributes, buildingCampusRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, buildingCampusRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, buildingCampusRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, buildingCampusRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class BuildingCampusRequestData {\n");
