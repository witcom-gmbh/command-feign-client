...
import com.fntsoftware.businessgateway.entities.CampusPersonsEntityRestriction;
import com.fntsoftware.businessgateway.entities.CampusPersonsRelationRestriction;
...
/**
 * CampusPersonsRequestData
 */
@JsonPropertyOrder({
  CampusPersonsRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  CampusPersonsRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  CampusPersonsRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  CampusPersonsRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-03-04T13:31:32.601557352Z[Etc/UTC]")
public class CampusPersonsRequestData {
  ...
  private CampusPersonsEntityRestriction entityRestrictions;

  public static final String JSON_PROPERTY_RELATION_RESTRICTIONS = "relationRestrictions";
  private CampusPersonsRelationRestriction relationRestrictions;
  ...
  public CampusPersonsRequestData() {
  }

  public CampusPersonsRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public CampusPersonsRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public CampusPersonsRequestData entityRestrictions(CampusPersonsEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public CampusPersonsEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(CampusPersonsEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public CampusPersonsRequestData relationRestrictions(CampusPersonsRelationRestriction relationRestrictions) {
  ...
  **/
  ...
  public CampusPersonsRelationRestriction getRelationRestrictions() {
    return relationRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_RELATION_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRelationRestrictions(CampusPersonsRelationRestriction relationRestrictions) {
    this.relationRestrictions = relationRestrictions;
  }


  public CampusPersonsRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public CampusPersonsRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    CampusPersonsRequestData campusPersonsRequestData = (CampusPersonsRequestData) o;
    return Objects.equals(this.returnEntityAttributes, campusPersonsRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, campusPersonsRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, campusPersonsRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, campusPersonsRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class CampusPersonsRequestData {\n");
