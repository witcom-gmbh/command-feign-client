...
/**
 * VlanDevicesAllEntityRestriction
 */
@JsonPropertyOrder({
  VlanDevicesAllEntityRestriction.JSON_PROPERTY_CLIMATE_RELEVANT,
  VlanDevicesAllEntityRestriction.JSON_PROPERTY_POWER_CONSUMPTION,
  VlanDevicesAllEntityRestriction.JSON_PROPERTY_POWER_SWITCHING_STATUS,
  VlanDevicesAllEntityRestriction.JSON_PROPERTY_PLAN_STATUS,
  VlanDevicesAllEntityRestriction.JSON_PROPERTY_SYSTEM_RUNTIME,
  VlanDevicesAllEntityRestriction.JSON_PROPERTY_WEIGHT,
  VlanDevicesAllEntityRestriction.JSON_PROPERTY_REMARK,
  VlanDevicesAllEntityRestriction.JSON_PROPERTY_ELID,
  VlanDevicesAllEntityRestriction.JSON_PROPERTY_LAST_SEEN,
  VlanDevicesAllEntityRestriction.JSON_PROPERTY_TYPE_ELID,
  VlanDevicesAllEntityRestriction.JSON_PROPERTY_VISIBLE_ID,
  VlanDevicesAllEntityRestriction.JSON_PROPERTY_ID,
  VlanDevicesAllEntityRestriction.JSON_PROPERTY_HEAT_EMISSION
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-03-04T13:31:32.601557352Z[Etc/UTC]")
public class VlanDevicesAllEntityRestriction {
  ...
  public VlanDevicesAllEntityRestriction() {
  }

  public VlanDevicesAllEntityRestriction climateRelevant(RestrictionsBoolean climateRelevant) {
  ...
  **/
  ...
  public VlanDevicesAllEntityRestriction powerConsumption(RestrictionsNumeric powerConsumption) {
  ...
  **/
  ...
  public VlanDevicesAllEntityRestriction powerSwitchingStatus(RestrictionsString powerSwitchingStatus) {
  ...
  **/
  ...
  public VlanDevicesAllEntityRestriction planStatus(RestrictionsString planStatus) {
  ...
  **/
  ...
  public VlanDevicesAllEntityRestriction systemRuntime(RestrictionsNumeric systemRuntime) {
  ...
  **/
  ...
  public VlanDevicesAllEntityRestriction weight(RestrictionsNumeric weight) {
  ...
  **/
  ...
  public VlanDevicesAllEntityRestriction remark(RestrictionsString remark) {
  ...
  **/
  ...
  public VlanDevicesAllEntityRestriction elid(RestrictionsString elid) {
  ...
  **/
  ...
  public VlanDevicesAllEntityRestriction lastSeen(RestrictionsDate lastSeen) {
  ...
  **/
  ...
  public VlanDevicesAllEntityRestriction typeElid(RestrictionsString typeElid) {
  ...
  **/
  ...
  public VlanDevicesAllEntityRestriction visibleId(RestrictionsString visibleId) {
  ...
  **/
  ...
  public VlanDevicesAllEntityRestriction id(RestrictionsString id) {
  ...
  **/
  ...
  public VlanDevicesAllEntityRestriction heatEmission(RestrictionsNumeric heatEmission) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    VlanDevicesAllEntityRestriction vlanDevicesAllEntityRestriction = (VlanDevicesAllEntityRestriction) o;
    return Objects.equals(this.climateRelevant, vlanDevicesAllEntityRestriction.climateRelevant) &&
        Objects.equals(this.powerConsumption, vlanDevicesAllEntityRestriction.powerConsumption) &&
        Objects.equals(this.powerSwitchingStatus, vlanDevicesAllEntityRestriction.powerSwitchingStatus) &&
        Objects.equals(this.planStatus, vlanDevicesAllEntityRestriction.planStatus) &&
        Objects.equals(this.systemRuntime, vlanDevicesAllEntityRestriction.systemRuntime) &&
        Objects.equals(this.weight, vlanDevicesAllEntityRestriction.weight) &&
        Objects.equals(this.remark, vlanDevicesAllEntityRestriction.remark) &&
        Objects.equals(this.elid, vlanDevicesAllEntityRestriction.elid) &&
        Objects.equals(this.lastSeen, vlanDevicesAllEntityRestriction.lastSeen) &&
        Objects.equals(this.typeElid, vlanDevicesAllEntityRestriction.typeElid) &&
        Objects.equals(this.visibleId, vlanDevicesAllEntityRestriction.visibleId) &&
        Objects.equals(this.id, vlanDevicesAllEntityRestriction.id) &&
        Objects.equals(this.heatEmission, vlanDevicesAllEntityRestriction.heatEmission);
  }
  ...
  public String toString() {
    ...
    sb.append("class VlanDevicesAllEntityRestriction {\n");
