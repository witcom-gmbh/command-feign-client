...
import com.fntsoftware.businessgateway.entities.DataSocketDeviceMasterEntityRestriction;
...
/**
 * DataSocketDeviceMasterRequestData
 */
@JsonPropertyOrder({
  DataSocketDeviceMasterRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  DataSocketDeviceMasterRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  DataSocketDeviceMasterRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  DataSocketDeviceMasterRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-03-04T13:31:32.601557352Z[Etc/UTC]")
public class DataSocketDeviceMasterRequestData {
  ...
  private DataSocketDeviceMasterEntityRestriction entityRestrictions;
  ...
  public DataSocketDeviceMasterRequestData() {
  }

  public DataSocketDeviceMasterRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public DataSocketDeviceMasterRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public DataSocketDeviceMasterRequestData entityRestrictions(DataSocketDeviceMasterEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public DataSocketDeviceMasterEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(DataSocketDeviceMasterEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public DataSocketDeviceMasterRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public DataSocketDeviceMasterRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public DataSocketDeviceMasterRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    DataSocketDeviceMasterRequestData dataSocketDeviceMasterRequestData = (DataSocketDeviceMasterRequestData) o;
    return Objects.equals(this.returnEntityAttributes, dataSocketDeviceMasterRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, dataSocketDeviceMasterRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, dataSocketDeviceMasterRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, dataSocketDeviceMasterRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class DataSocketDeviceMasterRequestData {\n");
