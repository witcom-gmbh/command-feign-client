...
/**
 * FrameContractQueryRestriction
 */
@JsonPropertyOrder({
  FrameContractQueryRestriction.JSON_PROPERTY_END_DATE,
  FrameContractQueryRestriction.JSON_PROPERTY_DESCRIPTION,
  FrameContractQueryRestriction.JSON_PROPERTY_C_DISMISSAL_DATE,
  FrameContractQueryRestriction.JSON_PROPERTY_C_AUTOMATIC_RENEWAL,
  FrameContractQueryRestriction.JSON_PROPERTY_C_DISMISSAL_RECEIVED_DATE,
  FrameContractQueryRestriction.JSON_PROPERTY_C_REFTYPE1,
  FrameContractQueryRestriction.JSON_PROPERTY_DISMISSAL_PROTECTION,
  FrameContractQueryRestriction.JSON_PROPERTY_ACCOUNT_NO,
  FrameContractQueryRestriction.JSON_PROPERTY_C_STATE,
  FrameContractQueryRestriction.JSON_PROPERTY_YEARLY_COSTS,
  FrameContractQueryRestriction.JSON_PROPERTY_C_REFVALUE1,
  FrameContractQueryRestriction.JSON_PROPERTY_CONTRACT_NAME,
  FrameContractQueryRestriction.JSON_PROPERTY_C_REFVALUE2,
  FrameContractQueryRestriction.JSON_PROPERTY_ID,
  FrameContractQueryRestriction.JSON_PROPERTY_C_REFTYPE2,
  FrameContractQueryRestriction.JSON_PROPERTY_C_DISMISSAL_PROTECTION_END,
  FrameContractQueryRestriction.JSON_PROPERTY_C_AUTO_RENEWAL_PERIOD,
  FrameContractQueryRestriction.JSON_PROPERTY_C_RENEWAL_DATE,
  FrameContractQueryRestriction.JSON_PROPERTY_RUNTIME,
  FrameContractQueryRestriction.JSON_PROPERTY_ELID,
  FrameContractQueryRestriction.JSON_PROPERTY_BEGIN_DATE,
  FrameContractQueryRestriction.JSON_PROPERTY_DISMISSAL,
  FrameContractQueryRestriction.JSON_PROPERTY_C_DISMISSAL_END_DATE,
  FrameContractQueryRestriction.JSON_PROPERTY_FIRST,
  FrameContractQueryRestriction.JSON_PROPERTY_C_RENEWAL
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-01-31T11:10:37.320689708Z[Etc/UTC]")
public class FrameContractQueryRestriction {
  ...
  public FrameContractQueryRestriction() {
  }

  public FrameContractQueryRestriction endDate(RestrictionsDate endDate) {
  ...
  **/
  ...
  public FrameContractQueryRestriction description(RestrictionsString description) {
  ...
  **/
  ...
  public FrameContractQueryRestriction cDismissalDate(RestrictionsDate cDismissalDate) {
  ...
  **/
  ...
  public FrameContractQueryRestriction cAutomaticRenewal(RestrictionsString cAutomaticRenewal) {
  ...
  **/
  ...
  public FrameContractQueryRestriction cDismissalReceivedDate(RestrictionsDate cDismissalReceivedDate) {
  ...
  **/
  ...
  public FrameContractQueryRestriction cReftype1(RestrictionsString cReftype1) {
  ...
  **/
  ...
  public FrameContractQueryRestriction dismissalProtection(RestrictionsString dismissalProtection) {
  ...
  **/
  ...
  public FrameContractQueryRestriction accountNo(RestrictionsString accountNo) {
  ...
  **/
  ...
  public FrameContractQueryRestriction cState(RestrictionsString cState) {
  ...
  **/
  ...
  public FrameContractQueryRestriction yearlyCosts(RestrictionsNumeric yearlyCosts) {
  ...
  **/
  ...
  public FrameContractQueryRestriction cRefvalue1(RestrictionsString cRefvalue1) {
  ...
  **/
  ...
  public FrameContractQueryRestriction contractName(RestrictionsString contractName) {
  ...
  **/
  ...
  public FrameContractQueryRestriction cRefvalue2(RestrictionsString cRefvalue2) {
  ...
  **/
  ...
  public FrameContractQueryRestriction id(RestrictionsString id) {
  ...
  **/
  ...
  public FrameContractQueryRestriction cReftype2(RestrictionsString cReftype2) {
  ...
  **/
  ...
  public FrameContractQueryRestriction cDismissalProtectionEnd(RestrictionsDate cDismissalProtectionEnd) {
  ...
  **/
  ...
  public FrameContractQueryRestriction cAutoRenewalPeriod(RestrictionsString cAutoRenewalPeriod) {
  ...
  **/
  ...
  public FrameContractQueryRestriction cRenewalDate(RestrictionsDate cRenewalDate) {
  ...
  **/
  ...
  public FrameContractQueryRestriction runtime(RestrictionsString runtime) {
  ...
  **/
  ...
  public FrameContractQueryRestriction elid(RestrictionsString elid) {
  ...
  **/
  ...
  public FrameContractQueryRestriction beginDate(RestrictionsDate beginDate) {
  ...
  **/
  ...
  public FrameContractQueryRestriction dismissal(RestrictionsString dismissal) {
  ...
  **/
  ...
  public FrameContractQueryRestriction cDismissalEndDate(RestrictionsDate cDismissalEndDate) {
  ...
  **/
  ...
  public FrameContractQueryRestriction first(RestrictionsNumeric first) {
  ...
  **/
  ...
  public FrameContractQueryRestriction cRenewal(RestrictionsString cRenewal) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    FrameContractQueryRestriction frameContractQueryRestriction = (FrameContractQueryRestriction) o;
    return Objects.equals(this.endDate, frameContractQueryRestriction.endDate) &&
        Objects.equals(this.description, frameContractQueryRestriction.description) &&
        Objects.equals(this.cDismissalDate, frameContractQueryRestriction.cDismissalDate) &&
        Objects.equals(this.cAutomaticRenewal, frameContractQueryRestriction.cAutomaticRenewal) &&
        Objects.equals(this.cDismissalReceivedDate, frameContractQueryRestriction.cDismissalReceivedDate) &&
        Objects.equals(this.cReftype1, frameContractQueryRestriction.cReftype1) &&
        Objects.equals(this.dismissalProtection, frameContractQueryRestriction.dismissalProtection) &&
        Objects.equals(this.accountNo, frameContractQueryRestriction.accountNo) &&
        Objects.equals(this.cState, frameContractQueryRestriction.cState) &&
        Objects.equals(this.yearlyCosts, frameContractQueryRestriction.yearlyCosts) &&
        Objects.equals(this.cRefvalue1, frameContractQueryRestriction.cRefvalue1) &&
        Objects.equals(this.contractName, frameContractQueryRestriction.contractName) &&
        Objects.equals(this.cRefvalue2, frameContractQueryRestriction.cRefvalue2) &&
        Objects.equals(this.id, frameContractQueryRestriction.id) &&
        Objects.equals(this.cReftype2, frameContractQueryRestriction.cReftype2) &&
        Objects.equals(this.cDismissalProtectionEnd, frameContractQueryRestriction.cDismissalProtectionEnd) &&
        Objects.equals(this.cAutoRenewalPeriod, frameContractQueryRestriction.cAutoRenewalPeriod) &&
        Objects.equals(this.cRenewalDate, frameContractQueryRestriction.cRenewalDate) &&
        Objects.equals(this.runtime, frameContractQueryRestriction.runtime) &&
        Objects.equals(this.elid, frameContractQueryRestriction.elid) &&
        Objects.equals(this.beginDate, frameContractQueryRestriction.beginDate) &&
        Objects.equals(this.dismissal, frameContractQueryRestriction.dismissal) &&
        Objects.equals(this.cDismissalEndDate, frameContractQueryRestriction.cDismissalEndDate) &&
        Objects.equals(this.first, frameContractQueryRestriction.first) &&
        Objects.equals(this.cRenewal, frameContractQueryRestriction.cRenewal);
  }

  @Override
  public int hashCode() {
    return Objects.hash(endDate, description, cDismissalDate, cAutomaticRenewal, cDismissalReceivedDate, cReftype1, dismissalProtection, accountNo, cState, yearlyCosts, cRefvalue1, contractName, cRefvalue2, id, cReftype2, cDismissalProtectionEnd, cAutoRenewalPeriod, cRenewalDate, runtime, elid, beginDate, dismissal, cDismissalEndDate, first, cRenewal);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class FrameContractQueryRestriction {\n");
