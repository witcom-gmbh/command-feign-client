...
import com.fntsoftware.businessgateway.entities.TerminalSlotEntityRestriction;
import com.fntsoftware.businessgateway.entities.TerminalSlotRelationRestriction;
...
/**
 * TerminalSlotRequestData
 */
@JsonPropertyOrder({
  TerminalSlotRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  TerminalSlotRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  TerminalSlotRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  TerminalSlotRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-01-31T11:10:37.320689708Z[Etc/UTC]")
public class TerminalSlotRequestData {
  ...
  private TerminalSlotEntityRestriction entityRestrictions;

  public static final String JSON_PROPERTY_RELATION_RESTRICTIONS = "relationRestrictions";
  private TerminalSlotRelationRestriction relationRestrictions;
  ...
  public TerminalSlotRequestData() {
  }

  public TerminalSlotRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public TerminalSlotRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public TerminalSlotRequestData entityRestrictions(TerminalSlotEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public TerminalSlotEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(TerminalSlotEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public TerminalSlotRequestData relationRestrictions(TerminalSlotRelationRestriction relationRestrictions) {
  ...
  **/
  ...
  public TerminalSlotRelationRestriction getRelationRestrictions() {
    return relationRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_RELATION_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRelationRestrictions(TerminalSlotRelationRestriction relationRestrictions) {
    this.relationRestrictions = relationRestrictions;
  }


  public TerminalSlotRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public TerminalSlotRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    TerminalSlotRequestData terminalSlotRequestData = (TerminalSlotRequestData) o;
    return Objects.equals(this.returnEntityAttributes, terminalSlotRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, terminalSlotRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, terminalSlotRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, terminalSlotRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class TerminalSlotRequestData {\n");
