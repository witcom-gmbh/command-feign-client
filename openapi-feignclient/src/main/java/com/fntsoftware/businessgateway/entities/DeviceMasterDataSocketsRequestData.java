...
import com.fntsoftware.businessgateway.entities.DeviceMasterDataSocketsEntityRestriction;
...
/**
 * DeviceMasterDataSocketsRequestData
 */
@JsonPropertyOrder({
  DeviceMasterDataSocketsRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  DeviceMasterDataSocketsRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  DeviceMasterDataSocketsRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  DeviceMasterDataSocketsRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-02-26T11:20:24.990023935Z[Etc/UTC]")
public class DeviceMasterDataSocketsRequestData {
  ...
  private DeviceMasterDataSocketsEntityRestriction entityRestrictions;
  ...
  public DeviceMasterDataSocketsRequestData() {
  }

  public DeviceMasterDataSocketsRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public DeviceMasterDataSocketsRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public DeviceMasterDataSocketsRequestData entityRestrictions(DeviceMasterDataSocketsEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public DeviceMasterDataSocketsEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(DeviceMasterDataSocketsEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public DeviceMasterDataSocketsRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public DeviceMasterDataSocketsRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public DeviceMasterDataSocketsRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    DeviceMasterDataSocketsRequestData deviceMasterDataSocketsRequestData = (DeviceMasterDataSocketsRequestData) o;
    return Objects.equals(this.returnEntityAttributes, deviceMasterDataSocketsRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, deviceMasterDataSocketsRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, deviceMasterDataSocketsRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, deviceMasterDataSocketsRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeviceMasterDataSocketsRequestData {\n");
