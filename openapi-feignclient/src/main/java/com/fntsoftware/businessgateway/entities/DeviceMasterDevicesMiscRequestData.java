...
import com.fntsoftware.businessgateway.entities.DeviceMasterDevicesMiscEntityRestriction;
...
/**
 * DeviceMasterDevicesMiscRequestData
 */
@JsonPropertyOrder({
  DeviceMasterDevicesMiscRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  DeviceMasterDevicesMiscRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  DeviceMasterDevicesMiscRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  DeviceMasterDevicesMiscRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-01-31T11:10:37.320689708Z[Etc/UTC]")
public class DeviceMasterDevicesMiscRequestData {
  ...
  private DeviceMasterDevicesMiscEntityRestriction entityRestrictions;
  ...
  public DeviceMasterDevicesMiscRequestData() {
  }

  public DeviceMasterDevicesMiscRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public DeviceMasterDevicesMiscRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public DeviceMasterDevicesMiscRequestData entityRestrictions(DeviceMasterDevicesMiscEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public DeviceMasterDevicesMiscEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(DeviceMasterDevicesMiscEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public DeviceMasterDevicesMiscRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public DeviceMasterDevicesMiscRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public DeviceMasterDevicesMiscRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    DeviceMasterDevicesMiscRequestData deviceMasterDevicesMiscRequestData = (DeviceMasterDevicesMiscRequestData) o;
    return Objects.equals(this.returnEntityAttributes, deviceMasterDevicesMiscRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, deviceMasterDevicesMiscRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, deviceMasterDevicesMiscRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, deviceMasterDevicesMiscRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeviceMasterDevicesMiscRequestData {\n");
