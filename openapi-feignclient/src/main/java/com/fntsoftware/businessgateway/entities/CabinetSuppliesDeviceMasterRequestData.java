...
import com.fntsoftware.businessgateway.entities.CabinetSuppliesDeviceMasterEntityRestriction;
...
/**
 * CabinetSuppliesDeviceMasterRequestData
 */
@JsonPropertyOrder({
  CabinetSuppliesDeviceMasterRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  CabinetSuppliesDeviceMasterRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  CabinetSuppliesDeviceMasterRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  CabinetSuppliesDeviceMasterRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-01-31T11:10:37.320689708Z[Etc/UTC]")
public class CabinetSuppliesDeviceMasterRequestData {
  ...
  private CabinetSuppliesDeviceMasterEntityRestriction entityRestrictions;
  ...
  public CabinetSuppliesDeviceMasterRequestData() {
  }

  public CabinetSuppliesDeviceMasterRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public CabinetSuppliesDeviceMasterRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public CabinetSuppliesDeviceMasterRequestData entityRestrictions(CabinetSuppliesDeviceMasterEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public CabinetSuppliesDeviceMasterEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(CabinetSuppliesDeviceMasterEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public CabinetSuppliesDeviceMasterRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public CabinetSuppliesDeviceMasterRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public CabinetSuppliesDeviceMasterRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    CabinetSuppliesDeviceMasterRequestData cabinetSuppliesDeviceMasterRequestData = (CabinetSuppliesDeviceMasterRequestData) o;
    return Objects.equals(this.returnEntityAttributes, cabinetSuppliesDeviceMasterRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, cabinetSuppliesDeviceMasterRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, cabinetSuppliesDeviceMasterRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, cabinetSuppliesDeviceMasterRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class CabinetSuppliesDeviceMasterRequestData {\n");
