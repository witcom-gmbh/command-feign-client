...
/**
 * StorageUnitQtreeStorageUnitsEntityRestriction
 */
@JsonPropertyOrder({
  StorageUnitQtreeStorageUnitsEntityRestriction.JSON_PROPERTY_LIFECYCLE_STATUS_DATE,
  StorageUnitQtreeStorageUnitsEntityRestriction.JSON_PROPERTY_USED_GB,
  StorageUnitQtreeStorageUnitsEntityRestriction.JSON_PROPERTY_C_POOL_NAME,
  StorageUnitQtreeStorageUnitsEntityRestriction.JSON_PROPERTY_LIFECYCLE_STATUS,
  StorageUnitQtreeStorageUnitsEntityRestriction.JSON_PROPERTY_REDUNDANCY_CLASS,
  StorageUnitQtreeStorageUnitsEntityRestriction.JSON_PROPERTY_C_STORAGE_CLASS,
  StorageUnitQtreeStorageUnitsEntityRestriction.JSON_PROPERTY_CAPACITY_GB,
  StorageUnitQtreeStorageUnitsEntityRestriction.JSON_PROPERTY_REMARK,
  StorageUnitQtreeStorageUnitsEntityRestriction.JSON_PROPERTY_VISIBLE_ID,
  StorageUnitQtreeStorageUnitsEntityRestriction.JSON_PROPERTY_ID,
  StorageUnitQtreeStorageUnitsEntityRestriction.JSON_PROPERTY_REDUNDANCY,
  StorageUnitQtreeStorageUnitsEntityRestriction.JSON_PROPERTY_ELID
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-01-31T11:10:37.320689708Z[Etc/UTC]")
public class StorageUnitQtreeStorageUnitsEntityRestriction {
  ...
  public StorageUnitQtreeStorageUnitsEntityRestriction() {
  }

  public StorageUnitQtreeStorageUnitsEntityRestriction lifecycleStatusDate(RestrictionsDate lifecycleStatusDate) {
  ...
  **/
  ...
  public StorageUnitQtreeStorageUnitsEntityRestriction usedGb(RestrictionsNumeric usedGb) {
  ...
  **/
  ...
  public StorageUnitQtreeStorageUnitsEntityRestriction cPoolName(RestrictionsString cPoolName) {
  ...
  **/
  ...
  public StorageUnitQtreeStorageUnitsEntityRestriction lifecycleStatus(RestrictionsString lifecycleStatus) {
  ...
  **/
  ...
  public StorageUnitQtreeStorageUnitsEntityRestriction redundancyClass(RestrictionsString redundancyClass) {
  ...
  **/
  ...
  public StorageUnitQtreeStorageUnitsEntityRestriction cStorageClass(RestrictionsString cStorageClass) {
  ...
  **/
  ...
  public StorageUnitQtreeStorageUnitsEntityRestriction capacityGb(RestrictionsNumeric capacityGb) {
  ...
  **/
  ...
  public StorageUnitQtreeStorageUnitsEntityRestriction remark(RestrictionsString remark) {
  ...
  **/
  ...
  public StorageUnitQtreeStorageUnitsEntityRestriction visibleId(RestrictionsString visibleId) {
  ...
  **/
  ...
  public StorageUnitQtreeStorageUnitsEntityRestriction id(RestrictionsString id) {
  ...
  **/
  ...
  public StorageUnitQtreeStorageUnitsEntityRestriction redundancy(RestrictionsBoolean redundancy) {
  ...
  **/
  ...
  public StorageUnitQtreeStorageUnitsEntityRestriction elid(RestrictionsString elid) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    StorageUnitQtreeStorageUnitsEntityRestriction storageUnitQtreeStorageUnitsEntityRestriction = (StorageUnitQtreeStorageUnitsEntityRestriction) o;
    return Objects.equals(this.lifecycleStatusDate, storageUnitQtreeStorageUnitsEntityRestriction.lifecycleStatusDate) &&
        Objects.equals(this.usedGb, storageUnitQtreeStorageUnitsEntityRestriction.usedGb) &&
        Objects.equals(this.cPoolName, storageUnitQtreeStorageUnitsEntityRestriction.cPoolName) &&
        Objects.equals(this.lifecycleStatus, storageUnitQtreeStorageUnitsEntityRestriction.lifecycleStatus) &&
        Objects.equals(this.redundancyClass, storageUnitQtreeStorageUnitsEntityRestriction.redundancyClass) &&
        Objects.equals(this.cStorageClass, storageUnitQtreeStorageUnitsEntityRestriction.cStorageClass) &&
        Objects.equals(this.capacityGb, storageUnitQtreeStorageUnitsEntityRestriction.capacityGb) &&
        Objects.equals(this.remark, storageUnitQtreeStorageUnitsEntityRestriction.remark) &&
        Objects.equals(this.visibleId, storageUnitQtreeStorageUnitsEntityRestriction.visibleId) &&
        Objects.equals(this.id, storageUnitQtreeStorageUnitsEntityRestriction.id) &&
        Objects.equals(this.redundancy, storageUnitQtreeStorageUnitsEntityRestriction.redundancy) &&
        Objects.equals(this.elid, storageUnitQtreeStorageUnitsEntityRestriction.elid);
  }
  ...
  public String toString() {
    ...
    sb.append("class StorageUnitQtreeStorageUnitsEntityRestriction {\n");
