...
import com.fntsoftware.businessgateway.entities.NetworkFunctionNetworkElementEntityRestriction;
...
/**
 * NetworkFunctionNetworkElementRequestData
 */
@JsonPropertyOrder({
  NetworkFunctionNetworkElementRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  NetworkFunctionNetworkElementRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  NetworkFunctionNetworkElementRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  NetworkFunctionNetworkElementRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-03-04T13:31:32.601557352Z[Etc/UTC]")
public class NetworkFunctionNetworkElementRequestData {
  ...
  private NetworkFunctionNetworkElementEntityRestriction entityRestrictions;
  ...
  public NetworkFunctionNetworkElementRequestData() {
  }

  public NetworkFunctionNetworkElementRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public NetworkFunctionNetworkElementRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public NetworkFunctionNetworkElementRequestData entityRestrictions(NetworkFunctionNetworkElementEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public NetworkFunctionNetworkElementEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(NetworkFunctionNetworkElementEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public NetworkFunctionNetworkElementRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public NetworkFunctionNetworkElementRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public NetworkFunctionNetworkElementRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    NetworkFunctionNetworkElementRequestData networkFunctionNetworkElementRequestData = (NetworkFunctionNetworkElementRequestData) o;
    return Objects.equals(this.returnEntityAttributes, networkFunctionNetworkElementRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, networkFunctionNetworkElementRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, networkFunctionNetworkElementRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, networkFunctionNetworkElementRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class NetworkFunctionNetworkElementRequestData {\n");
