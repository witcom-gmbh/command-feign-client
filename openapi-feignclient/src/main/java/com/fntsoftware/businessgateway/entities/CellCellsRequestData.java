...
import com.fntsoftware.businessgateway.entities.CellCellsEntityRestriction;
import com.fntsoftware.businessgateway.entities.CellCellsRelationRestriction;
...
/**
 * CellCellsRequestData
 */
@JsonPropertyOrder({
  CellCellsRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  CellCellsRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  CellCellsRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  CellCellsRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-03-04T13:31:32.601557352Z[Etc/UTC]")
public class CellCellsRequestData {
  ...
  private CellCellsEntityRestriction entityRestrictions;

  public static final String JSON_PROPERTY_RELATION_RESTRICTIONS = "relationRestrictions";
  private CellCellsRelationRestriction relationRestrictions;
  ...
  public CellCellsRequestData() {
  }

  public CellCellsRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public CellCellsRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public CellCellsRequestData entityRestrictions(CellCellsEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public CellCellsEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(CellCellsEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public CellCellsRequestData relationRestrictions(CellCellsRelationRestriction relationRestrictions) {
  ...
  **/
  ...
  public CellCellsRelationRestriction getRelationRestrictions() {
    return relationRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_RELATION_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRelationRestrictions(CellCellsRelationRestriction relationRestrictions) {
    this.relationRestrictions = relationRestrictions;
  }


  public CellCellsRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public CellCellsRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    CellCellsRequestData cellCellsRequestData = (CellCellsRequestData) o;
    return Objects.equals(this.returnEntityAttributes, cellCellsRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, cellCellsRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, cellCellsRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, cellCellsRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class CellCellsRequestData {\n");
