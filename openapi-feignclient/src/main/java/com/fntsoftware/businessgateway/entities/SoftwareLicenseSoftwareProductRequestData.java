...
import com.fntsoftware.businessgateway.entities.SoftwareLicenseSoftwareProductEntityRestriction;
...
/**
 * SoftwareLicenseSoftwareProductRequestData
 */
@JsonPropertyOrder({
  SoftwareLicenseSoftwareProductRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  SoftwareLicenseSoftwareProductRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  SoftwareLicenseSoftwareProductRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  SoftwareLicenseSoftwareProductRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-02-26T11:20:24.990023935Z[Etc/UTC]")
public class SoftwareLicenseSoftwareProductRequestData {
  ...
  private SoftwareLicenseSoftwareProductEntityRestriction entityRestrictions;
  ...
  public SoftwareLicenseSoftwareProductRequestData() {
  }

  public SoftwareLicenseSoftwareProductRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public SoftwareLicenseSoftwareProductRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public SoftwareLicenseSoftwareProductRequestData entityRestrictions(SoftwareLicenseSoftwareProductEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public SoftwareLicenseSoftwareProductEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(SoftwareLicenseSoftwareProductEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public SoftwareLicenseSoftwareProductRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public SoftwareLicenseSoftwareProductRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public SoftwareLicenseSoftwareProductRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    SoftwareLicenseSoftwareProductRequestData softwareLicenseSoftwareProductRequestData = (SoftwareLicenseSoftwareProductRequestData) o;
    return Objects.equals(this.returnEntityAttributes, softwareLicenseSoftwareProductRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, softwareLicenseSoftwareProductRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, softwareLicenseSoftwareProductRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, softwareLicenseSoftwareProductRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class SoftwareLicenseSoftwareProductRequestData {\n");
