...
import com.fntsoftware.businessgateway.entities.Ipv4NetrangeDomainEntityRestriction;
...
/**
 * Ipv4NetrangeDomainRequestData
 */
@JsonPropertyOrder({
  Ipv4NetrangeDomainRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  Ipv4NetrangeDomainRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  Ipv4NetrangeDomainRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  Ipv4NetrangeDomainRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-01-31T11:10:37.320689708Z[Etc/UTC]")
public class Ipv4NetrangeDomainRequestData {
  ...
  private Ipv4NetrangeDomainEntityRestriction entityRestrictions;
  ...
  public Ipv4NetrangeDomainRequestData() {
  }

  public Ipv4NetrangeDomainRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public Ipv4NetrangeDomainRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public Ipv4NetrangeDomainRequestData entityRestrictions(Ipv4NetrangeDomainEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public Ipv4NetrangeDomainEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(Ipv4NetrangeDomainEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public Ipv4NetrangeDomainRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public Ipv4NetrangeDomainRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public Ipv4NetrangeDomainRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    Ipv4NetrangeDomainRequestData ipv4NetrangeDomainRequestData = (Ipv4NetrangeDomainRequestData) o;
    return Objects.equals(this.returnEntityAttributes, ipv4NetrangeDomainRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, ipv4NetrangeDomainRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, ipv4NetrangeDomainRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, ipv4NetrangeDomainRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class Ipv4NetrangeDomainRequestData {\n");
