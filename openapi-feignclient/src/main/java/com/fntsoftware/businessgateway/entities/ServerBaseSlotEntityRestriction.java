...
/**
 * ServerBaseSlotEntityRestriction
 */
@JsonPropertyOrder({
  ServerBaseSlotEntityRestriction.JSON_PROPERTY_CLIMATE_RELEVANT,
  ServerBaseSlotEntityRestriction.JSON_PROPERTY_POWER_CONSUMPTION,
  ServerBaseSlotEntityRestriction.JSON_PROPERTY_POWER_SWITCHING_STATUS,
  ServerBaseSlotEntityRestriction.JSON_PROPERTY_PLAN_STATUS,
  ServerBaseSlotEntityRestriction.JSON_PROPERTY_SYSTEM_RUNTIME,
  ServerBaseSlotEntityRestriction.JSON_PROPERTY_WEIGHT,
  ServerBaseSlotEntityRestriction.JSON_PROPERTY_REMARK,
  ServerBaseSlotEntityRestriction.JSON_PROPERTY_ELID,
  ServerBaseSlotEntityRestriction.JSON_PROPERTY_LAST_SEEN,
  ServerBaseSlotEntityRestriction.JSON_PROPERTY_TYPE_ELID,
  ServerBaseSlotEntityRestriction.JSON_PROPERTY_VISIBLE_ID,
  ServerBaseSlotEntityRestriction.JSON_PROPERTY_ID,
  ServerBaseSlotEntityRestriction.JSON_PROPERTY_HEAT_EMISSION
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-03-04T13:31:32.601557352Z[Etc/UTC]")
public class ServerBaseSlotEntityRestriction {
  ...
  public ServerBaseSlotEntityRestriction() {
  }

  public ServerBaseSlotEntityRestriction climateRelevant(RestrictionsBoolean climateRelevant) {
  ...
  **/
  ...
  public ServerBaseSlotEntityRestriction powerConsumption(RestrictionsNumeric powerConsumption) {
  ...
  **/
  ...
  public ServerBaseSlotEntityRestriction powerSwitchingStatus(RestrictionsString powerSwitchingStatus) {
  ...
  **/
  ...
  public ServerBaseSlotEntityRestriction planStatus(RestrictionsString planStatus) {
  ...
  **/
  ...
  public ServerBaseSlotEntityRestriction systemRuntime(RestrictionsNumeric systemRuntime) {
  ...
  **/
  ...
  public ServerBaseSlotEntityRestriction weight(RestrictionsNumeric weight) {
  ...
  **/
  ...
  public ServerBaseSlotEntityRestriction remark(RestrictionsString remark) {
  ...
  **/
  ...
  public ServerBaseSlotEntityRestriction elid(RestrictionsString elid) {
  ...
  **/
  ...
  public ServerBaseSlotEntityRestriction lastSeen(RestrictionsDate lastSeen) {
  ...
  **/
  ...
  public ServerBaseSlotEntityRestriction typeElid(RestrictionsString typeElid) {
  ...
  **/
  ...
  public ServerBaseSlotEntityRestriction visibleId(RestrictionsString visibleId) {
  ...
  **/
  ...
  public ServerBaseSlotEntityRestriction id(RestrictionsString id) {
  ...
  **/
  ...
  public ServerBaseSlotEntityRestriction heatEmission(RestrictionsNumeric heatEmission) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ServerBaseSlotEntityRestriction serverBaseSlotEntityRestriction = (ServerBaseSlotEntityRestriction) o;
    return Objects.equals(this.climateRelevant, serverBaseSlotEntityRestriction.climateRelevant) &&
        Objects.equals(this.powerConsumption, serverBaseSlotEntityRestriction.powerConsumption) &&
        Objects.equals(this.powerSwitchingStatus, serverBaseSlotEntityRestriction.powerSwitchingStatus) &&
        Objects.equals(this.planStatus, serverBaseSlotEntityRestriction.planStatus) &&
        Objects.equals(this.systemRuntime, serverBaseSlotEntityRestriction.systemRuntime) &&
        Objects.equals(this.weight, serverBaseSlotEntityRestriction.weight) &&
        Objects.equals(this.remark, serverBaseSlotEntityRestriction.remark) &&
        Objects.equals(this.elid, serverBaseSlotEntityRestriction.elid) &&
        Objects.equals(this.lastSeen, serverBaseSlotEntityRestriction.lastSeen) &&
        Objects.equals(this.typeElid, serverBaseSlotEntityRestriction.typeElid) &&
        Objects.equals(this.visibleId, serverBaseSlotEntityRestriction.visibleId) &&
        Objects.equals(this.id, serverBaseSlotEntityRestriction.id) &&
        Objects.equals(this.heatEmission, serverBaseSlotEntityRestriction.heatEmission);
  }
  ...
  public String toString() {
    ...
    sb.append("class ServerBaseSlotEntityRestriction {\n");
