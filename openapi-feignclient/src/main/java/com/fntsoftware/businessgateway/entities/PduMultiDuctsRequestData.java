...
import com.fntsoftware.businessgateway.entities.PduMultiDuctsEntityRestriction;
import com.fntsoftware.businessgateway.entities.PduMultiDuctsRelationRestriction;
...
/**
 * PduMultiDuctsRequestData
 */
@JsonPropertyOrder({
  PduMultiDuctsRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  PduMultiDuctsRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  PduMultiDuctsRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  PduMultiDuctsRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-03-04T13:31:32.601557352Z[Etc/UTC]")
public class PduMultiDuctsRequestData {
  ...
  private PduMultiDuctsEntityRestriction entityRestrictions;

  public static final String JSON_PROPERTY_RELATION_RESTRICTIONS = "relationRestrictions";
  private PduMultiDuctsRelationRestriction relationRestrictions;
  ...
  public PduMultiDuctsRequestData() {
  }

  public PduMultiDuctsRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public PduMultiDuctsRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public PduMultiDuctsRequestData entityRestrictions(PduMultiDuctsEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public PduMultiDuctsEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(PduMultiDuctsEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public PduMultiDuctsRequestData relationRestrictions(PduMultiDuctsRelationRestriction relationRestrictions) {
  ...
  **/
  ...
  public PduMultiDuctsRelationRestriction getRelationRestrictions() {
    return relationRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_RELATION_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRelationRestrictions(PduMultiDuctsRelationRestriction relationRestrictions) {
    this.relationRestrictions = relationRestrictions;
  }


  public PduMultiDuctsRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public PduMultiDuctsRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    PduMultiDuctsRequestData pduMultiDuctsRequestData = (PduMultiDuctsRequestData) o;
    return Objects.equals(this.returnEntityAttributes, pduMultiDuctsRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, pduMultiDuctsRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, pduMultiDuctsRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, pduMultiDuctsRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class PduMultiDuctsRequestData {\n");
