...
import com.fntsoftware.businessgateway.entities.ServiceTelcoTrailLogicalPortEndEntityRestriction;
...
/**
 * ServiceTelcoTrailLogicalPortEndRequestData
 */
@JsonPropertyOrder({
  ServiceTelcoTrailLogicalPortEndRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  ServiceTelcoTrailLogicalPortEndRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  ServiceTelcoTrailLogicalPortEndRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  ServiceTelcoTrailLogicalPortEndRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-03-04T13:31:32.601557352Z[Etc/UTC]")
public class ServiceTelcoTrailLogicalPortEndRequestData {
  ...
  private ServiceTelcoTrailLogicalPortEndEntityRestriction entityRestrictions;
  ...
  public ServiceTelcoTrailLogicalPortEndRequestData() {
  }

  public ServiceTelcoTrailLogicalPortEndRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public ServiceTelcoTrailLogicalPortEndRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public ServiceTelcoTrailLogicalPortEndRequestData entityRestrictions(ServiceTelcoTrailLogicalPortEndEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public ServiceTelcoTrailLogicalPortEndEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(ServiceTelcoTrailLogicalPortEndEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public ServiceTelcoTrailLogicalPortEndRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public ServiceTelcoTrailLogicalPortEndRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public ServiceTelcoTrailLogicalPortEndRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ServiceTelcoTrailLogicalPortEndRequestData serviceTelcoTrailLogicalPortEndRequestData = (ServiceTelcoTrailLogicalPortEndRequestData) o;
    return Objects.equals(this.returnEntityAttributes, serviceTelcoTrailLogicalPortEndRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, serviceTelcoTrailLogicalPortEndRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, serviceTelcoTrailLogicalPortEndRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, serviceTelcoTrailLogicalPortEndRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class ServiceTelcoTrailLogicalPortEndRequestData {\n");
