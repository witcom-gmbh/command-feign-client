...
import com.fntsoftware.businessgateway.entities.DeviceMasterPassiveModulesEntityRestriction;
...
/**
 * DeviceMasterPassiveModulesRequestData
 */
@JsonPropertyOrder({
  DeviceMasterPassiveModulesRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  DeviceMasterPassiveModulesRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  DeviceMasterPassiveModulesRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  DeviceMasterPassiveModulesRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-03-04T13:31:32.601557352Z[Etc/UTC]")
public class DeviceMasterPassiveModulesRequestData {
  ...
  private DeviceMasterPassiveModulesEntityRestriction entityRestrictions;
  ...
  public DeviceMasterPassiveModulesRequestData() {
  }

  public DeviceMasterPassiveModulesRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public DeviceMasterPassiveModulesRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public DeviceMasterPassiveModulesRequestData entityRestrictions(DeviceMasterPassiveModulesEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public DeviceMasterPassiveModulesEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(DeviceMasterPassiveModulesEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public DeviceMasterPassiveModulesRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public DeviceMasterPassiveModulesRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public DeviceMasterPassiveModulesRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    DeviceMasterPassiveModulesRequestData deviceMasterPassiveModulesRequestData = (DeviceMasterPassiveModulesRequestData) o;
    return Objects.equals(this.returnEntityAttributes, deviceMasterPassiveModulesRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, deviceMasterPassiveModulesRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, deviceMasterPassiveModulesRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, deviceMasterPassiveModulesRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeviceMasterPassiveModulesRequestData {\n");
