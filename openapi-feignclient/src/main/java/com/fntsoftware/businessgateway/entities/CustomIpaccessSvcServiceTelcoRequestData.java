...
import com.fntsoftware.businessgateway.entities.CustomIpaccessSvcServiceTelcoEntityRestriction;
...
/**
 * CustomIpaccessSvcServiceTelcoRequestData
 */
@JsonPropertyOrder({
  CustomIpaccessSvcServiceTelcoRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  CustomIpaccessSvcServiceTelcoRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  CustomIpaccessSvcServiceTelcoRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  CustomIpaccessSvcServiceTelcoRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-02-26T11:20:24.990023935Z[Etc/UTC]")
public class CustomIpaccessSvcServiceTelcoRequestData {
  ...
  private CustomIpaccessSvcServiceTelcoEntityRestriction entityRestrictions;
  ...
  public CustomIpaccessSvcServiceTelcoRequestData() {
  }

  public CustomIpaccessSvcServiceTelcoRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public CustomIpaccessSvcServiceTelcoRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public CustomIpaccessSvcServiceTelcoRequestData entityRestrictions(CustomIpaccessSvcServiceTelcoEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public CustomIpaccessSvcServiceTelcoEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(CustomIpaccessSvcServiceTelcoEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public CustomIpaccessSvcServiceTelcoRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public CustomIpaccessSvcServiceTelcoRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public CustomIpaccessSvcServiceTelcoRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    CustomIpaccessSvcServiceTelcoRequestData customIpaccessSvcServiceTelcoRequestData = (CustomIpaccessSvcServiceTelcoRequestData) o;
    return Objects.equals(this.returnEntityAttributes, customIpaccessSvcServiceTelcoRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, customIpaccessSvcServiceTelcoRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, customIpaccessSvcServiceTelcoRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, customIpaccessSvcServiceTelcoRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class CustomIpaccessSvcServiceTelcoRequestData {\n");
