...
import com.fntsoftware.businessgateway.entities.CampusBuildingsEntityRestriction;
...
/**
 * CampusBuildingsRequestData
 */
@JsonPropertyOrder({
  CampusBuildingsRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  CampusBuildingsRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  CampusBuildingsRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  CampusBuildingsRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-01-31T11:10:37.320689708Z[Etc/UTC]")
public class CampusBuildingsRequestData {
  ...
  private CampusBuildingsEntityRestriction entityRestrictions;
  ...
  public CampusBuildingsRequestData() {
  }

  public CampusBuildingsRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public CampusBuildingsRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public CampusBuildingsRequestData entityRestrictions(CampusBuildingsEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public CampusBuildingsEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(CampusBuildingsEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public CampusBuildingsRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public CampusBuildingsRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public CampusBuildingsRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    CampusBuildingsRequestData campusBuildingsRequestData = (CampusBuildingsRequestData) o;
    return Objects.equals(this.returnEntityAttributes, campusBuildingsRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, campusBuildingsRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, campusBuildingsRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, campusBuildingsRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class CampusBuildingsRequestData {\n");
