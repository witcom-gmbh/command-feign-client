...
import com.fntsoftware.businessgateway.entities.ModuleDeviceMasterEntityRestriction;
...
/**
 * ModuleDeviceMasterRequestData
 */
@JsonPropertyOrder({
  ModuleDeviceMasterRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  ModuleDeviceMasterRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  ModuleDeviceMasterRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  ModuleDeviceMasterRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-02-26T11:20:24.990023935Z[Etc/UTC]")
public class ModuleDeviceMasterRequestData {
  ...
  private ModuleDeviceMasterEntityRestriction entityRestrictions;
  ...
  public ModuleDeviceMasterRequestData() {
  }

  public ModuleDeviceMasterRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public ModuleDeviceMasterRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public ModuleDeviceMasterRequestData entityRestrictions(ModuleDeviceMasterEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public ModuleDeviceMasterEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(ModuleDeviceMasterEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public ModuleDeviceMasterRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public ModuleDeviceMasterRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public ModuleDeviceMasterRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ModuleDeviceMasterRequestData moduleDeviceMasterRequestData = (ModuleDeviceMasterRequestData) o;
    return Objects.equals(this.returnEntityAttributes, moduleDeviceMasterRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, moduleDeviceMasterRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, moduleDeviceMasterRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, moduleDeviceMasterRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class ModuleDeviceMasterRequestData {\n");
