...
import com.fntsoftware.businessgateway.entities.HostnameNetMandatorEntityRestriction;
...
/**
 * HostnameNetMandatorRequestData
 */
@JsonPropertyOrder({
  HostnameNetMandatorRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  HostnameNetMandatorRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  HostnameNetMandatorRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  HostnameNetMandatorRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-02-26T11:20:24.990023935Z[Etc/UTC]")
public class HostnameNetMandatorRequestData {
  ...
  private HostnameNetMandatorEntityRestriction entityRestrictions;
  ...
  public HostnameNetMandatorRequestData() {
  }

  public HostnameNetMandatorRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public HostnameNetMandatorRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public HostnameNetMandatorRequestData entityRestrictions(HostnameNetMandatorEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public HostnameNetMandatorEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(HostnameNetMandatorEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public HostnameNetMandatorRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public HostnameNetMandatorRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public HostnameNetMandatorRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    HostnameNetMandatorRequestData hostnameNetMandatorRequestData = (HostnameNetMandatorRequestData) o;
    return Objects.equals(this.returnEntityAttributes, hostnameNetMandatorRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, hostnameNetMandatorRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, hostnameNetMandatorRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, hostnameNetMandatorRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class HostnameNetMandatorRequestData {\n");
