...
import com.fntsoftware.businessgateway.entities.PersonContractsEntityRestriction;
import com.fntsoftware.businessgateway.entities.PersonContractsRelationRestriction;
...
/**
 * PersonContractsRequestData
 */
@JsonPropertyOrder({
  PersonContractsRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  PersonContractsRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  PersonContractsRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  PersonContractsRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-02-26T11:20:24.990023935Z[Etc/UTC]")
public class PersonContractsRequestData {
  ...
  private PersonContractsEntityRestriction entityRestrictions;

  public static final String JSON_PROPERTY_RELATION_RESTRICTIONS = "relationRestrictions";
  private PersonContractsRelationRestriction relationRestrictions;
  ...
  public PersonContractsRequestData() {
  }

  public PersonContractsRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public PersonContractsRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public PersonContractsRequestData entityRestrictions(PersonContractsEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public PersonContractsEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(PersonContractsEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public PersonContractsRequestData relationRestrictions(PersonContractsRelationRestriction relationRestrictions) {
  ...
  **/
  ...
  public PersonContractsRelationRestriction getRelationRestrictions() {
    return relationRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_RELATION_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRelationRestrictions(PersonContractsRelationRestriction relationRestrictions) {
    this.relationRestrictions = relationRestrictions;
  }


  public PersonContractsRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public PersonContractsRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    PersonContractsRequestData personContractsRequestData = (PersonContractsRequestData) o;
    return Objects.equals(this.returnEntityAttributes, personContractsRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, personContractsRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, personContractsRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, personContractsRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class PersonContractsRequestData {\n");
