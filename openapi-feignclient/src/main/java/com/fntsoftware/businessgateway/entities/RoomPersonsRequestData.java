...
import com.fntsoftware.businessgateway.entities.RoomPersonsEntityRestriction;
import com.fntsoftware.businessgateway.entities.RoomPersonsRelationRestriction;
...
/**
 * RoomPersonsRequestData
 */
@JsonPropertyOrder({
  RoomPersonsRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  RoomPersonsRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  RoomPersonsRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  RoomPersonsRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-01-31T11:10:37.320689708Z[Etc/UTC]")
public class RoomPersonsRequestData {
  ...
  private RoomPersonsEntityRestriction entityRestrictions;

  public static final String JSON_PROPERTY_RELATION_RESTRICTIONS = "relationRestrictions";
  private RoomPersonsRelationRestriction relationRestrictions;
  ...
  public RoomPersonsRequestData() {
  }

  public RoomPersonsRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public RoomPersonsRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public RoomPersonsRequestData entityRestrictions(RoomPersonsEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public RoomPersonsEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(RoomPersonsEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public RoomPersonsRequestData relationRestrictions(RoomPersonsRelationRestriction relationRestrictions) {
  ...
  **/
  ...
  public RoomPersonsRelationRestriction getRelationRestrictions() {
    return relationRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_RELATION_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRelationRestrictions(RoomPersonsRelationRestriction relationRestrictions) {
    this.relationRestrictions = relationRestrictions;
  }


  public RoomPersonsRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public RoomPersonsRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    RoomPersonsRequestData roomPersonsRequestData = (RoomPersonsRequestData) o;
    return Objects.equals(this.returnEntityAttributes, roomPersonsRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, roomPersonsRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, roomPersonsRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, roomPersonsRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class RoomPersonsRequestData {\n");
