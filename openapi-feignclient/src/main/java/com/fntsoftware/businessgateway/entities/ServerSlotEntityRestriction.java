...
/**
 * ServerSlotEntityRestriction
 */
@JsonPropertyOrder({
  ServerSlotEntityRestriction.JSON_PROPERTY_CLIMATE_RELEVANT,
  ServerSlotEntityRestriction.JSON_PROPERTY_POWER_CONSUMPTION,
  ServerSlotEntityRestriction.JSON_PROPERTY_POWER_SWITCHING_STATUS,
  ServerSlotEntityRestriction.JSON_PROPERTY_PLAN_STATUS,
  ServerSlotEntityRestriction.JSON_PROPERTY_SYSTEM_RUNTIME,
  ServerSlotEntityRestriction.JSON_PROPERTY_WEIGHT,
  ServerSlotEntityRestriction.JSON_PROPERTY_REMARK,
  ServerSlotEntityRestriction.JSON_PROPERTY_ELID,
  ServerSlotEntityRestriction.JSON_PROPERTY_LAST_SEEN,
  ServerSlotEntityRestriction.JSON_PROPERTY_TYPE_ELID,
  ServerSlotEntityRestriction.JSON_PROPERTY_VISIBLE_ID,
  ServerSlotEntityRestriction.JSON_PROPERTY_ID,
  ServerSlotEntityRestriction.JSON_PROPERTY_HEAT_EMISSION
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-01-31T11:10:37.320689708Z[Etc/UTC]")
public class ServerSlotEntityRestriction {
  ...
  public ServerSlotEntityRestriction() {
  }

  public ServerSlotEntityRestriction climateRelevant(RestrictionsBoolean climateRelevant) {
  ...
  **/
  ...
  public ServerSlotEntityRestriction powerConsumption(RestrictionsNumeric powerConsumption) {
  ...
  **/
  ...
  public ServerSlotEntityRestriction powerSwitchingStatus(RestrictionsString powerSwitchingStatus) {
  ...
  **/
  ...
  public ServerSlotEntityRestriction planStatus(RestrictionsString planStatus) {
  ...
  **/
  ...
  public ServerSlotEntityRestriction systemRuntime(RestrictionsNumeric systemRuntime) {
  ...
  **/
  ...
  public ServerSlotEntityRestriction weight(RestrictionsNumeric weight) {
  ...
  **/
  ...
  public ServerSlotEntityRestriction remark(RestrictionsString remark) {
  ...
  **/
  ...
  public ServerSlotEntityRestriction elid(RestrictionsString elid) {
  ...
  **/
  ...
  public ServerSlotEntityRestriction lastSeen(RestrictionsDate lastSeen) {
  ...
  **/
  ...
  public ServerSlotEntityRestriction typeElid(RestrictionsString typeElid) {
  ...
  **/
  ...
  public ServerSlotEntityRestriction visibleId(RestrictionsString visibleId) {
  ...
  **/
  ...
  public ServerSlotEntityRestriction id(RestrictionsString id) {
  ...
  **/
  ...
  public ServerSlotEntityRestriction heatEmission(RestrictionsNumeric heatEmission) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ServerSlotEntityRestriction serverSlotEntityRestriction = (ServerSlotEntityRestriction) o;
    return Objects.equals(this.climateRelevant, serverSlotEntityRestriction.climateRelevant) &&
        Objects.equals(this.powerConsumption, serverSlotEntityRestriction.powerConsumption) &&
        Objects.equals(this.powerSwitchingStatus, serverSlotEntityRestriction.powerSwitchingStatus) &&
        Objects.equals(this.planStatus, serverSlotEntityRestriction.planStatus) &&
        Objects.equals(this.systemRuntime, serverSlotEntityRestriction.systemRuntime) &&
        Objects.equals(this.weight, serverSlotEntityRestriction.weight) &&
        Objects.equals(this.remark, serverSlotEntityRestriction.remark) &&
        Objects.equals(this.elid, serverSlotEntityRestriction.elid) &&
        Objects.equals(this.lastSeen, serverSlotEntityRestriction.lastSeen) &&
        Objects.equals(this.typeElid, serverSlotEntityRestriction.typeElid) &&
        Objects.equals(this.visibleId, serverSlotEntityRestriction.visibleId) &&
        Objects.equals(this.id, serverSlotEntityRestriction.id) &&
        Objects.equals(this.heatEmission, serverSlotEntityRestriction.heatEmission);
  }
  ...
  public String toString() {
    ...
    sb.append("class ServerSlotEntityRestriction {\n");
