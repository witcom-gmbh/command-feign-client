...
import com.fntsoftware.businessgateway.entities.Ipv4NetrangeIpv4NetworkEntityRestriction;
...
/**
 * Ipv4NetrangeIpv4NetworkRequestData
 */
@JsonPropertyOrder({
  Ipv4NetrangeIpv4NetworkRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  Ipv4NetrangeIpv4NetworkRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  Ipv4NetrangeIpv4NetworkRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  Ipv4NetrangeIpv4NetworkRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-03-04T13:31:32.601557352Z[Etc/UTC]")
public class Ipv4NetrangeIpv4NetworkRequestData {
  ...
  private Ipv4NetrangeIpv4NetworkEntityRestriction entityRestrictions;
  ...
  public Ipv4NetrangeIpv4NetworkRequestData() {
  }

  public Ipv4NetrangeIpv4NetworkRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public Ipv4NetrangeIpv4NetworkRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public Ipv4NetrangeIpv4NetworkRequestData entityRestrictions(Ipv4NetrangeIpv4NetworkEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public Ipv4NetrangeIpv4NetworkEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(Ipv4NetrangeIpv4NetworkEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public Ipv4NetrangeIpv4NetworkRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public Ipv4NetrangeIpv4NetworkRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public Ipv4NetrangeIpv4NetworkRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    Ipv4NetrangeIpv4NetworkRequestData ipv4NetrangeIpv4NetworkRequestData = (Ipv4NetrangeIpv4NetworkRequestData) o;
    return Objects.equals(this.returnEntityAttributes, ipv4NetrangeIpv4NetworkRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, ipv4NetrangeIpv4NetworkRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, ipv4NetrangeIpv4NetworkRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, ipv4NetrangeIpv4NetworkRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class Ipv4NetrangeIpv4NetworkRequestData {\n");
