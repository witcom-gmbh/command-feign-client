...
import com.fntsoftware.businessgateway.entities.NmModuleSlotEntityRestriction;
import com.fntsoftware.businessgateway.entities.NmModuleSlotRelationRestriction;
...
/**
 * NmModuleSlotRequestData
 */
@JsonPropertyOrder({
  NmModuleSlotRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  NmModuleSlotRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  NmModuleSlotRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  NmModuleSlotRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-01-31T11:10:37.320689708Z[Etc/UTC]")
public class NmModuleSlotRequestData {
  ...
  private NmModuleSlotEntityRestriction entityRestrictions;

  public static final String JSON_PROPERTY_RELATION_RESTRICTIONS = "relationRestrictions";
  private NmModuleSlotRelationRestriction relationRestrictions;
  ...
  public NmModuleSlotRequestData() {
  }

  public NmModuleSlotRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public NmModuleSlotRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public NmModuleSlotRequestData entityRestrictions(NmModuleSlotEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public NmModuleSlotEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(NmModuleSlotEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public NmModuleSlotRequestData relationRestrictions(NmModuleSlotRelationRestriction relationRestrictions) {
  ...
  **/
  ...
  public NmModuleSlotRelationRestriction getRelationRestrictions() {
    return relationRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_RELATION_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRelationRestrictions(NmModuleSlotRelationRestriction relationRestrictions) {
    this.relationRestrictions = relationRestrictions;
  }


  public NmModuleSlotRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public NmModuleSlotRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    NmModuleSlotRequestData nmModuleSlotRequestData = (NmModuleSlotRequestData) o;
    return Objects.equals(this.returnEntityAttributes, nmModuleSlotRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, nmModuleSlotRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, nmModuleSlotRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, nmModuleSlotRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class NmModuleSlotRequestData {\n");
