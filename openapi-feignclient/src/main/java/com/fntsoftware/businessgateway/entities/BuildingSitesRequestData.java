...
import com.fntsoftware.businessgateway.entities.BuildingSitesEntityRestriction;
import com.fntsoftware.businessgateway.entities.BuildingSitesRelationRestriction;
...
/**
 * BuildingSitesRequestData
 */
@JsonPropertyOrder({
  BuildingSitesRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  BuildingSitesRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  BuildingSitesRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  BuildingSitesRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-01-31T11:10:37.320689708Z[Etc/UTC]")
public class BuildingSitesRequestData {
  ...
  private BuildingSitesEntityRestriction entityRestrictions;

  public static final String JSON_PROPERTY_RELATION_RESTRICTIONS = "relationRestrictions";
  private BuildingSitesRelationRestriction relationRestrictions;
  ...
  public BuildingSitesRequestData() {
  }

  public BuildingSitesRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public BuildingSitesRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public BuildingSitesRequestData entityRestrictions(BuildingSitesEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public BuildingSitesEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(BuildingSitesEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public BuildingSitesRequestData relationRestrictions(BuildingSitesRelationRestriction relationRestrictions) {
  ...
  **/
  ...
  public BuildingSitesRelationRestriction getRelationRestrictions() {
    return relationRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_RELATION_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRelationRestrictions(BuildingSitesRelationRestriction relationRestrictions) {
    this.relationRestrictions = relationRestrictions;
  }


  public BuildingSitesRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public BuildingSitesRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    BuildingSitesRequestData buildingSitesRequestData = (BuildingSitesRequestData) o;
    return Objects.equals(this.returnEntityAttributes, buildingSitesRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, buildingSitesRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, buildingSitesRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, buildingSitesRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class BuildingSitesRequestData {\n");
