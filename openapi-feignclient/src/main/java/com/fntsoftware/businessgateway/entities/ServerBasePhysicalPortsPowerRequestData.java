...
import com.fntsoftware.businessgateway.entities.ServerBasePhysicalPortsPowerEntityRestriction;
...
/**
 * ServerBasePhysicalPortsPowerRequestData
 */
@JsonPropertyOrder({
  ServerBasePhysicalPortsPowerRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  ServerBasePhysicalPortsPowerRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  ServerBasePhysicalPortsPowerRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  ServerBasePhysicalPortsPowerRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-01-31T11:10:37.320689708Z[Etc/UTC]")
public class ServerBasePhysicalPortsPowerRequestData {
  ...
  private ServerBasePhysicalPortsPowerEntityRestriction entityRestrictions;
  ...
  public ServerBasePhysicalPortsPowerRequestData() {
  }

  public ServerBasePhysicalPortsPowerRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public ServerBasePhysicalPortsPowerRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public ServerBasePhysicalPortsPowerRequestData entityRestrictions(ServerBasePhysicalPortsPowerEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public ServerBasePhysicalPortsPowerEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(ServerBasePhysicalPortsPowerEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public ServerBasePhysicalPortsPowerRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public ServerBasePhysicalPortsPowerRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public ServerBasePhysicalPortsPowerRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ServerBasePhysicalPortsPowerRequestData serverBasePhysicalPortsPowerRequestData = (ServerBasePhysicalPortsPowerRequestData) o;
    return Objects.equals(this.returnEntityAttributes, serverBasePhysicalPortsPowerRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, serverBasePhysicalPortsPowerRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, serverBasePhysicalPortsPowerRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, serverBasePhysicalPortsPowerRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class ServerBasePhysicalPortsPowerRequestData {\n");
