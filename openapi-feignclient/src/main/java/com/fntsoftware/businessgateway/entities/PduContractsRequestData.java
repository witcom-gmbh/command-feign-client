...
import com.fntsoftware.businessgateway.entities.PduContractsEntityRestriction;
import com.fntsoftware.businessgateway.entities.PduContractsRelationRestriction;
...
/**
 * PduContractsRequestData
 */
@JsonPropertyOrder({
  PduContractsRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  PduContractsRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  PduContractsRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  PduContractsRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-02-26T11:20:24.990023935Z[Etc/UTC]")
public class PduContractsRequestData {
  ...
  private PduContractsEntityRestriction entityRestrictions;

  public static final String JSON_PROPERTY_RELATION_RESTRICTIONS = "relationRestrictions";
  private PduContractsRelationRestriction relationRestrictions;
  ...
  public PduContractsRequestData() {
  }

  public PduContractsRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public PduContractsRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public PduContractsRequestData entityRestrictions(PduContractsEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public PduContractsEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(PduContractsEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public PduContractsRequestData relationRestrictions(PduContractsRelationRestriction relationRestrictions) {
  ...
  **/
  ...
  public PduContractsRelationRestriction getRelationRestrictions() {
    return relationRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_RELATION_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRelationRestrictions(PduContractsRelationRestriction relationRestrictions) {
    this.relationRestrictions = relationRestrictions;
  }


  public PduContractsRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public PduContractsRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    PduContractsRequestData pduContractsRequestData = (PduContractsRequestData) o;
    return Objects.equals(this.returnEntityAttributes, pduContractsRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, pduContractsRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, pduContractsRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, pduContractsRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class PduContractsRequestData {\n");
