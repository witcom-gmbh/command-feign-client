...
import com.fntsoftware.businessgateway.entities.LogicalPortParentDeviceEntityRestriction;
...
/**
 * LogicalPortParentDeviceRequestData
 */
@JsonPropertyOrder({
  LogicalPortParentDeviceRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  LogicalPortParentDeviceRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  LogicalPortParentDeviceRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  LogicalPortParentDeviceRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-03-04T13:31:32.601557352Z[Etc/UTC]")
public class LogicalPortParentDeviceRequestData {
  ...
  private LogicalPortParentDeviceEntityRestriction entityRestrictions;
  ...
  public LogicalPortParentDeviceRequestData() {
  }

  public LogicalPortParentDeviceRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public LogicalPortParentDeviceRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public LogicalPortParentDeviceRequestData entityRestrictions(LogicalPortParentDeviceEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public LogicalPortParentDeviceEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(LogicalPortParentDeviceEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public LogicalPortParentDeviceRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public LogicalPortParentDeviceRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public LogicalPortParentDeviceRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    LogicalPortParentDeviceRequestData logicalPortParentDeviceRequestData = (LogicalPortParentDeviceRequestData) o;
    return Objects.equals(this.returnEntityAttributes, logicalPortParentDeviceRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, logicalPortParentDeviceRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, logicalPortParentDeviceRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, logicalPortParentDeviceRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class LogicalPortParentDeviceRequestData {\n");
