...
/**
 * DeviceAllSlotEntityRestriction
 */
@JsonPropertyOrder({
  DeviceAllSlotEntityRestriction.JSON_PROPERTY_CLIMATE_RELEVANT,
  DeviceAllSlotEntityRestriction.JSON_PROPERTY_POWER_CONSUMPTION,
  DeviceAllSlotEntityRestriction.JSON_PROPERTY_POWER_SWITCHING_STATUS,
  DeviceAllSlotEntityRestriction.JSON_PROPERTY_PLAN_STATUS,
  DeviceAllSlotEntityRestriction.JSON_PROPERTY_SYSTEM_RUNTIME,
  DeviceAllSlotEntityRestriction.JSON_PROPERTY_WEIGHT,
  DeviceAllSlotEntityRestriction.JSON_PROPERTY_REMARK,
  DeviceAllSlotEntityRestriction.JSON_PROPERTY_ELID,
  DeviceAllSlotEntityRestriction.JSON_PROPERTY_LAST_SEEN,
  DeviceAllSlotEntityRestriction.JSON_PROPERTY_TYPE_ELID,
  DeviceAllSlotEntityRestriction.JSON_PROPERTY_VISIBLE_ID,
  DeviceAllSlotEntityRestriction.JSON_PROPERTY_ID,
  DeviceAllSlotEntityRestriction.JSON_PROPERTY_HEAT_EMISSION
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-01-31T11:10:37.320689708Z[Etc/UTC]")
public class DeviceAllSlotEntityRestriction {
  ...
  public DeviceAllSlotEntityRestriction() {
  }

  public DeviceAllSlotEntityRestriction climateRelevant(RestrictionsBoolean climateRelevant) {
  ...
  **/
  ...
  public DeviceAllSlotEntityRestriction powerConsumption(RestrictionsNumeric powerConsumption) {
  ...
  **/
  ...
  public DeviceAllSlotEntityRestriction powerSwitchingStatus(RestrictionsString powerSwitchingStatus) {
  ...
  **/
  ...
  public DeviceAllSlotEntityRestriction planStatus(RestrictionsString planStatus) {
  ...
  **/
  ...
  public DeviceAllSlotEntityRestriction systemRuntime(RestrictionsNumeric systemRuntime) {
  ...
  **/
  ...
  public DeviceAllSlotEntityRestriction weight(RestrictionsNumeric weight) {
  ...
  **/
  ...
  public DeviceAllSlotEntityRestriction remark(RestrictionsString remark) {
  ...
  **/
  ...
  public DeviceAllSlotEntityRestriction elid(RestrictionsString elid) {
  ...
  **/
  ...
  public DeviceAllSlotEntityRestriction lastSeen(RestrictionsDate lastSeen) {
  ...
  **/
  ...
  public DeviceAllSlotEntityRestriction typeElid(RestrictionsString typeElid) {
  ...
  **/
  ...
  public DeviceAllSlotEntityRestriction visibleId(RestrictionsString visibleId) {
  ...
  **/
  ...
  public DeviceAllSlotEntityRestriction id(RestrictionsString id) {
  ...
  **/
  ...
  public DeviceAllSlotEntityRestriction heatEmission(RestrictionsNumeric heatEmission) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    DeviceAllSlotEntityRestriction deviceAllSlotEntityRestriction = (DeviceAllSlotEntityRestriction) o;
    return Objects.equals(this.climateRelevant, deviceAllSlotEntityRestriction.climateRelevant) &&
        Objects.equals(this.powerConsumption, deviceAllSlotEntityRestriction.powerConsumption) &&
        Objects.equals(this.powerSwitchingStatus, deviceAllSlotEntityRestriction.powerSwitchingStatus) &&
        Objects.equals(this.planStatus, deviceAllSlotEntityRestriction.planStatus) &&
        Objects.equals(this.systemRuntime, deviceAllSlotEntityRestriction.systemRuntime) &&
        Objects.equals(this.weight, deviceAllSlotEntityRestriction.weight) &&
        Objects.equals(this.remark, deviceAllSlotEntityRestriction.remark) &&
        Objects.equals(this.elid, deviceAllSlotEntityRestriction.elid) &&
        Objects.equals(this.lastSeen, deviceAllSlotEntityRestriction.lastSeen) &&
        Objects.equals(this.typeElid, deviceAllSlotEntityRestriction.typeElid) &&
        Objects.equals(this.visibleId, deviceAllSlotEntityRestriction.visibleId) &&
        Objects.equals(this.id, deviceAllSlotEntityRestriction.id) &&
        Objects.equals(this.heatEmission, deviceAllSlotEntityRestriction.heatEmission);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeviceAllSlotEntityRestriction {\n");
