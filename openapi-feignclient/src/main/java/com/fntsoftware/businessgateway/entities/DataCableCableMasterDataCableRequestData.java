...
import com.fntsoftware.businessgateway.entities.DataCableCableMasterDataCableEntityRestriction;
...
/**
 * DataCableCableMasterDataCableRequestData
 */
@JsonPropertyOrder({
  DataCableCableMasterDataCableRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  DataCableCableMasterDataCableRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  DataCableCableMasterDataCableRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  DataCableCableMasterDataCableRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-02-26T11:20:24.990023935Z[Etc/UTC]")
public class DataCableCableMasterDataCableRequestData {
  ...
  private DataCableCableMasterDataCableEntityRestriction entityRestrictions;
  ...
  public DataCableCableMasterDataCableRequestData() {
  }

  public DataCableCableMasterDataCableRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public DataCableCableMasterDataCableRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public DataCableCableMasterDataCableRequestData entityRestrictions(DataCableCableMasterDataCableEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public DataCableCableMasterDataCableEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(DataCableCableMasterDataCableEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public DataCableCableMasterDataCableRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public DataCableCableMasterDataCableRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public DataCableCableMasterDataCableRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    DataCableCableMasterDataCableRequestData dataCableCableMasterDataCableRequestData = (DataCableCableMasterDataCableRequestData) o;
    return Objects.equals(this.returnEntityAttributes, dataCableCableMasterDataCableRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, dataCableCableMasterDataCableRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, dataCableCableMasterDataCableRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, dataCableCableMasterDataCableRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class DataCableCableMasterDataCableRequestData {\n");
