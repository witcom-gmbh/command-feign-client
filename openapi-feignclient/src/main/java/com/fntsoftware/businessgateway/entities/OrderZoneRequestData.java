...
import com.fntsoftware.businessgateway.entities.OrderZoneEntityRestriction;
...
/**
 * OrderZoneRequestData
 */
@JsonPropertyOrder({
  OrderZoneRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  OrderZoneRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  OrderZoneRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  OrderZoneRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-01-31T11:10:37.320689708Z[Etc/UTC]")
public class OrderZoneRequestData {
  ...
  private OrderZoneEntityRestriction entityRestrictions;
  ...
  public OrderZoneRequestData() {
  }

  public OrderZoneRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public OrderZoneRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public OrderZoneRequestData entityRestrictions(OrderZoneEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public OrderZoneEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(OrderZoneEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public OrderZoneRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public OrderZoneRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public OrderZoneRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    OrderZoneRequestData orderZoneRequestData = (OrderZoneRequestData) o;
    return Objects.equals(this.returnEntityAttributes, orderZoneRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, orderZoneRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, orderZoneRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, orderZoneRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class OrderZoneRequestData {\n");
