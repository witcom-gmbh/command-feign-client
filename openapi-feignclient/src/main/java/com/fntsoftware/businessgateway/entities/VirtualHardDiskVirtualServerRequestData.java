...
import com.fntsoftware.businessgateway.entities.VirtualHardDiskVirtualServerEntityRestriction;
...
/**
 * VirtualHardDiskVirtualServerRequestData
 */
@JsonPropertyOrder({
  VirtualHardDiskVirtualServerRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  VirtualHardDiskVirtualServerRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  VirtualHardDiskVirtualServerRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  VirtualHardDiskVirtualServerRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-03-04T13:31:32.601557352Z[Etc/UTC]")
public class VirtualHardDiskVirtualServerRequestData {
  ...
  private VirtualHardDiskVirtualServerEntityRestriction entityRestrictions;
  ...
  public VirtualHardDiskVirtualServerRequestData() {
  }

  public VirtualHardDiskVirtualServerRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public VirtualHardDiskVirtualServerRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public VirtualHardDiskVirtualServerRequestData entityRestrictions(VirtualHardDiskVirtualServerEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public VirtualHardDiskVirtualServerEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(VirtualHardDiskVirtualServerEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public VirtualHardDiskVirtualServerRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public VirtualHardDiskVirtualServerRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public VirtualHardDiskVirtualServerRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    VirtualHardDiskVirtualServerRequestData virtualHardDiskVirtualServerRequestData = (VirtualHardDiskVirtualServerRequestData) o;
    return Objects.equals(this.returnEntityAttributes, virtualHardDiskVirtualServerRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, virtualHardDiskVirtualServerRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, virtualHardDiskVirtualServerRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, virtualHardDiskVirtualServerRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class VirtualHardDiskVirtualServerRequestData {\n");
