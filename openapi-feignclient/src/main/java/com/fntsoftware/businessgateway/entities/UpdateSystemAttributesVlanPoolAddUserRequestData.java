...
/**
 * UpdateSystemAttributesVlanPoolAddUserRequestData
 */
@JsonPropertyOrder({
  UpdateSystemAttributesVlanPoolAddUserRequestData.JSON_PROPERTY_MODIFY_PLAN,
  UpdateSystemAttributesVlanPoolAddUserRequestData.JSON_PROPERTY_DELETE_REAL,
  UpdateSystemAttributesVlanPoolAddUserRequestData.JSON_PROPERTY_READ_PLAN,
  UpdateSystemAttributesVlanPoolAddUserRequestData.JSON_PROPERTY_MANDANT_ID,
  UpdateSystemAttributesVlanPoolAddUserRequestData.JSON_PROPERTY_USER_ELID,
  UpdateSystemAttributesVlanPoolAddUserRequestData.JSON_PROPERTY_MODIFY_REAL,
  UpdateSystemAttributesVlanPoolAddUserRequestData.JSON_PROPERTY_READ_REAL,
  UpdateSystemAttributesVlanPoolAddUserRequestData.JSON_PROPERTY_DELETE_PLAN
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-02-26T11:20:24.990023935Z[Etc/UTC]")
public class UpdateSystemAttributesVlanPoolAddUserRequestData {
  ...
  public UpdateSystemAttributesVlanPoolAddUserRequestData() {
  }

  public UpdateSystemAttributesVlanPoolAddUserRequestData modifyPlan(Boolean modifyPlan) {
  ...
  **/
  ...
  public UpdateSystemAttributesVlanPoolAddUserRequestData deleteReal(Boolean deleteReal) {
  ...
  **/
  ...
  public UpdateSystemAttributesVlanPoolAddUserRequestData readPlan(Boolean readPlan) {
  ...
  **/
  ...
  public UpdateSystemAttributesVlanPoolAddUserRequestData mandantId(BigDecimal mandantId) {
  ...
  **/
  ...
  public UpdateSystemAttributesVlanPoolAddUserRequestData userElid(String userElid) {
  ...
  **/
  ...
  public UpdateSystemAttributesVlanPoolAddUserRequestData modifyReal(Boolean modifyReal) {
  ...
  **/
  ...
  public UpdateSystemAttributesVlanPoolAddUserRequestData readReal(Boolean readReal) {
  ...
  **/
  ...
  public UpdateSystemAttributesVlanPoolAddUserRequestData deletePlan(Boolean deletePlan) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    UpdateSystemAttributesVlanPoolAddUserRequestData updateSystemAttributesVlanPoolAddUserRequestData = (UpdateSystemAttributesVlanPoolAddUserRequestData) o;
    return Objects.equals(this.modifyPlan, updateSystemAttributesVlanPoolAddUserRequestData.modifyPlan) &&
        Objects.equals(this.deleteReal, updateSystemAttributesVlanPoolAddUserRequestData.deleteReal) &&
        Objects.equals(this.readPlan, updateSystemAttributesVlanPoolAddUserRequestData.readPlan) &&
        Objects.equals(this.mandantId, updateSystemAttributesVlanPoolAddUserRequestData.mandantId) &&
        Objects.equals(this.userElid, updateSystemAttributesVlanPoolAddUserRequestData.userElid) &&
        Objects.equals(this.modifyReal, updateSystemAttributesVlanPoolAddUserRequestData.modifyReal) &&
        Objects.equals(this.readReal, updateSystemAttributesVlanPoolAddUserRequestData.readReal) &&
        Objects.equals(this.deletePlan, updateSystemAttributesVlanPoolAddUserRequestData.deletePlan);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateSystemAttributesVlanPoolAddUserRequestData {\n");
