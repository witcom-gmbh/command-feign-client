...
import com.fntsoftware.businessgateway.entities.SiteNominalEntityRestriction;
...
/**
 * SiteNominalRequestData
 */
@JsonPropertyOrder({
  SiteNominalRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  SiteNominalRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  SiteNominalRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  SiteNominalRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-03-04T13:31:32.601557352Z[Etc/UTC]")
public class SiteNominalRequestData {
  ...
  private SiteNominalEntityRestriction entityRestrictions;
  ...
  public SiteNominalRequestData() {
  }

  public SiteNominalRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public SiteNominalRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public SiteNominalRequestData entityRestrictions(SiteNominalEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public SiteNominalEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(SiteNominalEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public SiteNominalRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public SiteNominalRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public SiteNominalRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    SiteNominalRequestData siteNominalRequestData = (SiteNominalRequestData) o;
    return Objects.equals(this.returnEntityAttributes, siteNominalRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, siteNominalRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, siteNominalRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, siteNominalRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class SiteNominalRequestData {\n");
