...
import com.fntsoftware.businessgateway.entities.DeviceMasterDeviceStoragesEntityRestriction;
...
/**
 * DeviceMasterDeviceStoragesRequestData
 */
@JsonPropertyOrder({
  DeviceMasterDeviceStoragesRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  DeviceMasterDeviceStoragesRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  DeviceMasterDeviceStoragesRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  DeviceMasterDeviceStoragesRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-01-31T11:10:37.320689708Z[Etc/UTC]")
public class DeviceMasterDeviceStoragesRequestData {
  ...
  private DeviceMasterDeviceStoragesEntityRestriction entityRestrictions;
  ...
  public DeviceMasterDeviceStoragesRequestData() {
  }

  public DeviceMasterDeviceStoragesRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public DeviceMasterDeviceStoragesRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public DeviceMasterDeviceStoragesRequestData entityRestrictions(DeviceMasterDeviceStoragesEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public DeviceMasterDeviceStoragesEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(DeviceMasterDeviceStoragesEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public DeviceMasterDeviceStoragesRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public DeviceMasterDeviceStoragesRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public DeviceMasterDeviceStoragesRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    DeviceMasterDeviceStoragesRequestData deviceMasterDeviceStoragesRequestData = (DeviceMasterDeviceStoragesRequestData) o;
    return Objects.equals(this.returnEntityAttributes, deviceMasterDeviceStoragesRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, deviceMasterDeviceStoragesRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, deviceMasterDeviceStoragesRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, deviceMasterDeviceStoragesRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeviceMasterDeviceStoragesRequestData {\n");
