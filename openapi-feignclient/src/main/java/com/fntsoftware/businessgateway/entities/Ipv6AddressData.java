 ...
 */
@JsonPropertyOrder({
  Ipv6AddressData.JSON_PROPERTY_MULTIPLE_USAGE,
  Ipv6AddressData.JSON_PROPERTY_NETRANGE_ELID,
  Ipv6AddressData.JSON_PROPERTY_IP_ADDRESS,
  Ipv6AddressData.JSON_PROPERTY_H_INFO,
  Ipv6AddressData.JSON_PROPERTY_REMARK,
  Ipv6AddressData.JSON_PROPERTY_ELID,
  Ipv6AddressData.JSON_PROPERTY_FULL_IP_ADDRESS,
  Ipv6AddressData.JSON_PROPERTY_MULTICAST,
  Ipv6AddressData.JSON_PROPERTY_NET_CLIENT_ELID,
  Ipv6AddressData.JSON_PROPERTY_MAC_ADDRESS,
  Ipv6AddressData.JSON_PROPERTY_DHCP_TYPE,
  Ipv6AddressData.JSON_PROPERTY_HOSTNAME_ELID,
  Ipv6AddressData.JSON_PROPERTY_LOOKUP_ADDRESS,
  Ipv6AddressData.JSON_PROPERTY_NETWORK_ELID,
  Ipv6AddressData.JSON_PROPERTY_START_DATE,
  Ipv6AddressData.JSON_PROPERTY_DELETE_DATE,
  Ipv6AddressData.JSON_PROPERTY_STATUS
})
@JsonTypeName("ipv6AddressData")
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-02-26T11:20:24.990023935Z[Etc/UTC]")
public class Ipv6AddressData {
  ...
  public Ipv6AddressData multipleUsage(Boolean multipleUsage) {
  ...
  **/
  ...
  public Ipv6AddressData netrangeElid(String netrangeElid) {
  ...
  **/
  ...
  public Ipv6AddressData ipAddress(String ipAddress) {
  ...
  **/
  ...
  public Ipv6AddressData hInfo(String hInfo) {
  ...
  **/
  ...
  public Ipv6AddressData remark(String remark) {
  ...
  **/
  ...
  public Ipv6AddressData elid(String elid) {
  ...
  **/
  ...
  public Ipv6AddressData fullIpAddress(String fullIpAddress) {
  ...
  **/
  ...
  public Ipv6AddressData multicast(Boolean multicast) {
  ...
  **/
  ...
  public Ipv6AddressData netClientElid(String netClientElid) {
  ...
  **/
  ...
  public Ipv6AddressData macAddress(String macAddress) {
  ...
  **/
  ...
  public Ipv6AddressData dhcpType(String dhcpType) {
  ...
  **/
  ...
  public Ipv6AddressData hostnameElid(String hostnameElid) {
  ...
  **/
  ...
  public Ipv6AddressData lookupAddress(Boolean lookupAddress) {
  ...
  **/
  ...
  public Ipv6AddressData networkElid(String networkElid) {
  ...
  **/
  ...
  public Ipv6AddressData startDate(DateTime startDate) {
  ...
  **/
  ...
  public Ipv6AddressData deleteDate(DateTime deleteDate) {
  ...
  **/
  ...
  public Ipv6AddressData status(String status) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    Ipv6AddressData ipv6AddressData = (Ipv6AddressData) o;
    return Objects.equals(this.multipleUsage, ipv6AddressData.multipleUsage) &&
        Objects.equals(this.netrangeElid, ipv6AddressData.netrangeElid) &&
        Objects.equals(this.ipAddress, ipv6AddressData.ipAddress) &&
        Objects.equals(this.hInfo, ipv6AddressData.hInfo) &&
        Objects.equals(this.remark, ipv6AddressData.remark) &&
        Objects.equals(this.elid, ipv6AddressData.elid) &&
        Objects.equals(this.fullIpAddress, ipv6AddressData.fullIpAddress) &&
        Objects.equals(this.multicast, ipv6AddressData.multicast) &&
        Objects.equals(this.netClientElid, ipv6AddressData.netClientElid) &&
        Objects.equals(this.macAddress, ipv6AddressData.macAddress) &&
        Objects.equals(this.dhcpType, ipv6AddressData.dhcpType) &&
        Objects.equals(this.hostnameElid, ipv6AddressData.hostnameElid) &&
        Objects.equals(this.lookupAddress, ipv6AddressData.lookupAddress) &&
        Objects.equals(this.networkElid, ipv6AddressData.networkElid) &&
        Objects.equals(this.startDate, ipv6AddressData.startDate) &&
        Objects.equals(this.deleteDate, ipv6AddressData.deleteDate) &&
        Objects.equals(this.status, ipv6AddressData.status);
  }
  ...
  public String toString() {
    ...
    sb.append("class Ipv6AddressData {\n");
