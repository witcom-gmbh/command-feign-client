...
import com.fntsoftware.businessgateway.entities.ServerBasePhysicalPortsDataEntityRestriction;
...
/**
 * ServerBasePhysicalPortsDataRequestData
 */
@JsonPropertyOrder({
  ServerBasePhysicalPortsDataRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  ServerBasePhysicalPortsDataRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  ServerBasePhysicalPortsDataRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  ServerBasePhysicalPortsDataRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-03-04T13:31:32.601557352Z[Etc/UTC]")
public class ServerBasePhysicalPortsDataRequestData {
  ...
  private ServerBasePhysicalPortsDataEntityRestriction entityRestrictions;
  ...
  public ServerBasePhysicalPortsDataRequestData() {
  }

  public ServerBasePhysicalPortsDataRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public ServerBasePhysicalPortsDataRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public ServerBasePhysicalPortsDataRequestData entityRestrictions(ServerBasePhysicalPortsDataEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public ServerBasePhysicalPortsDataEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(ServerBasePhysicalPortsDataEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public ServerBasePhysicalPortsDataRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public ServerBasePhysicalPortsDataRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public ServerBasePhysicalPortsDataRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ServerBasePhysicalPortsDataRequestData serverBasePhysicalPortsDataRequestData = (ServerBasePhysicalPortsDataRequestData) o;
    return Objects.equals(this.returnEntityAttributes, serverBasePhysicalPortsDataRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, serverBasePhysicalPortsDataRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, serverBasePhysicalPortsDataRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, serverBasePhysicalPortsDataRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class ServerBasePhysicalPortsDataRequestData {\n");
