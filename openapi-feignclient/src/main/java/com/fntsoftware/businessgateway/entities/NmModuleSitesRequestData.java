...
import com.fntsoftware.businessgateway.entities.NmModuleSitesEntityRestriction;
import com.fntsoftware.businessgateway.entities.NmModuleSitesRelationRestriction;
...
/**
 * NmModuleSitesRequestData
 */
@JsonPropertyOrder({
  NmModuleSitesRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  NmModuleSitesRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  NmModuleSitesRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  NmModuleSitesRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-01-31T11:10:37.320689708Z[Etc/UTC]")
public class NmModuleSitesRequestData {
  ...
  private NmModuleSitesEntityRestriction entityRestrictions;

  public static final String JSON_PROPERTY_RELATION_RESTRICTIONS = "relationRestrictions";
  private NmModuleSitesRelationRestriction relationRestrictions;
  ...
  public NmModuleSitesRequestData() {
  }

  public NmModuleSitesRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public NmModuleSitesRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public NmModuleSitesRequestData entityRestrictions(NmModuleSitesEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public NmModuleSitesEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(NmModuleSitesEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public NmModuleSitesRequestData relationRestrictions(NmModuleSitesRelationRestriction relationRestrictions) {
  ...
  **/
  ...
  public NmModuleSitesRelationRestriction getRelationRestrictions() {
    return relationRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_RELATION_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRelationRestrictions(NmModuleSitesRelationRestriction relationRestrictions) {
    this.relationRestrictions = relationRestrictions;
  }


  public NmModuleSitesRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public NmModuleSitesRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    NmModuleSitesRequestData nmModuleSitesRequestData = (NmModuleSitesRequestData) o;
    return Objects.equals(this.returnEntityAttributes, nmModuleSitesRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, nmModuleSitesRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, nmModuleSitesRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, nmModuleSitesRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class NmModuleSitesRequestData {\n");
