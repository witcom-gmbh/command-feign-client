...
import com.fntsoftware.businessgateway.entities.DeviceMasterDevicePassiveModulesEntityRestriction;
...
/**
 * DeviceMasterDevicePassiveModulesRequestData
 */
@JsonPropertyOrder({
  DeviceMasterDevicePassiveModulesRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  DeviceMasterDevicePassiveModulesRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  DeviceMasterDevicePassiveModulesRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  DeviceMasterDevicePassiveModulesRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-02-26T11:20:24.990023935Z[Etc/UTC]")
public class DeviceMasterDevicePassiveModulesRequestData {
  ...
  private DeviceMasterDevicePassiveModulesEntityRestriction entityRestrictions;
  ...
  public DeviceMasterDevicePassiveModulesRequestData() {
  }

  public DeviceMasterDevicePassiveModulesRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public DeviceMasterDevicePassiveModulesRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public DeviceMasterDevicePassiveModulesRequestData entityRestrictions(DeviceMasterDevicePassiveModulesEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public DeviceMasterDevicePassiveModulesEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(DeviceMasterDevicePassiveModulesEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public DeviceMasterDevicePassiveModulesRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public DeviceMasterDevicePassiveModulesRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public DeviceMasterDevicePassiveModulesRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    DeviceMasterDevicePassiveModulesRequestData deviceMasterDevicePassiveModulesRequestData = (DeviceMasterDevicePassiveModulesRequestData) o;
    return Objects.equals(this.returnEntityAttributes, deviceMasterDevicePassiveModulesRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, deviceMasterDevicePassiveModulesRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, deviceMasterDevicePassiveModulesRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, deviceMasterDevicePassiveModulesRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeviceMasterDevicePassiveModulesRequestData {\n");
