...
/**
 * PduSlotEntityRestriction
 */
@JsonPropertyOrder({
  PduSlotEntityRestriction.JSON_PROPERTY_CLIMATE_RELEVANT,
  PduSlotEntityRestriction.JSON_PROPERTY_POWER_CONSUMPTION,
  PduSlotEntityRestriction.JSON_PROPERTY_POWER_SWITCHING_STATUS,
  PduSlotEntityRestriction.JSON_PROPERTY_PLAN_STATUS,
  PduSlotEntityRestriction.JSON_PROPERTY_SYSTEM_RUNTIME,
  PduSlotEntityRestriction.JSON_PROPERTY_WEIGHT,
  PduSlotEntityRestriction.JSON_PROPERTY_REMARK,
  PduSlotEntityRestriction.JSON_PROPERTY_ELID,
  PduSlotEntityRestriction.JSON_PROPERTY_LAST_SEEN,
  PduSlotEntityRestriction.JSON_PROPERTY_TYPE_ELID,
  PduSlotEntityRestriction.JSON_PROPERTY_VISIBLE_ID,
  PduSlotEntityRestriction.JSON_PROPERTY_ID,
  PduSlotEntityRestriction.JSON_PROPERTY_HEAT_EMISSION
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-03-04T13:31:32.601557352Z[Etc/UTC]")
public class PduSlotEntityRestriction {
  ...
  public PduSlotEntityRestriction() {
  }

  public PduSlotEntityRestriction climateRelevant(RestrictionsBoolean climateRelevant) {
  ...
  **/
  ...
  public PduSlotEntityRestriction powerConsumption(RestrictionsNumeric powerConsumption) {
  ...
  **/
  ...
  public PduSlotEntityRestriction powerSwitchingStatus(RestrictionsString powerSwitchingStatus) {
  ...
  **/
  ...
  public PduSlotEntityRestriction planStatus(RestrictionsString planStatus) {
  ...
  **/
  ...
  public PduSlotEntityRestriction systemRuntime(RestrictionsNumeric systemRuntime) {
  ...
  **/
  ...
  public PduSlotEntityRestriction weight(RestrictionsNumeric weight) {
  ...
  **/
  ...
  public PduSlotEntityRestriction remark(RestrictionsString remark) {
  ...
  **/
  ...
  public PduSlotEntityRestriction elid(RestrictionsString elid) {
  ...
  **/
  ...
  public PduSlotEntityRestriction lastSeen(RestrictionsDate lastSeen) {
  ...
  **/
  ...
  public PduSlotEntityRestriction typeElid(RestrictionsString typeElid) {
  ...
  **/
  ...
  public PduSlotEntityRestriction visibleId(RestrictionsString visibleId) {
  ...
  **/
  ...
  public PduSlotEntityRestriction id(RestrictionsString id) {
  ...
  **/
  ...
  public PduSlotEntityRestriction heatEmission(RestrictionsNumeric heatEmission) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    PduSlotEntityRestriction pduSlotEntityRestriction = (PduSlotEntityRestriction) o;
    return Objects.equals(this.climateRelevant, pduSlotEntityRestriction.climateRelevant) &&
        Objects.equals(this.powerConsumption, pduSlotEntityRestriction.powerConsumption) &&
        Objects.equals(this.powerSwitchingStatus, pduSlotEntityRestriction.powerSwitchingStatus) &&
        Objects.equals(this.planStatus, pduSlotEntityRestriction.planStatus) &&
        Objects.equals(this.systemRuntime, pduSlotEntityRestriction.systemRuntime) &&
        Objects.equals(this.weight, pduSlotEntityRestriction.weight) &&
        Objects.equals(this.remark, pduSlotEntityRestriction.remark) &&
        Objects.equals(this.elid, pduSlotEntityRestriction.elid) &&
        Objects.equals(this.lastSeen, pduSlotEntityRestriction.lastSeen) &&
        Objects.equals(this.typeElid, pduSlotEntityRestriction.typeElid) &&
        Objects.equals(this.visibleId, pduSlotEntityRestriction.visibleId) &&
        Objects.equals(this.id, pduSlotEntityRestriction.id) &&
        Objects.equals(this.heatEmission, pduSlotEntityRestriction.heatEmission);
  }
  ...
  public String toString() {
    ...
    sb.append("class PduSlotEntityRestriction {\n");
