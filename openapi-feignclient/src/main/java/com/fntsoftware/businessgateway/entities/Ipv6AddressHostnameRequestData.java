...
import com.fntsoftware.businessgateway.entities.Ipv6AddressHostnameEntityRestriction;
...
/**
 * Ipv6AddressHostnameRequestData
 */
@JsonPropertyOrder({
  Ipv6AddressHostnameRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  Ipv6AddressHostnameRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  Ipv6AddressHostnameRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  Ipv6AddressHostnameRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-01-31T11:10:37.320689708Z[Etc/UTC]")
public class Ipv6AddressHostnameRequestData {
  ...
  private Ipv6AddressHostnameEntityRestriction entityRestrictions;
  ...
  public Ipv6AddressHostnameRequestData() {
  }

  public Ipv6AddressHostnameRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public Ipv6AddressHostnameRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public Ipv6AddressHostnameRequestData entityRestrictions(Ipv6AddressHostnameEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public Ipv6AddressHostnameEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(Ipv6AddressHostnameEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public Ipv6AddressHostnameRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public Ipv6AddressHostnameRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public Ipv6AddressHostnameRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    Ipv6AddressHostnameRequestData ipv6AddressHostnameRequestData = (Ipv6AddressHostnameRequestData) o;
    return Objects.equals(this.returnEntityAttributes, ipv6AddressHostnameRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, ipv6AddressHostnameRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, ipv6AddressHostnameRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, ipv6AddressHostnameRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class Ipv6AddressHostnameRequestData {\n");
