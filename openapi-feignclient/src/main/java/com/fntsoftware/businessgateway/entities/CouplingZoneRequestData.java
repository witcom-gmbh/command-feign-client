...
import com.fntsoftware.businessgateway.entities.CouplingZoneEntityRestriction;
...
/**
 * CouplingZoneRequestData
 */
@JsonPropertyOrder({
  CouplingZoneRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  CouplingZoneRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  CouplingZoneRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  CouplingZoneRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-03-04T13:31:32.601557352Z[Etc/UTC]")
public class CouplingZoneRequestData {
  ...
  private CouplingZoneEntityRestriction entityRestrictions;
  ...
  public CouplingZoneRequestData() {
  }

  public CouplingZoneRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public CouplingZoneRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public CouplingZoneRequestData entityRestrictions(CouplingZoneEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public CouplingZoneEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(CouplingZoneEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public CouplingZoneRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public CouplingZoneRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public CouplingZoneRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    CouplingZoneRequestData couplingZoneRequestData = (CouplingZoneRequestData) o;
    return Objects.equals(this.returnEntityAttributes, couplingZoneRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, couplingZoneRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, couplingZoneRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, couplingZoneRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class CouplingZoneRequestData {\n");
