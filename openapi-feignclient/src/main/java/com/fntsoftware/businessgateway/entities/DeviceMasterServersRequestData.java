...
import com.fntsoftware.businessgateway.entities.DeviceMasterServersEntityRestriction;
...
/**
 * DeviceMasterServersRequestData
 */
@JsonPropertyOrder({
  DeviceMasterServersRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  DeviceMasterServersRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  DeviceMasterServersRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  DeviceMasterServersRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-01-31T11:10:37.320689708Z[Etc/UTC]")
public class DeviceMasterServersRequestData {
  ...
  private DeviceMasterServersEntityRestriction entityRestrictions;
  ...
  public DeviceMasterServersRequestData() {
  }

  public DeviceMasterServersRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public DeviceMasterServersRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public DeviceMasterServersRequestData entityRestrictions(DeviceMasterServersEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public DeviceMasterServersEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(DeviceMasterServersEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public DeviceMasterServersRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public DeviceMasterServersRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public DeviceMasterServersRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    DeviceMasterServersRequestData deviceMasterServersRequestData = (DeviceMasterServersRequestData) o;
    return Objects.equals(this.returnEntityAttributes, deviceMasterServersRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, deviceMasterServersRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, deviceMasterServersRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, deviceMasterServersRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeviceMasterServersRequestData {\n");
