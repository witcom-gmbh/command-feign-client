...
/**
 * PhysicalPortDataDeviceAllEntityRestriction
 */
@JsonPropertyOrder({
  PhysicalPortDataDeviceAllEntityRestriction.JSON_PROPERTY_CLIMATE_RELEVANT,
  PhysicalPortDataDeviceAllEntityRestriction.JSON_PROPERTY_POWER_CONSUMPTION,
  PhysicalPortDataDeviceAllEntityRestriction.JSON_PROPERTY_POWER_SWITCHING_STATUS,
  PhysicalPortDataDeviceAllEntityRestriction.JSON_PROPERTY_PLAN_STATUS,
  PhysicalPortDataDeviceAllEntityRestriction.JSON_PROPERTY_SYSTEM_RUNTIME,
  PhysicalPortDataDeviceAllEntityRestriction.JSON_PROPERTY_WEIGHT,
  PhysicalPortDataDeviceAllEntityRestriction.JSON_PROPERTY_REMARK,
  PhysicalPortDataDeviceAllEntityRestriction.JSON_PROPERTY_ELID,
  PhysicalPortDataDeviceAllEntityRestriction.JSON_PROPERTY_LAST_SEEN,
  PhysicalPortDataDeviceAllEntityRestriction.JSON_PROPERTY_TYPE_ELID,
  PhysicalPortDataDeviceAllEntityRestriction.JSON_PROPERTY_VISIBLE_ID,
  PhysicalPortDataDeviceAllEntityRestriction.JSON_PROPERTY_ID,
  PhysicalPortDataDeviceAllEntityRestriction.JSON_PROPERTY_HEAT_EMISSION
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-01-31T11:10:37.320689708Z[Etc/UTC]")
public class PhysicalPortDataDeviceAllEntityRestriction {
  ...
  public PhysicalPortDataDeviceAllEntityRestriction() {
  }

  public PhysicalPortDataDeviceAllEntityRestriction climateRelevant(RestrictionsBoolean climateRelevant) {
  ...
  **/
  ...
  public PhysicalPortDataDeviceAllEntityRestriction powerConsumption(RestrictionsNumeric powerConsumption) {
  ...
  **/
  ...
  public PhysicalPortDataDeviceAllEntityRestriction powerSwitchingStatus(RestrictionsString powerSwitchingStatus) {
  ...
  **/
  ...
  public PhysicalPortDataDeviceAllEntityRestriction planStatus(RestrictionsString planStatus) {
  ...
  **/
  ...
  public PhysicalPortDataDeviceAllEntityRestriction systemRuntime(RestrictionsNumeric systemRuntime) {
  ...
  **/
  ...
  public PhysicalPortDataDeviceAllEntityRestriction weight(RestrictionsNumeric weight) {
  ...
  **/
  ...
  public PhysicalPortDataDeviceAllEntityRestriction remark(RestrictionsString remark) {
  ...
  **/
  ...
  public PhysicalPortDataDeviceAllEntityRestriction elid(RestrictionsString elid) {
  ...
  **/
  ...
  public PhysicalPortDataDeviceAllEntityRestriction lastSeen(RestrictionsDate lastSeen) {
  ...
  **/
  ...
  public PhysicalPortDataDeviceAllEntityRestriction typeElid(RestrictionsString typeElid) {
  ...
  **/
  ...
  public PhysicalPortDataDeviceAllEntityRestriction visibleId(RestrictionsString visibleId) {
  ...
  **/
  ...
  public PhysicalPortDataDeviceAllEntityRestriction id(RestrictionsString id) {
  ...
  **/
  ...
  public PhysicalPortDataDeviceAllEntityRestriction heatEmission(RestrictionsNumeric heatEmission) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    PhysicalPortDataDeviceAllEntityRestriction physicalPortDataDeviceAllEntityRestriction = (PhysicalPortDataDeviceAllEntityRestriction) o;
    return Objects.equals(this.climateRelevant, physicalPortDataDeviceAllEntityRestriction.climateRelevant) &&
        Objects.equals(this.powerConsumption, physicalPortDataDeviceAllEntityRestriction.powerConsumption) &&
        Objects.equals(this.powerSwitchingStatus, physicalPortDataDeviceAllEntityRestriction.powerSwitchingStatus) &&
        Objects.equals(this.planStatus, physicalPortDataDeviceAllEntityRestriction.planStatus) &&
        Objects.equals(this.systemRuntime, physicalPortDataDeviceAllEntityRestriction.systemRuntime) &&
        Objects.equals(this.weight, physicalPortDataDeviceAllEntityRestriction.weight) &&
        Objects.equals(this.remark, physicalPortDataDeviceAllEntityRestriction.remark) &&
        Objects.equals(this.elid, physicalPortDataDeviceAllEntityRestriction.elid) &&
        Objects.equals(this.lastSeen, physicalPortDataDeviceAllEntityRestriction.lastSeen) &&
        Objects.equals(this.typeElid, physicalPortDataDeviceAllEntityRestriction.typeElid) &&
        Objects.equals(this.visibleId, physicalPortDataDeviceAllEntityRestriction.visibleId) &&
        Objects.equals(this.id, physicalPortDataDeviceAllEntityRestriction.id) &&
        Objects.equals(this.heatEmission, physicalPortDataDeviceAllEntityRestriction.heatEmission);
  }
  ...
  public String toString() {
    ...
    sb.append("class PhysicalPortDataDeviceAllEntityRestriction {\n");
