...
/**
 * FileSystemStorageUnitsEntityRestriction
 */
@JsonPropertyOrder({
  FileSystemStorageUnitsEntityRestriction.JSON_PROPERTY_LIFECYCLE_STATUS_DATE,
  FileSystemStorageUnitsEntityRestriction.JSON_PROPERTY_USED_GB,
  FileSystemStorageUnitsEntityRestriction.JSON_PROPERTY_C_POOL_NAME,
  FileSystemStorageUnitsEntityRestriction.JSON_PROPERTY_LIFECYCLE_STATUS,
  FileSystemStorageUnitsEntityRestriction.JSON_PROPERTY_REDUNDANCY_CLASS,
  FileSystemStorageUnitsEntityRestriction.JSON_PROPERTY_C_STORAGE_CLASS,
  FileSystemStorageUnitsEntityRestriction.JSON_PROPERTY_CAPACITY_GB,
  FileSystemStorageUnitsEntityRestriction.JSON_PROPERTY_REMARK,
  FileSystemStorageUnitsEntityRestriction.JSON_PROPERTY_VISIBLE_ID,
  FileSystemStorageUnitsEntityRestriction.JSON_PROPERTY_ID,
  FileSystemStorageUnitsEntityRestriction.JSON_PROPERTY_REDUNDANCY,
  FileSystemStorageUnitsEntityRestriction.JSON_PROPERTY_ELID
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-01-31T11:10:37.320689708Z[Etc/UTC]")
public class FileSystemStorageUnitsEntityRestriction {
  ...
  public FileSystemStorageUnitsEntityRestriction() {
  }

  public FileSystemStorageUnitsEntityRestriction lifecycleStatusDate(RestrictionsDate lifecycleStatusDate) {
  ...
  **/
  ...
  public FileSystemStorageUnitsEntityRestriction usedGb(RestrictionsNumeric usedGb) {
  ...
  **/
  ...
  public FileSystemStorageUnitsEntityRestriction cPoolName(RestrictionsString cPoolName) {
  ...
  **/
  ...
  public FileSystemStorageUnitsEntityRestriction lifecycleStatus(RestrictionsString lifecycleStatus) {
  ...
  **/
  ...
  public FileSystemStorageUnitsEntityRestriction redundancyClass(RestrictionsString redundancyClass) {
  ...
  **/
  ...
  public FileSystemStorageUnitsEntityRestriction cStorageClass(RestrictionsString cStorageClass) {
  ...
  **/
  ...
  public FileSystemStorageUnitsEntityRestriction capacityGb(RestrictionsNumeric capacityGb) {
  ...
  **/
  ...
  public FileSystemStorageUnitsEntityRestriction remark(RestrictionsString remark) {
  ...
  **/
  ...
  public FileSystemStorageUnitsEntityRestriction visibleId(RestrictionsString visibleId) {
  ...
  **/
  ...
  public FileSystemStorageUnitsEntityRestriction id(RestrictionsString id) {
  ...
  **/
  ...
  public FileSystemStorageUnitsEntityRestriction redundancy(RestrictionsBoolean redundancy) {
  ...
  **/
  ...
  public FileSystemStorageUnitsEntityRestriction elid(RestrictionsString elid) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    FileSystemStorageUnitsEntityRestriction fileSystemStorageUnitsEntityRestriction = (FileSystemStorageUnitsEntityRestriction) o;
    return Objects.equals(this.lifecycleStatusDate, fileSystemStorageUnitsEntityRestriction.lifecycleStatusDate) &&
        Objects.equals(this.usedGb, fileSystemStorageUnitsEntityRestriction.usedGb) &&
        Objects.equals(this.cPoolName, fileSystemStorageUnitsEntityRestriction.cPoolName) &&
        Objects.equals(this.lifecycleStatus, fileSystemStorageUnitsEntityRestriction.lifecycleStatus) &&
        Objects.equals(this.redundancyClass, fileSystemStorageUnitsEntityRestriction.redundancyClass) &&
        Objects.equals(this.cStorageClass, fileSystemStorageUnitsEntityRestriction.cStorageClass) &&
        Objects.equals(this.capacityGb, fileSystemStorageUnitsEntityRestriction.capacityGb) &&
        Objects.equals(this.remark, fileSystemStorageUnitsEntityRestriction.remark) &&
        Objects.equals(this.visibleId, fileSystemStorageUnitsEntityRestriction.visibleId) &&
        Objects.equals(this.id, fileSystemStorageUnitsEntityRestriction.id) &&
        Objects.equals(this.redundancy, fileSystemStorageUnitsEntityRestriction.redundancy) &&
        Objects.equals(this.elid, fileSystemStorageUnitsEntityRestriction.elid);
  }
  ...
  public String toString() {
    ...
    sb.append("class FileSystemStorageUnitsEntityRestriction {\n");
