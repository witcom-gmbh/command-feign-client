...
import com.fntsoftware.businessgateway.entities.PowerCableCableMasterPowerCableEntityRestriction;
...
/**
 * PowerCableCableMasterPowerCableRequestData
 */
@JsonPropertyOrder({
  PowerCableCableMasterPowerCableRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  PowerCableCableMasterPowerCableRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  PowerCableCableMasterPowerCableRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  PowerCableCableMasterPowerCableRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-01-31T11:10:37.320689708Z[Etc/UTC]")
public class PowerCableCableMasterPowerCableRequestData {
  ...
  private PowerCableCableMasterPowerCableEntityRestriction entityRestrictions;
  ...
  public PowerCableCableMasterPowerCableRequestData() {
  }

  public PowerCableCableMasterPowerCableRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public PowerCableCableMasterPowerCableRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public PowerCableCableMasterPowerCableRequestData entityRestrictions(PowerCableCableMasterPowerCableEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public PowerCableCableMasterPowerCableEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(PowerCableCableMasterPowerCableEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public PowerCableCableMasterPowerCableRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public PowerCableCableMasterPowerCableRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public PowerCableCableMasterPowerCableRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    PowerCableCableMasterPowerCableRequestData powerCableCableMasterPowerCableRequestData = (PowerCableCableMasterPowerCableRequestData) o;
    return Objects.equals(this.returnEntityAttributes, powerCableCableMasterPowerCableRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, powerCableCableMasterPowerCableRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, powerCableCableMasterPowerCableRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, powerCableCableMasterPowerCableRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class PowerCableCableMasterPowerCableRequestData {\n");
