...
import com.fntsoftware.businessgateway.entities.CreateUserGroupResponseData;
 ...
 */
@JsonPropertyOrder({
  CreateUserGroupResponse.JSON_PROPERTY_RETURN_DATA,
...
public class CreateUserGroupResponse {
  ...
  private CreateUserGroupResponseData returnData;
  ...
  public CreateUserGroupResponse returnData(CreateUserGroupResponseData returnData) {
  ...
  **/
  ...
  public CreateUserGroupResponseData getReturnData() {
    return returnData;
  }
  ...
  @JsonProperty(JSON_PROPERTY_RETURN_DATA)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setReturnData(CreateUserGroupResponseData returnData) {
    this.returnData = returnData;
  }


  public CreateUserGroupResponse status(ServiceStatusData status) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.returnData, createUserGroupResponse.returnData) &&
