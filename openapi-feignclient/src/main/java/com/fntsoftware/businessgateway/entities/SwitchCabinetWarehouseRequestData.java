...
import com.fntsoftware.businessgateway.entities.SwitchCabinetWarehouseEntityRestriction;
...
/**
 * SwitchCabinetWarehouseRequestData
 */
@JsonPropertyOrder({
  SwitchCabinetWarehouseRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  SwitchCabinetWarehouseRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  SwitchCabinetWarehouseRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  SwitchCabinetWarehouseRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-03-04T13:31:32.601557352Z[Etc/UTC]")
public class SwitchCabinetWarehouseRequestData {
  ...
  private SwitchCabinetWarehouseEntityRestriction entityRestrictions;
  ...
  public SwitchCabinetWarehouseRequestData() {
  }

  public SwitchCabinetWarehouseRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public SwitchCabinetWarehouseRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public SwitchCabinetWarehouseRequestData entityRestrictions(SwitchCabinetWarehouseEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public SwitchCabinetWarehouseEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(SwitchCabinetWarehouseEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public SwitchCabinetWarehouseRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public SwitchCabinetWarehouseRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public SwitchCabinetWarehouseRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    SwitchCabinetWarehouseRequestData switchCabinetWarehouseRequestData = (SwitchCabinetWarehouseRequestData) o;
    return Objects.equals(this.returnEntityAttributes, switchCabinetWarehouseRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, switchCabinetWarehouseRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, switchCabinetWarehouseRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, switchCabinetWarehouseRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class SwitchCabinetWarehouseRequestData {\n");
