...
import com.fntsoftware.businessgateway.entities.ModuleSitesEntityRestriction;
import com.fntsoftware.businessgateway.entities.ModuleSitesRelationRestriction;
...
/**
 * ModuleSitesRequestData
 */
@JsonPropertyOrder({
  ModuleSitesRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  ModuleSitesRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  ModuleSitesRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  ModuleSitesRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-03-04T13:31:32.601557352Z[Etc/UTC]")
public class ModuleSitesRequestData {
  ...
  private ModuleSitesEntityRestriction entityRestrictions;

  public static final String JSON_PROPERTY_RELATION_RESTRICTIONS = "relationRestrictions";
  private ModuleSitesRelationRestriction relationRestrictions;
  ...
  public ModuleSitesRequestData() {
  }

  public ModuleSitesRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public ModuleSitesRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public ModuleSitesRequestData entityRestrictions(ModuleSitesEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public ModuleSitesEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(ModuleSitesEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public ModuleSitesRequestData relationRestrictions(ModuleSitesRelationRestriction relationRestrictions) {
  ...
  **/
  ...
  public ModuleSitesRelationRestriction getRelationRestrictions() {
    return relationRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_RELATION_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRelationRestrictions(ModuleSitesRelationRestriction relationRestrictions) {
    this.relationRestrictions = relationRestrictions;
  }


  public ModuleSitesRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public ModuleSitesRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ModuleSitesRequestData moduleSitesRequestData = (ModuleSitesRequestData) o;
    return Objects.equals(this.returnEntityAttributes, moduleSitesRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, moduleSitesRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, moduleSitesRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, moduleSitesRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class ModuleSitesRequestData {\n");
