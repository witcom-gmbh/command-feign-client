...
import com.fntsoftware.businessgateway.entities.ServerPersonsEntityRestriction;
import com.fntsoftware.businessgateway.entities.ServerPersonsRelationRestriction;
...
/**
 * ServerPersonsRequestData
 */
@JsonPropertyOrder({
  ServerPersonsRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  ServerPersonsRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  ServerPersonsRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  ServerPersonsRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-01-31T11:10:37.320689708Z[Etc/UTC]")
public class ServerPersonsRequestData {
  ...
  private ServerPersonsEntityRestriction entityRestrictions;

  public static final String JSON_PROPERTY_RELATION_RESTRICTIONS = "relationRestrictions";
  private ServerPersonsRelationRestriction relationRestrictions;
  ...
  public ServerPersonsRequestData() {
  }

  public ServerPersonsRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public ServerPersonsRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public ServerPersonsRequestData entityRestrictions(ServerPersonsEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public ServerPersonsEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(ServerPersonsEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public ServerPersonsRequestData relationRestrictions(ServerPersonsRelationRestriction relationRestrictions) {
  ...
  **/
  ...
  public ServerPersonsRelationRestriction getRelationRestrictions() {
    return relationRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_RELATION_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRelationRestrictions(ServerPersonsRelationRestriction relationRestrictions) {
    this.relationRestrictions = relationRestrictions;
  }


  public ServerPersonsRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public ServerPersonsRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ServerPersonsRequestData serverPersonsRequestData = (ServerPersonsRequestData) o;
    return Objects.equals(this.returnEntityAttributes, serverPersonsRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, serverPersonsRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, serverPersonsRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, serverPersonsRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class ServerPersonsRequestData {\n");
