...
/**
 * NmModuleSlotEntityRestriction
 */
@JsonPropertyOrder({
  NmModuleSlotEntityRestriction.JSON_PROPERTY_CLIMATE_RELEVANT,
  NmModuleSlotEntityRestriction.JSON_PROPERTY_POWER_CONSUMPTION,
  NmModuleSlotEntityRestriction.JSON_PROPERTY_POWER_SWITCHING_STATUS,
  NmModuleSlotEntityRestriction.JSON_PROPERTY_PLAN_STATUS,
  NmModuleSlotEntityRestriction.JSON_PROPERTY_SYSTEM_RUNTIME,
  NmModuleSlotEntityRestriction.JSON_PROPERTY_WEIGHT,
  NmModuleSlotEntityRestriction.JSON_PROPERTY_REMARK,
  NmModuleSlotEntityRestriction.JSON_PROPERTY_ELID,
  NmModuleSlotEntityRestriction.JSON_PROPERTY_LAST_SEEN,
  NmModuleSlotEntityRestriction.JSON_PROPERTY_TYPE_ELID,
  NmModuleSlotEntityRestriction.JSON_PROPERTY_VISIBLE_ID,
  NmModuleSlotEntityRestriction.JSON_PROPERTY_ID,
  NmModuleSlotEntityRestriction.JSON_PROPERTY_HEAT_EMISSION
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-01-31T11:10:37.320689708Z[Etc/UTC]")
public class NmModuleSlotEntityRestriction {
  ...
  public NmModuleSlotEntityRestriction() {
  }

  public NmModuleSlotEntityRestriction climateRelevant(RestrictionsBoolean climateRelevant) {
  ...
  **/
  ...
  public NmModuleSlotEntityRestriction powerConsumption(RestrictionsNumeric powerConsumption) {
  ...
  **/
  ...
  public NmModuleSlotEntityRestriction powerSwitchingStatus(RestrictionsString powerSwitchingStatus) {
  ...
  **/
  ...
  public NmModuleSlotEntityRestriction planStatus(RestrictionsString planStatus) {
  ...
  **/
  ...
  public NmModuleSlotEntityRestriction systemRuntime(RestrictionsNumeric systemRuntime) {
  ...
  **/
  ...
  public NmModuleSlotEntityRestriction weight(RestrictionsNumeric weight) {
  ...
  **/
  ...
  public NmModuleSlotEntityRestriction remark(RestrictionsString remark) {
  ...
  **/
  ...
  public NmModuleSlotEntityRestriction elid(RestrictionsString elid) {
  ...
  **/
  ...
  public NmModuleSlotEntityRestriction lastSeen(RestrictionsDate lastSeen) {
  ...
  **/
  ...
  public NmModuleSlotEntityRestriction typeElid(RestrictionsString typeElid) {
  ...
  **/
  ...
  public NmModuleSlotEntityRestriction visibleId(RestrictionsString visibleId) {
  ...
  **/
  ...
  public NmModuleSlotEntityRestriction id(RestrictionsString id) {
  ...
  **/
  ...
  public NmModuleSlotEntityRestriction heatEmission(RestrictionsNumeric heatEmission) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    NmModuleSlotEntityRestriction nmModuleSlotEntityRestriction = (NmModuleSlotEntityRestriction) o;
    return Objects.equals(this.climateRelevant, nmModuleSlotEntityRestriction.climateRelevant) &&
        Objects.equals(this.powerConsumption, nmModuleSlotEntityRestriction.powerConsumption) &&
        Objects.equals(this.powerSwitchingStatus, nmModuleSlotEntityRestriction.powerSwitchingStatus) &&
        Objects.equals(this.planStatus, nmModuleSlotEntityRestriction.planStatus) &&
        Objects.equals(this.systemRuntime, nmModuleSlotEntityRestriction.systemRuntime) &&
        Objects.equals(this.weight, nmModuleSlotEntityRestriction.weight) &&
        Objects.equals(this.remark, nmModuleSlotEntityRestriction.remark) &&
        Objects.equals(this.elid, nmModuleSlotEntityRestriction.elid) &&
        Objects.equals(this.lastSeen, nmModuleSlotEntityRestriction.lastSeen) &&
        Objects.equals(this.typeElid, nmModuleSlotEntityRestriction.typeElid) &&
        Objects.equals(this.visibleId, nmModuleSlotEntityRestriction.visibleId) &&
        Objects.equals(this.id, nmModuleSlotEntityRestriction.id) &&
        Objects.equals(this.heatEmission, nmModuleSlotEntityRestriction.heatEmission);
  }
  ...
  public String toString() {
    ...
    sb.append("class NmModuleSlotEntityRestriction {\n");
