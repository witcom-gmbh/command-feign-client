...
import com.fntsoftware.businessgateway.entities.VlanGroupVlansEntityRestriction;
import com.fntsoftware.businessgateway.entities.VlanGroupVlansRelationRestriction;
...
/**
 * VlanGroupVlansRequestData
 */
@JsonPropertyOrder({
  VlanGroupVlansRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  VlanGroupVlansRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  VlanGroupVlansRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  VlanGroupVlansRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-02-26T11:20:24.990023935Z[Etc/UTC]")
public class VlanGroupVlansRequestData {
  ...
  private VlanGroupVlansEntityRestriction entityRestrictions;

  public static final String JSON_PROPERTY_RELATION_RESTRICTIONS = "relationRestrictions";
  private VlanGroupVlansRelationRestriction relationRestrictions;
  ...
  public VlanGroupVlansRequestData() {
  }

  public VlanGroupVlansRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public VlanGroupVlansRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public VlanGroupVlansRequestData entityRestrictions(VlanGroupVlansEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public VlanGroupVlansEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(VlanGroupVlansEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public VlanGroupVlansRequestData relationRestrictions(VlanGroupVlansRelationRestriction relationRestrictions) {
  ...
  **/
  ...
  public VlanGroupVlansRelationRestriction getRelationRestrictions() {
    return relationRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_RELATION_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRelationRestrictions(VlanGroupVlansRelationRestriction relationRestrictions) {
    this.relationRestrictions = relationRestrictions;
  }


  public VlanGroupVlansRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public VlanGroupVlansRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    VlanGroupVlansRequestData vlanGroupVlansRequestData = (VlanGroupVlansRequestData) o;
    return Objects.equals(this.returnEntityAttributes, vlanGroupVlansRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, vlanGroupVlansRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, vlanGroupVlansRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, vlanGroupVlansRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class VlanGroupVlansRequestData {\n");
