...
/**
 * PassiveModuleSlotEntityRestriction
 */
@JsonPropertyOrder({
  PassiveModuleSlotEntityRestriction.JSON_PROPERTY_CLIMATE_RELEVANT,
  PassiveModuleSlotEntityRestriction.JSON_PROPERTY_POWER_CONSUMPTION,
  PassiveModuleSlotEntityRestriction.JSON_PROPERTY_POWER_SWITCHING_STATUS,
  PassiveModuleSlotEntityRestriction.JSON_PROPERTY_PLAN_STATUS,
  PassiveModuleSlotEntityRestriction.JSON_PROPERTY_SYSTEM_RUNTIME,
  PassiveModuleSlotEntityRestriction.JSON_PROPERTY_WEIGHT,
  PassiveModuleSlotEntityRestriction.JSON_PROPERTY_REMARK,
  PassiveModuleSlotEntityRestriction.JSON_PROPERTY_ELID,
  PassiveModuleSlotEntityRestriction.JSON_PROPERTY_LAST_SEEN,
  PassiveModuleSlotEntityRestriction.JSON_PROPERTY_TYPE_ELID,
  PassiveModuleSlotEntityRestriction.JSON_PROPERTY_VISIBLE_ID,
  PassiveModuleSlotEntityRestriction.JSON_PROPERTY_ID,
  PassiveModuleSlotEntityRestriction.JSON_PROPERTY_HEAT_EMISSION
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-03-04T13:31:32.601557352Z[Etc/UTC]")
public class PassiveModuleSlotEntityRestriction {
  ...
  public PassiveModuleSlotEntityRestriction() {
  }

  public PassiveModuleSlotEntityRestriction climateRelevant(RestrictionsBoolean climateRelevant) {
  ...
  **/
  ...
  public PassiveModuleSlotEntityRestriction powerConsumption(RestrictionsNumeric powerConsumption) {
  ...
  **/
  ...
  public PassiveModuleSlotEntityRestriction powerSwitchingStatus(RestrictionsString powerSwitchingStatus) {
  ...
  **/
  ...
  public PassiveModuleSlotEntityRestriction planStatus(RestrictionsString planStatus) {
  ...
  **/
  ...
  public PassiveModuleSlotEntityRestriction systemRuntime(RestrictionsNumeric systemRuntime) {
  ...
  **/
  ...
  public PassiveModuleSlotEntityRestriction weight(RestrictionsNumeric weight) {
  ...
  **/
  ...
  public PassiveModuleSlotEntityRestriction remark(RestrictionsString remark) {
  ...
  **/
  ...
  public PassiveModuleSlotEntityRestriction elid(RestrictionsString elid) {
  ...
  **/
  ...
  public PassiveModuleSlotEntityRestriction lastSeen(RestrictionsDate lastSeen) {
  ...
  **/
  ...
  public PassiveModuleSlotEntityRestriction typeElid(RestrictionsString typeElid) {
  ...
  **/
  ...
  public PassiveModuleSlotEntityRestriction visibleId(RestrictionsString visibleId) {
  ...
  **/
  ...
  public PassiveModuleSlotEntityRestriction id(RestrictionsString id) {
  ...
  **/
  ...
  public PassiveModuleSlotEntityRestriction heatEmission(RestrictionsNumeric heatEmission) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    PassiveModuleSlotEntityRestriction passiveModuleSlotEntityRestriction = (PassiveModuleSlotEntityRestriction) o;
    return Objects.equals(this.climateRelevant, passiveModuleSlotEntityRestriction.climateRelevant) &&
        Objects.equals(this.powerConsumption, passiveModuleSlotEntityRestriction.powerConsumption) &&
        Objects.equals(this.powerSwitchingStatus, passiveModuleSlotEntityRestriction.powerSwitchingStatus) &&
        Objects.equals(this.planStatus, passiveModuleSlotEntityRestriction.planStatus) &&
        Objects.equals(this.systemRuntime, passiveModuleSlotEntityRestriction.systemRuntime) &&
        Objects.equals(this.weight, passiveModuleSlotEntityRestriction.weight) &&
        Objects.equals(this.remark, passiveModuleSlotEntityRestriction.remark) &&
        Objects.equals(this.elid, passiveModuleSlotEntityRestriction.elid) &&
        Objects.equals(this.lastSeen, passiveModuleSlotEntityRestriction.lastSeen) &&
        Objects.equals(this.typeElid, passiveModuleSlotEntityRestriction.typeElid) &&
        Objects.equals(this.visibleId, passiveModuleSlotEntityRestriction.visibleId) &&
        Objects.equals(this.id, passiveModuleSlotEntityRestriction.id) &&
        Objects.equals(this.heatEmission, passiveModuleSlotEntityRestriction.heatEmission);
  }
  ...
  public String toString() {
    ...
    sb.append("class PassiveModuleSlotEntityRestriction {\n");
