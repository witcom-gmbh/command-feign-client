...
import com.fntsoftware.businessgateway.entities.PhysicalConnectionPowerToPortEntityRestriction;
...
/**
 * PhysicalConnectionPowerToPortRequestData
 */
@JsonPropertyOrder({
  PhysicalConnectionPowerToPortRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  PhysicalConnectionPowerToPortRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  PhysicalConnectionPowerToPortRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  PhysicalConnectionPowerToPortRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-03-04T13:31:32.601557352Z[Etc/UTC]")
public class PhysicalConnectionPowerToPortRequestData {
  ...
  private PhysicalConnectionPowerToPortEntityRestriction entityRestrictions;
  ...
  public PhysicalConnectionPowerToPortRequestData() {
  }

  public PhysicalConnectionPowerToPortRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public PhysicalConnectionPowerToPortRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public PhysicalConnectionPowerToPortRequestData entityRestrictions(PhysicalConnectionPowerToPortEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public PhysicalConnectionPowerToPortEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(PhysicalConnectionPowerToPortEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public PhysicalConnectionPowerToPortRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public PhysicalConnectionPowerToPortRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public PhysicalConnectionPowerToPortRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    PhysicalConnectionPowerToPortRequestData physicalConnectionPowerToPortRequestData = (PhysicalConnectionPowerToPortRequestData) o;
    return Objects.equals(this.returnEntityAttributes, physicalConnectionPowerToPortRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, physicalConnectionPowerToPortRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, physicalConnectionPowerToPortRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, physicalConnectionPowerToPortRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class PhysicalConnectionPowerToPortRequestData {\n");
