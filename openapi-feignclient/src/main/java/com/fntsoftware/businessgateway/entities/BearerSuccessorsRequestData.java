...
import com.fntsoftware.businessgateway.entities.BearerSuccessorsEntityRestriction;
...
/**
 * BearerSuccessorsRequestData
 */
@JsonPropertyOrder({
  BearerSuccessorsRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  BearerSuccessorsRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  BearerSuccessorsRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  BearerSuccessorsRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-03-04T13:31:32.601557352Z[Etc/UTC]")
public class BearerSuccessorsRequestData {
  ...
  private BearerSuccessorsEntityRestriction entityRestrictions;
  ...
  public BearerSuccessorsRequestData() {
  }

  public BearerSuccessorsRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public BearerSuccessorsRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public BearerSuccessorsRequestData entityRestrictions(BearerSuccessorsEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public BearerSuccessorsEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(BearerSuccessorsEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public BearerSuccessorsRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public BearerSuccessorsRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public BearerSuccessorsRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    BearerSuccessorsRequestData bearerSuccessorsRequestData = (BearerSuccessorsRequestData) o;
    return Objects.equals(this.returnEntityAttributes, bearerSuccessorsRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, bearerSuccessorsRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, bearerSuccessorsRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, bearerSuccessorsRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class BearerSuccessorsRequestData {\n");
