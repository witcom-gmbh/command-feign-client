...
import com.fntsoftware.businessgateway.entities.ChassisCustomL2CpeSegmentEntityRestriction;
...
/**
 * ChassisCustomL2CpeSegmentRequestData
 */
@JsonPropertyOrder({
  ChassisCustomL2CpeSegmentRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  ChassisCustomL2CpeSegmentRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  ChassisCustomL2CpeSegmentRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  ChassisCustomL2CpeSegmentRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-02-26T11:20:24.990023935Z[Etc/UTC]")
public class ChassisCustomL2CpeSegmentRequestData {
  ...
  private ChassisCustomL2CpeSegmentEntityRestriction entityRestrictions;
  ...
  public ChassisCustomL2CpeSegmentRequestData() {
  }

  public ChassisCustomL2CpeSegmentRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public ChassisCustomL2CpeSegmentRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public ChassisCustomL2CpeSegmentRequestData entityRestrictions(ChassisCustomL2CpeSegmentEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public ChassisCustomL2CpeSegmentEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(ChassisCustomL2CpeSegmentEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public ChassisCustomL2CpeSegmentRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public ChassisCustomL2CpeSegmentRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public ChassisCustomL2CpeSegmentRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ChassisCustomL2CpeSegmentRequestData chassisCustomL2CpeSegmentRequestData = (ChassisCustomL2CpeSegmentRequestData) o;
    return Objects.equals(this.returnEntityAttributes, chassisCustomL2CpeSegmentRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, chassisCustomL2CpeSegmentRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, chassisCustomL2CpeSegmentRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, chassisCustomL2CpeSegmentRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class ChassisCustomL2CpeSegmentRequestData {\n");
