...
import com.fntsoftware.businessgateway.entities.Ipv6AddressIpv6NetworkEntityRestriction;
...
/**
 * Ipv6AddressIpv6NetworkRequestData
 */
@JsonPropertyOrder({
  Ipv6AddressIpv6NetworkRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  Ipv6AddressIpv6NetworkRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  Ipv6AddressIpv6NetworkRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  Ipv6AddressIpv6NetworkRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-02-26T11:20:24.990023935Z[Etc/UTC]")
public class Ipv6AddressIpv6NetworkRequestData {
  ...
  private Ipv6AddressIpv6NetworkEntityRestriction entityRestrictions;
  ...
  public Ipv6AddressIpv6NetworkRequestData() {
  }

  public Ipv6AddressIpv6NetworkRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public Ipv6AddressIpv6NetworkRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public Ipv6AddressIpv6NetworkRequestData entityRestrictions(Ipv6AddressIpv6NetworkEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public Ipv6AddressIpv6NetworkEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(Ipv6AddressIpv6NetworkEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public Ipv6AddressIpv6NetworkRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public Ipv6AddressIpv6NetworkRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public Ipv6AddressIpv6NetworkRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    Ipv6AddressIpv6NetworkRequestData ipv6AddressIpv6NetworkRequestData = (Ipv6AddressIpv6NetworkRequestData) o;
    return Objects.equals(this.returnEntityAttributes, ipv6AddressIpv6NetworkRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, ipv6AddressIpv6NetworkRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, ipv6AddressIpv6NetworkRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, ipv6AddressIpv6NetworkRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class Ipv6AddressIpv6NetworkRequestData {\n");
