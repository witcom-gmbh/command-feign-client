...
import com.fntsoftware.businessgateway.entities.CVlanVlanGroupsEntityRestriction;
import com.fntsoftware.businessgateway.entities.CVlanVlanGroupsRelationRestriction;
...
/**
 * CVlanVlanGroupsRequestData
 */
@JsonPropertyOrder({
  CVlanVlanGroupsRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  CVlanVlanGroupsRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  CVlanVlanGroupsRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  CVlanVlanGroupsRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-02-26T11:20:24.990023935Z[Etc/UTC]")
public class CVlanVlanGroupsRequestData {
  ...
  private CVlanVlanGroupsEntityRestriction entityRestrictions;

  public static final String JSON_PROPERTY_RELATION_RESTRICTIONS = "relationRestrictions";
  private CVlanVlanGroupsRelationRestriction relationRestrictions;
  ...
  public CVlanVlanGroupsRequestData() {
  }

  public CVlanVlanGroupsRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public CVlanVlanGroupsRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public CVlanVlanGroupsRequestData entityRestrictions(CVlanVlanGroupsEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public CVlanVlanGroupsEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(CVlanVlanGroupsEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public CVlanVlanGroupsRequestData relationRestrictions(CVlanVlanGroupsRelationRestriction relationRestrictions) {
  ...
  **/
  ...
  public CVlanVlanGroupsRelationRestriction getRelationRestrictions() {
    return relationRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_RELATION_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRelationRestrictions(CVlanVlanGroupsRelationRestriction relationRestrictions) {
    this.relationRestrictions = relationRestrictions;
  }


  public CVlanVlanGroupsRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public CVlanVlanGroupsRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    CVlanVlanGroupsRequestData cvlanVlanGroupsRequestData = (CVlanVlanGroupsRequestData) o;
    return Objects.equals(this.returnEntityAttributes, cvlanVlanGroupsRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, cvlanVlanGroupsRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, cvlanVlanGroupsRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, cvlanVlanGroupsRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class CVlanVlanGroupsRequestData {\n");
