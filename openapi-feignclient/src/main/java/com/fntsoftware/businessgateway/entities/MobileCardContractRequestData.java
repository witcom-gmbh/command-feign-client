...
import com.fntsoftware.businessgateway.entities.MobileCardContractEntityRestriction;
...
/**
 * MobileCardContractRequestData
 */
@JsonPropertyOrder({
  MobileCardContractRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  MobileCardContractRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  MobileCardContractRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  MobileCardContractRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-02-26T11:20:24.990023935Z[Etc/UTC]")
public class MobileCardContractRequestData {
  ...
  private MobileCardContractEntityRestriction entityRestrictions;
  ...
  public MobileCardContractRequestData() {
  }

  public MobileCardContractRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public MobileCardContractRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public MobileCardContractRequestData entityRestrictions(MobileCardContractEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public MobileCardContractEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(MobileCardContractEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public MobileCardContractRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public MobileCardContractRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public MobileCardContractRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    MobileCardContractRequestData mobileCardContractRequestData = (MobileCardContractRequestData) o;
    return Objects.equals(this.returnEntityAttributes, mobileCardContractRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, mobileCardContractRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, mobileCardContractRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, mobileCardContractRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class MobileCardContractRequestData {\n");
