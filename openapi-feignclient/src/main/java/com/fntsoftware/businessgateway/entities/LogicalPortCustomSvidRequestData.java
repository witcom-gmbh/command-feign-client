...
import com.fntsoftware.businessgateway.entities.LogicalPortCustomSvidEntityRestriction;
...
/**
 * LogicalPortCustomSvidRequestData
 */
@JsonPropertyOrder({
  LogicalPortCustomSvidRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  LogicalPortCustomSvidRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  LogicalPortCustomSvidRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  LogicalPortCustomSvidRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-01-31T11:10:37.320689708Z[Etc/UTC]")
public class LogicalPortCustomSvidRequestData {
  ...
  private LogicalPortCustomSvidEntityRestriction entityRestrictions;
  ...
  public LogicalPortCustomSvidRequestData() {
  }

  public LogicalPortCustomSvidRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public LogicalPortCustomSvidRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public LogicalPortCustomSvidRequestData entityRestrictions(LogicalPortCustomSvidEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public LogicalPortCustomSvidEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(LogicalPortCustomSvidEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public LogicalPortCustomSvidRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public LogicalPortCustomSvidRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public LogicalPortCustomSvidRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    LogicalPortCustomSvidRequestData logicalPortCustomSvidRequestData = (LogicalPortCustomSvidRequestData) o;
    return Objects.equals(this.returnEntityAttributes, logicalPortCustomSvidRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, logicalPortCustomSvidRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, logicalPortCustomSvidRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, logicalPortCustomSvidRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class LogicalPortCustomSvidRequestData {\n");
