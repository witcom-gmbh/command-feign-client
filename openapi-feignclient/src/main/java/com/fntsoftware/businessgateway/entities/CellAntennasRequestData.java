...
import com.fntsoftware.businessgateway.entities.CellAntennasEntityRestriction;
import com.fntsoftware.businessgateway.entities.CellAntennasRelationRestriction;
...
/**
 * CellAntennasRequestData
 */
@JsonPropertyOrder({
  CellAntennasRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  CellAntennasRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  CellAntennasRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  CellAntennasRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-03-04T13:31:32.601557352Z[Etc/UTC]")
public class CellAntennasRequestData {
  ...
  private CellAntennasEntityRestriction entityRestrictions;

  public static final String JSON_PROPERTY_RELATION_RESTRICTIONS = "relationRestrictions";
  private CellAntennasRelationRestriction relationRestrictions;
  ...
  public CellAntennasRequestData() {
  }

  public CellAntennasRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public CellAntennasRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public CellAntennasRequestData entityRestrictions(CellAntennasEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public CellAntennasEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(CellAntennasEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public CellAntennasRequestData relationRestrictions(CellAntennasRelationRestriction relationRestrictions) {
  ...
  **/
  ...
  public CellAntennasRelationRestriction getRelationRestrictions() {
    return relationRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_RELATION_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRelationRestrictions(CellAntennasRelationRestriction relationRestrictions) {
    this.relationRestrictions = relationRestrictions;
  }


  public CellAntennasRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public CellAntennasRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    CellAntennasRequestData cellAntennasRequestData = (CellAntennasRequestData) o;
    return Objects.equals(this.returnEntityAttributes, cellAntennasRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, cellAntennasRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, cellAntennasRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, cellAntennasRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class CellAntennasRequestData {\n");
