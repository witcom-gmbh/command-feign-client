...
import com.fntsoftware.businessgateway.entities.ModulePhysicalPortsDataEntityRestriction;
...
/**
 * ModulePhysicalPortsDataRequestData
 */
@JsonPropertyOrder({
  ModulePhysicalPortsDataRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  ModulePhysicalPortsDataRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  ModulePhysicalPortsDataRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  ModulePhysicalPortsDataRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-01-31T11:10:37.320689708Z[Etc/UTC]")
public class ModulePhysicalPortsDataRequestData {
  ...
  private ModulePhysicalPortsDataEntityRestriction entityRestrictions;
  ...
  public ModulePhysicalPortsDataRequestData() {
  }

  public ModulePhysicalPortsDataRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public ModulePhysicalPortsDataRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public ModulePhysicalPortsDataRequestData entityRestrictions(ModulePhysicalPortsDataEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public ModulePhysicalPortsDataEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(ModulePhysicalPortsDataEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public ModulePhysicalPortsDataRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public ModulePhysicalPortsDataRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public ModulePhysicalPortsDataRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ModulePhysicalPortsDataRequestData modulePhysicalPortsDataRequestData = (ModulePhysicalPortsDataRequestData) o;
    return Objects.equals(this.returnEntityAttributes, modulePhysicalPortsDataRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, modulePhysicalPortsDataRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, modulePhysicalPortsDataRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, modulePhysicalPortsDataRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class ModulePhysicalPortsDataRequestData {\n");
