...
import com.fntsoftware.businessgateway.entities.FloorContractsEntityRestriction;
import com.fntsoftware.businessgateway.entities.FloorContractsRelationRestriction;
...
/**
 * FloorContractsRequestData
 */
@JsonPropertyOrder({
  FloorContractsRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  FloorContractsRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  FloorContractsRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  FloorContractsRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-02-26T11:20:24.990023935Z[Etc/UTC]")
public class FloorContractsRequestData {
  ...
  private FloorContractsEntityRestriction entityRestrictions;

  public static final String JSON_PROPERTY_RELATION_RESTRICTIONS = "relationRestrictions";
  private FloorContractsRelationRestriction relationRestrictions;
  ...
  public FloorContractsRequestData() {
  }

  public FloorContractsRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public FloorContractsRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public FloorContractsRequestData entityRestrictions(FloorContractsEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public FloorContractsEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(FloorContractsEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public FloorContractsRequestData relationRestrictions(FloorContractsRelationRestriction relationRestrictions) {
  ...
  **/
  ...
  public FloorContractsRelationRestriction getRelationRestrictions() {
    return relationRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_RELATION_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRelationRestrictions(FloorContractsRelationRestriction relationRestrictions) {
    this.relationRestrictions = relationRestrictions;
  }


  public FloorContractsRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public FloorContractsRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    FloorContractsRequestData floorContractsRequestData = (FloorContractsRequestData) o;
    return Objects.equals(this.returnEntityAttributes, floorContractsRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, floorContractsRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, floorContractsRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, floorContractsRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class FloorContractsRequestData {\n");
