...
import com.fntsoftware.businessgateway.entities.DeviceMasterSwitchCabinetsEntityRestriction;
...
/**
 * DeviceMasterSwitchCabinetsRequestData
 */
@JsonPropertyOrder({
  DeviceMasterSwitchCabinetsRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  DeviceMasterSwitchCabinetsRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  DeviceMasterSwitchCabinetsRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  DeviceMasterSwitchCabinetsRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-02-26T11:20:24.990023935Z[Etc/UTC]")
public class DeviceMasterSwitchCabinetsRequestData {
  ...
  private DeviceMasterSwitchCabinetsEntityRestriction entityRestrictions;
  ...
  public DeviceMasterSwitchCabinetsRequestData() {
  }

  public DeviceMasterSwitchCabinetsRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public DeviceMasterSwitchCabinetsRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public DeviceMasterSwitchCabinetsRequestData entityRestrictions(DeviceMasterSwitchCabinetsEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public DeviceMasterSwitchCabinetsEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(DeviceMasterSwitchCabinetsEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public DeviceMasterSwitchCabinetsRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public DeviceMasterSwitchCabinetsRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public DeviceMasterSwitchCabinetsRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    DeviceMasterSwitchCabinetsRequestData deviceMasterSwitchCabinetsRequestData = (DeviceMasterSwitchCabinetsRequestData) o;
    return Objects.equals(this.returnEntityAttributes, deviceMasterSwitchCabinetsRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, deviceMasterSwitchCabinetsRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, deviceMasterSwitchCabinetsRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, deviceMasterSwitchCabinetsRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeviceMasterSwitchCabinetsRequestData {\n");
