...
import com.fntsoftware.businessgateway.entities.HostnameIpv4AddressesEntityRestriction;
...
/**
 * HostnameIpv4AddressesRequestData
 */
@JsonPropertyOrder({
  HostnameIpv4AddressesRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  HostnameIpv4AddressesRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  HostnameIpv4AddressesRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  HostnameIpv4AddressesRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-02-26T11:20:24.990023935Z[Etc/UTC]")
public class HostnameIpv4AddressesRequestData {
  ...
  private HostnameIpv4AddressesEntityRestriction entityRestrictions;
  ...
  public HostnameIpv4AddressesRequestData() {
  }

  public HostnameIpv4AddressesRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public HostnameIpv4AddressesRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public HostnameIpv4AddressesRequestData entityRestrictions(HostnameIpv4AddressesEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public HostnameIpv4AddressesEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(HostnameIpv4AddressesEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public HostnameIpv4AddressesRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public HostnameIpv4AddressesRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public HostnameIpv4AddressesRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    HostnameIpv4AddressesRequestData hostnameIpv4AddressesRequestData = (HostnameIpv4AddressesRequestData) o;
    return Objects.equals(this.returnEntityAttributes, hostnameIpv4AddressesRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, hostnameIpv4AddressesRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, hostnameIpv4AddressesRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, hostnameIpv4AddressesRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class HostnameIpv4AddressesRequestData {\n");
