...
import com.fntsoftware.businessgateway.entities.Ipv4NetworkParentNetworkEntityRestriction;
...
/**
 * Ipv4NetworkParentNetworkRequestData
 */
@JsonPropertyOrder({
  Ipv4NetworkParentNetworkRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  Ipv4NetworkParentNetworkRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  Ipv4NetworkParentNetworkRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  Ipv4NetworkParentNetworkRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-03-04T13:31:32.601557352Z[Etc/UTC]")
public class Ipv4NetworkParentNetworkRequestData {
  ...
  private Ipv4NetworkParentNetworkEntityRestriction entityRestrictions;
  ...
  public Ipv4NetworkParentNetworkRequestData() {
  }

  public Ipv4NetworkParentNetworkRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public Ipv4NetworkParentNetworkRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public Ipv4NetworkParentNetworkRequestData entityRestrictions(Ipv4NetworkParentNetworkEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public Ipv4NetworkParentNetworkEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(Ipv4NetworkParentNetworkEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public Ipv4NetworkParentNetworkRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public Ipv4NetworkParentNetworkRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public Ipv4NetworkParentNetworkRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    Ipv4NetworkParentNetworkRequestData ipv4NetworkParentNetworkRequestData = (Ipv4NetworkParentNetworkRequestData) o;
    return Objects.equals(this.returnEntityAttributes, ipv4NetworkParentNetworkRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, ipv4NetworkParentNetworkRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, ipv4NetworkParentNetworkRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, ipv4NetworkParentNetworkRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class Ipv4NetworkParentNetworkRequestData {\n");
