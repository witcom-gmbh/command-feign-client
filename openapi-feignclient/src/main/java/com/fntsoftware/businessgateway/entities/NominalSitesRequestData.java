...
import com.fntsoftware.businessgateway.entities.NominalSitesEntityRestriction;
import com.fntsoftware.businessgateway.entities.NominalSitesRelationRestriction;
...
/**
 * NominalSitesRequestData
 */
@JsonPropertyOrder({
  NominalSitesRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  NominalSitesRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  NominalSitesRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  NominalSitesRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-03-04T13:31:32.601557352Z[Etc/UTC]")
public class NominalSitesRequestData {
  ...
  private NominalSitesEntityRestriction entityRestrictions;

  public static final String JSON_PROPERTY_RELATION_RESTRICTIONS = "relationRestrictions";
  private NominalSitesRelationRestriction relationRestrictions;
  ...
  public NominalSitesRequestData() {
  }

  public NominalSitesRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public NominalSitesRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public NominalSitesRequestData entityRestrictions(NominalSitesEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public NominalSitesEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(NominalSitesEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public NominalSitesRequestData relationRestrictions(NominalSitesRelationRestriction relationRestrictions) {
  ...
  **/
  ...
  public NominalSitesRelationRestriction getRelationRestrictions() {
    return relationRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_RELATION_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRelationRestrictions(NominalSitesRelationRestriction relationRestrictions) {
    this.relationRestrictions = relationRestrictions;
  }


  public NominalSitesRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public NominalSitesRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    NominalSitesRequestData nominalSitesRequestData = (NominalSitesRequestData) o;
    return Objects.equals(this.returnEntityAttributes, nominalSitesRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, nominalSitesRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, nominalSitesRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, nominalSitesRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class NominalSitesRequestData {\n");
