...
import com.fntsoftware.businessgateway.entities.BearerPersonsEntityRestriction;
import com.fntsoftware.businessgateway.entities.BearerPersonsRelationRestriction;
...
/**
 * BearerPersonsRequestData
 */
@JsonPropertyOrder({
  BearerPersonsRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  BearerPersonsRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  BearerPersonsRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  BearerPersonsRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-02-26T11:20:24.990023935Z[Etc/UTC]")
public class BearerPersonsRequestData {
  ...
  private BearerPersonsEntityRestriction entityRestrictions;

  public static final String JSON_PROPERTY_RELATION_RESTRICTIONS = "relationRestrictions";
  private BearerPersonsRelationRestriction relationRestrictions;
  ...
  public BearerPersonsRequestData() {
  }

  public BearerPersonsRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public BearerPersonsRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public BearerPersonsRequestData entityRestrictions(BearerPersonsEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public BearerPersonsEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(BearerPersonsEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public BearerPersonsRequestData relationRestrictions(BearerPersonsRelationRestriction relationRestrictions) {
  ...
  **/
  ...
  public BearerPersonsRelationRestriction getRelationRestrictions() {
    return relationRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_RELATION_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRelationRestrictions(BearerPersonsRelationRestriction relationRestrictions) {
    this.relationRestrictions = relationRestrictions;
  }


  public BearerPersonsRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public BearerPersonsRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    BearerPersonsRequestData bearerPersonsRequestData = (BearerPersonsRequestData) o;
    return Objects.equals(this.returnEntityAttributes, bearerPersonsRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, bearerPersonsRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, bearerPersonsRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, bearerPersonsRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class BearerPersonsRequestData {\n");
