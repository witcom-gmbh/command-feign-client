...
/**
 * NetworkElementMasterDeviceEntityRestriction
 */
@JsonPropertyOrder({
  NetworkElementMasterDeviceEntityRestriction.JSON_PROPERTY_CLIMATE_RELEVANT,
  NetworkElementMasterDeviceEntityRestriction.JSON_PROPERTY_POWER_CONSUMPTION,
  NetworkElementMasterDeviceEntityRestriction.JSON_PROPERTY_POWER_SWITCHING_STATUS,
  NetworkElementMasterDeviceEntityRestriction.JSON_PROPERTY_PLAN_STATUS,
  NetworkElementMasterDeviceEntityRestriction.JSON_PROPERTY_SYSTEM_RUNTIME,
  NetworkElementMasterDeviceEntityRestriction.JSON_PROPERTY_WEIGHT,
  NetworkElementMasterDeviceEntityRestriction.JSON_PROPERTY_REMARK,
  NetworkElementMasterDeviceEntityRestriction.JSON_PROPERTY_ELID,
  NetworkElementMasterDeviceEntityRestriction.JSON_PROPERTY_LAST_SEEN,
  NetworkElementMasterDeviceEntityRestriction.JSON_PROPERTY_TYPE_ELID,
  NetworkElementMasterDeviceEntityRestriction.JSON_PROPERTY_VISIBLE_ID,
  NetworkElementMasterDeviceEntityRestriction.JSON_PROPERTY_ID,
  NetworkElementMasterDeviceEntityRestriction.JSON_PROPERTY_HEAT_EMISSION
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-03-04T13:31:32.601557352Z[Etc/UTC]")
public class NetworkElementMasterDeviceEntityRestriction {
  ...
  public NetworkElementMasterDeviceEntityRestriction() {
  }

  public NetworkElementMasterDeviceEntityRestriction climateRelevant(RestrictionsBoolean climateRelevant) {
  ...
  **/
  ...
  public NetworkElementMasterDeviceEntityRestriction powerConsumption(RestrictionsNumeric powerConsumption) {
  ...
  **/
  ...
  public NetworkElementMasterDeviceEntityRestriction powerSwitchingStatus(RestrictionsString powerSwitchingStatus) {
  ...
  **/
  ...
  public NetworkElementMasterDeviceEntityRestriction planStatus(RestrictionsString planStatus) {
  ...
  **/
  ...
  public NetworkElementMasterDeviceEntityRestriction systemRuntime(RestrictionsNumeric systemRuntime) {
  ...
  **/
  ...
  public NetworkElementMasterDeviceEntityRestriction weight(RestrictionsNumeric weight) {
  ...
  **/
  ...
  public NetworkElementMasterDeviceEntityRestriction remark(RestrictionsString remark) {
  ...
  **/
  ...
  public NetworkElementMasterDeviceEntityRestriction elid(RestrictionsString elid) {
  ...
  **/
  ...
  public NetworkElementMasterDeviceEntityRestriction lastSeen(RestrictionsDate lastSeen) {
  ...
  **/
  ...
  public NetworkElementMasterDeviceEntityRestriction typeElid(RestrictionsString typeElid) {
  ...
  **/
  ...
  public NetworkElementMasterDeviceEntityRestriction visibleId(RestrictionsString visibleId) {
  ...
  **/
  ...
  public NetworkElementMasterDeviceEntityRestriction id(RestrictionsString id) {
  ...
  **/
  ...
  public NetworkElementMasterDeviceEntityRestriction heatEmission(RestrictionsNumeric heatEmission) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    NetworkElementMasterDeviceEntityRestriction networkElementMasterDeviceEntityRestriction = (NetworkElementMasterDeviceEntityRestriction) o;
    return Objects.equals(this.climateRelevant, networkElementMasterDeviceEntityRestriction.climateRelevant) &&
        Objects.equals(this.powerConsumption, networkElementMasterDeviceEntityRestriction.powerConsumption) &&
        Objects.equals(this.powerSwitchingStatus, networkElementMasterDeviceEntityRestriction.powerSwitchingStatus) &&
        Objects.equals(this.planStatus, networkElementMasterDeviceEntityRestriction.planStatus) &&
        Objects.equals(this.systemRuntime, networkElementMasterDeviceEntityRestriction.systemRuntime) &&
        Objects.equals(this.weight, networkElementMasterDeviceEntityRestriction.weight) &&
        Objects.equals(this.remark, networkElementMasterDeviceEntityRestriction.remark) &&
        Objects.equals(this.elid, networkElementMasterDeviceEntityRestriction.elid) &&
        Objects.equals(this.lastSeen, networkElementMasterDeviceEntityRestriction.lastSeen) &&
        Objects.equals(this.typeElid, networkElementMasterDeviceEntityRestriction.typeElid) &&
        Objects.equals(this.visibleId, networkElementMasterDeviceEntityRestriction.visibleId) &&
        Objects.equals(this.id, networkElementMasterDeviceEntityRestriction.id) &&
        Objects.equals(this.heatEmission, networkElementMasterDeviceEntityRestriction.heatEmission);
  }
  ...
  public String toString() {
    ...
    sb.append("class NetworkElementMasterDeviceEntityRestriction {\n");
