...
/**
 * ModuleSlotEntityRestriction
 */
@JsonPropertyOrder({
  ModuleSlotEntityRestriction.JSON_PROPERTY_CLIMATE_RELEVANT,
  ModuleSlotEntityRestriction.JSON_PROPERTY_POWER_CONSUMPTION,
  ModuleSlotEntityRestriction.JSON_PROPERTY_POWER_SWITCHING_STATUS,
  ModuleSlotEntityRestriction.JSON_PROPERTY_PLAN_STATUS,
  ModuleSlotEntityRestriction.JSON_PROPERTY_SYSTEM_RUNTIME,
  ModuleSlotEntityRestriction.JSON_PROPERTY_WEIGHT,
  ModuleSlotEntityRestriction.JSON_PROPERTY_REMARK,
  ModuleSlotEntityRestriction.JSON_PROPERTY_ELID,
  ModuleSlotEntityRestriction.JSON_PROPERTY_LAST_SEEN,
  ModuleSlotEntityRestriction.JSON_PROPERTY_TYPE_ELID,
  ModuleSlotEntityRestriction.JSON_PROPERTY_VISIBLE_ID,
  ModuleSlotEntityRestriction.JSON_PROPERTY_ID,
  ModuleSlotEntityRestriction.JSON_PROPERTY_HEAT_EMISSION
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-03-04T13:31:32.601557352Z[Etc/UTC]")
public class ModuleSlotEntityRestriction {
  ...
  public ModuleSlotEntityRestriction() {
  }

  public ModuleSlotEntityRestriction climateRelevant(RestrictionsBoolean climateRelevant) {
  ...
  **/
  ...
  public ModuleSlotEntityRestriction powerConsumption(RestrictionsNumeric powerConsumption) {
  ...
  **/
  ...
  public ModuleSlotEntityRestriction powerSwitchingStatus(RestrictionsString powerSwitchingStatus) {
  ...
  **/
  ...
  public ModuleSlotEntityRestriction planStatus(RestrictionsString planStatus) {
  ...
  **/
  ...
  public ModuleSlotEntityRestriction systemRuntime(RestrictionsNumeric systemRuntime) {
  ...
  **/
  ...
  public ModuleSlotEntityRestriction weight(RestrictionsNumeric weight) {
  ...
  **/
  ...
  public ModuleSlotEntityRestriction remark(RestrictionsString remark) {
  ...
  **/
  ...
  public ModuleSlotEntityRestriction elid(RestrictionsString elid) {
  ...
  **/
  ...
  public ModuleSlotEntityRestriction lastSeen(RestrictionsDate lastSeen) {
  ...
  **/
  ...
  public ModuleSlotEntityRestriction typeElid(RestrictionsString typeElid) {
  ...
  **/
  ...
  public ModuleSlotEntityRestriction visibleId(RestrictionsString visibleId) {
  ...
  **/
  ...
  public ModuleSlotEntityRestriction id(RestrictionsString id) {
  ...
  **/
  ...
  public ModuleSlotEntityRestriction heatEmission(RestrictionsNumeric heatEmission) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ModuleSlotEntityRestriction moduleSlotEntityRestriction = (ModuleSlotEntityRestriction) o;
    return Objects.equals(this.climateRelevant, moduleSlotEntityRestriction.climateRelevant) &&
        Objects.equals(this.powerConsumption, moduleSlotEntityRestriction.powerConsumption) &&
        Objects.equals(this.powerSwitchingStatus, moduleSlotEntityRestriction.powerSwitchingStatus) &&
        Objects.equals(this.planStatus, moduleSlotEntityRestriction.planStatus) &&
        Objects.equals(this.systemRuntime, moduleSlotEntityRestriction.systemRuntime) &&
        Objects.equals(this.weight, moduleSlotEntityRestriction.weight) &&
        Objects.equals(this.remark, moduleSlotEntityRestriction.remark) &&
        Objects.equals(this.elid, moduleSlotEntityRestriction.elid) &&
        Objects.equals(this.lastSeen, moduleSlotEntityRestriction.lastSeen) &&
        Objects.equals(this.typeElid, moduleSlotEntityRestriction.typeElid) &&
        Objects.equals(this.visibleId, moduleSlotEntityRestriction.visibleId) &&
        Objects.equals(this.id, moduleSlotEntityRestriction.id) &&
        Objects.equals(this.heatEmission, moduleSlotEntityRestriction.heatEmission);
  }
  ...
  public String toString() {
    ...
    sb.append("class ModuleSlotEntityRestriction {\n");
