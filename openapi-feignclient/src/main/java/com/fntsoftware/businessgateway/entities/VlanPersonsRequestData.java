...
import com.fntsoftware.businessgateway.entities.VlanPersonsEntityRestriction;
import com.fntsoftware.businessgateway.entities.VlanPersonsRelationRestriction;
...
/**
 * VlanPersonsRequestData
 */
@JsonPropertyOrder({
  VlanPersonsRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  VlanPersonsRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  VlanPersonsRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  VlanPersonsRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-01-31T11:10:37.320689708Z[Etc/UTC]")
public class VlanPersonsRequestData {
  ...
  private VlanPersonsEntityRestriction entityRestrictions;

  public static final String JSON_PROPERTY_RELATION_RESTRICTIONS = "relationRestrictions";
  private VlanPersonsRelationRestriction relationRestrictions;
  ...
  public VlanPersonsRequestData() {
  }

  public VlanPersonsRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public VlanPersonsRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public VlanPersonsRequestData entityRestrictions(VlanPersonsEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public VlanPersonsEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(VlanPersonsEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public VlanPersonsRequestData relationRestrictions(VlanPersonsRelationRestriction relationRestrictions) {
  ...
  **/
  ...
  public VlanPersonsRelationRestriction getRelationRestrictions() {
    return relationRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_RELATION_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRelationRestrictions(VlanPersonsRelationRestriction relationRestrictions) {
    this.relationRestrictions = relationRestrictions;
  }


  public VlanPersonsRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public VlanPersonsRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    VlanPersonsRequestData vlanPersonsRequestData = (VlanPersonsRequestData) o;
    return Objects.equals(this.returnEntityAttributes, vlanPersonsRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, vlanPersonsRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, vlanPersonsRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, vlanPersonsRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class VlanPersonsRequestData {\n");
