...
import com.fntsoftware.businessgateway.entities.NodeTypeNodesEntityRestriction;
import com.fntsoftware.businessgateway.entities.NodeTypeNodesRelationRestriction;
...
/**
 * NodeTypeNodesRequestData
 */
@JsonPropertyOrder({
  NodeTypeNodesRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  NodeTypeNodesRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  NodeTypeNodesRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  NodeTypeNodesRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-01-31T11:10:37.320689708Z[Etc/UTC]")
public class NodeTypeNodesRequestData {
  ...
  private NodeTypeNodesEntityRestriction entityRestrictions;

  public static final String JSON_PROPERTY_RELATION_RESTRICTIONS = "relationRestrictions";
  private NodeTypeNodesRelationRestriction relationRestrictions;
  ...
  public NodeTypeNodesRequestData() {
  }

  public NodeTypeNodesRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public NodeTypeNodesRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public NodeTypeNodesRequestData entityRestrictions(NodeTypeNodesEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public NodeTypeNodesEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(NodeTypeNodesEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public NodeTypeNodesRequestData relationRestrictions(NodeTypeNodesRelationRestriction relationRestrictions) {
  ...
  **/
  ...
  public NodeTypeNodesRelationRestriction getRelationRestrictions() {
    return relationRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_RELATION_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRelationRestrictions(NodeTypeNodesRelationRestriction relationRestrictions) {
    this.relationRestrictions = relationRestrictions;
  }


  public NodeTypeNodesRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public NodeTypeNodesRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    NodeTypeNodesRequestData nodeTypeNodesRequestData = (NodeTypeNodesRequestData) o;
    return Objects.equals(this.returnEntityAttributes, nodeTypeNodesRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, nodeTypeNodesRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, nodeTypeNodesRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, nodeTypeNodesRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class NodeTypeNodesRequestData {\n");
