...
public class NodeQueryResponseData {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(coordX, coordY, coordZ, floorElid, zoneElid, description, campusElid, elid, coordSystem, typeElid, function, roomElid, visibleId, id, buildingElid);
  }
