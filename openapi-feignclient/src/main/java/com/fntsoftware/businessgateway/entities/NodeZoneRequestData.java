...
import com.fntsoftware.businessgateway.entities.NodeZoneEntityRestriction;
 ...
 */
@JsonPropertyOrder({
  NodeZoneRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  NodeZoneRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  NodeZoneRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  NodeZoneRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-01-31T11:10:37.320689708Z[Etc/UTC]")
public class NodeZoneRequestData {
  ...
  private NodeZoneEntityRestriction entityRestrictions;
  ...
  public NodeZoneRequestData() {
  }

  public NodeZoneRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public NodeZoneRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public NodeZoneRequestData entityRestrictions(NodeZoneEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public NodeZoneEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(NodeZoneEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public NodeZoneRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public NodeZoneRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public NodeZoneRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    NodeZoneRequestData nodeZoneRequestData = (NodeZoneRequestData) o;
    return Objects.equals(this.returnEntityAttributes, nodeZoneRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, nodeZoneRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, nodeZoneRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, nodeZoneRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class NodeZoneRequestData {\n");
