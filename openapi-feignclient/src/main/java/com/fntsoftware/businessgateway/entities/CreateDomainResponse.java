...
import com.fntsoftware.businessgateway.entities.CreateDomainResponseData;
 ...
 */
@JsonPropertyOrder({
  CreateDomainResponse.JSON_PROPERTY_RETURN_DATA,
  CreateDomainResponse.JSON_PROPERTY_STATUS
})
...
public class CreateDomainResponse {
  ...
  private CreateDomainResponseData returnData;
  ...
  public CreateDomainResponse returnData(CreateDomainResponseData returnData) {
  ...
  **/
  ...
  public CreateDomainResponseData getReturnData() {
    return returnData;
  }
  ...
  @JsonProperty(JSON_PROPERTY_RETURN_DATA)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setReturnData(CreateDomainResponseData returnData) {
    this.returnData = returnData;
  }


  public CreateDomainResponse status(ServiceStatusData status) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.returnData, createDomainResponse.returnData) &&
