...
import com.fntsoftware.businessgateway.entities.NodeNodeTypeEntityRestriction;
...
/**
 * NodeNodeTypeRequestData
 */
@JsonPropertyOrder({
  NodeNodeTypeRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  NodeNodeTypeRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  NodeNodeTypeRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  NodeNodeTypeRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-03-04T13:31:32.601557352Z[Etc/UTC]")
public class NodeNodeTypeRequestData {
  ...
  private NodeNodeTypeEntityRestriction entityRestrictions;
  ...
  public NodeNodeTypeRequestData() {
  }

  public NodeNodeTypeRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public NodeNodeTypeRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public NodeNodeTypeRequestData entityRestrictions(NodeNodeTypeEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public NodeNodeTypeEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(NodeNodeTypeEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public NodeNodeTypeRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public NodeNodeTypeRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public NodeNodeTypeRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    NodeNodeTypeRequestData nodeNodeTypeRequestData = (NodeNodeTypeRequestData) o;
    return Objects.equals(this.returnEntityAttributes, nodeNodeTypeRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, nodeNodeTypeRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, nodeNodeTypeRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, nodeNodeTypeRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class NodeNodeTypeRequestData {\n");
