...
import com.fntsoftware.businessgateway.entities.ChassisDuctsEntityRestriction;
import com.fntsoftware.businessgateway.entities.ChassisDuctsRelationRestriction;
...
/**
 * ChassisDuctsRequestData
 */
@JsonPropertyOrder({
  ChassisDuctsRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  ChassisDuctsRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  ChassisDuctsRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  ChassisDuctsRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
...
public class ChassisDuctsRequestData {
  ...
  private ChassisDuctsEntityRestriction entityRestrictions;

  public static final String JSON_PROPERTY_RELATION_RESTRICTIONS = "relationRestrictions";
  private ChassisDuctsRelationRestriction relationRestrictions;
  ...
  public ChassisDuctsRequestData() {
  }

  public ChassisDuctsRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public ChassisDuctsRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public ChassisDuctsRequestData entityRestrictions(ChassisDuctsEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public ChassisDuctsEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(ChassisDuctsEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public ChassisDuctsRequestData relationRestrictions(ChassisDuctsRelationRestriction relationRestrictions) {
  ...
  **/
  ...
  public ChassisDuctsRelationRestriction getRelationRestrictions() {
    return relationRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_RELATION_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRelationRestrictions(ChassisDuctsRelationRestriction relationRestrictions) {
    this.relationRestrictions = relationRestrictions;
  }


  public ChassisDuctsRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public ChassisDuctsRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ChassisDuctsRequestData chassisDuctsRequestData = (ChassisDuctsRequestData) o;
    return Objects.equals(this.returnEntityAttributes, chassisDuctsRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, chassisDuctsRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, chassisDuctsRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, chassisDuctsRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class ChassisDuctsRequestData {\n");
