...
import com.fntsoftware.businessgateway.entities.VlanContractsEntityRestriction;
import com.fntsoftware.businessgateway.entities.VlanContractsRelationRestriction;
...
/**
 * VlanContractsRequestData
 */
@JsonPropertyOrder({
  VlanContractsRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  VlanContractsRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  VlanContractsRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  VlanContractsRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-03-04T13:31:32.601557352Z[Etc/UTC]")
public class VlanContractsRequestData {
  ...
  private VlanContractsEntityRestriction entityRestrictions;

  public static final String JSON_PROPERTY_RELATION_RESTRICTIONS = "relationRestrictions";
  private VlanContractsRelationRestriction relationRestrictions;
  ...
  public VlanContractsRequestData() {
  }

  public VlanContractsRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public VlanContractsRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public VlanContractsRequestData entityRestrictions(VlanContractsEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public VlanContractsEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(VlanContractsEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public VlanContractsRequestData relationRestrictions(VlanContractsRelationRestriction relationRestrictions) {
  ...
  **/
  ...
  public VlanContractsRelationRestriction getRelationRestrictions() {
    return relationRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_RELATION_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRelationRestrictions(VlanContractsRelationRestriction relationRestrictions) {
    this.relationRestrictions = relationRestrictions;
  }


  public VlanContractsRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public VlanContractsRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    VlanContractsRequestData vlanContractsRequestData = (VlanContractsRequestData) o;
    return Objects.equals(this.returnEntityAttributes, vlanContractsRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, vlanContractsRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, vlanContractsRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, vlanContractsRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class VlanContractsRequestData {\n");
