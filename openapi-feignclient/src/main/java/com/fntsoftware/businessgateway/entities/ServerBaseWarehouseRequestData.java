...
import com.fntsoftware.businessgateway.entities.ServerBaseWarehouseEntityRestriction;
...
/**
 * ServerBaseWarehouseRequestData
 */
@JsonPropertyOrder({
  ServerBaseWarehouseRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  ServerBaseWarehouseRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  ServerBaseWarehouseRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  ServerBaseWarehouseRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-01-31T11:10:37.320689708Z[Etc/UTC]")
public class ServerBaseWarehouseRequestData {
  ...
  private ServerBaseWarehouseEntityRestriction entityRestrictions;
  ...
  public ServerBaseWarehouseRequestData() {
  }

  public ServerBaseWarehouseRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public ServerBaseWarehouseRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public ServerBaseWarehouseRequestData entityRestrictions(ServerBaseWarehouseEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public ServerBaseWarehouseEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(ServerBaseWarehouseEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public ServerBaseWarehouseRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public ServerBaseWarehouseRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public ServerBaseWarehouseRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ServerBaseWarehouseRequestData serverBaseWarehouseRequestData = (ServerBaseWarehouseRequestData) o;
    return Objects.equals(this.returnEntityAttributes, serverBaseWarehouseRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, serverBaseWarehouseRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, serverBaseWarehouseRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, serverBaseWarehouseRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class ServerBaseWarehouseRequestData {\n");
