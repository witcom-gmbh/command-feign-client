...
import com.fntsoftware.businessgateway.entities.SVlanCustomL2CpeSegmentEntityRestriction;
...
/**
 * SVlanCustomL2CpeSegmentRequestData
 */
@JsonPropertyOrder({
  SVlanCustomL2CpeSegmentRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  SVlanCustomL2CpeSegmentRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  SVlanCustomL2CpeSegmentRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  SVlanCustomL2CpeSegmentRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-01-31T11:10:37.320689708Z[Etc/UTC]")
public class SVlanCustomL2CpeSegmentRequestData {
  ...
  private SVlanCustomL2CpeSegmentEntityRestriction entityRestrictions;
  ...
  public SVlanCustomL2CpeSegmentRequestData() {
  }

  public SVlanCustomL2CpeSegmentRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public SVlanCustomL2CpeSegmentRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public SVlanCustomL2CpeSegmentRequestData entityRestrictions(SVlanCustomL2CpeSegmentEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public SVlanCustomL2CpeSegmentEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(SVlanCustomL2CpeSegmentEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public SVlanCustomL2CpeSegmentRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public SVlanCustomL2CpeSegmentRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public SVlanCustomL2CpeSegmentRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    SVlanCustomL2CpeSegmentRequestData svlanCustomL2CpeSegmentRequestData = (SVlanCustomL2CpeSegmentRequestData) o;
    return Objects.equals(this.returnEntityAttributes, svlanCustomL2CpeSegmentRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, svlanCustomL2CpeSegmentRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, svlanCustomL2CpeSegmentRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, svlanCustomL2CpeSegmentRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class SVlanCustomL2CpeSegmentRequestData {\n");
