...
import com.fntsoftware.businessgateway.entities.MandatorUsersEntityRestriction;
import com.fntsoftware.businessgateway.entities.MandatorUsersRelationRestriction;
...
/**
 * MandatorUsersRequestData
 */
@JsonPropertyOrder({
  MandatorUsersRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  MandatorUsersRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  MandatorUsersRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  MandatorUsersRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-01-31T11:10:37.320689708Z[Etc/UTC]")
public class MandatorUsersRequestData {
  ...
  private MandatorUsersEntityRestriction entityRestrictions;

  public static final String JSON_PROPERTY_RELATION_RESTRICTIONS = "relationRestrictions";
  private MandatorUsersRelationRestriction relationRestrictions;
  ...
  public MandatorUsersRequestData() {
  }

  public MandatorUsersRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public MandatorUsersRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public MandatorUsersRequestData entityRestrictions(MandatorUsersEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public MandatorUsersEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(MandatorUsersEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public MandatorUsersRequestData relationRestrictions(MandatorUsersRelationRestriction relationRestrictions) {
  ...
  **/
  ...
  public MandatorUsersRelationRestriction getRelationRestrictions() {
    return relationRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_RELATION_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRelationRestrictions(MandatorUsersRelationRestriction relationRestrictions) {
    this.relationRestrictions = relationRestrictions;
  }


  public MandatorUsersRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public MandatorUsersRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    MandatorUsersRequestData mandatorUsersRequestData = (MandatorUsersRequestData) o;
    return Objects.equals(this.returnEntityAttributes, mandatorUsersRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, mandatorUsersRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, mandatorUsersRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, mandatorUsersRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class MandatorUsersRequestData {\n");
