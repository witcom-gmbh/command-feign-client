...
import com.fntsoftware.businessgateway.entities.ChassisZoneEntityRestriction;
...
/**
 * ChassisZoneRequestData
 */
@JsonPropertyOrder({
  ChassisZoneRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  ChassisZoneRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  ChassisZoneRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  ChassisZoneRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
...
public class ChassisZoneRequestData {
  ...
  private ChassisZoneEntityRestriction entityRestrictions;
  ...
  public ChassisZoneRequestData() {
  }

  public ChassisZoneRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public ChassisZoneRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public ChassisZoneRequestData entityRestrictions(ChassisZoneEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public ChassisZoneEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(ChassisZoneEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public ChassisZoneRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public ChassisZoneRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public ChassisZoneRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ChassisZoneRequestData chassisZoneRequestData = (ChassisZoneRequestData) o;
    return Objects.equals(this.returnEntityAttributes, chassisZoneRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, chassisZoneRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, chassisZoneRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, chassisZoneRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class ChassisZoneRequestData {\n");
