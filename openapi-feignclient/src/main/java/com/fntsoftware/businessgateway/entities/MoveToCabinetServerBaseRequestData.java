...
import com.fntsoftware.businessgateway.entities.MoveToCabinetServerBaseCreateLinkSwitchCabinetRequestData;
import com.fasterxml.jackson.annotation.JsonPropertyOrder;
import com.fasterxml.jackson.annotation.JsonTypeName;

/**
 * MoveToCabinetServerBaseRequestData
 */
@JsonPropertyOrder({
  MoveToCabinetServerBaseRequestData.JSON_PROPERTY_RELEASE_CONNECTIONS,
  MoveToCabinetServerBaseRequestData.JSON_PROPERTY_RELEASE_TRM_ROUTE,
  MoveToCabinetServerBaseRequestData.JSON_PROPERTY_RELEASE_SUPPORTS,
  MoveToCabinetServerBaseRequestData.JSON_PROPERTY_RELEASE_PATCHES,
  MoveToCabinetServerBaseRequestData.JSON_PROPERTY_CREATE_LINK_SWITCH_CABINET
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-01-31T11:10:37.320689708Z[Etc/UTC]")
public class MoveToCabinetServerBaseRequestData {
  ...
  private MoveToCabinetServerBaseCreateLinkSwitchCabinetRequestData createLinkSwitchCabinet;

  public MoveToCabinetServerBaseRequestData() {
  }

  public MoveToCabinetServerBaseRequestData releaseConnections(Boolean releaseConnections) {
  ...
  **/
  ...
  public MoveToCabinetServerBaseRequestData releaseTrmRoute(Boolean releaseTrmRoute) {
  ...
  **/
  ...
  public MoveToCabinetServerBaseRequestData releaseSupports(Boolean releaseSupports) {
  ...
  **/
  ...
  public MoveToCabinetServerBaseRequestData releasePatches(Boolean releasePatches) {
  ...
  **/
  ...
  public MoveToCabinetServerBaseRequestData createLinkSwitchCabinet(MoveToCabinetServerBaseCreateLinkSwitchCabinetRequestData createLinkSwitchCabinet) {
  ...
  **/
  ...
  public MoveToCabinetServerBaseCreateLinkSwitchCabinetRequestData getCreateLinkSwitchCabinet() {
    return createLinkSwitchCabinet;
  }
  ...
  @JsonProperty(JSON_PROPERTY_CREATE_LINK_SWITCH_CABINET)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setCreateLinkSwitchCabinet(MoveToCabinetServerBaseCreateLinkSwitchCabinetRequestData createLinkSwitchCabinet) {
    this.createLinkSwitchCabinet = createLinkSwitchCabinet;
  }
  ...
  public boolean equals(Object o) {
    ...
    MoveToCabinetServerBaseRequestData moveToCabinetServerBaseRequestData = (MoveToCabinetServerBaseRequestData) o;
    return Objects.equals(this.releaseConnections, moveToCabinetServerBaseRequestData.releaseConnections) &&
        Objects.equals(this.releaseTrmRoute, moveToCabinetServerBaseRequestData.releaseTrmRoute) &&
        Objects.equals(this.releaseSupports, moveToCabinetServerBaseRequestData.releaseSupports) &&
        Objects.equals(this.releasePatches, moveToCabinetServerBaseRequestData.releasePatches) &&
        Objects.equals(this.createLinkSwitchCabinet, moveToCabinetServerBaseRequestData.createLinkSwitchCabinet);
  }
  ...
  public String toString() {
    ...
    sb.append("class MoveToCabinetServerBaseRequestData {\n");
