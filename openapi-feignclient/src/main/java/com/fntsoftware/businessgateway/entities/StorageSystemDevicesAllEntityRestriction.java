...
/**
 * StorageSystemDevicesAllEntityRestriction
 */
@JsonPropertyOrder({
  StorageSystemDevicesAllEntityRestriction.JSON_PROPERTY_CLIMATE_RELEVANT,
  StorageSystemDevicesAllEntityRestriction.JSON_PROPERTY_POWER_CONSUMPTION,
  StorageSystemDevicesAllEntityRestriction.JSON_PROPERTY_POWER_SWITCHING_STATUS,
  StorageSystemDevicesAllEntityRestriction.JSON_PROPERTY_PLAN_STATUS,
  StorageSystemDevicesAllEntityRestriction.JSON_PROPERTY_SYSTEM_RUNTIME,
  StorageSystemDevicesAllEntityRestriction.JSON_PROPERTY_WEIGHT,
  StorageSystemDevicesAllEntityRestriction.JSON_PROPERTY_REMARK,
  StorageSystemDevicesAllEntityRestriction.JSON_PROPERTY_ELID,
  StorageSystemDevicesAllEntityRestriction.JSON_PROPERTY_LAST_SEEN,
  StorageSystemDevicesAllEntityRestriction.JSON_PROPERTY_TYPE_ELID,
  StorageSystemDevicesAllEntityRestriction.JSON_PROPERTY_VISIBLE_ID,
  StorageSystemDevicesAllEntityRestriction.JSON_PROPERTY_ID,
  StorageSystemDevicesAllEntityRestriction.JSON_PROPERTY_HEAT_EMISSION
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-03-04T13:31:32.601557352Z[Etc/UTC]")
public class StorageSystemDevicesAllEntityRestriction {
  ...
  public StorageSystemDevicesAllEntityRestriction() {
  }

  public StorageSystemDevicesAllEntityRestriction climateRelevant(RestrictionsBoolean climateRelevant) {
  ...
  **/
  ...
  public StorageSystemDevicesAllEntityRestriction powerConsumption(RestrictionsNumeric powerConsumption) {
  ...
  **/
  ...
  public StorageSystemDevicesAllEntityRestriction powerSwitchingStatus(RestrictionsString powerSwitchingStatus) {
  ...
  **/
  ...
  public StorageSystemDevicesAllEntityRestriction planStatus(RestrictionsString planStatus) {
  ...
  **/
  ...
  public StorageSystemDevicesAllEntityRestriction systemRuntime(RestrictionsNumeric systemRuntime) {
  ...
  **/
  ...
  public StorageSystemDevicesAllEntityRestriction weight(RestrictionsNumeric weight) {
  ...
  **/
  ...
  public StorageSystemDevicesAllEntityRestriction remark(RestrictionsString remark) {
  ...
  **/
  ...
  public StorageSystemDevicesAllEntityRestriction elid(RestrictionsString elid) {
  ...
  **/
  ...
  public StorageSystemDevicesAllEntityRestriction lastSeen(RestrictionsDate lastSeen) {
  ...
  **/
  ...
  public StorageSystemDevicesAllEntityRestriction typeElid(RestrictionsString typeElid) {
  ...
  **/
  ...
  public StorageSystemDevicesAllEntityRestriction visibleId(RestrictionsString visibleId) {
  ...
  **/
  ...
  public StorageSystemDevicesAllEntityRestriction id(RestrictionsString id) {
  ...
  **/
  ...
  public StorageSystemDevicesAllEntityRestriction heatEmission(RestrictionsNumeric heatEmission) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    StorageSystemDevicesAllEntityRestriction storageSystemDevicesAllEntityRestriction = (StorageSystemDevicesAllEntityRestriction) o;
    return Objects.equals(this.climateRelevant, storageSystemDevicesAllEntityRestriction.climateRelevant) &&
        Objects.equals(this.powerConsumption, storageSystemDevicesAllEntityRestriction.powerConsumption) &&
        Objects.equals(this.powerSwitchingStatus, storageSystemDevicesAllEntityRestriction.powerSwitchingStatus) &&
        Objects.equals(this.planStatus, storageSystemDevicesAllEntityRestriction.planStatus) &&
        Objects.equals(this.systemRuntime, storageSystemDevicesAllEntityRestriction.systemRuntime) &&
        Objects.equals(this.weight, storageSystemDevicesAllEntityRestriction.weight) &&
        Objects.equals(this.remark, storageSystemDevicesAllEntityRestriction.remark) &&
        Objects.equals(this.elid, storageSystemDevicesAllEntityRestriction.elid) &&
        Objects.equals(this.lastSeen, storageSystemDevicesAllEntityRestriction.lastSeen) &&
        Objects.equals(this.typeElid, storageSystemDevicesAllEntityRestriction.typeElid) &&
        Objects.equals(this.visibleId, storageSystemDevicesAllEntityRestriction.visibleId) &&
        Objects.equals(this.id, storageSystemDevicesAllEntityRestriction.id) &&
        Objects.equals(this.heatEmission, storageSystemDevicesAllEntityRestriction.heatEmission);
  }
  ...
  public String toString() {
    ...
    sb.append("class StorageSystemDevicesAllEntityRestriction {\n");
