...
import com.fntsoftware.businessgateway.entities.Ipv6NetworkVlanEntityRestriction;
...
/**
 * Ipv6NetworkVlanRequestData
 */
@JsonPropertyOrder({
  Ipv6NetworkVlanRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  Ipv6NetworkVlanRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  Ipv6NetworkVlanRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  Ipv6NetworkVlanRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-01-31T11:10:37.320689708Z[Etc/UTC]")
public class Ipv6NetworkVlanRequestData {
  ...
  private Ipv6NetworkVlanEntityRestriction entityRestrictions;
  ...
  public Ipv6NetworkVlanRequestData() {
  }

  public Ipv6NetworkVlanRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public Ipv6NetworkVlanRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public Ipv6NetworkVlanRequestData entityRestrictions(Ipv6NetworkVlanEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public Ipv6NetworkVlanEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(Ipv6NetworkVlanEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public Ipv6NetworkVlanRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public Ipv6NetworkVlanRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public Ipv6NetworkVlanRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    Ipv6NetworkVlanRequestData ipv6NetworkVlanRequestData = (Ipv6NetworkVlanRequestData) o;
    return Objects.equals(this.returnEntityAttributes, ipv6NetworkVlanRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, ipv6NetworkVlanRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, ipv6NetworkVlanRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, ipv6NetworkVlanRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class Ipv6NetworkVlanRequestData {\n");
