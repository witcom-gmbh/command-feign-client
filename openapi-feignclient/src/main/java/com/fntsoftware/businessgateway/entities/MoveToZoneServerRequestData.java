...
import com.fntsoftware.businessgateway.entities.MoveToZoneServerCreateLinkZoneRequestData;
import com.fasterxml.jackson.annotation.JsonPropertyOrder;
import com.fasterxml.jackson.annotation.JsonTypeName;

/**
 * MoveToZoneServerRequestData
 */
@JsonPropertyOrder({
  MoveToZoneServerRequestData.JSON_PROPERTY_RELEASE_SIGNALPATH,
  MoveToZoneServerRequestData.JSON_PROPERTY_RELEASE_CONNECTIONS,
  MoveToZoneServerRequestData.JSON_PROPERTY_RELEASE_SERVICE,
  MoveToZoneServerRequestData.JSON_PROPERTY_RELEASE_SUPPORTS,
  MoveToZoneServerRequestData.JSON_PROPERTY_RELEASE_PATCHES,
  MoveToZoneServerRequestData.JSON_PROPERTY_CREATE_LINK_ZONE
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-02-26T11:20:24.990023935Z[Etc/UTC]")
public class MoveToZoneServerRequestData {
  ...
  private MoveToZoneServerCreateLinkZoneRequestData createLinkZone;

  public MoveToZoneServerRequestData() {
  }

  public MoveToZoneServerRequestData releaseSignalpath(Boolean releaseSignalpath) {
  ...
  **/
  ...
  public MoveToZoneServerRequestData releaseConnections(Boolean releaseConnections) {
  ...
  **/
  ...
  public MoveToZoneServerRequestData releaseService(Boolean releaseService) {
  ...
  **/
  ...
  public MoveToZoneServerRequestData releaseSupports(Boolean releaseSupports) {
  ...
  **/
  ...
  public MoveToZoneServerRequestData releasePatches(Boolean releasePatches) {
  ...
  **/
  ...
  public MoveToZoneServerRequestData createLinkZone(MoveToZoneServerCreateLinkZoneRequestData createLinkZone) {
  ...
  **/
  ...
  public MoveToZoneServerCreateLinkZoneRequestData getCreateLinkZone() {
    return createLinkZone;
  }
  ...
  @JsonProperty(JSON_PROPERTY_CREATE_LINK_ZONE)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setCreateLinkZone(MoveToZoneServerCreateLinkZoneRequestData createLinkZone) {
    this.createLinkZone = createLinkZone;
  }
  ...
  public boolean equals(Object o) {
    ...
    MoveToZoneServerRequestData moveToZoneServerRequestData = (MoveToZoneServerRequestData) o;
    return Objects.equals(this.releaseSignalpath, moveToZoneServerRequestData.releaseSignalpath) &&
        Objects.equals(this.releaseConnections, moveToZoneServerRequestData.releaseConnections) &&
        Objects.equals(this.releaseService, moveToZoneServerRequestData.releaseService) &&
        Objects.equals(this.releaseSupports, moveToZoneServerRequestData.releaseSupports) &&
        Objects.equals(this.releasePatches, moveToZoneServerRequestData.releasePatches) &&
        Objects.equals(this.createLinkZone, moveToZoneServerRequestData.createLinkZone);
  }
  ...
  public String toString() {
    ...
    sb.append("class MoveToZoneServerRequestData {\n");
