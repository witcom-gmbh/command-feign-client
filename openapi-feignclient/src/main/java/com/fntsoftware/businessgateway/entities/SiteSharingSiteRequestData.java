...
import com.fntsoftware.businessgateway.entities.SiteSharingSiteEntityRestriction;
...
/**
 * SiteSharingSiteRequestData
 */
@JsonPropertyOrder({
  SiteSharingSiteRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  SiteSharingSiteRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  SiteSharingSiteRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  SiteSharingSiteRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-01-31T11:10:37.320689708Z[Etc/UTC]")
public class SiteSharingSiteRequestData {
  ...
  private SiteSharingSiteEntityRestriction entityRestrictions;
  ...
  public SiteSharingSiteRequestData() {
  }

  public SiteSharingSiteRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public SiteSharingSiteRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public SiteSharingSiteRequestData entityRestrictions(SiteSharingSiteEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public SiteSharingSiteEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(SiteSharingSiteEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public SiteSharingSiteRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public SiteSharingSiteRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public SiteSharingSiteRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    SiteSharingSiteRequestData siteSharingSiteRequestData = (SiteSharingSiteRequestData) o;
    return Objects.equals(this.returnEntityAttributes, siteSharingSiteRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, siteSharingSiteRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, siteSharingSiteRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, siteSharingSiteRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class SiteSharingSiteRequestData {\n");
