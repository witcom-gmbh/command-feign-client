...
import com.fntsoftware.businessgateway.entities.LogicalPortDeviceAllEntityRestriction;
...
/**
 * LogicalPortDeviceAllRequestData
 */
@JsonPropertyOrder({
  LogicalPortDeviceAllRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  LogicalPortDeviceAllRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  LogicalPortDeviceAllRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  LogicalPortDeviceAllRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-02-26T11:20:24.990023935Z[Etc/UTC]")
public class LogicalPortDeviceAllRequestData {
  ...
  private LogicalPortDeviceAllEntityRestriction entityRestrictions;
  ...
  public LogicalPortDeviceAllRequestData() {
  }

  public LogicalPortDeviceAllRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public LogicalPortDeviceAllRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public LogicalPortDeviceAllRequestData entityRestrictions(LogicalPortDeviceAllEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public LogicalPortDeviceAllEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(LogicalPortDeviceAllEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public LogicalPortDeviceAllRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public LogicalPortDeviceAllRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public LogicalPortDeviceAllRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    LogicalPortDeviceAllRequestData logicalPortDeviceAllRequestData = (LogicalPortDeviceAllRequestData) o;
    return Objects.equals(this.returnEntityAttributes, logicalPortDeviceAllRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, logicalPortDeviceAllRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, logicalPortDeviceAllRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, logicalPortDeviceAllRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class LogicalPortDeviceAllRequestData {\n");
