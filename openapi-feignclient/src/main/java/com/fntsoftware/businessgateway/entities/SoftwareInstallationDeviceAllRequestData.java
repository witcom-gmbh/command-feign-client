...
import com.fntsoftware.businessgateway.entities.SoftwareInstallationDeviceAllEntityRestriction;
...
/**
 * SoftwareInstallationDeviceAllRequestData
 */
@JsonPropertyOrder({
  SoftwareInstallationDeviceAllRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  SoftwareInstallationDeviceAllRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  SoftwareInstallationDeviceAllRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  SoftwareInstallationDeviceAllRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-03-04T13:31:32.601557352Z[Etc/UTC]")
public class SoftwareInstallationDeviceAllRequestData {
  ...
  private SoftwareInstallationDeviceAllEntityRestriction entityRestrictions;
  ...
  public SoftwareInstallationDeviceAllRequestData() {
  }

  public SoftwareInstallationDeviceAllRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public SoftwareInstallationDeviceAllRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public SoftwareInstallationDeviceAllRequestData entityRestrictions(SoftwareInstallationDeviceAllEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public SoftwareInstallationDeviceAllEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(SoftwareInstallationDeviceAllEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public SoftwareInstallationDeviceAllRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public SoftwareInstallationDeviceAllRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public SoftwareInstallationDeviceAllRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    SoftwareInstallationDeviceAllRequestData softwareInstallationDeviceAllRequestData = (SoftwareInstallationDeviceAllRequestData) o;
    return Objects.equals(this.returnEntityAttributes, softwareInstallationDeviceAllRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, softwareInstallationDeviceAllRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, softwareInstallationDeviceAllRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, softwareInstallationDeviceAllRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class SoftwareInstallationDeviceAllRequestData {\n");
