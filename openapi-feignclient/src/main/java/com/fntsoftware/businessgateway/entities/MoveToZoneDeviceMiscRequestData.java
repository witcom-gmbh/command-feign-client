...
import com.fntsoftware.businessgateway.entities.MoveToZoneDeviceMiscCreateLinkZoneRequestData;
import com.fasterxml.jackson.annotation.JsonPropertyOrder;
import com.fasterxml.jackson.annotation.JsonTypeName;

/**
 * MoveToZoneDeviceMiscRequestData
 */
@JsonPropertyOrder({
  MoveToZoneDeviceMiscRequestData.JSON_PROPERTY_RELEASE_SIGNALPATH,
  MoveToZoneDeviceMiscRequestData.JSON_PROPERTY_RELEASE_CONNECTIONS,
  MoveToZoneDeviceMiscRequestData.JSON_PROPERTY_RELEASE_SERVICE,
  MoveToZoneDeviceMiscRequestData.JSON_PROPERTY_RELEASE_SUPPORTS,
  MoveToZoneDeviceMiscRequestData.JSON_PROPERTY_RELEASE_PATCHES,
  MoveToZoneDeviceMiscRequestData.JSON_PROPERTY_CREATE_LINK_ZONE
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-02-26T11:20:24.990023935Z[Etc/UTC]")
public class MoveToZoneDeviceMiscRequestData {
  ...
  private MoveToZoneDeviceMiscCreateLinkZoneRequestData createLinkZone;

  public MoveToZoneDeviceMiscRequestData() {
  }

  public MoveToZoneDeviceMiscRequestData releaseSignalpath(Boolean releaseSignalpath) {
  ...
  **/
  ...
  public MoveToZoneDeviceMiscRequestData releaseConnections(Boolean releaseConnections) {
  ...
  **/
  ...
  public MoveToZoneDeviceMiscRequestData releaseService(Boolean releaseService) {
  ...
  **/
  ...
  public MoveToZoneDeviceMiscRequestData releaseSupports(Boolean releaseSupports) {
  ...
  **/
  ...
  public MoveToZoneDeviceMiscRequestData releasePatches(Boolean releasePatches) {
  ...
  **/
  ...
  public MoveToZoneDeviceMiscRequestData createLinkZone(MoveToZoneDeviceMiscCreateLinkZoneRequestData createLinkZone) {
  ...
  **/
  ...
  public MoveToZoneDeviceMiscCreateLinkZoneRequestData getCreateLinkZone() {
    return createLinkZone;
  }
  ...
  @JsonProperty(JSON_PROPERTY_CREATE_LINK_ZONE)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setCreateLinkZone(MoveToZoneDeviceMiscCreateLinkZoneRequestData createLinkZone) {
    this.createLinkZone = createLinkZone;
  }
  ...
  public boolean equals(Object o) {
    ...
    MoveToZoneDeviceMiscRequestData moveToZoneDeviceMiscRequestData = (MoveToZoneDeviceMiscRequestData) o;
    return Objects.equals(this.releaseSignalpath, moveToZoneDeviceMiscRequestData.releaseSignalpath) &&
        Objects.equals(this.releaseConnections, moveToZoneDeviceMiscRequestData.releaseConnections) &&
        Objects.equals(this.releaseService, moveToZoneDeviceMiscRequestData.releaseService) &&
        Objects.equals(this.releaseSupports, moveToZoneDeviceMiscRequestData.releaseSupports) &&
        Objects.equals(this.releasePatches, moveToZoneDeviceMiscRequestData.releasePatches) &&
        Objects.equals(this.createLinkZone, moveToZoneDeviceMiscRequestData.createLinkZone);
  }
  ...
  public String toString() {
    ...
    sb.append("class MoveToZoneDeviceMiscRequestData {\n");
