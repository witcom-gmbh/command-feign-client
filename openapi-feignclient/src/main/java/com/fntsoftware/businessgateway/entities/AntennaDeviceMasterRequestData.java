...
import com.fntsoftware.businessgateway.entities.AntennaDeviceMasterEntityRestriction;
...
/**
 * AntennaDeviceMasterRequestData
 */
@JsonPropertyOrder({
  AntennaDeviceMasterRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  AntennaDeviceMasterRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  AntennaDeviceMasterRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  AntennaDeviceMasterRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-02-26T11:20:24.990023935Z[Etc/UTC]")
public class AntennaDeviceMasterRequestData {
  ...
  private AntennaDeviceMasterEntityRestriction entityRestrictions;
  ...
  public AntennaDeviceMasterRequestData() {
  }

  public AntennaDeviceMasterRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public AntennaDeviceMasterRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public AntennaDeviceMasterRequestData entityRestrictions(AntennaDeviceMasterEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public AntennaDeviceMasterEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(AntennaDeviceMasterEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public AntennaDeviceMasterRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public AntennaDeviceMasterRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public AntennaDeviceMasterRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    AntennaDeviceMasterRequestData antennaDeviceMasterRequestData = (AntennaDeviceMasterRequestData) o;
    return Objects.equals(this.returnEntityAttributes, antennaDeviceMasterRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, antennaDeviceMasterRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, antennaDeviceMasterRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, antennaDeviceMasterRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class AntennaDeviceMasterRequestData {\n");
