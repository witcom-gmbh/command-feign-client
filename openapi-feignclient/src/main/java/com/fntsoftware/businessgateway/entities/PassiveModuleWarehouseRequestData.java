...
import com.fntsoftware.businessgateway.entities.PassiveModuleWarehouseEntityRestriction;
...
/**
 * PassiveModuleWarehouseRequestData
 */
@JsonPropertyOrder({
  PassiveModuleWarehouseRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  PassiveModuleWarehouseRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  PassiveModuleWarehouseRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  PassiveModuleWarehouseRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-03-04T13:31:32.601557352Z[Etc/UTC]")
public class PassiveModuleWarehouseRequestData {
  ...
  private PassiveModuleWarehouseEntityRestriction entityRestrictions;
  ...
  public PassiveModuleWarehouseRequestData() {
  }

  public PassiveModuleWarehouseRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public PassiveModuleWarehouseRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public PassiveModuleWarehouseRequestData entityRestrictions(PassiveModuleWarehouseEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public PassiveModuleWarehouseEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(PassiveModuleWarehouseEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public PassiveModuleWarehouseRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public PassiveModuleWarehouseRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public PassiveModuleWarehouseRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    PassiveModuleWarehouseRequestData passiveModuleWarehouseRequestData = (PassiveModuleWarehouseRequestData) o;
    return Objects.equals(this.returnEntityAttributes, passiveModuleWarehouseRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, passiveModuleWarehouseRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, passiveModuleWarehouseRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, passiveModuleWarehouseRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class PassiveModuleWarehouseRequestData {\n");
