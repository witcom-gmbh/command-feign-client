...
/**
 * MaintenanceWindowStorageUnitsEntityRestriction
 */
@JsonPropertyOrder({
  MaintenanceWindowStorageUnitsEntityRestriction.JSON_PROPERTY_LIFECYCLE_STATUS_DATE,
  MaintenanceWindowStorageUnitsEntityRestriction.JSON_PROPERTY_USED_GB,
  MaintenanceWindowStorageUnitsEntityRestriction.JSON_PROPERTY_C_POOL_NAME,
  MaintenanceWindowStorageUnitsEntityRestriction.JSON_PROPERTY_LIFECYCLE_STATUS,
  MaintenanceWindowStorageUnitsEntityRestriction.JSON_PROPERTY_REDUNDANCY_CLASS,
  MaintenanceWindowStorageUnitsEntityRestriction.JSON_PROPERTY_C_STORAGE_CLASS,
  MaintenanceWindowStorageUnitsEntityRestriction.JSON_PROPERTY_CAPACITY_GB,
  MaintenanceWindowStorageUnitsEntityRestriction.JSON_PROPERTY_REMARK,
  MaintenanceWindowStorageUnitsEntityRestriction.JSON_PROPERTY_VISIBLE_ID,
  MaintenanceWindowStorageUnitsEntityRestriction.JSON_PROPERTY_ID,
  MaintenanceWindowStorageUnitsEntityRestriction.JSON_PROPERTY_REDUNDANCY,
  MaintenanceWindowStorageUnitsEntityRestriction.JSON_PROPERTY_ELID
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-03-04T13:31:32.601557352Z[Etc/UTC]")
public class MaintenanceWindowStorageUnitsEntityRestriction {
  ...
  public MaintenanceWindowStorageUnitsEntityRestriction() {
  }

  public MaintenanceWindowStorageUnitsEntityRestriction lifecycleStatusDate(RestrictionsDate lifecycleStatusDate) {
  ...
  **/
  ...
  public MaintenanceWindowStorageUnitsEntityRestriction usedGb(RestrictionsNumeric usedGb) {
  ...
  **/
  ...
  public MaintenanceWindowStorageUnitsEntityRestriction cPoolName(RestrictionsString cPoolName) {
  ...
  **/
  ...
  public MaintenanceWindowStorageUnitsEntityRestriction lifecycleStatus(RestrictionsString lifecycleStatus) {
  ...
  **/
  ...
  public MaintenanceWindowStorageUnitsEntityRestriction redundancyClass(RestrictionsString redundancyClass) {
  ...
  **/
  ...
  public MaintenanceWindowStorageUnitsEntityRestriction cStorageClass(RestrictionsString cStorageClass) {
  ...
  **/
  ...
  public MaintenanceWindowStorageUnitsEntityRestriction capacityGb(RestrictionsNumeric capacityGb) {
  ...
  **/
  ...
  public MaintenanceWindowStorageUnitsEntityRestriction remark(RestrictionsString remark) {
  ...
  **/
  ...
  public MaintenanceWindowStorageUnitsEntityRestriction visibleId(RestrictionsString visibleId) {
  ...
  **/
  ...
  public MaintenanceWindowStorageUnitsEntityRestriction id(RestrictionsString id) {
  ...
  **/
  ...
  public MaintenanceWindowStorageUnitsEntityRestriction redundancy(RestrictionsBoolean redundancy) {
  ...
  **/
  ...
  public MaintenanceWindowStorageUnitsEntityRestriction elid(RestrictionsString elid) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    MaintenanceWindowStorageUnitsEntityRestriction maintenanceWindowStorageUnitsEntityRestriction = (MaintenanceWindowStorageUnitsEntityRestriction) o;
    return Objects.equals(this.lifecycleStatusDate, maintenanceWindowStorageUnitsEntityRestriction.lifecycleStatusDate) &&
        Objects.equals(this.usedGb, maintenanceWindowStorageUnitsEntityRestriction.usedGb) &&
        Objects.equals(this.cPoolName, maintenanceWindowStorageUnitsEntityRestriction.cPoolName) &&
        Objects.equals(this.lifecycleStatus, maintenanceWindowStorageUnitsEntityRestriction.lifecycleStatus) &&
        Objects.equals(this.redundancyClass, maintenanceWindowStorageUnitsEntityRestriction.redundancyClass) &&
        Objects.equals(this.cStorageClass, maintenanceWindowStorageUnitsEntityRestriction.cStorageClass) &&
        Objects.equals(this.capacityGb, maintenanceWindowStorageUnitsEntityRestriction.capacityGb) &&
        Objects.equals(this.remark, maintenanceWindowStorageUnitsEntityRestriction.remark) &&
        Objects.equals(this.visibleId, maintenanceWindowStorageUnitsEntityRestriction.visibleId) &&
        Objects.equals(this.id, maintenanceWindowStorageUnitsEntityRestriction.id) &&
        Objects.equals(this.redundancy, maintenanceWindowStorageUnitsEntityRestriction.redundancy) &&
        Objects.equals(this.elid, maintenanceWindowStorageUnitsEntityRestriction.elid);
  }
  ...
  public String toString() {
    ...
    sb.append("class MaintenanceWindowStorageUnitsEntityRestriction {\n");
