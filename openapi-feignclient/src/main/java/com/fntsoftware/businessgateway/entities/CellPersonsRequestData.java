...
import com.fntsoftware.businessgateway.entities.CellPersonsEntityRestriction;
import com.fntsoftware.businessgateway.entities.CellPersonsRelationRestriction;
...
/**
 * CellPersonsRequestData
 */
@JsonPropertyOrder({
  CellPersonsRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  CellPersonsRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  CellPersonsRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  CellPersonsRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-01-31T11:10:37.320689708Z[Etc/UTC]")
public class CellPersonsRequestData {
  ...
  private CellPersonsEntityRestriction entityRestrictions;

  public static final String JSON_PROPERTY_RELATION_RESTRICTIONS = "relationRestrictions";
  private CellPersonsRelationRestriction relationRestrictions;
  ...
  public CellPersonsRequestData() {
  }

  public CellPersonsRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public CellPersonsRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public CellPersonsRequestData entityRestrictions(CellPersonsEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public CellPersonsEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(CellPersonsEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public CellPersonsRequestData relationRestrictions(CellPersonsRelationRestriction relationRestrictions) {
  ...
  **/
  ...
  public CellPersonsRelationRestriction getRelationRestrictions() {
    return relationRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_RELATION_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRelationRestrictions(CellPersonsRelationRestriction relationRestrictions) {
    this.relationRestrictions = relationRestrictions;
  }


  public CellPersonsRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public CellPersonsRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    CellPersonsRequestData cellPersonsRequestData = (CellPersonsRequestData) o;
    return Objects.equals(this.returnEntityAttributes, cellPersonsRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, cellPersonsRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, cellPersonsRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, cellPersonsRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class CellPersonsRequestData {\n");
