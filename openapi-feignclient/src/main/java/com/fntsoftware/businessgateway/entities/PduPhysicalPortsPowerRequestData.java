...
import com.fntsoftware.businessgateway.entities.PduPhysicalPortsPowerEntityRestriction;
...
/**
 * PduPhysicalPortsPowerRequestData
 */
@JsonPropertyOrder({
  PduPhysicalPortsPowerRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  PduPhysicalPortsPowerRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  PduPhysicalPortsPowerRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  PduPhysicalPortsPowerRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-02-26T11:20:24.990023935Z[Etc/UTC]")
public class PduPhysicalPortsPowerRequestData {
  ...
  private PduPhysicalPortsPowerEntityRestriction entityRestrictions;
  ...
  public PduPhysicalPortsPowerRequestData() {
  }

  public PduPhysicalPortsPowerRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public PduPhysicalPortsPowerRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public PduPhysicalPortsPowerRequestData entityRestrictions(PduPhysicalPortsPowerEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public PduPhysicalPortsPowerEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(PduPhysicalPortsPowerEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public PduPhysicalPortsPowerRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public PduPhysicalPortsPowerRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public PduPhysicalPortsPowerRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    PduPhysicalPortsPowerRequestData pduPhysicalPortsPowerRequestData = (PduPhysicalPortsPowerRequestData) o;
    return Objects.equals(this.returnEntityAttributes, pduPhysicalPortsPowerRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, pduPhysicalPortsPowerRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, pduPhysicalPortsPowerRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, pduPhysicalPortsPowerRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class PduPhysicalPortsPowerRequestData {\n");
