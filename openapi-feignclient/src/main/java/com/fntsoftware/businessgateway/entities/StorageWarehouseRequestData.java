...
import com.fntsoftware.businessgateway.entities.StorageWarehouseEntityRestriction;
...
/**
 * StorageWarehouseRequestData
 */
@JsonPropertyOrder({
  StorageWarehouseRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  StorageWarehouseRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  StorageWarehouseRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  StorageWarehouseRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-03-04T13:31:32.601557352Z[Etc/UTC]")
public class StorageWarehouseRequestData {
  ...
  private StorageWarehouseEntityRestriction entityRestrictions;
  ...
  public StorageWarehouseRequestData() {
  }

  public StorageWarehouseRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public StorageWarehouseRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public StorageWarehouseRequestData entityRestrictions(StorageWarehouseEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public StorageWarehouseEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(StorageWarehouseEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public StorageWarehouseRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public StorageWarehouseRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public StorageWarehouseRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    StorageWarehouseRequestData storageWarehouseRequestData = (StorageWarehouseRequestData) o;
    return Objects.equals(this.returnEntityAttributes, storageWarehouseRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, storageWarehouseRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, storageWarehouseRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, storageWarehouseRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class StorageWarehouseRequestData {\n");
