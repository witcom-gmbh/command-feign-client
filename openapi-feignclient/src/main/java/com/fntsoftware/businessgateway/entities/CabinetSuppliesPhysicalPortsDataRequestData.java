...
import com.fntsoftware.businessgateway.entities.CabinetSuppliesPhysicalPortsDataEntityRestriction;
...
/**
 * CabinetSuppliesPhysicalPortsDataRequestData
 */
@JsonPropertyOrder({
  CabinetSuppliesPhysicalPortsDataRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  CabinetSuppliesPhysicalPortsDataRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  CabinetSuppliesPhysicalPortsDataRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  CabinetSuppliesPhysicalPortsDataRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-02-26T11:20:24.990023935Z[Etc/UTC]")
public class CabinetSuppliesPhysicalPortsDataRequestData {
  ...
  private CabinetSuppliesPhysicalPortsDataEntityRestriction entityRestrictions;
  ...
  public CabinetSuppliesPhysicalPortsDataRequestData() {
  }

  public CabinetSuppliesPhysicalPortsDataRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public CabinetSuppliesPhysicalPortsDataRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public CabinetSuppliesPhysicalPortsDataRequestData entityRestrictions(CabinetSuppliesPhysicalPortsDataEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public CabinetSuppliesPhysicalPortsDataEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(CabinetSuppliesPhysicalPortsDataEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public CabinetSuppliesPhysicalPortsDataRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public CabinetSuppliesPhysicalPortsDataRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public CabinetSuppliesPhysicalPortsDataRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    CabinetSuppliesPhysicalPortsDataRequestData cabinetSuppliesPhysicalPortsDataRequestData = (CabinetSuppliesPhysicalPortsDataRequestData) o;
    return Objects.equals(this.returnEntityAttributes, cabinetSuppliesPhysicalPortsDataRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, cabinetSuppliesPhysicalPortsDataRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, cabinetSuppliesPhysicalPortsDataRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, cabinetSuppliesPhysicalPortsDataRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class CabinetSuppliesPhysicalPortsDataRequestData {\n");
