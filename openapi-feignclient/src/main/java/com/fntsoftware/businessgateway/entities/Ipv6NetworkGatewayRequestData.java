...
import com.fntsoftware.businessgateway.entities.Ipv6NetworkGatewayEntityRestriction;
...
/**
 * Ipv6NetworkGatewayRequestData
 */
@JsonPropertyOrder({
  Ipv6NetworkGatewayRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  Ipv6NetworkGatewayRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  Ipv6NetworkGatewayRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  Ipv6NetworkGatewayRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-01-31T11:10:37.320689708Z[Etc/UTC]")
public class Ipv6NetworkGatewayRequestData {
  ...
  private Ipv6NetworkGatewayEntityRestriction entityRestrictions;
  ...
  public Ipv6NetworkGatewayRequestData() {
  }

  public Ipv6NetworkGatewayRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public Ipv6NetworkGatewayRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public Ipv6NetworkGatewayRequestData entityRestrictions(Ipv6NetworkGatewayEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public Ipv6NetworkGatewayEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(Ipv6NetworkGatewayEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public Ipv6NetworkGatewayRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public Ipv6NetworkGatewayRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public Ipv6NetworkGatewayRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    Ipv6NetworkGatewayRequestData ipv6NetworkGatewayRequestData = (Ipv6NetworkGatewayRequestData) o;
    return Objects.equals(this.returnEntityAttributes, ipv6NetworkGatewayRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, ipv6NetworkGatewayRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, ipv6NetworkGatewayRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, ipv6NetworkGatewayRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class Ipv6NetworkGatewayRequestData {\n");
