...
import com.fntsoftware.businessgateway.entities.Ipv6NetworkDomainEntityRestriction;
...
/**
 * Ipv6NetworkDomainRequestData
 */
@JsonPropertyOrder({
  Ipv6NetworkDomainRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  Ipv6NetworkDomainRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  Ipv6NetworkDomainRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  Ipv6NetworkDomainRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-02-26T11:20:24.990023935Z[Etc/UTC]")
public class Ipv6NetworkDomainRequestData {
  ...
  private Ipv6NetworkDomainEntityRestriction entityRestrictions;
  ...
  public Ipv6NetworkDomainRequestData() {
  }

  public Ipv6NetworkDomainRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public Ipv6NetworkDomainRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public Ipv6NetworkDomainRequestData entityRestrictions(Ipv6NetworkDomainEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public Ipv6NetworkDomainEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(Ipv6NetworkDomainEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public Ipv6NetworkDomainRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public Ipv6NetworkDomainRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public Ipv6NetworkDomainRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    Ipv6NetworkDomainRequestData ipv6NetworkDomainRequestData = (Ipv6NetworkDomainRequestData) o;
    return Objects.equals(this.returnEntityAttributes, ipv6NetworkDomainRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, ipv6NetworkDomainRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, ipv6NetworkDomainRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, ipv6NetworkDomainRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class Ipv6NetworkDomainRequestData {\n");
