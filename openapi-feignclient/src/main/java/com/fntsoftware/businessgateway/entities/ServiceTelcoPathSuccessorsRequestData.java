...
import com.fntsoftware.businessgateway.entities.ServiceTelcoPathSuccessorsEntityRestriction;
...
/**
 * ServiceTelcoPathSuccessorsRequestData
 */
@JsonPropertyOrder({
  ServiceTelcoPathSuccessorsRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  ServiceTelcoPathSuccessorsRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  ServiceTelcoPathSuccessorsRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  ServiceTelcoPathSuccessorsRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-03-04T13:31:32.601557352Z[Etc/UTC]")
public class ServiceTelcoPathSuccessorsRequestData {
  ...
  private ServiceTelcoPathSuccessorsEntityRestriction entityRestrictions;
  ...
  public ServiceTelcoPathSuccessorsRequestData() {
  }

  public ServiceTelcoPathSuccessorsRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public ServiceTelcoPathSuccessorsRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public ServiceTelcoPathSuccessorsRequestData entityRestrictions(ServiceTelcoPathSuccessorsEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public ServiceTelcoPathSuccessorsEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(ServiceTelcoPathSuccessorsEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public ServiceTelcoPathSuccessorsRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public ServiceTelcoPathSuccessorsRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public ServiceTelcoPathSuccessorsRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ServiceTelcoPathSuccessorsRequestData serviceTelcoPathSuccessorsRequestData = (ServiceTelcoPathSuccessorsRequestData) o;
    return Objects.equals(this.returnEntityAttributes, serviceTelcoPathSuccessorsRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, serviceTelcoPathSuccessorsRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, serviceTelcoPathSuccessorsRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, serviceTelcoPathSuccessorsRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class ServiceTelcoPathSuccessorsRequestData {\n");
