...
import com.fntsoftware.businessgateway.entities.AntennaZoneEntityRestriction;
...
/**
 * AntennaZoneRequestData
 */
@JsonPropertyOrder({
  AntennaZoneRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  AntennaZoneRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  AntennaZoneRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  AntennaZoneRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-01-31T11:10:37.320689708Z[Etc/UTC]")
public class AntennaZoneRequestData {
  ...
  private AntennaZoneEntityRestriction entityRestrictions;
  ...
  public AntennaZoneRequestData() {
  }

  public AntennaZoneRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public AntennaZoneRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public AntennaZoneRequestData entityRestrictions(AntennaZoneEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public AntennaZoneEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(AntennaZoneEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public AntennaZoneRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public AntennaZoneRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public AntennaZoneRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    AntennaZoneRequestData antennaZoneRequestData = (AntennaZoneRequestData) o;
    return Objects.equals(this.returnEntityAttributes, antennaZoneRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, antennaZoneRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, antennaZoneRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, antennaZoneRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class AntennaZoneRequestData {\n");
