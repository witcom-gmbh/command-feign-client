...
import com.fntsoftware.businessgateway.entities.Ipv6NetworkParentNetworkEntityRestriction;
...
/**
 * Ipv6NetworkParentNetworkRequestData
 */
@JsonPropertyOrder({
  Ipv6NetworkParentNetworkRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  Ipv6NetworkParentNetworkRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  Ipv6NetworkParentNetworkRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  Ipv6NetworkParentNetworkRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-01-31T11:10:37.320689708Z[Etc/UTC]")
public class Ipv6NetworkParentNetworkRequestData {
  ...
  private Ipv6NetworkParentNetworkEntityRestriction entityRestrictions;
  ...
  public Ipv6NetworkParentNetworkRequestData() {
  }

  public Ipv6NetworkParentNetworkRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public Ipv6NetworkParentNetworkRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public Ipv6NetworkParentNetworkRequestData entityRestrictions(Ipv6NetworkParentNetworkEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public Ipv6NetworkParentNetworkEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(Ipv6NetworkParentNetworkEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public Ipv6NetworkParentNetworkRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public Ipv6NetworkParentNetworkRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public Ipv6NetworkParentNetworkRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    Ipv6NetworkParentNetworkRequestData ipv6NetworkParentNetworkRequestData = (Ipv6NetworkParentNetworkRequestData) o;
    return Objects.equals(this.returnEntityAttributes, ipv6NetworkParentNetworkRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, ipv6NetworkParentNetworkRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, ipv6NetworkParentNetworkRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, ipv6NetworkParentNetworkRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class Ipv6NetworkParentNetworkRequestData {\n");
