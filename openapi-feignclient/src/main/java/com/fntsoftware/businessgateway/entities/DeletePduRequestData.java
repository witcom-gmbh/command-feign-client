...
/**
 * DeletePduRequestData
 */
@JsonPropertyOrder({
  DeletePduRequestData.JSON_PROPERTY_RELEASE_SIGNALPATH,
  DeletePduRequestData.JSON_PROPERTY_RELEASE_CONNECTIONS,
  DeletePduRequestData.JSON_PROPERTY_RELEASE_SERVICE,
  DeletePduRequestData.JSON_PROPERTY_CONTEXT_ID,
  DeletePduRequestData.JSON_PROPERTY_RELEASE_PATCHES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-02-26T11:20:24.990023935Z[Etc/UTC]")
public class DeletePduRequestData {
  ...
  public DeletePduRequestData() {
  }

  public DeletePduRequestData releaseSignalpath(Boolean releaseSignalpath) {
  ...
  **/
  ...
  public DeletePduRequestData releaseConnections(Boolean releaseConnections) {
  ...
  **/
  ...
  public DeletePduRequestData releaseService(Boolean releaseService) {
  ...
  **/
  ...
  public DeletePduRequestData contextId(String contextId) {
  ...
  **/
  ...
  public DeletePduRequestData releasePatches(Boolean releasePatches) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    DeletePduRequestData deletePduRequestData = (DeletePduRequestData) o;
    return Objects.equals(this.releaseSignalpath, deletePduRequestData.releaseSignalpath) &&
        Objects.equals(this.releaseConnections, deletePduRequestData.releaseConnections) &&
        Objects.equals(this.releaseService, deletePduRequestData.releaseService) &&
        Objects.equals(this.contextId, deletePduRequestData.contextId) &&
        Objects.equals(this.releasePatches, deletePduRequestData.releasePatches);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeletePduRequestData {\n");
