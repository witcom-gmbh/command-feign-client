...
import com.fntsoftware.businessgateway.entities.PassiveModulePhysicalPortsPowerEntityRestriction;
...
/**
 * PassiveModulePhysicalPortsPowerRequestData
 */
@JsonPropertyOrder({
  PassiveModulePhysicalPortsPowerRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  PassiveModulePhysicalPortsPowerRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  PassiveModulePhysicalPortsPowerRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  PassiveModulePhysicalPortsPowerRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-02-26T11:20:24.990023935Z[Etc/UTC]")
public class PassiveModulePhysicalPortsPowerRequestData {
  ...
  private PassiveModulePhysicalPortsPowerEntityRestriction entityRestrictions;
  ...
  public PassiveModulePhysicalPortsPowerRequestData() {
  }

  public PassiveModulePhysicalPortsPowerRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public PassiveModulePhysicalPortsPowerRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public PassiveModulePhysicalPortsPowerRequestData entityRestrictions(PassiveModulePhysicalPortsPowerEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public PassiveModulePhysicalPortsPowerEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(PassiveModulePhysicalPortsPowerEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public PassiveModulePhysicalPortsPowerRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public PassiveModulePhysicalPortsPowerRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public PassiveModulePhysicalPortsPowerRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    PassiveModulePhysicalPortsPowerRequestData passiveModulePhysicalPortsPowerRequestData = (PassiveModulePhysicalPortsPowerRequestData) o;
    return Objects.equals(this.returnEntityAttributes, passiveModulePhysicalPortsPowerRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, passiveModulePhysicalPortsPowerRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, passiveModulePhysicalPortsPowerRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, passiveModulePhysicalPortsPowerRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class PassiveModulePhysicalPortsPowerRequestData {\n");
