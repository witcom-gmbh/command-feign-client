...
import com.fntsoftware.businessgateway.entities.UserGroupUsersEntityRestriction;
...
/**
 * UserGroupUsersRequestData
 */
@JsonPropertyOrder({
  UserGroupUsersRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  UserGroupUsersRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  UserGroupUsersRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  UserGroupUsersRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-01-31T11:10:37.320689708Z[Etc/UTC]")
public class UserGroupUsersRequestData {
  ...
  private UserGroupUsersEntityRestriction entityRestrictions;
  ...
  public UserGroupUsersRequestData() {
  }

  public UserGroupUsersRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public UserGroupUsersRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public UserGroupUsersRequestData entityRestrictions(UserGroupUsersEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public UserGroupUsersEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(UserGroupUsersEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public UserGroupUsersRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public UserGroupUsersRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public UserGroupUsersRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    UserGroupUsersRequestData userGroupUsersRequestData = (UserGroupUsersRequestData) o;
    return Objects.equals(this.returnEntityAttributes, userGroupUsersRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, userGroupUsersRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, userGroupUsersRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, userGroupUsersRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class UserGroupUsersRequestData {\n");
