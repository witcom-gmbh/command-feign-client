...
import com.fntsoftware.businessgateway.entities.CustomTcoInterconnectVlanPoolEntityRestriction;
...
/**
 * CustomTcoInterconnectVlanPoolRequestData
 */
@JsonPropertyOrder({
  CustomTcoInterconnectVlanPoolRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  CustomTcoInterconnectVlanPoolRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  CustomTcoInterconnectVlanPoolRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  CustomTcoInterconnectVlanPoolRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-02-26T11:20:24.990023935Z[Etc/UTC]")
public class CustomTcoInterconnectVlanPoolRequestData {
  ...
  private CustomTcoInterconnectVlanPoolEntityRestriction entityRestrictions;
  ...
  public CustomTcoInterconnectVlanPoolRequestData() {
  }

  public CustomTcoInterconnectVlanPoolRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public CustomTcoInterconnectVlanPoolRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public CustomTcoInterconnectVlanPoolRequestData entityRestrictions(CustomTcoInterconnectVlanPoolEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public CustomTcoInterconnectVlanPoolEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(CustomTcoInterconnectVlanPoolEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public CustomTcoInterconnectVlanPoolRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public CustomTcoInterconnectVlanPoolRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public CustomTcoInterconnectVlanPoolRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    CustomTcoInterconnectVlanPoolRequestData customTcoInterconnectVlanPoolRequestData = (CustomTcoInterconnectVlanPoolRequestData) o;
    return Objects.equals(this.returnEntityAttributes, customTcoInterconnectVlanPoolRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, customTcoInterconnectVlanPoolRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, customTcoInterconnectVlanPoolRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, customTcoInterconnectVlanPoolRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class CustomTcoInterconnectVlanPoolRequestData {\n");
