...
import com.fntsoftware.businessgateway.entities.DeviceMasterStoragesEntityRestriction;
...
/**
 * DeviceMasterStoragesRequestData
 */
@JsonPropertyOrder({
  DeviceMasterStoragesRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  DeviceMasterStoragesRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  DeviceMasterStoragesRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  DeviceMasterStoragesRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-02-26T11:20:24.990023935Z[Etc/UTC]")
public class DeviceMasterStoragesRequestData {
  ...
  private DeviceMasterStoragesEntityRestriction entityRestrictions;
  ...
  public DeviceMasterStoragesRequestData() {
  }

  public DeviceMasterStoragesRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public DeviceMasterStoragesRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public DeviceMasterStoragesRequestData entityRestrictions(DeviceMasterStoragesEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public DeviceMasterStoragesEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(DeviceMasterStoragesEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public DeviceMasterStoragesRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public DeviceMasterStoragesRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public DeviceMasterStoragesRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    DeviceMasterStoragesRequestData deviceMasterStoragesRequestData = (DeviceMasterStoragesRequestData) o;
    return Objects.equals(this.returnEntityAttributes, deviceMasterStoragesRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, deviceMasterStoragesRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, deviceMasterStoragesRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, deviceMasterStoragesRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeviceMasterStoragesRequestData {\n");
