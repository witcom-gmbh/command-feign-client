...
/**
 * CellRadioUnitEntityRestriction
 */
@JsonPropertyOrder({
  CellRadioUnitEntityRestriction.JSON_PROPERTY_CLIMATE_RELEVANT,
  CellRadioUnitEntityRestriction.JSON_PROPERTY_POWER_CONSUMPTION,
  CellRadioUnitEntityRestriction.JSON_PROPERTY_POWER_SWITCHING_STATUS,
  CellRadioUnitEntityRestriction.JSON_PROPERTY_PLAN_STATUS,
  CellRadioUnitEntityRestriction.JSON_PROPERTY_SYSTEM_RUNTIME,
  CellRadioUnitEntityRestriction.JSON_PROPERTY_WEIGHT,
  CellRadioUnitEntityRestriction.JSON_PROPERTY_REMARK,
  CellRadioUnitEntityRestriction.JSON_PROPERTY_ELID,
  CellRadioUnitEntityRestriction.JSON_PROPERTY_LAST_SEEN,
  CellRadioUnitEntityRestriction.JSON_PROPERTY_TYPE_ELID,
  CellRadioUnitEntityRestriction.JSON_PROPERTY_VISIBLE_ID,
  CellRadioUnitEntityRestriction.JSON_PROPERTY_ID,
  CellRadioUnitEntityRestriction.JSON_PROPERTY_HEAT_EMISSION
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-01-31T11:10:37.320689708Z[Etc/UTC]")
public class CellRadioUnitEntityRestriction {
  ...
  public CellRadioUnitEntityRestriction() {
  }

  public CellRadioUnitEntityRestriction climateRelevant(RestrictionsBoolean climateRelevant) {
  ...
  **/
  ...
  public CellRadioUnitEntityRestriction powerConsumption(RestrictionsNumeric powerConsumption) {
  ...
  **/
  ...
  public CellRadioUnitEntityRestriction powerSwitchingStatus(RestrictionsString powerSwitchingStatus) {
  ...
  **/
  ...
  public CellRadioUnitEntityRestriction planStatus(RestrictionsString planStatus) {
  ...
  **/
  ...
  public CellRadioUnitEntityRestriction systemRuntime(RestrictionsNumeric systemRuntime) {
  ...
  **/
  ...
  public CellRadioUnitEntityRestriction weight(RestrictionsNumeric weight) {
  ...
  **/
  ...
  public CellRadioUnitEntityRestriction remark(RestrictionsString remark) {
  ...
  **/
  ...
  public CellRadioUnitEntityRestriction elid(RestrictionsString elid) {
  ...
  **/
  ...
  public CellRadioUnitEntityRestriction lastSeen(RestrictionsDate lastSeen) {
  ...
  **/
  ...
  public CellRadioUnitEntityRestriction typeElid(RestrictionsString typeElid) {
  ...
  **/
  ...
  public CellRadioUnitEntityRestriction visibleId(RestrictionsString visibleId) {
  ...
  **/
  ...
  public CellRadioUnitEntityRestriction id(RestrictionsString id) {
  ...
  **/
  ...
  public CellRadioUnitEntityRestriction heatEmission(RestrictionsNumeric heatEmission) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    CellRadioUnitEntityRestriction cellRadioUnitEntityRestriction = (CellRadioUnitEntityRestriction) o;
    return Objects.equals(this.climateRelevant, cellRadioUnitEntityRestriction.climateRelevant) &&
        Objects.equals(this.powerConsumption, cellRadioUnitEntityRestriction.powerConsumption) &&
        Objects.equals(this.powerSwitchingStatus, cellRadioUnitEntityRestriction.powerSwitchingStatus) &&
        Objects.equals(this.planStatus, cellRadioUnitEntityRestriction.planStatus) &&
        Objects.equals(this.systemRuntime, cellRadioUnitEntityRestriction.systemRuntime) &&
        Objects.equals(this.weight, cellRadioUnitEntityRestriction.weight) &&
        Objects.equals(this.remark, cellRadioUnitEntityRestriction.remark) &&
        Objects.equals(this.elid, cellRadioUnitEntityRestriction.elid) &&
        Objects.equals(this.lastSeen, cellRadioUnitEntityRestriction.lastSeen) &&
        Objects.equals(this.typeElid, cellRadioUnitEntityRestriction.typeElid) &&
        Objects.equals(this.visibleId, cellRadioUnitEntityRestriction.visibleId) &&
        Objects.equals(this.id, cellRadioUnitEntityRestriction.id) &&
        Objects.equals(this.heatEmission, cellRadioUnitEntityRestriction.heatEmission);
  }
  ...
  public String toString() {
    ...
    sb.append("class CellRadioUnitEntityRestriction {\n");
