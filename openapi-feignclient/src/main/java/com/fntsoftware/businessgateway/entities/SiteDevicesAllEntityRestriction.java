...
/**
 * SiteDevicesAllEntityRestriction
 */
@JsonPropertyOrder({
  SiteDevicesAllEntityRestriction.JSON_PROPERTY_CLIMATE_RELEVANT,
  SiteDevicesAllEntityRestriction.JSON_PROPERTY_POWER_CONSUMPTION,
  SiteDevicesAllEntityRestriction.JSON_PROPERTY_POWER_SWITCHING_STATUS,
  SiteDevicesAllEntityRestriction.JSON_PROPERTY_PLAN_STATUS,
  SiteDevicesAllEntityRestriction.JSON_PROPERTY_SYSTEM_RUNTIME,
  SiteDevicesAllEntityRestriction.JSON_PROPERTY_WEIGHT,
  SiteDevicesAllEntityRestriction.JSON_PROPERTY_REMARK,
  SiteDevicesAllEntityRestriction.JSON_PROPERTY_ELID,
  SiteDevicesAllEntityRestriction.JSON_PROPERTY_LAST_SEEN,
  SiteDevicesAllEntityRestriction.JSON_PROPERTY_TYPE_ELID,
  SiteDevicesAllEntityRestriction.JSON_PROPERTY_VISIBLE_ID,
  SiteDevicesAllEntityRestriction.JSON_PROPERTY_ID,
  SiteDevicesAllEntityRestriction.JSON_PROPERTY_HEAT_EMISSION
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-01-31T11:10:37.320689708Z[Etc/UTC]")
public class SiteDevicesAllEntityRestriction {
  ...
  public SiteDevicesAllEntityRestriction() {
  }

  public SiteDevicesAllEntityRestriction climateRelevant(RestrictionsBoolean climateRelevant) {
  ...
  **/
  ...
  public SiteDevicesAllEntityRestriction powerConsumption(RestrictionsNumeric powerConsumption) {
  ...
  **/
  ...
  public SiteDevicesAllEntityRestriction powerSwitchingStatus(RestrictionsString powerSwitchingStatus) {
  ...
  **/
  ...
  public SiteDevicesAllEntityRestriction planStatus(RestrictionsString planStatus) {
  ...
  **/
  ...
  public SiteDevicesAllEntityRestriction systemRuntime(RestrictionsNumeric systemRuntime) {
  ...
  **/
  ...
  public SiteDevicesAllEntityRestriction weight(RestrictionsNumeric weight) {
  ...
  **/
  ...
  public SiteDevicesAllEntityRestriction remark(RestrictionsString remark) {
  ...
  **/
  ...
  public SiteDevicesAllEntityRestriction elid(RestrictionsString elid) {
  ...
  **/
  ...
  public SiteDevicesAllEntityRestriction lastSeen(RestrictionsDate lastSeen) {
  ...
  **/
  ...
  public SiteDevicesAllEntityRestriction typeElid(RestrictionsString typeElid) {
  ...
  **/
  ...
  public SiteDevicesAllEntityRestriction visibleId(RestrictionsString visibleId) {
  ...
  **/
  ...
  public SiteDevicesAllEntityRestriction id(RestrictionsString id) {
  ...
  **/
  ...
  public SiteDevicesAllEntityRestriction heatEmission(RestrictionsNumeric heatEmission) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    SiteDevicesAllEntityRestriction siteDevicesAllEntityRestriction = (SiteDevicesAllEntityRestriction) o;
    return Objects.equals(this.climateRelevant, siteDevicesAllEntityRestriction.climateRelevant) &&
        Objects.equals(this.powerConsumption, siteDevicesAllEntityRestriction.powerConsumption) &&
        Objects.equals(this.powerSwitchingStatus, siteDevicesAllEntityRestriction.powerSwitchingStatus) &&
        Objects.equals(this.planStatus, siteDevicesAllEntityRestriction.planStatus) &&
        Objects.equals(this.systemRuntime, siteDevicesAllEntityRestriction.systemRuntime) &&
        Objects.equals(this.weight, siteDevicesAllEntityRestriction.weight) &&
        Objects.equals(this.remark, siteDevicesAllEntityRestriction.remark) &&
        Objects.equals(this.elid, siteDevicesAllEntityRestriction.elid) &&
        Objects.equals(this.lastSeen, siteDevicesAllEntityRestriction.lastSeen) &&
        Objects.equals(this.typeElid, siteDevicesAllEntityRestriction.typeElid) &&
        Objects.equals(this.visibleId, siteDevicesAllEntityRestriction.visibleId) &&
        Objects.equals(this.id, siteDevicesAllEntityRestriction.id) &&
        Objects.equals(this.heatEmission, siteDevicesAllEntityRestriction.heatEmission);
  }
  ...
  public String toString() {
    ...
    sb.append("class SiteDevicesAllEntityRestriction {\n");
