...
import com.fntsoftware.businessgateway.entities.JunctionBoxFistNodeEntityRestriction;
...
/**
 * JunctionBoxFistNodeRequestData
 */
@JsonPropertyOrder({
  JunctionBoxFistNodeRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  JunctionBoxFistNodeRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  JunctionBoxFistNodeRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  JunctionBoxFistNodeRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-03-04T13:31:32.601557352Z[Etc/UTC]")
public class JunctionBoxFistNodeRequestData {
  ...
  private JunctionBoxFistNodeEntityRestriction entityRestrictions;
  ...
  public JunctionBoxFistNodeRequestData() {
  }

  public JunctionBoxFistNodeRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public JunctionBoxFistNodeRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public JunctionBoxFistNodeRequestData entityRestrictions(JunctionBoxFistNodeEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public JunctionBoxFistNodeEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(JunctionBoxFistNodeEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public JunctionBoxFistNodeRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public JunctionBoxFistNodeRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public JunctionBoxFistNodeRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    JunctionBoxFistNodeRequestData junctionBoxFistNodeRequestData = (JunctionBoxFistNodeRequestData) o;
    return Objects.equals(this.returnEntityAttributes, junctionBoxFistNodeRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, junctionBoxFistNodeRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, junctionBoxFistNodeRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, junctionBoxFistNodeRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class JunctionBoxFistNodeRequestData {\n");
