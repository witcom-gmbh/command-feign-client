...
import com.fntsoftware.businessgateway.entities.NmModuleZoneEntityRestriction;
...
/**
 * NmModuleZoneRequestData
 */
@JsonPropertyOrder({
  NmModuleZoneRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  NmModuleZoneRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  NmModuleZoneRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  NmModuleZoneRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-03-04T13:31:32.601557352Z[Etc/UTC]")
public class NmModuleZoneRequestData {
  ...
  private NmModuleZoneEntityRestriction entityRestrictions;
  ...
  public NmModuleZoneRequestData() {
  }

  public NmModuleZoneRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public NmModuleZoneRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public NmModuleZoneRequestData entityRestrictions(NmModuleZoneEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public NmModuleZoneEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(NmModuleZoneEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public NmModuleZoneRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public NmModuleZoneRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public NmModuleZoneRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    NmModuleZoneRequestData nmModuleZoneRequestData = (NmModuleZoneRequestData) o;
    return Objects.equals(this.returnEntityAttributes, nmModuleZoneRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, nmModuleZoneRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, nmModuleZoneRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, nmModuleZoneRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class NmModuleZoneRequestData {\n");
