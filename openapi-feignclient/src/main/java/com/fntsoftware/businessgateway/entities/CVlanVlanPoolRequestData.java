...
import com.fntsoftware.businessgateway.entities.CVlanVlanPoolEntityRestriction;
...
/**
 * CVlanVlanPoolRequestData
 */
@JsonPropertyOrder({
  CVlanVlanPoolRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  CVlanVlanPoolRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  CVlanVlanPoolRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  CVlanVlanPoolRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-02-26T11:20:24.990023935Z[Etc/UTC]")
public class CVlanVlanPoolRequestData {
  ...
  private CVlanVlanPoolEntityRestriction entityRestrictions;
  ...
  public CVlanVlanPoolRequestData() {
  }

  public CVlanVlanPoolRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public CVlanVlanPoolRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public CVlanVlanPoolRequestData entityRestrictions(CVlanVlanPoolEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public CVlanVlanPoolEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(CVlanVlanPoolEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public CVlanVlanPoolRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public CVlanVlanPoolRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public CVlanVlanPoolRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    CVlanVlanPoolRequestData cvlanVlanPoolRequestData = (CVlanVlanPoolRequestData) o;
    return Objects.equals(this.returnEntityAttributes, cvlanVlanPoolRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, cvlanVlanPoolRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, cvlanVlanPoolRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, cvlanVlanPoolRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class CVlanVlanPoolRequestData {\n");
