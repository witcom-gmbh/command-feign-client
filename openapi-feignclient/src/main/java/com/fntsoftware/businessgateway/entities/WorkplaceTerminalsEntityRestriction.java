...
/**
 * WorkplaceTerminalsEntityRestriction
 */
@JsonPropertyOrder({
  WorkplaceTerminalsEntityRestriction.JSON_PROPERTY_CLIMATE_RELEVANT,
  WorkplaceTerminalsEntityRestriction.JSON_PROPERTY_POWER_CONSUMPTION,
  WorkplaceTerminalsEntityRestriction.JSON_PROPERTY_WARRANTY_UNTIL,
  WorkplaceTerminalsEntityRestriction.JSON_PROPERTY_POWER_SWITCHING_STATUS,
  WorkplaceTerminalsEntityRestriction.JSON_PROPERTY_IP_ADDRESS,
  WorkplaceTerminalsEntityRestriction.JSON_PROPERTY_HOST_ID,
  WorkplaceTerminalsEntityRestriction.JSON_PROPERTY_SYSTEM_RUNTIME,
  WorkplaceTerminalsEntityRestriction.JSON_PROPERTY_WEIGHT,
  WorkplaceTerminalsEntityRestriction.JSON_PROPERTY_REMARK,
  WorkplaceTerminalsEntityRestriction.JSON_PROPERTY_SUPPLY_DATE,
  WorkplaceTerminalsEntityRestriction.JSON_PROPERTY_ELID,
  WorkplaceTerminalsEntityRestriction.JSON_PROPERTY_SERIAL_NO,
  WorkplaceTerminalsEntityRestriction.JSON_PROPERTY_C_INVENTORY_NO,
  WorkplaceTerminalsEntityRestriction.JSON_PROPERTY_MAC_ADDRESS,
  WorkplaceTerminalsEntityRestriction.JSON_PROPERTY_LAST_SEEN,
  WorkplaceTerminalsEntityRestriction.JSON_PROPERTY_TYPE_ELID,
  WorkplaceTerminalsEntityRestriction.JSON_PROPERTY_SERVICE,
  WorkplaceTerminalsEntityRestriction.JSON_PROPERTY_SERVICE_END,
  WorkplaceTerminalsEntityRestriction.JSON_PROPERTY_SUPPLIER,
  WorkplaceTerminalsEntityRestriction.JSON_PROPERTY_VISIBLE_ID,
  WorkplaceTerminalsEntityRestriction.JSON_PROPERTY_ID,
  WorkplaceTerminalsEntityRestriction.JSON_PROPERTY_HEAT_EMISSION,
  WorkplaceTerminalsEntityRestriction.JSON_PROPERTY_SERVICE_AGENCY
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-02-26T11:20:24.990023935Z[Etc/UTC]")
public class WorkplaceTerminalsEntityRestriction {
  ...
  public WorkplaceTerminalsEntityRestriction() {
  }

  public WorkplaceTerminalsEntityRestriction climateRelevant(RestrictionsBoolean climateRelevant) {
  ...
  **/
  ...
  public WorkplaceTerminalsEntityRestriction powerConsumption(RestrictionsNumeric powerConsumption) {
  ...
  **/
  ...
  public WorkplaceTerminalsEntityRestriction warrantyUntil(RestrictionsDate warrantyUntil) {
  ...
  **/
  ...
  public WorkplaceTerminalsEntityRestriction powerSwitchingStatus(RestrictionsString powerSwitchingStatus) {
  ...
  **/
  ...
  public WorkplaceTerminalsEntityRestriction ipAddress(RestrictionsString ipAddress) {
  ...
  **/
  ...
  public WorkplaceTerminalsEntityRestriction hostId(RestrictionsString hostId) {
  ...
  **/
  ...
  public WorkplaceTerminalsEntityRestriction systemRuntime(RestrictionsNumeric systemRuntime) {
  ...
  **/
  ...
  public WorkplaceTerminalsEntityRestriction weight(RestrictionsNumeric weight) {
  ...
  **/
  ...
  public WorkplaceTerminalsEntityRestriction remark(RestrictionsString remark) {
  ...
  **/
  ...
  public WorkplaceTerminalsEntityRestriction supplyDate(RestrictionsDate supplyDate) {
  ...
  **/
  ...
  public WorkplaceTerminalsEntityRestriction elid(RestrictionsString elid) {
  ...
  **/
  ...
  public WorkplaceTerminalsEntityRestriction serialNo(RestrictionsString serialNo) {
  ...
  **/
  ...
  public WorkplaceTerminalsEntityRestriction cInventoryNo(RestrictionsString cInventoryNo) {
  ...
  **/
  ...
  public WorkplaceTerminalsEntityRestriction macAddress(RestrictionsString macAddress) {
  ...
  **/
  ...
  public WorkplaceTerminalsEntityRestriction lastSeen(RestrictionsDate lastSeen) {
  ...
  **/
  ...
  public WorkplaceTerminalsEntityRestriction typeElid(RestrictionsString typeElid) {
  ...
  **/
  ...
  public WorkplaceTerminalsEntityRestriction service(RestrictionsBoolean service) {
  ...
  **/
  ...
  public WorkplaceTerminalsEntityRestriction serviceEnd(RestrictionsDate serviceEnd) {
  ...
  **/
  ...
  public WorkplaceTerminalsEntityRestriction supplier(RestrictionsString supplier) {
  ...
  **/
  ...
  public WorkplaceTerminalsEntityRestriction visibleId(RestrictionsString visibleId) {
  ...
  **/
  ...
  public WorkplaceTerminalsEntityRestriction id(RestrictionsString id) {
  ...
  **/
  ...
  public WorkplaceTerminalsEntityRestriction heatEmission(RestrictionsNumeric heatEmission) {
  ...
  **/
  ...
  public WorkplaceTerminalsEntityRestriction serviceAgency(RestrictionsString serviceAgency) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    WorkplaceTerminalsEntityRestriction workplaceTerminalsEntityRestriction = (WorkplaceTerminalsEntityRestriction) o;
    return Objects.equals(this.climateRelevant, workplaceTerminalsEntityRestriction.climateRelevant) &&
        Objects.equals(this.powerConsumption, workplaceTerminalsEntityRestriction.powerConsumption) &&
        Objects.equals(this.warrantyUntil, workplaceTerminalsEntityRestriction.warrantyUntil) &&
        Objects.equals(this.powerSwitchingStatus, workplaceTerminalsEntityRestriction.powerSwitchingStatus) &&
        Objects.equals(this.ipAddress, workplaceTerminalsEntityRestriction.ipAddress) &&
        Objects.equals(this.hostId, workplaceTerminalsEntityRestriction.hostId) &&
        Objects.equals(this.systemRuntime, workplaceTerminalsEntityRestriction.systemRuntime) &&
        Objects.equals(this.weight, workplaceTerminalsEntityRestriction.weight) &&
        Objects.equals(this.remark, workplaceTerminalsEntityRestriction.remark) &&
        Objects.equals(this.supplyDate, workplaceTerminalsEntityRestriction.supplyDate) &&
        Objects.equals(this.elid, workplaceTerminalsEntityRestriction.elid) &&
        Objects.equals(this.serialNo, workplaceTerminalsEntityRestriction.serialNo) &&
        Objects.equals(this.cInventoryNo, workplaceTerminalsEntityRestriction.cInventoryNo) &&
        Objects.equals(this.macAddress, workplaceTerminalsEntityRestriction.macAddress) &&
        Objects.equals(this.lastSeen, workplaceTerminalsEntityRestriction.lastSeen) &&
        Objects.equals(this.typeElid, workplaceTerminalsEntityRestriction.typeElid) &&
        Objects.equals(this.service, workplaceTerminalsEntityRestriction.service) &&
        Objects.equals(this.serviceEnd, workplaceTerminalsEntityRestriction.serviceEnd) &&
        Objects.equals(this.supplier, workplaceTerminalsEntityRestriction.supplier) &&
        Objects.equals(this.visibleId, workplaceTerminalsEntityRestriction.visibleId) &&
        Objects.equals(this.id, workplaceTerminalsEntityRestriction.id) &&
        Objects.equals(this.heatEmission, workplaceTerminalsEntityRestriction.heatEmission) &&
        Objects.equals(this.serviceAgency, workplaceTerminalsEntityRestriction.serviceAgency);
  }
  ...
  public String toString() {
    ...
    sb.append("class WorkplaceTerminalsEntityRestriction {\n");
