...
/**
 * UpdateSystemAttributesHardDiskAddUserRequestData
 */
@JsonPropertyOrder({
  UpdateSystemAttributesHardDiskAddUserRequestData.JSON_PROPERTY_MODIFY_PLAN,
  UpdateSystemAttributesHardDiskAddUserRequestData.JSON_PROPERTY_DELETE_REAL,
  UpdateSystemAttributesHardDiskAddUserRequestData.JSON_PROPERTY_READ_PLAN,
  UpdateSystemAttributesHardDiskAddUserRequestData.JSON_PROPERTY_MANDANT_ID,
  UpdateSystemAttributesHardDiskAddUserRequestData.JSON_PROPERTY_USER_ELID,
  UpdateSystemAttributesHardDiskAddUserRequestData.JSON_PROPERTY_MODIFY_REAL,
  UpdateSystemAttributesHardDiskAddUserRequestData.JSON_PROPERTY_READ_REAL,
  UpdateSystemAttributesHardDiskAddUserRequestData.JSON_PROPERTY_DELETE_PLAN
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-02-26T11:20:24.990023935Z[Etc/UTC]")
public class UpdateSystemAttributesHardDiskAddUserRequestData {
  ...
  public UpdateSystemAttributesHardDiskAddUserRequestData() {
  }

  public UpdateSystemAttributesHardDiskAddUserRequestData modifyPlan(Boolean modifyPlan) {
  ...
  **/
  ...
  public UpdateSystemAttributesHardDiskAddUserRequestData deleteReal(Boolean deleteReal) {
  ...
  **/
  ...
  public UpdateSystemAttributesHardDiskAddUserRequestData readPlan(Boolean readPlan) {
  ...
  **/
  ...
  public UpdateSystemAttributesHardDiskAddUserRequestData mandantId(BigDecimal mandantId) {
  ...
  **/
  ...
  public UpdateSystemAttributesHardDiskAddUserRequestData userElid(String userElid) {
  ...
  **/
  ...
  public UpdateSystemAttributesHardDiskAddUserRequestData modifyReal(Boolean modifyReal) {
  ...
  **/
  ...
  public UpdateSystemAttributesHardDiskAddUserRequestData readReal(Boolean readReal) {
  ...
  **/
  ...
  public UpdateSystemAttributesHardDiskAddUserRequestData deletePlan(Boolean deletePlan) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    UpdateSystemAttributesHardDiskAddUserRequestData updateSystemAttributesHardDiskAddUserRequestData = (UpdateSystemAttributesHardDiskAddUserRequestData) o;
    return Objects.equals(this.modifyPlan, updateSystemAttributesHardDiskAddUserRequestData.modifyPlan) &&
        Objects.equals(this.deleteReal, updateSystemAttributesHardDiskAddUserRequestData.deleteReal) &&
        Objects.equals(this.readPlan, updateSystemAttributesHardDiskAddUserRequestData.readPlan) &&
        Objects.equals(this.mandantId, updateSystemAttributesHardDiskAddUserRequestData.mandantId) &&
        Objects.equals(this.userElid, updateSystemAttributesHardDiskAddUserRequestData.userElid) &&
        Objects.equals(this.modifyReal, updateSystemAttributesHardDiskAddUserRequestData.modifyReal) &&
        Objects.equals(this.readReal, updateSystemAttributesHardDiskAddUserRequestData.readReal) &&
        Objects.equals(this.deletePlan, updateSystemAttributesHardDiskAddUserRequestData.deletePlan);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateSystemAttributesHardDiskAddUserRequestData {\n");
