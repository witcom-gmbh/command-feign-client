...
import com.fntsoftware.businessgateway.entities.StorageSitesEntityRestriction;
import com.fntsoftware.businessgateway.entities.StorageSitesRelationRestriction;
...
/**
 * StorageSitesRequestData
 */
@JsonPropertyOrder({
  StorageSitesRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  StorageSitesRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  StorageSitesRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  StorageSitesRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-03-04T13:31:32.601557352Z[Etc/UTC]")
public class StorageSitesRequestData {
  ...
  private StorageSitesEntityRestriction entityRestrictions;

  public static final String JSON_PROPERTY_RELATION_RESTRICTIONS = "relationRestrictions";
  private StorageSitesRelationRestriction relationRestrictions;
  ...
  public StorageSitesRequestData() {
  }

  public StorageSitesRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public StorageSitesRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public StorageSitesRequestData entityRestrictions(StorageSitesEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public StorageSitesEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(StorageSitesEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public StorageSitesRequestData relationRestrictions(StorageSitesRelationRestriction relationRestrictions) {
  ...
  **/
  ...
  public StorageSitesRelationRestriction getRelationRestrictions() {
    return relationRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_RELATION_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRelationRestrictions(StorageSitesRelationRestriction relationRestrictions) {
    this.relationRestrictions = relationRestrictions;
  }


  public StorageSitesRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public StorageSitesRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    StorageSitesRequestData storageSitesRequestData = (StorageSitesRequestData) o;
    return Objects.equals(this.returnEntityAttributes, storageSitesRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, storageSitesRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, storageSitesRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, storageSitesRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class StorageSitesRequestData {\n");
