...
/**
 * UpdateSystemAttributesDuctAddUserRequestData
 */
@JsonPropertyOrder({
  UpdateSystemAttributesDuctAddUserRequestData.JSON_PROPERTY_MODIFY_PLAN,
  UpdateSystemAttributesDuctAddUserRequestData.JSON_PROPERTY_DELETE_REAL,
  UpdateSystemAttributesDuctAddUserRequestData.JSON_PROPERTY_READ_PLAN,
  UpdateSystemAttributesDuctAddUserRequestData.JSON_PROPERTY_MANDANT_ID,
  UpdateSystemAttributesDuctAddUserRequestData.JSON_PROPERTY_USER_ELID,
  UpdateSystemAttributesDuctAddUserRequestData.JSON_PROPERTY_MODIFY_REAL,
  UpdateSystemAttributesDuctAddUserRequestData.JSON_PROPERTY_READ_REAL,
  UpdateSystemAttributesDuctAddUserRequestData.JSON_PROPERTY_DELETE_PLAN
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-01-31T11:10:37.320689708Z[Etc/UTC]")
public class UpdateSystemAttributesDuctAddUserRequestData {
  ...
  public UpdateSystemAttributesDuctAddUserRequestData() {
  }

  public UpdateSystemAttributesDuctAddUserRequestData modifyPlan(Boolean modifyPlan) {
  ...
  **/
  ...
  public UpdateSystemAttributesDuctAddUserRequestData deleteReal(Boolean deleteReal) {
  ...
  **/
  ...
  public UpdateSystemAttributesDuctAddUserRequestData readPlan(Boolean readPlan) {
  ...
  **/
  ...
  public UpdateSystemAttributesDuctAddUserRequestData mandantId(BigDecimal mandantId) {
  ...
  **/
  ...
  public UpdateSystemAttributesDuctAddUserRequestData userElid(String userElid) {
  ...
  **/
  ...
  public UpdateSystemAttributesDuctAddUserRequestData modifyReal(Boolean modifyReal) {
  ...
  **/
  ...
  public UpdateSystemAttributesDuctAddUserRequestData readReal(Boolean readReal) {
  ...
  **/
  ...
  public UpdateSystemAttributesDuctAddUserRequestData deletePlan(Boolean deletePlan) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    UpdateSystemAttributesDuctAddUserRequestData updateSystemAttributesDuctAddUserRequestData = (UpdateSystemAttributesDuctAddUserRequestData) o;
    return Objects.equals(this.modifyPlan, updateSystemAttributesDuctAddUserRequestData.modifyPlan) &&
        Objects.equals(this.deleteReal, updateSystemAttributesDuctAddUserRequestData.deleteReal) &&
        Objects.equals(this.readPlan, updateSystemAttributesDuctAddUserRequestData.readPlan) &&
        Objects.equals(this.mandantId, updateSystemAttributesDuctAddUserRequestData.mandantId) &&
        Objects.equals(this.userElid, updateSystemAttributesDuctAddUserRequestData.userElid) &&
        Objects.equals(this.modifyReal, updateSystemAttributesDuctAddUserRequestData.modifyReal) &&
        Objects.equals(this.readReal, updateSystemAttributesDuctAddUserRequestData.readReal) &&
        Objects.equals(this.deletePlan, updateSystemAttributesDuctAddUserRequestData.deletePlan);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateSystemAttributesDuctAddUserRequestData {\n");
