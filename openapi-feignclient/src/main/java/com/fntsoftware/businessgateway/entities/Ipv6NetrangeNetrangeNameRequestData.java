...
import com.fntsoftware.businessgateway.entities.Ipv6NetrangeNetrangeNameEntityRestriction;
...
/**
 * Ipv6NetrangeNetrangeNameRequestData
 */
@JsonPropertyOrder({
  Ipv6NetrangeNetrangeNameRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  Ipv6NetrangeNetrangeNameRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  Ipv6NetrangeNetrangeNameRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  Ipv6NetrangeNetrangeNameRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-02-26T11:20:24.990023935Z[Etc/UTC]")
public class Ipv6NetrangeNetrangeNameRequestData {
  ...
  private Ipv6NetrangeNetrangeNameEntityRestriction entityRestrictions;
  ...
  public Ipv6NetrangeNetrangeNameRequestData() {
  }

  public Ipv6NetrangeNetrangeNameRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public Ipv6NetrangeNetrangeNameRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public Ipv6NetrangeNetrangeNameRequestData entityRestrictions(Ipv6NetrangeNetrangeNameEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public Ipv6NetrangeNetrangeNameEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(Ipv6NetrangeNetrangeNameEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public Ipv6NetrangeNetrangeNameRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public Ipv6NetrangeNetrangeNameRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public Ipv6NetrangeNetrangeNameRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    Ipv6NetrangeNetrangeNameRequestData ipv6NetrangeNetrangeNameRequestData = (Ipv6NetrangeNetrangeNameRequestData) o;
    return Objects.equals(this.returnEntityAttributes, ipv6NetrangeNetrangeNameRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, ipv6NetrangeNetrangeNameRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, ipv6NetrangeNetrangeNameRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, ipv6NetrangeNetrangeNameRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class Ipv6NetrangeNetrangeNameRequestData {\n");
