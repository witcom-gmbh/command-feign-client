...
import com.fntsoftware.businessgateway.entities.CustomKeyCustomKeyParentEntityRestriction;
...
/**
 * CustomKeyCustomKeyParentRequestData
 */
@JsonPropertyOrder({
  CustomKeyCustomKeyParentRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  CustomKeyCustomKeyParentRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  CustomKeyCustomKeyParentRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  CustomKeyCustomKeyParentRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-03-04T13:31:32.601557352Z[Etc/UTC]")
public class CustomKeyCustomKeyParentRequestData {
  ...
  private CustomKeyCustomKeyParentEntityRestriction entityRestrictions;
  ...
  public CustomKeyCustomKeyParentRequestData() {
  }

  public CustomKeyCustomKeyParentRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public CustomKeyCustomKeyParentRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public CustomKeyCustomKeyParentRequestData entityRestrictions(CustomKeyCustomKeyParentEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public CustomKeyCustomKeyParentEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(CustomKeyCustomKeyParentEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public CustomKeyCustomKeyParentRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public CustomKeyCustomKeyParentRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public CustomKeyCustomKeyParentRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    CustomKeyCustomKeyParentRequestData customKeyCustomKeyParentRequestData = (CustomKeyCustomKeyParentRequestData) o;
    return Objects.equals(this.returnEntityAttributes, customKeyCustomKeyParentRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, customKeyCustomKeyParentRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, customKeyCustomKeyParentRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, customKeyCustomKeyParentRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class CustomKeyCustomKeyParentRequestData {\n");
