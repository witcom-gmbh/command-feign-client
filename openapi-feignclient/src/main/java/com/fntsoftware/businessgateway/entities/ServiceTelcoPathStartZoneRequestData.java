...
import com.fntsoftware.businessgateway.entities.ServiceTelcoPathStartZoneEntityRestriction;
...
/**
 * ServiceTelcoPathStartZoneRequestData
 */
@JsonPropertyOrder({
  ServiceTelcoPathStartZoneRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  ServiceTelcoPathStartZoneRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  ServiceTelcoPathStartZoneRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  ServiceTelcoPathStartZoneRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-01-31T11:10:37.320689708Z[Etc/UTC]")
public class ServiceTelcoPathStartZoneRequestData {
  ...
  private ServiceTelcoPathStartZoneEntityRestriction entityRestrictions;
  ...
  public ServiceTelcoPathStartZoneRequestData() {
  }

  public ServiceTelcoPathStartZoneRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public ServiceTelcoPathStartZoneRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public ServiceTelcoPathStartZoneRequestData entityRestrictions(ServiceTelcoPathStartZoneEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public ServiceTelcoPathStartZoneEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(ServiceTelcoPathStartZoneEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public ServiceTelcoPathStartZoneRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public ServiceTelcoPathStartZoneRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public ServiceTelcoPathStartZoneRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ServiceTelcoPathStartZoneRequestData serviceTelcoPathStartZoneRequestData = (ServiceTelcoPathStartZoneRequestData) o;
    return Objects.equals(this.returnEntityAttributes, serviceTelcoPathStartZoneRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, serviceTelcoPathStartZoneRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, serviceTelcoPathStartZoneRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, serviceTelcoPathStartZoneRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class ServiceTelcoPathStartZoneRequestData {\n");
