 ...
 */
@JsonPropertyOrder({
  DeletePersonResponse.JSON_PROPERTY_STATUS
})
...
public class DeletePersonResponse {
  ...
  public DeletePersonResponse status(ServiceStatusData status) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    DeletePersonResponse deletePersonResponse = (DeletePersonResponse) o;
    return Objects.equals(this.status, deletePersonResponse.status);
  }
