...
/**
 * DataSocketSlotEntityRestriction
 */
@JsonPropertyOrder({
  DataSocketSlotEntityRestriction.JSON_PROPERTY_CLIMATE_RELEVANT,
  DataSocketSlotEntityRestriction.JSON_PROPERTY_POWER_CONSUMPTION,
  DataSocketSlotEntityRestriction.JSON_PROPERTY_POWER_SWITCHING_STATUS,
  DataSocketSlotEntityRestriction.JSON_PROPERTY_PLAN_STATUS,
  DataSocketSlotEntityRestriction.JSON_PROPERTY_SYSTEM_RUNTIME,
  DataSocketSlotEntityRestriction.JSON_PROPERTY_WEIGHT,
  DataSocketSlotEntityRestriction.JSON_PROPERTY_REMARK,
  DataSocketSlotEntityRestriction.JSON_PROPERTY_ELID,
  DataSocketSlotEntityRestriction.JSON_PROPERTY_LAST_SEEN,
  DataSocketSlotEntityRestriction.JSON_PROPERTY_TYPE_ELID,
  DataSocketSlotEntityRestriction.JSON_PROPERTY_VISIBLE_ID,
  DataSocketSlotEntityRestriction.JSON_PROPERTY_ID,
  DataSocketSlotEntityRestriction.JSON_PROPERTY_HEAT_EMISSION
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-03-04T13:31:32.601557352Z[Etc/UTC]")
public class DataSocketSlotEntityRestriction {
  ...
  public DataSocketSlotEntityRestriction() {
  }

  public DataSocketSlotEntityRestriction climateRelevant(RestrictionsBoolean climateRelevant) {
  ...
  **/
  ...
  public DataSocketSlotEntityRestriction powerConsumption(RestrictionsNumeric powerConsumption) {
  ...
  **/
  ...
  public DataSocketSlotEntityRestriction powerSwitchingStatus(RestrictionsString powerSwitchingStatus) {
  ...
  **/
  ...
  public DataSocketSlotEntityRestriction planStatus(RestrictionsString planStatus) {
  ...
  **/
  ...
  public DataSocketSlotEntityRestriction systemRuntime(RestrictionsNumeric systemRuntime) {
  ...
  **/
  ...
  public DataSocketSlotEntityRestriction weight(RestrictionsNumeric weight) {
  ...
  **/
  ...
  public DataSocketSlotEntityRestriction remark(RestrictionsString remark) {
  ...
  **/
  ...
  public DataSocketSlotEntityRestriction elid(RestrictionsString elid) {
  ...
  **/
  ...
  public DataSocketSlotEntityRestriction lastSeen(RestrictionsDate lastSeen) {
  ...
  **/
  ...
  public DataSocketSlotEntityRestriction typeElid(RestrictionsString typeElid) {
  ...
  **/
  ...
  public DataSocketSlotEntityRestriction visibleId(RestrictionsString visibleId) {
  ...
  **/
  ...
  public DataSocketSlotEntityRestriction id(RestrictionsString id) {
  ...
  **/
  ...
  public DataSocketSlotEntityRestriction heatEmission(RestrictionsNumeric heatEmission) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    DataSocketSlotEntityRestriction dataSocketSlotEntityRestriction = (DataSocketSlotEntityRestriction) o;
    return Objects.equals(this.climateRelevant, dataSocketSlotEntityRestriction.climateRelevant) &&
        Objects.equals(this.powerConsumption, dataSocketSlotEntityRestriction.powerConsumption) &&
        Objects.equals(this.powerSwitchingStatus, dataSocketSlotEntityRestriction.powerSwitchingStatus) &&
        Objects.equals(this.planStatus, dataSocketSlotEntityRestriction.planStatus) &&
        Objects.equals(this.systemRuntime, dataSocketSlotEntityRestriction.systemRuntime) &&
        Objects.equals(this.weight, dataSocketSlotEntityRestriction.weight) &&
        Objects.equals(this.remark, dataSocketSlotEntityRestriction.remark) &&
        Objects.equals(this.elid, dataSocketSlotEntityRestriction.elid) &&
        Objects.equals(this.lastSeen, dataSocketSlotEntityRestriction.lastSeen) &&
        Objects.equals(this.typeElid, dataSocketSlotEntityRestriction.typeElid) &&
        Objects.equals(this.visibleId, dataSocketSlotEntityRestriction.visibleId) &&
        Objects.equals(this.id, dataSocketSlotEntityRestriction.id) &&
        Objects.equals(this.heatEmission, dataSocketSlotEntityRestriction.heatEmission);
  }
  ...
  public String toString() {
    ...
    sb.append("class DataSocketSlotEntityRestriction {\n");
