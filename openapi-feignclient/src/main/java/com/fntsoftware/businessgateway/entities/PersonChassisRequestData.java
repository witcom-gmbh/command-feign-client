...
import com.fntsoftware.businessgateway.entities.PersonChassisEntityRestriction;
import com.fntsoftware.businessgateway.entities.PersonChassisRelationRestriction;
...
/**
 * PersonChassisRequestData
 */
@JsonPropertyOrder({
  PersonChassisRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  PersonChassisRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  PersonChassisRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  PersonChassisRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-03-04T13:31:32.601557352Z[Etc/UTC]")
public class PersonChassisRequestData {
  ...
  private PersonChassisEntityRestriction entityRestrictions;

  public static final String JSON_PROPERTY_RELATION_RESTRICTIONS = "relationRestrictions";
  private PersonChassisRelationRestriction relationRestrictions;
  ...
  public PersonChassisRequestData() {
  }

  public PersonChassisRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public PersonChassisRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public PersonChassisRequestData entityRestrictions(PersonChassisEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public PersonChassisEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(PersonChassisEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public PersonChassisRequestData relationRestrictions(PersonChassisRelationRestriction relationRestrictions) {
  ...
  **/
  ...
  public PersonChassisRelationRestriction getRelationRestrictions() {
    return relationRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_RELATION_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRelationRestrictions(PersonChassisRelationRestriction relationRestrictions) {
    this.relationRestrictions = relationRestrictions;
  }


  public PersonChassisRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public PersonChassisRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    PersonChassisRequestData personChassisRequestData = (PersonChassisRequestData) o;
    return Objects.equals(this.returnEntityAttributes, personChassisRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, personChassisRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, personChassisRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, personChassisRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class PersonChassisRequestData {\n");
