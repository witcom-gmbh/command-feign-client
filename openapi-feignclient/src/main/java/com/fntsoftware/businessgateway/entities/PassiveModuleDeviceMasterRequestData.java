...
import com.fntsoftware.businessgateway.entities.PassiveModuleDeviceMasterEntityRestriction;
...
/**
 * PassiveModuleDeviceMasterRequestData
 */
@JsonPropertyOrder({
  PassiveModuleDeviceMasterRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  PassiveModuleDeviceMasterRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  PassiveModuleDeviceMasterRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  PassiveModuleDeviceMasterRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-03-04T13:31:32.601557352Z[Etc/UTC]")
public class PassiveModuleDeviceMasterRequestData {
  ...
  private PassiveModuleDeviceMasterEntityRestriction entityRestrictions;
  ...
  public PassiveModuleDeviceMasterRequestData() {
  }

  public PassiveModuleDeviceMasterRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public PassiveModuleDeviceMasterRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public PassiveModuleDeviceMasterRequestData entityRestrictions(PassiveModuleDeviceMasterEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public PassiveModuleDeviceMasterEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(PassiveModuleDeviceMasterEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public PassiveModuleDeviceMasterRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public PassiveModuleDeviceMasterRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public PassiveModuleDeviceMasterRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    PassiveModuleDeviceMasterRequestData passiveModuleDeviceMasterRequestData = (PassiveModuleDeviceMasterRequestData) o;
    return Objects.equals(this.returnEntityAttributes, passiveModuleDeviceMasterRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, passiveModuleDeviceMasterRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, passiveModuleDeviceMasterRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, passiveModuleDeviceMasterRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class PassiveModuleDeviceMasterRequestData {\n");
