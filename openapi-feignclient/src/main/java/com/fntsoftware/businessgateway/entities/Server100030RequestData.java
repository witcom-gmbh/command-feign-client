...
import com.fntsoftware.businessgateway.entities.Server100030EntityRestriction;
import com.fntsoftware.businessgateway.entities.Server100030RelationRestriction;
...
/**
 * Server100030RequestData
 */
@JsonPropertyOrder({
  Server100030RequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  Server100030RequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  Server100030RequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  Server100030RequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-02-26T11:20:24.990023935Z[Etc/UTC]")
public class Server100030RequestData {
  ...
  private Server100030EntityRestriction entityRestrictions;

  public static final String JSON_PROPERTY_RELATION_RESTRICTIONS = "relationRestrictions";
  private Server100030RelationRestriction relationRestrictions;
  ...
  public Server100030RequestData() {
  }

  public Server100030RequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public Server100030RequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public Server100030RequestData entityRestrictions(Server100030EntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public Server100030EntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(Server100030EntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public Server100030RequestData relationRestrictions(Server100030RelationRestriction relationRestrictions) {
  ...
  **/
  ...
  public Server100030RelationRestriction getRelationRestrictions() {
    return relationRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_RELATION_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRelationRestrictions(Server100030RelationRestriction relationRestrictions) {
    this.relationRestrictions = relationRestrictions;
  }


  public Server100030RequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public Server100030RequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    Server100030RequestData server100030RequestData = (Server100030RequestData) o;
    return Objects.equals(this.returnEntityAttributes, server100030RequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, server100030RequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, server100030RequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, server100030RequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class Server100030RequestData {\n");
