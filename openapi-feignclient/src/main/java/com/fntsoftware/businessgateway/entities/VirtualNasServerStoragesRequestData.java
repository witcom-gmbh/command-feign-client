...
import com.fntsoftware.businessgateway.entities.VirtualNasServerStoragesEntityRestriction;
...
/**
 * VirtualNasServerStoragesRequestData
 */
@JsonPropertyOrder({
  VirtualNasServerStoragesRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  VirtualNasServerStoragesRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  VirtualNasServerStoragesRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  VirtualNasServerStoragesRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-03-04T13:31:32.601557352Z[Etc/UTC]")
public class VirtualNasServerStoragesRequestData {
  ...
  private VirtualNasServerStoragesEntityRestriction entityRestrictions;
  ...
  public VirtualNasServerStoragesRequestData() {
  }

  public VirtualNasServerStoragesRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public VirtualNasServerStoragesRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public VirtualNasServerStoragesRequestData entityRestrictions(VirtualNasServerStoragesEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public VirtualNasServerStoragesEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(VirtualNasServerStoragesEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public VirtualNasServerStoragesRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public VirtualNasServerStoragesRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public VirtualNasServerStoragesRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    VirtualNasServerStoragesRequestData virtualNasServerStoragesRequestData = (VirtualNasServerStoragesRequestData) o;
    return Objects.equals(this.returnEntityAttributes, virtualNasServerStoragesRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, virtualNasServerStoragesRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, virtualNasServerStoragesRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, virtualNasServerStoragesRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class VirtualNasServerStoragesRequestData {\n");
