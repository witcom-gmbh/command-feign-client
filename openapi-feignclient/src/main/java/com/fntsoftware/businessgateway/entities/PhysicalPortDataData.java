...
/**
 * PhysicalPortDataData
 */
@JsonPropertyOrder({
  PhysicalPortDataData.JSON_PROPERTY_SOCKET_NAME_SPC,
  PhysicalPortDataData.JSON_PROPERTY_BORDER_COLOR,
  PhysicalPortDataData.JSON_PROPERTY_WWN_ADDRESS,
  PhysicalPortDataData.JSON_PROPERTY_NOTES,
  PhysicalPortDataData.JSON_PROPERTY_PORT_STATE,
  PhysicalPortDataData.JSON_PROPERTY_SOCKET_NAME,
  PhysicalPortDataData.JSON_PROPERTY_WIRE_TYPE,
  PhysicalPortDataData.JSON_PROPERTY_MEDIUM,
  PhysicalPortDataData.JSON_PROPERTY_VLAN,
  PhysicalPortDataData.JSON_PROPERTY_SOCKET_SUB_NO,
  PhysicalPortDataData.JSON_PROPERTY_PORT_SPEED,
  PhysicalPortDataData.JSON_PROPERTY_STATUS_REMARK,
  PhysicalPortDataData.JSON_PROPERTY_VLAN_TYPE,
  PhysicalPortDataData.JSON_PROPERTY_DEVICE_ALL_ELID,
  PhysicalPortDataData.JSON_PROPERTY_PORT_IDENTIFIER,
  PhysicalPortDataData.JSON_PROPERTY_VLAN_ID,
  PhysicalPortDataData.JSON_PROPERTY_PORT_NETWORK_CATEGORY,
  PhysicalPortDataData.JSON_PROPERTY_SOCKET_NO,
  PhysicalPortDataData.JSON_PROPERTY_VTP_DOMAIN,
  PhysicalPortDataData.JSON_PROPERTY_CONNECTOR,
  PhysicalPortDataData.JSON_PROPERTY_PORT_DUPLEX,
  PhysicalPortDataData.JSON_PROPERTY_SOCKET_SIDE,
  PhysicalPortDataData.JSON_PROPERTY_DEVICE_ALL_ID,
  PhysicalPortDataData.JSON_PROPERTY_COAX_NET,
  PhysicalPortDataData.JSON_PROPERTY_STATUS
})
@JsonTypeName("physicalPortDataData")
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-02-26T11:20:24.990023935Z[Etc/UTC]")
public class PhysicalPortDataData {
  ...
  public PhysicalPortDataData() {
  }

  public PhysicalPortDataData socketNameSpc(String socketNameSpc) {
  ...
  **/
  ...
  public PhysicalPortDataData borderColor(String borderColor) {
  ...
  **/
  ...
  public PhysicalPortDataData wwnAddress(String wwnAddress) {
  ...
  **/
  ...
  public PhysicalPortDataData notes(String notes) {
  ...
  **/
  ...
  public PhysicalPortDataData portState(String portState) {
  ...
  **/
  ...
  public PhysicalPortDataData socketName(String socketName) {
  ...
  **/
  ...
  public PhysicalPortDataData wireType(String wireType) {
  ...
  **/
  ...
  public PhysicalPortDataData medium(String medium) {
  ...
  **/
  ...
  public PhysicalPortDataData vlan(String vlan) {
  ...
  **/
  ...
  public PhysicalPortDataData socketSubNo(BigDecimal socketSubNo) {
  ...
  **/
  ...
  public PhysicalPortDataData portSpeed(String portSpeed) {
  ...
  **/
  ...
  public PhysicalPortDataData statusRemark(String statusRemark) {
  ...
  **/
  ...
  public PhysicalPortDataData vlanType(String vlanType) {
  ...
  **/
  ...
  public PhysicalPortDataData deviceAllElid(String deviceAllElid) {
  ...
  **/
  ...
  public PhysicalPortDataData portIdentifier(String portIdentifier) {
  ...
  **/
  ...
  public PhysicalPortDataData vlanId(BigDecimal vlanId) {
  ...
  **/
  ...
  public PhysicalPortDataData portNetworkCategory(String portNetworkCategory) {
  ...
  **/
  ...
  public PhysicalPortDataData socketNo(BigDecimal socketNo) {
  ...
  **/
  ...
  public PhysicalPortDataData vtpDomain(String vtpDomain) {
  ...
  **/
  ...
  public PhysicalPortDataData connector(String connector) {
  ...
  **/
  ...
  public PhysicalPortDataData portDuplex(String portDuplex) {
  ...
  **/
  ...
  public PhysicalPortDataData socketSide(String socketSide) {
  ...
  **/
  ...
  public PhysicalPortDataData deviceAllId(String deviceAllId) {
  ...
  **/
  ...
  public PhysicalPortDataData coaxNet(String coaxNet) {
  ...
  **/
  ...
  public PhysicalPortDataData status(String status) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    PhysicalPortDataData physicalPortDataData = (PhysicalPortDataData) o;
    return Objects.equals(this.socketNameSpc, physicalPortDataData.socketNameSpc) &&
        Objects.equals(this.borderColor, physicalPortDataData.borderColor) &&
        Objects.equals(this.wwnAddress, physicalPortDataData.wwnAddress) &&
        Objects.equals(this.notes, physicalPortDataData.notes) &&
        Objects.equals(this.portState, physicalPortDataData.portState) &&
        Objects.equals(this.socketName, physicalPortDataData.socketName) &&
        Objects.equals(this.wireType, physicalPortDataData.wireType) &&
        Objects.equals(this.medium, physicalPortDataData.medium) &&
        Objects.equals(this.vlan, physicalPortDataData.vlan) &&
        Objects.equals(this.socketSubNo, physicalPortDataData.socketSubNo) &&
        Objects.equals(this.portSpeed, physicalPortDataData.portSpeed) &&
        Objects.equals(this.statusRemark, physicalPortDataData.statusRemark) &&
        Objects.equals(this.vlanType, physicalPortDataData.vlanType) &&
        Objects.equals(this.deviceAllElid, physicalPortDataData.deviceAllElid) &&
        Objects.equals(this.portIdentifier, physicalPortDataData.portIdentifier) &&
        Objects.equals(this.vlanId, physicalPortDataData.vlanId) &&
        Objects.equals(this.portNetworkCategory, physicalPortDataData.portNetworkCategory) &&
        Objects.equals(this.socketNo, physicalPortDataData.socketNo) &&
        Objects.equals(this.vtpDomain, physicalPortDataData.vtpDomain) &&
        Objects.equals(this.connector, physicalPortDataData.connector) &&
        Objects.equals(this.portDuplex, physicalPortDataData.portDuplex) &&
        Objects.equals(this.socketSide, physicalPortDataData.socketSide) &&
        Objects.equals(this.deviceAllId, physicalPortDataData.deviceAllId) &&
        Objects.equals(this.coaxNet, physicalPortDataData.coaxNet) &&
        Objects.equals(this.status, physicalPortDataData.status);
  }
  ...
  public String toString() {
    ...
    sb.append("class PhysicalPortDataData {\n");
