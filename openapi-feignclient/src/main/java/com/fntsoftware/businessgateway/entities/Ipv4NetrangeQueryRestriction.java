...
/**
 * Ipv4NetrangeQueryRestriction
 */
@JsonPropertyOrder({
  Ipv4NetrangeQueryRestriction.JSON_PROPERTY_END_IP,
  Ipv4NetrangeQueryRestriction.JSON_PROPERTY_NET_CLIENT,
  Ipv4NetrangeQueryRestriction.JSON_PROPERTY_DOMAIN_ELID,
  Ipv4NetrangeQueryRestriction.JSON_PROPERTY_NETRANGE_NAME_ELID,
  Ipv4NetrangeQueryRestriction.JSON_PROPERTY_START_IP,
  Ipv4NetrangeQueryRestriction.JSON_PROPERTY_BLOCKED,
  Ipv4NetrangeQueryRestriction.JSON_PROPERTY_REMARK,
  Ipv4NetrangeQueryRestriction.JSON_PROPERTY_ELID,
  Ipv4NetrangeQueryRestriction.JSON_PROPERTY_NETWORK_ELID,
  Ipv4NetrangeQueryRestriction.JSON_PROPERTY_DHCP,
  Ipv4NetrangeQueryRestriction.JSON_PROPERTY_FIRST,
  Ipv4NetrangeQueryRestriction.JSON_PROPERTY_NET_CLIENT_ELID
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-03-04T13:31:32.601557352Z[Etc/UTC]")
public class Ipv4NetrangeQueryRestriction {
  ...
  public Ipv4NetrangeQueryRestriction() {
  }

  public Ipv4NetrangeQueryRestriction endIp(RestrictionsString endIp) {
  ...
  **/
  ...
  public Ipv4NetrangeQueryRestriction netClient(RestrictionsString netClient) {
  ...
  **/
  ...
  public Ipv4NetrangeQueryRestriction domainElid(RestrictionsString domainElid) {
  ...
  **/
  ...
  public Ipv4NetrangeQueryRestriction netrangeNameElid(RestrictionsString netrangeNameElid) {
  ...
  **/
  ...
  public Ipv4NetrangeQueryRestriction startIp(RestrictionsString startIp) {
  ...
  **/
  ...
  public Ipv4NetrangeQueryRestriction blocked(RestrictionsBoolean blocked) {
  ...
  **/
  ...
  public Ipv4NetrangeQueryRestriction remark(RestrictionsString remark) {
  ...
  **/
  ...
  public Ipv4NetrangeQueryRestriction elid(RestrictionsString elid) {
  ...
  **/
  ...
  public Ipv4NetrangeQueryRestriction networkElid(RestrictionsString networkElid) {
  ...
  **/
  ...
  public Ipv4NetrangeQueryRestriction dhcp(RestrictionsBoolean dhcp) {
  ...
  **/
  ...
  public Ipv4NetrangeQueryRestriction first(RestrictionsNumeric first) {
  ...
  **/
  ...
  public Ipv4NetrangeQueryRestriction netClientElid(RestrictionsString netClientElid) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    Ipv4NetrangeQueryRestriction ipv4NetrangeQueryRestriction = (Ipv4NetrangeQueryRestriction) o;
    return Objects.equals(this.endIp, ipv4NetrangeQueryRestriction.endIp) &&
        Objects.equals(this.netClient, ipv4NetrangeQueryRestriction.netClient) &&
        Objects.equals(this.domainElid, ipv4NetrangeQueryRestriction.domainElid) &&
        Objects.equals(this.netrangeNameElid, ipv4NetrangeQueryRestriction.netrangeNameElid) &&
        Objects.equals(this.startIp, ipv4NetrangeQueryRestriction.startIp) &&
        Objects.equals(this.blocked, ipv4NetrangeQueryRestriction.blocked) &&
        Objects.equals(this.remark, ipv4NetrangeQueryRestriction.remark) &&
        Objects.equals(this.elid, ipv4NetrangeQueryRestriction.elid) &&
        Objects.equals(this.networkElid, ipv4NetrangeQueryRestriction.networkElid) &&
        Objects.equals(this.dhcp, ipv4NetrangeQueryRestriction.dhcp) &&
        Objects.equals(this.first, ipv4NetrangeQueryRestriction.first) &&
        Objects.equals(this.netClientElid, ipv4NetrangeQueryRestriction.netClientElid);
  }

  @Override
  public int hashCode() {
    return Objects.hash(endIp, netClient, domainElid, netrangeNameElid, startIp, blocked, remark, elid, networkElid, dhcp, first, netClientElid);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class Ipv4NetrangeQueryRestriction {\n");
