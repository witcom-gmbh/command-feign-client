...
import com.fntsoftware.businessgateway.entities.TopzoneRoomsEntityRestriction;
import com.fntsoftware.businessgateway.entities.TopzoneRoomsRelationRestriction;
...
/**
 * TopzoneRoomsRequestData
 */
@JsonPropertyOrder({
  TopzoneRoomsRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  TopzoneRoomsRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  TopzoneRoomsRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  TopzoneRoomsRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-01-31T11:10:37.320689708Z[Etc/UTC]")
public class TopzoneRoomsRequestData {
  ...
  private TopzoneRoomsEntityRestriction entityRestrictions;

  public static final String JSON_PROPERTY_RELATION_RESTRICTIONS = "relationRestrictions";
  private TopzoneRoomsRelationRestriction relationRestrictions;
  ...
  public TopzoneRoomsRequestData() {
  }

  public TopzoneRoomsRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public TopzoneRoomsRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public TopzoneRoomsRequestData entityRestrictions(TopzoneRoomsEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public TopzoneRoomsEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(TopzoneRoomsEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public TopzoneRoomsRequestData relationRestrictions(TopzoneRoomsRelationRestriction relationRestrictions) {
  ...
  **/
  ...
  public TopzoneRoomsRelationRestriction getRelationRestrictions() {
    return relationRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_RELATION_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRelationRestrictions(TopzoneRoomsRelationRestriction relationRestrictions) {
    this.relationRestrictions = relationRestrictions;
  }


  public TopzoneRoomsRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public TopzoneRoomsRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    TopzoneRoomsRequestData topzoneRoomsRequestData = (TopzoneRoomsRequestData) o;
    return Objects.equals(this.returnEntityAttributes, topzoneRoomsRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, topzoneRoomsRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, topzoneRoomsRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, topzoneRoomsRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class TopzoneRoomsRequestData {\n");
