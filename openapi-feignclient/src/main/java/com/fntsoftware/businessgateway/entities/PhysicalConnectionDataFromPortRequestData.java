...
import com.fntsoftware.businessgateway.entities.PhysicalConnectionDataFromPortEntityRestriction;
...
/**
 * PhysicalConnectionDataFromPortRequestData
 */
@JsonPropertyOrder({
  PhysicalConnectionDataFromPortRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  PhysicalConnectionDataFromPortRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  PhysicalConnectionDataFromPortRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  PhysicalConnectionDataFromPortRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-02-26T11:20:24.990023935Z[Etc/UTC]")
public class PhysicalConnectionDataFromPortRequestData {
  ...
  private PhysicalConnectionDataFromPortEntityRestriction entityRestrictions;
  ...
  public PhysicalConnectionDataFromPortRequestData() {
  }

  public PhysicalConnectionDataFromPortRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public PhysicalConnectionDataFromPortRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public PhysicalConnectionDataFromPortRequestData entityRestrictions(PhysicalConnectionDataFromPortEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public PhysicalConnectionDataFromPortEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(PhysicalConnectionDataFromPortEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public PhysicalConnectionDataFromPortRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public PhysicalConnectionDataFromPortRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public PhysicalConnectionDataFromPortRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    PhysicalConnectionDataFromPortRequestData physicalConnectionDataFromPortRequestData = (PhysicalConnectionDataFromPortRequestData) o;
    return Objects.equals(this.returnEntityAttributes, physicalConnectionDataFromPortRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, physicalConnectionDataFromPortRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, physicalConnectionDataFromPortRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, physicalConnectionDataFromPortRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class PhysicalConnectionDataFromPortRequestData {\n");
