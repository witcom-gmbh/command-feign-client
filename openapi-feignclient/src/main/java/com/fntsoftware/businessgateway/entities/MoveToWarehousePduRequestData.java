...
import com.fntsoftware.businessgateway.entities.MoveToWarehousePduCreateLinkWarehouseRequestData;
import com.fasterxml.jackson.annotation.JsonPropertyOrder;
import com.fasterxml.jackson.annotation.JsonTypeName;

/**
 * MoveToWarehousePduRequestData
 */
@JsonPropertyOrder({
  MoveToWarehousePduRequestData.JSON_PROPERTY_RELEASE_SIGNALPATH,
  MoveToWarehousePduRequestData.JSON_PROPERTY_RELEASE_CONNECTIONS,
  MoveToWarehousePduRequestData.JSON_PROPERTY_RELEASE_SERVICE,
  MoveToWarehousePduRequestData.JSON_PROPERTY_RELEASE_SUPPORTS,
  MoveToWarehousePduRequestData.JSON_PROPERTY_RELEASE_PATCHES,
  MoveToWarehousePduRequestData.JSON_PROPERTY_CREATE_LINK_WAREHOUSE
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-02-26T11:20:24.990023935Z[Etc/UTC]")
public class MoveToWarehousePduRequestData {
  ...
  private MoveToWarehousePduCreateLinkWarehouseRequestData createLinkWarehouse;

  public MoveToWarehousePduRequestData() {
  }

  public MoveToWarehousePduRequestData releaseSignalpath(Boolean releaseSignalpath) {
  ...
  **/
  ...
  public MoveToWarehousePduRequestData releaseConnections(Boolean releaseConnections) {
  ...
  **/
  ...
  public MoveToWarehousePduRequestData releaseService(Boolean releaseService) {
  ...
  **/
  ...
  public MoveToWarehousePduRequestData releaseSupports(Boolean releaseSupports) {
  ...
  **/
  ...
  public MoveToWarehousePduRequestData releasePatches(Boolean releasePatches) {
  ...
  **/
  ...
  public MoveToWarehousePduRequestData createLinkWarehouse(MoveToWarehousePduCreateLinkWarehouseRequestData createLinkWarehouse) {
  ...
  **/
  ...
  public MoveToWarehousePduCreateLinkWarehouseRequestData getCreateLinkWarehouse() {
    return createLinkWarehouse;
  }
  ...
  @JsonProperty(JSON_PROPERTY_CREATE_LINK_WAREHOUSE)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setCreateLinkWarehouse(MoveToWarehousePduCreateLinkWarehouseRequestData createLinkWarehouse) {
    this.createLinkWarehouse = createLinkWarehouse;
  }
  ...
  public boolean equals(Object o) {
    ...
    MoveToWarehousePduRequestData moveToWarehousePduRequestData = (MoveToWarehousePduRequestData) o;
    return Objects.equals(this.releaseSignalpath, moveToWarehousePduRequestData.releaseSignalpath) &&
        Objects.equals(this.releaseConnections, moveToWarehousePduRequestData.releaseConnections) &&
        Objects.equals(this.releaseService, moveToWarehousePduRequestData.releaseService) &&
        Objects.equals(this.releaseSupports, moveToWarehousePduRequestData.releaseSupports) &&
        Objects.equals(this.releasePatches, moveToWarehousePduRequestData.releasePatches) &&
        Objects.equals(this.createLinkWarehouse, moveToWarehousePduRequestData.createLinkWarehouse);
  }
  ...
  public String toString() {
    ...
    sb.append("class MoveToWarehousePduRequestData {\n");
