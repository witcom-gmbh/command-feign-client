...
/**
 * MultiDuctToDeviceAllEntityRestriction
 */
@JsonPropertyOrder({
  MultiDuctToDeviceAllEntityRestriction.JSON_PROPERTY_CLIMATE_RELEVANT,
  MultiDuctToDeviceAllEntityRestriction.JSON_PROPERTY_POWER_CONSUMPTION,
  MultiDuctToDeviceAllEntityRestriction.JSON_PROPERTY_POWER_SWITCHING_STATUS,
  MultiDuctToDeviceAllEntityRestriction.JSON_PROPERTY_PLAN_STATUS,
  MultiDuctToDeviceAllEntityRestriction.JSON_PROPERTY_SYSTEM_RUNTIME,
  MultiDuctToDeviceAllEntityRestriction.JSON_PROPERTY_WEIGHT,
  MultiDuctToDeviceAllEntityRestriction.JSON_PROPERTY_REMARK,
  MultiDuctToDeviceAllEntityRestriction.JSON_PROPERTY_ELID,
  MultiDuctToDeviceAllEntityRestriction.JSON_PROPERTY_LAST_SEEN,
  MultiDuctToDeviceAllEntityRestriction.JSON_PROPERTY_TYPE_ELID,
  MultiDuctToDeviceAllEntityRestriction.JSON_PROPERTY_VISIBLE_ID,
  MultiDuctToDeviceAllEntityRestriction.JSON_PROPERTY_ID,
  MultiDuctToDeviceAllEntityRestriction.JSON_PROPERTY_HEAT_EMISSION
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-03-04T13:31:32.601557352Z[Etc/UTC]")
public class MultiDuctToDeviceAllEntityRestriction {
  ...
  public MultiDuctToDeviceAllEntityRestriction() {
  }

  public MultiDuctToDeviceAllEntityRestriction climateRelevant(RestrictionsBoolean climateRelevant) {
  ...
  **/
  ...
  public MultiDuctToDeviceAllEntityRestriction powerConsumption(RestrictionsNumeric powerConsumption) {
  ...
  **/
  ...
  public MultiDuctToDeviceAllEntityRestriction powerSwitchingStatus(RestrictionsString powerSwitchingStatus) {
  ...
  **/
  ...
  public MultiDuctToDeviceAllEntityRestriction planStatus(RestrictionsString planStatus) {
  ...
  **/
  ...
  public MultiDuctToDeviceAllEntityRestriction systemRuntime(RestrictionsNumeric systemRuntime) {
  ...
  **/
  ...
  public MultiDuctToDeviceAllEntityRestriction weight(RestrictionsNumeric weight) {
  ...
  **/
  ...
  public MultiDuctToDeviceAllEntityRestriction remark(RestrictionsString remark) {
  ...
  **/
  ...
  public MultiDuctToDeviceAllEntityRestriction elid(RestrictionsString elid) {
  ...
  **/
  ...
  public MultiDuctToDeviceAllEntityRestriction lastSeen(RestrictionsDate lastSeen) {
  ...
  **/
  ...
  public MultiDuctToDeviceAllEntityRestriction typeElid(RestrictionsString typeElid) {
  ...
  **/
  ...
  public MultiDuctToDeviceAllEntityRestriction visibleId(RestrictionsString visibleId) {
  ...
  **/
  ...
  public MultiDuctToDeviceAllEntityRestriction id(RestrictionsString id) {
  ...
  **/
  ...
  public MultiDuctToDeviceAllEntityRestriction heatEmission(RestrictionsNumeric heatEmission) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    MultiDuctToDeviceAllEntityRestriction multiDuctToDeviceAllEntityRestriction = (MultiDuctToDeviceAllEntityRestriction) o;
    return Objects.equals(this.climateRelevant, multiDuctToDeviceAllEntityRestriction.climateRelevant) &&
        Objects.equals(this.powerConsumption, multiDuctToDeviceAllEntityRestriction.powerConsumption) &&
        Objects.equals(this.powerSwitchingStatus, multiDuctToDeviceAllEntityRestriction.powerSwitchingStatus) &&
        Objects.equals(this.planStatus, multiDuctToDeviceAllEntityRestriction.planStatus) &&
        Objects.equals(this.systemRuntime, multiDuctToDeviceAllEntityRestriction.systemRuntime) &&
        Objects.equals(this.weight, multiDuctToDeviceAllEntityRestriction.weight) &&
        Objects.equals(this.remark, multiDuctToDeviceAllEntityRestriction.remark) &&
        Objects.equals(this.elid, multiDuctToDeviceAllEntityRestriction.elid) &&
        Objects.equals(this.lastSeen, multiDuctToDeviceAllEntityRestriction.lastSeen) &&
        Objects.equals(this.typeElid, multiDuctToDeviceAllEntityRestriction.typeElid) &&
        Objects.equals(this.visibleId, multiDuctToDeviceAllEntityRestriction.visibleId) &&
        Objects.equals(this.id, multiDuctToDeviceAllEntityRestriction.id) &&
        Objects.equals(this.heatEmission, multiDuctToDeviceAllEntityRestriction.heatEmission);
  }
  ...
  public String toString() {
    ...
    sb.append("class MultiDuctToDeviceAllEntityRestriction {\n");
