...
import com.fntsoftware.businessgateway.entities.LogicalGroupZoneEntityRestriction;
...
/**
 * LogicalGroupZoneRequestData
 */
@JsonPropertyOrder({
  LogicalGroupZoneRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  LogicalGroupZoneRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  LogicalGroupZoneRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  LogicalGroupZoneRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-02-26T11:20:24.990023935Z[Etc/UTC]")
public class LogicalGroupZoneRequestData {
  ...
  private LogicalGroupZoneEntityRestriction entityRestrictions;
  ...
  public LogicalGroupZoneRequestData() {
  }

  public LogicalGroupZoneRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public LogicalGroupZoneRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public LogicalGroupZoneRequestData entityRestrictions(LogicalGroupZoneEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public LogicalGroupZoneEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(LogicalGroupZoneEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public LogicalGroupZoneRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public LogicalGroupZoneRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public LogicalGroupZoneRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    LogicalGroupZoneRequestData logicalGroupZoneRequestData = (LogicalGroupZoneRequestData) o;
    return Objects.equals(this.returnEntityAttributes, logicalGroupZoneRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, logicalGroupZoneRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, logicalGroupZoneRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, logicalGroupZoneRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class LogicalGroupZoneRequestData {\n");
