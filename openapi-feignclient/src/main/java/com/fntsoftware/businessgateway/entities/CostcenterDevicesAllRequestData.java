...
import com.fntsoftware.businessgateway.entities.CostcenterDevicesAllEntityRestriction;
...
/**
 * CostcenterDevicesAllRequestData
 */
@JsonPropertyOrder({
  CostcenterDevicesAllRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  CostcenterDevicesAllRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  CostcenterDevicesAllRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  CostcenterDevicesAllRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-02-26T11:20:24.990023935Z[Etc/UTC]")
public class CostcenterDevicesAllRequestData {
  ...
  private CostcenterDevicesAllEntityRestriction entityRestrictions;
  ...
  public CostcenterDevicesAllRequestData() {
  }

  public CostcenterDevicesAllRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public CostcenterDevicesAllRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public CostcenterDevicesAllRequestData entityRestrictions(CostcenterDevicesAllEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public CostcenterDevicesAllEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(CostcenterDevicesAllEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public CostcenterDevicesAllRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public CostcenterDevicesAllRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public CostcenterDevicesAllRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    CostcenterDevicesAllRequestData costcenterDevicesAllRequestData = (CostcenterDevicesAllRequestData) o;
    return Objects.equals(this.returnEntityAttributes, costcenterDevicesAllRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, costcenterDevicesAllRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, costcenterDevicesAllRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, costcenterDevicesAllRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class CostcenterDevicesAllRequestData {\n");
