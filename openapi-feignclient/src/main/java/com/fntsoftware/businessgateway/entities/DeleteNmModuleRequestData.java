...
/**
 * DeleteNmModuleRequestData
 */
@JsonPropertyOrder({
  DeleteNmModuleRequestData.JSON_PROPERTY_RELEASE_SIGNALPATH,
  DeleteNmModuleRequestData.JSON_PROPERTY_RELEASE_CONNECTIONS,
  DeleteNmModuleRequestData.JSON_PROPERTY_RELEASE_SERVICE,
  DeleteNmModuleRequestData.JSON_PROPERTY_CONTEXT_ID,
  DeleteNmModuleRequestData.JSON_PROPERTY_RELEASE_PATCHES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-02-26T11:20:24.990023935Z[Etc/UTC]")
public class DeleteNmModuleRequestData {
  ...
  public DeleteNmModuleRequestData() {
  }

  public DeleteNmModuleRequestData releaseSignalpath(Boolean releaseSignalpath) {
  ...
  **/
  ...
  public DeleteNmModuleRequestData releaseConnections(Boolean releaseConnections) {
  ...
  **/
  ...
  public DeleteNmModuleRequestData releaseService(Boolean releaseService) {
  ...
  **/
  ...
  public DeleteNmModuleRequestData contextId(String contextId) {
  ...
  **/
  ...
  public DeleteNmModuleRequestData releasePatches(Boolean releasePatches) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    DeleteNmModuleRequestData deleteNmModuleRequestData = (DeleteNmModuleRequestData) o;
    return Objects.equals(this.releaseSignalpath, deleteNmModuleRequestData.releaseSignalpath) &&
        Objects.equals(this.releaseConnections, deleteNmModuleRequestData.releaseConnections) &&
        Objects.equals(this.releaseService, deleteNmModuleRequestData.releaseService) &&
        Objects.equals(this.contextId, deleteNmModuleRequestData.contextId) &&
        Objects.equals(this.releasePatches, deleteNmModuleRequestData.releasePatches);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeleteNmModuleRequestData {\n");
