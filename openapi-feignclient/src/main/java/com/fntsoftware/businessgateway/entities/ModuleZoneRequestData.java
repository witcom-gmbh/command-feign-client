...
import com.fntsoftware.businessgateway.entities.ModuleZoneEntityRestriction;
...
/**
 * ModuleZoneRequestData
 */
@JsonPropertyOrder({
  ModuleZoneRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  ModuleZoneRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  ModuleZoneRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  ModuleZoneRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-01-31T11:10:37.320689708Z[Etc/UTC]")
public class ModuleZoneRequestData {
  ...
  private ModuleZoneEntityRestriction entityRestrictions;
  ...
  public ModuleZoneRequestData() {
  }

  public ModuleZoneRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public ModuleZoneRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public ModuleZoneRequestData entityRestrictions(ModuleZoneEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public ModuleZoneEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(ModuleZoneEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public ModuleZoneRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public ModuleZoneRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public ModuleZoneRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ModuleZoneRequestData moduleZoneRequestData = (ModuleZoneRequestData) o;
    return Objects.equals(this.returnEntityAttributes, moduleZoneRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, moduleZoneRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, moduleZoneRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, moduleZoneRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class ModuleZoneRequestData {\n");
