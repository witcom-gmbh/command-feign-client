...
import com.fntsoftware.businessgateway.entities.FuseTypeFusesEntityRestriction;
import com.fntsoftware.businessgateway.entities.FuseTypeFusesRelationRestriction;
...
/**
 * FuseTypeFusesRequestData
 */
@JsonPropertyOrder({
  FuseTypeFusesRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  FuseTypeFusesRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  FuseTypeFusesRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  FuseTypeFusesRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-03-04T13:31:32.601557352Z[Etc/UTC]")
public class FuseTypeFusesRequestData {
  ...
  private FuseTypeFusesEntityRestriction entityRestrictions;

  public static final String JSON_PROPERTY_RELATION_RESTRICTIONS = "relationRestrictions";
  private FuseTypeFusesRelationRestriction relationRestrictions;
  ...
  public FuseTypeFusesRequestData() {
  }

  public FuseTypeFusesRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public FuseTypeFusesRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public FuseTypeFusesRequestData entityRestrictions(FuseTypeFusesEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public FuseTypeFusesEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(FuseTypeFusesEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public FuseTypeFusesRequestData relationRestrictions(FuseTypeFusesRelationRestriction relationRestrictions) {
  ...
  **/
  ...
  public FuseTypeFusesRelationRestriction getRelationRestrictions() {
    return relationRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_RELATION_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRelationRestrictions(FuseTypeFusesRelationRestriction relationRestrictions) {
    this.relationRestrictions = relationRestrictions;
  }


  public FuseTypeFusesRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public FuseTypeFusesRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    FuseTypeFusesRequestData fuseTypeFusesRequestData = (FuseTypeFusesRequestData) o;
    return Objects.equals(this.returnEntityAttributes, fuseTypeFusesRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, fuseTypeFusesRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, fuseTypeFusesRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, fuseTypeFusesRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class FuseTypeFusesRequestData {\n");
