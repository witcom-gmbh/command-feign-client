...
import com.fntsoftware.businessgateway.entities.StoragePhysicalPortsPowerEntityRestriction;
...
/**
 * StoragePhysicalPortsPowerRequestData
 */
@JsonPropertyOrder({
  StoragePhysicalPortsPowerRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  StoragePhysicalPortsPowerRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  StoragePhysicalPortsPowerRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  StoragePhysicalPortsPowerRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-03-04T13:31:32.601557352Z[Etc/UTC]")
public class StoragePhysicalPortsPowerRequestData {
  ...
  private StoragePhysicalPortsPowerEntityRestriction entityRestrictions;
  ...
  public StoragePhysicalPortsPowerRequestData() {
  }

  public StoragePhysicalPortsPowerRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public StoragePhysicalPortsPowerRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public StoragePhysicalPortsPowerRequestData entityRestrictions(StoragePhysicalPortsPowerEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public StoragePhysicalPortsPowerEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(StoragePhysicalPortsPowerEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public StoragePhysicalPortsPowerRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public StoragePhysicalPortsPowerRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public StoragePhysicalPortsPowerRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    StoragePhysicalPortsPowerRequestData storagePhysicalPortsPowerRequestData = (StoragePhysicalPortsPowerRequestData) o;
    return Objects.equals(this.returnEntityAttributes, storagePhysicalPortsPowerRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, storagePhysicalPortsPowerRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, storagePhysicalPortsPowerRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, storagePhysicalPortsPowerRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class StoragePhysicalPortsPowerRequestData {\n");
