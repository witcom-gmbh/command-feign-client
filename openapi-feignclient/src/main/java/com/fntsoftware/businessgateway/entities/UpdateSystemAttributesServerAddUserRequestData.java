...
/**
 * UpdateSystemAttributesServerAddUserRequestData
 */
@JsonPropertyOrder({
  UpdateSystemAttributesServerAddUserRequestData.JSON_PROPERTY_MODIFY_PLAN,
  UpdateSystemAttributesServerAddUserRequestData.JSON_PROPERTY_DELETE_REAL,
  UpdateSystemAttributesServerAddUserRequestData.JSON_PROPERTY_READ_PLAN,
  UpdateSystemAttributesServerAddUserRequestData.JSON_PROPERTY_MANDANT_ID,
  UpdateSystemAttributesServerAddUserRequestData.JSON_PROPERTY_USER_ELID,
  UpdateSystemAttributesServerAddUserRequestData.JSON_PROPERTY_MODIFY_REAL,
  UpdateSystemAttributesServerAddUserRequestData.JSON_PROPERTY_READ_REAL,
  UpdateSystemAttributesServerAddUserRequestData.JSON_PROPERTY_DELETE_PLAN
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-03-04T13:31:32.601557352Z[Etc/UTC]")
public class UpdateSystemAttributesServerAddUserRequestData {
  ...
  public UpdateSystemAttributesServerAddUserRequestData() {
  }

  public UpdateSystemAttributesServerAddUserRequestData modifyPlan(Boolean modifyPlan) {
  ...
  **/
  ...
  public UpdateSystemAttributesServerAddUserRequestData deleteReal(Boolean deleteReal) {
  ...
  **/
  ...
  public UpdateSystemAttributesServerAddUserRequestData readPlan(Boolean readPlan) {
  ...
  **/
  ...
  public UpdateSystemAttributesServerAddUserRequestData mandantId(BigDecimal mandantId) {
  ...
  **/
  ...
  public UpdateSystemAttributesServerAddUserRequestData userElid(String userElid) {
  ...
  **/
  ...
  public UpdateSystemAttributesServerAddUserRequestData modifyReal(Boolean modifyReal) {
  ...
  **/
  ...
  public UpdateSystemAttributesServerAddUserRequestData readReal(Boolean readReal) {
  ...
  **/
  ...
  public UpdateSystemAttributesServerAddUserRequestData deletePlan(Boolean deletePlan) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    UpdateSystemAttributesServerAddUserRequestData updateSystemAttributesServerAddUserRequestData = (UpdateSystemAttributesServerAddUserRequestData) o;
    return Objects.equals(this.modifyPlan, updateSystemAttributesServerAddUserRequestData.modifyPlan) &&
        Objects.equals(this.deleteReal, updateSystemAttributesServerAddUserRequestData.deleteReal) &&
        Objects.equals(this.readPlan, updateSystemAttributesServerAddUserRequestData.readPlan) &&
        Objects.equals(this.mandantId, updateSystemAttributesServerAddUserRequestData.mandantId) &&
        Objects.equals(this.userElid, updateSystemAttributesServerAddUserRequestData.userElid) &&
        Objects.equals(this.modifyReal, updateSystemAttributesServerAddUserRequestData.modifyReal) &&
        Objects.equals(this.readReal, updateSystemAttributesServerAddUserRequestData.readReal) &&
        Objects.equals(this.deletePlan, updateSystemAttributesServerAddUserRequestData.deletePlan);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateSystemAttributesServerAddUserRequestData {\n");
