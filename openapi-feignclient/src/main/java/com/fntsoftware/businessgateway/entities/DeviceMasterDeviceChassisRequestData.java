...
import com.fntsoftware.businessgateway.entities.DeviceMasterDeviceChassisEntityRestriction;
...
/**
 * DeviceMasterDeviceChassisRequestData
 */
@JsonPropertyOrder({
  DeviceMasterDeviceChassisRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  DeviceMasterDeviceChassisRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  DeviceMasterDeviceChassisRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  DeviceMasterDeviceChassisRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-02-26T11:20:24.990023935Z[Etc/UTC]")
public class DeviceMasterDeviceChassisRequestData {
  ...
  private DeviceMasterDeviceChassisEntityRestriction entityRestrictions;
  ...
  public DeviceMasterDeviceChassisRequestData() {
  }

  public DeviceMasterDeviceChassisRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public DeviceMasterDeviceChassisRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public DeviceMasterDeviceChassisRequestData entityRestrictions(DeviceMasterDeviceChassisEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public DeviceMasterDeviceChassisEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(DeviceMasterDeviceChassisEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public DeviceMasterDeviceChassisRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public DeviceMasterDeviceChassisRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public DeviceMasterDeviceChassisRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    DeviceMasterDeviceChassisRequestData deviceMasterDeviceChassisRequestData = (DeviceMasterDeviceChassisRequestData) o;
    return Objects.equals(this.returnEntityAttributes, deviceMasterDeviceChassisRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, deviceMasterDeviceChassisRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, deviceMasterDeviceChassisRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, deviceMasterDeviceChassisRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeviceMasterDeviceChassisRequestData {\n");
