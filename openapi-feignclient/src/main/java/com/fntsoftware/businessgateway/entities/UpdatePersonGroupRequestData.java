...
public class UpdatePersonGroupRequestData {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, updatePersonGroupRequestData.name) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(name, description, contextId, remark, id, createLinkContract, createLinkFrameContract, createLinkMaintenanceContract, createLinkOrganization, createLinkPerson, deleteLinkAssignments, deleteLinkContract, deleteLinkFrameContract, deleteLinkMaintenanceContract, deleteLinkOrganization, deleteLinkPerson);
  }
