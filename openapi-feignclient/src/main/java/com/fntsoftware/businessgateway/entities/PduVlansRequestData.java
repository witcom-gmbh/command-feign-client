...
import com.fntsoftware.businessgateway.entities.PduVlansEntityRestriction;
import com.fntsoftware.businessgateway.entities.PduVlansRelationRestriction;
 ...
 */
@JsonPropertyOrder({
  PduVlansRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  PduVlansRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  PduVlansRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  PduVlansRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-01-31T11:10:37.320689708Z[Etc/UTC]")
public class PduVlansRequestData {
  ...
  private PduVlansEntityRestriction entityRestrictions;

  public static final String JSON_PROPERTY_RELATION_RESTRICTIONS = "relationRestrictions";
  private PduVlansRelationRestriction relationRestrictions;
  ...
  public PduVlansRequestData() {
  }

  public PduVlansRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public PduVlansRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public PduVlansRequestData entityRestrictions(PduVlansEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public PduVlansEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(PduVlansEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public PduVlansRequestData relationRestrictions(PduVlansRelationRestriction relationRestrictions) {
  ...
  **/
  ...
  public PduVlansRelationRestriction getRelationRestrictions() {
    return relationRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_RELATION_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRelationRestrictions(PduVlansRelationRestriction relationRestrictions) {
    this.relationRestrictions = relationRestrictions;
  }


  public PduVlansRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public PduVlansRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    PduVlansRequestData pduVlansRequestData = (PduVlansRequestData) o;
    return Objects.equals(this.returnEntityAttributes, pduVlansRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, pduVlansRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, pduVlansRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, pduVlansRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class PduVlansRequestData {\n");
