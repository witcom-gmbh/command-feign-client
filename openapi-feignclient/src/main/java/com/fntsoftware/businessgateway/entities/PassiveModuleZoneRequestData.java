...
import com.fntsoftware.businessgateway.entities.PassiveModuleZoneEntityRestriction;
...
/**
 * PassiveModuleZoneRequestData
 */
@JsonPropertyOrder({
  PassiveModuleZoneRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  PassiveModuleZoneRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  PassiveModuleZoneRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  PassiveModuleZoneRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-01-31T11:10:37.320689708Z[Etc/UTC]")
public class PassiveModuleZoneRequestData {
  ...
  private PassiveModuleZoneEntityRestriction entityRestrictions;
  ...
  public PassiveModuleZoneRequestData() {
  }

  public PassiveModuleZoneRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public PassiveModuleZoneRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public PassiveModuleZoneRequestData entityRestrictions(PassiveModuleZoneEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public PassiveModuleZoneEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(PassiveModuleZoneEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public PassiveModuleZoneRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public PassiveModuleZoneRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public PassiveModuleZoneRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    PassiveModuleZoneRequestData passiveModuleZoneRequestData = (PassiveModuleZoneRequestData) o;
    return Objects.equals(this.returnEntityAttributes, passiveModuleZoneRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, passiveModuleZoneRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, passiveModuleZoneRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, passiveModuleZoneRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class PassiveModuleZoneRequestData {\n");
