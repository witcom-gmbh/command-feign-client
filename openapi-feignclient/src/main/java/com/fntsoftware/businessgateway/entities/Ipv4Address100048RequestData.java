...
import com.fntsoftware.businessgateway.entities.Ipv4Address100048EntityRestriction;
...
/**
 * Ipv4Address100048RequestData
 */
@JsonPropertyOrder({
  Ipv4Address100048RequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  Ipv4Address100048RequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  Ipv4Address100048RequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  Ipv4Address100048RequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-03-04T13:31:32.601557352Z[Etc/UTC]")
public class Ipv4Address100048RequestData {
  ...
  private Ipv4Address100048EntityRestriction entityRestrictions;
  ...
  public Ipv4Address100048RequestData() {
  }

  public Ipv4Address100048RequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public Ipv4Address100048RequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public Ipv4Address100048RequestData entityRestrictions(Ipv4Address100048EntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public Ipv4Address100048EntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(Ipv4Address100048EntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public Ipv4Address100048RequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public Ipv4Address100048RequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public Ipv4Address100048RequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    Ipv4Address100048RequestData ipv4Address100048RequestData = (Ipv4Address100048RequestData) o;
    return Objects.equals(this.returnEntityAttributes, ipv4Address100048RequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, ipv4Address100048RequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, ipv4Address100048RequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, ipv4Address100048RequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class Ipv4Address100048RequestData {\n");
