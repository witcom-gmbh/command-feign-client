...
import com.fntsoftware.businessgateway.entities.LogicalPortCustomSvidSVlanEntityRestriction;
...
/**
 * LogicalPortCustomSvidSVlanRequestData
 */
@JsonPropertyOrder({
  LogicalPortCustomSvidSVlanRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  LogicalPortCustomSvidSVlanRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  LogicalPortCustomSvidSVlanRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  LogicalPortCustomSvidSVlanRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-02-26T11:20:24.990023935Z[Etc/UTC]")
public class LogicalPortCustomSvidSVlanRequestData {
  ...
  private LogicalPortCustomSvidSVlanEntityRestriction entityRestrictions;
  ...
  public LogicalPortCustomSvidSVlanRequestData() {
  }

  public LogicalPortCustomSvidSVlanRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public LogicalPortCustomSvidSVlanRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public LogicalPortCustomSvidSVlanRequestData entityRestrictions(LogicalPortCustomSvidSVlanEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public LogicalPortCustomSvidSVlanEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(LogicalPortCustomSvidSVlanEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public LogicalPortCustomSvidSVlanRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public LogicalPortCustomSvidSVlanRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public LogicalPortCustomSvidSVlanRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    LogicalPortCustomSvidSVlanRequestData logicalPortCustomSvidSVlanRequestData = (LogicalPortCustomSvidSVlanRequestData) o;
    return Objects.equals(this.returnEntityAttributes, logicalPortCustomSvidSVlanRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, logicalPortCustomSvidSVlanRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, logicalPortCustomSvidSVlanRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, logicalPortCustomSvidSVlanRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class LogicalPortCustomSvidSVlanRequestData {\n");
