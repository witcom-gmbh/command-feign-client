...
import com.fntsoftware.businessgateway.entities.ModuleWarehouseEntityRestriction;
...
/**
 * ModuleWarehouseRequestData
 */
@JsonPropertyOrder({
  ModuleWarehouseRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  ModuleWarehouseRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  ModuleWarehouseRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  ModuleWarehouseRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-02-26T11:20:24.990023935Z[Etc/UTC]")
public class ModuleWarehouseRequestData {
  ...
  private ModuleWarehouseEntityRestriction entityRestrictions;
  ...
  public ModuleWarehouseRequestData() {
  }

  public ModuleWarehouseRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public ModuleWarehouseRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public ModuleWarehouseRequestData entityRestrictions(ModuleWarehouseEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public ModuleWarehouseEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(ModuleWarehouseEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public ModuleWarehouseRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public ModuleWarehouseRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public ModuleWarehouseRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ModuleWarehouseRequestData moduleWarehouseRequestData = (ModuleWarehouseRequestData) o;
    return Objects.equals(this.returnEntityAttributes, moduleWarehouseRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, moduleWarehouseRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, moduleWarehouseRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, moduleWarehouseRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class ModuleWarehouseRequestData {\n");
