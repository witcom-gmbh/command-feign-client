...
import com.fntsoftware.businessgateway.entities.MoveToCabinetServerCreateLinkSwitchCabinetRequestData;
import com.fasterxml.jackson.annotation.JsonPropertyOrder;
import com.fasterxml.jackson.annotation.JsonTypeName;

/**
 * MoveToCabinetServerRequestData
 */
@JsonPropertyOrder({
  MoveToCabinetServerRequestData.JSON_PROPERTY_RELEASE_SIGNALPATH,
  MoveToCabinetServerRequestData.JSON_PROPERTY_RELEASE_CONNECTIONS,
  MoveToCabinetServerRequestData.JSON_PROPERTY_RELEASE_SERVICE,
  MoveToCabinetServerRequestData.JSON_PROPERTY_RELEASE_SUPPORTS,
  MoveToCabinetServerRequestData.JSON_PROPERTY_RELEASE_PATCHES,
  MoveToCabinetServerRequestData.JSON_PROPERTY_CREATE_LINK_SWITCH_CABINET
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-02-26T11:20:24.990023935Z[Etc/UTC]")
public class MoveToCabinetServerRequestData {
  ...
  private MoveToCabinetServerCreateLinkSwitchCabinetRequestData createLinkSwitchCabinet;

  public MoveToCabinetServerRequestData() {
  }

  public MoveToCabinetServerRequestData releaseSignalpath(Boolean releaseSignalpath) {
  ...
  **/
  ...
  public MoveToCabinetServerRequestData releaseConnections(Boolean releaseConnections) {
  ...
  **/
  ...
  public MoveToCabinetServerRequestData releaseService(Boolean releaseService) {
  ...
  **/
  ...
  public MoveToCabinetServerRequestData releaseSupports(Boolean releaseSupports) {
  ...
  **/
  ...
  public MoveToCabinetServerRequestData releasePatches(Boolean releasePatches) {
  ...
  **/
  ...
  public MoveToCabinetServerRequestData createLinkSwitchCabinet(MoveToCabinetServerCreateLinkSwitchCabinetRequestData createLinkSwitchCabinet) {
  ...
  **/
  ...
  public MoveToCabinetServerCreateLinkSwitchCabinetRequestData getCreateLinkSwitchCabinet() {
    return createLinkSwitchCabinet;
  }
  ...
  @JsonProperty(JSON_PROPERTY_CREATE_LINK_SWITCH_CABINET)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setCreateLinkSwitchCabinet(MoveToCabinetServerCreateLinkSwitchCabinetRequestData createLinkSwitchCabinet) {
    this.createLinkSwitchCabinet = createLinkSwitchCabinet;
  }
  ...
  public boolean equals(Object o) {
    ...
    MoveToCabinetServerRequestData moveToCabinetServerRequestData = (MoveToCabinetServerRequestData) o;
    return Objects.equals(this.releaseSignalpath, moveToCabinetServerRequestData.releaseSignalpath) &&
        Objects.equals(this.releaseConnections, moveToCabinetServerRequestData.releaseConnections) &&
        Objects.equals(this.releaseService, moveToCabinetServerRequestData.releaseService) &&
        Objects.equals(this.releaseSupports, moveToCabinetServerRequestData.releaseSupports) &&
        Objects.equals(this.releasePatches, moveToCabinetServerRequestData.releasePatches) &&
        Objects.equals(this.createLinkSwitchCabinet, moveToCabinetServerRequestData.createLinkSwitchCabinet);
  }
  ...
  public String toString() {
    ...
    sb.append("class MoveToCabinetServerRequestData {\n");
