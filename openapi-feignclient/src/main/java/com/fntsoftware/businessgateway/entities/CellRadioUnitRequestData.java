...
import com.fntsoftware.businessgateway.entities.CellRadioUnitEntityRestriction;
import com.fntsoftware.businessgateway.entities.CellRadioUnitRelationRestriction;
...
/**
 * CellRadioUnitRequestData
 */
@JsonPropertyOrder({
  CellRadioUnitRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  CellRadioUnitRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  CellRadioUnitRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  CellRadioUnitRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-02-26T11:20:24.990023935Z[Etc/UTC]")
public class CellRadioUnitRequestData {
  ...
  private CellRadioUnitEntityRestriction entityRestrictions;

  public static final String JSON_PROPERTY_RELATION_RESTRICTIONS = "relationRestrictions";
  private CellRadioUnitRelationRestriction relationRestrictions;
  ...
  public CellRadioUnitRequestData() {
  }

  public CellRadioUnitRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public CellRadioUnitRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public CellRadioUnitRequestData entityRestrictions(CellRadioUnitEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public CellRadioUnitEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(CellRadioUnitEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public CellRadioUnitRequestData relationRestrictions(CellRadioUnitRelationRestriction relationRestrictions) {
  ...
  **/
  ...
  public CellRadioUnitRelationRestriction getRelationRestrictions() {
    return relationRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_RELATION_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRelationRestrictions(CellRadioUnitRelationRestriction relationRestrictions) {
    this.relationRestrictions = relationRestrictions;
  }


  public CellRadioUnitRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public CellRadioUnitRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    CellRadioUnitRequestData cellRadioUnitRequestData = (CellRadioUnitRequestData) o;
    return Objects.equals(this.returnEntityAttributes, cellRadioUnitRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, cellRadioUnitRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, cellRadioUnitRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, cellRadioUnitRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class CellRadioUnitRequestData {\n");
