...
/**
 * StorageUnitLunStorageUnitsEntityRestriction
 */
@JsonPropertyOrder({
  StorageUnitLunStorageUnitsEntityRestriction.JSON_PROPERTY_LIFECYCLE_STATUS_DATE,
  StorageUnitLunStorageUnitsEntityRestriction.JSON_PROPERTY_USED_GB,
  StorageUnitLunStorageUnitsEntityRestriction.JSON_PROPERTY_C_POOL_NAME,
  StorageUnitLunStorageUnitsEntityRestriction.JSON_PROPERTY_LIFECYCLE_STATUS,
  StorageUnitLunStorageUnitsEntityRestriction.JSON_PROPERTY_REDUNDANCY_CLASS,
  StorageUnitLunStorageUnitsEntityRestriction.JSON_PROPERTY_C_STORAGE_CLASS,
  StorageUnitLunStorageUnitsEntityRestriction.JSON_PROPERTY_CAPACITY_GB,
  StorageUnitLunStorageUnitsEntityRestriction.JSON_PROPERTY_REMARK,
  StorageUnitLunStorageUnitsEntityRestriction.JSON_PROPERTY_VISIBLE_ID,
  StorageUnitLunStorageUnitsEntityRestriction.JSON_PROPERTY_ID,
  StorageUnitLunStorageUnitsEntityRestriction.JSON_PROPERTY_REDUNDANCY,
  StorageUnitLunStorageUnitsEntityRestriction.JSON_PROPERTY_ELID
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-01-31T11:10:37.320689708Z[Etc/UTC]")
public class StorageUnitLunStorageUnitsEntityRestriction {
  ...
  public StorageUnitLunStorageUnitsEntityRestriction() {
  }

  public StorageUnitLunStorageUnitsEntityRestriction lifecycleStatusDate(RestrictionsDate lifecycleStatusDate) {
  ...
  **/
  ...
  public StorageUnitLunStorageUnitsEntityRestriction usedGb(RestrictionsNumeric usedGb) {
  ...
  **/
  ...
  public StorageUnitLunStorageUnitsEntityRestriction cPoolName(RestrictionsString cPoolName) {
  ...
  **/
  ...
  public StorageUnitLunStorageUnitsEntityRestriction lifecycleStatus(RestrictionsString lifecycleStatus) {
  ...
  **/
  ...
  public StorageUnitLunStorageUnitsEntityRestriction redundancyClass(RestrictionsString redundancyClass) {
  ...
  **/
  ...
  public StorageUnitLunStorageUnitsEntityRestriction cStorageClass(RestrictionsString cStorageClass) {
  ...
  **/
  ...
  public StorageUnitLunStorageUnitsEntityRestriction capacityGb(RestrictionsNumeric capacityGb) {
  ...
  **/
  ...
  public StorageUnitLunStorageUnitsEntityRestriction remark(RestrictionsString remark) {
  ...
  **/
  ...
  public StorageUnitLunStorageUnitsEntityRestriction visibleId(RestrictionsString visibleId) {
  ...
  **/
  ...
  public StorageUnitLunStorageUnitsEntityRestriction id(RestrictionsString id) {
  ...
  **/
  ...
  public StorageUnitLunStorageUnitsEntityRestriction redundancy(RestrictionsBoolean redundancy) {
  ...
  **/
  ...
  public StorageUnitLunStorageUnitsEntityRestriction elid(RestrictionsString elid) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    StorageUnitLunStorageUnitsEntityRestriction storageUnitLunStorageUnitsEntityRestriction = (StorageUnitLunStorageUnitsEntityRestriction) o;
    return Objects.equals(this.lifecycleStatusDate, storageUnitLunStorageUnitsEntityRestriction.lifecycleStatusDate) &&
        Objects.equals(this.usedGb, storageUnitLunStorageUnitsEntityRestriction.usedGb) &&
        Objects.equals(this.cPoolName, storageUnitLunStorageUnitsEntityRestriction.cPoolName) &&
        Objects.equals(this.lifecycleStatus, storageUnitLunStorageUnitsEntityRestriction.lifecycleStatus) &&
        Objects.equals(this.redundancyClass, storageUnitLunStorageUnitsEntityRestriction.redundancyClass) &&
        Objects.equals(this.cStorageClass, storageUnitLunStorageUnitsEntityRestriction.cStorageClass) &&
        Objects.equals(this.capacityGb, storageUnitLunStorageUnitsEntityRestriction.capacityGb) &&
        Objects.equals(this.remark, storageUnitLunStorageUnitsEntityRestriction.remark) &&
        Objects.equals(this.visibleId, storageUnitLunStorageUnitsEntityRestriction.visibleId) &&
        Objects.equals(this.id, storageUnitLunStorageUnitsEntityRestriction.id) &&
        Objects.equals(this.redundancy, storageUnitLunStorageUnitsEntityRestriction.redundancy) &&
        Objects.equals(this.elid, storageUnitLunStorageUnitsEntityRestriction.elid);
  }
  ...
  public String toString() {
    ...
    sb.append("class StorageUnitLunStorageUnitsEntityRestriction {\n");
