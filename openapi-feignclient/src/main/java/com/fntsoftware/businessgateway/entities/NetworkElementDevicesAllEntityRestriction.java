...
/**
 * NetworkElementDevicesAllEntityRestriction
 */
@JsonPropertyOrder({
  NetworkElementDevicesAllEntityRestriction.JSON_PROPERTY_CLIMATE_RELEVANT,
  NetworkElementDevicesAllEntityRestriction.JSON_PROPERTY_POWER_CONSUMPTION,
  NetworkElementDevicesAllEntityRestriction.JSON_PROPERTY_POWER_SWITCHING_STATUS,
  NetworkElementDevicesAllEntityRestriction.JSON_PROPERTY_PLAN_STATUS,
  NetworkElementDevicesAllEntityRestriction.JSON_PROPERTY_SYSTEM_RUNTIME,
  NetworkElementDevicesAllEntityRestriction.JSON_PROPERTY_WEIGHT,
  NetworkElementDevicesAllEntityRestriction.JSON_PROPERTY_REMARK,
  NetworkElementDevicesAllEntityRestriction.JSON_PROPERTY_ELID,
  NetworkElementDevicesAllEntityRestriction.JSON_PROPERTY_LAST_SEEN,
  NetworkElementDevicesAllEntityRestriction.JSON_PROPERTY_TYPE_ELID,
  NetworkElementDevicesAllEntityRestriction.JSON_PROPERTY_VISIBLE_ID,
  NetworkElementDevicesAllEntityRestriction.JSON_PROPERTY_ID,
  NetworkElementDevicesAllEntityRestriction.JSON_PROPERTY_HEAT_EMISSION
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-03-04T13:31:32.601557352Z[Etc/UTC]")
public class NetworkElementDevicesAllEntityRestriction {
  ...
  public NetworkElementDevicesAllEntityRestriction() {
  }

  public NetworkElementDevicesAllEntityRestriction climateRelevant(RestrictionsBoolean climateRelevant) {
  ...
  **/
  ...
  public NetworkElementDevicesAllEntityRestriction powerConsumption(RestrictionsNumeric powerConsumption) {
  ...
  **/
  ...
  public NetworkElementDevicesAllEntityRestriction powerSwitchingStatus(RestrictionsString powerSwitchingStatus) {
  ...
  **/
  ...
  public NetworkElementDevicesAllEntityRestriction planStatus(RestrictionsString planStatus) {
  ...
  **/
  ...
  public NetworkElementDevicesAllEntityRestriction systemRuntime(RestrictionsNumeric systemRuntime) {
  ...
  **/
  ...
  public NetworkElementDevicesAllEntityRestriction weight(RestrictionsNumeric weight) {
  ...
  **/
  ...
  public NetworkElementDevicesAllEntityRestriction remark(RestrictionsString remark) {
  ...
  **/
  ...
  public NetworkElementDevicesAllEntityRestriction elid(RestrictionsString elid) {
  ...
  **/
  ...
  public NetworkElementDevicesAllEntityRestriction lastSeen(RestrictionsDate lastSeen) {
  ...
  **/
  ...
  public NetworkElementDevicesAllEntityRestriction typeElid(RestrictionsString typeElid) {
  ...
  **/
  ...
  public NetworkElementDevicesAllEntityRestriction visibleId(RestrictionsString visibleId) {
  ...
  **/
  ...
  public NetworkElementDevicesAllEntityRestriction id(RestrictionsString id) {
  ...
  **/
  ...
  public NetworkElementDevicesAllEntityRestriction heatEmission(RestrictionsNumeric heatEmission) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    NetworkElementDevicesAllEntityRestriction networkElementDevicesAllEntityRestriction = (NetworkElementDevicesAllEntityRestriction) o;
    return Objects.equals(this.climateRelevant, networkElementDevicesAllEntityRestriction.climateRelevant) &&
        Objects.equals(this.powerConsumption, networkElementDevicesAllEntityRestriction.powerConsumption) &&
        Objects.equals(this.powerSwitchingStatus, networkElementDevicesAllEntityRestriction.powerSwitchingStatus) &&
        Objects.equals(this.planStatus, networkElementDevicesAllEntityRestriction.planStatus) &&
        Objects.equals(this.systemRuntime, networkElementDevicesAllEntityRestriction.systemRuntime) &&
        Objects.equals(this.weight, networkElementDevicesAllEntityRestriction.weight) &&
        Objects.equals(this.remark, networkElementDevicesAllEntityRestriction.remark) &&
        Objects.equals(this.elid, networkElementDevicesAllEntityRestriction.elid) &&
        Objects.equals(this.lastSeen, networkElementDevicesAllEntityRestriction.lastSeen) &&
        Objects.equals(this.typeElid, networkElementDevicesAllEntityRestriction.typeElid) &&
        Objects.equals(this.visibleId, networkElementDevicesAllEntityRestriction.visibleId) &&
        Objects.equals(this.id, networkElementDevicesAllEntityRestriction.id) &&
        Objects.equals(this.heatEmission, networkElementDevicesAllEntityRestriction.heatEmission);
  }
  ...
  public String toString() {
    ...
    sb.append("class NetworkElementDevicesAllEntityRestriction {\n");
