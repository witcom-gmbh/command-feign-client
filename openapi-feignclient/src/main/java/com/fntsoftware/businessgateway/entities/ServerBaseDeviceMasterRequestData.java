...
import com.fntsoftware.businessgateway.entities.ServerBaseDeviceMasterEntityRestriction;
...
/**
 * ServerBaseDeviceMasterRequestData
 */
@JsonPropertyOrder({
  ServerBaseDeviceMasterRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  ServerBaseDeviceMasterRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  ServerBaseDeviceMasterRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  ServerBaseDeviceMasterRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-01-31T11:10:37.320689708Z[Etc/UTC]")
public class ServerBaseDeviceMasterRequestData {
  ...
  private ServerBaseDeviceMasterEntityRestriction entityRestrictions;
  ...
  public ServerBaseDeviceMasterRequestData() {
  }

  public ServerBaseDeviceMasterRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public ServerBaseDeviceMasterRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public ServerBaseDeviceMasterRequestData entityRestrictions(ServerBaseDeviceMasterEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public ServerBaseDeviceMasterEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(ServerBaseDeviceMasterEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public ServerBaseDeviceMasterRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public ServerBaseDeviceMasterRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public ServerBaseDeviceMasterRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ServerBaseDeviceMasterRequestData serverBaseDeviceMasterRequestData = (ServerBaseDeviceMasterRequestData) o;
    return Objects.equals(this.returnEntityAttributes, serverBaseDeviceMasterRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, serverBaseDeviceMasterRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, serverBaseDeviceMasterRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, serverBaseDeviceMasterRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class ServerBaseDeviceMasterRequestData {\n");
