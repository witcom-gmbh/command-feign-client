...
import com.fntsoftware.businessgateway.entities.ServerDeviceMasterEntityRestriction;
...
/**
 * ServerDeviceMasterRequestData
 */
@JsonPropertyOrder({
  ServerDeviceMasterRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  ServerDeviceMasterRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  ServerDeviceMasterRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  ServerDeviceMasterRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-02-26T11:20:24.990023935Z[Etc/UTC]")
public class ServerDeviceMasterRequestData {
  ...
  private ServerDeviceMasterEntityRestriction entityRestrictions;
  ...
  public ServerDeviceMasterRequestData() {
  }

  public ServerDeviceMasterRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public ServerDeviceMasterRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public ServerDeviceMasterRequestData entityRestrictions(ServerDeviceMasterEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public ServerDeviceMasterEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(ServerDeviceMasterEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public ServerDeviceMasterRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public ServerDeviceMasterRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public ServerDeviceMasterRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ServerDeviceMasterRequestData serverDeviceMasterRequestData = (ServerDeviceMasterRequestData) o;
    return Objects.equals(this.returnEntityAttributes, serverDeviceMasterRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, serverDeviceMasterRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, serverDeviceMasterRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, serverDeviceMasterRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class ServerDeviceMasterRequestData {\n");
