...
import com.fntsoftware.businessgateway.entities.DeviceMasterDeviceTerminalsEntityRestriction;
...
/**
 * DeviceMasterDeviceTerminalsRequestData
 */
@JsonPropertyOrder({
  DeviceMasterDeviceTerminalsRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  DeviceMasterDeviceTerminalsRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  DeviceMasterDeviceTerminalsRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  DeviceMasterDeviceTerminalsRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-02-26T11:20:24.990023935Z[Etc/UTC]")
public class DeviceMasterDeviceTerminalsRequestData {
  ...
  private DeviceMasterDeviceTerminalsEntityRestriction entityRestrictions;
  ...
  public DeviceMasterDeviceTerminalsRequestData() {
  }

  public DeviceMasterDeviceTerminalsRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public DeviceMasterDeviceTerminalsRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public DeviceMasterDeviceTerminalsRequestData entityRestrictions(DeviceMasterDeviceTerminalsEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public DeviceMasterDeviceTerminalsEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(DeviceMasterDeviceTerminalsEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public DeviceMasterDeviceTerminalsRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public DeviceMasterDeviceTerminalsRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public DeviceMasterDeviceTerminalsRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    DeviceMasterDeviceTerminalsRequestData deviceMasterDeviceTerminalsRequestData = (DeviceMasterDeviceTerminalsRequestData) o;
    return Objects.equals(this.returnEntityAttributes, deviceMasterDeviceTerminalsRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, deviceMasterDeviceTerminalsRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, deviceMasterDeviceTerminalsRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, deviceMasterDeviceTerminalsRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeviceMasterDeviceTerminalsRequestData {\n");
