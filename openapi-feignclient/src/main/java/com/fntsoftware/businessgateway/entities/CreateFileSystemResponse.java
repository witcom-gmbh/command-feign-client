...
import com.fntsoftware.businessgateway.entities.CreateFileSystemResponseData;
 ...
 */
@JsonPropertyOrder({
  CreateFileSystemResponse.JSON_PROPERTY_RETURN_DATA,
  CreateFileSystemResponse.JSON_PROPERTY_STATUS
})
...
public class CreateFileSystemResponse {
  ...
  private CreateFileSystemResponseData returnData;
  ...
  public CreateFileSystemResponse returnData(CreateFileSystemResponseData returnData) {
  ...
  **/
  ...
  public CreateFileSystemResponseData getReturnData() {
    return returnData;
  }
  ...
  @JsonProperty(JSON_PROPERTY_RETURN_DATA)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setReturnData(CreateFileSystemResponseData returnData) {
    this.returnData = returnData;
  }


  public CreateFileSystemResponse status(ServiceStatusData status) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.returnData, createFileSystemResponse.returnData) &&
        Objects.equals(this.status, createFileSystemResponse.status);
  }
