...
import com.fntsoftware.businessgateway.entities.TopzoneCampusesEntityRestriction;
import com.fntsoftware.businessgateway.entities.TopzoneCampusesRelationRestriction;
...
/**
 * TopzoneCampusesRequestData
 */
@JsonPropertyOrder({
  TopzoneCampusesRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  TopzoneCampusesRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  TopzoneCampusesRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  TopzoneCampusesRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-02-26T11:20:24.990023935Z[Etc/UTC]")
public class TopzoneCampusesRequestData {
  ...
  private TopzoneCampusesEntityRestriction entityRestrictions;

  public static final String JSON_PROPERTY_RELATION_RESTRICTIONS = "relationRestrictions";
  private TopzoneCampusesRelationRestriction relationRestrictions;
  ...
  public TopzoneCampusesRequestData() {
  }

  public TopzoneCampusesRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public TopzoneCampusesRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public TopzoneCampusesRequestData entityRestrictions(TopzoneCampusesEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public TopzoneCampusesEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(TopzoneCampusesEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public TopzoneCampusesRequestData relationRestrictions(TopzoneCampusesRelationRestriction relationRestrictions) {
  ...
  **/
  ...
  public TopzoneCampusesRelationRestriction getRelationRestrictions() {
    return relationRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_RELATION_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRelationRestrictions(TopzoneCampusesRelationRestriction relationRestrictions) {
    this.relationRestrictions = relationRestrictions;
  }


  public TopzoneCampusesRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public TopzoneCampusesRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    TopzoneCampusesRequestData topzoneCampusesRequestData = (TopzoneCampusesRequestData) o;
    return Objects.equals(this.returnEntityAttributes, topzoneCampusesRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, topzoneCampusesRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, topzoneCampusesRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, topzoneCampusesRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class TopzoneCampusesRequestData {\n");
