...
/**
 * DeviceMiscSlotEntityRestriction
 */
@JsonPropertyOrder({
  DeviceMiscSlotEntityRestriction.JSON_PROPERTY_CLIMATE_RELEVANT,
  DeviceMiscSlotEntityRestriction.JSON_PROPERTY_POWER_CONSUMPTION,
  DeviceMiscSlotEntityRestriction.JSON_PROPERTY_POWER_SWITCHING_STATUS,
  DeviceMiscSlotEntityRestriction.JSON_PROPERTY_PLAN_STATUS,
  DeviceMiscSlotEntityRestriction.JSON_PROPERTY_SYSTEM_RUNTIME,
  DeviceMiscSlotEntityRestriction.JSON_PROPERTY_WEIGHT,
  DeviceMiscSlotEntityRestriction.JSON_PROPERTY_REMARK,
  DeviceMiscSlotEntityRestriction.JSON_PROPERTY_ELID,
  DeviceMiscSlotEntityRestriction.JSON_PROPERTY_LAST_SEEN,
  DeviceMiscSlotEntityRestriction.JSON_PROPERTY_TYPE_ELID,
  DeviceMiscSlotEntityRestriction.JSON_PROPERTY_VISIBLE_ID,
  DeviceMiscSlotEntityRestriction.JSON_PROPERTY_ID,
  DeviceMiscSlotEntityRestriction.JSON_PROPERTY_HEAT_EMISSION
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-03-04T13:31:32.601557352Z[Etc/UTC]")
public class DeviceMiscSlotEntityRestriction {
  ...
  public DeviceMiscSlotEntityRestriction() {
  }

  public DeviceMiscSlotEntityRestriction climateRelevant(RestrictionsBoolean climateRelevant) {
  ...
  **/
  ...
  public DeviceMiscSlotEntityRestriction powerConsumption(RestrictionsNumeric powerConsumption) {
  ...
  **/
  ...
  public DeviceMiscSlotEntityRestriction powerSwitchingStatus(RestrictionsString powerSwitchingStatus) {
  ...
  **/
  ...
  public DeviceMiscSlotEntityRestriction planStatus(RestrictionsString planStatus) {
  ...
  **/
  ...
  public DeviceMiscSlotEntityRestriction systemRuntime(RestrictionsNumeric systemRuntime) {
  ...
  **/
  ...
  public DeviceMiscSlotEntityRestriction weight(RestrictionsNumeric weight) {
  ...
  **/
  ...
  public DeviceMiscSlotEntityRestriction remark(RestrictionsString remark) {
  ...
  **/
  ...
  public DeviceMiscSlotEntityRestriction elid(RestrictionsString elid) {
  ...
  **/
  ...
  public DeviceMiscSlotEntityRestriction lastSeen(RestrictionsDate lastSeen) {
  ...
  **/
  ...
  public DeviceMiscSlotEntityRestriction typeElid(RestrictionsString typeElid) {
  ...
  **/
  ...
  public DeviceMiscSlotEntityRestriction visibleId(RestrictionsString visibleId) {
  ...
  **/
  ...
  public DeviceMiscSlotEntityRestriction id(RestrictionsString id) {
  ...
  **/
  ...
  public DeviceMiscSlotEntityRestriction heatEmission(RestrictionsNumeric heatEmission) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    DeviceMiscSlotEntityRestriction deviceMiscSlotEntityRestriction = (DeviceMiscSlotEntityRestriction) o;
    return Objects.equals(this.climateRelevant, deviceMiscSlotEntityRestriction.climateRelevant) &&
        Objects.equals(this.powerConsumption, deviceMiscSlotEntityRestriction.powerConsumption) &&
        Objects.equals(this.powerSwitchingStatus, deviceMiscSlotEntityRestriction.powerSwitchingStatus) &&
        Objects.equals(this.planStatus, deviceMiscSlotEntityRestriction.planStatus) &&
        Objects.equals(this.systemRuntime, deviceMiscSlotEntityRestriction.systemRuntime) &&
        Objects.equals(this.weight, deviceMiscSlotEntityRestriction.weight) &&
        Objects.equals(this.remark, deviceMiscSlotEntityRestriction.remark) &&
        Objects.equals(this.elid, deviceMiscSlotEntityRestriction.elid) &&
        Objects.equals(this.lastSeen, deviceMiscSlotEntityRestriction.lastSeen) &&
        Objects.equals(this.typeElid, deviceMiscSlotEntityRestriction.typeElid) &&
        Objects.equals(this.visibleId, deviceMiscSlotEntityRestriction.visibleId) &&
        Objects.equals(this.id, deviceMiscSlotEntityRestriction.id) &&
        Objects.equals(this.heatEmission, deviceMiscSlotEntityRestriction.heatEmission);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeviceMiscSlotEntityRestriction {\n");
