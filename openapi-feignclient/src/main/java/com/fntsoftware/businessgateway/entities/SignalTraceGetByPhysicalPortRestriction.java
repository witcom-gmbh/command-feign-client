...
public class SignalTraceGetByPhysicalPortRestriction {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(fetchBaseInfo, deviceAllElid, socketCategory, fetchAdditionalInfo, fetchLocation, socketSide, socketSubNo, hops, socketNo, fetchParentDevices);
  }
