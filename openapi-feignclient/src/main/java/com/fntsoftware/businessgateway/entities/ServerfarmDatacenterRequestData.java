...
import com.fntsoftware.businessgateway.entities.ServerfarmDatacenterEntityRestriction;
...
/**
 * ServerfarmDatacenterRequestData
 */
@JsonPropertyOrder({
  ServerfarmDatacenterRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  ServerfarmDatacenterRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  ServerfarmDatacenterRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  ServerfarmDatacenterRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-02-26T11:20:24.990023935Z[Etc/UTC]")
public class ServerfarmDatacenterRequestData {
  ...
  private ServerfarmDatacenterEntityRestriction entityRestrictions;
  ...
  public ServerfarmDatacenterRequestData() {
  }

  public ServerfarmDatacenterRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public ServerfarmDatacenterRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public ServerfarmDatacenterRequestData entityRestrictions(ServerfarmDatacenterEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public ServerfarmDatacenterEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(ServerfarmDatacenterEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public ServerfarmDatacenterRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public ServerfarmDatacenterRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public ServerfarmDatacenterRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ServerfarmDatacenterRequestData serverfarmDatacenterRequestData = (ServerfarmDatacenterRequestData) o;
    return Objects.equals(this.returnEntityAttributes, serverfarmDatacenterRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, serverfarmDatacenterRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, serverfarmDatacenterRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, serverfarmDatacenterRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class ServerfarmDatacenterRequestData {\n");
