...
import com.fntsoftware.businessgateway.entities.UserPersonEntityRestriction;
...
/**
 * UserPersonRequestData
 */
@JsonPropertyOrder({
  UserPersonRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  UserPersonRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  UserPersonRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  UserPersonRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-02-26T11:20:24.990023935Z[Etc/UTC]")
public class UserPersonRequestData {
  ...
  private UserPersonEntityRestriction entityRestrictions;
  ...
  public UserPersonRequestData() {
  }

  public UserPersonRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public UserPersonRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public UserPersonRequestData entityRestrictions(UserPersonEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public UserPersonEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(UserPersonEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public UserPersonRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public UserPersonRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public UserPersonRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    UserPersonRequestData userPersonRequestData = (UserPersonRequestData) o;
    return Objects.equals(this.returnEntityAttributes, userPersonRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, userPersonRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, userPersonRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, userPersonRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class UserPersonRequestData {\n");
