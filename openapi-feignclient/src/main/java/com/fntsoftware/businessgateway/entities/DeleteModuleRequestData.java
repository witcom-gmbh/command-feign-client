...
/**
 * DeleteModuleRequestData
 */
@JsonPropertyOrder({
  DeleteModuleRequestData.JSON_PROPERTY_RELEASE_SIGNALPATH,
  DeleteModuleRequestData.JSON_PROPERTY_RELEASE_CONNECTIONS,
  DeleteModuleRequestData.JSON_PROPERTY_RELEASE_SERVICE,
  DeleteModuleRequestData.JSON_PROPERTY_CONTEXT_ID,
  DeleteModuleRequestData.JSON_PROPERTY_RELEASE_PATCHES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-02-26T11:20:24.990023935Z[Etc/UTC]")
public class DeleteModuleRequestData {
  ...
  public DeleteModuleRequestData() {
  }

  public DeleteModuleRequestData releaseSignalpath(Boolean releaseSignalpath) {
  ...
  **/
  ...
  public DeleteModuleRequestData releaseConnections(Boolean releaseConnections) {
  ...
  **/
  ...
  public DeleteModuleRequestData releaseService(Boolean releaseService) {
  ...
  **/
  ...
  public DeleteModuleRequestData contextId(String contextId) {
  ...
  **/
  ...
  public DeleteModuleRequestData releasePatches(Boolean releasePatches) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    DeleteModuleRequestData deleteModuleRequestData = (DeleteModuleRequestData) o;
    return Objects.equals(this.releaseSignalpath, deleteModuleRequestData.releaseSignalpath) &&
        Objects.equals(this.releaseConnections, deleteModuleRequestData.releaseConnections) &&
        Objects.equals(this.releaseService, deleteModuleRequestData.releaseService) &&
        Objects.equals(this.contextId, deleteModuleRequestData.contextId) &&
        Objects.equals(this.releasePatches, deleteModuleRequestData.releasePatches);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeleteModuleRequestData {\n");
