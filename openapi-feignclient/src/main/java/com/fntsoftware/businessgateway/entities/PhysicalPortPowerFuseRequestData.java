...
import com.fntsoftware.businessgateway.entities.PhysicalPortPowerFuseEntityRestriction;
...
/**
 * PhysicalPortPowerFuseRequestData
 */
@JsonPropertyOrder({
  PhysicalPortPowerFuseRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  PhysicalPortPowerFuseRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  PhysicalPortPowerFuseRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  PhysicalPortPowerFuseRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-01-31T11:10:37.320689708Z[Etc/UTC]")
public class PhysicalPortPowerFuseRequestData {
  ...
  private PhysicalPortPowerFuseEntityRestriction entityRestrictions;
  ...
  public PhysicalPortPowerFuseRequestData() {
  }

  public PhysicalPortPowerFuseRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public PhysicalPortPowerFuseRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public PhysicalPortPowerFuseRequestData entityRestrictions(PhysicalPortPowerFuseEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public PhysicalPortPowerFuseEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(PhysicalPortPowerFuseEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public PhysicalPortPowerFuseRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public PhysicalPortPowerFuseRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public PhysicalPortPowerFuseRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    PhysicalPortPowerFuseRequestData physicalPortPowerFuseRequestData = (PhysicalPortPowerFuseRequestData) o;
    return Objects.equals(this.returnEntityAttributes, physicalPortPowerFuseRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, physicalPortPowerFuseRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, physicalPortPowerFuseRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, physicalPortPowerFuseRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class PhysicalPortPowerFuseRequestData {\n");
