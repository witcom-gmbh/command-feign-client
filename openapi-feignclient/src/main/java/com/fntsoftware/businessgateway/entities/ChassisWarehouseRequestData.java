...
import com.fntsoftware.businessgateway.entities.ChassisWarehouseEntityRestriction;
...
/**
 * ChassisWarehouseRequestData
 */
@JsonPropertyOrder({
  ChassisWarehouseRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  ChassisWarehouseRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  ChassisWarehouseRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  ChassisWarehouseRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
...
public class ChassisWarehouseRequestData {
  ...
  private ChassisWarehouseEntityRestriction entityRestrictions;
  ...
  public ChassisWarehouseRequestData() {
  }

  public ChassisWarehouseRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public ChassisWarehouseRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public ChassisWarehouseRequestData entityRestrictions(ChassisWarehouseEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public ChassisWarehouseEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(ChassisWarehouseEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public ChassisWarehouseRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public ChassisWarehouseRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public ChassisWarehouseRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ChassisWarehouseRequestData chassisWarehouseRequestData = (ChassisWarehouseRequestData) o;
    return Objects.equals(this.returnEntityAttributes, chassisWarehouseRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, chassisWarehouseRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, chassisWarehouseRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, chassisWarehouseRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class ChassisWarehouseRequestData {\n");
