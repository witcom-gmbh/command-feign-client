...
import com.fntsoftware.businessgateway.entities.VirtualNetworkCardVirtualServerEntityRestriction;
...
/**
 * VirtualNetworkCardVirtualServerRequestData
 */
@JsonPropertyOrder({
  VirtualNetworkCardVirtualServerRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  VirtualNetworkCardVirtualServerRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  VirtualNetworkCardVirtualServerRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  VirtualNetworkCardVirtualServerRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-03-04T13:31:32.601557352Z[Etc/UTC]")
public class VirtualNetworkCardVirtualServerRequestData {
  ...
  private VirtualNetworkCardVirtualServerEntityRestriction entityRestrictions;
  ...
  public VirtualNetworkCardVirtualServerRequestData() {
  }

  public VirtualNetworkCardVirtualServerRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public VirtualNetworkCardVirtualServerRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public VirtualNetworkCardVirtualServerRequestData entityRestrictions(VirtualNetworkCardVirtualServerEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public VirtualNetworkCardVirtualServerEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(VirtualNetworkCardVirtualServerEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public VirtualNetworkCardVirtualServerRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public VirtualNetworkCardVirtualServerRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public VirtualNetworkCardVirtualServerRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    VirtualNetworkCardVirtualServerRequestData virtualNetworkCardVirtualServerRequestData = (VirtualNetworkCardVirtualServerRequestData) o;
    return Objects.equals(this.returnEntityAttributes, virtualNetworkCardVirtualServerRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, virtualNetworkCardVirtualServerRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, virtualNetworkCardVirtualServerRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, virtualNetworkCardVirtualServerRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class VirtualNetworkCardVirtualServerRequestData {\n");
