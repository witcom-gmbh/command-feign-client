...
/**
 * LogicalGroupDevicesAllEntityRestriction
 */
@JsonPropertyOrder({
  LogicalGroupDevicesAllEntityRestriction.JSON_PROPERTY_CLIMATE_RELEVANT,
  LogicalGroupDevicesAllEntityRestriction.JSON_PROPERTY_POWER_CONSUMPTION,
  LogicalGroupDevicesAllEntityRestriction.JSON_PROPERTY_POWER_SWITCHING_STATUS,
  LogicalGroupDevicesAllEntityRestriction.JSON_PROPERTY_PLAN_STATUS,
  LogicalGroupDevicesAllEntityRestriction.JSON_PROPERTY_SYSTEM_RUNTIME,
  LogicalGroupDevicesAllEntityRestriction.JSON_PROPERTY_WEIGHT,
  LogicalGroupDevicesAllEntityRestriction.JSON_PROPERTY_REMARK,
  LogicalGroupDevicesAllEntityRestriction.JSON_PROPERTY_ELID,
  LogicalGroupDevicesAllEntityRestriction.JSON_PROPERTY_LAST_SEEN,
  LogicalGroupDevicesAllEntityRestriction.JSON_PROPERTY_TYPE_ELID,
  LogicalGroupDevicesAllEntityRestriction.JSON_PROPERTY_VISIBLE_ID,
  LogicalGroupDevicesAllEntityRestriction.JSON_PROPERTY_ID,
  LogicalGroupDevicesAllEntityRestriction.JSON_PROPERTY_HEAT_EMISSION
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-01-31T11:10:37.320689708Z[Etc/UTC]")
public class LogicalGroupDevicesAllEntityRestriction {
  ...
  public LogicalGroupDevicesAllEntityRestriction() {
  }

  public LogicalGroupDevicesAllEntityRestriction climateRelevant(RestrictionsBoolean climateRelevant) {
  ...
  **/
  ...
  public LogicalGroupDevicesAllEntityRestriction powerConsumption(RestrictionsNumeric powerConsumption) {
  ...
  **/
  ...
  public LogicalGroupDevicesAllEntityRestriction powerSwitchingStatus(RestrictionsString powerSwitchingStatus) {
  ...
  **/
  ...
  public LogicalGroupDevicesAllEntityRestriction planStatus(RestrictionsString planStatus) {
  ...
  **/
  ...
  public LogicalGroupDevicesAllEntityRestriction systemRuntime(RestrictionsNumeric systemRuntime) {
  ...
  **/
  ...
  public LogicalGroupDevicesAllEntityRestriction weight(RestrictionsNumeric weight) {
  ...
  **/
  ...
  public LogicalGroupDevicesAllEntityRestriction remark(RestrictionsString remark) {
  ...
  **/
  ...
  public LogicalGroupDevicesAllEntityRestriction elid(RestrictionsString elid) {
  ...
  **/
  ...
  public LogicalGroupDevicesAllEntityRestriction lastSeen(RestrictionsDate lastSeen) {
  ...
  **/
  ...
  public LogicalGroupDevicesAllEntityRestriction typeElid(RestrictionsString typeElid) {
  ...
  **/
  ...
  public LogicalGroupDevicesAllEntityRestriction visibleId(RestrictionsString visibleId) {
  ...
  **/
  ...
  public LogicalGroupDevicesAllEntityRestriction id(RestrictionsString id) {
  ...
  **/
  ...
  public LogicalGroupDevicesAllEntityRestriction heatEmission(RestrictionsNumeric heatEmission) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    LogicalGroupDevicesAllEntityRestriction logicalGroupDevicesAllEntityRestriction = (LogicalGroupDevicesAllEntityRestriction) o;
    return Objects.equals(this.climateRelevant, logicalGroupDevicesAllEntityRestriction.climateRelevant) &&
        Objects.equals(this.powerConsumption, logicalGroupDevicesAllEntityRestriction.powerConsumption) &&
        Objects.equals(this.powerSwitchingStatus, logicalGroupDevicesAllEntityRestriction.powerSwitchingStatus) &&
        Objects.equals(this.planStatus, logicalGroupDevicesAllEntityRestriction.planStatus) &&
        Objects.equals(this.systemRuntime, logicalGroupDevicesAllEntityRestriction.systemRuntime) &&
        Objects.equals(this.weight, logicalGroupDevicesAllEntityRestriction.weight) &&
        Objects.equals(this.remark, logicalGroupDevicesAllEntityRestriction.remark) &&
        Objects.equals(this.elid, logicalGroupDevicesAllEntityRestriction.elid) &&
        Objects.equals(this.lastSeen, logicalGroupDevicesAllEntityRestriction.lastSeen) &&
        Objects.equals(this.typeElid, logicalGroupDevicesAllEntityRestriction.typeElid) &&
        Objects.equals(this.visibleId, logicalGroupDevicesAllEntityRestriction.visibleId) &&
        Objects.equals(this.id, logicalGroupDevicesAllEntityRestriction.id) &&
        Objects.equals(this.heatEmission, logicalGroupDevicesAllEntityRestriction.heatEmission);
  }
  ...
  public String toString() {
    ...
    sb.append("class LogicalGroupDevicesAllEntityRestriction {\n");
