...
import com.fntsoftware.businessgateway.entities.CellNetworkFunctionEntityRestriction;
...
/**
 * CellNetworkFunctionRequestData
 */
@JsonPropertyOrder({
  CellNetworkFunctionRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  CellNetworkFunctionRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  CellNetworkFunctionRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  CellNetworkFunctionRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-02-26T11:20:24.990023935Z[Etc/UTC]")
public class CellNetworkFunctionRequestData {
  ...
  private CellNetworkFunctionEntityRestriction entityRestrictions;
  ...
  public CellNetworkFunctionRequestData() {
  }

  public CellNetworkFunctionRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public CellNetworkFunctionRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public CellNetworkFunctionRequestData entityRestrictions(CellNetworkFunctionEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public CellNetworkFunctionEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(CellNetworkFunctionEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public CellNetworkFunctionRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public CellNetworkFunctionRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public CellNetworkFunctionRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    CellNetworkFunctionRequestData cellNetworkFunctionRequestData = (CellNetworkFunctionRequestData) o;
    return Objects.equals(this.returnEntityAttributes, cellNetworkFunctionRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, cellNetworkFunctionRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, cellNetworkFunctionRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, cellNetworkFunctionRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class CellNetworkFunctionRequestData {\n");
