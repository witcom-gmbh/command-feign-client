...
import com.fntsoftware.businessgateway.entities.MultiDuctMultiDuctTypeEntityRestriction;
...
/**
 * MultiDuctMultiDuctTypeRequestData
 */
@JsonPropertyOrder({
  MultiDuctMultiDuctTypeRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  MultiDuctMultiDuctTypeRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  MultiDuctMultiDuctTypeRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  MultiDuctMultiDuctTypeRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-01-31T11:10:37.320689708Z[Etc/UTC]")
public class MultiDuctMultiDuctTypeRequestData {
  ...
  private MultiDuctMultiDuctTypeEntityRestriction entityRestrictions;
  ...
  public MultiDuctMultiDuctTypeRequestData() {
  }

  public MultiDuctMultiDuctTypeRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public MultiDuctMultiDuctTypeRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public MultiDuctMultiDuctTypeRequestData entityRestrictions(MultiDuctMultiDuctTypeEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public MultiDuctMultiDuctTypeEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(MultiDuctMultiDuctTypeEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public MultiDuctMultiDuctTypeRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public MultiDuctMultiDuctTypeRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public MultiDuctMultiDuctTypeRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    MultiDuctMultiDuctTypeRequestData multiDuctMultiDuctTypeRequestData = (MultiDuctMultiDuctTypeRequestData) o;
    return Objects.equals(this.returnEntityAttributes, multiDuctMultiDuctTypeRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, multiDuctMultiDuctTypeRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, multiDuctMultiDuctTypeRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, multiDuctMultiDuctTypeRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class MultiDuctMultiDuctTypeRequestData {\n");
