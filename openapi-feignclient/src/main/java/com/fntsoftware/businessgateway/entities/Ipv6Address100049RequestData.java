...
import com.fntsoftware.businessgateway.entities.Ipv6Address100049EntityRestriction;
...
/**
 * Ipv6Address100049RequestData
 */
@JsonPropertyOrder({
  Ipv6Address100049RequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  Ipv6Address100049RequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  Ipv6Address100049RequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  Ipv6Address100049RequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-03-04T13:31:32.601557352Z[Etc/UTC]")
public class Ipv6Address100049RequestData {
  ...
  private Ipv6Address100049EntityRestriction entityRestrictions;
  ...
  public Ipv6Address100049RequestData() {
  }

  public Ipv6Address100049RequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public Ipv6Address100049RequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public Ipv6Address100049RequestData entityRestrictions(Ipv6Address100049EntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public Ipv6Address100049EntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(Ipv6Address100049EntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public Ipv6Address100049RequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public Ipv6Address100049RequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public Ipv6Address100049RequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    Ipv6Address100049RequestData ipv6Address100049RequestData = (Ipv6Address100049RequestData) o;
    return Objects.equals(this.returnEntityAttributes, ipv6Address100049RequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, ipv6Address100049RequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, ipv6Address100049RequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, ipv6Address100049RequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class Ipv6Address100049RequestData {\n");
