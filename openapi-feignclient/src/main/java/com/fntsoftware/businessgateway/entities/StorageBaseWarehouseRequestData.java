...
import com.fntsoftware.businessgateway.entities.StorageBaseWarehouseEntityRestriction;
...
/**
 * StorageBaseWarehouseRequestData
 */
@JsonPropertyOrder({
  StorageBaseWarehouseRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  StorageBaseWarehouseRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  StorageBaseWarehouseRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  StorageBaseWarehouseRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-01-31T11:10:37.320689708Z[Etc/UTC]")
public class StorageBaseWarehouseRequestData {
  ...
  private StorageBaseWarehouseEntityRestriction entityRestrictions;
  ...
  public StorageBaseWarehouseRequestData() {
  }

  public StorageBaseWarehouseRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public StorageBaseWarehouseRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public StorageBaseWarehouseRequestData entityRestrictions(StorageBaseWarehouseEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public StorageBaseWarehouseEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(StorageBaseWarehouseEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public StorageBaseWarehouseRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public StorageBaseWarehouseRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public StorageBaseWarehouseRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    StorageBaseWarehouseRequestData storageBaseWarehouseRequestData = (StorageBaseWarehouseRequestData) o;
    return Objects.equals(this.returnEntityAttributes, storageBaseWarehouseRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, storageBaseWarehouseRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, storageBaseWarehouseRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, storageBaseWarehouseRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class StorageBaseWarehouseRequestData {\n");
