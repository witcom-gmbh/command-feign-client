...
import com.fntsoftware.businessgateway.entities.FrameContractSoftwareInstanceWebEntityRestriction;
...
/**
 * FrameContractSoftwareInstanceWebRequestData
 */
@JsonPropertyOrder({
  FrameContractSoftwareInstanceWebRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  FrameContractSoftwareInstanceWebRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  FrameContractSoftwareInstanceWebRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  FrameContractSoftwareInstanceWebRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-02-26T11:20:24.990023935Z[Etc/UTC]")
public class FrameContractSoftwareInstanceWebRequestData {
  ...
  private FrameContractSoftwareInstanceWebEntityRestriction entityRestrictions;
  ...
  public FrameContractSoftwareInstanceWebRequestData() {
  }

  public FrameContractSoftwareInstanceWebRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public FrameContractSoftwareInstanceWebRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public FrameContractSoftwareInstanceWebRequestData entityRestrictions(FrameContractSoftwareInstanceWebEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public FrameContractSoftwareInstanceWebEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(FrameContractSoftwareInstanceWebEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public FrameContractSoftwareInstanceWebRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public FrameContractSoftwareInstanceWebRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public FrameContractSoftwareInstanceWebRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    FrameContractSoftwareInstanceWebRequestData frameContractSoftwareInstanceWebRequestData = (FrameContractSoftwareInstanceWebRequestData) o;
    return Objects.equals(this.returnEntityAttributes, frameContractSoftwareInstanceWebRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, frameContractSoftwareInstanceWebRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, frameContractSoftwareInstanceWebRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, frameContractSoftwareInstanceWebRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class FrameContractSoftwareInstanceWebRequestData {\n");
