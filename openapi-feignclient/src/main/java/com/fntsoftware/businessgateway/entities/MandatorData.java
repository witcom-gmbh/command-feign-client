 ...
 */
@JsonPropertyOrder({
  MandatorData.JSON_PROPERTY_USE_OWNER_FROM_ZONE,
  MandatorData.JSON_PROPERTY_IS_PROTECTED,
  MandatorData.JSON_PROPERTY_MAN_ID,
  MandatorData.JSON_PROPERTY_DESCRIPTION,
  MandatorData.JSON_PROPERTY_ROLE_ADDITION
})
@JsonTypeName("mandatorData")
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-01-31T11:10:37.320689708Z[Etc/UTC]")
public class MandatorData {
  ...
  public MandatorData useOwnerFromZone(Boolean useOwnerFromZone) {
  ...
  **/
  ...
  public MandatorData isProtected(Boolean isProtected) {
  ...
  **/
  ...
  public MandatorData manId(BigDecimal manId) {
  ...
  **/
  ...
  public MandatorData description(String description) {
  ...
  **/
  ...
  public MandatorData roleAddition(Boolean roleAddition) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    MandatorData mandatorData = (MandatorData) o;
    return Objects.equals(this.useOwnerFromZone, mandatorData.useOwnerFromZone) &&
        Objects.equals(this.isProtected, mandatorData.isProtected) &&
        Objects.equals(this.manId, mandatorData.manId) &&
        Objects.equals(this.description, mandatorData.description) &&
        Objects.equals(this.roleAddition, mandatorData.roleAddition);
  }
