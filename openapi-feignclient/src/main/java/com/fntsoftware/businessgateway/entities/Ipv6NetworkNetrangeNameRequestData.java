...
import com.fntsoftware.businessgateway.entities.Ipv6NetworkNetrangeNameEntityRestriction;
...
/**
 * Ipv6NetworkNetrangeNameRequestData
 */
@JsonPropertyOrder({
  Ipv6NetworkNetrangeNameRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  Ipv6NetworkNetrangeNameRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  Ipv6NetworkNetrangeNameRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  Ipv6NetworkNetrangeNameRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-01-31T11:10:37.320689708Z[Etc/UTC]")
public class Ipv6NetworkNetrangeNameRequestData {
  ...
  private Ipv6NetworkNetrangeNameEntityRestriction entityRestrictions;
  ...
  public Ipv6NetworkNetrangeNameRequestData() {
  }

  public Ipv6NetworkNetrangeNameRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public Ipv6NetworkNetrangeNameRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public Ipv6NetworkNetrangeNameRequestData entityRestrictions(Ipv6NetworkNetrangeNameEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public Ipv6NetworkNetrangeNameEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(Ipv6NetworkNetrangeNameEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public Ipv6NetworkNetrangeNameRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public Ipv6NetworkNetrangeNameRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public Ipv6NetworkNetrangeNameRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    Ipv6NetworkNetrangeNameRequestData ipv6NetworkNetrangeNameRequestData = (Ipv6NetworkNetrangeNameRequestData) o;
    return Objects.equals(this.returnEntityAttributes, ipv6NetworkNetrangeNameRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, ipv6NetworkNetrangeNameRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, ipv6NetworkNetrangeNameRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, ipv6NetworkNetrangeNameRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class Ipv6NetworkNetrangeNameRequestData {\n");
