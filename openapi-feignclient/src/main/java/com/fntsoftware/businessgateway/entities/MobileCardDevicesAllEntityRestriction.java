...
/**
 * MobileCardDevicesAllEntityRestriction
 */
@JsonPropertyOrder({
  MobileCardDevicesAllEntityRestriction.JSON_PROPERTY_CLIMATE_RELEVANT,
  MobileCardDevicesAllEntityRestriction.JSON_PROPERTY_LAST_SEEN,
  MobileCardDevicesAllEntityRestriction.JSON_PROPERTY_POWER_CONSUMPTION,
  MobileCardDevicesAllEntityRestriction.JSON_PROPERTY_POWER_SWITCHING_STATUS,
  MobileCardDevicesAllEntityRestriction.JSON_PROPERTY_TYPE_ELID,
  MobileCardDevicesAllEntityRestriction.JSON_PROPERTY_SYSTEM_RUNTIME,
  MobileCardDevicesAllEntityRestriction.JSON_PROPERTY_WEIGHT,
  MobileCardDevicesAllEntityRestriction.JSON_PROPERTY_REMARK,
  MobileCardDevicesAllEntityRestriction.JSON_PROPERTY_VISIBLE_ID,
  MobileCardDevicesAllEntityRestriction.JSON_PROPERTY_ID,
  MobileCardDevicesAllEntityRestriction.JSON_PROPERTY_HEAT_EMISSION,
  MobileCardDevicesAllEntityRestriction.JSON_PROPERTY_ELID
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-02-26T11:20:24.990023935Z[Etc/UTC]")
public class MobileCardDevicesAllEntityRestriction {
  ...
  public MobileCardDevicesAllEntityRestriction() {
  }

  public MobileCardDevicesAllEntityRestriction climateRelevant(RestrictionsBoolean climateRelevant) {
  ...
  **/
  ...
  public MobileCardDevicesAllEntityRestriction lastSeen(RestrictionsDate lastSeen) {
  ...
  **/
  ...
  public MobileCardDevicesAllEntityRestriction powerConsumption(RestrictionsNumeric powerConsumption) {
  ...
  **/
  ...
  public MobileCardDevicesAllEntityRestriction powerSwitchingStatus(RestrictionsString powerSwitchingStatus) {
  ...
  **/
  ...
  public MobileCardDevicesAllEntityRestriction typeElid(RestrictionsString typeElid) {
  ...
  **/
  ...
  public MobileCardDevicesAllEntityRestriction systemRuntime(RestrictionsNumeric systemRuntime) {
  ...
  **/
  ...
  public MobileCardDevicesAllEntityRestriction weight(RestrictionsNumeric weight) {
  ...
  **/
  ...
  public MobileCardDevicesAllEntityRestriction remark(RestrictionsString remark) {
  ...
  **/
  ...
  public MobileCardDevicesAllEntityRestriction visibleId(RestrictionsString visibleId) {
  ...
  **/
  ...
  public MobileCardDevicesAllEntityRestriction id(RestrictionsString id) {
  ...
  **/
  ...
  public MobileCardDevicesAllEntityRestriction heatEmission(RestrictionsNumeric heatEmission) {
  ...
  **/
  ...
  public MobileCardDevicesAllEntityRestriction elid(RestrictionsString elid) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    MobileCardDevicesAllEntityRestriction mobileCardDevicesAllEntityRestriction = (MobileCardDevicesAllEntityRestriction) o;
    return Objects.equals(this.climateRelevant, mobileCardDevicesAllEntityRestriction.climateRelevant) &&
        Objects.equals(this.lastSeen, mobileCardDevicesAllEntityRestriction.lastSeen) &&
        Objects.equals(this.powerConsumption, mobileCardDevicesAllEntityRestriction.powerConsumption) &&
        Objects.equals(this.powerSwitchingStatus, mobileCardDevicesAllEntityRestriction.powerSwitchingStatus) &&
        Objects.equals(this.typeElid, mobileCardDevicesAllEntityRestriction.typeElid) &&
        Objects.equals(this.systemRuntime, mobileCardDevicesAllEntityRestriction.systemRuntime) &&
        Objects.equals(this.weight, mobileCardDevicesAllEntityRestriction.weight) &&
        Objects.equals(this.remark, mobileCardDevicesAllEntityRestriction.remark) &&
        Objects.equals(this.visibleId, mobileCardDevicesAllEntityRestriction.visibleId) &&
        Objects.equals(this.id, mobileCardDevicesAllEntityRestriction.id) &&
        Objects.equals(this.heatEmission, mobileCardDevicesAllEntityRestriction.heatEmission) &&
        Objects.equals(this.elid, mobileCardDevicesAllEntityRestriction.elid);
  }
  ...
  public String toString() {
    ...
    sb.append("class MobileCardDevicesAllEntityRestriction {\n");
