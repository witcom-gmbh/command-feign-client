...
import com.fntsoftware.businessgateway.entities.DeviceMiscPhysicalPortsPowerEntityRestriction;
...
/**
 * DeviceMiscPhysicalPortsPowerRequestData
 */
@JsonPropertyOrder({
  DeviceMiscPhysicalPortsPowerRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  DeviceMiscPhysicalPortsPowerRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  DeviceMiscPhysicalPortsPowerRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  DeviceMiscPhysicalPortsPowerRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-01-31T11:10:37.320689708Z[Etc/UTC]")
public class DeviceMiscPhysicalPortsPowerRequestData {
  ...
  private DeviceMiscPhysicalPortsPowerEntityRestriction entityRestrictions;
  ...
  public DeviceMiscPhysicalPortsPowerRequestData() {
  }

  public DeviceMiscPhysicalPortsPowerRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public DeviceMiscPhysicalPortsPowerRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public DeviceMiscPhysicalPortsPowerRequestData entityRestrictions(DeviceMiscPhysicalPortsPowerEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public DeviceMiscPhysicalPortsPowerEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(DeviceMiscPhysicalPortsPowerEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public DeviceMiscPhysicalPortsPowerRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public DeviceMiscPhysicalPortsPowerRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public DeviceMiscPhysicalPortsPowerRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    DeviceMiscPhysicalPortsPowerRequestData deviceMiscPhysicalPortsPowerRequestData = (DeviceMiscPhysicalPortsPowerRequestData) o;
    return Objects.equals(this.returnEntityAttributes, deviceMiscPhysicalPortsPowerRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, deviceMiscPhysicalPortsPowerRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, deviceMiscPhysicalPortsPowerRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, deviceMiscPhysicalPortsPowerRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeviceMiscPhysicalPortsPowerRequestData {\n");
