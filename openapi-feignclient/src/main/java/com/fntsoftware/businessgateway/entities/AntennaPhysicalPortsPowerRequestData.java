...
import com.fntsoftware.businessgateway.entities.AntennaPhysicalPortsPowerEntityRestriction;
...
/**
 * AntennaPhysicalPortsPowerRequestData
 */
@JsonPropertyOrder({
  AntennaPhysicalPortsPowerRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  AntennaPhysicalPortsPowerRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  AntennaPhysicalPortsPowerRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  AntennaPhysicalPortsPowerRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-01-31T11:10:37.320689708Z[Etc/UTC]")
public class AntennaPhysicalPortsPowerRequestData {
  ...
  private AntennaPhysicalPortsPowerEntityRestriction entityRestrictions;
  ...
  public AntennaPhysicalPortsPowerRequestData() {
  }

  public AntennaPhysicalPortsPowerRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public AntennaPhysicalPortsPowerRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public AntennaPhysicalPortsPowerRequestData entityRestrictions(AntennaPhysicalPortsPowerEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public AntennaPhysicalPortsPowerEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(AntennaPhysicalPortsPowerEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public AntennaPhysicalPortsPowerRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public AntennaPhysicalPortsPowerRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public AntennaPhysicalPortsPowerRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    AntennaPhysicalPortsPowerRequestData antennaPhysicalPortsPowerRequestData = (AntennaPhysicalPortsPowerRequestData) o;
    return Objects.equals(this.returnEntityAttributes, antennaPhysicalPortsPowerRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, antennaPhysicalPortsPowerRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, antennaPhysicalPortsPowerRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, antennaPhysicalPortsPowerRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class AntennaPhysicalPortsPowerRequestData {\n");
