...
import com.fntsoftware.businessgateway.entities.LogicalPortCustomSvidVlanEntityRestriction;
...
/**
 * LogicalPortCustomSvidVlanRequestData
 */
@JsonPropertyOrder({
  LogicalPortCustomSvidVlanRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  LogicalPortCustomSvidVlanRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  LogicalPortCustomSvidVlanRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  LogicalPortCustomSvidVlanRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-02-26T11:20:24.990023935Z[Etc/UTC]")
public class LogicalPortCustomSvidVlanRequestData {
  ...
  private LogicalPortCustomSvidVlanEntityRestriction entityRestrictions;
  ...
  public LogicalPortCustomSvidVlanRequestData() {
  }

  public LogicalPortCustomSvidVlanRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public LogicalPortCustomSvidVlanRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public LogicalPortCustomSvidVlanRequestData entityRestrictions(LogicalPortCustomSvidVlanEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public LogicalPortCustomSvidVlanEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(LogicalPortCustomSvidVlanEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public LogicalPortCustomSvidVlanRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public LogicalPortCustomSvidVlanRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public LogicalPortCustomSvidVlanRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    LogicalPortCustomSvidVlanRequestData logicalPortCustomSvidVlanRequestData = (LogicalPortCustomSvidVlanRequestData) o;
    return Objects.equals(this.returnEntityAttributes, logicalPortCustomSvidVlanRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, logicalPortCustomSvidVlanRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, logicalPortCustomSvidVlanRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, logicalPortCustomSvidVlanRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class LogicalPortCustomSvidVlanRequestData {\n");
