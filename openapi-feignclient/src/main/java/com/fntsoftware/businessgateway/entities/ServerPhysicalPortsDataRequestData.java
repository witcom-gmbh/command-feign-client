...
import com.fntsoftware.businessgateway.entities.ServerPhysicalPortsDataEntityRestriction;
...
/**
 * ServerPhysicalPortsDataRequestData
 */
@JsonPropertyOrder({
  ServerPhysicalPortsDataRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  ServerPhysicalPortsDataRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  ServerPhysicalPortsDataRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  ServerPhysicalPortsDataRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-01-31T11:10:37.320689708Z[Etc/UTC]")
public class ServerPhysicalPortsDataRequestData {
  ...
  private ServerPhysicalPortsDataEntityRestriction entityRestrictions;
  ...
  public ServerPhysicalPortsDataRequestData() {
  }

  public ServerPhysicalPortsDataRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public ServerPhysicalPortsDataRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public ServerPhysicalPortsDataRequestData entityRestrictions(ServerPhysicalPortsDataEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public ServerPhysicalPortsDataEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(ServerPhysicalPortsDataEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public ServerPhysicalPortsDataRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public ServerPhysicalPortsDataRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public ServerPhysicalPortsDataRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ServerPhysicalPortsDataRequestData serverPhysicalPortsDataRequestData = (ServerPhysicalPortsDataRequestData) o;
    return Objects.equals(this.returnEntityAttributes, serverPhysicalPortsDataRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, serverPhysicalPortsDataRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, serverPhysicalPortsDataRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, serverPhysicalPortsDataRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class ServerPhysicalPortsDataRequestData {\n");
