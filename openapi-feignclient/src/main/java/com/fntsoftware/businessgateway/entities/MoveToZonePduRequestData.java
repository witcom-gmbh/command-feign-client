...
import com.fntsoftware.businessgateway.entities.MoveToZonePduCreateLinkZoneRequestData;
import com.fasterxml.jackson.annotation.JsonPropertyOrder;
import com.fasterxml.jackson.annotation.JsonTypeName;

/**
 * MoveToZonePduRequestData
 */
@JsonPropertyOrder({
  MoveToZonePduRequestData.JSON_PROPERTY_RELEASE_SIGNALPATH,
  MoveToZonePduRequestData.JSON_PROPERTY_RELEASE_CONNECTIONS,
  MoveToZonePduRequestData.JSON_PROPERTY_RELEASE_SERVICE,
  MoveToZonePduRequestData.JSON_PROPERTY_RELEASE_SUPPORTS,
  MoveToZonePduRequestData.JSON_PROPERTY_RELEASE_PATCHES,
  MoveToZonePduRequestData.JSON_PROPERTY_CREATE_LINK_ZONE
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-02-26T11:20:24.990023935Z[Etc/UTC]")
public class MoveToZonePduRequestData {
  ...
  private MoveToZonePduCreateLinkZoneRequestData createLinkZone;

  public MoveToZonePduRequestData() {
  }

  public MoveToZonePduRequestData releaseSignalpath(Boolean releaseSignalpath) {
  ...
  **/
  ...
  public MoveToZonePduRequestData releaseConnections(Boolean releaseConnections) {
  ...
  **/
  ...
  public MoveToZonePduRequestData releaseService(Boolean releaseService) {
  ...
  **/
  ...
  public MoveToZonePduRequestData releaseSupports(Boolean releaseSupports) {
  ...
  **/
  ...
  public MoveToZonePduRequestData releasePatches(Boolean releasePatches) {
  ...
  **/
  ...
  public MoveToZonePduRequestData createLinkZone(MoveToZonePduCreateLinkZoneRequestData createLinkZone) {
  ...
  **/
  ...
  public MoveToZonePduCreateLinkZoneRequestData getCreateLinkZone() {
    return createLinkZone;
  }
  ...
  @JsonProperty(JSON_PROPERTY_CREATE_LINK_ZONE)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setCreateLinkZone(MoveToZonePduCreateLinkZoneRequestData createLinkZone) {
    this.createLinkZone = createLinkZone;
  }
  ...
  public boolean equals(Object o) {
    ...
    MoveToZonePduRequestData moveToZonePduRequestData = (MoveToZonePduRequestData) o;
    return Objects.equals(this.releaseSignalpath, moveToZonePduRequestData.releaseSignalpath) &&
        Objects.equals(this.releaseConnections, moveToZonePduRequestData.releaseConnections) &&
        Objects.equals(this.releaseService, moveToZonePduRequestData.releaseService) &&
        Objects.equals(this.releaseSupports, moveToZonePduRequestData.releaseSupports) &&
        Objects.equals(this.releasePatches, moveToZonePduRequestData.releasePatches) &&
        Objects.equals(this.createLinkZone, moveToZonePduRequestData.createLinkZone);
  }
  ...
  public String toString() {
    ...
    sb.append("class MoveToZonePduRequestData {\n");
