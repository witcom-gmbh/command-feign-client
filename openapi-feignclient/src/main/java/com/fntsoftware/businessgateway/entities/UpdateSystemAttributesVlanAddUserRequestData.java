...
/**
 * UpdateSystemAttributesVlanAddUserRequestData
 */
@JsonPropertyOrder({
  UpdateSystemAttributesVlanAddUserRequestData.JSON_PROPERTY_MODIFY_PLAN,
  UpdateSystemAttributesVlanAddUserRequestData.JSON_PROPERTY_DELETE_REAL,
  UpdateSystemAttributesVlanAddUserRequestData.JSON_PROPERTY_READ_PLAN,
  UpdateSystemAttributesVlanAddUserRequestData.JSON_PROPERTY_MANDANT_ID,
  UpdateSystemAttributesVlanAddUserRequestData.JSON_PROPERTY_USER_ELID,
  UpdateSystemAttributesVlanAddUserRequestData.JSON_PROPERTY_MODIFY_REAL,
  UpdateSystemAttributesVlanAddUserRequestData.JSON_PROPERTY_READ_REAL,
  UpdateSystemAttributesVlanAddUserRequestData.JSON_PROPERTY_DELETE_PLAN
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-01-31T11:10:37.320689708Z[Etc/UTC]")
public class UpdateSystemAttributesVlanAddUserRequestData {
  ...
  public UpdateSystemAttributesVlanAddUserRequestData() {
  }

  public UpdateSystemAttributesVlanAddUserRequestData modifyPlan(Boolean modifyPlan) {
  ...
  **/
  ...
  public UpdateSystemAttributesVlanAddUserRequestData deleteReal(Boolean deleteReal) {
  ...
  **/
  ...
  public UpdateSystemAttributesVlanAddUserRequestData readPlan(Boolean readPlan) {
  ...
  **/
  ...
  public UpdateSystemAttributesVlanAddUserRequestData mandantId(BigDecimal mandantId) {
  ...
  **/
  ...
  public UpdateSystemAttributesVlanAddUserRequestData userElid(String userElid) {
  ...
  **/
  ...
  public UpdateSystemAttributesVlanAddUserRequestData modifyReal(Boolean modifyReal) {
  ...
  **/
  ...
  public UpdateSystemAttributesVlanAddUserRequestData readReal(Boolean readReal) {
  ...
  **/
  ...
  public UpdateSystemAttributesVlanAddUserRequestData deletePlan(Boolean deletePlan) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    UpdateSystemAttributesVlanAddUserRequestData updateSystemAttributesVlanAddUserRequestData = (UpdateSystemAttributesVlanAddUserRequestData) o;
    return Objects.equals(this.modifyPlan, updateSystemAttributesVlanAddUserRequestData.modifyPlan) &&
        Objects.equals(this.deleteReal, updateSystemAttributesVlanAddUserRequestData.deleteReal) &&
        Objects.equals(this.readPlan, updateSystemAttributesVlanAddUserRequestData.readPlan) &&
        Objects.equals(this.mandantId, updateSystemAttributesVlanAddUserRequestData.mandantId) &&
        Objects.equals(this.userElid, updateSystemAttributesVlanAddUserRequestData.userElid) &&
        Objects.equals(this.modifyReal, updateSystemAttributesVlanAddUserRequestData.modifyReal) &&
        Objects.equals(this.readReal, updateSystemAttributesVlanAddUserRequestData.readReal) &&
        Objects.equals(this.deletePlan, updateSystemAttributesVlanAddUserRequestData.deletePlan);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateSystemAttributesVlanAddUserRequestData {\n");
