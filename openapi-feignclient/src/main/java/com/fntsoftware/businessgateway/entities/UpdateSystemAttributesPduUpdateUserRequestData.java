...
/**
 * UpdateSystemAttributesPduUpdateUserRequestData
 */
@JsonPropertyOrder({
  UpdateSystemAttributesPduUpdateUserRequestData.JSON_PROPERTY_MODIFY_PLAN,
  UpdateSystemAttributesPduUpdateUserRequestData.JSON_PROPERTY_DELETE_REAL,
  UpdateSystemAttributesPduUpdateUserRequestData.JSON_PROPERTY_READ_PLAN,
  UpdateSystemAttributesPduUpdateUserRequestData.JSON_PROPERTY_MANDANT_ID,
  UpdateSystemAttributesPduUpdateUserRequestData.JSON_PROPERTY_USER_ELID,
  UpdateSystemAttributesPduUpdateUserRequestData.JSON_PROPERTY_MODIFY_REAL,
  UpdateSystemAttributesPduUpdateUserRequestData.JSON_PROPERTY_READ_REAL,
  UpdateSystemAttributesPduUpdateUserRequestData.JSON_PROPERTY_DELETE_PLAN
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-01-31T11:10:37.320689708Z[Etc/UTC]")
public class UpdateSystemAttributesPduUpdateUserRequestData {
  ...
  public UpdateSystemAttributesPduUpdateUserRequestData() {
  }

  public UpdateSystemAttributesPduUpdateUserRequestData modifyPlan(Boolean modifyPlan) {
  ...
  **/
  ...
  public UpdateSystemAttributesPduUpdateUserRequestData deleteReal(Boolean deleteReal) {
  ...
  **/
  ...
  public UpdateSystemAttributesPduUpdateUserRequestData readPlan(Boolean readPlan) {
  ...
  **/
  ...
  public UpdateSystemAttributesPduUpdateUserRequestData mandantId(BigDecimal mandantId) {
  ...
  **/
  ...
  public UpdateSystemAttributesPduUpdateUserRequestData userElid(String userElid) {
  ...
  **/
  ...
  public UpdateSystemAttributesPduUpdateUserRequestData modifyReal(Boolean modifyReal) {
  ...
  **/
  ...
  public UpdateSystemAttributesPduUpdateUserRequestData readReal(Boolean readReal) {
  ...
  **/
  ...
  public UpdateSystemAttributesPduUpdateUserRequestData deletePlan(Boolean deletePlan) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    UpdateSystemAttributesPduUpdateUserRequestData updateSystemAttributesPduUpdateUserRequestData = (UpdateSystemAttributesPduUpdateUserRequestData) o;
    return Objects.equals(this.modifyPlan, updateSystemAttributesPduUpdateUserRequestData.modifyPlan) &&
        Objects.equals(this.deleteReal, updateSystemAttributesPduUpdateUserRequestData.deleteReal) &&
        Objects.equals(this.readPlan, updateSystemAttributesPduUpdateUserRequestData.readPlan) &&
        Objects.equals(this.mandantId, updateSystemAttributesPduUpdateUserRequestData.mandantId) &&
        Objects.equals(this.userElid, updateSystemAttributesPduUpdateUserRequestData.userElid) &&
        Objects.equals(this.modifyReal, updateSystemAttributesPduUpdateUserRequestData.modifyReal) &&
        Objects.equals(this.readReal, updateSystemAttributesPduUpdateUserRequestData.readReal) &&
        Objects.equals(this.deletePlan, updateSystemAttributesPduUpdateUserRequestData.deletePlan);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateSystemAttributesPduUpdateUserRequestData {\n");
