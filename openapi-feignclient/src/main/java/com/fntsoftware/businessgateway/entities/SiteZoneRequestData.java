...
import com.fntsoftware.businessgateway.entities.SiteZoneEntityRestriction;
 ...
 */
@JsonPropertyOrder({
  SiteZoneRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  SiteZoneRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  SiteZoneRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  SiteZoneRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-01-31T11:10:37.320689708Z[Etc/UTC]")
public class SiteZoneRequestData {
  ...
  private SiteZoneEntityRestriction entityRestrictions;
  ...
  public SiteZoneRequestData() {
  }

  public SiteZoneRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public SiteZoneRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public SiteZoneRequestData entityRestrictions(SiteZoneEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public SiteZoneEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(SiteZoneEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public SiteZoneRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public SiteZoneRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public SiteZoneRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    SiteZoneRequestData siteZoneRequestData = (SiteZoneRequestData) o;
    return Objects.equals(this.returnEntityAttributes, siteZoneRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, siteZoneRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, siteZoneRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, siteZoneRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class SiteZoneRequestData {\n");
