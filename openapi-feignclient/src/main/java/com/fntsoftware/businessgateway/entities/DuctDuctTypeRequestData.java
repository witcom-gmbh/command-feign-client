...
import com.fntsoftware.businessgateway.entities.DuctDuctTypeEntityRestriction;
...
/**
 * DuctDuctTypeRequestData
 */
@JsonPropertyOrder({
  DuctDuctTypeRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  DuctDuctTypeRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  DuctDuctTypeRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  DuctDuctTypeRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-01-31T11:10:37.320689708Z[Etc/UTC]")
public class DuctDuctTypeRequestData {
  ...
  private DuctDuctTypeEntityRestriction entityRestrictions;
  ...
  public DuctDuctTypeRequestData() {
  }

  public DuctDuctTypeRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public DuctDuctTypeRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public DuctDuctTypeRequestData entityRestrictions(DuctDuctTypeEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public DuctDuctTypeEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(DuctDuctTypeEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public DuctDuctTypeRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public DuctDuctTypeRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public DuctDuctTypeRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    DuctDuctTypeRequestData ductDuctTypeRequestData = (DuctDuctTypeRequestData) o;
    return Objects.equals(this.returnEntityAttributes, ductDuctTypeRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, ductDuctTypeRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, ductDuctTypeRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, ductDuctTypeRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class DuctDuctTypeRequestData {\n");
