...
/**
 * ServerBaseIpAddressesResponseData
 */
@JsonPropertyOrder({
  ServerBaseIpAddressesResponseData.JSON_PROPERTY_ASSIGNED_DIRECTLY,
  ServerBaseIpAddressesResponseData.JSON_PROPERTY_INTERFACE,
  ServerBaseIpAddressesResponseData.JSON_PROPERTY_PORTS,
  ServerBaseIpAddressesResponseData.JSON_PROPERTY_OBJECT_ELID,
  ServerBaseIpAddressesResponseData.JSON_PROPERTY_OBJECT_ID
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-03-04T13:31:32.601557352Z[Etc/UTC]")
public class ServerBaseIpAddressesResponseData {
  ...
  public ServerBaseIpAddressesResponseData() {
  }

  public ServerBaseIpAddressesResponseData assignedDirectly(Boolean assignedDirectly) {
  ...
  **/
  ...
  public ServerBaseIpAddressesResponseData _interface(InterfaceinterfaceWithAddressData _interface) {
  ...
  **/
  ...
  public ServerBaseIpAddressesResponseData ports(List<PhysicalPortDataphysicalPortDataInfo> ports) {
    
    this.ports = ports;
    return this;
  }

  public ServerBaseIpAddressesResponseData addPortsItem(PhysicalPortDataphysicalPortDataInfo portsItem) {
    if (this.ports == null) {
  ...
  **/
  ...
  public ServerBaseIpAddressesResponseData objectElid(String objectElid) {
  ...
  **/
  ...
  public ServerBaseIpAddressesResponseData objectId(String objectId) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ServerBaseIpAddressesResponseData serverBaseIpAddressesResponseData = (ServerBaseIpAddressesResponseData) o;
    return Objects.equals(this.assignedDirectly, serverBaseIpAddressesResponseData.assignedDirectly) &&
        Objects.equals(this._interface, serverBaseIpAddressesResponseData._interface) &&
        Objects.equals(this.ports, serverBaseIpAddressesResponseData.ports) &&
        Objects.equals(this.objectElid, serverBaseIpAddressesResponseData.objectElid) &&
        Objects.equals(this.objectId, serverBaseIpAddressesResponseData.objectId);
  }
  ...
  public String toString() {
    ...
    sb.append("class ServerBaseIpAddressesResponseData {\n");
