...
import com.fntsoftware.businessgateway.entities.OrderItemOrderEntityRestriction;
...
/**
 * OrderItemOrderRequestData
 */
@JsonPropertyOrder({
  OrderItemOrderRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  OrderItemOrderRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  OrderItemOrderRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  OrderItemOrderRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-01-31T11:10:37.320689708Z[Etc/UTC]")
public class OrderItemOrderRequestData {
  ...
  private OrderItemOrderEntityRestriction entityRestrictions;
  ...
  public OrderItemOrderRequestData() {
  }

  public OrderItemOrderRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public OrderItemOrderRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public OrderItemOrderRequestData entityRestrictions(OrderItemOrderEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public OrderItemOrderEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(OrderItemOrderEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public OrderItemOrderRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public OrderItemOrderRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public OrderItemOrderRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    OrderItemOrderRequestData orderItemOrderRequestData = (OrderItemOrderRequestData) o;
    return Objects.equals(this.returnEntityAttributes, orderItemOrderRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, orderItemOrderRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, orderItemOrderRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, orderItemOrderRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class OrderItemOrderRequestData {\n");
