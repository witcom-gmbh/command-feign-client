...
import com.fntsoftware.businessgateway.entities.CustomL2CpeSegmentVlanEntityRestriction;
...
/**
 * CustomL2CpeSegmentVlanRequestData
 */
@JsonPropertyOrder({
  CustomL2CpeSegmentVlanRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  CustomL2CpeSegmentVlanRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  CustomL2CpeSegmentVlanRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  CustomL2CpeSegmentVlanRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-03-04T13:31:32.601557352Z[Etc/UTC]")
public class CustomL2CpeSegmentVlanRequestData {
  ...
  private CustomL2CpeSegmentVlanEntityRestriction entityRestrictions;
  ...
  public CustomL2CpeSegmentVlanRequestData() {
  }

  public CustomL2CpeSegmentVlanRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public CustomL2CpeSegmentVlanRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public CustomL2CpeSegmentVlanRequestData entityRestrictions(CustomL2CpeSegmentVlanEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public CustomL2CpeSegmentVlanEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(CustomL2CpeSegmentVlanEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public CustomL2CpeSegmentVlanRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public CustomL2CpeSegmentVlanRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public CustomL2CpeSegmentVlanRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    CustomL2CpeSegmentVlanRequestData customL2CpeSegmentVlanRequestData = (CustomL2CpeSegmentVlanRequestData) o;
    return Objects.equals(this.returnEntityAttributes, customL2CpeSegmentVlanRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, customL2CpeSegmentVlanRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, customL2CpeSegmentVlanRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, customL2CpeSegmentVlanRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class CustomL2CpeSegmentVlanRequestData {\n");
