...
import com.fntsoftware.businessgateway.entities.ServerBaseZoneEntityRestriction;
...
/**
 * ServerBaseZoneRequestData
 */
@JsonPropertyOrder({
  ServerBaseZoneRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  ServerBaseZoneRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  ServerBaseZoneRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  ServerBaseZoneRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-01-31T11:10:37.320689708Z[Etc/UTC]")
public class ServerBaseZoneRequestData {
  ...
  private ServerBaseZoneEntityRestriction entityRestrictions;
  ...
  public ServerBaseZoneRequestData() {
  }

  public ServerBaseZoneRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public ServerBaseZoneRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public ServerBaseZoneRequestData entityRestrictions(ServerBaseZoneEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public ServerBaseZoneEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(ServerBaseZoneEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public ServerBaseZoneRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public ServerBaseZoneRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public ServerBaseZoneRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ServerBaseZoneRequestData serverBaseZoneRequestData = (ServerBaseZoneRequestData) o;
    return Objects.equals(this.returnEntityAttributes, serverBaseZoneRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, serverBaseZoneRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, serverBaseZoneRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, serverBaseZoneRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class ServerBaseZoneRequestData {\n");
