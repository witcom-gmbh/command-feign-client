...
/**
 * Ipv4NetworkDevicesAllEntityRestriction
 */
@JsonPropertyOrder({
  Ipv4NetworkDevicesAllEntityRestriction.JSON_PROPERTY_CLIMATE_RELEVANT,
  Ipv4NetworkDevicesAllEntityRestriction.JSON_PROPERTY_POWER_CONSUMPTION,
  Ipv4NetworkDevicesAllEntityRestriction.JSON_PROPERTY_POWER_SWITCHING_STATUS,
  Ipv4NetworkDevicesAllEntityRestriction.JSON_PROPERTY_PLAN_STATUS,
  Ipv4NetworkDevicesAllEntityRestriction.JSON_PROPERTY_SYSTEM_RUNTIME,
  Ipv4NetworkDevicesAllEntityRestriction.JSON_PROPERTY_WEIGHT,
  Ipv4NetworkDevicesAllEntityRestriction.JSON_PROPERTY_REMARK,
  Ipv4NetworkDevicesAllEntityRestriction.JSON_PROPERTY_ELID,
  Ipv4NetworkDevicesAllEntityRestriction.JSON_PROPERTY_LAST_SEEN,
  Ipv4NetworkDevicesAllEntityRestriction.JSON_PROPERTY_TYPE_ELID,
  Ipv4NetworkDevicesAllEntityRestriction.JSON_PROPERTY_VISIBLE_ID,
  Ipv4NetworkDevicesAllEntityRestriction.JSON_PROPERTY_ID,
  Ipv4NetworkDevicesAllEntityRestriction.JSON_PROPERTY_HEAT_EMISSION
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-03-04T13:31:32.601557352Z[Etc/UTC]")
public class Ipv4NetworkDevicesAllEntityRestriction {
  ...
  public Ipv4NetworkDevicesAllEntityRestriction() {
  }

  public Ipv4NetworkDevicesAllEntityRestriction climateRelevant(RestrictionsBoolean climateRelevant) {
  ...
  **/
  ...
  public Ipv4NetworkDevicesAllEntityRestriction powerConsumption(RestrictionsNumeric powerConsumption) {
  ...
  **/
  ...
  public Ipv4NetworkDevicesAllEntityRestriction powerSwitchingStatus(RestrictionsString powerSwitchingStatus) {
  ...
  **/
  ...
  public Ipv4NetworkDevicesAllEntityRestriction planStatus(RestrictionsString planStatus) {
  ...
  **/
  ...
  public Ipv4NetworkDevicesAllEntityRestriction systemRuntime(RestrictionsNumeric systemRuntime) {
  ...
  **/
  ...
  public Ipv4NetworkDevicesAllEntityRestriction weight(RestrictionsNumeric weight) {
  ...
  **/
  ...
  public Ipv4NetworkDevicesAllEntityRestriction remark(RestrictionsString remark) {
  ...
  **/
  ...
  public Ipv4NetworkDevicesAllEntityRestriction elid(RestrictionsString elid) {
  ...
  **/
  ...
  public Ipv4NetworkDevicesAllEntityRestriction lastSeen(RestrictionsDate lastSeen) {
  ...
  **/
  ...
  public Ipv4NetworkDevicesAllEntityRestriction typeElid(RestrictionsString typeElid) {
  ...
  **/
  ...
  public Ipv4NetworkDevicesAllEntityRestriction visibleId(RestrictionsString visibleId) {
  ...
  **/
  ...
  public Ipv4NetworkDevicesAllEntityRestriction id(RestrictionsString id) {
  ...
  **/
  ...
  public Ipv4NetworkDevicesAllEntityRestriction heatEmission(RestrictionsNumeric heatEmission) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    Ipv4NetworkDevicesAllEntityRestriction ipv4NetworkDevicesAllEntityRestriction = (Ipv4NetworkDevicesAllEntityRestriction) o;
    return Objects.equals(this.climateRelevant, ipv4NetworkDevicesAllEntityRestriction.climateRelevant) &&
        Objects.equals(this.powerConsumption, ipv4NetworkDevicesAllEntityRestriction.powerConsumption) &&
        Objects.equals(this.powerSwitchingStatus, ipv4NetworkDevicesAllEntityRestriction.powerSwitchingStatus) &&
        Objects.equals(this.planStatus, ipv4NetworkDevicesAllEntityRestriction.planStatus) &&
        Objects.equals(this.systemRuntime, ipv4NetworkDevicesAllEntityRestriction.systemRuntime) &&
        Objects.equals(this.weight, ipv4NetworkDevicesAllEntityRestriction.weight) &&
        Objects.equals(this.remark, ipv4NetworkDevicesAllEntityRestriction.remark) &&
        Objects.equals(this.elid, ipv4NetworkDevicesAllEntityRestriction.elid) &&
        Objects.equals(this.lastSeen, ipv4NetworkDevicesAllEntityRestriction.lastSeen) &&
        Objects.equals(this.typeElid, ipv4NetworkDevicesAllEntityRestriction.typeElid) &&
        Objects.equals(this.visibleId, ipv4NetworkDevicesAllEntityRestriction.visibleId) &&
        Objects.equals(this.id, ipv4NetworkDevicesAllEntityRestriction.id) &&
        Objects.equals(this.heatEmission, ipv4NetworkDevicesAllEntityRestriction.heatEmission);
  }
  ...
  public String toString() {
    ...
    sb.append("class Ipv4NetworkDevicesAllEntityRestriction {\n");
