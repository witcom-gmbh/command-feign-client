...
import com.fntsoftware.businessgateway.entities.Ipv6NetrangeIpv6NetworkEntityRestriction;
...
/**
 * Ipv6NetrangeIpv6NetworkRequestData
 */
@JsonPropertyOrder({
  Ipv6NetrangeIpv6NetworkRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  Ipv6NetrangeIpv6NetworkRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  Ipv6NetrangeIpv6NetworkRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  Ipv6NetrangeIpv6NetworkRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-02-26T11:20:24.990023935Z[Etc/UTC]")
public class Ipv6NetrangeIpv6NetworkRequestData {
  ...
  private Ipv6NetrangeIpv6NetworkEntityRestriction entityRestrictions;
  ...
  public Ipv6NetrangeIpv6NetworkRequestData() {
  }

  public Ipv6NetrangeIpv6NetworkRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public Ipv6NetrangeIpv6NetworkRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public Ipv6NetrangeIpv6NetworkRequestData entityRestrictions(Ipv6NetrangeIpv6NetworkEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public Ipv6NetrangeIpv6NetworkEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(Ipv6NetrangeIpv6NetworkEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public Ipv6NetrangeIpv6NetworkRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public Ipv6NetrangeIpv6NetworkRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public Ipv6NetrangeIpv6NetworkRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    Ipv6NetrangeIpv6NetworkRequestData ipv6NetrangeIpv6NetworkRequestData = (Ipv6NetrangeIpv6NetworkRequestData) o;
    return Objects.equals(this.returnEntityAttributes, ipv6NetrangeIpv6NetworkRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, ipv6NetrangeIpv6NetworkRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, ipv6NetrangeIpv6NetworkRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, ipv6NetrangeIpv6NetworkRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class Ipv6NetrangeIpv6NetworkRequestData {\n");
