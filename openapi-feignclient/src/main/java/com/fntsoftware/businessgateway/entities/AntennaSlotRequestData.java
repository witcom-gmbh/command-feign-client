...
import com.fntsoftware.businessgateway.entities.AntennaSlotEntityRestriction;
import com.fntsoftware.businessgateway.entities.AntennaSlotRelationRestriction;
...
/**
 * AntennaSlotRequestData
 */
@JsonPropertyOrder({
  AntennaSlotRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  AntennaSlotRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  AntennaSlotRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  AntennaSlotRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-02-26T11:20:24.990023935Z[Etc/UTC]")
public class AntennaSlotRequestData {
  ...
  private AntennaSlotEntityRestriction entityRestrictions;

  public static final String JSON_PROPERTY_RELATION_RESTRICTIONS = "relationRestrictions";
  private AntennaSlotRelationRestriction relationRestrictions;
  ...
  public AntennaSlotRequestData() {
  }

  public AntennaSlotRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public AntennaSlotRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public AntennaSlotRequestData entityRestrictions(AntennaSlotEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public AntennaSlotEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(AntennaSlotEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public AntennaSlotRequestData relationRestrictions(AntennaSlotRelationRestriction relationRestrictions) {
  ...
  **/
  ...
  public AntennaSlotRelationRestriction getRelationRestrictions() {
    return relationRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_RELATION_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRelationRestrictions(AntennaSlotRelationRestriction relationRestrictions) {
    this.relationRestrictions = relationRestrictions;
  }


  public AntennaSlotRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public AntennaSlotRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    AntennaSlotRequestData antennaSlotRequestData = (AntennaSlotRequestData) o;
    return Objects.equals(this.returnEntityAttributes, antennaSlotRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, antennaSlotRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, antennaSlotRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, antennaSlotRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class AntennaSlotRequestData {\n");
