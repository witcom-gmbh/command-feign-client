...
import com.fntsoftware.businessgateway.entities.CampusSitesEntityRestriction;
import com.fntsoftware.businessgateway.entities.CampusSitesRelationRestriction;
...
/**
 * CampusSitesRequestData
 */
@JsonPropertyOrder({
  CampusSitesRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  CampusSitesRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  CampusSitesRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  CampusSitesRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-01-31T11:10:37.320689708Z[Etc/UTC]")
public class CampusSitesRequestData {
  ...
  private CampusSitesEntityRestriction entityRestrictions;

  public static final String JSON_PROPERTY_RELATION_RESTRICTIONS = "relationRestrictions";
  private CampusSitesRelationRestriction relationRestrictions;
  ...
  public CampusSitesRequestData() {
  }

  public CampusSitesRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public CampusSitesRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public CampusSitesRequestData entityRestrictions(CampusSitesEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public CampusSitesEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(CampusSitesEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public CampusSitesRequestData relationRestrictions(CampusSitesRelationRestriction relationRestrictions) {
  ...
  **/
  ...
  public CampusSitesRelationRestriction getRelationRestrictions() {
    return relationRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_RELATION_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRelationRestrictions(CampusSitesRelationRestriction relationRestrictions) {
    this.relationRestrictions = relationRestrictions;
  }


  public CampusSitesRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public CampusSitesRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    CampusSitesRequestData campusSitesRequestData = (CampusSitesRequestData) o;
    return Objects.equals(this.returnEntityAttributes, campusSitesRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, campusSitesRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, campusSitesRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, campusSitesRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class CampusSitesRequestData {\n");
