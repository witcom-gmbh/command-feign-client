...
import com.fntsoftware.businessgateway.entities.PhysicalPortDataDeviceAllEntityRestriction;
...
/**
 * PhysicalPortDataDeviceAllRequestData
 */
@JsonPropertyOrder({
  PhysicalPortDataDeviceAllRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  PhysicalPortDataDeviceAllRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  PhysicalPortDataDeviceAllRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  PhysicalPortDataDeviceAllRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-01-31T11:10:37.320689708Z[Etc/UTC]")
public class PhysicalPortDataDeviceAllRequestData {
  ...
  private PhysicalPortDataDeviceAllEntityRestriction entityRestrictions;
  ...
  public PhysicalPortDataDeviceAllRequestData() {
  }

  public PhysicalPortDataDeviceAllRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public PhysicalPortDataDeviceAllRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public PhysicalPortDataDeviceAllRequestData entityRestrictions(PhysicalPortDataDeviceAllEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public PhysicalPortDataDeviceAllEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(PhysicalPortDataDeviceAllEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public PhysicalPortDataDeviceAllRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public PhysicalPortDataDeviceAllRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public PhysicalPortDataDeviceAllRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    PhysicalPortDataDeviceAllRequestData physicalPortDataDeviceAllRequestData = (PhysicalPortDataDeviceAllRequestData) o;
    return Objects.equals(this.returnEntityAttributes, physicalPortDataDeviceAllRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, physicalPortDataDeviceAllRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, physicalPortDataDeviceAllRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, physicalPortDataDeviceAllRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class PhysicalPortDataDeviceAllRequestData {\n");
