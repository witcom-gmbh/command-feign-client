...
import com.fntsoftware.businessgateway.entities.DeviceMasterServersBaseEntityRestriction;
...
/**
 * DeviceMasterServersBaseRequestData
 */
@JsonPropertyOrder({
  DeviceMasterServersBaseRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  DeviceMasterServersBaseRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  DeviceMasterServersBaseRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  DeviceMasterServersBaseRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-03-04T13:31:32.601557352Z[Etc/UTC]")
public class DeviceMasterServersBaseRequestData {
  ...
  private DeviceMasterServersBaseEntityRestriction entityRestrictions;
  ...
  public DeviceMasterServersBaseRequestData() {
  }

  public DeviceMasterServersBaseRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public DeviceMasterServersBaseRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public DeviceMasterServersBaseRequestData entityRestrictions(DeviceMasterServersBaseEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public DeviceMasterServersBaseEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(DeviceMasterServersBaseEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public DeviceMasterServersBaseRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public DeviceMasterServersBaseRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public DeviceMasterServersBaseRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    DeviceMasterServersBaseRequestData deviceMasterServersBaseRequestData = (DeviceMasterServersBaseRequestData) o;
    return Objects.equals(this.returnEntityAttributes, deviceMasterServersBaseRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, deviceMasterServersBaseRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, deviceMasterServersBaseRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, deviceMasterServersBaseRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeviceMasterServersBaseRequestData {\n");
