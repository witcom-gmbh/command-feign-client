...
import com.fntsoftware.businessgateway.entities.Ipv4AddressIpv4NetrangeEntityRestriction;
...
/**
 * Ipv4AddressIpv4NetrangeRequestData
 */
@JsonPropertyOrder({
  Ipv4AddressIpv4NetrangeRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  Ipv4AddressIpv4NetrangeRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  Ipv4AddressIpv4NetrangeRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  Ipv4AddressIpv4NetrangeRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-03-04T13:31:32.601557352Z[Etc/UTC]")
public class Ipv4AddressIpv4NetrangeRequestData {
  ...
  private Ipv4AddressIpv4NetrangeEntityRestriction entityRestrictions;
  ...
  public Ipv4AddressIpv4NetrangeRequestData() {
  }

  public Ipv4AddressIpv4NetrangeRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public Ipv4AddressIpv4NetrangeRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public Ipv4AddressIpv4NetrangeRequestData entityRestrictions(Ipv4AddressIpv4NetrangeEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public Ipv4AddressIpv4NetrangeEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(Ipv4AddressIpv4NetrangeEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public Ipv4AddressIpv4NetrangeRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public Ipv4AddressIpv4NetrangeRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public Ipv4AddressIpv4NetrangeRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    Ipv4AddressIpv4NetrangeRequestData ipv4AddressIpv4NetrangeRequestData = (Ipv4AddressIpv4NetrangeRequestData) o;
    return Objects.equals(this.returnEntityAttributes, ipv4AddressIpv4NetrangeRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, ipv4AddressIpv4NetrangeRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, ipv4AddressIpv4NetrangeRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, ipv4AddressIpv4NetrangeRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class Ipv4AddressIpv4NetrangeRequestData {\n");
