...
import com.fntsoftware.businessgateway.entities.JunctionBoxWarehouseEntityRestriction;
...
/**
 * JunctionBoxWarehouseRequestData
 */
@JsonPropertyOrder({
  JunctionBoxWarehouseRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  JunctionBoxWarehouseRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  JunctionBoxWarehouseRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  JunctionBoxWarehouseRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-03-04T13:31:32.601557352Z[Etc/UTC]")
public class JunctionBoxWarehouseRequestData {
  ...
  private JunctionBoxWarehouseEntityRestriction entityRestrictions;
  ...
  public JunctionBoxWarehouseRequestData() {
  }

  public JunctionBoxWarehouseRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public JunctionBoxWarehouseRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public JunctionBoxWarehouseRequestData entityRestrictions(JunctionBoxWarehouseEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public JunctionBoxWarehouseEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(JunctionBoxWarehouseEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public JunctionBoxWarehouseRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public JunctionBoxWarehouseRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public JunctionBoxWarehouseRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    JunctionBoxWarehouseRequestData junctionBoxWarehouseRequestData = (JunctionBoxWarehouseRequestData) o;
    return Objects.equals(this.returnEntityAttributes, junctionBoxWarehouseRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, junctionBoxWarehouseRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, junctionBoxWarehouseRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, junctionBoxWarehouseRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class JunctionBoxWarehouseRequestData {\n");
