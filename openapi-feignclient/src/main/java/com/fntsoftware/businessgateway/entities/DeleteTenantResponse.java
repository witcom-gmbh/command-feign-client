 ...
 */
@JsonPropertyOrder({
  DeleteTenantResponse.JSON_PROPERTY_STATUS
})
...
public class DeleteTenantResponse {
  ...
  public DeleteTenantResponse status(ServiceStatusData status) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.status, deleteTenantResponse.status);
  }
