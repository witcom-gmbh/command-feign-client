...
import com.fntsoftware.businessgateway.entities.PersonFloorsEntityRestriction;
import com.fntsoftware.businessgateway.entities.PersonFloorsRelationRestriction;
...
/**
 * PersonFloorsRequestData
 */
@JsonPropertyOrder({
  PersonFloorsRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  PersonFloorsRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  PersonFloorsRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  PersonFloorsRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-02-26T11:20:24.990023935Z[Etc/UTC]")
public class PersonFloorsRequestData {
  ...
  private PersonFloorsEntityRestriction entityRestrictions;

  public static final String JSON_PROPERTY_RELATION_RESTRICTIONS = "relationRestrictions";
  private PersonFloorsRelationRestriction relationRestrictions;
  ...
  public PersonFloorsRequestData() {
  }

  public PersonFloorsRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public PersonFloorsRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public PersonFloorsRequestData entityRestrictions(PersonFloorsEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public PersonFloorsEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(PersonFloorsEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public PersonFloorsRequestData relationRestrictions(PersonFloorsRelationRestriction relationRestrictions) {
  ...
  **/
  ...
  public PersonFloorsRelationRestriction getRelationRestrictions() {
    return relationRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_RELATION_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRelationRestrictions(PersonFloorsRelationRestriction relationRestrictions) {
    this.relationRestrictions = relationRestrictions;
  }


  public PersonFloorsRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public PersonFloorsRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    PersonFloorsRequestData personFloorsRequestData = (PersonFloorsRequestData) o;
    return Objects.equals(this.returnEntityAttributes, personFloorsRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, personFloorsRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, personFloorsRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, personFloorsRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class PersonFloorsRequestData {\n");
