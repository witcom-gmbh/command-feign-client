...
import com.fntsoftware.businessgateway.entities.FrameContractApplicationReleaseEntityRestriction;
...
/**
 * FrameContractApplicationReleaseRequestData
 */
@JsonPropertyOrder({
  FrameContractApplicationReleaseRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  FrameContractApplicationReleaseRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  FrameContractApplicationReleaseRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  FrameContractApplicationReleaseRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-02-26T11:20:24.990023935Z[Etc/UTC]")
public class FrameContractApplicationReleaseRequestData {
  ...
  private FrameContractApplicationReleaseEntityRestriction entityRestrictions;
  ...
  public FrameContractApplicationReleaseRequestData() {
  }

  public FrameContractApplicationReleaseRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public FrameContractApplicationReleaseRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public FrameContractApplicationReleaseRequestData entityRestrictions(FrameContractApplicationReleaseEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public FrameContractApplicationReleaseEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(FrameContractApplicationReleaseEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public FrameContractApplicationReleaseRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public FrameContractApplicationReleaseRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public FrameContractApplicationReleaseRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    FrameContractApplicationReleaseRequestData frameContractApplicationReleaseRequestData = (FrameContractApplicationReleaseRequestData) o;
    return Objects.equals(this.returnEntityAttributes, frameContractApplicationReleaseRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, frameContractApplicationReleaseRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, frameContractApplicationReleaseRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, frameContractApplicationReleaseRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class FrameContractApplicationReleaseRequestData {\n");
