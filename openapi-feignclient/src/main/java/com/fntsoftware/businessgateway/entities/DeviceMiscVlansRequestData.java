...
import com.fntsoftware.businessgateway.entities.DeviceMiscVlansEntityRestriction;
import com.fntsoftware.businessgateway.entities.DeviceMiscVlansRelationRestriction;
...
/**
 * DeviceMiscVlansRequestData
 */
@JsonPropertyOrder({
  DeviceMiscVlansRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  DeviceMiscVlansRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  DeviceMiscVlansRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  DeviceMiscVlansRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-02-26T11:20:24.990023935Z[Etc/UTC]")
public class DeviceMiscVlansRequestData {
  ...
  private DeviceMiscVlansEntityRestriction entityRestrictions;

  public static final String JSON_PROPERTY_RELATION_RESTRICTIONS = "relationRestrictions";
  private DeviceMiscVlansRelationRestriction relationRestrictions;
  ...
  public DeviceMiscVlansRequestData() {
  }

  public DeviceMiscVlansRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public DeviceMiscVlansRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public DeviceMiscVlansRequestData entityRestrictions(DeviceMiscVlansEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public DeviceMiscVlansEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(DeviceMiscVlansEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public DeviceMiscVlansRequestData relationRestrictions(DeviceMiscVlansRelationRestriction relationRestrictions) {
  ...
  **/
  ...
  public DeviceMiscVlansRelationRestriction getRelationRestrictions() {
    return relationRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_RELATION_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRelationRestrictions(DeviceMiscVlansRelationRestriction relationRestrictions) {
    this.relationRestrictions = relationRestrictions;
  }


  public DeviceMiscVlansRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public DeviceMiscVlansRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    DeviceMiscVlansRequestData deviceMiscVlansRequestData = (DeviceMiscVlansRequestData) o;
    return Objects.equals(this.returnEntityAttributes, deviceMiscVlansRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, deviceMiscVlansRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, deviceMiscVlansRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, deviceMiscVlansRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeviceMiscVlansRequestData {\n");
