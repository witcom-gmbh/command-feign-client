...
import com.fntsoftware.businessgateway.entities.ServiceTelcoTrailPredecessorEntityRestriction;
...
/**
 * ServiceTelcoTrailPredecessorRequestData
 */
@JsonPropertyOrder({
  ServiceTelcoTrailPredecessorRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  ServiceTelcoTrailPredecessorRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  ServiceTelcoTrailPredecessorRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  ServiceTelcoTrailPredecessorRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-01-31T11:10:37.320689708Z[Etc/UTC]")
public class ServiceTelcoTrailPredecessorRequestData {
  ...
  private ServiceTelcoTrailPredecessorEntityRestriction entityRestrictions;
  ...
  public ServiceTelcoTrailPredecessorRequestData() {
  }

  public ServiceTelcoTrailPredecessorRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public ServiceTelcoTrailPredecessorRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public ServiceTelcoTrailPredecessorRequestData entityRestrictions(ServiceTelcoTrailPredecessorEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public ServiceTelcoTrailPredecessorEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(ServiceTelcoTrailPredecessorEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public ServiceTelcoTrailPredecessorRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public ServiceTelcoTrailPredecessorRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public ServiceTelcoTrailPredecessorRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ServiceTelcoTrailPredecessorRequestData serviceTelcoTrailPredecessorRequestData = (ServiceTelcoTrailPredecessorRequestData) o;
    return Objects.equals(this.returnEntityAttributes, serviceTelcoTrailPredecessorRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, serviceTelcoTrailPredecessorRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, serviceTelcoTrailPredecessorRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, serviceTelcoTrailPredecessorRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class ServiceTelcoTrailPredecessorRequestData {\n");
