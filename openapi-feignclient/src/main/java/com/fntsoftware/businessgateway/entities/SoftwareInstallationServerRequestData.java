...
import com.fntsoftware.businessgateway.entities.SoftwareInstallationServerEntityRestriction;
...
/**
 * SoftwareInstallationServerRequestData
 */
@JsonPropertyOrder({
  SoftwareInstallationServerRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  SoftwareInstallationServerRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  SoftwareInstallationServerRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  SoftwareInstallationServerRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-01-31T11:10:37.320689708Z[Etc/UTC]")
public class SoftwareInstallationServerRequestData {
  ...
  private SoftwareInstallationServerEntityRestriction entityRestrictions;
  ...
  public SoftwareInstallationServerRequestData() {
  }

  public SoftwareInstallationServerRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public SoftwareInstallationServerRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public SoftwareInstallationServerRequestData entityRestrictions(SoftwareInstallationServerEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public SoftwareInstallationServerEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(SoftwareInstallationServerEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public SoftwareInstallationServerRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public SoftwareInstallationServerRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public SoftwareInstallationServerRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    SoftwareInstallationServerRequestData softwareInstallationServerRequestData = (SoftwareInstallationServerRequestData) o;
    return Objects.equals(this.returnEntityAttributes, softwareInstallationServerRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, softwareInstallationServerRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, softwareInstallationServerRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, softwareInstallationServerRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class SoftwareInstallationServerRequestData {\n");
