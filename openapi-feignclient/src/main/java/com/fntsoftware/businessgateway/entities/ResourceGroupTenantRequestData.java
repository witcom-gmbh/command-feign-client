...
import com.fntsoftware.businessgateway.entities.ResourceGroupTenantEntityRestriction;
...
/**
 * ResourceGroupTenantRequestData
 */
@JsonPropertyOrder({
  ResourceGroupTenantRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  ResourceGroupTenantRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  ResourceGroupTenantRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  ResourceGroupTenantRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-03-04T13:31:32.601557352Z[Etc/UTC]")
public class ResourceGroupTenantRequestData {
  ...
  private ResourceGroupTenantEntityRestriction entityRestrictions;
  ...
  public ResourceGroupTenantRequestData() {
  }

  public ResourceGroupTenantRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public ResourceGroupTenantRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public ResourceGroupTenantRequestData entityRestrictions(ResourceGroupTenantEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public ResourceGroupTenantEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(ResourceGroupTenantEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public ResourceGroupTenantRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public ResourceGroupTenantRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public ResourceGroupTenantRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ResourceGroupTenantRequestData resourceGroupTenantRequestData = (ResourceGroupTenantRequestData) o;
    return Objects.equals(this.returnEntityAttributes, resourceGroupTenantRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, resourceGroupTenantRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, resourceGroupTenantRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, resourceGroupTenantRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class ResourceGroupTenantRequestData {\n");
