...
import com.fntsoftware.businessgateway.entities.StoragePhysicalPortsDataEntityRestriction;
...
/**
 * StoragePhysicalPortsDataRequestData
 */
@JsonPropertyOrder({
  StoragePhysicalPortsDataRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  StoragePhysicalPortsDataRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  StoragePhysicalPortsDataRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  StoragePhysicalPortsDataRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-03-04T13:31:32.601557352Z[Etc/UTC]")
public class StoragePhysicalPortsDataRequestData {
  ...
  private StoragePhysicalPortsDataEntityRestriction entityRestrictions;
  ...
  public StoragePhysicalPortsDataRequestData() {
  }

  public StoragePhysicalPortsDataRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public StoragePhysicalPortsDataRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public StoragePhysicalPortsDataRequestData entityRestrictions(StoragePhysicalPortsDataEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public StoragePhysicalPortsDataEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(StoragePhysicalPortsDataEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public StoragePhysicalPortsDataRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public StoragePhysicalPortsDataRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public StoragePhysicalPortsDataRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    StoragePhysicalPortsDataRequestData storagePhysicalPortsDataRequestData = (StoragePhysicalPortsDataRequestData) o;
    return Objects.equals(this.returnEntityAttributes, storagePhysicalPortsDataRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, storagePhysicalPortsDataRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, storagePhysicalPortsDataRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, storagePhysicalPortsDataRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class StoragePhysicalPortsDataRequestData {\n");
