...
import com.fntsoftware.businessgateway.entities.ChassisVlansEntityRestriction;
import com.fntsoftware.businessgateway.entities.ChassisVlansRelationRestriction;
...
/**
 * ChassisVlansRequestData
 */
@JsonPropertyOrder({
  ChassisVlansRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  ChassisVlansRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  ChassisVlansRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  ChassisVlansRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-01-31T11:10:37.320689708Z[Etc/UTC]")
public class ChassisVlansRequestData {
  ...
  private ChassisVlansEntityRestriction entityRestrictions;

  public static final String JSON_PROPERTY_RELATION_RESTRICTIONS = "relationRestrictions";
  private ChassisVlansRelationRestriction relationRestrictions;
  ...
  public ChassisVlansRequestData() {
  }

  public ChassisVlansRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public ChassisVlansRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public ChassisVlansRequestData entityRestrictions(ChassisVlansEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public ChassisVlansEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(ChassisVlansEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public ChassisVlansRequestData relationRestrictions(ChassisVlansRelationRestriction relationRestrictions) {
  ...
  **/
  ...
  public ChassisVlansRelationRestriction getRelationRestrictions() {
    return relationRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_RELATION_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRelationRestrictions(ChassisVlansRelationRestriction relationRestrictions) {
    this.relationRestrictions = relationRestrictions;
  }


  public ChassisVlansRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public ChassisVlansRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ChassisVlansRequestData chassisVlansRequestData = (ChassisVlansRequestData) o;
    return Objects.equals(this.returnEntityAttributes, chassisVlansRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, chassisVlansRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, chassisVlansRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, chassisVlansRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class ChassisVlansRequestData {\n");
