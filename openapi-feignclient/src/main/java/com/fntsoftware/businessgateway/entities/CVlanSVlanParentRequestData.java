...
import com.fntsoftware.businessgateway.entities.CVlanSVlanParentEntityRestriction;
...
/**
 * CVlanSVlanParentRequestData
 */
@JsonPropertyOrder({
  CVlanSVlanParentRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  CVlanSVlanParentRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  CVlanSVlanParentRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  CVlanSVlanParentRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-03-04T13:31:32.601557352Z[Etc/UTC]")
public class CVlanSVlanParentRequestData {
  ...
  private CVlanSVlanParentEntityRestriction entityRestrictions;
  ...
  public CVlanSVlanParentRequestData() {
  }

  public CVlanSVlanParentRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public CVlanSVlanParentRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public CVlanSVlanParentRequestData entityRestrictions(CVlanSVlanParentEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public CVlanSVlanParentEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(CVlanSVlanParentEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public CVlanSVlanParentRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public CVlanSVlanParentRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public CVlanSVlanParentRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    CVlanSVlanParentRequestData cvlanSVlanParentRequestData = (CVlanSVlanParentRequestData) o;
    return Objects.equals(this.returnEntityAttributes, cvlanSVlanParentRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, cvlanSVlanParentRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, cvlanSVlanParentRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, cvlanSVlanParentRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class CVlanSVlanParentRequestData {\n");
