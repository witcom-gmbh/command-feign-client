...
/**
 * PassiveModuleIpAddressesResponseData
 */
@JsonPropertyOrder({
  PassiveModuleIpAddressesResponseData.JSON_PROPERTY_ASSIGNED_DIRECTLY,
  PassiveModuleIpAddressesResponseData.JSON_PROPERTY_INTERFACE,
  PassiveModuleIpAddressesResponseData.JSON_PROPERTY_PORTS,
  PassiveModuleIpAddressesResponseData.JSON_PROPERTY_OBJECT_ELID,
  PassiveModuleIpAddressesResponseData.JSON_PROPERTY_OBJECT_ID
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-01-31T11:10:37.320689708Z[Etc/UTC]")
public class PassiveModuleIpAddressesResponseData {
  ...
  public PassiveModuleIpAddressesResponseData() {
  }

  public PassiveModuleIpAddressesResponseData assignedDirectly(Boolean assignedDirectly) {
  ...
  **/
  ...
  public PassiveModuleIpAddressesResponseData _interface(InterfaceinterfaceWithAddressData _interface) {
  ...
  **/
  ...
  public PassiveModuleIpAddressesResponseData ports(List<PhysicalPortDataphysicalPortDataInfo> ports) {
    
    this.ports = ports;
    return this;
  }

  public PassiveModuleIpAddressesResponseData addPortsItem(PhysicalPortDataphysicalPortDataInfo portsItem) {
    if (this.ports == null) {
  ...
  **/
  ...
  public PassiveModuleIpAddressesResponseData objectElid(String objectElid) {
  ...
  **/
  ...
  public PassiveModuleIpAddressesResponseData objectId(String objectId) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    PassiveModuleIpAddressesResponseData passiveModuleIpAddressesResponseData = (PassiveModuleIpAddressesResponseData) o;
    return Objects.equals(this.assignedDirectly, passiveModuleIpAddressesResponseData.assignedDirectly) &&
        Objects.equals(this._interface, passiveModuleIpAddressesResponseData._interface) &&
        Objects.equals(this.ports, passiveModuleIpAddressesResponseData.ports) &&
        Objects.equals(this.objectElid, passiveModuleIpAddressesResponseData.objectElid) &&
        Objects.equals(this.objectId, passiveModuleIpAddressesResponseData.objectId);
  }
  ...
  public String toString() {
    ...
    sb.append("class PassiveModuleIpAddressesResponseData {\n");
