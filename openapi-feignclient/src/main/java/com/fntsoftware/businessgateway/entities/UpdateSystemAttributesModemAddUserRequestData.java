...
/**
 * UpdateSystemAttributesModemAddUserRequestData
 */
@JsonPropertyOrder({
  UpdateSystemAttributesModemAddUserRequestData.JSON_PROPERTY_MODIFY_PLAN,
  UpdateSystemAttributesModemAddUserRequestData.JSON_PROPERTY_DELETE_REAL,
  UpdateSystemAttributesModemAddUserRequestData.JSON_PROPERTY_READ_PLAN,
  UpdateSystemAttributesModemAddUserRequestData.JSON_PROPERTY_MANDANT_ID,
  UpdateSystemAttributesModemAddUserRequestData.JSON_PROPERTY_USER_ELID,
  UpdateSystemAttributesModemAddUserRequestData.JSON_PROPERTY_MODIFY_REAL,
  UpdateSystemAttributesModemAddUserRequestData.JSON_PROPERTY_READ_REAL,
  UpdateSystemAttributesModemAddUserRequestData.JSON_PROPERTY_DELETE_PLAN
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-02-26T11:20:24.990023935Z[Etc/UTC]")
public class UpdateSystemAttributesModemAddUserRequestData {
  ...
  public UpdateSystemAttributesModemAddUserRequestData() {
  }

  public UpdateSystemAttributesModemAddUserRequestData modifyPlan(Boolean modifyPlan) {
  ...
  **/
  ...
  public UpdateSystemAttributesModemAddUserRequestData deleteReal(Boolean deleteReal) {
  ...
  **/
  ...
  public UpdateSystemAttributesModemAddUserRequestData readPlan(Boolean readPlan) {
  ...
  **/
  ...
  public UpdateSystemAttributesModemAddUserRequestData mandantId(BigDecimal mandantId) {
  ...
  **/
  ...
  public UpdateSystemAttributesModemAddUserRequestData userElid(String userElid) {
  ...
  **/
  ...
  public UpdateSystemAttributesModemAddUserRequestData modifyReal(Boolean modifyReal) {
  ...
  **/
  ...
  public UpdateSystemAttributesModemAddUserRequestData readReal(Boolean readReal) {
  ...
  **/
  ...
  public UpdateSystemAttributesModemAddUserRequestData deletePlan(Boolean deletePlan) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    UpdateSystemAttributesModemAddUserRequestData updateSystemAttributesModemAddUserRequestData = (UpdateSystemAttributesModemAddUserRequestData) o;
    return Objects.equals(this.modifyPlan, updateSystemAttributesModemAddUserRequestData.modifyPlan) &&
        Objects.equals(this.deleteReal, updateSystemAttributesModemAddUserRequestData.deleteReal) &&
        Objects.equals(this.readPlan, updateSystemAttributesModemAddUserRequestData.readPlan) &&
        Objects.equals(this.mandantId, updateSystemAttributesModemAddUserRequestData.mandantId) &&
        Objects.equals(this.userElid, updateSystemAttributesModemAddUserRequestData.userElid) &&
        Objects.equals(this.modifyReal, updateSystemAttributesModemAddUserRequestData.modifyReal) &&
        Objects.equals(this.readReal, updateSystemAttributesModemAddUserRequestData.readReal) &&
        Objects.equals(this.deletePlan, updateSystemAttributesModemAddUserRequestData.deletePlan);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateSystemAttributesModemAddUserRequestData {\n");
