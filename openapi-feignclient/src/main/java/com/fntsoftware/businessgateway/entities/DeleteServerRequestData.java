...
/**
 * DeleteServerRequestData
 */
@JsonPropertyOrder({
  DeleteServerRequestData.JSON_PROPERTY_RELEASE_SIGNALPATH,
  DeleteServerRequestData.JSON_PROPERTY_RELEASE_CONNECTIONS,
  DeleteServerRequestData.JSON_PROPERTY_RELEASE_SERVICE,
  DeleteServerRequestData.JSON_PROPERTY_CONTEXT_ID,
  DeleteServerRequestData.JSON_PROPERTY_RELEASE_PATCHES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-02-26T11:20:24.990023935Z[Etc/UTC]")
public class DeleteServerRequestData {
  ...
  public DeleteServerRequestData() {
  }

  public DeleteServerRequestData releaseSignalpath(Boolean releaseSignalpath) {
  ...
  **/
  ...
  public DeleteServerRequestData releaseConnections(Boolean releaseConnections) {
  ...
  **/
  ...
  public DeleteServerRequestData releaseService(Boolean releaseService) {
  ...
  **/
  ...
  public DeleteServerRequestData contextId(String contextId) {
  ...
  **/
  ...
  public DeleteServerRequestData releasePatches(Boolean releasePatches) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    DeleteServerRequestData deleteServerRequestData = (DeleteServerRequestData) o;
    return Objects.equals(this.releaseSignalpath, deleteServerRequestData.releaseSignalpath) &&
        Objects.equals(this.releaseConnections, deleteServerRequestData.releaseConnections) &&
        Objects.equals(this.releaseService, deleteServerRequestData.releaseService) &&
        Objects.equals(this.contextId, deleteServerRequestData.contextId) &&
        Objects.equals(this.releasePatches, deleteServerRequestData.releasePatches);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeleteServerRequestData {\n");
