...
import com.fntsoftware.businessgateway.entities.ServiceAccessPointLogicalPortEntityRestriction;
...
/**
 * ServiceAccessPointLogicalPortRequestData
 */
@JsonPropertyOrder({
  ServiceAccessPointLogicalPortRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  ServiceAccessPointLogicalPortRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  ServiceAccessPointLogicalPortRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  ServiceAccessPointLogicalPortRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-03-04T13:31:32.601557352Z[Etc/UTC]")
public class ServiceAccessPointLogicalPortRequestData {
  ...
  private ServiceAccessPointLogicalPortEntityRestriction entityRestrictions;
  ...
  public ServiceAccessPointLogicalPortRequestData() {
  }

  public ServiceAccessPointLogicalPortRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public ServiceAccessPointLogicalPortRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public ServiceAccessPointLogicalPortRequestData entityRestrictions(ServiceAccessPointLogicalPortEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public ServiceAccessPointLogicalPortEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(ServiceAccessPointLogicalPortEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public ServiceAccessPointLogicalPortRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public ServiceAccessPointLogicalPortRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public ServiceAccessPointLogicalPortRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ServiceAccessPointLogicalPortRequestData serviceAccessPointLogicalPortRequestData = (ServiceAccessPointLogicalPortRequestData) o;
    return Objects.equals(this.returnEntityAttributes, serviceAccessPointLogicalPortRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, serviceAccessPointLogicalPortRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, serviceAccessPointLogicalPortRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, serviceAccessPointLogicalPortRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class ServiceAccessPointLogicalPortRequestData {\n");
