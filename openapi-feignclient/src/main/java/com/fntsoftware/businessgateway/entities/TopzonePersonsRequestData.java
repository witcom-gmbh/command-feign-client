...
import com.fntsoftware.businessgateway.entities.TopzonePersonsEntityRestriction;
import com.fntsoftware.businessgateway.entities.TopzonePersonsRelationRestriction;
...
/**
 * TopzonePersonsRequestData
 */
@JsonPropertyOrder({
  TopzonePersonsRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  TopzonePersonsRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  TopzonePersonsRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  TopzonePersonsRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-02-26T11:20:24.990023935Z[Etc/UTC]")
public class TopzonePersonsRequestData {
  ...
  private TopzonePersonsEntityRestriction entityRestrictions;

  public static final String JSON_PROPERTY_RELATION_RESTRICTIONS = "relationRestrictions";
  private TopzonePersonsRelationRestriction relationRestrictions;
  ...
  public TopzonePersonsRequestData() {
  }

  public TopzonePersonsRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public TopzonePersonsRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public TopzonePersonsRequestData entityRestrictions(TopzonePersonsEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public TopzonePersonsEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(TopzonePersonsEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public TopzonePersonsRequestData relationRestrictions(TopzonePersonsRelationRestriction relationRestrictions) {
  ...
  **/
  ...
  public TopzonePersonsRelationRestriction getRelationRestrictions() {
    return relationRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_RELATION_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRelationRestrictions(TopzonePersonsRelationRestriction relationRestrictions) {
    this.relationRestrictions = relationRestrictions;
  }


  public TopzonePersonsRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public TopzonePersonsRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    TopzonePersonsRequestData topzonePersonsRequestData = (TopzonePersonsRequestData) o;
    return Objects.equals(this.returnEntityAttributes, topzonePersonsRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, topzonePersonsRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, topzonePersonsRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, topzonePersonsRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class TopzonePersonsRequestData {\n");
