...
import com.fntsoftware.businessgateway.entities.BearerRoutesEntityRestriction;
import com.fntsoftware.businessgateway.entities.BearerRoutesRelationRestriction;
...
/**
 * BearerRoutesRequestData
 */
@JsonPropertyOrder({
  BearerRoutesRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  BearerRoutesRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  BearerRoutesRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  BearerRoutesRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-02-26T11:20:24.990023935Z[Etc/UTC]")
public class BearerRoutesRequestData {
  ...
  private BearerRoutesEntityRestriction entityRestrictions;

  public static final String JSON_PROPERTY_RELATION_RESTRICTIONS = "relationRestrictions";
  private BearerRoutesRelationRestriction relationRestrictions;
  ...
  public BearerRoutesRequestData() {
  }

  public BearerRoutesRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public BearerRoutesRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public BearerRoutesRequestData entityRestrictions(BearerRoutesEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public BearerRoutesEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(BearerRoutesEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public BearerRoutesRequestData relationRestrictions(BearerRoutesRelationRestriction relationRestrictions) {
  ...
  **/
  ...
  public BearerRoutesRelationRestriction getRelationRestrictions() {
    return relationRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_RELATION_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRelationRestrictions(BearerRoutesRelationRestriction relationRestrictions) {
    this.relationRestrictions = relationRestrictions;
  }


  public BearerRoutesRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public BearerRoutesRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    BearerRoutesRequestData bearerRoutesRequestData = (BearerRoutesRequestData) o;
    return Objects.equals(this.returnEntityAttributes, bearerRoutesRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, bearerRoutesRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, bearerRoutesRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, bearerRoutesRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class BearerRoutesRequestData {\n");
