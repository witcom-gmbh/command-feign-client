...
import com.fntsoftware.businessgateway.entities.CableMasterDataCableDataCablesEntityRestriction;
...
/**
 * CableMasterDataCableDataCablesRequestData
 */
@JsonPropertyOrder({
  CableMasterDataCableDataCablesRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  CableMasterDataCableDataCablesRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  CableMasterDataCableDataCablesRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  CableMasterDataCableDataCablesRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-02-26T11:20:24.990023935Z[Etc/UTC]")
public class CableMasterDataCableDataCablesRequestData {
  ...
  private CableMasterDataCableDataCablesEntityRestriction entityRestrictions;
  ...
  public CableMasterDataCableDataCablesRequestData() {
  }

  public CableMasterDataCableDataCablesRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public CableMasterDataCableDataCablesRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public CableMasterDataCableDataCablesRequestData entityRestrictions(CableMasterDataCableDataCablesEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public CableMasterDataCableDataCablesEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(CableMasterDataCableDataCablesEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public CableMasterDataCableDataCablesRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public CableMasterDataCableDataCablesRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public CableMasterDataCableDataCablesRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    CableMasterDataCableDataCablesRequestData cableMasterDataCableDataCablesRequestData = (CableMasterDataCableDataCablesRequestData) o;
    return Objects.equals(this.returnEntityAttributes, cableMasterDataCableDataCablesRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, cableMasterDataCableDataCablesRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, cableMasterDataCableDataCablesRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, cableMasterDataCableDataCablesRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class CableMasterDataCableDataCablesRequestData {\n");
