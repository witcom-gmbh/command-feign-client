...
/**
 * TerminalSlotEntityRestriction
 */
@JsonPropertyOrder({
  TerminalSlotEntityRestriction.JSON_PROPERTY_CLIMATE_RELEVANT,
  TerminalSlotEntityRestriction.JSON_PROPERTY_POWER_CONSUMPTION,
  TerminalSlotEntityRestriction.JSON_PROPERTY_POWER_SWITCHING_STATUS,
  TerminalSlotEntityRestriction.JSON_PROPERTY_PLAN_STATUS,
  TerminalSlotEntityRestriction.JSON_PROPERTY_SYSTEM_RUNTIME,
  TerminalSlotEntityRestriction.JSON_PROPERTY_WEIGHT,
  TerminalSlotEntityRestriction.JSON_PROPERTY_REMARK,
  TerminalSlotEntityRestriction.JSON_PROPERTY_ELID,
  TerminalSlotEntityRestriction.JSON_PROPERTY_LAST_SEEN,
  TerminalSlotEntityRestriction.JSON_PROPERTY_TYPE_ELID,
  TerminalSlotEntityRestriction.JSON_PROPERTY_VISIBLE_ID,
  TerminalSlotEntityRestriction.JSON_PROPERTY_ID,
  TerminalSlotEntityRestriction.JSON_PROPERTY_HEAT_EMISSION
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-03-04T13:31:32.601557352Z[Etc/UTC]")
public class TerminalSlotEntityRestriction {
  ...
  public TerminalSlotEntityRestriction() {
  }

  public TerminalSlotEntityRestriction climateRelevant(RestrictionsBoolean climateRelevant) {
  ...
  **/
  ...
  public TerminalSlotEntityRestriction powerConsumption(RestrictionsNumeric powerConsumption) {
  ...
  **/
  ...
  public TerminalSlotEntityRestriction powerSwitchingStatus(RestrictionsString powerSwitchingStatus) {
  ...
  **/
  ...
  public TerminalSlotEntityRestriction planStatus(RestrictionsString planStatus) {
  ...
  **/
  ...
  public TerminalSlotEntityRestriction systemRuntime(RestrictionsNumeric systemRuntime) {
  ...
  **/
  ...
  public TerminalSlotEntityRestriction weight(RestrictionsNumeric weight) {
  ...
  **/
  ...
  public TerminalSlotEntityRestriction remark(RestrictionsString remark) {
  ...
  **/
  ...
  public TerminalSlotEntityRestriction elid(RestrictionsString elid) {
  ...
  **/
  ...
  public TerminalSlotEntityRestriction lastSeen(RestrictionsDate lastSeen) {
  ...
  **/
  ...
  public TerminalSlotEntityRestriction typeElid(RestrictionsString typeElid) {
  ...
  **/
  ...
  public TerminalSlotEntityRestriction visibleId(RestrictionsString visibleId) {
  ...
  **/
  ...
  public TerminalSlotEntityRestriction id(RestrictionsString id) {
  ...
  **/
  ...
  public TerminalSlotEntityRestriction heatEmission(RestrictionsNumeric heatEmission) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    TerminalSlotEntityRestriction terminalSlotEntityRestriction = (TerminalSlotEntityRestriction) o;
    return Objects.equals(this.climateRelevant, terminalSlotEntityRestriction.climateRelevant) &&
        Objects.equals(this.powerConsumption, terminalSlotEntityRestriction.powerConsumption) &&
        Objects.equals(this.powerSwitchingStatus, terminalSlotEntityRestriction.powerSwitchingStatus) &&
        Objects.equals(this.planStatus, terminalSlotEntityRestriction.planStatus) &&
        Objects.equals(this.systemRuntime, terminalSlotEntityRestriction.systemRuntime) &&
        Objects.equals(this.weight, terminalSlotEntityRestriction.weight) &&
        Objects.equals(this.remark, terminalSlotEntityRestriction.remark) &&
        Objects.equals(this.elid, terminalSlotEntityRestriction.elid) &&
        Objects.equals(this.lastSeen, terminalSlotEntityRestriction.lastSeen) &&
        Objects.equals(this.typeElid, terminalSlotEntityRestriction.typeElid) &&
        Objects.equals(this.visibleId, terminalSlotEntityRestriction.visibleId) &&
        Objects.equals(this.id, terminalSlotEntityRestriction.id) &&
        Objects.equals(this.heatEmission, terminalSlotEntityRestriction.heatEmission);
  }
  ...
  public String toString() {
    ...
    sb.append("class TerminalSlotEntityRestriction {\n");
