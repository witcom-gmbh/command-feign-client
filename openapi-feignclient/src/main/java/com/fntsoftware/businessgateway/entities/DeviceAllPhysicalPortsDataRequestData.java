...
import com.fntsoftware.businessgateway.entities.DeviceAllPhysicalPortsDataEntityRestriction;
...
/**
 * DeviceAllPhysicalPortsDataRequestData
 */
@JsonPropertyOrder({
  DeviceAllPhysicalPortsDataRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  DeviceAllPhysicalPortsDataRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  DeviceAllPhysicalPortsDataRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  DeviceAllPhysicalPortsDataRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-02-26T11:20:24.990023935Z[Etc/UTC]")
public class DeviceAllPhysicalPortsDataRequestData {
  ...
  private DeviceAllPhysicalPortsDataEntityRestriction entityRestrictions;
  ...
  public DeviceAllPhysicalPortsDataRequestData() {
  }

  public DeviceAllPhysicalPortsDataRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public DeviceAllPhysicalPortsDataRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public DeviceAllPhysicalPortsDataRequestData entityRestrictions(DeviceAllPhysicalPortsDataEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public DeviceAllPhysicalPortsDataEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(DeviceAllPhysicalPortsDataEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public DeviceAllPhysicalPortsDataRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public DeviceAllPhysicalPortsDataRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public DeviceAllPhysicalPortsDataRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    DeviceAllPhysicalPortsDataRequestData deviceAllPhysicalPortsDataRequestData = (DeviceAllPhysicalPortsDataRequestData) o;
    return Objects.equals(this.returnEntityAttributes, deviceAllPhysicalPortsDataRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, deviceAllPhysicalPortsDataRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, deviceAllPhysicalPortsDataRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, deviceAllPhysicalPortsDataRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeviceAllPhysicalPortsDataRequestData {\n");
