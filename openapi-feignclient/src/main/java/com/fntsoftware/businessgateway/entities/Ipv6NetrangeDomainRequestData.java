...
import com.fntsoftware.businessgateway.entities.Ipv6NetrangeDomainEntityRestriction;
...
/**
 * Ipv6NetrangeDomainRequestData
 */
@JsonPropertyOrder({
  Ipv6NetrangeDomainRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  Ipv6NetrangeDomainRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  Ipv6NetrangeDomainRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  Ipv6NetrangeDomainRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-03-04T13:31:32.601557352Z[Etc/UTC]")
public class Ipv6NetrangeDomainRequestData {
  ...
  private Ipv6NetrangeDomainEntityRestriction entityRestrictions;
  ...
  public Ipv6NetrangeDomainRequestData() {
  }

  public Ipv6NetrangeDomainRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public Ipv6NetrangeDomainRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public Ipv6NetrangeDomainRequestData entityRestrictions(Ipv6NetrangeDomainEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public Ipv6NetrangeDomainEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(Ipv6NetrangeDomainEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public Ipv6NetrangeDomainRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public Ipv6NetrangeDomainRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public Ipv6NetrangeDomainRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    Ipv6NetrangeDomainRequestData ipv6NetrangeDomainRequestData = (Ipv6NetrangeDomainRequestData) o;
    return Objects.equals(this.returnEntityAttributes, ipv6NetrangeDomainRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, ipv6NetrangeDomainRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, ipv6NetrangeDomainRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, ipv6NetrangeDomainRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class Ipv6NetrangeDomainRequestData {\n");
