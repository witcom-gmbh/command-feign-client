...
import com.fntsoftware.businessgateway.entities.LogicalPortBearerRxEntityRestriction;
...
/**
 * LogicalPortBearerRxRequestData
 */
@JsonPropertyOrder({
  LogicalPortBearerRxRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  LogicalPortBearerRxRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  LogicalPortBearerRxRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  LogicalPortBearerRxRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-03-04T13:31:32.601557352Z[Etc/UTC]")
public class LogicalPortBearerRxRequestData {
  ...
  private LogicalPortBearerRxEntityRestriction entityRestrictions;
  ...
  public LogicalPortBearerRxRequestData() {
  }

  public LogicalPortBearerRxRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public LogicalPortBearerRxRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public LogicalPortBearerRxRequestData entityRestrictions(LogicalPortBearerRxEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public LogicalPortBearerRxEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(LogicalPortBearerRxEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public LogicalPortBearerRxRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public LogicalPortBearerRxRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public LogicalPortBearerRxRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    LogicalPortBearerRxRequestData logicalPortBearerRxRequestData = (LogicalPortBearerRxRequestData) o;
    return Objects.equals(this.returnEntityAttributes, logicalPortBearerRxRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, logicalPortBearerRxRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, logicalPortBearerRxRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, logicalPortBearerRxRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class LogicalPortBearerRxRequestData {\n");
