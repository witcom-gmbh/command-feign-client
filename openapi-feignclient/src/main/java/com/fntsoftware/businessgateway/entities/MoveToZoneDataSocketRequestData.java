...
import com.fntsoftware.businessgateway.entities.MoveToZoneDataSocketCreateLinkZoneRequestData;
import com.fasterxml.jackson.annotation.JsonPropertyOrder;
import com.fasterxml.jackson.annotation.JsonTypeName;

/**
 * MoveToZoneDataSocketRequestData
 */
@JsonPropertyOrder({
  MoveToZoneDataSocketRequestData.JSON_PROPERTY_RELEASE_SIGNALPATH,
  MoveToZoneDataSocketRequestData.JSON_PROPERTY_RELEASE_CONNECTIONS,
  MoveToZoneDataSocketRequestData.JSON_PROPERTY_RELEASE_SERVICE,
  MoveToZoneDataSocketRequestData.JSON_PROPERTY_RELEASE_SUPPORTS,
  MoveToZoneDataSocketRequestData.JSON_PROPERTY_RELEASE_PATCHES,
  MoveToZoneDataSocketRequestData.JSON_PROPERTY_CREATE_LINK_ZONE
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-02-26T11:20:24.990023935Z[Etc/UTC]")
public class MoveToZoneDataSocketRequestData {
  ...
  private MoveToZoneDataSocketCreateLinkZoneRequestData createLinkZone;

  public MoveToZoneDataSocketRequestData() {
  }

  public MoveToZoneDataSocketRequestData releaseSignalpath(Boolean releaseSignalpath) {
  ...
  **/
  ...
  public MoveToZoneDataSocketRequestData releaseConnections(Boolean releaseConnections) {
  ...
  **/
  ...
  public MoveToZoneDataSocketRequestData releaseService(Boolean releaseService) {
  ...
  **/
  ...
  public MoveToZoneDataSocketRequestData releaseSupports(Boolean releaseSupports) {
  ...
  **/
  ...
  public MoveToZoneDataSocketRequestData releasePatches(Boolean releasePatches) {
  ...
  **/
  ...
  public MoveToZoneDataSocketRequestData createLinkZone(MoveToZoneDataSocketCreateLinkZoneRequestData createLinkZone) {
  ...
  **/
  ...
  public MoveToZoneDataSocketCreateLinkZoneRequestData getCreateLinkZone() {
    return createLinkZone;
  }
  ...
  @JsonProperty(JSON_PROPERTY_CREATE_LINK_ZONE)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setCreateLinkZone(MoveToZoneDataSocketCreateLinkZoneRequestData createLinkZone) {
    this.createLinkZone = createLinkZone;
  }
  ...
  public boolean equals(Object o) {
    ...
    MoveToZoneDataSocketRequestData moveToZoneDataSocketRequestData = (MoveToZoneDataSocketRequestData) o;
    return Objects.equals(this.releaseSignalpath, moveToZoneDataSocketRequestData.releaseSignalpath) &&
        Objects.equals(this.releaseConnections, moveToZoneDataSocketRequestData.releaseConnections) &&
        Objects.equals(this.releaseService, moveToZoneDataSocketRequestData.releaseService) &&
        Objects.equals(this.releaseSupports, moveToZoneDataSocketRequestData.releaseSupports) &&
        Objects.equals(this.releasePatches, moveToZoneDataSocketRequestData.releasePatches) &&
        Objects.equals(this.createLinkZone, moveToZoneDataSocketRequestData.createLinkZone);
  }
  ...
  public String toString() {
    ...
    sb.append("class MoveToZoneDataSocketRequestData {\n");
