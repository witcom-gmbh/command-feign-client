...
import com.fntsoftware.businessgateway.entities.Ipv4NetrangeNetrangeNameEntityRestriction;
...
/**
 * Ipv4NetrangeNetrangeNameRequestData
 */
@JsonPropertyOrder({
  Ipv4NetrangeNetrangeNameRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  Ipv4NetrangeNetrangeNameRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  Ipv4NetrangeNetrangeNameRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  Ipv4NetrangeNetrangeNameRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-02-26T11:20:24.990023935Z[Etc/UTC]")
public class Ipv4NetrangeNetrangeNameRequestData {
  ...
  private Ipv4NetrangeNetrangeNameEntityRestriction entityRestrictions;
  ...
  public Ipv4NetrangeNetrangeNameRequestData() {
  }

  public Ipv4NetrangeNetrangeNameRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public Ipv4NetrangeNetrangeNameRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public Ipv4NetrangeNetrangeNameRequestData entityRestrictions(Ipv4NetrangeNetrangeNameEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public Ipv4NetrangeNetrangeNameEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(Ipv4NetrangeNetrangeNameEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public Ipv4NetrangeNetrangeNameRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public Ipv4NetrangeNetrangeNameRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public Ipv4NetrangeNetrangeNameRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    Ipv4NetrangeNetrangeNameRequestData ipv4NetrangeNetrangeNameRequestData = (Ipv4NetrangeNetrangeNameRequestData) o;
    return Objects.equals(this.returnEntityAttributes, ipv4NetrangeNetrangeNameRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, ipv4NetrangeNetrangeNameRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, ipv4NetrangeNetrangeNameRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, ipv4NetrangeNetrangeNameRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class Ipv4NetrangeNetrangeNameRequestData {\n");
