...
import com.fntsoftware.businessgateway.entities.DeviceMiscDeviceMasterEntityRestriction;
...
/**
 * DeviceMiscDeviceMasterRequestData
 */
@JsonPropertyOrder({
  DeviceMiscDeviceMasterRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  DeviceMiscDeviceMasterRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  DeviceMiscDeviceMasterRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  DeviceMiscDeviceMasterRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-02-26T11:20:24.990023935Z[Etc/UTC]")
public class DeviceMiscDeviceMasterRequestData {
  ...
  private DeviceMiscDeviceMasterEntityRestriction entityRestrictions;
  ...
  public DeviceMiscDeviceMasterRequestData() {
  }

  public DeviceMiscDeviceMasterRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public DeviceMiscDeviceMasterRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public DeviceMiscDeviceMasterRequestData entityRestrictions(DeviceMiscDeviceMasterEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public DeviceMiscDeviceMasterEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(DeviceMiscDeviceMasterEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public DeviceMiscDeviceMasterRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public DeviceMiscDeviceMasterRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public DeviceMiscDeviceMasterRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    DeviceMiscDeviceMasterRequestData deviceMiscDeviceMasterRequestData = (DeviceMiscDeviceMasterRequestData) o;
    return Objects.equals(this.returnEntityAttributes, deviceMiscDeviceMasterRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, deviceMiscDeviceMasterRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, deviceMiscDeviceMasterRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, deviceMiscDeviceMasterRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeviceMiscDeviceMasterRequestData {\n");
