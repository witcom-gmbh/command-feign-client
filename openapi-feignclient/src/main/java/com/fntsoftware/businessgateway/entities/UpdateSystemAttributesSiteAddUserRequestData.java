...
/**
 * UpdateSystemAttributesSiteAddUserRequestData
 */
@JsonPropertyOrder({
  UpdateSystemAttributesSiteAddUserRequestData.JSON_PROPERTY_MODIFY_PLAN,
  UpdateSystemAttributesSiteAddUserRequestData.JSON_PROPERTY_DELETE_REAL,
  UpdateSystemAttributesSiteAddUserRequestData.JSON_PROPERTY_READ_PLAN,
  UpdateSystemAttributesSiteAddUserRequestData.JSON_PROPERTY_MANDANT_ID,
  UpdateSystemAttributesSiteAddUserRequestData.JSON_PROPERTY_USER_ELID,
  UpdateSystemAttributesSiteAddUserRequestData.JSON_PROPERTY_MODIFY_REAL,
  UpdateSystemAttributesSiteAddUserRequestData.JSON_PROPERTY_READ_REAL,
  UpdateSystemAttributesSiteAddUserRequestData.JSON_PROPERTY_DELETE_PLAN
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-01-31T11:10:37.320689708Z[Etc/UTC]")
public class UpdateSystemAttributesSiteAddUserRequestData {
  ...
  public UpdateSystemAttributesSiteAddUserRequestData() {
  }

  public UpdateSystemAttributesSiteAddUserRequestData modifyPlan(Boolean modifyPlan) {
  ...
  **/
  ...
  public UpdateSystemAttributesSiteAddUserRequestData deleteReal(Boolean deleteReal) {
  ...
  **/
  ...
  public UpdateSystemAttributesSiteAddUserRequestData readPlan(Boolean readPlan) {
  ...
  **/
  ...
  public UpdateSystemAttributesSiteAddUserRequestData mandantId(BigDecimal mandantId) {
  ...
  **/
  ...
  public UpdateSystemAttributesSiteAddUserRequestData userElid(String userElid) {
  ...
  **/
  ...
  public UpdateSystemAttributesSiteAddUserRequestData modifyReal(Boolean modifyReal) {
  ...
  **/
  ...
  public UpdateSystemAttributesSiteAddUserRequestData readReal(Boolean readReal) {
  ...
  **/
  ...
  public UpdateSystemAttributesSiteAddUserRequestData deletePlan(Boolean deletePlan) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    UpdateSystemAttributesSiteAddUserRequestData updateSystemAttributesSiteAddUserRequestData = (UpdateSystemAttributesSiteAddUserRequestData) o;
    return Objects.equals(this.modifyPlan, updateSystemAttributesSiteAddUserRequestData.modifyPlan) &&
        Objects.equals(this.deleteReal, updateSystemAttributesSiteAddUserRequestData.deleteReal) &&
        Objects.equals(this.readPlan, updateSystemAttributesSiteAddUserRequestData.readPlan) &&
        Objects.equals(this.mandantId, updateSystemAttributesSiteAddUserRequestData.mandantId) &&
        Objects.equals(this.userElid, updateSystemAttributesSiteAddUserRequestData.userElid) &&
        Objects.equals(this.modifyReal, updateSystemAttributesSiteAddUserRequestData.modifyReal) &&
        Objects.equals(this.readReal, updateSystemAttributesSiteAddUserRequestData.readReal) &&
        Objects.equals(this.deletePlan, updateSystemAttributesSiteAddUserRequestData.deletePlan);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateSystemAttributesSiteAddUserRequestData {\n");
