...
import com.fntsoftware.businessgateway.entities.CellAntennaEntityRestriction;
import com.fntsoftware.businessgateway.entities.CellAntennaRelationRestriction;
...
/**
 * CellAntennaRequestData
 */
@JsonPropertyOrder({
  CellAntennaRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  CellAntennaRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  CellAntennaRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  CellAntennaRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-02-26T11:20:24.990023935Z[Etc/UTC]")
public class CellAntennaRequestData {
  ...
  private CellAntennaEntityRestriction entityRestrictions;

  public static final String JSON_PROPERTY_RELATION_RESTRICTIONS = "relationRestrictions";
  private CellAntennaRelationRestriction relationRestrictions;
  ...
  public CellAntennaRequestData() {
  }

  public CellAntennaRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public CellAntennaRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public CellAntennaRequestData entityRestrictions(CellAntennaEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public CellAntennaEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(CellAntennaEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public CellAntennaRequestData relationRestrictions(CellAntennaRelationRestriction relationRestrictions) {
  ...
  **/
  ...
  public CellAntennaRelationRestriction getRelationRestrictions() {
    return relationRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_RELATION_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRelationRestrictions(CellAntennaRelationRestriction relationRestrictions) {
    this.relationRestrictions = relationRestrictions;
  }


  public CellAntennaRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public CellAntennaRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    CellAntennaRequestData cellAntennaRequestData = (CellAntennaRequestData) o;
    return Objects.equals(this.returnEntityAttributes, cellAntennaRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, cellAntennaRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, cellAntennaRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, cellAntennaRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class CellAntennaRequestData {\n");
