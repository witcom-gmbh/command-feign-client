...
import com.fntsoftware.businessgateway.entities.StorageZoneEntityRestriction;
...
/**
 * StorageZoneRequestData
 */
@JsonPropertyOrder({
  StorageZoneRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  StorageZoneRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  StorageZoneRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  StorageZoneRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-02-26T11:20:24.990023935Z[Etc/UTC]")
public class StorageZoneRequestData {
  ...
  private StorageZoneEntityRestriction entityRestrictions;
  ...
  public StorageZoneRequestData() {
  }

  public StorageZoneRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public StorageZoneRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public StorageZoneRequestData entityRestrictions(StorageZoneEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public StorageZoneEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(StorageZoneEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public StorageZoneRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public StorageZoneRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public StorageZoneRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    StorageZoneRequestData storageZoneRequestData = (StorageZoneRequestData) o;
    return Objects.equals(this.returnEntityAttributes, storageZoneRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, storageZoneRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, storageZoneRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, storageZoneRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class StorageZoneRequestData {\n");
