...
import com.fntsoftware.businessgateway.entities.DuctPersonsEntityRestriction;
import com.fntsoftware.businessgateway.entities.DuctPersonsRelationRestriction;
...
/**
 * DuctPersonsRequestData
 */
@JsonPropertyOrder({
  DuctPersonsRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  DuctPersonsRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  DuctPersonsRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  DuctPersonsRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-03-04T13:31:32.601557352Z[Etc/UTC]")
public class DuctPersonsRequestData {
  ...
  private DuctPersonsEntityRestriction entityRestrictions;

  public static final String JSON_PROPERTY_RELATION_RESTRICTIONS = "relationRestrictions";
  private DuctPersonsRelationRestriction relationRestrictions;
  ...
  public DuctPersonsRequestData() {
  }

  public DuctPersonsRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public DuctPersonsRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public DuctPersonsRequestData entityRestrictions(DuctPersonsEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public DuctPersonsEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(DuctPersonsEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public DuctPersonsRequestData relationRestrictions(DuctPersonsRelationRestriction relationRestrictions) {
  ...
  **/
  ...
  public DuctPersonsRelationRestriction getRelationRestrictions() {
    return relationRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_RELATION_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRelationRestrictions(DuctPersonsRelationRestriction relationRestrictions) {
    this.relationRestrictions = relationRestrictions;
  }


  public DuctPersonsRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public DuctPersonsRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    DuctPersonsRequestData ductPersonsRequestData = (DuctPersonsRequestData) o;
    return Objects.equals(this.returnEntityAttributes, ductPersonsRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, ductPersonsRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, ductPersonsRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, ductPersonsRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class DuctPersonsRequestData {\n");
