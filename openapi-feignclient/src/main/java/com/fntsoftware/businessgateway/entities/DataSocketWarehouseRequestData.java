...
import com.fntsoftware.businessgateway.entities.DataSocketWarehouseEntityRestriction;
...
/**
 * DataSocketWarehouseRequestData
 */
@JsonPropertyOrder({
  DataSocketWarehouseRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  DataSocketWarehouseRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  DataSocketWarehouseRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  DataSocketWarehouseRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-01-31T11:10:37.320689708Z[Etc/UTC]")
public class DataSocketWarehouseRequestData {
  ...
  private DataSocketWarehouseEntityRestriction entityRestrictions;
  ...
  public DataSocketWarehouseRequestData() {
  }

  public DataSocketWarehouseRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public DataSocketWarehouseRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public DataSocketWarehouseRequestData entityRestrictions(DataSocketWarehouseEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public DataSocketWarehouseEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(DataSocketWarehouseEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public DataSocketWarehouseRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public DataSocketWarehouseRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public DataSocketWarehouseRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    DataSocketWarehouseRequestData dataSocketWarehouseRequestData = (DataSocketWarehouseRequestData) o;
    return Objects.equals(this.returnEntityAttributes, dataSocketWarehouseRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, dataSocketWarehouseRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, dataSocketWarehouseRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, dataSocketWarehouseRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class DataSocketWarehouseRequestData {\n");
