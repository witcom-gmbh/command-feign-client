...
import com.fntsoftware.businessgateway.entities.ServiceTelcoTrailEndZoneEntityRestriction;
...
/**
 * ServiceTelcoTrailEndZoneRequestData
 */
@JsonPropertyOrder({
  ServiceTelcoTrailEndZoneRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  ServiceTelcoTrailEndZoneRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  ServiceTelcoTrailEndZoneRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  ServiceTelcoTrailEndZoneRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-01-31T11:10:37.320689708Z[Etc/UTC]")
public class ServiceTelcoTrailEndZoneRequestData {
  ...
  private ServiceTelcoTrailEndZoneEntityRestriction entityRestrictions;
  ...
  public ServiceTelcoTrailEndZoneRequestData() {
  }

  public ServiceTelcoTrailEndZoneRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public ServiceTelcoTrailEndZoneRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public ServiceTelcoTrailEndZoneRequestData entityRestrictions(ServiceTelcoTrailEndZoneEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public ServiceTelcoTrailEndZoneEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(ServiceTelcoTrailEndZoneEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public ServiceTelcoTrailEndZoneRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public ServiceTelcoTrailEndZoneRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public ServiceTelcoTrailEndZoneRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ServiceTelcoTrailEndZoneRequestData serviceTelcoTrailEndZoneRequestData = (ServiceTelcoTrailEndZoneRequestData) o;
    return Objects.equals(this.returnEntityAttributes, serviceTelcoTrailEndZoneRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, serviceTelcoTrailEndZoneRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, serviceTelcoTrailEndZoneRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, serviceTelcoTrailEndZoneRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class ServiceTelcoTrailEndZoneRequestData {\n");
