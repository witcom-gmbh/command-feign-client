...
import com.fntsoftware.businessgateway.entities.MultiDuctFromDeviceAllEntityRestriction;
...
/**
 * MultiDuctFromDeviceAllRequestData
 */
@JsonPropertyOrder({
  MultiDuctFromDeviceAllRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  MultiDuctFromDeviceAllRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  MultiDuctFromDeviceAllRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  MultiDuctFromDeviceAllRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-03-04T13:31:32.601557352Z[Etc/UTC]")
public class MultiDuctFromDeviceAllRequestData {
  ...
  private MultiDuctFromDeviceAllEntityRestriction entityRestrictions;
  ...
  public MultiDuctFromDeviceAllRequestData() {
  }

  public MultiDuctFromDeviceAllRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public MultiDuctFromDeviceAllRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public MultiDuctFromDeviceAllRequestData entityRestrictions(MultiDuctFromDeviceAllEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public MultiDuctFromDeviceAllEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(MultiDuctFromDeviceAllEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public MultiDuctFromDeviceAllRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public MultiDuctFromDeviceAllRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public MultiDuctFromDeviceAllRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    MultiDuctFromDeviceAllRequestData multiDuctFromDeviceAllRequestData = (MultiDuctFromDeviceAllRequestData) o;
    return Objects.equals(this.returnEntityAttributes, multiDuctFromDeviceAllRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, multiDuctFromDeviceAllRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, multiDuctFromDeviceAllRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, multiDuctFromDeviceAllRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class MultiDuctFromDeviceAllRequestData {\n");
