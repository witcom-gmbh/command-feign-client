...
import com.fntsoftware.businessgateway.entities.CreateShareResponseData;
 ...
 */
@JsonPropertyOrder({
  CreateShareResponse.JSON_PROPERTY_RETURN_DATA,
  CreateShareResponse.JSON_PROPERTY_STATUS
})
...
public class CreateShareResponse {
  ...
  private CreateShareResponseData returnData;
  ...
  public CreateShareResponse returnData(CreateShareResponseData returnData) {
  ...
  **/
  ...
  public CreateShareResponseData getReturnData() {
    return returnData;
  }
  ...
  @JsonProperty(JSON_PROPERTY_RETURN_DATA)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setReturnData(CreateShareResponseData returnData) {
    this.returnData = returnData;
  }


  public CreateShareResponse status(ServiceStatusData status) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.returnData, createShareResponse.returnData) &&
