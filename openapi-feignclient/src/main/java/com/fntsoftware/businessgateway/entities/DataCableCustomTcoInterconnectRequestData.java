...
import com.fntsoftware.businessgateway.entities.DataCableCustomTcoInterconnectEntityRestriction;
...
/**
 * DataCableCustomTcoInterconnectRequestData
 */
@JsonPropertyOrder({
  DataCableCustomTcoInterconnectRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  DataCableCustomTcoInterconnectRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  DataCableCustomTcoInterconnectRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  DataCableCustomTcoInterconnectRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-02-26T11:20:24.990023935Z[Etc/UTC]")
public class DataCableCustomTcoInterconnectRequestData {
  ...
  private DataCableCustomTcoInterconnectEntityRestriction entityRestrictions;
  ...
  public DataCableCustomTcoInterconnectRequestData() {
  }

  public DataCableCustomTcoInterconnectRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public DataCableCustomTcoInterconnectRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public DataCableCustomTcoInterconnectRequestData entityRestrictions(DataCableCustomTcoInterconnectEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public DataCableCustomTcoInterconnectEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(DataCableCustomTcoInterconnectEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public DataCableCustomTcoInterconnectRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public DataCableCustomTcoInterconnectRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public DataCableCustomTcoInterconnectRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    DataCableCustomTcoInterconnectRequestData dataCableCustomTcoInterconnectRequestData = (DataCableCustomTcoInterconnectRequestData) o;
    return Objects.equals(this.returnEntityAttributes, dataCableCustomTcoInterconnectRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, dataCableCustomTcoInterconnectRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, dataCableCustomTcoInterconnectRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, dataCableCustomTcoInterconnectRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class DataCableCustomTcoInterconnectRequestData {\n");
