...
import com.fntsoftware.businessgateway.entities.MoveToZoneDeviceAllCreateLinkZoneRequestData;
import com.fasterxml.jackson.annotation.JsonPropertyOrder;
import com.fasterxml.jackson.annotation.JsonTypeName;

/**
 * MoveToZoneDeviceAllRequestData
 */
@JsonPropertyOrder({
  MoveToZoneDeviceAllRequestData.JSON_PROPERTY_RELEASE_SIGNALPATH,
  MoveToZoneDeviceAllRequestData.JSON_PROPERTY_RELEASE_CONNECTIONS,
  MoveToZoneDeviceAllRequestData.JSON_PROPERTY_RELEASE_SERVICE,
  MoveToZoneDeviceAllRequestData.JSON_PROPERTY_RELEASE_SUPPORTS,
  MoveToZoneDeviceAllRequestData.JSON_PROPERTY_RELEASE_PATCHES,
  MoveToZoneDeviceAllRequestData.JSON_PROPERTY_CREATE_LINK_ZONE
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-02-26T11:20:24.990023935Z[Etc/UTC]")
public class MoveToZoneDeviceAllRequestData {
  ...
  private MoveToZoneDeviceAllCreateLinkZoneRequestData createLinkZone;

  public MoveToZoneDeviceAllRequestData() {
  }

  public MoveToZoneDeviceAllRequestData releaseSignalpath(Boolean releaseSignalpath) {
  ...
  **/
  ...
  public MoveToZoneDeviceAllRequestData releaseConnections(Boolean releaseConnections) {
  ...
  **/
  ...
  public MoveToZoneDeviceAllRequestData releaseService(Boolean releaseService) {
  ...
  **/
  ...
  public MoveToZoneDeviceAllRequestData releaseSupports(Boolean releaseSupports) {
  ...
  **/
  ...
  public MoveToZoneDeviceAllRequestData releasePatches(Boolean releasePatches) {
  ...
  **/
  ...
  public MoveToZoneDeviceAllRequestData createLinkZone(MoveToZoneDeviceAllCreateLinkZoneRequestData createLinkZone) {
  ...
  **/
  ...
  public MoveToZoneDeviceAllCreateLinkZoneRequestData getCreateLinkZone() {
    return createLinkZone;
  }
  ...
  @JsonProperty(JSON_PROPERTY_CREATE_LINK_ZONE)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setCreateLinkZone(MoveToZoneDeviceAllCreateLinkZoneRequestData createLinkZone) {
    this.createLinkZone = createLinkZone;
  }
  ...
  public boolean equals(Object o) {
    ...
    MoveToZoneDeviceAllRequestData moveToZoneDeviceAllRequestData = (MoveToZoneDeviceAllRequestData) o;
    return Objects.equals(this.releaseSignalpath, moveToZoneDeviceAllRequestData.releaseSignalpath) &&
        Objects.equals(this.releaseConnections, moveToZoneDeviceAllRequestData.releaseConnections) &&
        Objects.equals(this.releaseService, moveToZoneDeviceAllRequestData.releaseService) &&
        Objects.equals(this.releaseSupports, moveToZoneDeviceAllRequestData.releaseSupports) &&
        Objects.equals(this.releasePatches, moveToZoneDeviceAllRequestData.releasePatches) &&
        Objects.equals(this.createLinkZone, moveToZoneDeviceAllRequestData.createLinkZone);
  }
  ...
  public String toString() {
    ...
    sb.append("class MoveToZoneDeviceAllRequestData {\n");
