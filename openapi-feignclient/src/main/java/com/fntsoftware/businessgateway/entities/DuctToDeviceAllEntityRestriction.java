...
/**
 * DuctToDeviceAllEntityRestriction
 */
@JsonPropertyOrder({
  DuctToDeviceAllEntityRestriction.JSON_PROPERTY_CLIMATE_RELEVANT,
  DuctToDeviceAllEntityRestriction.JSON_PROPERTY_POWER_CONSUMPTION,
  DuctToDeviceAllEntityRestriction.JSON_PROPERTY_POWER_SWITCHING_STATUS,
  DuctToDeviceAllEntityRestriction.JSON_PROPERTY_PLAN_STATUS,
  DuctToDeviceAllEntityRestriction.JSON_PROPERTY_SYSTEM_RUNTIME,
  DuctToDeviceAllEntityRestriction.JSON_PROPERTY_WEIGHT,
  DuctToDeviceAllEntityRestriction.JSON_PROPERTY_REMARK,
  DuctToDeviceAllEntityRestriction.JSON_PROPERTY_ELID,
  DuctToDeviceAllEntityRestriction.JSON_PROPERTY_LAST_SEEN,
  DuctToDeviceAllEntityRestriction.JSON_PROPERTY_TYPE_ELID,
  DuctToDeviceAllEntityRestriction.JSON_PROPERTY_VISIBLE_ID,
  DuctToDeviceAllEntityRestriction.JSON_PROPERTY_ID,
  DuctToDeviceAllEntityRestriction.JSON_PROPERTY_HEAT_EMISSION
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-01-31T11:10:37.320689708Z[Etc/UTC]")
public class DuctToDeviceAllEntityRestriction {
  ...
  public DuctToDeviceAllEntityRestriction() {
  }

  public DuctToDeviceAllEntityRestriction climateRelevant(RestrictionsBoolean climateRelevant) {
  ...
  **/
  ...
  public DuctToDeviceAllEntityRestriction powerConsumption(RestrictionsNumeric powerConsumption) {
  ...
  **/
  ...
  public DuctToDeviceAllEntityRestriction powerSwitchingStatus(RestrictionsString powerSwitchingStatus) {
  ...
  **/
  ...
  public DuctToDeviceAllEntityRestriction planStatus(RestrictionsString planStatus) {
  ...
  **/
  ...
  public DuctToDeviceAllEntityRestriction systemRuntime(RestrictionsNumeric systemRuntime) {
  ...
  **/
  ...
  public DuctToDeviceAllEntityRestriction weight(RestrictionsNumeric weight) {
  ...
  **/
  ...
  public DuctToDeviceAllEntityRestriction remark(RestrictionsString remark) {
  ...
  **/
  ...
  public DuctToDeviceAllEntityRestriction elid(RestrictionsString elid) {
  ...
  **/
  ...
  public DuctToDeviceAllEntityRestriction lastSeen(RestrictionsDate lastSeen) {
  ...
  **/
  ...
  public DuctToDeviceAllEntityRestriction typeElid(RestrictionsString typeElid) {
  ...
  **/
  ...
  public DuctToDeviceAllEntityRestriction visibleId(RestrictionsString visibleId) {
  ...
  **/
  ...
  public DuctToDeviceAllEntityRestriction id(RestrictionsString id) {
  ...
  **/
  ...
  public DuctToDeviceAllEntityRestriction heatEmission(RestrictionsNumeric heatEmission) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    DuctToDeviceAllEntityRestriction ductToDeviceAllEntityRestriction = (DuctToDeviceAllEntityRestriction) o;
    return Objects.equals(this.climateRelevant, ductToDeviceAllEntityRestriction.climateRelevant) &&
        Objects.equals(this.powerConsumption, ductToDeviceAllEntityRestriction.powerConsumption) &&
        Objects.equals(this.powerSwitchingStatus, ductToDeviceAllEntityRestriction.powerSwitchingStatus) &&
        Objects.equals(this.planStatus, ductToDeviceAllEntityRestriction.planStatus) &&
        Objects.equals(this.systemRuntime, ductToDeviceAllEntityRestriction.systemRuntime) &&
        Objects.equals(this.weight, ductToDeviceAllEntityRestriction.weight) &&
        Objects.equals(this.remark, ductToDeviceAllEntityRestriction.remark) &&
        Objects.equals(this.elid, ductToDeviceAllEntityRestriction.elid) &&
        Objects.equals(this.lastSeen, ductToDeviceAllEntityRestriction.lastSeen) &&
        Objects.equals(this.typeElid, ductToDeviceAllEntityRestriction.typeElid) &&
        Objects.equals(this.visibleId, ductToDeviceAllEntityRestriction.visibleId) &&
        Objects.equals(this.id, ductToDeviceAllEntityRestriction.id) &&
        Objects.equals(this.heatEmission, ductToDeviceAllEntityRestriction.heatEmission);
  }
  ...
  public String toString() {
    ...
    sb.append("class DuctToDeviceAllEntityRestriction {\n");
