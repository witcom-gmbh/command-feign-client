...
import com.fntsoftware.businessgateway.entities.AliasHostnameEntityRestriction;
...
/**
 * AliasHostnameRequestData
 */
@JsonPropertyOrder({
  AliasHostnameRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  AliasHostnameRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  AliasHostnameRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  AliasHostnameRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-03-04T13:31:32.601557352Z[Etc/UTC]")
public class AliasHostnameRequestData {
  ...
  private AliasHostnameEntityRestriction entityRestrictions;
  ...
  public AliasHostnameRequestData() {
  }

  public AliasHostnameRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public AliasHostnameRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public AliasHostnameRequestData entityRestrictions(AliasHostnameEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public AliasHostnameEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(AliasHostnameEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public AliasHostnameRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public AliasHostnameRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public AliasHostnameRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    AliasHostnameRequestData aliasHostnameRequestData = (AliasHostnameRequestData) o;
    return Objects.equals(this.returnEntityAttributes, aliasHostnameRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, aliasHostnameRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, aliasHostnameRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, aliasHostnameRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class AliasHostnameRequestData {\n");
