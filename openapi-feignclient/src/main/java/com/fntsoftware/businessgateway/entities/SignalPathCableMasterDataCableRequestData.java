...
import com.fntsoftware.businessgateway.entities.SignalPathCableMasterDataCableEntityRestriction;
...
/**
 * SignalPathCableMasterDataCableRequestData
 */
@JsonPropertyOrder({
  SignalPathCableMasterDataCableRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  SignalPathCableMasterDataCableRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  SignalPathCableMasterDataCableRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  SignalPathCableMasterDataCableRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-02-26T11:20:24.990023935Z[Etc/UTC]")
public class SignalPathCableMasterDataCableRequestData {
  ...
  private SignalPathCableMasterDataCableEntityRestriction entityRestrictions;
  ...
  public SignalPathCableMasterDataCableRequestData() {
  }

  public SignalPathCableMasterDataCableRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public SignalPathCableMasterDataCableRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public SignalPathCableMasterDataCableRequestData entityRestrictions(SignalPathCableMasterDataCableEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public SignalPathCableMasterDataCableEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(SignalPathCableMasterDataCableEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public SignalPathCableMasterDataCableRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public SignalPathCableMasterDataCableRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public SignalPathCableMasterDataCableRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    SignalPathCableMasterDataCableRequestData signalPathCableMasterDataCableRequestData = (SignalPathCableMasterDataCableRequestData) o;
    return Objects.equals(this.returnEntityAttributes, signalPathCableMasterDataCableRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, signalPathCableMasterDataCableRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, signalPathCableMasterDataCableRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, signalPathCableMasterDataCableRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class SignalPathCableMasterDataCableRequestData {\n");
