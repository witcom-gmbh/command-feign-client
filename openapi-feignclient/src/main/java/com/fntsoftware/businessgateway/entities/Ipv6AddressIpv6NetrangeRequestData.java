...
import com.fntsoftware.businessgateway.entities.Ipv6AddressIpv6NetrangeEntityRestriction;
...
/**
 * Ipv6AddressIpv6NetrangeRequestData
 */
@JsonPropertyOrder({
  Ipv6AddressIpv6NetrangeRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  Ipv6AddressIpv6NetrangeRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  Ipv6AddressIpv6NetrangeRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  Ipv6AddressIpv6NetrangeRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-02-26T11:20:24.990023935Z[Etc/UTC]")
public class Ipv6AddressIpv6NetrangeRequestData {
  ...
  private Ipv6AddressIpv6NetrangeEntityRestriction entityRestrictions;
  ...
  public Ipv6AddressIpv6NetrangeRequestData() {
  }

  public Ipv6AddressIpv6NetrangeRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public Ipv6AddressIpv6NetrangeRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public Ipv6AddressIpv6NetrangeRequestData entityRestrictions(Ipv6AddressIpv6NetrangeEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public Ipv6AddressIpv6NetrangeEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(Ipv6AddressIpv6NetrangeEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public Ipv6AddressIpv6NetrangeRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public Ipv6AddressIpv6NetrangeRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public Ipv6AddressIpv6NetrangeRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    Ipv6AddressIpv6NetrangeRequestData ipv6AddressIpv6NetrangeRequestData = (Ipv6AddressIpv6NetrangeRequestData) o;
    return Objects.equals(this.returnEntityAttributes, ipv6AddressIpv6NetrangeRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, ipv6AddressIpv6NetrangeRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, ipv6AddressIpv6NetrangeRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, ipv6AddressIpv6NetrangeRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class Ipv6AddressIpv6NetrangeRequestData {\n");
