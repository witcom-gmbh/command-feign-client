...
import com.fntsoftware.businessgateway.entities.ProcessorServerEntityRestriction;
import com.fntsoftware.businessgateway.entities.ProcessorServerRelationRestriction;
...
/**
 * ProcessorServerRequestData
 */
@JsonPropertyOrder({
  ProcessorServerRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  ProcessorServerRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  ProcessorServerRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  ProcessorServerRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-02-26T11:20:24.990023935Z[Etc/UTC]")
public class ProcessorServerRequestData {
  ...
  private ProcessorServerEntityRestriction entityRestrictions;

  public static final String JSON_PROPERTY_RELATION_RESTRICTIONS = "relationRestrictions";
  private ProcessorServerRelationRestriction relationRestrictions;
  ...
  public ProcessorServerRequestData() {
  }

  public ProcessorServerRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public ProcessorServerRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public ProcessorServerRequestData entityRestrictions(ProcessorServerEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public ProcessorServerEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(ProcessorServerEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public ProcessorServerRequestData relationRestrictions(ProcessorServerRelationRestriction relationRestrictions) {
  ...
  **/
  ...
  public ProcessorServerRelationRestriction getRelationRestrictions() {
    return relationRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_RELATION_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRelationRestrictions(ProcessorServerRelationRestriction relationRestrictions) {
    this.relationRestrictions = relationRestrictions;
  }


  public ProcessorServerRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public ProcessorServerRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ProcessorServerRequestData processorServerRequestData = (ProcessorServerRequestData) o;
    return Objects.equals(this.returnEntityAttributes, processorServerRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, processorServerRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, processorServerRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, processorServerRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class ProcessorServerRequestData {\n");
