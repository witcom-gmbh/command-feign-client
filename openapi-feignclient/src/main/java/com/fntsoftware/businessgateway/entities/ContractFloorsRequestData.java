...
import com.fntsoftware.businessgateway.entities.ContractFloorsEntityRestriction;
import com.fntsoftware.businessgateway.entities.ContractFloorsRelationRestriction;
...
/**
 * ContractFloorsRequestData
 */
@JsonPropertyOrder({
  ContractFloorsRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  ContractFloorsRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  ContractFloorsRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  ContractFloorsRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-02-26T11:20:24.990023935Z[Etc/UTC]")
public class ContractFloorsRequestData {
  ...
  private ContractFloorsEntityRestriction entityRestrictions;

  public static final String JSON_PROPERTY_RELATION_RESTRICTIONS = "relationRestrictions";
  private ContractFloorsRelationRestriction relationRestrictions;
  ...
  public ContractFloorsRequestData() {
  }

  public ContractFloorsRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public ContractFloorsRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public ContractFloorsRequestData entityRestrictions(ContractFloorsEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public ContractFloorsEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(ContractFloorsEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public ContractFloorsRequestData relationRestrictions(ContractFloorsRelationRestriction relationRestrictions) {
  ...
  **/
  ...
  public ContractFloorsRelationRestriction getRelationRestrictions() {
    return relationRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_RELATION_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRelationRestrictions(ContractFloorsRelationRestriction relationRestrictions) {
    this.relationRestrictions = relationRestrictions;
  }


  public ContractFloorsRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public ContractFloorsRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ContractFloorsRequestData contractFloorsRequestData = (ContractFloorsRequestData) o;
    return Objects.equals(this.returnEntityAttributes, contractFloorsRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, contractFloorsRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, contractFloorsRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, contractFloorsRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class ContractFloorsRequestData {\n");
