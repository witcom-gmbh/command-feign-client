...
import com.fntsoftware.businessgateway.entities.DeviceMasterPdusEntityRestriction;
...
/**
 * DeviceMasterPdusRequestData
 */
@JsonPropertyOrder({
  DeviceMasterPdusRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  DeviceMasterPdusRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  DeviceMasterPdusRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  DeviceMasterPdusRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-01-31T11:10:37.320689708Z[Etc/UTC]")
public class DeviceMasterPdusRequestData {
  ...
  private DeviceMasterPdusEntityRestriction entityRestrictions;
  ...
  public DeviceMasterPdusRequestData() {
  }

  public DeviceMasterPdusRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public DeviceMasterPdusRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public DeviceMasterPdusRequestData entityRestrictions(DeviceMasterPdusEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public DeviceMasterPdusEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(DeviceMasterPdusEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public DeviceMasterPdusRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public DeviceMasterPdusRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public DeviceMasterPdusRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    DeviceMasterPdusRequestData deviceMasterPdusRequestData = (DeviceMasterPdusRequestData) o;
    return Objects.equals(this.returnEntityAttributes, deviceMasterPdusRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, deviceMasterPdusRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, deviceMasterPdusRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, deviceMasterPdusRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeviceMasterPdusRequestData {\n");
