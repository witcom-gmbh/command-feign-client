...
import com.fntsoftware.businessgateway.entities.ContractRoomsEntityRestriction;
import com.fntsoftware.businessgateway.entities.ContractRoomsRelationRestriction;
...
/**
 * ContractRoomsRequestData
 */
@JsonPropertyOrder({
  ContractRoomsRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  ContractRoomsRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  ContractRoomsRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  ContractRoomsRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-02-26T11:20:24.990023935Z[Etc/UTC]")
public class ContractRoomsRequestData {
  ...
  private ContractRoomsEntityRestriction entityRestrictions;

  public static final String JSON_PROPERTY_RELATION_RESTRICTIONS = "relationRestrictions";
  private ContractRoomsRelationRestriction relationRestrictions;
  ...
  public ContractRoomsRequestData() {
  }

  public ContractRoomsRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public ContractRoomsRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public ContractRoomsRequestData entityRestrictions(ContractRoomsEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public ContractRoomsEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(ContractRoomsEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public ContractRoomsRequestData relationRestrictions(ContractRoomsRelationRestriction relationRestrictions) {
  ...
  **/
  ...
  public ContractRoomsRelationRestriction getRelationRestrictions() {
    return relationRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_RELATION_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRelationRestrictions(ContractRoomsRelationRestriction relationRestrictions) {
    this.relationRestrictions = relationRestrictions;
  }


  public ContractRoomsRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public ContractRoomsRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ContractRoomsRequestData contractRoomsRequestData = (ContractRoomsRequestData) o;
    return Objects.equals(this.returnEntityAttributes, contractRoomsRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, contractRoomsRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, contractRoomsRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, contractRoomsRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class ContractRoomsRequestData {\n");
