...
import com.fntsoftware.businessgateway.entities.CreateOrderResponseData;
 ...
 */
@JsonPropertyOrder({
  CreateOrderResponse.JSON_PROPERTY_RETURN_DATA,
  CreateOrderResponse.JSON_PROPERTY_STATUS
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-01-31T11:10:37.320689708Z[Etc/UTC]")
public class CreateOrderResponse {
  public static final String JSON_PROPERTY_RETURN_DATA = "returnData";
  private CreateOrderResponseData returnData;
  ...
  public CreateOrderResponse returnData(CreateOrderResponseData returnData) {
  ...
  **/
  ...
  public CreateOrderResponseData getReturnData() {
    return returnData;
  }
  ...
  @JsonProperty(JSON_PROPERTY_RETURN_DATA)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setReturnData(CreateOrderResponseData returnData) {
    this.returnData = returnData;
  }


  public CreateOrderResponse status(ServiceStatusData status) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.returnData, createOrderResponse.returnData) &&
