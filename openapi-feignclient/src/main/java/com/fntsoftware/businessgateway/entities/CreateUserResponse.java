...
import com.fntsoftware.businessgateway.entities.CreateUserResponseData;
 ...
 */
@JsonPropertyOrder({
  CreateUserResponse.JSON_PROPERTY_RETURN_DATA,
  CreateUserResponse.JSON_PROPERTY_STATUS
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-01-31T11:10:37.320689708Z[Etc/UTC]")
public class CreateUserResponse {
  public static final String JSON_PROPERTY_RETURN_DATA = "returnData";
  private CreateUserResponseData returnData;
  ...
  public CreateUserResponse returnData(CreateUserResponseData returnData) {
  ...
  **/
  ...
  public CreateUserResponseData getReturnData() {
    return returnData;
  }
  ...
  @JsonProperty(JSON_PROPERTY_RETURN_DATA)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setReturnData(CreateUserResponseData returnData) {
    this.returnData = returnData;
  }


  public CreateUserResponse status(ServiceStatusData status) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.returnData, createUserResponse.returnData) &&
