...
/**
 * AntennaSitesEntityRestriction
 */
@JsonPropertyOrder({
  AntennaSitesEntityRestriction.JSON_PROPERTY_ROOF_TYPE,
  AntennaSitesEntityRestriction.JSON_PROPERTY_REMARK,
  AntennaSitesEntityRestriction.JSON_PROPERTY_ELID,
  AntennaSitesEntityRestriction.JSON_PROPERTY_MAST_CONSTRUCTION,
  AntennaSitesEntityRestriction.JSON_PROPERTY_AREA_TYPE,
  AntennaSitesEntityRestriction.JSON_PROPERTY_BUILDING_HEIGHT,
  AntennaSitesEntityRestriction.JSON_PROPERTY_NAME,
  AntennaSitesEntityRestriction.JSON_PROPERTY_MAST_TYPE_OF_USE,
  AntennaSitesEntityRestriction.JSON_PROPERTY_ID,
  AntennaSitesEntityRestriction.JSON_PROPERTY_CATEGORY,
  AntennaSitesEntityRestriction.JSON_PROPERTY_BUILDING_TYPE,
  AntennaSitesEntityRestriction.JSON_PROPERTY_DEVELOPMENT_STATUS,
  AntennaSitesEntityRestriction.JSON_PROPERTY_LAND_USE,
  AntennaSitesEntityRestriction.JSON_PROPERTY_STATUS
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-03-04T13:31:32.601557352Z[Etc/UTC]")
public class AntennaSitesEntityRestriction {
  ...
  public AntennaSitesEntityRestriction() {
  }

  public AntennaSitesEntityRestriction roofType(RestrictionsString roofType) {
  ...
  **/
  ...
  public AntennaSitesEntityRestriction remark(RestrictionsString remark) {
  ...
  **/
  ...
  public AntennaSitesEntityRestriction elid(RestrictionsString elid) {
  ...
  **/
  ...
  public AntennaSitesEntityRestriction mastConstruction(RestrictionsString mastConstruction) {
  ...
  **/
  ...
  public AntennaSitesEntityRestriction areaType(RestrictionsString areaType) {
  ...
  **/
  ...
  public AntennaSitesEntityRestriction buildingHeight(RestrictionsNumeric buildingHeight) {
  ...
  **/
  ...
  public AntennaSitesEntityRestriction name(RestrictionsString name) {
  ...
  **/
  ...
  public AntennaSitesEntityRestriction mastTypeOfUse(RestrictionsString mastTypeOfUse) {
  ...
  **/
  ...
  public AntennaSitesEntityRestriction id(RestrictionsString id) {
  ...
  **/
  ...
  public AntennaSitesEntityRestriction category(RestrictionsString category) {
  ...
  **/
  ...
  public AntennaSitesEntityRestriction buildingType(RestrictionsString buildingType) {
  ...
  **/
  ...
  public AntennaSitesEntityRestriction developmentStatus(RestrictionsString developmentStatus) {
  ...
  **/
  ...
  public AntennaSitesEntityRestriction landUse(RestrictionsString landUse) {
  ...
  **/
  ...
  public AntennaSitesEntityRestriction status(RestrictionsString status) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    AntennaSitesEntityRestriction antennaSitesEntityRestriction = (AntennaSitesEntityRestriction) o;
    return Objects.equals(this.roofType, antennaSitesEntityRestriction.roofType) &&
        Objects.equals(this.remark, antennaSitesEntityRestriction.remark) &&
        Objects.equals(this.elid, antennaSitesEntityRestriction.elid) &&
        Objects.equals(this.mastConstruction, antennaSitesEntityRestriction.mastConstruction) &&
        Objects.equals(this.areaType, antennaSitesEntityRestriction.areaType) &&
        Objects.equals(this.buildingHeight, antennaSitesEntityRestriction.buildingHeight) &&
        Objects.equals(this.name, antennaSitesEntityRestriction.name) &&
        Objects.equals(this.mastTypeOfUse, antennaSitesEntityRestriction.mastTypeOfUse) &&
        Objects.equals(this.id, antennaSitesEntityRestriction.id) &&
        Objects.equals(this.category, antennaSitesEntityRestriction.category) &&
        Objects.equals(this.buildingType, antennaSitesEntityRestriction.buildingType) &&
        Objects.equals(this.developmentStatus, antennaSitesEntityRestriction.developmentStatus) &&
        Objects.equals(this.landUse, antennaSitesEntityRestriction.landUse) &&
        Objects.equals(this.status, antennaSitesEntityRestriction.status);
  }
  ...
  public String toString() {
    ...
    sb.append("class AntennaSitesEntityRestriction {\n");
