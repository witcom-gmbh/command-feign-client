...
/**
 * StorageIpAddressesResponseData
 */
@JsonPropertyOrder({
  StorageIpAddressesResponseData.JSON_PROPERTY_ASSIGNED_DIRECTLY,
  StorageIpAddressesResponseData.JSON_PROPERTY_INTERFACE,
  StorageIpAddressesResponseData.JSON_PROPERTY_PORTS,
  StorageIpAddressesResponseData.JSON_PROPERTY_OBJECT_ELID,
  StorageIpAddressesResponseData.JSON_PROPERTY_OBJECT_ID
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-02-26T11:20:24.990023935Z[Etc/UTC]")
public class StorageIpAddressesResponseData {
  ...
  public StorageIpAddressesResponseData() {
  }

  public StorageIpAddressesResponseData assignedDirectly(Boolean assignedDirectly) {
  ...
  **/
  ...
  public StorageIpAddressesResponseData _interface(InterfaceinterfaceWithAddressData _interface) {
  ...
  **/
  ...
  public StorageIpAddressesResponseData ports(List<PhysicalPortDataphysicalPortDataInfo> ports) {
    
    this.ports = ports;
    return this;
  }

  public StorageIpAddressesResponseData addPortsItem(PhysicalPortDataphysicalPortDataInfo portsItem) {
    if (this.ports == null) {
  ...
  **/
  ...
  public StorageIpAddressesResponseData objectElid(String objectElid) {
  ...
  **/
  ...
  public StorageIpAddressesResponseData objectId(String objectId) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    StorageIpAddressesResponseData storageIpAddressesResponseData = (StorageIpAddressesResponseData) o;
    return Objects.equals(this.assignedDirectly, storageIpAddressesResponseData.assignedDirectly) &&
        Objects.equals(this._interface, storageIpAddressesResponseData._interface) &&
        Objects.equals(this.ports, storageIpAddressesResponseData.ports) &&
        Objects.equals(this.objectElid, storageIpAddressesResponseData.objectElid) &&
        Objects.equals(this.objectId, storageIpAddressesResponseData.objectId);
  }
  ...
  public String toString() {
    ...
    sb.append("class StorageIpAddressesResponseData {\n");
