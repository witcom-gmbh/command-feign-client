...
import com.fntsoftware.businessgateway.entities.PduInterfacesEntityRestriction;
import com.fntsoftware.businessgateway.entities.PduInterfacesRelationRestriction;
...
/**
 * PduInterfacesRequestData
 */
@JsonPropertyOrder({
  PduInterfacesRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  PduInterfacesRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  PduInterfacesRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  PduInterfacesRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-01-31T11:10:37.320689708Z[Etc/UTC]")
public class PduInterfacesRequestData {
  ...
  private PduInterfacesEntityRestriction entityRestrictions;

  public static final String JSON_PROPERTY_RELATION_RESTRICTIONS = "relationRestrictions";
  private PduInterfacesRelationRestriction relationRestrictions;
  ...
  public PduInterfacesRequestData() {
  }

  public PduInterfacesRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public PduInterfacesRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public PduInterfacesRequestData entityRestrictions(PduInterfacesEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public PduInterfacesEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(PduInterfacesEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public PduInterfacesRequestData relationRestrictions(PduInterfacesRelationRestriction relationRestrictions) {
  ...
  **/
  ...
  public PduInterfacesRelationRestriction getRelationRestrictions() {
    return relationRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_RELATION_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRelationRestrictions(PduInterfacesRelationRestriction relationRestrictions) {
    this.relationRestrictions = relationRestrictions;
  }


  public PduInterfacesRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public PduInterfacesRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    PduInterfacesRequestData pduInterfacesRequestData = (PduInterfacesRequestData) o;
    return Objects.equals(this.returnEntityAttributes, pduInterfacesRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, pduInterfacesRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, pduInterfacesRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, pduInterfacesRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class PduInterfacesRequestData {\n");
