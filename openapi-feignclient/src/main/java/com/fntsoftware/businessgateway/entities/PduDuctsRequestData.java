...
import com.fntsoftware.businessgateway.entities.PduDuctsEntityRestriction;
import com.fntsoftware.businessgateway.entities.PduDuctsRelationRestriction;
 ...
 */
@JsonPropertyOrder({
  PduDuctsRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  PduDuctsRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  PduDuctsRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  PduDuctsRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-01-31T11:10:37.320689708Z[Etc/UTC]")
public class PduDuctsRequestData {
  ...
  private PduDuctsEntityRestriction entityRestrictions;

  public static final String JSON_PROPERTY_RELATION_RESTRICTIONS = "relationRestrictions";
  private PduDuctsRelationRestriction relationRestrictions;
  ...
  public PduDuctsRequestData() {
  }

  public PduDuctsRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public PduDuctsRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public PduDuctsRequestData entityRestrictions(PduDuctsEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public PduDuctsEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(PduDuctsEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public PduDuctsRequestData relationRestrictions(PduDuctsRelationRestriction relationRestrictions) {
  ...
  **/
  ...
  public PduDuctsRelationRestriction getRelationRestrictions() {
    return relationRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_RELATION_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRelationRestrictions(PduDuctsRelationRestriction relationRestrictions) {
    this.relationRestrictions = relationRestrictions;
  }


  public PduDuctsRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public PduDuctsRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    PduDuctsRequestData pduDuctsRequestData = (PduDuctsRequestData) o;
    return Objects.equals(this.returnEntityAttributes, pduDuctsRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, pduDuctsRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, pduDuctsRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, pduDuctsRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class PduDuctsRequestData {\n");
