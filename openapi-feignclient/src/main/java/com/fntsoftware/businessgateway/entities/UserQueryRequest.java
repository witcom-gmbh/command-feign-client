...
import com.fntsoftware.businessgateway.entities.UserQueryRestriction;
 ...
 */
@JsonPropertyOrder({
  UserQueryRequest.JSON_PROPERTY_RETURN_ATTRIBUTES,
  UserQueryRequest.JSON_PROPERTY_RESTRICTIONS
})
...
public class UserQueryRequest {
  ...
  private UserQueryRestriction restrictions;

  public UserQueryRequest() {
  }

  public UserQueryRequest returnAttributes(List<String> returnAttributes) {
    
    this.returnAttributes = returnAttributes;
    return this;
  }

  public UserQueryRequest addReturnAttributesItem(String returnAttributesItem) {
  ...
  **/
  ...
  public UserQueryRequest restrictions(UserQueryRestriction restrictions) {
  ...
  **/
  ...
  public UserQueryRestriction getRestrictions() {
    return restrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRestrictions(UserQueryRestriction restrictions) {
    this.restrictions = restrictions;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.returnAttributes, userQueryRequest.returnAttributes) &&
        Objects.equals(this.restrictions, userQueryRequest.restrictions);
  }
