...
import com.fntsoftware.businessgateway.entities.CabinetSuppliesZoneEntityRestriction;
...
/**
 * CabinetSuppliesZoneRequestData
 */
@JsonPropertyOrder({
  CabinetSuppliesZoneRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  CabinetSuppliesZoneRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  CabinetSuppliesZoneRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  CabinetSuppliesZoneRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-01-31T11:10:37.320689708Z[Etc/UTC]")
public class CabinetSuppliesZoneRequestData {
  ...
  private CabinetSuppliesZoneEntityRestriction entityRestrictions;
  ...
  public CabinetSuppliesZoneRequestData() {
  }

  public CabinetSuppliesZoneRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public CabinetSuppliesZoneRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public CabinetSuppliesZoneRequestData entityRestrictions(CabinetSuppliesZoneEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public CabinetSuppliesZoneEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(CabinetSuppliesZoneEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public CabinetSuppliesZoneRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public CabinetSuppliesZoneRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public CabinetSuppliesZoneRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    CabinetSuppliesZoneRequestData cabinetSuppliesZoneRequestData = (CabinetSuppliesZoneRequestData) o;
    return Objects.equals(this.returnEntityAttributes, cabinetSuppliesZoneRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, cabinetSuppliesZoneRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, cabinetSuppliesZoneRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, cabinetSuppliesZoneRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class CabinetSuppliesZoneRequestData {\n");
