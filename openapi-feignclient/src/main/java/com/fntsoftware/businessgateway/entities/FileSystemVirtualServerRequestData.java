...
import com.fntsoftware.businessgateway.entities.FileSystemVirtualServerEntityRestriction;
...
/**
 * FileSystemVirtualServerRequestData
 */
@JsonPropertyOrder({
  FileSystemVirtualServerRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  FileSystemVirtualServerRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  FileSystemVirtualServerRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  FileSystemVirtualServerRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-01-31T11:10:37.320689708Z[Etc/UTC]")
public class FileSystemVirtualServerRequestData {
  ...
  private FileSystemVirtualServerEntityRestriction entityRestrictions;
  ...
  public FileSystemVirtualServerRequestData() {
  }

  public FileSystemVirtualServerRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public FileSystemVirtualServerRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public FileSystemVirtualServerRequestData entityRestrictions(FileSystemVirtualServerEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public FileSystemVirtualServerEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(FileSystemVirtualServerEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public FileSystemVirtualServerRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public FileSystemVirtualServerRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public FileSystemVirtualServerRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    FileSystemVirtualServerRequestData fileSystemVirtualServerRequestData = (FileSystemVirtualServerRequestData) o;
    return Objects.equals(this.returnEntityAttributes, fileSystemVirtualServerRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, fileSystemVirtualServerRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, fileSystemVirtualServerRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, fileSystemVirtualServerRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class FileSystemVirtualServerRequestData {\n");
