...
import com.fntsoftware.businessgateway.entities.TerminalWarehouseEntityRestriction;
...
/**
 * TerminalWarehouseRequestData
 */
@JsonPropertyOrder({
  TerminalWarehouseRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  TerminalWarehouseRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  TerminalWarehouseRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  TerminalWarehouseRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-03-04T13:31:32.601557352Z[Etc/UTC]")
public class TerminalWarehouseRequestData {
  ...
  private TerminalWarehouseEntityRestriction entityRestrictions;
  ...
  public TerminalWarehouseRequestData() {
  }

  public TerminalWarehouseRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public TerminalWarehouseRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public TerminalWarehouseRequestData entityRestrictions(TerminalWarehouseEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public TerminalWarehouseEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(TerminalWarehouseEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public TerminalWarehouseRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public TerminalWarehouseRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public TerminalWarehouseRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    TerminalWarehouseRequestData terminalWarehouseRequestData = (TerminalWarehouseRequestData) o;
    return Objects.equals(this.returnEntityAttributes, terminalWarehouseRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, terminalWarehouseRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, terminalWarehouseRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, terminalWarehouseRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class TerminalWarehouseRequestData {\n");
