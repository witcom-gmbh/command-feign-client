...
import com.fntsoftware.businessgateway.entities.WarehouseZoneEntityRestriction;
...
/**
 * WarehouseZoneRequestData
 */
@JsonPropertyOrder({
  WarehouseZoneRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  WarehouseZoneRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  WarehouseZoneRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  WarehouseZoneRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-01-31T11:10:37.320689708Z[Etc/UTC]")
public class WarehouseZoneRequestData {
  ...
  private WarehouseZoneEntityRestriction entityRestrictions;
  ...
  public WarehouseZoneRequestData() {
  }

  public WarehouseZoneRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public WarehouseZoneRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public WarehouseZoneRequestData entityRestrictions(WarehouseZoneEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public WarehouseZoneEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(WarehouseZoneEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public WarehouseZoneRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public WarehouseZoneRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public WarehouseZoneRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    WarehouseZoneRequestData warehouseZoneRequestData = (WarehouseZoneRequestData) o;
    return Objects.equals(this.returnEntityAttributes, warehouseZoneRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, warehouseZoneRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, warehouseZoneRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, warehouseZoneRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class WarehouseZoneRequestData {\n");
