...
/**
 * DeleteJunctionBoxFistRequestData
 */
@JsonPropertyOrder({
  DeleteJunctionBoxFistRequestData.JSON_PROPERTY_RELEASE_SIGNALPATH,
  DeleteJunctionBoxFistRequestData.JSON_PROPERTY_RELEASE_CONNECTIONS,
  DeleteJunctionBoxFistRequestData.JSON_PROPERTY_RELEASE_SERVICE,
  DeleteJunctionBoxFistRequestData.JSON_PROPERTY_CONTEXT_ID,
  DeleteJunctionBoxFistRequestData.JSON_PROPERTY_RELEASE_PATCHES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-02-26T11:20:24.990023935Z[Etc/UTC]")
public class DeleteJunctionBoxFistRequestData {
  ...
  public DeleteJunctionBoxFistRequestData() {
  }

  public DeleteJunctionBoxFistRequestData releaseSignalpath(Boolean releaseSignalpath) {
  ...
  **/
  ...
  public DeleteJunctionBoxFistRequestData releaseConnections(Boolean releaseConnections) {
  ...
  **/
  ...
  public DeleteJunctionBoxFistRequestData releaseService(Boolean releaseService) {
  ...
  **/
  ...
  public DeleteJunctionBoxFistRequestData contextId(String contextId) {
  ...
  **/
  ...
  public DeleteJunctionBoxFistRequestData releasePatches(Boolean releasePatches) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    DeleteJunctionBoxFistRequestData deleteJunctionBoxFistRequestData = (DeleteJunctionBoxFistRequestData) o;
    return Objects.equals(this.releaseSignalpath, deleteJunctionBoxFistRequestData.releaseSignalpath) &&
        Objects.equals(this.releaseConnections, deleteJunctionBoxFistRequestData.releaseConnections) &&
        Objects.equals(this.releaseService, deleteJunctionBoxFistRequestData.releaseService) &&
        Objects.equals(this.contextId, deleteJunctionBoxFistRequestData.contextId) &&
        Objects.equals(this.releasePatches, deleteJunctionBoxFistRequestData.releasePatches);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeleteJunctionBoxFistRequestData {\n");
