...
import com.fntsoftware.businessgateway.entities.CVlanPersonsEntityRestriction;
import com.fntsoftware.businessgateway.entities.CVlanPersonsRelationRestriction;
...
/**
 * CVlanPersonsRequestData
 */
@JsonPropertyOrder({
  CVlanPersonsRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  CVlanPersonsRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  CVlanPersonsRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  CVlanPersonsRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-02-26T11:20:24.990023935Z[Etc/UTC]")
public class CVlanPersonsRequestData {
  ...
  private CVlanPersonsEntityRestriction entityRestrictions;

  public static final String JSON_PROPERTY_RELATION_RESTRICTIONS = "relationRestrictions";
  private CVlanPersonsRelationRestriction relationRestrictions;
  ...
  public CVlanPersonsRequestData() {
  }

  public CVlanPersonsRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public CVlanPersonsRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public CVlanPersonsRequestData entityRestrictions(CVlanPersonsEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public CVlanPersonsEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(CVlanPersonsEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public CVlanPersonsRequestData relationRestrictions(CVlanPersonsRelationRestriction relationRestrictions) {
  ...
  **/
  ...
  public CVlanPersonsRelationRestriction getRelationRestrictions() {
    return relationRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_RELATION_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRelationRestrictions(CVlanPersonsRelationRestriction relationRestrictions) {
    this.relationRestrictions = relationRestrictions;
  }


  public CVlanPersonsRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public CVlanPersonsRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    CVlanPersonsRequestData cvlanPersonsRequestData = (CVlanPersonsRequestData) o;
    return Objects.equals(this.returnEntityAttributes, cvlanPersonsRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, cvlanPersonsRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, cvlanPersonsRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, cvlanPersonsRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class CVlanPersonsRequestData {\n");
