...
import com.fntsoftware.businessgateway.entities.PhysicalConnectionDataCableEntityRestriction;
...
/**
 * PhysicalConnectionDataCableRequestData
 */
@JsonPropertyOrder({
  PhysicalConnectionDataCableRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  PhysicalConnectionDataCableRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  PhysicalConnectionDataCableRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  PhysicalConnectionDataCableRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-02-26T11:20:24.990023935Z[Etc/UTC]")
public class PhysicalConnectionDataCableRequestData {
  ...
  private PhysicalConnectionDataCableEntityRestriction entityRestrictions;
  ...
  public PhysicalConnectionDataCableRequestData() {
  }

  public PhysicalConnectionDataCableRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public PhysicalConnectionDataCableRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public PhysicalConnectionDataCableRequestData entityRestrictions(PhysicalConnectionDataCableEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public PhysicalConnectionDataCableEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(PhysicalConnectionDataCableEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public PhysicalConnectionDataCableRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public PhysicalConnectionDataCableRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public PhysicalConnectionDataCableRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    PhysicalConnectionDataCableRequestData physicalConnectionDataCableRequestData = (PhysicalConnectionDataCableRequestData) o;
    return Objects.equals(this.returnEntityAttributes, physicalConnectionDataCableRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, physicalConnectionDataCableRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, physicalConnectionDataCableRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, physicalConnectionDataCableRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class PhysicalConnectionDataCableRequestData {\n");
