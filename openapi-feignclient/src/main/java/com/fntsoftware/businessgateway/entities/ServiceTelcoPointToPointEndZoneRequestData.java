...
import com.fntsoftware.businessgateway.entities.ServiceTelcoPointToPointEndZoneEntityRestriction;
...
/**
 * ServiceTelcoPointToPointEndZoneRequestData
 */
@JsonPropertyOrder({
  ServiceTelcoPointToPointEndZoneRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  ServiceTelcoPointToPointEndZoneRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  ServiceTelcoPointToPointEndZoneRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  ServiceTelcoPointToPointEndZoneRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-01-31T11:10:37.320689708Z[Etc/UTC]")
public class ServiceTelcoPointToPointEndZoneRequestData {
  ...
  private ServiceTelcoPointToPointEndZoneEntityRestriction entityRestrictions;
  ...
  public ServiceTelcoPointToPointEndZoneRequestData() {
  }

  public ServiceTelcoPointToPointEndZoneRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public ServiceTelcoPointToPointEndZoneRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public ServiceTelcoPointToPointEndZoneRequestData entityRestrictions(ServiceTelcoPointToPointEndZoneEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public ServiceTelcoPointToPointEndZoneEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(ServiceTelcoPointToPointEndZoneEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public ServiceTelcoPointToPointEndZoneRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public ServiceTelcoPointToPointEndZoneRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public ServiceTelcoPointToPointEndZoneRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ServiceTelcoPointToPointEndZoneRequestData serviceTelcoPointToPointEndZoneRequestData = (ServiceTelcoPointToPointEndZoneRequestData) o;
    return Objects.equals(this.returnEntityAttributes, serviceTelcoPointToPointEndZoneRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, serviceTelcoPointToPointEndZoneRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, serviceTelcoPointToPointEndZoneRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, serviceTelcoPointToPointEndZoneRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class ServiceTelcoPointToPointEndZoneRequestData {\n");
