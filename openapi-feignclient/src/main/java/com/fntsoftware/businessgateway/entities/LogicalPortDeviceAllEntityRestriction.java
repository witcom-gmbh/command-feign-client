...
/**
 * LogicalPortDeviceAllEntityRestriction
 */
@JsonPropertyOrder({
  LogicalPortDeviceAllEntityRestriction.JSON_PROPERTY_CLIMATE_RELEVANT,
  LogicalPortDeviceAllEntityRestriction.JSON_PROPERTY_POWER_CONSUMPTION,
  LogicalPortDeviceAllEntityRestriction.JSON_PROPERTY_POWER_SWITCHING_STATUS,
  LogicalPortDeviceAllEntityRestriction.JSON_PROPERTY_PLAN_STATUS,
  LogicalPortDeviceAllEntityRestriction.JSON_PROPERTY_SYSTEM_RUNTIME,
  LogicalPortDeviceAllEntityRestriction.JSON_PROPERTY_WEIGHT,
  LogicalPortDeviceAllEntityRestriction.JSON_PROPERTY_REMARK,
  LogicalPortDeviceAllEntityRestriction.JSON_PROPERTY_ELID,
  LogicalPortDeviceAllEntityRestriction.JSON_PROPERTY_LAST_SEEN,
  LogicalPortDeviceAllEntityRestriction.JSON_PROPERTY_TYPE_ELID,
  LogicalPortDeviceAllEntityRestriction.JSON_PROPERTY_VISIBLE_ID,
  LogicalPortDeviceAllEntityRestriction.JSON_PROPERTY_ID,
  LogicalPortDeviceAllEntityRestriction.JSON_PROPERTY_HEAT_EMISSION
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-01-31T11:10:37.320689708Z[Etc/UTC]")
public class LogicalPortDeviceAllEntityRestriction {
  ...
  public LogicalPortDeviceAllEntityRestriction() {
  }

  public LogicalPortDeviceAllEntityRestriction climateRelevant(RestrictionsBoolean climateRelevant) {
  ...
  **/
  ...
  public LogicalPortDeviceAllEntityRestriction powerConsumption(RestrictionsNumeric powerConsumption) {
  ...
  **/
  ...
  public LogicalPortDeviceAllEntityRestriction powerSwitchingStatus(RestrictionsString powerSwitchingStatus) {
  ...
  **/
  ...
  public LogicalPortDeviceAllEntityRestriction planStatus(RestrictionsString planStatus) {
  ...
  **/
  ...
  public LogicalPortDeviceAllEntityRestriction systemRuntime(RestrictionsNumeric systemRuntime) {
  ...
  **/
  ...
  public LogicalPortDeviceAllEntityRestriction weight(RestrictionsNumeric weight) {
  ...
  **/
  ...
  public LogicalPortDeviceAllEntityRestriction remark(RestrictionsString remark) {
  ...
  **/
  ...
  public LogicalPortDeviceAllEntityRestriction elid(RestrictionsString elid) {
  ...
  **/
  ...
  public LogicalPortDeviceAllEntityRestriction lastSeen(RestrictionsDate lastSeen) {
  ...
  **/
  ...
  public LogicalPortDeviceAllEntityRestriction typeElid(RestrictionsString typeElid) {
  ...
  **/
  ...
  public LogicalPortDeviceAllEntityRestriction visibleId(RestrictionsString visibleId) {
  ...
  **/
  ...
  public LogicalPortDeviceAllEntityRestriction id(RestrictionsString id) {
  ...
  **/
  ...
  public LogicalPortDeviceAllEntityRestriction heatEmission(RestrictionsNumeric heatEmission) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    LogicalPortDeviceAllEntityRestriction logicalPortDeviceAllEntityRestriction = (LogicalPortDeviceAllEntityRestriction) o;
    return Objects.equals(this.climateRelevant, logicalPortDeviceAllEntityRestriction.climateRelevant) &&
        Objects.equals(this.powerConsumption, logicalPortDeviceAllEntityRestriction.powerConsumption) &&
        Objects.equals(this.powerSwitchingStatus, logicalPortDeviceAllEntityRestriction.powerSwitchingStatus) &&
        Objects.equals(this.planStatus, logicalPortDeviceAllEntityRestriction.planStatus) &&
        Objects.equals(this.systemRuntime, logicalPortDeviceAllEntityRestriction.systemRuntime) &&
        Objects.equals(this.weight, logicalPortDeviceAllEntityRestriction.weight) &&
        Objects.equals(this.remark, logicalPortDeviceAllEntityRestriction.remark) &&
        Objects.equals(this.elid, logicalPortDeviceAllEntityRestriction.elid) &&
        Objects.equals(this.lastSeen, logicalPortDeviceAllEntityRestriction.lastSeen) &&
        Objects.equals(this.typeElid, logicalPortDeviceAllEntityRestriction.typeElid) &&
        Objects.equals(this.visibleId, logicalPortDeviceAllEntityRestriction.visibleId) &&
        Objects.equals(this.id, logicalPortDeviceAllEntityRestriction.id) &&
        Objects.equals(this.heatEmission, logicalPortDeviceAllEntityRestriction.heatEmission);
  }
  ...
  public String toString() {
    ...
    sb.append("class LogicalPortDeviceAllEntityRestriction {\n");
