...
/**
 * LogicalPortQueryRestriction
 */
@JsonPropertyOrder({
  LogicalPortQueryRestriction.JSON_PROPERTY_RX_BLOCK_FLAG,
  LogicalPortQueryRestriction.JSON_PROPERTY_LOCK_SUB_PORT,
  LogicalPortQueryRestriction.JSON_PROPERTY_C_DATA_SOURCE_ID,
  LogicalPortQueryRestriction.JSON_PROPERTY_PHYS_PORT2,
  LogicalPortQueryRestriction.JSON_PROPERTY_PORT_STATUS,
  LogicalPortQueryRestriction.JSON_PROPERTY_PORT_NAME,
  LogicalPortQueryRestriction.JSON_PROPERTY_PTOLP,
  LogicalPortQueryRestriction.JSON_PROPERTY_TX_BLOCK_FLAG,
  LogicalPortQueryRestriction.JSON_PROPERTY_PORT_NO,
  LogicalPortQueryRestriction.JSON_PROPERTY_ATM,
  LogicalPortQueryRestriction.JSON_PROPERTY_PORT_NAME_ORG,
  LogicalPortQueryRestriction.JSON_PROPERTY_SIGNAL_RATE,
  LogicalPortQueryRestriction.JSON_PROPERTY_ACTIVE_FROM,
  LogicalPortQueryRestriction.JSON_PROPERTY_OBJECT_ID,
  LogicalPortQueryRestriction.JSON_PROPERTY_NOMINAL_UTILIZATION,
  LogicalPortQueryRestriction.JSON_PROPERTY_C_DATA_SOURCE_DELETED,
  LogicalPortQueryRestriction.JSON_PROPERTY_C_SERVICE_SIDE,
  LogicalPortQueryRestriction.JSON_PROPERTY_OVERLOAD_WARNING,
  LogicalPortQueryRestriction.JSON_PROPERTY_BANDWIDTH,
  LogicalPortQueryRestriction.JSON_PROPERTY_PORT_CATEGORY,
  LogicalPortQueryRestriction.JSON_PROPERTY_ELID,
  LogicalPortQueryRestriction.JSON_PROPERTY_PHYS_PORT2_SIDE,
  LogicalPortQueryRestriction.JSON_PROPERTY_PORT_TYPE,
  LogicalPortQueryRestriction.JSON_PROPERTY_C_DATA_SOURCE,
  LogicalPortQueryRestriction.JSON_PROPERTY_PHYS_PORT,
  LogicalPortQueryRestriction.JSON_PROPERTY_PHYS_PORT_SIDE,
  LogicalPortQueryRestriction.JSON_PROPERTY_PORT_FUNCTION,
  LogicalPortQueryRestriction.JSON_PROPERTY_IMA,
  LogicalPortQueryRestriction.JSON_PROPERTY_ACTIVE_UNTIL,
  LogicalPortQueryRestriction.JSON_PROPERTY_FIRST
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-03-04T13:31:32.601557352Z[Etc/UTC]")
public class LogicalPortQueryRestriction {
  ...
  private RestrictionsString objectId;
  ...
  public LogicalPortQueryRestriction() {
  }

  public LogicalPortQueryRestriction rxBlockFlag(RestrictionsBoolean rxBlockFlag) {
  ...
  **/
  ...
  public LogicalPortQueryRestriction lockSubPort(RestrictionsBoolean lockSubPort) {
  ...
  **/
  ...
  public LogicalPortQueryRestriction cDataSourceId(RestrictionsString cDataSourceId) {
  ...
  **/
  ...
  public LogicalPortQueryRestriction physPort2(RestrictionsNumeric physPort2) {
  ...
  **/
  ...
  public LogicalPortQueryRestriction portStatus(RestrictionsString portStatus) {
  ...
  **/
  ...
  public LogicalPortQueryRestriction portName(RestrictionsString portName) {
  ...
  **/
  ...
  public LogicalPortQueryRestriction ptolp(RestrictionsString ptolp) {
  ...
  **/
  ...
  public LogicalPortQueryRestriction txBlockFlag(RestrictionsBoolean txBlockFlag) {
  ...
  **/
  ...
  public LogicalPortQueryRestriction portNo(RestrictionsNumeric portNo) {
  ...
  **/
  ...
  public LogicalPortQueryRestriction atm(RestrictionsBoolean atm) {
  ...
  **/
  ...
  public LogicalPortQueryRestriction portNameOrg(RestrictionsString portNameOrg) {
  ...
  **/
  ...
  public LogicalPortQueryRestriction signalRate(RestrictionsString signalRate) {
  ...
  **/
  ...
  public LogicalPortQueryRestriction activeFrom(RestrictionsDate activeFrom) {
  ...
  **/
  ...
  public LogicalPortQueryRestriction objectId(RestrictionsString objectId) {
  ...
  **/
  ...
  public RestrictionsString getObjectId() {
    return objectId;
  }
  ...
  @JsonProperty(JSON_PROPERTY_OBJECT_ID)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setObjectId(RestrictionsString objectId) {
    this.objectId = objectId;
  }


  public LogicalPortQueryRestriction nominalUtilization(RestrictionsNumeric nominalUtilization) {
  ...
  **/
  ...
  public LogicalPortQueryRestriction cDataSourceDeleted(RestrictionsString cDataSourceDeleted) {
  ...
  **/
  ...
  public LogicalPortQueryRestriction cServiceSide(RestrictionsString cServiceSide) {
  ...
  **/
  ...
  public LogicalPortQueryRestriction overloadWarning(RestrictionsString overloadWarning) {
  ...
  **/
  ...
  public LogicalPortQueryRestriction bandwidth(RestrictionsNumeric bandwidth) {
  ...
  **/
  ...
  public LogicalPortQueryRestriction portCategory(RestrictionsString portCategory) {
  ...
  **/
  ...
  public LogicalPortQueryRestriction elid(RestrictionsString elid) {
  ...
  **/
  ...
  public LogicalPortQueryRestriction physPort2Side(RestrictionsString physPort2Side) {
  ...
  **/
  ...
  public LogicalPortQueryRestriction portType(RestrictionsString portType) {
  ...
  **/
  ...
  public LogicalPortQueryRestriction cDataSource(RestrictionsString cDataSource) {
  ...
  **/
  ...
  public LogicalPortQueryRestriction physPort(RestrictionsNumeric physPort) {
  ...
  **/
  ...
  public LogicalPortQueryRestriction physPortSide(RestrictionsString physPortSide) {
  ...
  **/
  ...
  public LogicalPortQueryRestriction portFunction(RestrictionsString portFunction) {
  ...
  **/
  ...
  public LogicalPortQueryRestriction ima(RestrictionsBoolean ima) {
  ...
  **/
  ...
  public LogicalPortQueryRestriction activeUntil(RestrictionsDate activeUntil) {
  ...
  **/
  ...
  public LogicalPortQueryRestriction first(RestrictionsNumeric first) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    LogicalPortQueryRestriction logicalPortQueryRestriction = (LogicalPortQueryRestriction) o;
    return Objects.equals(this.rxBlockFlag, logicalPortQueryRestriction.rxBlockFlag) &&
        Objects.equals(this.lockSubPort, logicalPortQueryRestriction.lockSubPort) &&
        Objects.equals(this.cDataSourceId, logicalPortQueryRestriction.cDataSourceId) &&
        Objects.equals(this.physPort2, logicalPortQueryRestriction.physPort2) &&
        Objects.equals(this.portStatus, logicalPortQueryRestriction.portStatus) &&
        Objects.equals(this.portName, logicalPortQueryRestriction.portName) &&
        Objects.equals(this.ptolp, logicalPortQueryRestriction.ptolp) &&
        Objects.equals(this.txBlockFlag, logicalPortQueryRestriction.txBlockFlag) &&
        Objects.equals(this.portNo, logicalPortQueryRestriction.portNo) &&
        Objects.equals(this.atm, logicalPortQueryRestriction.atm) &&
        Objects.equals(this.portNameOrg, logicalPortQueryRestriction.portNameOrg) &&
        Objects.equals(this.signalRate, logicalPortQueryRestriction.signalRate) &&
        Objects.equals(this.activeFrom, logicalPortQueryRestriction.activeFrom) &&
        Objects.equals(this.objectId, logicalPortQueryRestriction.objectId) &&
        Objects.equals(this.nominalUtilization, logicalPortQueryRestriction.nominalUtilization) &&
        Objects.equals(this.cDataSourceDeleted, logicalPortQueryRestriction.cDataSourceDeleted) &&
        Objects.equals(this.cServiceSide, logicalPortQueryRestriction.cServiceSide) &&
        Objects.equals(this.overloadWarning, logicalPortQueryRestriction.overloadWarning) &&
        Objects.equals(this.bandwidth, logicalPortQueryRestriction.bandwidth) &&
        Objects.equals(this.portCategory, logicalPortQueryRestriction.portCategory) &&
        Objects.equals(this.elid, logicalPortQueryRestriction.elid) &&
        Objects.equals(this.physPort2Side, logicalPortQueryRestriction.physPort2Side) &&
        Objects.equals(this.portType, logicalPortQueryRestriction.portType) &&
        Objects.equals(this.cDataSource, logicalPortQueryRestriction.cDataSource) &&
        Objects.equals(this.physPort, logicalPortQueryRestriction.physPort) &&
        Objects.equals(this.physPortSide, logicalPortQueryRestriction.physPortSide) &&
        Objects.equals(this.portFunction, logicalPortQueryRestriction.portFunction) &&
        Objects.equals(this.ima, logicalPortQueryRestriction.ima) &&
        Objects.equals(this.activeUntil, logicalPortQueryRestriction.activeUntil) &&
        Objects.equals(this.first, logicalPortQueryRestriction.first);
  }

  @Override
  public int hashCode() {
    return Objects.hash(rxBlockFlag, lockSubPort, cDataSourceId, physPort2, portStatus, portName, ptolp, txBlockFlag, portNo, atm, portNameOrg, signalRate, activeFrom, objectId, nominalUtilization, cDataSourceDeleted, cServiceSide, overloadWarning, bandwidth, portCategory, elid, physPort2Side, portType, cDataSource, physPort, physPortSide, portFunction, ima, activeUntil, first);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class LogicalPortQueryRestriction {\n");
