...
import com.fntsoftware.businessgateway.entities.UpdateNodeResponseData;
 ...
 */
@JsonPropertyOrder({
  UpdateNodeResponse.JSON_PROPERTY_RETURN_DATA,
  UpdateNodeResponse.JSON_PROPERTY_STATUS
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-02-26T11:20:24.990023935Z[Etc/UTC]")
public class UpdateNodeResponse {
  public static final String JSON_PROPERTY_RETURN_DATA = "returnData";
  private UpdateNodeResponseData returnData;
  ...
  public UpdateNodeResponse returnData(UpdateNodeResponseData returnData) {
  ...
  **/
  ...
  public UpdateNodeResponseData getReturnData() {
    return returnData;
  }
  ...
  @JsonProperty(JSON_PROPERTY_RETURN_DATA)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setReturnData(UpdateNodeResponseData returnData) {
    this.returnData = returnData;
  }


  public UpdateNodeResponse status(ServiceStatusData status) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.returnData, updateNodeResponse.returnData) &&
