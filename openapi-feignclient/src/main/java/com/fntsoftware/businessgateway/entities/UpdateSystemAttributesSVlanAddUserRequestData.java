...
/**
 * UpdateSystemAttributesSVlanAddUserRequestData
 */
@JsonPropertyOrder({
  UpdateSystemAttributesSVlanAddUserRequestData.JSON_PROPERTY_MODIFY_PLAN,
  UpdateSystemAttributesSVlanAddUserRequestData.JSON_PROPERTY_DELETE_REAL,
  UpdateSystemAttributesSVlanAddUserRequestData.JSON_PROPERTY_READ_PLAN,
  UpdateSystemAttributesSVlanAddUserRequestData.JSON_PROPERTY_MANDANT_ID,
  UpdateSystemAttributesSVlanAddUserRequestData.JSON_PROPERTY_USER_ELID,
  UpdateSystemAttributesSVlanAddUserRequestData.JSON_PROPERTY_MODIFY_REAL,
  UpdateSystemAttributesSVlanAddUserRequestData.JSON_PROPERTY_READ_REAL,
  UpdateSystemAttributesSVlanAddUserRequestData.JSON_PROPERTY_DELETE_PLAN
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-02-26T11:20:24.990023935Z[Etc/UTC]")
public class UpdateSystemAttributesSVlanAddUserRequestData {
  ...
  public UpdateSystemAttributesSVlanAddUserRequestData() {
  }

  public UpdateSystemAttributesSVlanAddUserRequestData modifyPlan(Boolean modifyPlan) {
  ...
  **/
  ...
  public UpdateSystemAttributesSVlanAddUserRequestData deleteReal(Boolean deleteReal) {
  ...
  **/
  ...
  public UpdateSystemAttributesSVlanAddUserRequestData readPlan(Boolean readPlan) {
  ...
  **/
  ...
  public UpdateSystemAttributesSVlanAddUserRequestData mandantId(BigDecimal mandantId) {
  ...
  **/
  ...
  public UpdateSystemAttributesSVlanAddUserRequestData userElid(String userElid) {
  ...
  **/
  ...
  public UpdateSystemAttributesSVlanAddUserRequestData modifyReal(Boolean modifyReal) {
  ...
  **/
  ...
  public UpdateSystemAttributesSVlanAddUserRequestData readReal(Boolean readReal) {
  ...
  **/
  ...
  public UpdateSystemAttributesSVlanAddUserRequestData deletePlan(Boolean deletePlan) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    UpdateSystemAttributesSVlanAddUserRequestData updateSystemAttributesSVlanAddUserRequestData = (UpdateSystemAttributesSVlanAddUserRequestData) o;
    return Objects.equals(this.modifyPlan, updateSystemAttributesSVlanAddUserRequestData.modifyPlan) &&
        Objects.equals(this.deleteReal, updateSystemAttributesSVlanAddUserRequestData.deleteReal) &&
        Objects.equals(this.readPlan, updateSystemAttributesSVlanAddUserRequestData.readPlan) &&
        Objects.equals(this.mandantId, updateSystemAttributesSVlanAddUserRequestData.mandantId) &&
        Objects.equals(this.userElid, updateSystemAttributesSVlanAddUserRequestData.userElid) &&
        Objects.equals(this.modifyReal, updateSystemAttributesSVlanAddUserRequestData.modifyReal) &&
        Objects.equals(this.readReal, updateSystemAttributesSVlanAddUserRequestData.readReal) &&
        Objects.equals(this.deletePlan, updateSystemAttributesSVlanAddUserRequestData.deletePlan);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateSystemAttributesSVlanAddUserRequestData {\n");
