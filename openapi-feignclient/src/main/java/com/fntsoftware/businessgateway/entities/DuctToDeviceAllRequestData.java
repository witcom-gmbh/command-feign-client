...
import com.fntsoftware.businessgateway.entities.DuctToDeviceAllEntityRestriction;
...
/**
 * DuctToDeviceAllRequestData
 */
@JsonPropertyOrder({
  DuctToDeviceAllRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  DuctToDeviceAllRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  DuctToDeviceAllRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  DuctToDeviceAllRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-03-04T13:31:32.601557352Z[Etc/UTC]")
public class DuctToDeviceAllRequestData {
  ...
  private DuctToDeviceAllEntityRestriction entityRestrictions;
  ...
  public DuctToDeviceAllRequestData() {
  }

  public DuctToDeviceAllRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public DuctToDeviceAllRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public DuctToDeviceAllRequestData entityRestrictions(DuctToDeviceAllEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public DuctToDeviceAllEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(DuctToDeviceAllEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public DuctToDeviceAllRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public DuctToDeviceAllRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public DuctToDeviceAllRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    DuctToDeviceAllRequestData ductToDeviceAllRequestData = (DuctToDeviceAllRequestData) o;
    return Objects.equals(this.returnEntityAttributes, ductToDeviceAllRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, ductToDeviceAllRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, ductToDeviceAllRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, ductToDeviceAllRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class DuctToDeviceAllRequestData {\n");
