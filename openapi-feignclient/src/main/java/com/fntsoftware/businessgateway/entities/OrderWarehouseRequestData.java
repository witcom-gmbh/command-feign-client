...
import com.fntsoftware.businessgateway.entities.OrderWarehouseEntityRestriction;
...
/**
 * OrderWarehouseRequestData
 */
@JsonPropertyOrder({
  OrderWarehouseRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  OrderWarehouseRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  OrderWarehouseRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  OrderWarehouseRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-03-04T13:31:32.601557352Z[Etc/UTC]")
public class OrderWarehouseRequestData {
  ...
  private OrderWarehouseEntityRestriction entityRestrictions;
  ...
  public OrderWarehouseRequestData() {
  }

  public OrderWarehouseRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public OrderWarehouseRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public OrderWarehouseRequestData entityRestrictions(OrderWarehouseEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public OrderWarehouseEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(OrderWarehouseEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public OrderWarehouseRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public OrderWarehouseRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public OrderWarehouseRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    OrderWarehouseRequestData orderWarehouseRequestData = (OrderWarehouseRequestData) o;
    return Objects.equals(this.returnEntityAttributes, orderWarehouseRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, orderWarehouseRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, orderWarehouseRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, orderWarehouseRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class OrderWarehouseRequestData {\n");
