...
import com.fntsoftware.businessgateway.entities.ServerZoneEntityRestriction;
...
/**
 * ServerZoneRequestData
 */
@JsonPropertyOrder({
  ServerZoneRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  ServerZoneRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  ServerZoneRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  ServerZoneRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-03-04T13:31:32.601557352Z[Etc/UTC]")
public class ServerZoneRequestData {
  ...
  private ServerZoneEntityRestriction entityRestrictions;
  ...
  public ServerZoneRequestData() {
  }

  public ServerZoneRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public ServerZoneRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public ServerZoneRequestData entityRestrictions(ServerZoneEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public ServerZoneEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(ServerZoneEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public ServerZoneRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public ServerZoneRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public ServerZoneRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ServerZoneRequestData serverZoneRequestData = (ServerZoneRequestData) o;
    return Objects.equals(this.returnEntityAttributes, serverZoneRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, serverZoneRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, serverZoneRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, serverZoneRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class ServerZoneRequestData {\n");
