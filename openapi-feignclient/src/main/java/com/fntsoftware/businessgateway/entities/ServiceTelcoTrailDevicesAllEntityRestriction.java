...
/**
 * ServiceTelcoTrailDevicesAllEntityRestriction
 */
@JsonPropertyOrder({
  ServiceTelcoTrailDevicesAllEntityRestriction.JSON_PROPERTY_CLIMATE_RELEVANT,
  ServiceTelcoTrailDevicesAllEntityRestriction.JSON_PROPERTY_POWER_CONSUMPTION,
  ServiceTelcoTrailDevicesAllEntityRestriction.JSON_PROPERTY_POWER_SWITCHING_STATUS,
  ServiceTelcoTrailDevicesAllEntityRestriction.JSON_PROPERTY_PLAN_STATUS,
  ServiceTelcoTrailDevicesAllEntityRestriction.JSON_PROPERTY_SYSTEM_RUNTIME,
  ServiceTelcoTrailDevicesAllEntityRestriction.JSON_PROPERTY_WEIGHT,
  ServiceTelcoTrailDevicesAllEntityRestriction.JSON_PROPERTY_REMARK,
  ServiceTelcoTrailDevicesAllEntityRestriction.JSON_PROPERTY_ELID,
  ServiceTelcoTrailDevicesAllEntityRestriction.JSON_PROPERTY_LAST_SEEN,
  ServiceTelcoTrailDevicesAllEntityRestriction.JSON_PROPERTY_TYPE_ELID,
  ServiceTelcoTrailDevicesAllEntityRestriction.JSON_PROPERTY_VISIBLE_ID,
  ServiceTelcoTrailDevicesAllEntityRestriction.JSON_PROPERTY_ID,
  ServiceTelcoTrailDevicesAllEntityRestriction.JSON_PROPERTY_HEAT_EMISSION
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-01-31T11:10:37.320689708Z[Etc/UTC]")
public class ServiceTelcoTrailDevicesAllEntityRestriction {
  ...
  public ServiceTelcoTrailDevicesAllEntityRestriction() {
  }

  public ServiceTelcoTrailDevicesAllEntityRestriction climateRelevant(RestrictionsBoolean climateRelevant) {
  ...
  **/
  ...
  public ServiceTelcoTrailDevicesAllEntityRestriction powerConsumption(RestrictionsNumeric powerConsumption) {
  ...
  **/
  ...
  public ServiceTelcoTrailDevicesAllEntityRestriction powerSwitchingStatus(RestrictionsString powerSwitchingStatus) {
  ...
  **/
  ...
  public ServiceTelcoTrailDevicesAllEntityRestriction planStatus(RestrictionsString planStatus) {
  ...
  **/
  ...
  public ServiceTelcoTrailDevicesAllEntityRestriction systemRuntime(RestrictionsNumeric systemRuntime) {
  ...
  **/
  ...
  public ServiceTelcoTrailDevicesAllEntityRestriction weight(RestrictionsNumeric weight) {
  ...
  **/
  ...
  public ServiceTelcoTrailDevicesAllEntityRestriction remark(RestrictionsString remark) {
  ...
  **/
  ...
  public ServiceTelcoTrailDevicesAllEntityRestriction elid(RestrictionsString elid) {
  ...
  **/
  ...
  public ServiceTelcoTrailDevicesAllEntityRestriction lastSeen(RestrictionsDate lastSeen) {
  ...
  **/
  ...
  public ServiceTelcoTrailDevicesAllEntityRestriction typeElid(RestrictionsString typeElid) {
  ...
  **/
  ...
  public ServiceTelcoTrailDevicesAllEntityRestriction visibleId(RestrictionsString visibleId) {
  ...
  **/
  ...
  public ServiceTelcoTrailDevicesAllEntityRestriction id(RestrictionsString id) {
  ...
  **/
  ...
  public ServiceTelcoTrailDevicesAllEntityRestriction heatEmission(RestrictionsNumeric heatEmission) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ServiceTelcoTrailDevicesAllEntityRestriction serviceTelcoTrailDevicesAllEntityRestriction = (ServiceTelcoTrailDevicesAllEntityRestriction) o;
    return Objects.equals(this.climateRelevant, serviceTelcoTrailDevicesAllEntityRestriction.climateRelevant) &&
        Objects.equals(this.powerConsumption, serviceTelcoTrailDevicesAllEntityRestriction.powerConsumption) &&
        Objects.equals(this.powerSwitchingStatus, serviceTelcoTrailDevicesAllEntityRestriction.powerSwitchingStatus) &&
        Objects.equals(this.planStatus, serviceTelcoTrailDevicesAllEntityRestriction.planStatus) &&
        Objects.equals(this.systemRuntime, serviceTelcoTrailDevicesAllEntityRestriction.systemRuntime) &&
        Objects.equals(this.weight, serviceTelcoTrailDevicesAllEntityRestriction.weight) &&
        Objects.equals(this.remark, serviceTelcoTrailDevicesAllEntityRestriction.remark) &&
        Objects.equals(this.elid, serviceTelcoTrailDevicesAllEntityRestriction.elid) &&
        Objects.equals(this.lastSeen, serviceTelcoTrailDevicesAllEntityRestriction.lastSeen) &&
        Objects.equals(this.typeElid, serviceTelcoTrailDevicesAllEntityRestriction.typeElid) &&
        Objects.equals(this.visibleId, serviceTelcoTrailDevicesAllEntityRestriction.visibleId) &&
        Objects.equals(this.id, serviceTelcoTrailDevicesAllEntityRestriction.id) &&
        Objects.equals(this.heatEmission, serviceTelcoTrailDevicesAllEntityRestriction.heatEmission);
  }
  ...
  public String toString() {
    ...
    sb.append("class ServiceTelcoTrailDevicesAllEntityRestriction {\n");
