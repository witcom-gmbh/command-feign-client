...
import com.fntsoftware.businessgateway.entities.AntennaSitesEntityRestriction;
import com.fntsoftware.businessgateway.entities.AntennaSitesRelationRestriction;
...
/**
 * AntennaSitesRequestData
 */
@JsonPropertyOrder({
  AntennaSitesRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  AntennaSitesRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  AntennaSitesRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  AntennaSitesRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-01-31T11:10:37.320689708Z[Etc/UTC]")
public class AntennaSitesRequestData {
  ...
  private AntennaSitesEntityRestriction entityRestrictions;

  public static final String JSON_PROPERTY_RELATION_RESTRICTIONS = "relationRestrictions";
  private AntennaSitesRelationRestriction relationRestrictions;
  ...
  public AntennaSitesRequestData() {
  }

  public AntennaSitesRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public AntennaSitesRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public AntennaSitesRequestData entityRestrictions(AntennaSitesEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public AntennaSitesEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(AntennaSitesEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public AntennaSitesRequestData relationRestrictions(AntennaSitesRelationRestriction relationRestrictions) {
  ...
  **/
  ...
  public AntennaSitesRelationRestriction getRelationRestrictions() {
    return relationRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_RELATION_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRelationRestrictions(AntennaSitesRelationRestriction relationRestrictions) {
    this.relationRestrictions = relationRestrictions;
  }


  public AntennaSitesRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public AntennaSitesRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    AntennaSitesRequestData antennaSitesRequestData = (AntennaSitesRequestData) o;
    return Objects.equals(this.returnEntityAttributes, antennaSitesRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, antennaSitesRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, antennaSitesRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, antennaSitesRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class AntennaSitesRequestData {\n");
