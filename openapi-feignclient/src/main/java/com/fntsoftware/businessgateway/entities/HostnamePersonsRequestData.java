...
import com.fntsoftware.businessgateway.entities.HostnamePersonsEntityRestriction;
import com.fntsoftware.businessgateway.entities.HostnamePersonsRelationRestriction;
...
/**
 * HostnamePersonsRequestData
 */
@JsonPropertyOrder({
  HostnamePersonsRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  HostnamePersonsRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  HostnamePersonsRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  HostnamePersonsRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-02-26T11:20:24.990023935Z[Etc/UTC]")
public class HostnamePersonsRequestData {
  ...
  private HostnamePersonsEntityRestriction entityRestrictions;

  public static final String JSON_PROPERTY_RELATION_RESTRICTIONS = "relationRestrictions";
  private HostnamePersonsRelationRestriction relationRestrictions;
  ...
  public HostnamePersonsRequestData() {
  }

  public HostnamePersonsRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public HostnamePersonsRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public HostnamePersonsRequestData entityRestrictions(HostnamePersonsEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public HostnamePersonsEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(HostnamePersonsEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public HostnamePersonsRequestData relationRestrictions(HostnamePersonsRelationRestriction relationRestrictions) {
  ...
  **/
  ...
  public HostnamePersonsRelationRestriction getRelationRestrictions() {
    return relationRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_RELATION_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRelationRestrictions(HostnamePersonsRelationRestriction relationRestrictions) {
    this.relationRestrictions = relationRestrictions;
  }


  public HostnamePersonsRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public HostnamePersonsRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    HostnamePersonsRequestData hostnamePersonsRequestData = (HostnamePersonsRequestData) o;
    return Objects.equals(this.returnEntityAttributes, hostnamePersonsRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, hostnamePersonsRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, hostnamePersonsRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, hostnamePersonsRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class HostnamePersonsRequestData {\n");
