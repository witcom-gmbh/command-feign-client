...
import com.fntsoftware.businessgateway.entities.DataSocketZoneEntityRestriction;
...
/**
 * DataSocketZoneRequestData
 */
@JsonPropertyOrder({
  DataSocketZoneRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  DataSocketZoneRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  DataSocketZoneRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  DataSocketZoneRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-02-26T11:20:24.990023935Z[Etc/UTC]")
public class DataSocketZoneRequestData {
  ...
  private DataSocketZoneEntityRestriction entityRestrictions;
  ...
  public DataSocketZoneRequestData() {
  }

  public DataSocketZoneRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public DataSocketZoneRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public DataSocketZoneRequestData entityRestrictions(DataSocketZoneEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public DataSocketZoneEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(DataSocketZoneEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public DataSocketZoneRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public DataSocketZoneRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public DataSocketZoneRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    DataSocketZoneRequestData dataSocketZoneRequestData = (DataSocketZoneRequestData) o;
    return Objects.equals(this.returnEntityAttributes, dataSocketZoneRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, dataSocketZoneRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, dataSocketZoneRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, dataSocketZoneRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class DataSocketZoneRequestData {\n");
