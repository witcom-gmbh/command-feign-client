...
import com.fntsoftware.businessgateway.entities.VlanCustomL2CpeSegmentEntityRestriction;
...
/**
 * VlanCustomL2CpeSegmentRequestData
 */
@JsonPropertyOrder({
  VlanCustomL2CpeSegmentRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  VlanCustomL2CpeSegmentRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  VlanCustomL2CpeSegmentRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  VlanCustomL2CpeSegmentRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-03-04T13:31:32.601557352Z[Etc/UTC]")
public class VlanCustomL2CpeSegmentRequestData {
  ...
  private VlanCustomL2CpeSegmentEntityRestriction entityRestrictions;
  ...
  public VlanCustomL2CpeSegmentRequestData() {
  }

  public VlanCustomL2CpeSegmentRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public VlanCustomL2CpeSegmentRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public VlanCustomL2CpeSegmentRequestData entityRestrictions(VlanCustomL2CpeSegmentEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public VlanCustomL2CpeSegmentEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(VlanCustomL2CpeSegmentEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public VlanCustomL2CpeSegmentRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public VlanCustomL2CpeSegmentRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public VlanCustomL2CpeSegmentRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    VlanCustomL2CpeSegmentRequestData vlanCustomL2CpeSegmentRequestData = (VlanCustomL2CpeSegmentRequestData) o;
    return Objects.equals(this.returnEntityAttributes, vlanCustomL2CpeSegmentRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, vlanCustomL2CpeSegmentRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, vlanCustomL2CpeSegmentRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, vlanCustomL2CpeSegmentRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class VlanCustomL2CpeSegmentRequestData {\n");
