...
import com.fntsoftware.businessgateway.entities.AntennaPhysicalPortsDataEntityRestriction;
...
/**
 * AntennaPhysicalPortsDataRequestData
 */
@JsonPropertyOrder({
  AntennaPhysicalPortsDataRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  AntennaPhysicalPortsDataRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  AntennaPhysicalPortsDataRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  AntennaPhysicalPortsDataRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-01-31T11:10:37.320689708Z[Etc/UTC]")
public class AntennaPhysicalPortsDataRequestData {
  ...
  private AntennaPhysicalPortsDataEntityRestriction entityRestrictions;
  ...
  public AntennaPhysicalPortsDataRequestData() {
  }

  public AntennaPhysicalPortsDataRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public AntennaPhysicalPortsDataRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public AntennaPhysicalPortsDataRequestData entityRestrictions(AntennaPhysicalPortsDataEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public AntennaPhysicalPortsDataEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(AntennaPhysicalPortsDataEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public AntennaPhysicalPortsDataRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public AntennaPhysicalPortsDataRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public AntennaPhysicalPortsDataRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    AntennaPhysicalPortsDataRequestData antennaPhysicalPortsDataRequestData = (AntennaPhysicalPortsDataRequestData) o;
    return Objects.equals(this.returnEntityAttributes, antennaPhysicalPortsDataRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, antennaPhysicalPortsDataRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, antennaPhysicalPortsDataRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, antennaPhysicalPortsDataRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class AntennaPhysicalPortsDataRequestData {\n");
