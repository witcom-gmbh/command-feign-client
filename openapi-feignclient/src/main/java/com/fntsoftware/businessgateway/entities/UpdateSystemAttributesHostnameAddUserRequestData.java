...
/**
 * UpdateSystemAttributesHostnameAddUserRequestData
 */
@JsonPropertyOrder({
  UpdateSystemAttributesHostnameAddUserRequestData.JSON_PROPERTY_MODIFY_PLAN,
  UpdateSystemAttributesHostnameAddUserRequestData.JSON_PROPERTY_DELETE_REAL,
  UpdateSystemAttributesHostnameAddUserRequestData.JSON_PROPERTY_READ_PLAN,
  UpdateSystemAttributesHostnameAddUserRequestData.JSON_PROPERTY_MANDANT_ID,
  UpdateSystemAttributesHostnameAddUserRequestData.JSON_PROPERTY_USER_ELID,
  UpdateSystemAttributesHostnameAddUserRequestData.JSON_PROPERTY_MODIFY_REAL,
  UpdateSystemAttributesHostnameAddUserRequestData.JSON_PROPERTY_READ_REAL,
  UpdateSystemAttributesHostnameAddUserRequestData.JSON_PROPERTY_DELETE_PLAN
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-02-26T11:20:24.990023935Z[Etc/UTC]")
public class UpdateSystemAttributesHostnameAddUserRequestData {
  ...
  public UpdateSystemAttributesHostnameAddUserRequestData() {
  }

  public UpdateSystemAttributesHostnameAddUserRequestData modifyPlan(Boolean modifyPlan) {
  ...
  **/
  ...
  public UpdateSystemAttributesHostnameAddUserRequestData deleteReal(Boolean deleteReal) {
  ...
  **/
  ...
  public UpdateSystemAttributesHostnameAddUserRequestData readPlan(Boolean readPlan) {
  ...
  **/
  ...
  public UpdateSystemAttributesHostnameAddUserRequestData mandantId(BigDecimal mandantId) {
  ...
  **/
  ...
  public UpdateSystemAttributesHostnameAddUserRequestData userElid(String userElid) {
  ...
  **/
  ...
  public UpdateSystemAttributesHostnameAddUserRequestData modifyReal(Boolean modifyReal) {
  ...
  **/
  ...
  public UpdateSystemAttributesHostnameAddUserRequestData readReal(Boolean readReal) {
  ...
  **/
  ...
  public UpdateSystemAttributesHostnameAddUserRequestData deletePlan(Boolean deletePlan) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    UpdateSystemAttributesHostnameAddUserRequestData updateSystemAttributesHostnameAddUserRequestData = (UpdateSystemAttributesHostnameAddUserRequestData) o;
    return Objects.equals(this.modifyPlan, updateSystemAttributesHostnameAddUserRequestData.modifyPlan) &&
        Objects.equals(this.deleteReal, updateSystemAttributesHostnameAddUserRequestData.deleteReal) &&
        Objects.equals(this.readPlan, updateSystemAttributesHostnameAddUserRequestData.readPlan) &&
        Objects.equals(this.mandantId, updateSystemAttributesHostnameAddUserRequestData.mandantId) &&
        Objects.equals(this.userElid, updateSystemAttributesHostnameAddUserRequestData.userElid) &&
        Objects.equals(this.modifyReal, updateSystemAttributesHostnameAddUserRequestData.modifyReal) &&
        Objects.equals(this.readReal, updateSystemAttributesHostnameAddUserRequestData.readReal) &&
        Objects.equals(this.deletePlan, updateSystemAttributesHostnameAddUserRequestData.deletePlan);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateSystemAttributesHostnameAddUserRequestData {\n");
