...
import com.fntsoftware.businessgateway.entities.FrameContractSoftwareInstanceEntityRestriction;
...
/**
 * FrameContractSoftwareInstanceRequestData
 */
@JsonPropertyOrder({
  FrameContractSoftwareInstanceRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  FrameContractSoftwareInstanceRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  FrameContractSoftwareInstanceRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  FrameContractSoftwareInstanceRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-02-26T11:20:24.990023935Z[Etc/UTC]")
public class FrameContractSoftwareInstanceRequestData {
  ...
  private FrameContractSoftwareInstanceEntityRestriction entityRestrictions;
  ...
  public FrameContractSoftwareInstanceRequestData() {
  }

  public FrameContractSoftwareInstanceRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public FrameContractSoftwareInstanceRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public FrameContractSoftwareInstanceRequestData entityRestrictions(FrameContractSoftwareInstanceEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public FrameContractSoftwareInstanceEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(FrameContractSoftwareInstanceEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public FrameContractSoftwareInstanceRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public FrameContractSoftwareInstanceRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public FrameContractSoftwareInstanceRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    FrameContractSoftwareInstanceRequestData frameContractSoftwareInstanceRequestData = (FrameContractSoftwareInstanceRequestData) o;
    return Objects.equals(this.returnEntityAttributes, frameContractSoftwareInstanceRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, frameContractSoftwareInstanceRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, frameContractSoftwareInstanceRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, frameContractSoftwareInstanceRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class FrameContractSoftwareInstanceRequestData {\n");
