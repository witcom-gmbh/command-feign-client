...
/**
 * StorageDevicesAllEntityRestriction
 */
@JsonPropertyOrder({
  StorageDevicesAllEntityRestriction.JSON_PROPERTY_CLIMATE_RELEVANT,
  StorageDevicesAllEntityRestriction.JSON_PROPERTY_POWER_CONSUMPTION,
  StorageDevicesAllEntityRestriction.JSON_PROPERTY_POWER_SWITCHING_STATUS,
  StorageDevicesAllEntityRestriction.JSON_PROPERTY_PLAN_STATUS,
  StorageDevicesAllEntityRestriction.JSON_PROPERTY_SYSTEM_RUNTIME,
  StorageDevicesAllEntityRestriction.JSON_PROPERTY_WEIGHT,
  StorageDevicesAllEntityRestriction.JSON_PROPERTY_REMARK,
  StorageDevicesAllEntityRestriction.JSON_PROPERTY_ELID,
  StorageDevicesAllEntityRestriction.JSON_PROPERTY_LAST_SEEN,
  StorageDevicesAllEntityRestriction.JSON_PROPERTY_TYPE_ELID,
  StorageDevicesAllEntityRestriction.JSON_PROPERTY_VISIBLE_ID,
  StorageDevicesAllEntityRestriction.JSON_PROPERTY_ID,
  StorageDevicesAllEntityRestriction.JSON_PROPERTY_HEAT_EMISSION
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-01-31T11:10:37.320689708Z[Etc/UTC]")
public class StorageDevicesAllEntityRestriction {
  ...
  public StorageDevicesAllEntityRestriction() {
  }

  public StorageDevicesAllEntityRestriction climateRelevant(RestrictionsBoolean climateRelevant) {
  ...
  **/
  ...
  public StorageDevicesAllEntityRestriction powerConsumption(RestrictionsNumeric powerConsumption) {
  ...
  **/
  ...
  public StorageDevicesAllEntityRestriction powerSwitchingStatus(RestrictionsString powerSwitchingStatus) {
  ...
  **/
  ...
  public StorageDevicesAllEntityRestriction planStatus(RestrictionsString planStatus) {
  ...
  **/
  ...
  public StorageDevicesAllEntityRestriction systemRuntime(RestrictionsNumeric systemRuntime) {
  ...
  **/
  ...
  public StorageDevicesAllEntityRestriction weight(RestrictionsNumeric weight) {
  ...
  **/
  ...
  public StorageDevicesAllEntityRestriction remark(RestrictionsString remark) {
  ...
  **/
  ...
  public StorageDevicesAllEntityRestriction elid(RestrictionsString elid) {
  ...
  **/
  ...
  public StorageDevicesAllEntityRestriction lastSeen(RestrictionsDate lastSeen) {
  ...
  **/
  ...
  public StorageDevicesAllEntityRestriction typeElid(RestrictionsString typeElid) {
  ...
  **/
  ...
  public StorageDevicesAllEntityRestriction visibleId(RestrictionsString visibleId) {
  ...
  **/
  ...
  public StorageDevicesAllEntityRestriction id(RestrictionsString id) {
  ...
  **/
  ...
  public StorageDevicesAllEntityRestriction heatEmission(RestrictionsNumeric heatEmission) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    StorageDevicesAllEntityRestriction storageDevicesAllEntityRestriction = (StorageDevicesAllEntityRestriction) o;
    return Objects.equals(this.climateRelevant, storageDevicesAllEntityRestriction.climateRelevant) &&
        Objects.equals(this.powerConsumption, storageDevicesAllEntityRestriction.powerConsumption) &&
        Objects.equals(this.powerSwitchingStatus, storageDevicesAllEntityRestriction.powerSwitchingStatus) &&
        Objects.equals(this.planStatus, storageDevicesAllEntityRestriction.planStatus) &&
        Objects.equals(this.systemRuntime, storageDevicesAllEntityRestriction.systemRuntime) &&
        Objects.equals(this.weight, storageDevicesAllEntityRestriction.weight) &&
        Objects.equals(this.remark, storageDevicesAllEntityRestriction.remark) &&
        Objects.equals(this.elid, storageDevicesAllEntityRestriction.elid) &&
        Objects.equals(this.lastSeen, storageDevicesAllEntityRestriction.lastSeen) &&
        Objects.equals(this.typeElid, storageDevicesAllEntityRestriction.typeElid) &&
        Objects.equals(this.visibleId, storageDevicesAllEntityRestriction.visibleId) &&
        Objects.equals(this.id, storageDevicesAllEntityRestriction.id) &&
        Objects.equals(this.heatEmission, storageDevicesAllEntityRestriction.heatEmission);
  }
  ...
  public String toString() {
    ...
    sb.append("class StorageDevicesAllEntityRestriction {\n");
