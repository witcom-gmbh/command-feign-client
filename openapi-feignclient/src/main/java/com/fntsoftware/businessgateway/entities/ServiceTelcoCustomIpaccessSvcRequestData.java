...
import com.fntsoftware.businessgateway.entities.ServiceTelcoCustomIpaccessSvcEntityRestriction;
...
/**
 * ServiceTelcoCustomIpaccessSvcRequestData
 */
@JsonPropertyOrder({
  ServiceTelcoCustomIpaccessSvcRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  ServiceTelcoCustomIpaccessSvcRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  ServiceTelcoCustomIpaccessSvcRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  ServiceTelcoCustomIpaccessSvcRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-02-26T11:20:24.990023935Z[Etc/UTC]")
public class ServiceTelcoCustomIpaccessSvcRequestData {
  ...
  private ServiceTelcoCustomIpaccessSvcEntityRestriction entityRestrictions;
  ...
  public ServiceTelcoCustomIpaccessSvcRequestData() {
  }

  public ServiceTelcoCustomIpaccessSvcRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public ServiceTelcoCustomIpaccessSvcRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public ServiceTelcoCustomIpaccessSvcRequestData entityRestrictions(ServiceTelcoCustomIpaccessSvcEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public ServiceTelcoCustomIpaccessSvcEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(ServiceTelcoCustomIpaccessSvcEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public ServiceTelcoCustomIpaccessSvcRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public ServiceTelcoCustomIpaccessSvcRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public ServiceTelcoCustomIpaccessSvcRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ServiceTelcoCustomIpaccessSvcRequestData serviceTelcoCustomIpaccessSvcRequestData = (ServiceTelcoCustomIpaccessSvcRequestData) o;
    return Objects.equals(this.returnEntityAttributes, serviceTelcoCustomIpaccessSvcRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, serviceTelcoCustomIpaccessSvcRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, serviceTelcoCustomIpaccessSvcRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, serviceTelcoCustomIpaccessSvcRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class ServiceTelcoCustomIpaccessSvcRequestData {\n");
