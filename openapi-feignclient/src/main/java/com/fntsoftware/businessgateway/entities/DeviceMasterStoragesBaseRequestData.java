...
import com.fntsoftware.businessgateway.entities.DeviceMasterStoragesBaseEntityRestriction;
...
/**
 * DeviceMasterStoragesBaseRequestData
 */
@JsonPropertyOrder({
  DeviceMasterStoragesBaseRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  DeviceMasterStoragesBaseRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  DeviceMasterStoragesBaseRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  DeviceMasterStoragesBaseRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-01-31T11:10:37.320689708Z[Etc/UTC]")
public class DeviceMasterStoragesBaseRequestData {
  ...
  private DeviceMasterStoragesBaseEntityRestriction entityRestrictions;
  ...
  public DeviceMasterStoragesBaseRequestData() {
  }

  public DeviceMasterStoragesBaseRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public DeviceMasterStoragesBaseRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public DeviceMasterStoragesBaseRequestData entityRestrictions(DeviceMasterStoragesBaseEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public DeviceMasterStoragesBaseEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(DeviceMasterStoragesBaseEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public DeviceMasterStoragesBaseRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public DeviceMasterStoragesBaseRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public DeviceMasterStoragesBaseRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    DeviceMasterStoragesBaseRequestData deviceMasterStoragesBaseRequestData = (DeviceMasterStoragesBaseRequestData) o;
    return Objects.equals(this.returnEntityAttributes, deviceMasterStoragesBaseRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, deviceMasterStoragesBaseRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, deviceMasterStoragesBaseRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, deviceMasterStoragesBaseRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeviceMasterStoragesBaseRequestData {\n");
