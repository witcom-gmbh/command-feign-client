...
import com.fntsoftware.businessgateway.entities.ChassisSlotEntityRestriction;
import com.fntsoftware.businessgateway.entities.ChassisSlotRelationRestriction;
...
/**
 * ChassisSlotRequestData
 */
@JsonPropertyOrder({
  ChassisSlotRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  ChassisSlotRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  ChassisSlotRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  ChassisSlotRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-03-04T13:31:32.601557352Z[Etc/UTC]")
public class ChassisSlotRequestData {
  ...
  private ChassisSlotEntityRestriction entityRestrictions;

  public static final String JSON_PROPERTY_RELATION_RESTRICTIONS = "relationRestrictions";
  private ChassisSlotRelationRestriction relationRestrictions;
  ...
  public ChassisSlotRequestData() {
  }

  public ChassisSlotRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public ChassisSlotRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public ChassisSlotRequestData entityRestrictions(ChassisSlotEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public ChassisSlotEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(ChassisSlotEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public ChassisSlotRequestData relationRestrictions(ChassisSlotRelationRestriction relationRestrictions) {
  ...
  **/
  ...
  public ChassisSlotRelationRestriction getRelationRestrictions() {
    return relationRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_RELATION_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRelationRestrictions(ChassisSlotRelationRestriction relationRestrictions) {
    this.relationRestrictions = relationRestrictions;
  }


  public ChassisSlotRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public ChassisSlotRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ChassisSlotRequestData chassisSlotRequestData = (ChassisSlotRequestData) o;
    return Objects.equals(this.returnEntityAttributes, chassisSlotRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, chassisSlotRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, chassisSlotRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, chassisSlotRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class ChassisSlotRequestData {\n");
