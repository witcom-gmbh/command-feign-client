...
import com.fntsoftware.businessgateway.entities.BearerPredecessorEntityRestriction;
...
/**
 * BearerPredecessorRequestData
 */
@JsonPropertyOrder({
  BearerPredecessorRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  BearerPredecessorRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  BearerPredecessorRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  BearerPredecessorRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-01-31T11:10:37.320689708Z[Etc/UTC]")
public class BearerPredecessorRequestData {
  ...
  private BearerPredecessorEntityRestriction entityRestrictions;
  ...
  public BearerPredecessorRequestData() {
  }

  public BearerPredecessorRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public BearerPredecessorRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public BearerPredecessorRequestData entityRestrictions(BearerPredecessorEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public BearerPredecessorEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(BearerPredecessorEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public BearerPredecessorRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public BearerPredecessorRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public BearerPredecessorRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    BearerPredecessorRequestData bearerPredecessorRequestData = (BearerPredecessorRequestData) o;
    return Objects.equals(this.returnEntityAttributes, bearerPredecessorRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, bearerPredecessorRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, bearerPredecessorRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, bearerPredecessorRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class BearerPredecessorRequestData {\n");
