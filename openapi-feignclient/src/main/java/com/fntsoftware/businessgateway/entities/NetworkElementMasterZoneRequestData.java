...
import com.fntsoftware.businessgateway.entities.NetworkElementMasterZoneEntityRestriction;
...
/**
 * NetworkElementMasterZoneRequestData
 */
@JsonPropertyOrder({
  NetworkElementMasterZoneRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  NetworkElementMasterZoneRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  NetworkElementMasterZoneRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  NetworkElementMasterZoneRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-02-26T11:20:24.990023935Z[Etc/UTC]")
public class NetworkElementMasterZoneRequestData {
  ...
  private NetworkElementMasterZoneEntityRestriction entityRestrictions;
  ...
  public NetworkElementMasterZoneRequestData() {
  }

  public NetworkElementMasterZoneRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public NetworkElementMasterZoneRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public NetworkElementMasterZoneRequestData entityRestrictions(NetworkElementMasterZoneEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public NetworkElementMasterZoneEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(NetworkElementMasterZoneEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public NetworkElementMasterZoneRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public NetworkElementMasterZoneRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public NetworkElementMasterZoneRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    NetworkElementMasterZoneRequestData networkElementMasterZoneRequestData = (NetworkElementMasterZoneRequestData) o;
    return Objects.equals(this.returnEntityAttributes, networkElementMasterZoneRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, networkElementMasterZoneRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, networkElementMasterZoneRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, networkElementMasterZoneRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class NetworkElementMasterZoneRequestData {\n");
