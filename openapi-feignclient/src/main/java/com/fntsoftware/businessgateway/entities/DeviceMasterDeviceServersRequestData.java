...
import com.fntsoftware.businessgateway.entities.DeviceMasterDeviceServersEntityRestriction;
...
/**
 * DeviceMasterDeviceServersRequestData
 */
@JsonPropertyOrder({
  DeviceMasterDeviceServersRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  DeviceMasterDeviceServersRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  DeviceMasterDeviceServersRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  DeviceMasterDeviceServersRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-02-26T11:20:24.990023935Z[Etc/UTC]")
public class DeviceMasterDeviceServersRequestData {
  ...
  private DeviceMasterDeviceServersEntityRestriction entityRestrictions;
  ...
  public DeviceMasterDeviceServersRequestData() {
  }

  public DeviceMasterDeviceServersRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public DeviceMasterDeviceServersRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public DeviceMasterDeviceServersRequestData entityRestrictions(DeviceMasterDeviceServersEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public DeviceMasterDeviceServersEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(DeviceMasterDeviceServersEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public DeviceMasterDeviceServersRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public DeviceMasterDeviceServersRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public DeviceMasterDeviceServersRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    DeviceMasterDeviceServersRequestData deviceMasterDeviceServersRequestData = (DeviceMasterDeviceServersRequestData) o;
    return Objects.equals(this.returnEntityAttributes, deviceMasterDeviceServersRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, deviceMasterDeviceServersRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, deviceMasterDeviceServersRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, deviceMasterDeviceServersRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeviceMasterDeviceServersRequestData {\n");
