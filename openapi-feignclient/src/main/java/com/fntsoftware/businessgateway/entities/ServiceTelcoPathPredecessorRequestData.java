...
import com.fntsoftware.businessgateway.entities.ServiceTelcoPathPredecessorEntityRestriction;
...
/**
 * ServiceTelcoPathPredecessorRequestData
 */
@JsonPropertyOrder({
  ServiceTelcoPathPredecessorRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  ServiceTelcoPathPredecessorRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  ServiceTelcoPathPredecessorRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  ServiceTelcoPathPredecessorRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-02-26T11:20:24.990023935Z[Etc/UTC]")
public class ServiceTelcoPathPredecessorRequestData {
  ...
  private ServiceTelcoPathPredecessorEntityRestriction entityRestrictions;
  ...
  public ServiceTelcoPathPredecessorRequestData() {
  }

  public ServiceTelcoPathPredecessorRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public ServiceTelcoPathPredecessorRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public ServiceTelcoPathPredecessorRequestData entityRestrictions(ServiceTelcoPathPredecessorEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public ServiceTelcoPathPredecessorEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(ServiceTelcoPathPredecessorEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public ServiceTelcoPathPredecessorRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public ServiceTelcoPathPredecessorRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public ServiceTelcoPathPredecessorRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ServiceTelcoPathPredecessorRequestData serviceTelcoPathPredecessorRequestData = (ServiceTelcoPathPredecessorRequestData) o;
    return Objects.equals(this.returnEntityAttributes, serviceTelcoPathPredecessorRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, serviceTelcoPathPredecessorRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, serviceTelcoPathPredecessorRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, serviceTelcoPathPredecessorRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class ServiceTelcoPathPredecessorRequestData {\n");
