...
import com.fntsoftware.businessgateway.entities.FrameContractSoftwareProductEntityRestriction;
...
/**
 * FrameContractSoftwareProductRequestData
 */
@JsonPropertyOrder({
  FrameContractSoftwareProductRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  FrameContractSoftwareProductRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  FrameContractSoftwareProductRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  FrameContractSoftwareProductRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-01-31T11:10:37.320689708Z[Etc/UTC]")
public class FrameContractSoftwareProductRequestData {
  ...
  private FrameContractSoftwareProductEntityRestriction entityRestrictions;
  ...
  public FrameContractSoftwareProductRequestData() {
  }

  public FrameContractSoftwareProductRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public FrameContractSoftwareProductRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public FrameContractSoftwareProductRequestData entityRestrictions(FrameContractSoftwareProductEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public FrameContractSoftwareProductEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(FrameContractSoftwareProductEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public FrameContractSoftwareProductRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public FrameContractSoftwareProductRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public FrameContractSoftwareProductRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    FrameContractSoftwareProductRequestData frameContractSoftwareProductRequestData = (FrameContractSoftwareProductRequestData) o;
    return Objects.equals(this.returnEntityAttributes, frameContractSoftwareProductRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, frameContractSoftwareProductRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, frameContractSoftwareProductRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, frameContractSoftwareProductRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class FrameContractSoftwareProductRequestData {\n");
