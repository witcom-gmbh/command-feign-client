...
/**
 * UpdateSystemAttributesFuseAddUserRequestData
 */
@JsonPropertyOrder({
  UpdateSystemAttributesFuseAddUserRequestData.JSON_PROPERTY_MODIFY_PLAN,
  UpdateSystemAttributesFuseAddUserRequestData.JSON_PROPERTY_DELETE_REAL,
  UpdateSystemAttributesFuseAddUserRequestData.JSON_PROPERTY_READ_PLAN,
  UpdateSystemAttributesFuseAddUserRequestData.JSON_PROPERTY_MANDANT_ID,
  UpdateSystemAttributesFuseAddUserRequestData.JSON_PROPERTY_USER_ELID,
  UpdateSystemAttributesFuseAddUserRequestData.JSON_PROPERTY_MODIFY_REAL,
  UpdateSystemAttributesFuseAddUserRequestData.JSON_PROPERTY_READ_REAL,
  UpdateSystemAttributesFuseAddUserRequestData.JSON_PROPERTY_DELETE_PLAN
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-01-31T11:10:37.320689708Z[Etc/UTC]")
public class UpdateSystemAttributesFuseAddUserRequestData {
  ...
  public UpdateSystemAttributesFuseAddUserRequestData() {
  }

  public UpdateSystemAttributesFuseAddUserRequestData modifyPlan(Boolean modifyPlan) {
  ...
  **/
  ...
  public UpdateSystemAttributesFuseAddUserRequestData deleteReal(Boolean deleteReal) {
  ...
  **/
  ...
  public UpdateSystemAttributesFuseAddUserRequestData readPlan(Boolean readPlan) {
  ...
  **/
  ...
  public UpdateSystemAttributesFuseAddUserRequestData mandantId(BigDecimal mandantId) {
  ...
  **/
  ...
  public UpdateSystemAttributesFuseAddUserRequestData userElid(String userElid) {
  ...
  **/
  ...
  public UpdateSystemAttributesFuseAddUserRequestData modifyReal(Boolean modifyReal) {
  ...
  **/
  ...
  public UpdateSystemAttributesFuseAddUserRequestData readReal(Boolean readReal) {
  ...
  **/
  ...
  public UpdateSystemAttributesFuseAddUserRequestData deletePlan(Boolean deletePlan) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    UpdateSystemAttributesFuseAddUserRequestData updateSystemAttributesFuseAddUserRequestData = (UpdateSystemAttributesFuseAddUserRequestData) o;
    return Objects.equals(this.modifyPlan, updateSystemAttributesFuseAddUserRequestData.modifyPlan) &&
        Objects.equals(this.deleteReal, updateSystemAttributesFuseAddUserRequestData.deleteReal) &&
        Objects.equals(this.readPlan, updateSystemAttributesFuseAddUserRequestData.readPlan) &&
        Objects.equals(this.mandantId, updateSystemAttributesFuseAddUserRequestData.mandantId) &&
        Objects.equals(this.userElid, updateSystemAttributesFuseAddUserRequestData.userElid) &&
        Objects.equals(this.modifyReal, updateSystemAttributesFuseAddUserRequestData.modifyReal) &&
        Objects.equals(this.readReal, updateSystemAttributesFuseAddUserRequestData.readReal) &&
        Objects.equals(this.deletePlan, updateSystemAttributesFuseAddUserRequestData.deletePlan);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateSystemAttributesFuseAddUserRequestData {\n");
