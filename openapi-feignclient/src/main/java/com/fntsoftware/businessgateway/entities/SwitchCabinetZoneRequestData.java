...
import com.fntsoftware.businessgateway.entities.SwitchCabinetZoneEntityRestriction;
...
/**
 * SwitchCabinetZoneRequestData
 */
@JsonPropertyOrder({
  SwitchCabinetZoneRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  SwitchCabinetZoneRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  SwitchCabinetZoneRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  SwitchCabinetZoneRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-02-26T11:20:24.990023935Z[Etc/UTC]")
public class SwitchCabinetZoneRequestData {
  ...
  private SwitchCabinetZoneEntityRestriction entityRestrictions;
  ...
  public SwitchCabinetZoneRequestData() {
  }

  public SwitchCabinetZoneRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public SwitchCabinetZoneRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public SwitchCabinetZoneRequestData entityRestrictions(SwitchCabinetZoneEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public SwitchCabinetZoneEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(SwitchCabinetZoneEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public SwitchCabinetZoneRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public SwitchCabinetZoneRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public SwitchCabinetZoneRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    SwitchCabinetZoneRequestData switchCabinetZoneRequestData = (SwitchCabinetZoneRequestData) o;
    return Objects.equals(this.returnEntityAttributes, switchCabinetZoneRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, switchCabinetZoneRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, switchCabinetZoneRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, switchCabinetZoneRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class SwitchCabinetZoneRequestData {\n");
