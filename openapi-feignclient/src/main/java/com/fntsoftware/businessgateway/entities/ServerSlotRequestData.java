...
import com.fntsoftware.businessgateway.entities.ServerSlotEntityRestriction;
import com.fntsoftware.businessgateway.entities.ServerSlotRelationRestriction;
...
/**
 * ServerSlotRequestData
 */
@JsonPropertyOrder({
  ServerSlotRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  ServerSlotRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  ServerSlotRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  ServerSlotRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-03-04T13:31:32.601557352Z[Etc/UTC]")
public class ServerSlotRequestData {
  ...
  private ServerSlotEntityRestriction entityRestrictions;

  public static final String JSON_PROPERTY_RELATION_RESTRICTIONS = "relationRestrictions";
  private ServerSlotRelationRestriction relationRestrictions;
  ...
  public ServerSlotRequestData() {
  }

  public ServerSlotRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public ServerSlotRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public ServerSlotRequestData entityRestrictions(ServerSlotEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public ServerSlotEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(ServerSlotEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public ServerSlotRequestData relationRestrictions(ServerSlotRelationRestriction relationRestrictions) {
  ...
  **/
  ...
  public ServerSlotRelationRestriction getRelationRestrictions() {
    return relationRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_RELATION_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRelationRestrictions(ServerSlotRelationRestriction relationRestrictions) {
    this.relationRestrictions = relationRestrictions;
  }


  public ServerSlotRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public ServerSlotRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ServerSlotRequestData serverSlotRequestData = (ServerSlotRequestData) o;
    return Objects.equals(this.returnEntityAttributes, serverSlotRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, serverSlotRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, serverSlotRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, serverSlotRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class ServerSlotRequestData {\n");
