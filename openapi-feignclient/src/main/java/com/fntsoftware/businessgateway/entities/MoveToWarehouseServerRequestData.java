...
import com.fntsoftware.businessgateway.entities.MoveToWarehouseServerCreateLinkWarehouseRequestData;
import com.fasterxml.jackson.annotation.JsonPropertyOrder;
import com.fasterxml.jackson.annotation.JsonTypeName;

/**
 * MoveToWarehouseServerRequestData
 */
@JsonPropertyOrder({
  MoveToWarehouseServerRequestData.JSON_PROPERTY_RELEASE_SIGNALPATH,
  MoveToWarehouseServerRequestData.JSON_PROPERTY_RELEASE_CONNECTIONS,
  MoveToWarehouseServerRequestData.JSON_PROPERTY_RELEASE_SERVICE,
  MoveToWarehouseServerRequestData.JSON_PROPERTY_RELEASE_SUPPORTS,
  MoveToWarehouseServerRequestData.JSON_PROPERTY_RELEASE_PATCHES,
  MoveToWarehouseServerRequestData.JSON_PROPERTY_CREATE_LINK_WAREHOUSE
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-02-26T11:20:24.990023935Z[Etc/UTC]")
public class MoveToWarehouseServerRequestData {
  ...
  private MoveToWarehouseServerCreateLinkWarehouseRequestData createLinkWarehouse;

  public MoveToWarehouseServerRequestData() {
  }

  public MoveToWarehouseServerRequestData releaseSignalpath(Boolean releaseSignalpath) {
  ...
  **/
  ...
  public MoveToWarehouseServerRequestData releaseConnections(Boolean releaseConnections) {
  ...
  **/
  ...
  public MoveToWarehouseServerRequestData releaseService(Boolean releaseService) {
  ...
  **/
  ...
  public MoveToWarehouseServerRequestData releaseSupports(Boolean releaseSupports) {
  ...
  **/
  ...
  public MoveToWarehouseServerRequestData releasePatches(Boolean releasePatches) {
  ...
  **/
  ...
  public MoveToWarehouseServerRequestData createLinkWarehouse(MoveToWarehouseServerCreateLinkWarehouseRequestData createLinkWarehouse) {
  ...
  **/
  ...
  public MoveToWarehouseServerCreateLinkWarehouseRequestData getCreateLinkWarehouse() {
    return createLinkWarehouse;
  }
  ...
  @JsonProperty(JSON_PROPERTY_CREATE_LINK_WAREHOUSE)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setCreateLinkWarehouse(MoveToWarehouseServerCreateLinkWarehouseRequestData createLinkWarehouse) {
    this.createLinkWarehouse = createLinkWarehouse;
  }
  ...
  public boolean equals(Object o) {
    ...
    MoveToWarehouseServerRequestData moveToWarehouseServerRequestData = (MoveToWarehouseServerRequestData) o;
    return Objects.equals(this.releaseSignalpath, moveToWarehouseServerRequestData.releaseSignalpath) &&
        Objects.equals(this.releaseConnections, moveToWarehouseServerRequestData.releaseConnections) &&
        Objects.equals(this.releaseService, moveToWarehouseServerRequestData.releaseService) &&
        Objects.equals(this.releaseSupports, moveToWarehouseServerRequestData.releaseSupports) &&
        Objects.equals(this.releasePatches, moveToWarehouseServerRequestData.releasePatches) &&
        Objects.equals(this.createLinkWarehouse, moveToWarehouseServerRequestData.createLinkWarehouse);
  }
  ...
  public String toString() {
    ...
    sb.append("class MoveToWarehouseServerRequestData {\n");
