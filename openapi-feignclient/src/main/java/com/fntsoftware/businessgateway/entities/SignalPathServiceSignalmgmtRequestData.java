...
import com.fntsoftware.businessgateway.entities.SignalPathServiceSignalmgmtEntityRestriction;
...
/**
 * SignalPathServiceSignalmgmtRequestData
 */
@JsonPropertyOrder({
  SignalPathServiceSignalmgmtRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  SignalPathServiceSignalmgmtRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  SignalPathServiceSignalmgmtRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  SignalPathServiceSignalmgmtRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-02-26T11:20:24.990023935Z[Etc/UTC]")
public class SignalPathServiceSignalmgmtRequestData {
  ...
  private SignalPathServiceSignalmgmtEntityRestriction entityRestrictions;
  ...
  public SignalPathServiceSignalmgmtRequestData() {
  }

  public SignalPathServiceSignalmgmtRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public SignalPathServiceSignalmgmtRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public SignalPathServiceSignalmgmtRequestData entityRestrictions(SignalPathServiceSignalmgmtEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public SignalPathServiceSignalmgmtEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(SignalPathServiceSignalmgmtEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public SignalPathServiceSignalmgmtRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public SignalPathServiceSignalmgmtRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public SignalPathServiceSignalmgmtRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    SignalPathServiceSignalmgmtRequestData signalPathServiceSignalmgmtRequestData = (SignalPathServiceSignalmgmtRequestData) o;
    return Objects.equals(this.returnEntityAttributes, signalPathServiceSignalmgmtRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, signalPathServiceSignalmgmtRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, signalPathServiceSignalmgmtRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, signalPathServiceSignalmgmtRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class SignalPathServiceSignalmgmtRequestData {\n");
