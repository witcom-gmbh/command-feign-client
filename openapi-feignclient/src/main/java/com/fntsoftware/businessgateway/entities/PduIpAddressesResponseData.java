...
/**
 * PduIpAddressesResponseData
 */
@JsonPropertyOrder({
  PduIpAddressesResponseData.JSON_PROPERTY_ASSIGNED_DIRECTLY,
  PduIpAddressesResponseData.JSON_PROPERTY_INTERFACE,
  PduIpAddressesResponseData.JSON_PROPERTY_PORTS,
  PduIpAddressesResponseData.JSON_PROPERTY_OBJECT_ELID,
  PduIpAddressesResponseData.JSON_PROPERTY_OBJECT_ID
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-01-31T11:10:37.320689708Z[Etc/UTC]")
public class PduIpAddressesResponseData {
  ...
  public PduIpAddressesResponseData() {
  }

  public PduIpAddressesResponseData assignedDirectly(Boolean assignedDirectly) {
  ...
  **/
  ...
  public PduIpAddressesResponseData _interface(InterfaceinterfaceWithAddressData _interface) {
  ...
  **/
  ...
  public PduIpAddressesResponseData ports(List<PhysicalPortDataphysicalPortDataInfo> ports) {
    
    this.ports = ports;
    return this;
  }

  public PduIpAddressesResponseData addPortsItem(PhysicalPortDataphysicalPortDataInfo portsItem) {
    if (this.ports == null) {
  ...
  **/
  ...
  public PduIpAddressesResponseData objectElid(String objectElid) {
  ...
  **/
  ...
  public PduIpAddressesResponseData objectId(String objectId) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    PduIpAddressesResponseData pduIpAddressesResponseData = (PduIpAddressesResponseData) o;
    return Objects.equals(this.assignedDirectly, pduIpAddressesResponseData.assignedDirectly) &&
        Objects.equals(this._interface, pduIpAddressesResponseData._interface) &&
        Objects.equals(this.ports, pduIpAddressesResponseData.ports) &&
        Objects.equals(this.objectElid, pduIpAddressesResponseData.objectElid) &&
        Objects.equals(this.objectId, pduIpAddressesResponseData.objectId);
  }
  ...
  public String toString() {
    ...
    sb.append("class PduIpAddressesResponseData {\n");
