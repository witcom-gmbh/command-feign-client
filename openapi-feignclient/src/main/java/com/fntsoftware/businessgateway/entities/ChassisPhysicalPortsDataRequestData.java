...
import com.fntsoftware.businessgateway.entities.ChassisPhysicalPortsDataEntityRestriction;
...
/**
 * ChassisPhysicalPortsDataRequestData
 */
@JsonPropertyOrder({
  ChassisPhysicalPortsDataRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  ChassisPhysicalPortsDataRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  ChassisPhysicalPortsDataRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  ChassisPhysicalPortsDataRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-03-04T13:31:32.601557352Z[Etc/UTC]")
public class ChassisPhysicalPortsDataRequestData {
  ...
  private ChassisPhysicalPortsDataEntityRestriction entityRestrictions;
  ...
  public ChassisPhysicalPortsDataRequestData() {
  }

  public ChassisPhysicalPortsDataRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public ChassisPhysicalPortsDataRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public ChassisPhysicalPortsDataRequestData entityRestrictions(ChassisPhysicalPortsDataEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public ChassisPhysicalPortsDataEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(ChassisPhysicalPortsDataEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public ChassisPhysicalPortsDataRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public ChassisPhysicalPortsDataRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public ChassisPhysicalPortsDataRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ChassisPhysicalPortsDataRequestData chassisPhysicalPortsDataRequestData = (ChassisPhysicalPortsDataRequestData) o;
    return Objects.equals(this.returnEntityAttributes, chassisPhysicalPortsDataRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, chassisPhysicalPortsDataRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, chassisPhysicalPortsDataRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, chassisPhysicalPortsDataRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class ChassisPhysicalPortsDataRequestData {\n");
