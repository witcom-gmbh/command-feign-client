...
import com.fntsoftware.businessgateway.entities.RoomContractsEntityRestriction;
import com.fntsoftware.businessgateway.entities.RoomContractsRelationRestriction;
...
/**
 * RoomContractsRequestData
 */
@JsonPropertyOrder({
  RoomContractsRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  RoomContractsRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  RoomContractsRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  RoomContractsRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-01-31T11:10:37.320689708Z[Etc/UTC]")
public class RoomContractsRequestData {
  ...
  private RoomContractsEntityRestriction entityRestrictions;

  public static final String JSON_PROPERTY_RELATION_RESTRICTIONS = "relationRestrictions";
  private RoomContractsRelationRestriction relationRestrictions;
  ...
  public RoomContractsRequestData() {
  }

  public RoomContractsRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public RoomContractsRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public RoomContractsRequestData entityRestrictions(RoomContractsEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public RoomContractsEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(RoomContractsEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public RoomContractsRequestData relationRestrictions(RoomContractsRelationRestriction relationRestrictions) {
  ...
  **/
  ...
  public RoomContractsRelationRestriction getRelationRestrictions() {
    return relationRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_RELATION_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRelationRestrictions(RoomContractsRelationRestriction relationRestrictions) {
    this.relationRestrictions = relationRestrictions;
  }


  public RoomContractsRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public RoomContractsRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    RoomContractsRequestData roomContractsRequestData = (RoomContractsRequestData) o;
    return Objects.equals(this.returnEntityAttributes, roomContractsRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, roomContractsRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, roomContractsRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, roomContractsRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class RoomContractsRequestData {\n");
