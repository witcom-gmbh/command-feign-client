...
/**
 * MultiDuctFromDeviceAllEntityRestriction
 */
@JsonPropertyOrder({
  MultiDuctFromDeviceAllEntityRestriction.JSON_PROPERTY_CLIMATE_RELEVANT,
  MultiDuctFromDeviceAllEntityRestriction.JSON_PROPERTY_POWER_CONSUMPTION,
  MultiDuctFromDeviceAllEntityRestriction.JSON_PROPERTY_POWER_SWITCHING_STATUS,
  MultiDuctFromDeviceAllEntityRestriction.JSON_PROPERTY_PLAN_STATUS,
  MultiDuctFromDeviceAllEntityRestriction.JSON_PROPERTY_SYSTEM_RUNTIME,
  MultiDuctFromDeviceAllEntityRestriction.JSON_PROPERTY_WEIGHT,
  MultiDuctFromDeviceAllEntityRestriction.JSON_PROPERTY_REMARK,
  MultiDuctFromDeviceAllEntityRestriction.JSON_PROPERTY_ELID,
  MultiDuctFromDeviceAllEntityRestriction.JSON_PROPERTY_LAST_SEEN,
  MultiDuctFromDeviceAllEntityRestriction.JSON_PROPERTY_TYPE_ELID,
  MultiDuctFromDeviceAllEntityRestriction.JSON_PROPERTY_VISIBLE_ID,
  MultiDuctFromDeviceAllEntityRestriction.JSON_PROPERTY_ID,
  MultiDuctFromDeviceAllEntityRestriction.JSON_PROPERTY_HEAT_EMISSION
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-01-31T11:10:37.320689708Z[Etc/UTC]")
public class MultiDuctFromDeviceAllEntityRestriction {
  ...
  public MultiDuctFromDeviceAllEntityRestriction() {
  }

  public MultiDuctFromDeviceAllEntityRestriction climateRelevant(RestrictionsBoolean climateRelevant) {
  ...
  **/
  ...
  public MultiDuctFromDeviceAllEntityRestriction powerConsumption(RestrictionsNumeric powerConsumption) {
  ...
  **/
  ...
  public MultiDuctFromDeviceAllEntityRestriction powerSwitchingStatus(RestrictionsString powerSwitchingStatus) {
  ...
  **/
  ...
  public MultiDuctFromDeviceAllEntityRestriction planStatus(RestrictionsString planStatus) {
  ...
  **/
  ...
  public MultiDuctFromDeviceAllEntityRestriction systemRuntime(RestrictionsNumeric systemRuntime) {
  ...
  **/
  ...
  public MultiDuctFromDeviceAllEntityRestriction weight(RestrictionsNumeric weight) {
  ...
  **/
  ...
  public MultiDuctFromDeviceAllEntityRestriction remark(RestrictionsString remark) {
  ...
  **/
  ...
  public MultiDuctFromDeviceAllEntityRestriction elid(RestrictionsString elid) {
  ...
  **/
  ...
  public MultiDuctFromDeviceAllEntityRestriction lastSeen(RestrictionsDate lastSeen) {
  ...
  **/
  ...
  public MultiDuctFromDeviceAllEntityRestriction typeElid(RestrictionsString typeElid) {
  ...
  **/
  ...
  public MultiDuctFromDeviceAllEntityRestriction visibleId(RestrictionsString visibleId) {
  ...
  **/
  ...
  public MultiDuctFromDeviceAllEntityRestriction id(RestrictionsString id) {
  ...
  **/
  ...
  public MultiDuctFromDeviceAllEntityRestriction heatEmission(RestrictionsNumeric heatEmission) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    MultiDuctFromDeviceAllEntityRestriction multiDuctFromDeviceAllEntityRestriction = (MultiDuctFromDeviceAllEntityRestriction) o;
    return Objects.equals(this.climateRelevant, multiDuctFromDeviceAllEntityRestriction.climateRelevant) &&
        Objects.equals(this.powerConsumption, multiDuctFromDeviceAllEntityRestriction.powerConsumption) &&
        Objects.equals(this.powerSwitchingStatus, multiDuctFromDeviceAllEntityRestriction.powerSwitchingStatus) &&
        Objects.equals(this.planStatus, multiDuctFromDeviceAllEntityRestriction.planStatus) &&
        Objects.equals(this.systemRuntime, multiDuctFromDeviceAllEntityRestriction.systemRuntime) &&
        Objects.equals(this.weight, multiDuctFromDeviceAllEntityRestriction.weight) &&
        Objects.equals(this.remark, multiDuctFromDeviceAllEntityRestriction.remark) &&
        Objects.equals(this.elid, multiDuctFromDeviceAllEntityRestriction.elid) &&
        Objects.equals(this.lastSeen, multiDuctFromDeviceAllEntityRestriction.lastSeen) &&
        Objects.equals(this.typeElid, multiDuctFromDeviceAllEntityRestriction.typeElid) &&
        Objects.equals(this.visibleId, multiDuctFromDeviceAllEntityRestriction.visibleId) &&
        Objects.equals(this.id, multiDuctFromDeviceAllEntityRestriction.id) &&
        Objects.equals(this.heatEmission, multiDuctFromDeviceAllEntityRestriction.heatEmission);
  }
  ...
  public String toString() {
    ...
    sb.append("class MultiDuctFromDeviceAllEntityRestriction {\n");
