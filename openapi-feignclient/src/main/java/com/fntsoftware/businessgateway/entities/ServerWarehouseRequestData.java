...
import com.fntsoftware.businessgateway.entities.ServerWarehouseEntityRestriction;
...
/**
 * ServerWarehouseRequestData
 */
@JsonPropertyOrder({
  ServerWarehouseRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  ServerWarehouseRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  ServerWarehouseRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  ServerWarehouseRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-02-26T11:20:24.990023935Z[Etc/UTC]")
public class ServerWarehouseRequestData {
  ...
  private ServerWarehouseEntityRestriction entityRestrictions;
  ...
  public ServerWarehouseRequestData() {
  }

  public ServerWarehouseRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public ServerWarehouseRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public ServerWarehouseRequestData entityRestrictions(ServerWarehouseEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public ServerWarehouseEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(ServerWarehouseEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public ServerWarehouseRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public ServerWarehouseRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public ServerWarehouseRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ServerWarehouseRequestData serverWarehouseRequestData = (ServerWarehouseRequestData) o;
    return Objects.equals(this.returnEntityAttributes, serverWarehouseRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, serverWarehouseRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, serverWarehouseRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, serverWarehouseRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class ServerWarehouseRequestData {\n");
