...
import com.fntsoftware.businessgateway.entities.ServiceTelcoTrailSuccessorsEntityRestriction;
...
/**
 * ServiceTelcoTrailSuccessorsRequestData
 */
@JsonPropertyOrder({
  ServiceTelcoTrailSuccessorsRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  ServiceTelcoTrailSuccessorsRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  ServiceTelcoTrailSuccessorsRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  ServiceTelcoTrailSuccessorsRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-01-31T11:10:37.320689708Z[Etc/UTC]")
public class ServiceTelcoTrailSuccessorsRequestData {
  ...
  private ServiceTelcoTrailSuccessorsEntityRestriction entityRestrictions;
  ...
  public ServiceTelcoTrailSuccessorsRequestData() {
  }

  public ServiceTelcoTrailSuccessorsRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public ServiceTelcoTrailSuccessorsRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public ServiceTelcoTrailSuccessorsRequestData entityRestrictions(ServiceTelcoTrailSuccessorsEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public ServiceTelcoTrailSuccessorsEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(ServiceTelcoTrailSuccessorsEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public ServiceTelcoTrailSuccessorsRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public ServiceTelcoTrailSuccessorsRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public ServiceTelcoTrailSuccessorsRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ServiceTelcoTrailSuccessorsRequestData serviceTelcoTrailSuccessorsRequestData = (ServiceTelcoTrailSuccessorsRequestData) o;
    return Objects.equals(this.returnEntityAttributes, serviceTelcoTrailSuccessorsRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, serviceTelcoTrailSuccessorsRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, serviceTelcoTrailSuccessorsRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, serviceTelcoTrailSuccessorsRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class ServiceTelcoTrailSuccessorsRequestData {\n");
