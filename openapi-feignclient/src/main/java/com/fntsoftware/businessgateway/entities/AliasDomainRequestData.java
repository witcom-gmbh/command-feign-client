...
import com.fntsoftware.businessgateway.entities.AliasDomainEntityRestriction;
...
/**
 * AliasDomainRequestData
 */
@JsonPropertyOrder({
  AliasDomainRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  AliasDomainRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  AliasDomainRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  AliasDomainRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-03-04T13:31:32.601557352Z[Etc/UTC]")
public class AliasDomainRequestData {
  ...
  private AliasDomainEntityRestriction entityRestrictions;
  ...
  public AliasDomainRequestData() {
  }

  public AliasDomainRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public AliasDomainRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public AliasDomainRequestData entityRestrictions(AliasDomainEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public AliasDomainEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(AliasDomainEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public AliasDomainRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public AliasDomainRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public AliasDomainRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    AliasDomainRequestData aliasDomainRequestData = (AliasDomainRequestData) o;
    return Objects.equals(this.returnEntityAttributes, aliasDomainRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, aliasDomainRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, aliasDomainRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, aliasDomainRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class AliasDomainRequestData {\n");
