...
import com.fntsoftware.businessgateway.entities.DeviceMasterNmModulesEntityRestriction;
...
/**
 * DeviceMasterNmModulesRequestData
 */
@JsonPropertyOrder({
  DeviceMasterNmModulesRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  DeviceMasterNmModulesRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  DeviceMasterNmModulesRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  DeviceMasterNmModulesRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-02-26T11:20:24.990023935Z[Etc/UTC]")
public class DeviceMasterNmModulesRequestData {
  ...
  private DeviceMasterNmModulesEntityRestriction entityRestrictions;
  ...
  public DeviceMasterNmModulesRequestData() {
  }

  public DeviceMasterNmModulesRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public DeviceMasterNmModulesRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public DeviceMasterNmModulesRequestData entityRestrictions(DeviceMasterNmModulesEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public DeviceMasterNmModulesEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(DeviceMasterNmModulesEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public DeviceMasterNmModulesRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public DeviceMasterNmModulesRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public DeviceMasterNmModulesRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    DeviceMasterNmModulesRequestData deviceMasterNmModulesRequestData = (DeviceMasterNmModulesRequestData) o;
    return Objects.equals(this.returnEntityAttributes, deviceMasterNmModulesRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, deviceMasterNmModulesRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, deviceMasterNmModulesRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, deviceMasterNmModulesRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeviceMasterNmModulesRequestData {\n");
