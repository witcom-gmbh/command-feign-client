...
import com.fntsoftware.businessgateway.entities.PersonServersEntityRestriction;
import com.fntsoftware.businessgateway.entities.PersonServersRelationRestriction;
...
/**
 * PersonServersRequestData
 */
@JsonPropertyOrder({
  PersonServersRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  PersonServersRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  PersonServersRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  PersonServersRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-01-31T11:10:37.320689708Z[Etc/UTC]")
public class PersonServersRequestData {
  ...
  private PersonServersEntityRestriction entityRestrictions;

  public static final String JSON_PROPERTY_RELATION_RESTRICTIONS = "relationRestrictions";
  private PersonServersRelationRestriction relationRestrictions;
  ...
  public PersonServersRequestData() {
  }

  public PersonServersRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public PersonServersRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public PersonServersRequestData entityRestrictions(PersonServersEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public PersonServersEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(PersonServersEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public PersonServersRequestData relationRestrictions(PersonServersRelationRestriction relationRestrictions) {
  ...
  **/
  ...
  public PersonServersRelationRestriction getRelationRestrictions() {
    return relationRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_RELATION_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRelationRestrictions(PersonServersRelationRestriction relationRestrictions) {
    this.relationRestrictions = relationRestrictions;
  }


  public PersonServersRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public PersonServersRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    PersonServersRequestData personServersRequestData = (PersonServersRequestData) o;
    return Objects.equals(this.returnEntityAttributes, personServersRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, personServersRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, personServersRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, personServersRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class PersonServersRequestData {\n");
