...
import com.fntsoftware.businessgateway.entities.CreateNodeResponseData;
 ...
 */
@JsonPropertyOrder({
  CreateNodeResponse.JSON_PROPERTY_RETURN_DATA,
  CreateNodeResponse.JSON_PROPERTY_STATUS
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-01-31T11:10:37.320689708Z[Etc/UTC]")
public class CreateNodeResponse {
  public static final String JSON_PROPERTY_RETURN_DATA = "returnData";
  private CreateNodeResponseData returnData;
  ...
  public CreateNodeResponse returnData(CreateNodeResponseData returnData) {
  ...
  **/
  ...
  public CreateNodeResponseData getReturnData() {
    return returnData;
  }
  ...
  @JsonProperty(JSON_PROPERTY_RETURN_DATA)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setReturnData(CreateNodeResponseData returnData) {
    this.returnData = returnData;
  }


  public CreateNodeResponse status(ServiceStatusData status) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.returnData, createNodeResponse.returnData) &&
