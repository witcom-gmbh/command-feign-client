...
import com.fntsoftware.businessgateway.entities.AntennaPersonsEntityRestriction;
import com.fntsoftware.businessgateway.entities.AntennaPersonsRelationRestriction;
...
/**
 * AntennaPersonsRequestData
 */
@JsonPropertyOrder({
  AntennaPersonsRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  AntennaPersonsRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  AntennaPersonsRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  AntennaPersonsRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-02-26T11:20:24.990023935Z[Etc/UTC]")
public class AntennaPersonsRequestData {
  ...
  private AntennaPersonsEntityRestriction entityRestrictions;

  public static final String JSON_PROPERTY_RELATION_RESTRICTIONS = "relationRestrictions";
  private AntennaPersonsRelationRestriction relationRestrictions;
  ...
  public AntennaPersonsRequestData() {
  }

  public AntennaPersonsRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public AntennaPersonsRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public AntennaPersonsRequestData entityRestrictions(AntennaPersonsEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public AntennaPersonsEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(AntennaPersonsEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public AntennaPersonsRequestData relationRestrictions(AntennaPersonsRelationRestriction relationRestrictions) {
  ...
  **/
  ...
  public AntennaPersonsRelationRestriction getRelationRestrictions() {
    return relationRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_RELATION_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRelationRestrictions(AntennaPersonsRelationRestriction relationRestrictions) {
    this.relationRestrictions = relationRestrictions;
  }


  public AntennaPersonsRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public AntennaPersonsRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    AntennaPersonsRequestData antennaPersonsRequestData = (AntennaPersonsRequestData) o;
    return Objects.equals(this.returnEntityAttributes, antennaPersonsRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, antennaPersonsRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, antennaPersonsRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, antennaPersonsRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class AntennaPersonsRequestData {\n");
