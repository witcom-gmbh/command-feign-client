...
import com.fntsoftware.businessgateway.entities.SVlanVlanGroupsEntityRestriction;
import com.fntsoftware.businessgateway.entities.SVlanVlanGroupsRelationRestriction;
...
/**
 * SVlanVlanGroupsRequestData
 */
@JsonPropertyOrder({
  SVlanVlanGroupsRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  SVlanVlanGroupsRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  SVlanVlanGroupsRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  SVlanVlanGroupsRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-02-26T11:20:24.990023935Z[Etc/UTC]")
public class SVlanVlanGroupsRequestData {
  ...
  private SVlanVlanGroupsEntityRestriction entityRestrictions;

  public static final String JSON_PROPERTY_RELATION_RESTRICTIONS = "relationRestrictions";
  private SVlanVlanGroupsRelationRestriction relationRestrictions;
  ...
  public SVlanVlanGroupsRequestData() {
  }

  public SVlanVlanGroupsRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public SVlanVlanGroupsRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public SVlanVlanGroupsRequestData entityRestrictions(SVlanVlanGroupsEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public SVlanVlanGroupsEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(SVlanVlanGroupsEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public SVlanVlanGroupsRequestData relationRestrictions(SVlanVlanGroupsRelationRestriction relationRestrictions) {
  ...
  **/
  ...
  public SVlanVlanGroupsRelationRestriction getRelationRestrictions() {
    return relationRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_RELATION_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRelationRestrictions(SVlanVlanGroupsRelationRestriction relationRestrictions) {
    this.relationRestrictions = relationRestrictions;
  }


  public SVlanVlanGroupsRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public SVlanVlanGroupsRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    SVlanVlanGroupsRequestData svlanVlanGroupsRequestData = (SVlanVlanGroupsRequestData) o;
    return Objects.equals(this.returnEntityAttributes, svlanVlanGroupsRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, svlanVlanGroupsRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, svlanVlanGroupsRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, svlanVlanGroupsRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class SVlanVlanGroupsRequestData {\n");
