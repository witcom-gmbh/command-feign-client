...
import com.fntsoftware.businessgateway.entities.DuctToNodeEntityRestriction;
import com.fntsoftware.businessgateway.entities.DuctToNodeRelationRestriction;
...
/**
 * DuctToNodeRequestData
 */
@JsonPropertyOrder({
  DuctToNodeRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  DuctToNodeRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  DuctToNodeRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  DuctToNodeRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-01-31T11:10:37.320689708Z[Etc/UTC]")
public class DuctToNodeRequestData {
  ...
  private DuctToNodeEntityRestriction entityRestrictions;

  public static final String JSON_PROPERTY_RELATION_RESTRICTIONS = "relationRestrictions";
  private DuctToNodeRelationRestriction relationRestrictions;
  ...
  public DuctToNodeRequestData() {
  }

  public DuctToNodeRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public DuctToNodeRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public DuctToNodeRequestData entityRestrictions(DuctToNodeEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public DuctToNodeEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(DuctToNodeEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public DuctToNodeRequestData relationRestrictions(DuctToNodeRelationRestriction relationRestrictions) {
  ...
  **/
  ...
  public DuctToNodeRelationRestriction getRelationRestrictions() {
    return relationRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_RELATION_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRelationRestrictions(DuctToNodeRelationRestriction relationRestrictions) {
    this.relationRestrictions = relationRestrictions;
  }


  public DuctToNodeRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public DuctToNodeRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    DuctToNodeRequestData ductToNodeRequestData = (DuctToNodeRequestData) o;
    return Objects.equals(this.returnEntityAttributes, ductToNodeRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, ductToNodeRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, ductToNodeRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, ductToNodeRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class DuctToNodeRequestData {\n");
