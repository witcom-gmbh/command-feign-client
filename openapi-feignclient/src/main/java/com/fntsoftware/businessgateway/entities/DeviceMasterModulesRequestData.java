...
import com.fntsoftware.businessgateway.entities.DeviceMasterModulesEntityRestriction;
...
/**
 * DeviceMasterModulesRequestData
 */
@JsonPropertyOrder({
  DeviceMasterModulesRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  DeviceMasterModulesRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  DeviceMasterModulesRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  DeviceMasterModulesRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-02-26T11:20:24.990023935Z[Etc/UTC]")
public class DeviceMasterModulesRequestData {
  ...
  private DeviceMasterModulesEntityRestriction entityRestrictions;
  ...
  public DeviceMasterModulesRequestData() {
  }

  public DeviceMasterModulesRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public DeviceMasterModulesRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public DeviceMasterModulesRequestData entityRestrictions(DeviceMasterModulesEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public DeviceMasterModulesEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(DeviceMasterModulesEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public DeviceMasterModulesRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public DeviceMasterModulesRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public DeviceMasterModulesRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    DeviceMasterModulesRequestData deviceMasterModulesRequestData = (DeviceMasterModulesRequestData) o;
    return Objects.equals(this.returnEntityAttributes, deviceMasterModulesRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, deviceMasterModulesRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, deviceMasterModulesRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, deviceMasterModulesRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeviceMasterModulesRequestData {\n");
