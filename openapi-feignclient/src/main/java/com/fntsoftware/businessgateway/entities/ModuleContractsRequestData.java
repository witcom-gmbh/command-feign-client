...
import com.fntsoftware.businessgateway.entities.ModuleContractsEntityRestriction;
import com.fntsoftware.businessgateway.entities.ModuleContractsRelationRestriction;
...
/**
 * ModuleContractsRequestData
 */
@JsonPropertyOrder({
  ModuleContractsRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  ModuleContractsRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  ModuleContractsRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  ModuleContractsRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-02-26T11:20:24.990023935Z[Etc/UTC]")
public class ModuleContractsRequestData {
  ...
  private ModuleContractsEntityRestriction entityRestrictions;

  public static final String JSON_PROPERTY_RELATION_RESTRICTIONS = "relationRestrictions";
  private ModuleContractsRelationRestriction relationRestrictions;
  ...
  public ModuleContractsRequestData() {
  }

  public ModuleContractsRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public ModuleContractsRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public ModuleContractsRequestData entityRestrictions(ModuleContractsEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public ModuleContractsEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(ModuleContractsEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public ModuleContractsRequestData relationRestrictions(ModuleContractsRelationRestriction relationRestrictions) {
  ...
  **/
  ...
  public ModuleContractsRelationRestriction getRelationRestrictions() {
    return relationRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_RELATION_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRelationRestrictions(ModuleContractsRelationRestriction relationRestrictions) {
    this.relationRestrictions = relationRestrictions;
  }


  public ModuleContractsRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public ModuleContractsRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ModuleContractsRequestData moduleContractsRequestData = (ModuleContractsRequestData) o;
    return Objects.equals(this.returnEntityAttributes, moduleContractsRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, moduleContractsRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, moduleContractsRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, moduleContractsRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class ModuleContractsRequestData {\n");
