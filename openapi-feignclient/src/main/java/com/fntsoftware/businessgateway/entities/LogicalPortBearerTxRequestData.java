...
import com.fntsoftware.businessgateway.entities.LogicalPortBearerTxEntityRestriction;
...
/**
 * LogicalPortBearerTxRequestData
 */
@JsonPropertyOrder({
  LogicalPortBearerTxRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  LogicalPortBearerTxRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  LogicalPortBearerTxRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  LogicalPortBearerTxRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-02-26T11:20:24.990023935Z[Etc/UTC]")
public class LogicalPortBearerTxRequestData {
  ...
  private LogicalPortBearerTxEntityRestriction entityRestrictions;
  ...
  public LogicalPortBearerTxRequestData() {
  }

  public LogicalPortBearerTxRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public LogicalPortBearerTxRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public LogicalPortBearerTxRequestData entityRestrictions(LogicalPortBearerTxEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public LogicalPortBearerTxEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(LogicalPortBearerTxEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public LogicalPortBearerTxRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public LogicalPortBearerTxRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public LogicalPortBearerTxRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    LogicalPortBearerTxRequestData logicalPortBearerTxRequestData = (LogicalPortBearerTxRequestData) o;
    return Objects.equals(this.returnEntityAttributes, logicalPortBearerTxRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, logicalPortBearerTxRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, logicalPortBearerTxRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, logicalPortBearerTxRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class LogicalPortBearerTxRequestData {\n");
