...
import com.fntsoftware.businessgateway.entities.ServiceTelcoTrailStartZoneEntityRestriction;
...
/**
 * ServiceTelcoTrailStartZoneRequestData
 */
@JsonPropertyOrder({
  ServiceTelcoTrailStartZoneRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  ServiceTelcoTrailStartZoneRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  ServiceTelcoTrailStartZoneRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  ServiceTelcoTrailStartZoneRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-03-04T13:31:32.601557352Z[Etc/UTC]")
public class ServiceTelcoTrailStartZoneRequestData {
  ...
  private ServiceTelcoTrailStartZoneEntityRestriction entityRestrictions;
  ...
  public ServiceTelcoTrailStartZoneRequestData() {
  }

  public ServiceTelcoTrailStartZoneRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public ServiceTelcoTrailStartZoneRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public ServiceTelcoTrailStartZoneRequestData entityRestrictions(ServiceTelcoTrailStartZoneEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public ServiceTelcoTrailStartZoneEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(ServiceTelcoTrailStartZoneEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public ServiceTelcoTrailStartZoneRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public ServiceTelcoTrailStartZoneRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public ServiceTelcoTrailStartZoneRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ServiceTelcoTrailStartZoneRequestData serviceTelcoTrailStartZoneRequestData = (ServiceTelcoTrailStartZoneRequestData) o;
    return Objects.equals(this.returnEntityAttributes, serviceTelcoTrailStartZoneRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, serviceTelcoTrailStartZoneRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, serviceTelcoTrailStartZoneRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, serviceTelcoTrailStartZoneRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class ServiceTelcoTrailStartZoneRequestData {\n");
