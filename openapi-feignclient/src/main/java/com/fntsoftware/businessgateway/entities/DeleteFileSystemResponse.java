 ...
 */
@JsonPropertyOrder({
  DeleteFileSystemResponse.JSON_PROPERTY_STATUS
})
...
public class DeleteFileSystemResponse {
  ...
  public DeleteFileSystemResponse status(ServiceStatusData status) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.status, deleteFileSystemResponse.status);
  }
