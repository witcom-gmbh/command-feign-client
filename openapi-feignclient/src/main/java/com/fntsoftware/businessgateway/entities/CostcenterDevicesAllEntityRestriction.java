...
/**
 * CostcenterDevicesAllEntityRestriction
 */
@JsonPropertyOrder({
  CostcenterDevicesAllEntityRestriction.JSON_PROPERTY_CLIMATE_RELEVANT,
  CostcenterDevicesAllEntityRestriction.JSON_PROPERTY_LAST_SEEN,
  CostcenterDevicesAllEntityRestriction.JSON_PROPERTY_POWER_CONSUMPTION,
  CostcenterDevicesAllEntityRestriction.JSON_PROPERTY_POWER_SWITCHING_STATUS,
  CostcenterDevicesAllEntityRestriction.JSON_PROPERTY_TYPE_ELID,
  CostcenterDevicesAllEntityRestriction.JSON_PROPERTY_SYSTEM_RUNTIME,
  CostcenterDevicesAllEntityRestriction.JSON_PROPERTY_WEIGHT,
  CostcenterDevicesAllEntityRestriction.JSON_PROPERTY_REMARK,
  CostcenterDevicesAllEntityRestriction.JSON_PROPERTY_VISIBLE_ID,
  CostcenterDevicesAllEntityRestriction.JSON_PROPERTY_ID,
  CostcenterDevicesAllEntityRestriction.JSON_PROPERTY_HEAT_EMISSION,
  CostcenterDevicesAllEntityRestriction.JSON_PROPERTY_ELID
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-02-26T11:20:24.990023935Z[Etc/UTC]")
public class CostcenterDevicesAllEntityRestriction {
  ...
  public CostcenterDevicesAllEntityRestriction() {
  }

  public CostcenterDevicesAllEntityRestriction climateRelevant(RestrictionsBoolean climateRelevant) {
  ...
  **/
  ...
  public CostcenterDevicesAllEntityRestriction lastSeen(RestrictionsDate lastSeen) {
  ...
  **/
  ...
  public CostcenterDevicesAllEntityRestriction powerConsumption(RestrictionsNumeric powerConsumption) {
  ...
  **/
  ...
  public CostcenterDevicesAllEntityRestriction powerSwitchingStatus(RestrictionsString powerSwitchingStatus) {
  ...
  **/
  ...
  public CostcenterDevicesAllEntityRestriction typeElid(RestrictionsString typeElid) {
  ...
  **/
  ...
  public CostcenterDevicesAllEntityRestriction systemRuntime(RestrictionsNumeric systemRuntime) {
  ...
  **/
  ...
  public CostcenterDevicesAllEntityRestriction weight(RestrictionsNumeric weight) {
  ...
  **/
  ...
  public CostcenterDevicesAllEntityRestriction remark(RestrictionsString remark) {
  ...
  **/
  ...
  public CostcenterDevicesAllEntityRestriction visibleId(RestrictionsString visibleId) {
  ...
  **/
  ...
  public CostcenterDevicesAllEntityRestriction id(RestrictionsString id) {
  ...
  **/
  ...
  public CostcenterDevicesAllEntityRestriction heatEmission(RestrictionsNumeric heatEmission) {
  ...
  **/
  ...
  public CostcenterDevicesAllEntityRestriction elid(RestrictionsString elid) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    CostcenterDevicesAllEntityRestriction costcenterDevicesAllEntityRestriction = (CostcenterDevicesAllEntityRestriction) o;
    return Objects.equals(this.climateRelevant, costcenterDevicesAllEntityRestriction.climateRelevant) &&
        Objects.equals(this.lastSeen, costcenterDevicesAllEntityRestriction.lastSeen) &&
        Objects.equals(this.powerConsumption, costcenterDevicesAllEntityRestriction.powerConsumption) &&
        Objects.equals(this.powerSwitchingStatus, costcenterDevicesAllEntityRestriction.powerSwitchingStatus) &&
        Objects.equals(this.typeElid, costcenterDevicesAllEntityRestriction.typeElid) &&
        Objects.equals(this.systemRuntime, costcenterDevicesAllEntityRestriction.systemRuntime) &&
        Objects.equals(this.weight, costcenterDevicesAllEntityRestriction.weight) &&
        Objects.equals(this.remark, costcenterDevicesAllEntityRestriction.remark) &&
        Objects.equals(this.visibleId, costcenterDevicesAllEntityRestriction.visibleId) &&
        Objects.equals(this.id, costcenterDevicesAllEntityRestriction.id) &&
        Objects.equals(this.heatEmission, costcenterDevicesAllEntityRestriction.heatEmission) &&
        Objects.equals(this.elid, costcenterDevicesAllEntityRestriction.elid);
  }
  ...
  public String toString() {
    ...
    sb.append("class CostcenterDevicesAllEntityRestriction {\n");
