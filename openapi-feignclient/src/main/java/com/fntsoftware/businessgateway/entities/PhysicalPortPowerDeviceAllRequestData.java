...
import com.fntsoftware.businessgateway.entities.PhysicalPortPowerDeviceAllEntityRestriction;
...
/**
 * PhysicalPortPowerDeviceAllRequestData
 */
@JsonPropertyOrder({
  PhysicalPortPowerDeviceAllRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  PhysicalPortPowerDeviceAllRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  PhysicalPortPowerDeviceAllRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  PhysicalPortPowerDeviceAllRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-01-31T11:10:37.320689708Z[Etc/UTC]")
public class PhysicalPortPowerDeviceAllRequestData {
  ...
  private PhysicalPortPowerDeviceAllEntityRestriction entityRestrictions;
  ...
  public PhysicalPortPowerDeviceAllRequestData() {
  }

  public PhysicalPortPowerDeviceAllRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public PhysicalPortPowerDeviceAllRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public PhysicalPortPowerDeviceAllRequestData entityRestrictions(PhysicalPortPowerDeviceAllEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public PhysicalPortPowerDeviceAllEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(PhysicalPortPowerDeviceAllEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public PhysicalPortPowerDeviceAllRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public PhysicalPortPowerDeviceAllRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public PhysicalPortPowerDeviceAllRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    PhysicalPortPowerDeviceAllRequestData physicalPortPowerDeviceAllRequestData = (PhysicalPortPowerDeviceAllRequestData) o;
    return Objects.equals(this.returnEntityAttributes, physicalPortPowerDeviceAllRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, physicalPortPowerDeviceAllRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, physicalPortPowerDeviceAllRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, physicalPortPowerDeviceAllRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class PhysicalPortPowerDeviceAllRequestData {\n");
