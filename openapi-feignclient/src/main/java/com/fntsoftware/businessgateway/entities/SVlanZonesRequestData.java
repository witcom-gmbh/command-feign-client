...
import com.fntsoftware.businessgateway.entities.SVlanZonesEntityRestriction;
import com.fntsoftware.businessgateway.entities.SVlanZonesRelationRestriction;
...
/**
 * SVlanZonesRequestData
 */
@JsonPropertyOrder({
  SVlanZonesRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  SVlanZonesRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  SVlanZonesRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  SVlanZonesRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-01-31T11:10:37.320689708Z[Etc/UTC]")
public class SVlanZonesRequestData {
  ...
  private SVlanZonesEntityRestriction entityRestrictions;

  public static final String JSON_PROPERTY_RELATION_RESTRICTIONS = "relationRestrictions";
  private SVlanZonesRelationRestriction relationRestrictions;
  ...
  public SVlanZonesRequestData() {
  }

  public SVlanZonesRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public SVlanZonesRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public SVlanZonesRequestData entityRestrictions(SVlanZonesEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public SVlanZonesEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(SVlanZonesEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public SVlanZonesRequestData relationRestrictions(SVlanZonesRelationRestriction relationRestrictions) {
  ...
  **/
  ...
  public SVlanZonesRelationRestriction getRelationRestrictions() {
    return relationRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_RELATION_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRelationRestrictions(SVlanZonesRelationRestriction relationRestrictions) {
    this.relationRestrictions = relationRestrictions;
  }


  public SVlanZonesRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public SVlanZonesRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    SVlanZonesRequestData svlanZonesRequestData = (SVlanZonesRequestData) o;
    return Objects.equals(this.returnEntityAttributes, svlanZonesRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, svlanZonesRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, svlanZonesRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, svlanZonesRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class SVlanZonesRequestData {\n");
