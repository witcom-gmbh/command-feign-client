...
import com.fntsoftware.businessgateway.entities.DuctBundleDuctsEntityRestriction;
import com.fntsoftware.businessgateway.entities.DuctBundleDuctsRelationRestriction;
...
/**
 * DuctBundleDuctsRequestData
 */
@JsonPropertyOrder({
  DuctBundleDuctsRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  DuctBundleDuctsRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  DuctBundleDuctsRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  DuctBundleDuctsRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-02-26T11:20:24.990023935Z[Etc/UTC]")
public class DuctBundleDuctsRequestData {
  ...
  private DuctBundleDuctsEntityRestriction entityRestrictions;

  public static final String JSON_PROPERTY_RELATION_RESTRICTIONS = "relationRestrictions";
  private DuctBundleDuctsRelationRestriction relationRestrictions;
  ...
  public DuctBundleDuctsRequestData() {
  }

  public DuctBundleDuctsRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public DuctBundleDuctsRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public DuctBundleDuctsRequestData entityRestrictions(DuctBundleDuctsEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public DuctBundleDuctsEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(DuctBundleDuctsEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public DuctBundleDuctsRequestData relationRestrictions(DuctBundleDuctsRelationRestriction relationRestrictions) {
  ...
  **/
  ...
  public DuctBundleDuctsRelationRestriction getRelationRestrictions() {
    return relationRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_RELATION_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRelationRestrictions(DuctBundleDuctsRelationRestriction relationRestrictions) {
    this.relationRestrictions = relationRestrictions;
  }


  public DuctBundleDuctsRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public DuctBundleDuctsRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    DuctBundleDuctsRequestData ductBundleDuctsRequestData = (DuctBundleDuctsRequestData) o;
    return Objects.equals(this.returnEntityAttributes, ductBundleDuctsRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, ductBundleDuctsRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, ductBundleDuctsRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, ductBundleDuctsRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class DuctBundleDuctsRequestData {\n");
