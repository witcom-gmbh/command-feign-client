...
import com.fntsoftware.businessgateway.entities.MoveToZoneStorageBaseCreateLinkZoneRequestData;
import com.fasterxml.jackson.annotation.JsonPropertyOrder;
import com.fasterxml.jackson.annotation.JsonTypeName;

/**
 * MoveToZoneStorageBaseRequestData
 */
@JsonPropertyOrder({
  MoveToZoneStorageBaseRequestData.JSON_PROPERTY_RELEASE_CONNECTIONS,
  MoveToZoneStorageBaseRequestData.JSON_PROPERTY_RELEASE_TRM_ROUTE,
  MoveToZoneStorageBaseRequestData.JSON_PROPERTY_RELEASE_SUPPORTS,
  MoveToZoneStorageBaseRequestData.JSON_PROPERTY_RELEASE_PATCHES,
  MoveToZoneStorageBaseRequestData.JSON_PROPERTY_CREATE_LINK_ZONE
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-03-04T13:31:32.601557352Z[Etc/UTC]")
public class MoveToZoneStorageBaseRequestData {
  ...
  private MoveToZoneStorageBaseCreateLinkZoneRequestData createLinkZone;

  public MoveToZoneStorageBaseRequestData() {
  }

  public MoveToZoneStorageBaseRequestData releaseConnections(Boolean releaseConnections) {
  ...
  **/
  ...
  public MoveToZoneStorageBaseRequestData releaseTrmRoute(Boolean releaseTrmRoute) {
  ...
  **/
  ...
  public MoveToZoneStorageBaseRequestData releaseSupports(Boolean releaseSupports) {
  ...
  **/
  ...
  public MoveToZoneStorageBaseRequestData releasePatches(Boolean releasePatches) {
  ...
  **/
  ...
  public MoveToZoneStorageBaseRequestData createLinkZone(MoveToZoneStorageBaseCreateLinkZoneRequestData createLinkZone) {
  ...
  **/
  ...
  public MoveToZoneStorageBaseCreateLinkZoneRequestData getCreateLinkZone() {
    return createLinkZone;
  }
  ...
  @JsonProperty(JSON_PROPERTY_CREATE_LINK_ZONE)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setCreateLinkZone(MoveToZoneStorageBaseCreateLinkZoneRequestData createLinkZone) {
    this.createLinkZone = createLinkZone;
  }
  ...
  public boolean equals(Object o) {
    ...
    MoveToZoneStorageBaseRequestData moveToZoneStorageBaseRequestData = (MoveToZoneStorageBaseRequestData) o;
    return Objects.equals(this.releaseConnections, moveToZoneStorageBaseRequestData.releaseConnections) &&
        Objects.equals(this.releaseTrmRoute, moveToZoneStorageBaseRequestData.releaseTrmRoute) &&
        Objects.equals(this.releaseSupports, moveToZoneStorageBaseRequestData.releaseSupports) &&
        Objects.equals(this.releasePatches, moveToZoneStorageBaseRequestData.releasePatches) &&
        Objects.equals(this.createLinkZone, moveToZoneStorageBaseRequestData.createLinkZone);
  }
  ...
  public String toString() {
    ...
    sb.append("class MoveToZoneStorageBaseRequestData {\n");
