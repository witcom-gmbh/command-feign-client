...
import com.fntsoftware.businessgateway.entities.CreateSiteResponseData;
 ...
 */
@JsonPropertyOrder({
  CreateSiteResponse.JSON_PROPERTY_RETURN_DATA,
  CreateSiteResponse.JSON_PROPERTY_STATUS
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-03-04T13:31:32.601557352Z[Etc/UTC]")
public class CreateSiteResponse {
  public static final String JSON_PROPERTY_RETURN_DATA = "returnData";
  private CreateSiteResponseData returnData;
  ...
  public CreateSiteResponse returnData(CreateSiteResponseData returnData) {
  ...
  **/
  ...
  public CreateSiteResponseData getReturnData() {
    return returnData;
  }
  ...
  @JsonProperty(JSON_PROPERTY_RETURN_DATA)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setReturnData(CreateSiteResponseData returnData) {
    this.returnData = returnData;
  }


  public CreateSiteResponse status(ServiceStatusData status) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.returnData, createSiteResponse.returnData) &&
