...
import com.fntsoftware.businessgateway.entities.CabinetSuppliesWarehouseEntityRestriction;
...
/**
 * CabinetSuppliesWarehouseRequestData
 */
@JsonPropertyOrder({
  CabinetSuppliesWarehouseRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  CabinetSuppliesWarehouseRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  CabinetSuppliesWarehouseRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  CabinetSuppliesWarehouseRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-01-31T11:10:37.320689708Z[Etc/UTC]")
public class CabinetSuppliesWarehouseRequestData {
  ...
  private CabinetSuppliesWarehouseEntityRestriction entityRestrictions;
  ...
  public CabinetSuppliesWarehouseRequestData() {
  }

  public CabinetSuppliesWarehouseRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public CabinetSuppliesWarehouseRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public CabinetSuppliesWarehouseRequestData entityRestrictions(CabinetSuppliesWarehouseEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public CabinetSuppliesWarehouseEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(CabinetSuppliesWarehouseEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public CabinetSuppliesWarehouseRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public CabinetSuppliesWarehouseRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public CabinetSuppliesWarehouseRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    CabinetSuppliesWarehouseRequestData cabinetSuppliesWarehouseRequestData = (CabinetSuppliesWarehouseRequestData) o;
    return Objects.equals(this.returnEntityAttributes, cabinetSuppliesWarehouseRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, cabinetSuppliesWarehouseRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, cabinetSuppliesWarehouseRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, cabinetSuppliesWarehouseRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class CabinetSuppliesWarehouseRequestData {\n");
