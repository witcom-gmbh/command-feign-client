...
import com.fntsoftware.businessgateway.entities.NodeContractsEntityRestriction;
import com.fntsoftware.businessgateway.entities.NodeContractsRelationRestriction;
...
/**
 * NodeContractsRequestData
 */
@JsonPropertyOrder({
  NodeContractsRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  NodeContractsRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  NodeContractsRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  NodeContractsRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-03-04T13:31:32.601557352Z[Etc/UTC]")
public class NodeContractsRequestData {
  ...
  private NodeContractsEntityRestriction entityRestrictions;

  public static final String JSON_PROPERTY_RELATION_RESTRICTIONS = "relationRestrictions";
  private NodeContractsRelationRestriction relationRestrictions;
  ...
  public NodeContractsRequestData() {
  }

  public NodeContractsRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public NodeContractsRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public NodeContractsRequestData entityRestrictions(NodeContractsEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public NodeContractsEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(NodeContractsEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public NodeContractsRequestData relationRestrictions(NodeContractsRelationRestriction relationRestrictions) {
  ...
  **/
  ...
  public NodeContractsRelationRestriction getRelationRestrictions() {
    return relationRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_RELATION_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRelationRestrictions(NodeContractsRelationRestriction relationRestrictions) {
    this.relationRestrictions = relationRestrictions;
  }


  public NodeContractsRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public NodeContractsRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    NodeContractsRequestData nodeContractsRequestData = (NodeContractsRequestData) o;
    return Objects.equals(this.returnEntityAttributes, nodeContractsRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, nodeContractsRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, nodeContractsRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, nodeContractsRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class NodeContractsRequestData {\n");
