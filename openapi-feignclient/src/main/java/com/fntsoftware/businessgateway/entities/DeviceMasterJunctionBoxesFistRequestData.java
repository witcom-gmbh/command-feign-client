...
import com.fntsoftware.businessgateway.entities.DeviceMasterJunctionBoxesFistEntityRestriction;
...
/**
 * DeviceMasterJunctionBoxesFistRequestData
 */
@JsonPropertyOrder({
  DeviceMasterJunctionBoxesFistRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  DeviceMasterJunctionBoxesFistRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  DeviceMasterJunctionBoxesFistRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  DeviceMasterJunctionBoxesFistRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-03-04T13:31:32.601557352Z[Etc/UTC]")
public class DeviceMasterJunctionBoxesFistRequestData {
  ...
  private DeviceMasterJunctionBoxesFistEntityRestriction entityRestrictions;
  ...
  public DeviceMasterJunctionBoxesFistRequestData() {
  }

  public DeviceMasterJunctionBoxesFistRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public DeviceMasterJunctionBoxesFistRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public DeviceMasterJunctionBoxesFistRequestData entityRestrictions(DeviceMasterJunctionBoxesFistEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public DeviceMasterJunctionBoxesFistEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(DeviceMasterJunctionBoxesFistEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public DeviceMasterJunctionBoxesFistRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public DeviceMasterJunctionBoxesFistRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public DeviceMasterJunctionBoxesFistRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    DeviceMasterJunctionBoxesFistRequestData deviceMasterJunctionBoxesFistRequestData = (DeviceMasterJunctionBoxesFistRequestData) o;
    return Objects.equals(this.returnEntityAttributes, deviceMasterJunctionBoxesFistRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, deviceMasterJunctionBoxesFistRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, deviceMasterJunctionBoxesFistRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, deviceMasterJunctionBoxesFistRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeviceMasterJunctionBoxesFistRequestData {\n");
