...
import com.fntsoftware.businessgateway.entities.VirtualNasServerStorageSystemEntityRestriction;
...
/**
 * VirtualNasServerStorageSystemRequestData
 */
@JsonPropertyOrder({
  VirtualNasServerStorageSystemRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  VirtualNasServerStorageSystemRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  VirtualNasServerStorageSystemRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  VirtualNasServerStorageSystemRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-03-04T13:31:32.601557352Z[Etc/UTC]")
public class VirtualNasServerStorageSystemRequestData {
  ...
  private VirtualNasServerStorageSystemEntityRestriction entityRestrictions;
  ...
  public VirtualNasServerStorageSystemRequestData() {
  }

  public VirtualNasServerStorageSystemRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public VirtualNasServerStorageSystemRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public VirtualNasServerStorageSystemRequestData entityRestrictions(VirtualNasServerStorageSystemEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public VirtualNasServerStorageSystemEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(VirtualNasServerStorageSystemEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public VirtualNasServerStorageSystemRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public VirtualNasServerStorageSystemRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public VirtualNasServerStorageSystemRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    VirtualNasServerStorageSystemRequestData virtualNasServerStorageSystemRequestData = (VirtualNasServerStorageSystemRequestData) o;
    return Objects.equals(this.returnEntityAttributes, virtualNasServerStorageSystemRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, virtualNasServerStorageSystemRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, virtualNasServerStorageSystemRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, virtualNasServerStorageSystemRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class VirtualNasServerStorageSystemRequestData {\n");
