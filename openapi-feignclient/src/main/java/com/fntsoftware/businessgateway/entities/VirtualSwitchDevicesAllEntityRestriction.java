...
/**
 * VirtualSwitchDevicesAllEntityRestriction
 */
@JsonPropertyOrder({
  VirtualSwitchDevicesAllEntityRestriction.JSON_PROPERTY_CLIMATE_RELEVANT,
  VirtualSwitchDevicesAllEntityRestriction.JSON_PROPERTY_POWER_CONSUMPTION,
  VirtualSwitchDevicesAllEntityRestriction.JSON_PROPERTY_POWER_SWITCHING_STATUS,
  VirtualSwitchDevicesAllEntityRestriction.JSON_PROPERTY_PLAN_STATUS,
  VirtualSwitchDevicesAllEntityRestriction.JSON_PROPERTY_SYSTEM_RUNTIME,
  VirtualSwitchDevicesAllEntityRestriction.JSON_PROPERTY_WEIGHT,
  VirtualSwitchDevicesAllEntityRestriction.JSON_PROPERTY_REMARK,
  VirtualSwitchDevicesAllEntityRestriction.JSON_PROPERTY_ELID,
  VirtualSwitchDevicesAllEntityRestriction.JSON_PROPERTY_LAST_SEEN,
  VirtualSwitchDevicesAllEntityRestriction.JSON_PROPERTY_TYPE_ELID,
  VirtualSwitchDevicesAllEntityRestriction.JSON_PROPERTY_VISIBLE_ID,
  VirtualSwitchDevicesAllEntityRestriction.JSON_PROPERTY_ID,
  VirtualSwitchDevicesAllEntityRestriction.JSON_PROPERTY_HEAT_EMISSION
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-01-31T11:10:37.320689708Z[Etc/UTC]")
public class VirtualSwitchDevicesAllEntityRestriction {
  ...
  public VirtualSwitchDevicesAllEntityRestriction() {
  }

  public VirtualSwitchDevicesAllEntityRestriction climateRelevant(RestrictionsBoolean climateRelevant) {
  ...
  **/
  ...
  public VirtualSwitchDevicesAllEntityRestriction powerConsumption(RestrictionsNumeric powerConsumption) {
  ...
  **/
  ...
  public VirtualSwitchDevicesAllEntityRestriction powerSwitchingStatus(RestrictionsString powerSwitchingStatus) {
  ...
  **/
  ...
  public VirtualSwitchDevicesAllEntityRestriction planStatus(RestrictionsString planStatus) {
  ...
  **/
  ...
  public VirtualSwitchDevicesAllEntityRestriction systemRuntime(RestrictionsNumeric systemRuntime) {
  ...
  **/
  ...
  public VirtualSwitchDevicesAllEntityRestriction weight(RestrictionsNumeric weight) {
  ...
  **/
  ...
  public VirtualSwitchDevicesAllEntityRestriction remark(RestrictionsString remark) {
  ...
  **/
  ...
  public VirtualSwitchDevicesAllEntityRestriction elid(RestrictionsString elid) {
  ...
  **/
  ...
  public VirtualSwitchDevicesAllEntityRestriction lastSeen(RestrictionsDate lastSeen) {
  ...
  **/
  ...
  public VirtualSwitchDevicesAllEntityRestriction typeElid(RestrictionsString typeElid) {
  ...
  **/
  ...
  public VirtualSwitchDevicesAllEntityRestriction visibleId(RestrictionsString visibleId) {
  ...
  **/
  ...
  public VirtualSwitchDevicesAllEntityRestriction id(RestrictionsString id) {
  ...
  **/
  ...
  public VirtualSwitchDevicesAllEntityRestriction heatEmission(RestrictionsNumeric heatEmission) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    VirtualSwitchDevicesAllEntityRestriction virtualSwitchDevicesAllEntityRestriction = (VirtualSwitchDevicesAllEntityRestriction) o;
    return Objects.equals(this.climateRelevant, virtualSwitchDevicesAllEntityRestriction.climateRelevant) &&
        Objects.equals(this.powerConsumption, virtualSwitchDevicesAllEntityRestriction.powerConsumption) &&
        Objects.equals(this.powerSwitchingStatus, virtualSwitchDevicesAllEntityRestriction.powerSwitchingStatus) &&
        Objects.equals(this.planStatus, virtualSwitchDevicesAllEntityRestriction.planStatus) &&
        Objects.equals(this.systemRuntime, virtualSwitchDevicesAllEntityRestriction.systemRuntime) &&
        Objects.equals(this.weight, virtualSwitchDevicesAllEntityRestriction.weight) &&
        Objects.equals(this.remark, virtualSwitchDevicesAllEntityRestriction.remark) &&
        Objects.equals(this.elid, virtualSwitchDevicesAllEntityRestriction.elid) &&
        Objects.equals(this.lastSeen, virtualSwitchDevicesAllEntityRestriction.lastSeen) &&
        Objects.equals(this.typeElid, virtualSwitchDevicesAllEntityRestriction.typeElid) &&
        Objects.equals(this.visibleId, virtualSwitchDevicesAllEntityRestriction.visibleId) &&
        Objects.equals(this.id, virtualSwitchDevicesAllEntityRestriction.id) &&
        Objects.equals(this.heatEmission, virtualSwitchDevicesAllEntityRestriction.heatEmission);
  }
  ...
  public String toString() {
    ...
    sb.append("class VirtualSwitchDevicesAllEntityRestriction {\n");
