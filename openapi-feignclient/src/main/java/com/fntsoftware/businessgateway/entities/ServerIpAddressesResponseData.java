...
/**
 * ServerIpAddressesResponseData
 */
@JsonPropertyOrder({
  ServerIpAddressesResponseData.JSON_PROPERTY_ASSIGNED_DIRECTLY,
  ServerIpAddressesResponseData.JSON_PROPERTY_INTERFACE,
  ServerIpAddressesResponseData.JSON_PROPERTY_PORTS,
  ServerIpAddressesResponseData.JSON_PROPERTY_OBJECT_ELID,
  ServerIpAddressesResponseData.JSON_PROPERTY_OBJECT_ID
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-02-26T11:20:24.990023935Z[Etc/UTC]")
public class ServerIpAddressesResponseData {
  ...
  public ServerIpAddressesResponseData() {
  }

  public ServerIpAddressesResponseData assignedDirectly(Boolean assignedDirectly) {
  ...
  **/
  ...
  public ServerIpAddressesResponseData _interface(InterfaceinterfaceWithAddressData _interface) {
  ...
  **/
  ...
  public ServerIpAddressesResponseData ports(List<PhysicalPortDataphysicalPortDataInfo> ports) {
    
    this.ports = ports;
    return this;
  }

  public ServerIpAddressesResponseData addPortsItem(PhysicalPortDataphysicalPortDataInfo portsItem) {
    if (this.ports == null) {
  ...
  **/
  ...
  public ServerIpAddressesResponseData objectElid(String objectElid) {
  ...
  **/
  ...
  public ServerIpAddressesResponseData objectId(String objectId) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ServerIpAddressesResponseData serverIpAddressesResponseData = (ServerIpAddressesResponseData) o;
    return Objects.equals(this.assignedDirectly, serverIpAddressesResponseData.assignedDirectly) &&
        Objects.equals(this._interface, serverIpAddressesResponseData._interface) &&
        Objects.equals(this.ports, serverIpAddressesResponseData.ports) &&
        Objects.equals(this.objectElid, serverIpAddressesResponseData.objectElid) &&
        Objects.equals(this.objectId, serverIpAddressesResponseData.objectId);
  }
  ...
  public String toString() {
    ...
    sb.append("class ServerIpAddressesResponseData {\n");
