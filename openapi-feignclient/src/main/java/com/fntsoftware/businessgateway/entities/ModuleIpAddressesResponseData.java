...
/**
 * ModuleIpAddressesResponseData
 */
@JsonPropertyOrder({
  ModuleIpAddressesResponseData.JSON_PROPERTY_ASSIGNED_DIRECTLY,
  ModuleIpAddressesResponseData.JSON_PROPERTY_INTERFACE,
  ModuleIpAddressesResponseData.JSON_PROPERTY_PORTS,
  ModuleIpAddressesResponseData.JSON_PROPERTY_OBJECT_ELID,
  ModuleIpAddressesResponseData.JSON_PROPERTY_OBJECT_ID
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-03-04T13:31:32.601557352Z[Etc/UTC]")
public class ModuleIpAddressesResponseData {
  ...
  public ModuleIpAddressesResponseData() {
  }

  public ModuleIpAddressesResponseData assignedDirectly(Boolean assignedDirectly) {
  ...
  **/
  ...
  public ModuleIpAddressesResponseData _interface(InterfaceinterfaceWithAddressData _interface) {
  ...
  **/
  ...
  public ModuleIpAddressesResponseData ports(List<PhysicalPortDataphysicalPortDataInfo> ports) {
    
    this.ports = ports;
    return this;
  }

  public ModuleIpAddressesResponseData addPortsItem(PhysicalPortDataphysicalPortDataInfo portsItem) {
    if (this.ports == null) {
  ...
  **/
  ...
  public ModuleIpAddressesResponseData objectElid(String objectElid) {
  ...
  **/
  ...
  public ModuleIpAddressesResponseData objectId(String objectId) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ModuleIpAddressesResponseData moduleIpAddressesResponseData = (ModuleIpAddressesResponseData) o;
    return Objects.equals(this.assignedDirectly, moduleIpAddressesResponseData.assignedDirectly) &&
        Objects.equals(this._interface, moduleIpAddressesResponseData._interface) &&
        Objects.equals(this.ports, moduleIpAddressesResponseData.ports) &&
        Objects.equals(this.objectElid, moduleIpAddressesResponseData.objectElid) &&
        Objects.equals(this.objectId, moduleIpAddressesResponseData.objectId);
  }
  ...
  public String toString() {
    ...
    sb.append("class ModuleIpAddressesResponseData {\n");
