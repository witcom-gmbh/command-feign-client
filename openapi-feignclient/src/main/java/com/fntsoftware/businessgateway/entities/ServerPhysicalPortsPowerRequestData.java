...
import com.fntsoftware.businessgateway.entities.ServerPhysicalPortsPowerEntityRestriction;
...
/**
 * ServerPhysicalPortsPowerRequestData
 */
@JsonPropertyOrder({
  ServerPhysicalPortsPowerRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  ServerPhysicalPortsPowerRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  ServerPhysicalPortsPowerRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  ServerPhysicalPortsPowerRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-02-26T11:20:24.990023935Z[Etc/UTC]")
public class ServerPhysicalPortsPowerRequestData {
  ...
  private ServerPhysicalPortsPowerEntityRestriction entityRestrictions;
  ...
  public ServerPhysicalPortsPowerRequestData() {
  }

  public ServerPhysicalPortsPowerRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public ServerPhysicalPortsPowerRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public ServerPhysicalPortsPowerRequestData entityRestrictions(ServerPhysicalPortsPowerEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public ServerPhysicalPortsPowerEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(ServerPhysicalPortsPowerEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public ServerPhysicalPortsPowerRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public ServerPhysicalPortsPowerRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public ServerPhysicalPortsPowerRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ServerPhysicalPortsPowerRequestData serverPhysicalPortsPowerRequestData = (ServerPhysicalPortsPowerRequestData) o;
    return Objects.equals(this.returnEntityAttributes, serverPhysicalPortsPowerRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, serverPhysicalPortsPowerRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, serverPhysicalPortsPowerRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, serverPhysicalPortsPowerRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class ServerPhysicalPortsPowerRequestData {\n");
