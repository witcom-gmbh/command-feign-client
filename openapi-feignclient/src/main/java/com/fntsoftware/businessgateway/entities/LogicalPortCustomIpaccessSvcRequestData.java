...
import com.fntsoftware.businessgateway.entities.LogicalPortCustomIpaccessSvcEntityRestriction;
...
/**
 * LogicalPortCustomIpaccessSvcRequestData
 */
@JsonPropertyOrder({
  LogicalPortCustomIpaccessSvcRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  LogicalPortCustomIpaccessSvcRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  LogicalPortCustomIpaccessSvcRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  LogicalPortCustomIpaccessSvcRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-01-31T11:10:37.320689708Z[Etc/UTC]")
public class LogicalPortCustomIpaccessSvcRequestData {
  ...
  private LogicalPortCustomIpaccessSvcEntityRestriction entityRestrictions;
  ...
  public LogicalPortCustomIpaccessSvcRequestData() {
  }

  public LogicalPortCustomIpaccessSvcRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public LogicalPortCustomIpaccessSvcRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public LogicalPortCustomIpaccessSvcRequestData entityRestrictions(LogicalPortCustomIpaccessSvcEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public LogicalPortCustomIpaccessSvcEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(LogicalPortCustomIpaccessSvcEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public LogicalPortCustomIpaccessSvcRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public LogicalPortCustomIpaccessSvcRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public LogicalPortCustomIpaccessSvcRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    LogicalPortCustomIpaccessSvcRequestData logicalPortCustomIpaccessSvcRequestData = (LogicalPortCustomIpaccessSvcRequestData) o;
    return Objects.equals(this.returnEntityAttributes, logicalPortCustomIpaccessSvcRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, logicalPortCustomIpaccessSvcRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, logicalPortCustomIpaccessSvcRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, logicalPortCustomIpaccessSvcRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class LogicalPortCustomIpaccessSvcRequestData {\n");
