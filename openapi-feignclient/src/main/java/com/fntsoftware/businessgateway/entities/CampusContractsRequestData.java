...
import com.fntsoftware.businessgateway.entities.CampusContractsEntityRestriction;
import com.fntsoftware.businessgateway.entities.CampusContractsRelationRestriction;
...
/**
 * CampusContractsRequestData
 */
@JsonPropertyOrder({
  CampusContractsRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  CampusContractsRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  CampusContractsRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  CampusContractsRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-02-26T11:20:24.990023935Z[Etc/UTC]")
public class CampusContractsRequestData {
  ...
  private CampusContractsEntityRestriction entityRestrictions;

  public static final String JSON_PROPERTY_RELATION_RESTRICTIONS = "relationRestrictions";
  private CampusContractsRelationRestriction relationRestrictions;
  ...
  public CampusContractsRequestData() {
  }

  public CampusContractsRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public CampusContractsRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public CampusContractsRequestData entityRestrictions(CampusContractsEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public CampusContractsEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(CampusContractsEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public CampusContractsRequestData relationRestrictions(CampusContractsRelationRestriction relationRestrictions) {
  ...
  **/
  ...
  public CampusContractsRelationRestriction getRelationRestrictions() {
    return relationRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_RELATION_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRelationRestrictions(CampusContractsRelationRestriction relationRestrictions) {
    this.relationRestrictions = relationRestrictions;
  }


  public CampusContractsRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public CampusContractsRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    CampusContractsRequestData campusContractsRequestData = (CampusContractsRequestData) o;
    return Objects.equals(this.returnEntityAttributes, campusContractsRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, campusContractsRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, campusContractsRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, campusContractsRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class CampusContractsRequestData {\n");
