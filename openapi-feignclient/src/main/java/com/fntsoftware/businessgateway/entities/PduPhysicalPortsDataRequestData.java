...
import com.fntsoftware.businessgateway.entities.PduPhysicalPortsDataEntityRestriction;
...
/**
 * PduPhysicalPortsDataRequestData
 */
@JsonPropertyOrder({
  PduPhysicalPortsDataRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  PduPhysicalPortsDataRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  PduPhysicalPortsDataRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  PduPhysicalPortsDataRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-01-31T11:10:37.320689708Z[Etc/UTC]")
public class PduPhysicalPortsDataRequestData {
  ...
  private PduPhysicalPortsDataEntityRestriction entityRestrictions;
  ...
  public PduPhysicalPortsDataRequestData() {
  }

  public PduPhysicalPortsDataRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public PduPhysicalPortsDataRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public PduPhysicalPortsDataRequestData entityRestrictions(PduPhysicalPortsDataEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public PduPhysicalPortsDataEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(PduPhysicalPortsDataEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public PduPhysicalPortsDataRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public PduPhysicalPortsDataRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public PduPhysicalPortsDataRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    PduPhysicalPortsDataRequestData pduPhysicalPortsDataRequestData = (PduPhysicalPortsDataRequestData) o;
    return Objects.equals(this.returnEntityAttributes, pduPhysicalPortsDataRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, pduPhysicalPortsDataRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, pduPhysicalPortsDataRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, pduPhysicalPortsDataRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class PduPhysicalPortsDataRequestData {\n");
