...
import com.fntsoftware.businessgateway.entities.UpdateDomainResponseData;
 ...
 */
@JsonPropertyOrder({
  UpdateDomainResponse.JSON_PROPERTY_RETURN_DATA,
  UpdateDomainResponse.JSON_PROPERTY_STATUS
})
...
public class UpdateDomainResponse {
  ...
  private UpdateDomainResponseData returnData;
  ...
  public UpdateDomainResponse returnData(UpdateDomainResponseData returnData) {
  ...
  **/
  ...
  public UpdateDomainResponseData getReturnData() {
    return returnData;
  }
  ...
  @JsonProperty(JSON_PROPERTY_RETURN_DATA)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setReturnData(UpdateDomainResponseData returnData) {
    this.returnData = returnData;
  }


  public UpdateDomainResponse status(ServiceStatusData status) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.returnData, updateDomainResponse.returnData) &&
