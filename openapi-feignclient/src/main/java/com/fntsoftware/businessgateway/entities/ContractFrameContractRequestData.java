...
import com.fntsoftware.businessgateway.entities.ContractFrameContractEntityRestriction;
...
/**
 * ContractFrameContractRequestData
 */
@JsonPropertyOrder({
  ContractFrameContractRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  ContractFrameContractRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  ContractFrameContractRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  ContractFrameContractRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-01-31T11:10:37.320689708Z[Etc/UTC]")
public class ContractFrameContractRequestData {
  ...
  private ContractFrameContractEntityRestriction entityRestrictions;
  ...
  public ContractFrameContractRequestData() {
  }

  public ContractFrameContractRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public ContractFrameContractRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public ContractFrameContractRequestData entityRestrictions(ContractFrameContractEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public ContractFrameContractEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(ContractFrameContractEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public ContractFrameContractRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public ContractFrameContractRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public ContractFrameContractRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ContractFrameContractRequestData contractFrameContractRequestData = (ContractFrameContractRequestData) o;
    return Objects.equals(this.returnEntityAttributes, contractFrameContractRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, contractFrameContractRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, contractFrameContractRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, contractFrameContractRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class ContractFrameContractRequestData {\n");
