...
import com.fntsoftware.businessgateway.entities.ContractChassisEntityRestriction;
import com.fntsoftware.businessgateway.entities.ContractChassisRelationRestriction;
...
/**
 * ContractChassisRequestData
 */
@JsonPropertyOrder({
  ContractChassisRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  ContractChassisRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  ContractChassisRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  ContractChassisRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-02-26T11:20:24.990023935Z[Etc/UTC]")
public class ContractChassisRequestData {
  ...
  private ContractChassisEntityRestriction entityRestrictions;

  public static final String JSON_PROPERTY_RELATION_RESTRICTIONS = "relationRestrictions";
  private ContractChassisRelationRestriction relationRestrictions;
  ...
  public ContractChassisRequestData() {
  }

  public ContractChassisRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public ContractChassisRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public ContractChassisRequestData entityRestrictions(ContractChassisEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public ContractChassisEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(ContractChassisEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public ContractChassisRequestData relationRestrictions(ContractChassisRelationRestriction relationRestrictions) {
  ...
  **/
  ...
  public ContractChassisRelationRestriction getRelationRestrictions() {
    return relationRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_RELATION_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRelationRestrictions(ContractChassisRelationRestriction relationRestrictions) {
    this.relationRestrictions = relationRestrictions;
  }


  public ContractChassisRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public ContractChassisRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ContractChassisRequestData contractChassisRequestData = (ContractChassisRequestData) o;
    return Objects.equals(this.returnEntityAttributes, contractChassisRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, contractChassisRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, contractChassisRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, contractChassisRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class ContractChassisRequestData {\n");
