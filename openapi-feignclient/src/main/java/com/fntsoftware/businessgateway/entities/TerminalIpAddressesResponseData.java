...
/**
 * TerminalIpAddressesResponseData
 */
@JsonPropertyOrder({
  TerminalIpAddressesResponseData.JSON_PROPERTY_ASSIGNED_DIRECTLY,
  TerminalIpAddressesResponseData.JSON_PROPERTY_INTERFACE,
  TerminalIpAddressesResponseData.JSON_PROPERTY_PORTS,
  TerminalIpAddressesResponseData.JSON_PROPERTY_OBJECT_ELID,
  TerminalIpAddressesResponseData.JSON_PROPERTY_OBJECT_ID
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-03-04T13:31:32.601557352Z[Etc/UTC]")
public class TerminalIpAddressesResponseData {
  ...
  public TerminalIpAddressesResponseData() {
  }

  public TerminalIpAddressesResponseData assignedDirectly(Boolean assignedDirectly) {
  ...
  **/
  ...
  public TerminalIpAddressesResponseData _interface(InterfaceinterfaceWithAddressData _interface) {
  ...
  **/
  ...
  public TerminalIpAddressesResponseData ports(List<PhysicalPortDataphysicalPortDataInfo> ports) {
    
    this.ports = ports;
    return this;
  }

  public TerminalIpAddressesResponseData addPortsItem(PhysicalPortDataphysicalPortDataInfo portsItem) {
    if (this.ports == null) {
  ...
  **/
  ...
  public TerminalIpAddressesResponseData objectElid(String objectElid) {
  ...
  **/
  ...
  public TerminalIpAddressesResponseData objectId(String objectId) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    TerminalIpAddressesResponseData terminalIpAddressesResponseData = (TerminalIpAddressesResponseData) o;
    return Objects.equals(this.assignedDirectly, terminalIpAddressesResponseData.assignedDirectly) &&
        Objects.equals(this._interface, terminalIpAddressesResponseData._interface) &&
        Objects.equals(this.ports, terminalIpAddressesResponseData.ports) &&
        Objects.equals(this.objectElid, terminalIpAddressesResponseData.objectElid) &&
        Objects.equals(this.objectId, terminalIpAddressesResponseData.objectId);
  }
  ...
  public String toString() {
    ...
    sb.append("class TerminalIpAddressesResponseData {\n");
