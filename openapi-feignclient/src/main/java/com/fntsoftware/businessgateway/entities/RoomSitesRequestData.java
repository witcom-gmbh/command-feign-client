...
import com.fntsoftware.businessgateway.entities.RoomSitesEntityRestriction;
import com.fntsoftware.businessgateway.entities.RoomSitesRelationRestriction;
...
/**
 * RoomSitesRequestData
 */
@JsonPropertyOrder({
  RoomSitesRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  RoomSitesRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  RoomSitesRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  RoomSitesRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-03-04T13:31:32.601557352Z[Etc/UTC]")
public class RoomSitesRequestData {
  ...
  private RoomSitesEntityRestriction entityRestrictions;

  public static final String JSON_PROPERTY_RELATION_RESTRICTIONS = "relationRestrictions";
  private RoomSitesRelationRestriction relationRestrictions;
  ...
  public RoomSitesRequestData() {
  }

  public RoomSitesRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public RoomSitesRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public RoomSitesRequestData entityRestrictions(RoomSitesEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public RoomSitesEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(RoomSitesEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public RoomSitesRequestData relationRestrictions(RoomSitesRelationRestriction relationRestrictions) {
  ...
  **/
  ...
  public RoomSitesRelationRestriction getRelationRestrictions() {
    return relationRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_RELATION_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRelationRestrictions(RoomSitesRelationRestriction relationRestrictions) {
    this.relationRestrictions = relationRestrictions;
  }


  public RoomSitesRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public RoomSitesRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    RoomSitesRequestData roomSitesRequestData = (RoomSitesRequestData) o;
    return Objects.equals(this.returnEntityAttributes, roomSitesRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, roomSitesRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, roomSitesRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, roomSitesRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class RoomSitesRequestData {\n");
