...
import com.fntsoftware.businessgateway.entities.DataSocketSlotEntityRestriction;
import com.fntsoftware.businessgateway.entities.DataSocketSlotRelationRestriction;
...
/**
 * DataSocketSlotRequestData
 */
@JsonPropertyOrder({
  DataSocketSlotRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  DataSocketSlotRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  DataSocketSlotRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  DataSocketSlotRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-02-26T11:20:24.990023935Z[Etc/UTC]")
public class DataSocketSlotRequestData {
  ...
  private DataSocketSlotEntityRestriction entityRestrictions;

  public static final String JSON_PROPERTY_RELATION_RESTRICTIONS = "relationRestrictions";
  private DataSocketSlotRelationRestriction relationRestrictions;
  ...
  public DataSocketSlotRequestData() {
  }

  public DataSocketSlotRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public DataSocketSlotRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public DataSocketSlotRequestData entityRestrictions(DataSocketSlotEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public DataSocketSlotEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(DataSocketSlotEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public DataSocketSlotRequestData relationRestrictions(DataSocketSlotRelationRestriction relationRestrictions) {
  ...
  **/
  ...
  public DataSocketSlotRelationRestriction getRelationRestrictions() {
    return relationRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_RELATION_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRelationRestrictions(DataSocketSlotRelationRestriction relationRestrictions) {
    this.relationRestrictions = relationRestrictions;
  }


  public DataSocketSlotRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public DataSocketSlotRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    DataSocketSlotRequestData dataSocketSlotRequestData = (DataSocketSlotRequestData) o;
    return Objects.equals(this.returnEntityAttributes, dataSocketSlotRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, dataSocketSlotRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, dataSocketSlotRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, dataSocketSlotRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class DataSocketSlotRequestData {\n");
