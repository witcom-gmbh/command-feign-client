...
import com.fntsoftware.businessgateway.entities.ServerModemsEntityRestriction;
import com.fntsoftware.businessgateway.entities.ServerModemsRelationRestriction;
...
/**
 * ServerModemsRequestData
 */
@JsonPropertyOrder({
  ServerModemsRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  ServerModemsRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  ServerModemsRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  ServerModemsRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-02-26T11:20:24.990023935Z[Etc/UTC]")
public class ServerModemsRequestData {
  ...
  private ServerModemsEntityRestriction entityRestrictions;

  public static final String JSON_PROPERTY_RELATION_RESTRICTIONS = "relationRestrictions";
  private ServerModemsRelationRestriction relationRestrictions;
  ...
  public ServerModemsRequestData() {
  }

  public ServerModemsRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public ServerModemsRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public ServerModemsRequestData entityRestrictions(ServerModemsEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public ServerModemsEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(ServerModemsEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public ServerModemsRequestData relationRestrictions(ServerModemsRelationRestriction relationRestrictions) {
  ...
  **/
  ...
  public ServerModemsRelationRestriction getRelationRestrictions() {
    return relationRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_RELATION_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRelationRestrictions(ServerModemsRelationRestriction relationRestrictions) {
    this.relationRestrictions = relationRestrictions;
  }


  public ServerModemsRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public ServerModemsRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ServerModemsRequestData serverModemsRequestData = (ServerModemsRequestData) o;
    return Objects.equals(this.returnEntityAttributes, serverModemsRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, serverModemsRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, serverModemsRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, serverModemsRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class ServerModemsRequestData {\n");
