...
import com.fntsoftware.businessgateway.entities.DeviceMiscWarehouseEntityRestriction;
...
/**
 * DeviceMiscWarehouseRequestData
 */
@JsonPropertyOrder({
  DeviceMiscWarehouseRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  DeviceMiscWarehouseRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  DeviceMiscWarehouseRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  DeviceMiscWarehouseRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-02-26T11:20:24.990023935Z[Etc/UTC]")
public class DeviceMiscWarehouseRequestData {
  ...
  private DeviceMiscWarehouseEntityRestriction entityRestrictions;
  ...
  public DeviceMiscWarehouseRequestData() {
  }

  public DeviceMiscWarehouseRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public DeviceMiscWarehouseRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public DeviceMiscWarehouseRequestData entityRestrictions(DeviceMiscWarehouseEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public DeviceMiscWarehouseEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(DeviceMiscWarehouseEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public DeviceMiscWarehouseRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public DeviceMiscWarehouseRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public DeviceMiscWarehouseRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    DeviceMiscWarehouseRequestData deviceMiscWarehouseRequestData = (DeviceMiscWarehouseRequestData) o;
    return Objects.equals(this.returnEntityAttributes, deviceMiscWarehouseRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, deviceMiscWarehouseRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, deviceMiscWarehouseRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, deviceMiscWarehouseRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeviceMiscWarehouseRequestData {\n");
