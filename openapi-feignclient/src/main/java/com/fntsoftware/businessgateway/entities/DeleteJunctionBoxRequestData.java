...
/**
 * DeleteJunctionBoxRequestData
 */
@JsonPropertyOrder({
  DeleteJunctionBoxRequestData.JSON_PROPERTY_RELEASE_SIGNALPATH,
  DeleteJunctionBoxRequestData.JSON_PROPERTY_RELEASE_CONNECTIONS,
  DeleteJunctionBoxRequestData.JSON_PROPERTY_RELEASE_SERVICE,
  DeleteJunctionBoxRequestData.JSON_PROPERTY_CONTEXT_ID,
  DeleteJunctionBoxRequestData.JSON_PROPERTY_RELEASE_PATCHES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-02-26T11:20:24.990023935Z[Etc/UTC]")
public class DeleteJunctionBoxRequestData {
  ...
  public DeleteJunctionBoxRequestData() {
  }

  public DeleteJunctionBoxRequestData releaseSignalpath(Boolean releaseSignalpath) {
  ...
  **/
  ...
  public DeleteJunctionBoxRequestData releaseConnections(Boolean releaseConnections) {
  ...
  **/
  ...
  public DeleteJunctionBoxRequestData releaseService(Boolean releaseService) {
  ...
  **/
  ...
  public DeleteJunctionBoxRequestData contextId(String contextId) {
  ...
  **/
  ...
  public DeleteJunctionBoxRequestData releasePatches(Boolean releasePatches) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    DeleteJunctionBoxRequestData deleteJunctionBoxRequestData = (DeleteJunctionBoxRequestData) o;
    return Objects.equals(this.releaseSignalpath, deleteJunctionBoxRequestData.releaseSignalpath) &&
        Objects.equals(this.releaseConnections, deleteJunctionBoxRequestData.releaseConnections) &&
        Objects.equals(this.releaseService, deleteJunctionBoxRequestData.releaseService) &&
        Objects.equals(this.contextId, deleteJunctionBoxRequestData.contextId) &&
        Objects.equals(this.releasePatches, deleteJunctionBoxRequestData.releasePatches);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeleteJunctionBoxRequestData {\n");
