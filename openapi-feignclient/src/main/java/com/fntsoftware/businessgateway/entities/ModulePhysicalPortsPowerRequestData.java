...
import com.fntsoftware.businessgateway.entities.ModulePhysicalPortsPowerEntityRestriction;
...
/**
 * ModulePhysicalPortsPowerRequestData
 */
@JsonPropertyOrder({
  ModulePhysicalPortsPowerRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  ModulePhysicalPortsPowerRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  ModulePhysicalPortsPowerRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  ModulePhysicalPortsPowerRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-01-31T11:10:37.320689708Z[Etc/UTC]")
public class ModulePhysicalPortsPowerRequestData {
  ...
  private ModulePhysicalPortsPowerEntityRestriction entityRestrictions;
  ...
  public ModulePhysicalPortsPowerRequestData() {
  }

  public ModulePhysicalPortsPowerRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public ModulePhysicalPortsPowerRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public ModulePhysicalPortsPowerRequestData entityRestrictions(ModulePhysicalPortsPowerEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public ModulePhysicalPortsPowerEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(ModulePhysicalPortsPowerEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public ModulePhysicalPortsPowerRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public ModulePhysicalPortsPowerRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public ModulePhysicalPortsPowerRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ModulePhysicalPortsPowerRequestData modulePhysicalPortsPowerRequestData = (ModulePhysicalPortsPowerRequestData) o;
    return Objects.equals(this.returnEntityAttributes, modulePhysicalPortsPowerRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, modulePhysicalPortsPowerRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, modulePhysicalPortsPowerRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, modulePhysicalPortsPowerRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class ModulePhysicalPortsPowerRequestData {\n");
