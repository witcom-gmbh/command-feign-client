...
/**
 * UpdateSystemAttributesPduAddUserRequestData
 */
@JsonPropertyOrder({
  UpdateSystemAttributesPduAddUserRequestData.JSON_PROPERTY_MODIFY_PLAN,
  UpdateSystemAttributesPduAddUserRequestData.JSON_PROPERTY_DELETE_REAL,
  UpdateSystemAttributesPduAddUserRequestData.JSON_PROPERTY_READ_PLAN,
  UpdateSystemAttributesPduAddUserRequestData.JSON_PROPERTY_MANDANT_ID,
  UpdateSystemAttributesPduAddUserRequestData.JSON_PROPERTY_USER_ELID,
  UpdateSystemAttributesPduAddUserRequestData.JSON_PROPERTY_MODIFY_REAL,
  UpdateSystemAttributesPduAddUserRequestData.JSON_PROPERTY_READ_REAL,
  UpdateSystemAttributesPduAddUserRequestData.JSON_PROPERTY_DELETE_PLAN
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-02-26T11:20:24.990023935Z[Etc/UTC]")
public class UpdateSystemAttributesPduAddUserRequestData {
  ...
  public UpdateSystemAttributesPduAddUserRequestData() {
  }

  public UpdateSystemAttributesPduAddUserRequestData modifyPlan(Boolean modifyPlan) {
  ...
  **/
  ...
  public UpdateSystemAttributesPduAddUserRequestData deleteReal(Boolean deleteReal) {
  ...
  **/
  ...
  public UpdateSystemAttributesPduAddUserRequestData readPlan(Boolean readPlan) {
  ...
  **/
  ...
  public UpdateSystemAttributesPduAddUserRequestData mandantId(BigDecimal mandantId) {
  ...
  **/
  ...
  public UpdateSystemAttributesPduAddUserRequestData userElid(String userElid) {
  ...
  **/
  ...
  public UpdateSystemAttributesPduAddUserRequestData modifyReal(Boolean modifyReal) {
  ...
  **/
  ...
  public UpdateSystemAttributesPduAddUserRequestData readReal(Boolean readReal) {
  ...
  **/
  ...
  public UpdateSystemAttributesPduAddUserRequestData deletePlan(Boolean deletePlan) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    UpdateSystemAttributesPduAddUserRequestData updateSystemAttributesPduAddUserRequestData = (UpdateSystemAttributesPduAddUserRequestData) o;
    return Objects.equals(this.modifyPlan, updateSystemAttributesPduAddUserRequestData.modifyPlan) &&
        Objects.equals(this.deleteReal, updateSystemAttributesPduAddUserRequestData.deleteReal) &&
        Objects.equals(this.readPlan, updateSystemAttributesPduAddUserRequestData.readPlan) &&
        Objects.equals(this.mandantId, updateSystemAttributesPduAddUserRequestData.mandantId) &&
        Objects.equals(this.userElid, updateSystemAttributesPduAddUserRequestData.userElid) &&
        Objects.equals(this.modifyReal, updateSystemAttributesPduAddUserRequestData.modifyReal) &&
        Objects.equals(this.readReal, updateSystemAttributesPduAddUserRequestData.readReal) &&
        Objects.equals(this.deletePlan, updateSystemAttributesPduAddUserRequestData.deletePlan);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateSystemAttributesPduAddUserRequestData {\n");
