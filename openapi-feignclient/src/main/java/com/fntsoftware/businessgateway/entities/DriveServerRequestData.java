...
import com.fntsoftware.businessgateway.entities.DriveServerEntityRestriction;
import com.fntsoftware.businessgateway.entities.DriveServerRelationRestriction;
...
/**
 * DriveServerRequestData
 */
@JsonPropertyOrder({
  DriveServerRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  DriveServerRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  DriveServerRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  DriveServerRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-03-04T13:31:32.601557352Z[Etc/UTC]")
public class DriveServerRequestData {
  ...
  private DriveServerEntityRestriction entityRestrictions;

  public static final String JSON_PROPERTY_RELATION_RESTRICTIONS = "relationRestrictions";
  private DriveServerRelationRestriction relationRestrictions;
  ...
  public DriveServerRequestData() {
  }

  public DriveServerRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public DriveServerRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public DriveServerRequestData entityRestrictions(DriveServerEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public DriveServerEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(DriveServerEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public DriveServerRequestData relationRestrictions(DriveServerRelationRestriction relationRestrictions) {
  ...
  **/
  ...
  public DriveServerRelationRestriction getRelationRestrictions() {
    return relationRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_RELATION_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRelationRestrictions(DriveServerRelationRestriction relationRestrictions) {
    this.relationRestrictions = relationRestrictions;
  }


  public DriveServerRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public DriveServerRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    DriveServerRequestData driveServerRequestData = (DriveServerRequestData) o;
    return Objects.equals(this.returnEntityAttributes, driveServerRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, driveServerRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, driveServerRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, driveServerRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class DriveServerRequestData {\n");
