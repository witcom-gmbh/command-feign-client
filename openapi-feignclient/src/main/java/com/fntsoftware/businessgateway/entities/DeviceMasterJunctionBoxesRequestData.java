...
import com.fntsoftware.businessgateway.entities.DeviceMasterJunctionBoxesEntityRestriction;
...
/**
 * DeviceMasterJunctionBoxesRequestData
 */
@JsonPropertyOrder({
  DeviceMasterJunctionBoxesRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  DeviceMasterJunctionBoxesRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  DeviceMasterJunctionBoxesRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  DeviceMasterJunctionBoxesRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-03-04T13:31:32.601557352Z[Etc/UTC]")
public class DeviceMasterJunctionBoxesRequestData {
  ...
  private DeviceMasterJunctionBoxesEntityRestriction entityRestrictions;
  ...
  public DeviceMasterJunctionBoxesRequestData() {
  }

  public DeviceMasterJunctionBoxesRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public DeviceMasterJunctionBoxesRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public DeviceMasterJunctionBoxesRequestData entityRestrictions(DeviceMasterJunctionBoxesEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public DeviceMasterJunctionBoxesEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(DeviceMasterJunctionBoxesEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public DeviceMasterJunctionBoxesRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public DeviceMasterJunctionBoxesRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public DeviceMasterJunctionBoxesRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    DeviceMasterJunctionBoxesRequestData deviceMasterJunctionBoxesRequestData = (DeviceMasterJunctionBoxesRequestData) o;
    return Objects.equals(this.returnEntityAttributes, deviceMasterJunctionBoxesRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, deviceMasterJunctionBoxesRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, deviceMasterJunctionBoxesRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, deviceMasterJunctionBoxesRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeviceMasterJunctionBoxesRequestData {\n");
