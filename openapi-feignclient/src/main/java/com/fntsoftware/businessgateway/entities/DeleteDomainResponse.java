 ...
 */
@JsonPropertyOrder({
  DeleteDomainResponse.JSON_PROPERTY_STATUS
})
...
public class DeleteDomainResponse {
  ...
  public DeleteDomainResponse status(ServiceStatusData status) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.status, deleteDomainResponse.status);
  }
