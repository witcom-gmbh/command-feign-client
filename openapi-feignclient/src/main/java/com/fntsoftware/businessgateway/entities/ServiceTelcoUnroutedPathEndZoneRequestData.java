...
import com.fntsoftware.businessgateway.entities.ServiceTelcoUnroutedPathEndZoneEntityRestriction;
...
/**
 * ServiceTelcoUnroutedPathEndZoneRequestData
 */
@JsonPropertyOrder({
  ServiceTelcoUnroutedPathEndZoneRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  ServiceTelcoUnroutedPathEndZoneRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  ServiceTelcoUnroutedPathEndZoneRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  ServiceTelcoUnroutedPathEndZoneRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-01-31T11:10:37.320689708Z[Etc/UTC]")
public class ServiceTelcoUnroutedPathEndZoneRequestData {
  ...
  private ServiceTelcoUnroutedPathEndZoneEntityRestriction entityRestrictions;
  ...
  public ServiceTelcoUnroutedPathEndZoneRequestData() {
  }

  public ServiceTelcoUnroutedPathEndZoneRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public ServiceTelcoUnroutedPathEndZoneRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public ServiceTelcoUnroutedPathEndZoneRequestData entityRestrictions(ServiceTelcoUnroutedPathEndZoneEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public ServiceTelcoUnroutedPathEndZoneEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(ServiceTelcoUnroutedPathEndZoneEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public ServiceTelcoUnroutedPathEndZoneRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public ServiceTelcoUnroutedPathEndZoneRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public ServiceTelcoUnroutedPathEndZoneRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ServiceTelcoUnroutedPathEndZoneRequestData serviceTelcoUnroutedPathEndZoneRequestData = (ServiceTelcoUnroutedPathEndZoneRequestData) o;
    return Objects.equals(this.returnEntityAttributes, serviceTelcoUnroutedPathEndZoneRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, serviceTelcoUnroutedPathEndZoneRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, serviceTelcoUnroutedPathEndZoneRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, serviceTelcoUnroutedPathEndZoneRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class ServiceTelcoUnroutedPathEndZoneRequestData {\n");
