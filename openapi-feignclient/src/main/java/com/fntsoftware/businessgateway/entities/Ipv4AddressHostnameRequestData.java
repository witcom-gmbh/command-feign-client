...
import com.fntsoftware.businessgateway.entities.Ipv4AddressHostnameEntityRestriction;
...
/**
 * Ipv4AddressHostnameRequestData
 */
@JsonPropertyOrder({
  Ipv4AddressHostnameRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  Ipv4AddressHostnameRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  Ipv4AddressHostnameRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  Ipv4AddressHostnameRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-01-31T11:10:37.320689708Z[Etc/UTC]")
public class Ipv4AddressHostnameRequestData {
  ...
  private Ipv4AddressHostnameEntityRestriction entityRestrictions;
  ...
  public Ipv4AddressHostnameRequestData() {
  }

  public Ipv4AddressHostnameRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public Ipv4AddressHostnameRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public Ipv4AddressHostnameRequestData entityRestrictions(Ipv4AddressHostnameEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public Ipv4AddressHostnameEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(Ipv4AddressHostnameEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public Ipv4AddressHostnameRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public Ipv4AddressHostnameRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public Ipv4AddressHostnameRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    Ipv4AddressHostnameRequestData ipv4AddressHostnameRequestData = (Ipv4AddressHostnameRequestData) o;
    return Objects.equals(this.returnEntityAttributes, ipv4AddressHostnameRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, ipv4AddressHostnameRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, ipv4AddressHostnameRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, ipv4AddressHostnameRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class Ipv4AddressHostnameRequestData {\n");
