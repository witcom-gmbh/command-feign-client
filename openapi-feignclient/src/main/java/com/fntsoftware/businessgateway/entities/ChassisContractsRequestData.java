...
import com.fntsoftware.businessgateway.entities.ChassisContractsEntityRestriction;
import com.fntsoftware.businessgateway.entities.ChassisContractsRelationRestriction;
...
/**
 * ChassisContractsRequestData
 */
@JsonPropertyOrder({
  ChassisContractsRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  ChassisContractsRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  ChassisContractsRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  ChassisContractsRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
...
public class ChassisContractsRequestData {
  ...
  private ChassisContractsEntityRestriction entityRestrictions;

  public static final String JSON_PROPERTY_RELATION_RESTRICTIONS = "relationRestrictions";
  private ChassisContractsRelationRestriction relationRestrictions;
  ...
  public ChassisContractsRequestData() {
  }

  public ChassisContractsRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public ChassisContractsRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public ChassisContractsRequestData entityRestrictions(ChassisContractsEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public ChassisContractsEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(ChassisContractsEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public ChassisContractsRequestData relationRestrictions(ChassisContractsRelationRestriction relationRestrictions) {
  ...
  **/
  ...
  public ChassisContractsRelationRestriction getRelationRestrictions() {
    return relationRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_RELATION_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRelationRestrictions(ChassisContractsRelationRestriction relationRestrictions) {
    this.relationRestrictions = relationRestrictions;
  }


  public ChassisContractsRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public ChassisContractsRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ChassisContractsRequestData chassisContractsRequestData = (ChassisContractsRequestData) o;
    return Objects.equals(this.returnEntityAttributes, chassisContractsRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, chassisContractsRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, chassisContractsRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, chassisContractsRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class ChassisContractsRequestData {\n");
