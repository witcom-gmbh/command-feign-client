...
import com.fntsoftware.businessgateway.entities.StorageDrivesEntityRestriction;
import com.fntsoftware.businessgateway.entities.StorageDrivesRelationRestriction;
...
/**
 * StorageDrivesRequestData
 */
@JsonPropertyOrder({
  StorageDrivesRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  StorageDrivesRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  StorageDrivesRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  StorageDrivesRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-01-31T11:10:37.320689708Z[Etc/UTC]")
public class StorageDrivesRequestData {
  ...
  private StorageDrivesEntityRestriction entityRestrictions;

  public static final String JSON_PROPERTY_RELATION_RESTRICTIONS = "relationRestrictions";
  private StorageDrivesRelationRestriction relationRestrictions;
  ...
  public StorageDrivesRequestData() {
  }

  public StorageDrivesRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public StorageDrivesRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public StorageDrivesRequestData entityRestrictions(StorageDrivesEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public StorageDrivesEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(StorageDrivesEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public StorageDrivesRequestData relationRestrictions(StorageDrivesRelationRestriction relationRestrictions) {
  ...
  **/
  ...
  public StorageDrivesRelationRestriction getRelationRestrictions() {
    return relationRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_RELATION_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRelationRestrictions(StorageDrivesRelationRestriction relationRestrictions) {
    this.relationRestrictions = relationRestrictions;
  }


  public StorageDrivesRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public StorageDrivesRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    StorageDrivesRequestData storageDrivesRequestData = (StorageDrivesRequestData) o;
    return Objects.equals(this.returnEntityAttributes, storageDrivesRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, storageDrivesRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, storageDrivesRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, storageDrivesRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class StorageDrivesRequestData {\n");
