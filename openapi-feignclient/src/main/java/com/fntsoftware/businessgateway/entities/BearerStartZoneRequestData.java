...
import com.fntsoftware.businessgateway.entities.BearerStartZoneEntityRestriction;
...
/**
 * BearerStartZoneRequestData
 */
@JsonPropertyOrder({
  BearerStartZoneRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  BearerStartZoneRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  BearerStartZoneRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  BearerStartZoneRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-03-04T13:31:32.601557352Z[Etc/UTC]")
public class BearerStartZoneRequestData {
  ...
  private BearerStartZoneEntityRestriction entityRestrictions;
  ...
  public BearerStartZoneRequestData() {
  }

  public BearerStartZoneRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public BearerStartZoneRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public BearerStartZoneRequestData entityRestrictions(BearerStartZoneEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public BearerStartZoneEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(BearerStartZoneEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public BearerStartZoneRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public BearerStartZoneRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public BearerStartZoneRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    BearerStartZoneRequestData bearerStartZoneRequestData = (BearerStartZoneRequestData) o;
    return Objects.equals(this.returnEntityAttributes, bearerStartZoneRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, bearerStartZoneRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, bearerStartZoneRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, bearerStartZoneRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class BearerStartZoneRequestData {\n");
