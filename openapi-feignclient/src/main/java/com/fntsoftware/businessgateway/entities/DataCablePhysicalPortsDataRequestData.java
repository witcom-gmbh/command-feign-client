...
import com.fntsoftware.businessgateway.entities.DataCablePhysicalPortsDataEntityRestriction;
...
/**
 * DataCablePhysicalPortsDataRequestData
 */
@JsonPropertyOrder({
  DataCablePhysicalPortsDataRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  DataCablePhysicalPortsDataRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  DataCablePhysicalPortsDataRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  DataCablePhysicalPortsDataRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-03-04T13:31:32.601557352Z[Etc/UTC]")
public class DataCablePhysicalPortsDataRequestData {
  ...
  private DataCablePhysicalPortsDataEntityRestriction entityRestrictions;
  ...
  public DataCablePhysicalPortsDataRequestData() {
  }

  public DataCablePhysicalPortsDataRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public DataCablePhysicalPortsDataRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public DataCablePhysicalPortsDataRequestData entityRestrictions(DataCablePhysicalPortsDataEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public DataCablePhysicalPortsDataEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(DataCablePhysicalPortsDataEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public DataCablePhysicalPortsDataRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public DataCablePhysicalPortsDataRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public DataCablePhysicalPortsDataRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    DataCablePhysicalPortsDataRequestData dataCablePhysicalPortsDataRequestData = (DataCablePhysicalPortsDataRequestData) o;
    return Objects.equals(this.returnEntityAttributes, dataCablePhysicalPortsDataRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, dataCablePhysicalPortsDataRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, dataCablePhysicalPortsDataRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, dataCablePhysicalPortsDataRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class DataCablePhysicalPortsDataRequestData {\n");
