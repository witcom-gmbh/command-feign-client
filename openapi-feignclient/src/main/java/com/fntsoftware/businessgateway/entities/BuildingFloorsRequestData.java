...
import com.fntsoftware.businessgateway.entities.BuildingFloorsEntityRestriction;
...
/**
 * BuildingFloorsRequestData
 */
@JsonPropertyOrder({
  BuildingFloorsRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  BuildingFloorsRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  BuildingFloorsRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  BuildingFloorsRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-02-26T11:20:24.990023935Z[Etc/UTC]")
public class BuildingFloorsRequestData {
  ...
  private BuildingFloorsEntityRestriction entityRestrictions;
  ...
  public BuildingFloorsRequestData() {
  }

  public BuildingFloorsRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public BuildingFloorsRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public BuildingFloorsRequestData entityRestrictions(BuildingFloorsEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public BuildingFloorsEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(BuildingFloorsEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public BuildingFloorsRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public BuildingFloorsRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public BuildingFloorsRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    BuildingFloorsRequestData buildingFloorsRequestData = (BuildingFloorsRequestData) o;
    return Objects.equals(this.returnEntityAttributes, buildingFloorsRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, buildingFloorsRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, buildingFloorsRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, buildingFloorsRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class BuildingFloorsRequestData {\n");
