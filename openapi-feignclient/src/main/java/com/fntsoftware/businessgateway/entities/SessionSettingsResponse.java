...
import com.fntsoftware.businessgateway.entities.SessionSettingsResponseData;
 ...
 */
@JsonPropertyOrder({
  SessionSettingsResponse.JSON_PROPERTY_RETURN_DATA,
  SessionSettingsResponse.JSON_PROPERTY_STATUS
})
...
public class SessionSettingsResponse {
  ...
  private List<SessionSettingsResponseData> returnData;
  ...
  public SessionSettingsResponse returnData(List<SessionSettingsResponseData> returnData) {
    
    this.returnData = returnData;
    return this;
  }

  public SessionSettingsResponse addReturnDataItem(SessionSettingsResponseData returnDataItem) {
  ...
  **/
  ...
  public List<SessionSettingsResponseData> getReturnData() {
    return returnData;
  }
  ...
  @JsonProperty(JSON_PROPERTY_RETURN_DATA)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setReturnData(List<SessionSettingsResponseData> returnData) {
    this.returnData = returnData;
  }


  public SessionSettingsResponse status(ServiceStatusData status) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.returnData, sessionSettingsResponse.returnData) &&
