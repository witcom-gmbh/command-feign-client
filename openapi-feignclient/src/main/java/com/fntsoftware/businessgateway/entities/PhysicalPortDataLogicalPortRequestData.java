...
import com.fntsoftware.businessgateway.entities.PhysicalPortDataLogicalPortEntityRestriction;
...
/**
 * PhysicalPortDataLogicalPortRequestData
 */
@JsonPropertyOrder({
  PhysicalPortDataLogicalPortRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  PhysicalPortDataLogicalPortRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  PhysicalPortDataLogicalPortRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  PhysicalPortDataLogicalPortRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-03-04T13:31:32.601557352Z[Etc/UTC]")
public class PhysicalPortDataLogicalPortRequestData {
  ...
  private PhysicalPortDataLogicalPortEntityRestriction entityRestrictions;
  ...
  public PhysicalPortDataLogicalPortRequestData() {
  }

  public PhysicalPortDataLogicalPortRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public PhysicalPortDataLogicalPortRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public PhysicalPortDataLogicalPortRequestData entityRestrictions(PhysicalPortDataLogicalPortEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public PhysicalPortDataLogicalPortEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(PhysicalPortDataLogicalPortEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public PhysicalPortDataLogicalPortRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public PhysicalPortDataLogicalPortRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public PhysicalPortDataLogicalPortRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    PhysicalPortDataLogicalPortRequestData physicalPortDataLogicalPortRequestData = (PhysicalPortDataLogicalPortRequestData) o;
    return Objects.equals(this.returnEntityAttributes, physicalPortDataLogicalPortRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, physicalPortDataLogicalPortRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, physicalPortDataLogicalPortRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, physicalPortDataLogicalPortRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class PhysicalPortDataLogicalPortRequestData {\n");
