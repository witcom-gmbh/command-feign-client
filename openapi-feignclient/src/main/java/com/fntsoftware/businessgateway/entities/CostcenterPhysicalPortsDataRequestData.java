...
import com.fntsoftware.businessgateway.entities.CostcenterPhysicalPortsDataEntityRestriction;
...
/**
 * CostcenterPhysicalPortsDataRequestData
 */
@JsonPropertyOrder({
  CostcenterPhysicalPortsDataRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  CostcenterPhysicalPortsDataRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  CostcenterPhysicalPortsDataRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  CostcenterPhysicalPortsDataRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-02-26T11:20:24.990023935Z[Etc/UTC]")
public class CostcenterPhysicalPortsDataRequestData {
  ...
  private CostcenterPhysicalPortsDataEntityRestriction entityRestrictions;
  ...
  public CostcenterPhysicalPortsDataRequestData() {
  }

  public CostcenterPhysicalPortsDataRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public CostcenterPhysicalPortsDataRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public CostcenterPhysicalPortsDataRequestData entityRestrictions(CostcenterPhysicalPortsDataEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public CostcenterPhysicalPortsDataEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(CostcenterPhysicalPortsDataEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public CostcenterPhysicalPortsDataRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public CostcenterPhysicalPortsDataRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public CostcenterPhysicalPortsDataRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    CostcenterPhysicalPortsDataRequestData costcenterPhysicalPortsDataRequestData = (CostcenterPhysicalPortsDataRequestData) o;
    return Objects.equals(this.returnEntityAttributes, costcenterPhysicalPortsDataRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, costcenterPhysicalPortsDataRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, costcenterPhysicalPortsDataRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, costcenterPhysicalPortsDataRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class CostcenterPhysicalPortsDataRequestData {\n");
