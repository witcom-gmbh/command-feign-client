...
import com.fntsoftware.businessgateway.entities.TerminalZoneEntityRestriction;
...
/**
 * TerminalZoneRequestData
 */
@JsonPropertyOrder({
  TerminalZoneRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  TerminalZoneRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  TerminalZoneRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  TerminalZoneRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-01-31T11:10:37.320689708Z[Etc/UTC]")
public class TerminalZoneRequestData {
  ...
  private TerminalZoneEntityRestriction entityRestrictions;
  ...
  public TerminalZoneRequestData() {
  }

  public TerminalZoneRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public TerminalZoneRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public TerminalZoneRequestData entityRestrictions(TerminalZoneEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public TerminalZoneEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(TerminalZoneEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public TerminalZoneRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public TerminalZoneRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public TerminalZoneRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    TerminalZoneRequestData terminalZoneRequestData = (TerminalZoneRequestData) o;
    return Objects.equals(this.returnEntityAttributes, terminalZoneRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, terminalZoneRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, terminalZoneRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, terminalZoneRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class TerminalZoneRequestData {\n");
