...
import com.fntsoftware.businessgateway.entities.NmModulePhysicalPortsPowerEntityRestriction;
...
/**
 * NmModulePhysicalPortsPowerRequestData
 */
@JsonPropertyOrder({
  NmModulePhysicalPortsPowerRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  NmModulePhysicalPortsPowerRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  NmModulePhysicalPortsPowerRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  NmModulePhysicalPortsPowerRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-03-04T13:31:32.601557352Z[Etc/UTC]")
public class NmModulePhysicalPortsPowerRequestData {
  ...
  private NmModulePhysicalPortsPowerEntityRestriction entityRestrictions;
  ...
  public NmModulePhysicalPortsPowerRequestData() {
  }

  public NmModulePhysicalPortsPowerRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public NmModulePhysicalPortsPowerRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public NmModulePhysicalPortsPowerRequestData entityRestrictions(NmModulePhysicalPortsPowerEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public NmModulePhysicalPortsPowerEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(NmModulePhysicalPortsPowerEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public NmModulePhysicalPortsPowerRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public NmModulePhysicalPortsPowerRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public NmModulePhysicalPortsPowerRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    NmModulePhysicalPortsPowerRequestData nmModulePhysicalPortsPowerRequestData = (NmModulePhysicalPortsPowerRequestData) o;
    return Objects.equals(this.returnEntityAttributes, nmModulePhysicalPortsPowerRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, nmModulePhysicalPortsPowerRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, nmModulePhysicalPortsPowerRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, nmModulePhysicalPortsPowerRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class NmModulePhysicalPortsPowerRequestData {\n");
