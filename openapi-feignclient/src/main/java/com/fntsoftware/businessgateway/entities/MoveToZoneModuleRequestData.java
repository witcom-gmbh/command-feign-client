...
import com.fntsoftware.businessgateway.entities.MoveToZoneModuleCreateLinkZoneRequestData;
import com.fasterxml.jackson.annotation.JsonPropertyOrder;
import com.fasterxml.jackson.annotation.JsonTypeName;

/**
 * MoveToZoneModuleRequestData
 */
@JsonPropertyOrder({
  MoveToZoneModuleRequestData.JSON_PROPERTY_RELEASE_SIGNALPATH,
  MoveToZoneModuleRequestData.JSON_PROPERTY_RELEASE_CONNECTIONS,
  MoveToZoneModuleRequestData.JSON_PROPERTY_RELEASE_SERVICE,
  MoveToZoneModuleRequestData.JSON_PROPERTY_RELEASE_SUPPORTS,
  MoveToZoneModuleRequestData.JSON_PROPERTY_RELEASE_PATCHES,
  MoveToZoneModuleRequestData.JSON_PROPERTY_CREATE_LINK_ZONE
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-02-26T11:20:24.990023935Z[Etc/UTC]")
public class MoveToZoneModuleRequestData {
  ...
  private MoveToZoneModuleCreateLinkZoneRequestData createLinkZone;

  public MoveToZoneModuleRequestData() {
  }

  public MoveToZoneModuleRequestData releaseSignalpath(Boolean releaseSignalpath) {
  ...
  **/
  ...
  public MoveToZoneModuleRequestData releaseConnections(Boolean releaseConnections) {
  ...
  **/
  ...
  public MoveToZoneModuleRequestData releaseService(Boolean releaseService) {
  ...
  **/
  ...
  public MoveToZoneModuleRequestData releaseSupports(Boolean releaseSupports) {
  ...
  **/
  ...
  public MoveToZoneModuleRequestData releasePatches(Boolean releasePatches) {
  ...
  **/
  ...
  public MoveToZoneModuleRequestData createLinkZone(MoveToZoneModuleCreateLinkZoneRequestData createLinkZone) {
  ...
  **/
  ...
  public MoveToZoneModuleCreateLinkZoneRequestData getCreateLinkZone() {
    return createLinkZone;
  }
  ...
  @JsonProperty(JSON_PROPERTY_CREATE_LINK_ZONE)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setCreateLinkZone(MoveToZoneModuleCreateLinkZoneRequestData createLinkZone) {
    this.createLinkZone = createLinkZone;
  }
  ...
  public boolean equals(Object o) {
    ...
    MoveToZoneModuleRequestData moveToZoneModuleRequestData = (MoveToZoneModuleRequestData) o;
    return Objects.equals(this.releaseSignalpath, moveToZoneModuleRequestData.releaseSignalpath) &&
        Objects.equals(this.releaseConnections, moveToZoneModuleRequestData.releaseConnections) &&
        Objects.equals(this.releaseService, moveToZoneModuleRequestData.releaseService) &&
        Objects.equals(this.releaseSupports, moveToZoneModuleRequestData.releaseSupports) &&
        Objects.equals(this.releasePatches, moveToZoneModuleRequestData.releasePatches) &&
        Objects.equals(this.createLinkZone, moveToZoneModuleRequestData.createLinkZone);
  }
  ...
  public String toString() {
    ...
    sb.append("class MoveToZoneModuleRequestData {\n");
