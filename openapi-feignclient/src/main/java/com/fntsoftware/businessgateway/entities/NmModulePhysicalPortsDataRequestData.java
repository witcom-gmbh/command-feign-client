...
import com.fntsoftware.businessgateway.entities.NmModulePhysicalPortsDataEntityRestriction;
...
/**
 * NmModulePhysicalPortsDataRequestData
 */
@JsonPropertyOrder({
  NmModulePhysicalPortsDataRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  NmModulePhysicalPortsDataRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  NmModulePhysicalPortsDataRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  NmModulePhysicalPortsDataRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-03-04T13:31:32.601557352Z[Etc/UTC]")
public class NmModulePhysicalPortsDataRequestData {
  ...
  private NmModulePhysicalPortsDataEntityRestriction entityRestrictions;
  ...
  public NmModulePhysicalPortsDataRequestData() {
  }

  public NmModulePhysicalPortsDataRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public NmModulePhysicalPortsDataRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public NmModulePhysicalPortsDataRequestData entityRestrictions(NmModulePhysicalPortsDataEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public NmModulePhysicalPortsDataEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(NmModulePhysicalPortsDataEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public NmModulePhysicalPortsDataRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public NmModulePhysicalPortsDataRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public NmModulePhysicalPortsDataRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    NmModulePhysicalPortsDataRequestData nmModulePhysicalPortsDataRequestData = (NmModulePhysicalPortsDataRequestData) o;
    return Objects.equals(this.returnEntityAttributes, nmModulePhysicalPortsDataRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, nmModulePhysicalPortsDataRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, nmModulePhysicalPortsDataRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, nmModulePhysicalPortsDataRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class NmModulePhysicalPortsDataRequestData {\n");
