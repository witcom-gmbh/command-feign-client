...
/**
 * DuctFromDeviceAllEntityRestriction
 */
@JsonPropertyOrder({
  DuctFromDeviceAllEntityRestriction.JSON_PROPERTY_CLIMATE_RELEVANT,
  DuctFromDeviceAllEntityRestriction.JSON_PROPERTY_POWER_CONSUMPTION,
  DuctFromDeviceAllEntityRestriction.JSON_PROPERTY_POWER_SWITCHING_STATUS,
  DuctFromDeviceAllEntityRestriction.JSON_PROPERTY_PLAN_STATUS,
  DuctFromDeviceAllEntityRestriction.JSON_PROPERTY_SYSTEM_RUNTIME,
  DuctFromDeviceAllEntityRestriction.JSON_PROPERTY_WEIGHT,
  DuctFromDeviceAllEntityRestriction.JSON_PROPERTY_REMARK,
  DuctFromDeviceAllEntityRestriction.JSON_PROPERTY_ELID,
  DuctFromDeviceAllEntityRestriction.JSON_PROPERTY_LAST_SEEN,
  DuctFromDeviceAllEntityRestriction.JSON_PROPERTY_TYPE_ELID,
  DuctFromDeviceAllEntityRestriction.JSON_PROPERTY_VISIBLE_ID,
  DuctFromDeviceAllEntityRestriction.JSON_PROPERTY_ID,
  DuctFromDeviceAllEntityRestriction.JSON_PROPERTY_HEAT_EMISSION
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-03-04T13:31:32.601557352Z[Etc/UTC]")
public class DuctFromDeviceAllEntityRestriction {
  ...
  public DuctFromDeviceAllEntityRestriction() {
  }

  public DuctFromDeviceAllEntityRestriction climateRelevant(RestrictionsBoolean climateRelevant) {
  ...
  **/
  ...
  public DuctFromDeviceAllEntityRestriction powerConsumption(RestrictionsNumeric powerConsumption) {
  ...
  **/
  ...
  public DuctFromDeviceAllEntityRestriction powerSwitchingStatus(RestrictionsString powerSwitchingStatus) {
  ...
  **/
  ...
  public DuctFromDeviceAllEntityRestriction planStatus(RestrictionsString planStatus) {
  ...
  **/
  ...
  public DuctFromDeviceAllEntityRestriction systemRuntime(RestrictionsNumeric systemRuntime) {
  ...
  **/
  ...
  public DuctFromDeviceAllEntityRestriction weight(RestrictionsNumeric weight) {
  ...
  **/
  ...
  public DuctFromDeviceAllEntityRestriction remark(RestrictionsString remark) {
  ...
  **/
  ...
  public DuctFromDeviceAllEntityRestriction elid(RestrictionsString elid) {
  ...
  **/
  ...
  public DuctFromDeviceAllEntityRestriction lastSeen(RestrictionsDate lastSeen) {
  ...
  **/
  ...
  public DuctFromDeviceAllEntityRestriction typeElid(RestrictionsString typeElid) {
  ...
  **/
  ...
  public DuctFromDeviceAllEntityRestriction visibleId(RestrictionsString visibleId) {
  ...
  **/
  ...
  public DuctFromDeviceAllEntityRestriction id(RestrictionsString id) {
  ...
  **/
  ...
  public DuctFromDeviceAllEntityRestriction heatEmission(RestrictionsNumeric heatEmission) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    DuctFromDeviceAllEntityRestriction ductFromDeviceAllEntityRestriction = (DuctFromDeviceAllEntityRestriction) o;
    return Objects.equals(this.climateRelevant, ductFromDeviceAllEntityRestriction.climateRelevant) &&
        Objects.equals(this.powerConsumption, ductFromDeviceAllEntityRestriction.powerConsumption) &&
        Objects.equals(this.powerSwitchingStatus, ductFromDeviceAllEntityRestriction.powerSwitchingStatus) &&
        Objects.equals(this.planStatus, ductFromDeviceAllEntityRestriction.planStatus) &&
        Objects.equals(this.systemRuntime, ductFromDeviceAllEntityRestriction.systemRuntime) &&
        Objects.equals(this.weight, ductFromDeviceAllEntityRestriction.weight) &&
        Objects.equals(this.remark, ductFromDeviceAllEntityRestriction.remark) &&
        Objects.equals(this.elid, ductFromDeviceAllEntityRestriction.elid) &&
        Objects.equals(this.lastSeen, ductFromDeviceAllEntityRestriction.lastSeen) &&
        Objects.equals(this.typeElid, ductFromDeviceAllEntityRestriction.typeElid) &&
        Objects.equals(this.visibleId, ductFromDeviceAllEntityRestriction.visibleId) &&
        Objects.equals(this.id, ductFromDeviceAllEntityRestriction.id) &&
        Objects.equals(this.heatEmission, ductFromDeviceAllEntityRestriction.heatEmission);
  }
  ...
  public String toString() {
    ...
    sb.append("class DuctFromDeviceAllEntityRestriction {\n");
