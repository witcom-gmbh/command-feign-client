...
/**
 * ChassisSlotEntityRestriction
 */
@JsonPropertyOrder({
  ChassisSlotEntityRestriction.JSON_PROPERTY_CLIMATE_RELEVANT,
  ChassisSlotEntityRestriction.JSON_PROPERTY_POWER_CONSUMPTION,
  ChassisSlotEntityRestriction.JSON_PROPERTY_POWER_SWITCHING_STATUS,
  ChassisSlotEntityRestriction.JSON_PROPERTY_PLAN_STATUS,
  ChassisSlotEntityRestriction.JSON_PROPERTY_SYSTEM_RUNTIME,
  ChassisSlotEntityRestriction.JSON_PROPERTY_WEIGHT,
  ChassisSlotEntityRestriction.JSON_PROPERTY_REMARK,
  ChassisSlotEntityRestriction.JSON_PROPERTY_ELID,
  ChassisSlotEntityRestriction.JSON_PROPERTY_LAST_SEEN,
  ChassisSlotEntityRestriction.JSON_PROPERTY_TYPE_ELID,
  ChassisSlotEntityRestriction.JSON_PROPERTY_VISIBLE_ID,
  ChassisSlotEntityRestriction.JSON_PROPERTY_ID,
  ChassisSlotEntityRestriction.JSON_PROPERTY_HEAT_EMISSION
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-01-31T11:10:37.320689708Z[Etc/UTC]")
public class ChassisSlotEntityRestriction {
  ...
  public ChassisSlotEntityRestriction() {
  }

  public ChassisSlotEntityRestriction climateRelevant(RestrictionsBoolean climateRelevant) {
  ...
  **/
  ...
  public ChassisSlotEntityRestriction powerConsumption(RestrictionsNumeric powerConsumption) {
  ...
  **/
  ...
  public ChassisSlotEntityRestriction powerSwitchingStatus(RestrictionsString powerSwitchingStatus) {
  ...
  **/
  ...
  public ChassisSlotEntityRestriction planStatus(RestrictionsString planStatus) {
  ...
  **/
  ...
  public ChassisSlotEntityRestriction systemRuntime(RestrictionsNumeric systemRuntime) {
  ...
  **/
  ...
  public ChassisSlotEntityRestriction weight(RestrictionsNumeric weight) {
  ...
  **/
  ...
  public ChassisSlotEntityRestriction remark(RestrictionsString remark) {
  ...
  **/
  ...
  public ChassisSlotEntityRestriction elid(RestrictionsString elid) {
  ...
  **/
  ...
  public ChassisSlotEntityRestriction lastSeen(RestrictionsDate lastSeen) {
  ...
  **/
  ...
  public ChassisSlotEntityRestriction typeElid(RestrictionsString typeElid) {
  ...
  **/
  ...
  public ChassisSlotEntityRestriction visibleId(RestrictionsString visibleId) {
  ...
  **/
  ...
  public ChassisSlotEntityRestriction id(RestrictionsString id) {
  ...
  **/
  ...
  public ChassisSlotEntityRestriction heatEmission(RestrictionsNumeric heatEmission) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ChassisSlotEntityRestriction chassisSlotEntityRestriction = (ChassisSlotEntityRestriction) o;
    return Objects.equals(this.climateRelevant, chassisSlotEntityRestriction.climateRelevant) &&
        Objects.equals(this.powerConsumption, chassisSlotEntityRestriction.powerConsumption) &&
        Objects.equals(this.powerSwitchingStatus, chassisSlotEntityRestriction.powerSwitchingStatus) &&
        Objects.equals(this.planStatus, chassisSlotEntityRestriction.planStatus) &&
        Objects.equals(this.systemRuntime, chassisSlotEntityRestriction.systemRuntime) &&
        Objects.equals(this.weight, chassisSlotEntityRestriction.weight) &&
        Objects.equals(this.remark, chassisSlotEntityRestriction.remark) &&
        Objects.equals(this.elid, chassisSlotEntityRestriction.elid) &&
        Objects.equals(this.lastSeen, chassisSlotEntityRestriction.lastSeen) &&
        Objects.equals(this.typeElid, chassisSlotEntityRestriction.typeElid) &&
        Objects.equals(this.visibleId, chassisSlotEntityRestriction.visibleId) &&
        Objects.equals(this.id, chassisSlotEntityRestriction.id) &&
        Objects.equals(this.heatEmission, chassisSlotEntityRestriction.heatEmission);
  }
  ...
  public String toString() {
    ...
    sb.append("class ChassisSlotEntityRestriction {\n");
