...
import com.fntsoftware.businessgateway.entities.PowerCableCustomTcoInterconnectEntityRestriction;
...
/**
 * PowerCableCustomTcoInterconnectRequestData
 */
@JsonPropertyOrder({
  PowerCableCustomTcoInterconnectRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  PowerCableCustomTcoInterconnectRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  PowerCableCustomTcoInterconnectRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  PowerCableCustomTcoInterconnectRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-01-31T11:10:37.320689708Z[Etc/UTC]")
public class PowerCableCustomTcoInterconnectRequestData {
  ...
  private PowerCableCustomTcoInterconnectEntityRestriction entityRestrictions;
  ...
  public PowerCableCustomTcoInterconnectRequestData() {
  }

  public PowerCableCustomTcoInterconnectRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public PowerCableCustomTcoInterconnectRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public PowerCableCustomTcoInterconnectRequestData entityRestrictions(PowerCableCustomTcoInterconnectEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public PowerCableCustomTcoInterconnectEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(PowerCableCustomTcoInterconnectEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public PowerCableCustomTcoInterconnectRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public PowerCableCustomTcoInterconnectRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public PowerCableCustomTcoInterconnectRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    PowerCableCustomTcoInterconnectRequestData powerCableCustomTcoInterconnectRequestData = (PowerCableCustomTcoInterconnectRequestData) o;
    return Objects.equals(this.returnEntityAttributes, powerCableCustomTcoInterconnectRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, powerCableCustomTcoInterconnectRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, powerCableCustomTcoInterconnectRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, powerCableCustomTcoInterconnectRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class PowerCableCustomTcoInterconnectRequestData {\n");
