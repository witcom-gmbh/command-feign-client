...
/**
 * FusePhysicalPortsPowerEntityRestriction
 */
@JsonPropertyOrder({
  FusePhysicalPortsPowerEntityRestriction.JSON_PROPERTY_SOCKET_NAME_SPC,
  FusePhysicalPortsPowerEntityRestriction.JSON_PROPERTY_BORDER_COLOR,
  FusePhysicalPortsPowerEntityRestriction.JSON_PROPERTY_DEVICE_ALL_ELID,
  FusePhysicalPortsPowerEntityRestriction.JSON_PROPERTY_SOCKET_NAME,
  FusePhysicalPortsPowerEntityRestriction.JSON_PROPERTY_PORT_IDENTIFIER,
  FusePhysicalPortsPowerEntityRestriction.JSON_PROPERTY_WIRE_TYPE,
  FusePhysicalPortsPowerEntityRestriction.JSON_PROPERTY_PORT_NETWORK_CATEGORY,
  FusePhysicalPortsPowerEntityRestriction.JSON_PROPERTY_PORT_CATEGORY,
  FusePhysicalPortsPowerEntityRestriction.JSON_PROPERTY_SOCKET_NO,
  FusePhysicalPortsPowerEntityRestriction.JSON_PROPERTY_MEDIUM,
  FusePhysicalPortsPowerEntityRestriction.JSON_PROPERTY_CONNECTOR,
  FusePhysicalPortsPowerEntityRestriction.JSON_PROPERTY_SOCKET_SIDE,
  FusePhysicalPortsPowerEntityRestriction.JSON_PROPERTY_SOCKET_SUB_NO,
  FusePhysicalPortsPowerEntityRestriction.JSON_PROPERTY_STATUS_REMARK,
  FusePhysicalPortsPowerEntityRestriction.JSON_PROPERTY_DEVICE_ALL_ID,
  FusePhysicalPortsPowerEntityRestriction.JSON_PROPERTY_PLAN_PORT_NETWORK_CATEGORY,
  FusePhysicalPortsPowerEntityRestriction.JSON_PROPERTY_STATUS
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-02-26T11:20:24.990023935Z[Etc/UTC]")
public class FusePhysicalPortsPowerEntityRestriction {
  ...
  public FusePhysicalPortsPowerEntityRestriction() {
  }

  public FusePhysicalPortsPowerEntityRestriction socketNameSpc(RestrictionsString socketNameSpc) {
  ...
  **/
  ...
  public FusePhysicalPortsPowerEntityRestriction borderColor(RestrictionsString borderColor) {
  ...
  **/
  ...
  public FusePhysicalPortsPowerEntityRestriction deviceAllElid(RestrictionsString deviceAllElid) {
  ...
  **/
  ...
  public FusePhysicalPortsPowerEntityRestriction socketName(RestrictionsString socketName) {
  ...
  **/
  ...
  public FusePhysicalPortsPowerEntityRestriction portIdentifier(RestrictionsString portIdentifier) {
  ...
  **/
  ...
  public FusePhysicalPortsPowerEntityRestriction wireType(RestrictionsString wireType) {
  ...
  **/
  ...
  public FusePhysicalPortsPowerEntityRestriction portNetworkCategory(RestrictionsString portNetworkCategory) {
  ...
  **/
  ...
  public FusePhysicalPortsPowerEntityRestriction portCategory(RestrictionsString portCategory) {
  ...
  **/
  ...
  public FusePhysicalPortsPowerEntityRestriction socketNo(RestrictionsNumeric socketNo) {
  ...
  **/
  ...
  public FusePhysicalPortsPowerEntityRestriction medium(RestrictionsString medium) {
  ...
  **/
  ...
  public FusePhysicalPortsPowerEntityRestriction connector(RestrictionsString connector) {
  ...
  **/
  ...
  public FusePhysicalPortsPowerEntityRestriction socketSide(RestrictionsString socketSide) {
  ...
  **/
  ...
  public FusePhysicalPortsPowerEntityRestriction socketSubNo(RestrictionsNumeric socketSubNo) {
  ...
  **/
  ...
  public FusePhysicalPortsPowerEntityRestriction statusRemark(RestrictionsString statusRemark) {
  ...
  **/
  ...
  public FusePhysicalPortsPowerEntityRestriction deviceAllId(RestrictionsString deviceAllId) {
  ...
  **/
  ...
  public FusePhysicalPortsPowerEntityRestriction planPortNetworkCategory(RestrictionsString planPortNetworkCategory) {
  ...
  **/
  ...
  public FusePhysicalPortsPowerEntityRestriction status(RestrictionsString status) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    FusePhysicalPortsPowerEntityRestriction fusePhysicalPortsPowerEntityRestriction = (FusePhysicalPortsPowerEntityRestriction) o;
    return Objects.equals(this.socketNameSpc, fusePhysicalPortsPowerEntityRestriction.socketNameSpc) &&
        Objects.equals(this.borderColor, fusePhysicalPortsPowerEntityRestriction.borderColor) &&
        Objects.equals(this.deviceAllElid, fusePhysicalPortsPowerEntityRestriction.deviceAllElid) &&
        Objects.equals(this.socketName, fusePhysicalPortsPowerEntityRestriction.socketName) &&
        Objects.equals(this.portIdentifier, fusePhysicalPortsPowerEntityRestriction.portIdentifier) &&
        Objects.equals(this.wireType, fusePhysicalPortsPowerEntityRestriction.wireType) &&
        Objects.equals(this.portNetworkCategory, fusePhysicalPortsPowerEntityRestriction.portNetworkCategory) &&
        Objects.equals(this.portCategory, fusePhysicalPortsPowerEntityRestriction.portCategory) &&
        Objects.equals(this.socketNo, fusePhysicalPortsPowerEntityRestriction.socketNo) &&
        Objects.equals(this.medium, fusePhysicalPortsPowerEntityRestriction.medium) &&
        Objects.equals(this.connector, fusePhysicalPortsPowerEntityRestriction.connector) &&
        Objects.equals(this.socketSide, fusePhysicalPortsPowerEntityRestriction.socketSide) &&
        Objects.equals(this.socketSubNo, fusePhysicalPortsPowerEntityRestriction.socketSubNo) &&
        Objects.equals(this.statusRemark, fusePhysicalPortsPowerEntityRestriction.statusRemark) &&
        Objects.equals(this.deviceAllId, fusePhysicalPortsPowerEntityRestriction.deviceAllId) &&
        Objects.equals(this.planPortNetworkCategory, fusePhysicalPortsPowerEntityRestriction.planPortNetworkCategory) &&
        Objects.equals(this.status, fusePhysicalPortsPowerEntityRestriction.status);
  }
  ...
  public String toString() {
    ...
    sb.append("class FusePhysicalPortsPowerEntityRestriction {\n");
