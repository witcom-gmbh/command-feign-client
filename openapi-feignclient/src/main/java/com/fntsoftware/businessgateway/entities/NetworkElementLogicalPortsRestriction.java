...
public class NetworkElementLogicalPortsRestriction {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(portElid, physPort2, portStatus, portName, ptolp, portNo, atm, portNameOrg, signalRate, activeFrom, nominalUtilization, rxServiceElid, deviceAllElid, overloadWarning, bandwidth, txServiceElid, elid, physPort2Side, portType, physPort, physPortSide, deviceAllId, portFunction, ima, activeUntil);
  }
