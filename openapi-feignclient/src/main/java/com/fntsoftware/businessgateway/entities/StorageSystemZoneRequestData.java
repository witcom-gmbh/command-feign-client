...
import com.fntsoftware.businessgateway.entities.StorageSystemZoneEntityRestriction;
...
/**
 * StorageSystemZoneRequestData
 */
@JsonPropertyOrder({
  StorageSystemZoneRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  StorageSystemZoneRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  StorageSystemZoneRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  StorageSystemZoneRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-01-31T11:10:37.320689708Z[Etc/UTC]")
public class StorageSystemZoneRequestData {
  ...
  private StorageSystemZoneEntityRestriction entityRestrictions;
  ...
  public StorageSystemZoneRequestData() {
  }

  public StorageSystemZoneRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public StorageSystemZoneRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public StorageSystemZoneRequestData entityRestrictions(StorageSystemZoneEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public StorageSystemZoneEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(StorageSystemZoneEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public StorageSystemZoneRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public StorageSystemZoneRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public StorageSystemZoneRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    StorageSystemZoneRequestData storageSystemZoneRequestData = (StorageSystemZoneRequestData) o;
    return Objects.equals(this.returnEntityAttributes, storageSystemZoneRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, storageSystemZoneRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, storageSystemZoneRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, storageSystemZoneRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class StorageSystemZoneRequestData {\n");
