...
/**
 * ServiceTelcoPathDevicesAllEntityRestriction
 */
@JsonPropertyOrder({
  ServiceTelcoPathDevicesAllEntityRestriction.JSON_PROPERTY_CLIMATE_RELEVANT,
  ServiceTelcoPathDevicesAllEntityRestriction.JSON_PROPERTY_POWER_CONSUMPTION,
  ServiceTelcoPathDevicesAllEntityRestriction.JSON_PROPERTY_POWER_SWITCHING_STATUS,
  ServiceTelcoPathDevicesAllEntityRestriction.JSON_PROPERTY_PLAN_STATUS,
  ServiceTelcoPathDevicesAllEntityRestriction.JSON_PROPERTY_SYSTEM_RUNTIME,
  ServiceTelcoPathDevicesAllEntityRestriction.JSON_PROPERTY_WEIGHT,
  ServiceTelcoPathDevicesAllEntityRestriction.JSON_PROPERTY_REMARK,
  ServiceTelcoPathDevicesAllEntityRestriction.JSON_PROPERTY_ELID,
  ServiceTelcoPathDevicesAllEntityRestriction.JSON_PROPERTY_LAST_SEEN,
  ServiceTelcoPathDevicesAllEntityRestriction.JSON_PROPERTY_TYPE_ELID,
  ServiceTelcoPathDevicesAllEntityRestriction.JSON_PROPERTY_VISIBLE_ID,
  ServiceTelcoPathDevicesAllEntityRestriction.JSON_PROPERTY_ID,
  ServiceTelcoPathDevicesAllEntityRestriction.JSON_PROPERTY_HEAT_EMISSION
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-01-31T11:10:37.320689708Z[Etc/UTC]")
public class ServiceTelcoPathDevicesAllEntityRestriction {
  ...
  public ServiceTelcoPathDevicesAllEntityRestriction() {
  }

  public ServiceTelcoPathDevicesAllEntityRestriction climateRelevant(RestrictionsBoolean climateRelevant) {
  ...
  **/
  ...
  public ServiceTelcoPathDevicesAllEntityRestriction powerConsumption(RestrictionsNumeric powerConsumption) {
  ...
  **/
  ...
  public ServiceTelcoPathDevicesAllEntityRestriction powerSwitchingStatus(RestrictionsString powerSwitchingStatus) {
  ...
  **/
  ...
  public ServiceTelcoPathDevicesAllEntityRestriction planStatus(RestrictionsString planStatus) {
  ...
  **/
  ...
  public ServiceTelcoPathDevicesAllEntityRestriction systemRuntime(RestrictionsNumeric systemRuntime) {
  ...
  **/
  ...
  public ServiceTelcoPathDevicesAllEntityRestriction weight(RestrictionsNumeric weight) {
  ...
  **/
  ...
  public ServiceTelcoPathDevicesAllEntityRestriction remark(RestrictionsString remark) {
  ...
  **/
  ...
  public ServiceTelcoPathDevicesAllEntityRestriction elid(RestrictionsString elid) {
  ...
  **/
  ...
  public ServiceTelcoPathDevicesAllEntityRestriction lastSeen(RestrictionsDate lastSeen) {
  ...
  **/
  ...
  public ServiceTelcoPathDevicesAllEntityRestriction typeElid(RestrictionsString typeElid) {
  ...
  **/
  ...
  public ServiceTelcoPathDevicesAllEntityRestriction visibleId(RestrictionsString visibleId) {
  ...
  **/
  ...
  public ServiceTelcoPathDevicesAllEntityRestriction id(RestrictionsString id) {
  ...
  **/
  ...
  public ServiceTelcoPathDevicesAllEntityRestriction heatEmission(RestrictionsNumeric heatEmission) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ServiceTelcoPathDevicesAllEntityRestriction serviceTelcoPathDevicesAllEntityRestriction = (ServiceTelcoPathDevicesAllEntityRestriction) o;
    return Objects.equals(this.climateRelevant, serviceTelcoPathDevicesAllEntityRestriction.climateRelevant) &&
        Objects.equals(this.powerConsumption, serviceTelcoPathDevicesAllEntityRestriction.powerConsumption) &&
        Objects.equals(this.powerSwitchingStatus, serviceTelcoPathDevicesAllEntityRestriction.powerSwitchingStatus) &&
        Objects.equals(this.planStatus, serviceTelcoPathDevicesAllEntityRestriction.planStatus) &&
        Objects.equals(this.systemRuntime, serviceTelcoPathDevicesAllEntityRestriction.systemRuntime) &&
        Objects.equals(this.weight, serviceTelcoPathDevicesAllEntityRestriction.weight) &&
        Objects.equals(this.remark, serviceTelcoPathDevicesAllEntityRestriction.remark) &&
        Objects.equals(this.elid, serviceTelcoPathDevicesAllEntityRestriction.elid) &&
        Objects.equals(this.lastSeen, serviceTelcoPathDevicesAllEntityRestriction.lastSeen) &&
        Objects.equals(this.typeElid, serviceTelcoPathDevicesAllEntityRestriction.typeElid) &&
        Objects.equals(this.visibleId, serviceTelcoPathDevicesAllEntityRestriction.visibleId) &&
        Objects.equals(this.id, serviceTelcoPathDevicesAllEntityRestriction.id) &&
        Objects.equals(this.heatEmission, serviceTelcoPathDevicesAllEntityRestriction.heatEmission);
  }
  ...
  public String toString() {
    ...
    sb.append("class ServiceTelcoPathDevicesAllEntityRestriction {\n");
