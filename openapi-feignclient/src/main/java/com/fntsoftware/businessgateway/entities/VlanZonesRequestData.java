...
import com.fntsoftware.businessgateway.entities.VlanZonesEntityRestriction;
import com.fntsoftware.businessgateway.entities.VlanZonesRelationRestriction;
...
/**
 * VlanZonesRequestData
 */
@JsonPropertyOrder({
  VlanZonesRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  VlanZonesRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  VlanZonesRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  VlanZonesRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-01-31T11:10:37.320689708Z[Etc/UTC]")
public class VlanZonesRequestData {
  ...
  private VlanZonesEntityRestriction entityRestrictions;

  public static final String JSON_PROPERTY_RELATION_RESTRICTIONS = "relationRestrictions";
  private VlanZonesRelationRestriction relationRestrictions;
  ...
  public VlanZonesRequestData() {
  }

  public VlanZonesRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public VlanZonesRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public VlanZonesRequestData entityRestrictions(VlanZonesEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public VlanZonesEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(VlanZonesEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public VlanZonesRequestData relationRestrictions(VlanZonesRelationRestriction relationRestrictions) {
  ...
  **/
  ...
  public VlanZonesRelationRestriction getRelationRestrictions() {
    return relationRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_RELATION_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRelationRestrictions(VlanZonesRelationRestriction relationRestrictions) {
    this.relationRestrictions = relationRestrictions;
  }


  public VlanZonesRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public VlanZonesRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    VlanZonesRequestData vlanZonesRequestData = (VlanZonesRequestData) o;
    return Objects.equals(this.returnEntityAttributes, vlanZonesRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, vlanZonesRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, vlanZonesRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, vlanZonesRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class VlanZonesRequestData {\n");
