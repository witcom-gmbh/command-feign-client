...
import com.fntsoftware.businessgateway.entities.NodePersonsEntityRestriction;
import com.fntsoftware.businessgateway.entities.NodePersonsRelationRestriction;
...
/**
 * NodePersonsRequestData
 */
@JsonPropertyOrder({
  NodePersonsRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  NodePersonsRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  NodePersonsRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  NodePersonsRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-03-04T13:31:32.601557352Z[Etc/UTC]")
public class NodePersonsRequestData {
  ...
  private NodePersonsEntityRestriction entityRestrictions;

  public static final String JSON_PROPERTY_RELATION_RESTRICTIONS = "relationRestrictions";
  private NodePersonsRelationRestriction relationRestrictions;
  ...
  public NodePersonsRequestData() {
  }

  public NodePersonsRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public NodePersonsRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public NodePersonsRequestData entityRestrictions(NodePersonsEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public NodePersonsEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(NodePersonsEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public NodePersonsRequestData relationRestrictions(NodePersonsRelationRestriction relationRestrictions) {
  ...
  **/
  ...
  public NodePersonsRelationRestriction getRelationRestrictions() {
    return relationRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_RELATION_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRelationRestrictions(NodePersonsRelationRestriction relationRestrictions) {
    this.relationRestrictions = relationRestrictions;
  }


  public NodePersonsRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public NodePersonsRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    NodePersonsRequestData nodePersonsRequestData = (NodePersonsRequestData) o;
    return Objects.equals(this.returnEntityAttributes, nodePersonsRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, nodePersonsRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, nodePersonsRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, nodePersonsRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class NodePersonsRequestData {\n");
