...
import com.fntsoftware.businessgateway.entities.MultiDuctToDeviceAllEntityRestriction;
...
/**
 * MultiDuctToDeviceAllRequestData
 */
@JsonPropertyOrder({
  MultiDuctToDeviceAllRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  MultiDuctToDeviceAllRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  MultiDuctToDeviceAllRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  MultiDuctToDeviceAllRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-03-04T13:31:32.601557352Z[Etc/UTC]")
public class MultiDuctToDeviceAllRequestData {
  ...
  private MultiDuctToDeviceAllEntityRestriction entityRestrictions;
  ...
  public MultiDuctToDeviceAllRequestData() {
  }

  public MultiDuctToDeviceAllRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public MultiDuctToDeviceAllRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public MultiDuctToDeviceAllRequestData entityRestrictions(MultiDuctToDeviceAllEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public MultiDuctToDeviceAllEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(MultiDuctToDeviceAllEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public MultiDuctToDeviceAllRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public MultiDuctToDeviceAllRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public MultiDuctToDeviceAllRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    MultiDuctToDeviceAllRequestData multiDuctToDeviceAllRequestData = (MultiDuctToDeviceAllRequestData) o;
    return Objects.equals(this.returnEntityAttributes, multiDuctToDeviceAllRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, multiDuctToDeviceAllRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, multiDuctToDeviceAllRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, multiDuctToDeviceAllRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class MultiDuctToDeviceAllRequestData {\n");
