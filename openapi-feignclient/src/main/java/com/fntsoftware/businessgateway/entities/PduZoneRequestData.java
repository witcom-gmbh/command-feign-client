...
import com.fntsoftware.businessgateway.entities.PduZoneEntityRestriction;
 ...
 */
@JsonPropertyOrder({
  PduZoneRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  PduZoneRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  PduZoneRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  PduZoneRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-02-26T11:20:24.990023935Z[Etc/UTC]")
public class PduZoneRequestData {
  ...
  private PduZoneEntityRestriction entityRestrictions;
  ...
  public PduZoneRequestData() {
  }

  public PduZoneRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public PduZoneRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public PduZoneRequestData entityRestrictions(PduZoneEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public PduZoneEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(PduZoneEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public PduZoneRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public PduZoneRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public PduZoneRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    PduZoneRequestData pduZoneRequestData = (PduZoneRequestData) o;
    return Objects.equals(this.returnEntityAttributes, pduZoneRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, pduZoneRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, pduZoneRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, pduZoneRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class PduZoneRequestData {\n");
