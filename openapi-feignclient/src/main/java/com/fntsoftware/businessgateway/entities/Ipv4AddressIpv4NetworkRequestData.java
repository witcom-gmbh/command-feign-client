...
import com.fntsoftware.businessgateway.entities.Ipv4AddressIpv4NetworkEntityRestriction;
...
/**
 * Ipv4AddressIpv4NetworkRequestData
 */
@JsonPropertyOrder({
  Ipv4AddressIpv4NetworkRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  Ipv4AddressIpv4NetworkRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  Ipv4AddressIpv4NetworkRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  Ipv4AddressIpv4NetworkRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-01-31T11:10:37.320689708Z[Etc/UTC]")
public class Ipv4AddressIpv4NetworkRequestData {
  ...
  private Ipv4AddressIpv4NetworkEntityRestriction entityRestrictions;
  ...
  public Ipv4AddressIpv4NetworkRequestData() {
  }

  public Ipv4AddressIpv4NetworkRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public Ipv4AddressIpv4NetworkRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public Ipv4AddressIpv4NetworkRequestData entityRestrictions(Ipv4AddressIpv4NetworkEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public Ipv4AddressIpv4NetworkEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(Ipv4AddressIpv4NetworkEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public Ipv4AddressIpv4NetworkRequestData relationRestrictions(Object relationRestrictions) {
  ...
  **/
  ...
  public Ipv4AddressIpv4NetworkRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public Ipv4AddressIpv4NetworkRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    Ipv4AddressIpv4NetworkRequestData ipv4AddressIpv4NetworkRequestData = (Ipv4AddressIpv4NetworkRequestData) o;
    return Objects.equals(this.returnEntityAttributes, ipv4AddressIpv4NetworkRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, ipv4AddressIpv4NetworkRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, ipv4AddressIpv4NetworkRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, ipv4AddressIpv4NetworkRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class Ipv4AddressIpv4NetworkRequestData {\n");
