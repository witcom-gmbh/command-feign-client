...
/**
 * UpdateSystemAttributesFuseUpdateUserRequestData
 */
@JsonPropertyOrder({
  UpdateSystemAttributesFuseUpdateUserRequestData.JSON_PROPERTY_MODIFY_PLAN,
  UpdateSystemAttributesFuseUpdateUserRequestData.JSON_PROPERTY_DELETE_REAL,
  UpdateSystemAttributesFuseUpdateUserRequestData.JSON_PROPERTY_READ_PLAN,
  UpdateSystemAttributesFuseUpdateUserRequestData.JSON_PROPERTY_MANDANT_ID,
  UpdateSystemAttributesFuseUpdateUserRequestData.JSON_PROPERTY_USER_ELID,
  UpdateSystemAttributesFuseUpdateUserRequestData.JSON_PROPERTY_MODIFY_REAL,
  UpdateSystemAttributesFuseUpdateUserRequestData.JSON_PROPERTY_READ_REAL,
  UpdateSystemAttributesFuseUpdateUserRequestData.JSON_PROPERTY_DELETE_PLAN
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-02-26T11:20:24.990023935Z[Etc/UTC]")
public class UpdateSystemAttributesFuseUpdateUserRequestData {
  ...
  public UpdateSystemAttributesFuseUpdateUserRequestData() {
  }

  public UpdateSystemAttributesFuseUpdateUserRequestData modifyPlan(Boolean modifyPlan) {
  ...
  **/
  ...
  public UpdateSystemAttributesFuseUpdateUserRequestData deleteReal(Boolean deleteReal) {
  ...
  **/
  ...
  public UpdateSystemAttributesFuseUpdateUserRequestData readPlan(Boolean readPlan) {
  ...
  **/
  ...
  public UpdateSystemAttributesFuseUpdateUserRequestData mandantId(BigDecimal mandantId) {
  ...
  **/
  ...
  public UpdateSystemAttributesFuseUpdateUserRequestData userElid(String userElid) {
  ...
  **/
  ...
  public UpdateSystemAttributesFuseUpdateUserRequestData modifyReal(Boolean modifyReal) {
  ...
  **/
  ...
  public UpdateSystemAttributesFuseUpdateUserRequestData readReal(Boolean readReal) {
  ...
  **/
  ...
  public UpdateSystemAttributesFuseUpdateUserRequestData deletePlan(Boolean deletePlan) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    UpdateSystemAttributesFuseUpdateUserRequestData updateSystemAttributesFuseUpdateUserRequestData = (UpdateSystemAttributesFuseUpdateUserRequestData) o;
    return Objects.equals(this.modifyPlan, updateSystemAttributesFuseUpdateUserRequestData.modifyPlan) &&
        Objects.equals(this.deleteReal, updateSystemAttributesFuseUpdateUserRequestData.deleteReal) &&
        Objects.equals(this.readPlan, updateSystemAttributesFuseUpdateUserRequestData.readPlan) &&
        Objects.equals(this.mandantId, updateSystemAttributesFuseUpdateUserRequestData.mandantId) &&
        Objects.equals(this.userElid, updateSystemAttributesFuseUpdateUserRequestData.userElid) &&
        Objects.equals(this.modifyReal, updateSystemAttributesFuseUpdateUserRequestData.modifyReal) &&
        Objects.equals(this.readReal, updateSystemAttributesFuseUpdateUserRequestData.readReal) &&
        Objects.equals(this.deletePlan, updateSystemAttributesFuseUpdateUserRequestData.deletePlan);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateSystemAttributesFuseUpdateUserRequestData {\n");
