...
/**
 * PhysicalPortPowerQueryResponseData
 */
@JsonPropertyOrder({
  PhysicalPortPowerQueryResponseData.JSON_PROPERTY_SOCKET_NAME_SPC,
  PhysicalPortPowerQueryResponseData.JSON_PROPERTY_BORDER_COLOR,
  PhysicalPortPowerQueryResponseData.JSON_PROPERTY_DEVICE_ALL_ELID,
  PhysicalPortPowerQueryResponseData.JSON_PROPERTY_SOCKET_NAME,
  PhysicalPortPowerQueryResponseData.JSON_PROPERTY_PORT_IDENTIFIER,
  PhysicalPortPowerQueryResponseData.JSON_PROPERTY_WIRE_TYPE,
  PhysicalPortPowerQueryResponseData.JSON_PROPERTY_PORT_NETWORK_CATEGORY,
  PhysicalPortPowerQueryResponseData.JSON_PROPERTY_PORT_CATEGORY,
  PhysicalPortPowerQueryResponseData.JSON_PROPERTY_SOCKET_NO,
  PhysicalPortPowerQueryResponseData.JSON_PROPERTY_MEDIUM,
  PhysicalPortPowerQueryResponseData.JSON_PROPERTY_CONNECTOR,
  PhysicalPortPowerQueryResponseData.JSON_PROPERTY_SOCKET_SIDE,
  PhysicalPortPowerQueryResponseData.JSON_PROPERTY_SOCKET_SUB_NO,
  PhysicalPortPowerQueryResponseData.JSON_PROPERTY_STATUS_REMARK,
  PhysicalPortPowerQueryResponseData.JSON_PROPERTY_DEVICE_ALL_ID,
  PhysicalPortPowerQueryResponseData.JSON_PROPERTY_PLAN_PORT_NETWORK_CATEGORY,
  PhysicalPortPowerQueryResponseData.JSON_PROPERTY_STATUS
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-02-26T11:20:24.990023935Z[Etc/UTC]")
public class PhysicalPortPowerQueryResponseData {
  ...
  public PhysicalPortPowerQueryResponseData() {
  }

  public PhysicalPortPowerQueryResponseData socketNameSpc(String socketNameSpc) {
  ...
  **/
  ...
  public PhysicalPortPowerQueryResponseData borderColor(String borderColor) {
  ...
  **/
  ...
  public PhysicalPortPowerQueryResponseData deviceAllElid(String deviceAllElid) {
  ...
  **/
  ...
  public PhysicalPortPowerQueryResponseData socketName(String socketName) {
  ...
  **/
  ...
  public PhysicalPortPowerQueryResponseData portIdentifier(String portIdentifier) {
  ...
  **/
  ...
  public PhysicalPortPowerQueryResponseData wireType(String wireType) {
  ...
  **/
  ...
  public PhysicalPortPowerQueryResponseData portNetworkCategory(String portNetworkCategory) {
  ...
  **/
  ...
  public PhysicalPortPowerQueryResponseData portCategory(String portCategory) {
  ...
  **/
  ...
  public PhysicalPortPowerQueryResponseData socketNo(BigDecimal socketNo) {
  ...
  **/
  ...
  public PhysicalPortPowerQueryResponseData medium(String medium) {
  ...
  **/
  ...
  public PhysicalPortPowerQueryResponseData connector(String connector) {
  ...
  **/
  ...
  public PhysicalPortPowerQueryResponseData socketSide(String socketSide) {
  ...
  **/
  ...
  public PhysicalPortPowerQueryResponseData socketSubNo(BigDecimal socketSubNo) {
  ...
  **/
  ...
  public PhysicalPortPowerQueryResponseData statusRemark(String statusRemark) {
  ...
  **/
  ...
  public PhysicalPortPowerQueryResponseData deviceAllId(String deviceAllId) {
  ...
  **/
  ...
  public PhysicalPortPowerQueryResponseData planPortNetworkCategory(String planPortNetworkCategory) {
  ...
  **/
  ...
  public PhysicalPortPowerQueryResponseData status(String status) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    PhysicalPortPowerQueryResponseData physicalPortPowerQueryResponseData = (PhysicalPortPowerQueryResponseData) o;
    return Objects.equals(this.socketNameSpc, physicalPortPowerQueryResponseData.socketNameSpc) &&
        Objects.equals(this.borderColor, physicalPortPowerQueryResponseData.borderColor) &&
        Objects.equals(this.deviceAllElid, physicalPortPowerQueryResponseData.deviceAllElid) &&
        Objects.equals(this.socketName, physicalPortPowerQueryResponseData.socketName) &&
        Objects.equals(this.portIdentifier, physicalPortPowerQueryResponseData.portIdentifier) &&
        Objects.equals(this.wireType, physicalPortPowerQueryResponseData.wireType) &&
        Objects.equals(this.portNetworkCategory, physicalPortPowerQueryResponseData.portNetworkCategory) &&
        Objects.equals(this.portCategory, physicalPortPowerQueryResponseData.portCategory) &&
        Objects.equals(this.socketNo, physicalPortPowerQueryResponseData.socketNo) &&
        Objects.equals(this.medium, physicalPortPowerQueryResponseData.medium) &&
        Objects.equals(this.connector, physicalPortPowerQueryResponseData.connector) &&
        Objects.equals(this.socketSide, physicalPortPowerQueryResponseData.socketSide) &&
        Objects.equals(this.socketSubNo, physicalPortPowerQueryResponseData.socketSubNo) &&
        Objects.equals(this.statusRemark, physicalPortPowerQueryResponseData.statusRemark) &&
        Objects.equals(this.deviceAllId, physicalPortPowerQueryResponseData.deviceAllId) &&
        Objects.equals(this.planPortNetworkCategory, physicalPortPowerQueryResponseData.planPortNetworkCategory) &&
        Objects.equals(this.status, physicalPortPowerQueryResponseData.status);
  }
  ...
  public String toString() {
    ...
    sb.append("class PhysicalPortPowerQueryResponseData {\n");
