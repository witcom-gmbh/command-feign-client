...
/**
 * StorageBaseIpAddressesResponseData
 */
@JsonPropertyOrder({
  StorageBaseIpAddressesResponseData.JSON_PROPERTY_ASSIGNED_DIRECTLY,
  StorageBaseIpAddressesResponseData.JSON_PROPERTY_INTERFACE,
  StorageBaseIpAddressesResponseData.JSON_PROPERTY_PORTS,
  StorageBaseIpAddressesResponseData.JSON_PROPERTY_OBJECT_ELID,
  StorageBaseIpAddressesResponseData.JSON_PROPERTY_OBJECT_ID
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-01-31T11:10:37.320689708Z[Etc/UTC]")
public class StorageBaseIpAddressesResponseData {
  ...
  public StorageBaseIpAddressesResponseData() {
  }

  public StorageBaseIpAddressesResponseData assignedDirectly(Boolean assignedDirectly) {
  ...
  **/
  ...
  public StorageBaseIpAddressesResponseData _interface(InterfaceinterfaceWithAddressData _interface) {
  ...
  **/
  ...
  public StorageBaseIpAddressesResponseData ports(List<PhysicalPortDataphysicalPortDataInfo> ports) {
    
    this.ports = ports;
    return this;
  }

  public StorageBaseIpAddressesResponseData addPortsItem(PhysicalPortDataphysicalPortDataInfo portsItem) {
    if (this.ports == null) {
  ...
  **/
  ...
  public StorageBaseIpAddressesResponseData objectElid(String objectElid) {
  ...
  **/
  ...
  public StorageBaseIpAddressesResponseData objectId(String objectId) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    StorageBaseIpAddressesResponseData storageBaseIpAddressesResponseData = (StorageBaseIpAddressesResponseData) o;
    return Objects.equals(this.assignedDirectly, storageBaseIpAddressesResponseData.assignedDirectly) &&
        Objects.equals(this._interface, storageBaseIpAddressesResponseData._interface) &&
        Objects.equals(this.ports, storageBaseIpAddressesResponseData.ports) &&
        Objects.equals(this.objectElid, storageBaseIpAddressesResponseData.objectElid) &&
        Objects.equals(this.objectId, storageBaseIpAddressesResponseData.objectId);
  }
  ...
  public String toString() {
    ...
    sb.append("class StorageBaseIpAddressesResponseData {\n");
