...
/**
 * DataSocketSitesEntityRestriction
 */
@JsonPropertyOrder({
  DataSocketSitesEntityRestriction.JSON_PROPERTY_ROOF_TYPE,
  DataSocketSitesEntityRestriction.JSON_PROPERTY_REMARK,
  DataSocketSitesEntityRestriction.JSON_PROPERTY_ELID,
  DataSocketSitesEntityRestriction.JSON_PROPERTY_MAST_CONSTRUCTION,
  DataSocketSitesEntityRestriction.JSON_PROPERTY_AREA_TYPE,
  DataSocketSitesEntityRestriction.JSON_PROPERTY_BUILDING_HEIGHT,
  DataSocketSitesEntityRestriction.JSON_PROPERTY_NAME,
  DataSocketSitesEntityRestriction.JSON_PROPERTY_MAST_TYPE_OF_USE,
  DataSocketSitesEntityRestriction.JSON_PROPERTY_ID,
  DataSocketSitesEntityRestriction.JSON_PROPERTY_CATEGORY,
  DataSocketSitesEntityRestriction.JSON_PROPERTY_BUILDING_TYPE,
  DataSocketSitesEntityRestriction.JSON_PROPERTY_DEVELOPMENT_STATUS,
  DataSocketSitesEntityRestriction.JSON_PROPERTY_LAND_USE,
  DataSocketSitesEntityRestriction.JSON_PROPERTY_STATUS
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-01-31T11:10:37.320689708Z[Etc/UTC]")
public class DataSocketSitesEntityRestriction {
  ...
  public DataSocketSitesEntityRestriction() {
  }

  public DataSocketSitesEntityRestriction roofType(RestrictionsString roofType) {
  ...
  **/
  ...
  public DataSocketSitesEntityRestriction remark(RestrictionsString remark) {
  ...
  **/
  ...
  public DataSocketSitesEntityRestriction elid(RestrictionsString elid) {
  ...
  **/
  ...
  public DataSocketSitesEntityRestriction mastConstruction(RestrictionsString mastConstruction) {
  ...
  **/
  ...
  public DataSocketSitesEntityRestriction areaType(RestrictionsString areaType) {
  ...
  **/
  ...
  public DataSocketSitesEntityRestriction buildingHeight(RestrictionsNumeric buildingHeight) {
  ...
  **/
  ...
  public DataSocketSitesEntityRestriction name(RestrictionsString name) {
  ...
  **/
  ...
  public DataSocketSitesEntityRestriction mastTypeOfUse(RestrictionsString mastTypeOfUse) {
  ...
  **/
  ...
  public DataSocketSitesEntityRestriction id(RestrictionsString id) {
  ...
  **/
  ...
  public DataSocketSitesEntityRestriction category(RestrictionsString category) {
  ...
  **/
  ...
  public DataSocketSitesEntityRestriction buildingType(RestrictionsString buildingType) {
  ...
  **/
  ...
  public DataSocketSitesEntityRestriction developmentStatus(RestrictionsString developmentStatus) {
  ...
  **/
  ...
  public DataSocketSitesEntityRestriction landUse(RestrictionsString landUse) {
  ...
  **/
  ...
  public DataSocketSitesEntityRestriction status(RestrictionsString status) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    DataSocketSitesEntityRestriction dataSocketSitesEntityRestriction = (DataSocketSitesEntityRestriction) o;
    return Objects.equals(this.roofType, dataSocketSitesEntityRestriction.roofType) &&
        Objects.equals(this.remark, dataSocketSitesEntityRestriction.remark) &&
        Objects.equals(this.elid, dataSocketSitesEntityRestriction.elid) &&
        Objects.equals(this.mastConstruction, dataSocketSitesEntityRestriction.mastConstruction) &&
        Objects.equals(this.areaType, dataSocketSitesEntityRestriction.areaType) &&
        Objects.equals(this.buildingHeight, dataSocketSitesEntityRestriction.buildingHeight) &&
        Objects.equals(this.name, dataSocketSitesEntityRestriction.name) &&
        Objects.equals(this.mastTypeOfUse, dataSocketSitesEntityRestriction.mastTypeOfUse) &&
        Objects.equals(this.id, dataSocketSitesEntityRestriction.id) &&
        Objects.equals(this.category, dataSocketSitesEntityRestriction.category) &&
        Objects.equals(this.buildingType, dataSocketSitesEntityRestriction.buildingType) &&
        Objects.equals(this.developmentStatus, dataSocketSitesEntityRestriction.developmentStatus) &&
        Objects.equals(this.landUse, dataSocketSitesEntityRestriction.landUse) &&
        Objects.equals(this.status, dataSocketSitesEntityRestriction.status);
  }
  ...
  public String toString() {
    ...
    sb.append("class DataSocketSitesEntityRestriction {\n");
