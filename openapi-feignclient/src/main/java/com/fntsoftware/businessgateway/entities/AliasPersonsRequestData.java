...
import com.fntsoftware.businessgateway.entities.AliasPersonsEntityRestriction;
import com.fntsoftware.businessgateway.entities.AliasPersonsRelationRestriction;
...
/**
 * AliasPersonsRequestData
 */
@JsonPropertyOrder({
  AliasPersonsRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  AliasPersonsRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  AliasPersonsRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  AliasPersonsRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-02-26T11:20:24.990023935Z[Etc/UTC]")
public class AliasPersonsRequestData {
  ...
  private AliasPersonsEntityRestriction entityRestrictions;

  public static final String JSON_PROPERTY_RELATION_RESTRICTIONS = "relationRestrictions";
  private AliasPersonsRelationRestriction relationRestrictions;
  ...
  public AliasPersonsRequestData() {
  }

  public AliasPersonsRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public AliasPersonsRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public AliasPersonsRequestData entityRestrictions(AliasPersonsEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public AliasPersonsEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(AliasPersonsEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public AliasPersonsRequestData relationRestrictions(AliasPersonsRelationRestriction relationRestrictions) {
  ...
  **/
  ...
  public AliasPersonsRelationRestriction getRelationRestrictions() {
    return relationRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_RELATION_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRelationRestrictions(AliasPersonsRelationRestriction relationRestrictions) {
    this.relationRestrictions = relationRestrictions;
  }


  public AliasPersonsRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public AliasPersonsRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    AliasPersonsRequestData aliasPersonsRequestData = (AliasPersonsRequestData) o;
    return Objects.equals(this.returnEntityAttributes, aliasPersonsRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, aliasPersonsRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, aliasPersonsRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, aliasPersonsRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class AliasPersonsRequestData {\n");
