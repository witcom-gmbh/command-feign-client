...
/**
 * UpdateSystemAttributesAliasAddUserRequestData
 */
@JsonPropertyOrder({
  UpdateSystemAttributesAliasAddUserRequestData.JSON_PROPERTY_MODIFY_PLAN,
  UpdateSystemAttributesAliasAddUserRequestData.JSON_PROPERTY_DELETE_REAL,
  UpdateSystemAttributesAliasAddUserRequestData.JSON_PROPERTY_READ_PLAN,
  UpdateSystemAttributesAliasAddUserRequestData.JSON_PROPERTY_MANDANT_ID,
  UpdateSystemAttributesAliasAddUserRequestData.JSON_PROPERTY_USER_ELID,
  UpdateSystemAttributesAliasAddUserRequestData.JSON_PROPERTY_MODIFY_REAL,
  UpdateSystemAttributesAliasAddUserRequestData.JSON_PROPERTY_READ_REAL,
  UpdateSystemAttributesAliasAddUserRequestData.JSON_PROPERTY_DELETE_PLAN
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-03-04T13:31:32.601557352Z[Etc/UTC]")
public class UpdateSystemAttributesAliasAddUserRequestData {
  ...
  public UpdateSystemAttributesAliasAddUserRequestData() {
  }

  public UpdateSystemAttributesAliasAddUserRequestData modifyPlan(Boolean modifyPlan) {
  ...
  **/
  ...
  public UpdateSystemAttributesAliasAddUserRequestData deleteReal(Boolean deleteReal) {
  ...
  **/
  ...
  public UpdateSystemAttributesAliasAddUserRequestData readPlan(Boolean readPlan) {
  ...
  **/
  ...
  public UpdateSystemAttributesAliasAddUserRequestData mandantId(BigDecimal mandantId) {
  ...
  **/
  ...
  public UpdateSystemAttributesAliasAddUserRequestData userElid(String userElid) {
  ...
  **/
  ...
  public UpdateSystemAttributesAliasAddUserRequestData modifyReal(Boolean modifyReal) {
  ...
  **/
  ...
  public UpdateSystemAttributesAliasAddUserRequestData readReal(Boolean readReal) {
  ...
  **/
  ...
  public UpdateSystemAttributesAliasAddUserRequestData deletePlan(Boolean deletePlan) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    UpdateSystemAttributesAliasAddUserRequestData updateSystemAttributesAliasAddUserRequestData = (UpdateSystemAttributesAliasAddUserRequestData) o;
    return Objects.equals(this.modifyPlan, updateSystemAttributesAliasAddUserRequestData.modifyPlan) &&
        Objects.equals(this.deleteReal, updateSystemAttributesAliasAddUserRequestData.deleteReal) &&
        Objects.equals(this.readPlan, updateSystemAttributesAliasAddUserRequestData.readPlan) &&
        Objects.equals(this.mandantId, updateSystemAttributesAliasAddUserRequestData.mandantId) &&
        Objects.equals(this.userElid, updateSystemAttributesAliasAddUserRequestData.userElid) &&
        Objects.equals(this.modifyReal, updateSystemAttributesAliasAddUserRequestData.modifyReal) &&
        Objects.equals(this.readReal, updateSystemAttributesAliasAddUserRequestData.readReal) &&
        Objects.equals(this.deletePlan, updateSystemAttributesAliasAddUserRequestData.deletePlan);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateSystemAttributesAliasAddUserRequestData {\n");
