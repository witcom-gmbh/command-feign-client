...
import com.fntsoftware.businessgateway.entities.PduPersonsEntityRestriction;
import com.fntsoftware.businessgateway.entities.PduPersonsRelationRestriction;
...
/**
 * PduPersonsRequestData
 */
@JsonPropertyOrder({
  PduPersonsRequestData.JSON_PROPERTY_RETURN_ENTITY_ATTRIBUTES,
  PduPersonsRequestData.JSON_PROPERTY_ENTITY_RESTRICTIONS,
  PduPersonsRequestData.JSON_PROPERTY_RELATION_RESTRICTIONS,
  PduPersonsRequestData.JSON_PROPERTY_RETURN_RELATION_ATTRIBUTES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-03-04T13:31:32.601557352Z[Etc/UTC]")
public class PduPersonsRequestData {
  ...
  private PduPersonsEntityRestriction entityRestrictions;

  public static final String JSON_PROPERTY_RELATION_RESTRICTIONS = "relationRestrictions";
  private PduPersonsRelationRestriction relationRestrictions;
  ...
  public PduPersonsRequestData() {
  }

  public PduPersonsRequestData returnEntityAttributes(List<String> returnEntityAttributes) {
    
    this.returnEntityAttributes = returnEntityAttributes;
    return this;
  }

  public PduPersonsRequestData addReturnEntityAttributesItem(String returnEntityAttributesItem) {
  ...
  **/
  ...
  public PduPersonsRequestData entityRestrictions(PduPersonsEntityRestriction entityRestrictions) {
  ...
  **/
  ...
  public PduPersonsEntityRestriction getEntityRestrictions() {
    return entityRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityRestrictions(PduPersonsEntityRestriction entityRestrictions) {
    this.entityRestrictions = entityRestrictions;
  }


  public PduPersonsRequestData relationRestrictions(PduPersonsRelationRestriction relationRestrictions) {
  ...
  **/
  ...
  public PduPersonsRelationRestriction getRelationRestrictions() {
    return relationRestrictions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_RELATION_RESTRICTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRelationRestrictions(PduPersonsRelationRestriction relationRestrictions) {
    this.relationRestrictions = relationRestrictions;
  }


  public PduPersonsRequestData returnRelationAttributes(List<String> returnRelationAttributes) {
    
    this.returnRelationAttributes = returnRelationAttributes;
    return this;
  }

  public PduPersonsRequestData addReturnRelationAttributesItem(String returnRelationAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    PduPersonsRequestData pduPersonsRequestData = (PduPersonsRequestData) o;
    return Objects.equals(this.returnEntityAttributes, pduPersonsRequestData.returnEntityAttributes) &&
        Objects.equals(this.entityRestrictions, pduPersonsRequestData.entityRestrictions) &&
        Objects.equals(this.relationRestrictions, pduPersonsRequestData.relationRestrictions) &&
        Objects.equals(this.returnRelationAttributes, pduPersonsRequestData.returnRelationAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class PduPersonsRequestData {\n");
