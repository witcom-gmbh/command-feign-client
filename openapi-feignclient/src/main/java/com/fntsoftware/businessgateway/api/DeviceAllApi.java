...
import com.fntsoftware.businessgateway.entities.DeviceAllPhysicalPortsPowerRequest;
import com.fntsoftware.businessgateway.entities.DeviceAllPhysicalPortsPowerResponse;
...
public interface DeviceAllApi extends ApiClient.Api {
  ...
  * but this one also exposes the Http response headers
   ...
   * @param elid  (required)
   * @param body  (required)
   * @return DeviceAllPhysicalPortsPowerResponse
   */
  ...
  DeviceAllPhysicalPortsPowerResponse deviceAllPhysicalPortsPower(@Param("sessionId") String sessionId, @Param("elid") String elid, DeviceAllPhysicalPortsPowerRequest body);
  ...
  ApiResponse<DeviceAllPhysicalPortsPowerResponse> deviceAllPhysicalPortsPowerWithHttpInfo(@Param("sessionId") String sessionId, @Param("elid") String elid, DeviceAllPhysicalPortsPowerRequest body);
  ...
  DeviceAllPhysicalPortsPowerResponse deviceAllPhysicalPortsPower(@Param("elid") String elid, DeviceAllPhysicalPortsPowerRequest body, @QueryMap(encoded=true) DeviceAllPhysicalPortsPowerQueryParams queryParams);
  ...
  * but this one also exposes the Http response headers
   ...
   ApiResponse<DeviceAllPhysicalPortsPowerResponse> deviceAllPhysicalPortsPowerWithHttpInfo(@Param("elid") String elid, DeviceAllPhysicalPortsPowerRequest body, @QueryMap(encoded=true) DeviceAllPhysicalPortsPowerQueryParams queryParams);
