...
import com.fntsoftware.businessgateway.entities.DeviceMiscPhysicalPortsPowerRequest;
import com.fntsoftware.businessgateway.entities.DeviceMiscPhysicalPortsPowerResponse;
...
public interface DeviceMiscApi extends ApiClient.Api {
  ...
  * but this one also exposes the Http response headers
   ...
   * @param elid  (required)
   * @param body  (required)
   * @return DeviceMiscPhysicalPortsPowerResponse
   */
  ...
  DeviceMiscPhysicalPortsPowerResponse deviceMiscPhysicalPortsPower(@Param("sessionId") String sessionId, @Param("elid") String elid, DeviceMiscPhysicalPortsPowerRequest body);
  ...
  ApiResponse<DeviceMiscPhysicalPortsPowerResponse> deviceMiscPhysicalPortsPowerWithHttpInfo(@Param("sessionId") String sessionId, @Param("elid") String elid, DeviceMiscPhysicalPortsPowerRequest body);
  ...
  DeviceMiscPhysicalPortsPowerResponse deviceMiscPhysicalPortsPower(@Param("elid") String elid, DeviceMiscPhysicalPortsPowerRequest body, @QueryMap(encoded=true) DeviceMiscPhysicalPortsPowerQueryParams queryParams);
  ...
  * but this one also exposes the Http response headers
   ...
   ApiResponse<DeviceMiscPhysicalPortsPowerResponse> deviceMiscPhysicalPortsPowerWithHttpInfo(@Param("elid") String elid, DeviceMiscPhysicalPortsPowerRequest body, @QueryMap(encoded=true) DeviceMiscPhysicalPortsPowerQueryParams queryParams);
