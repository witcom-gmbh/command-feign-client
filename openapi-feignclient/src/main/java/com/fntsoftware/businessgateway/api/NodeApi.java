...
import com.fntsoftware.businessgateway.entities.ChangeTypeNodeRequestData;
import com.fntsoftware.businessgateway.entities.ChangeTypeNodeResponse;
...
import com.fntsoftware.businessgateway.entities.GenerateIdNodeRequestData;
import com.fntsoftware.businessgateway.entities.GenerateIdNodeResponse;
...
import com.fntsoftware.businessgateway.entities.NodeInheritedGeoCoordinatesRequest;
import com.fntsoftware.businessgateway.entities.NodeInheritedGeoCoordinatesResponse;
...
import com.fntsoftware.businessgateway.entities.NodeQueryLogicalCisRequest;
import com.fntsoftware.businessgateway.entities.NodeQueryLogicalCisResponse;
import com.fntsoftware.businessgateway.entities.NodeQueryNodeSidesRequest;
import com.fntsoftware.businessgateway.entities.NodeQueryNodeSidesResponse;
import com.fntsoftware.businessgateway.entities.NodeQueryPhysicalCisRequest;
import com.fntsoftware.businessgateway.entities.NodeQueryPhysicalCisResponse;
...
public interface NodeApi extends ApiClient.Api {
   ...
   * @param elid  (required)
   * @param body  (required)
   * @return ChangeTypeNodeResponse
   */
  @RequestLine("POST /api/rest/entity/node/{elid}/changeType?sessionId={sessionId}")
  @Headers({
    "Content-Type: application/json",
    "Accept: application/json",
  })
  ChangeTypeNodeResponse changeTypeNode(@Param("sessionId") String sessionId, @Param("elid") String elid, ChangeTypeNodeRequestData body);

  /**
   * Change node type
   * Similar to <code>changeTypeNode</code> but it also returns the http response headers .
   * Change node type
   * @param sessionId Session-ID (required)
   * @param elid  (required)
   * @param body  (required)
  ...
  ApiResponse<ChangeTypeNodeResponse> changeTypeNodeWithHttpInfo(@Param("sessionId") String sessionId, @Param("elid") String elid, ChangeTypeNodeRequestData body);


  /**
   * Change node type
   * Change node type
   * Note, this is equivalent to the other <code>changeTypeNode</code> method,
   * but with the query parameters collected into a single Map parameter. This
   * is convenient for services with optional query parameters, especially when
   * used with the {@link ChangeTypeNodeQueryParams} class that allows for
  ...
  ChangeTypeNodeResponse changeTypeNode(@Param("elid") String elid, ChangeTypeNodeRequestData body, @QueryMap(encoded=true) ChangeTypeNodeQueryParams queryParams);

  /**
  * Change node type
  * Change node type
  * Note, this is equivalent to the other <code>changeTypeNode</code> that receives the query parameters as a map,
  * but this one also exposes the Http response headers
   ...
   ApiResponse<ChangeTypeNodeResponse> changeTypeNodeWithHttpInfo(@Param("elid") String elid, ChangeTypeNodeRequestData body, @QueryMap(encoded=true) ChangeTypeNodeQueryParams queryParams);


   /**
   * A convenience class for generating query parameters for the
   * <code>changeTypeNode</code> method in a fluent style.
   */
  public static class ChangeTypeNodeQueryParams extends HashMap<String, Object> {
    public ChangeTypeNodeQueryParams sessionId(final String value) {
  ...
  * but this one also exposes the Http response headers
   ...
   * @param sessionId Session-ID (required)
   * @param body  (required)
   * @return GenerateIdNodeResponse
   */
  @RequestLine("POST /api/rest/entity/node/generateId?sessionId={sessionId}")
  @Headers({
    "Content-Type: application/json",
    "Accept: application/json",
  })
  GenerateIdNodeResponse generateIdNode(@Param("sessionId") String sessionId, GenerateIdNodeRequestData body);

  /**
   * Generate Node-ID
   * Similar to <code>generateIdNode</code> but it also returns the http response headers .
   * Generates an ID that can be used for creating a new node.
   * @param sessionId Session-ID (required)
   * @param body  (required)
   * @return A ApiResponse that wraps the response boyd and the http headers.
  ...
  ApiResponse<GenerateIdNodeResponse> generateIdNodeWithHttpInfo(@Param("sessionId") String sessionId, GenerateIdNodeRequestData body);


  /**
   * Generate Node-ID
   * Generates an ID that can be used for creating a new node.
   * Note, this is equivalent to the other <code>generateIdNode</code> method,
   * but with the query parameters collected into a single Map parameter. This
   * is convenient for services with optional query parameters, especially when
   * used with the {@link GenerateIdNodeQueryParams} class that allows for
   * building up this map in a fluent style.
   * @param body  (required)
   * @param queryParams Map of query parameters as name-value pairs
   *   <p>The following elements may be specified in the query map:</p>
  ...
  GenerateIdNodeResponse generateIdNode(GenerateIdNodeRequestData body, @QueryMap(encoded=true) GenerateIdNodeQueryParams queryParams);

  /**
  * Generate Node-ID
  * Generates an ID that can be used for creating a new node.
  * Note, this is equivalent to the other <code>generateIdNode</code> that receives the query parameters as a map,
  * but this one also exposes the Http response headers
              * @param body  (required)
      * @param queryParams Map of query parameters as name-value pairs
      *   <p>The following elements may be specified in the query map:</p>
   ...
   ApiResponse<GenerateIdNodeResponse> generateIdNodeWithHttpInfo(GenerateIdNodeRequestData body, @QueryMap(encoded=true) GenerateIdNodeQueryParams queryParams);


   /**
   * A convenience class for generating query parameters for the
   * <code>generateIdNode</code> method in a fluent style.
   */
  public static class GenerateIdNodeQueryParams extends HashMap<String, Object> {
    public GenerateIdNodeQueryParams sessionId(final String value) {
      put("sessionId", EncodingUtils.encode(value));
      return this;
    }
  }
  ...
  * but this one also exposes the Http response headers
   ...
   * @param sessionId Session-ID (required)
   * @param body  (required)
   * @return NodeInheritedGeoCoordinatesResponse
   */
  @RequestLine("POST /api/rest/entity/node/inheritedGeoCoordinates?sessionId={sessionId}")
  @Headers({
    "Content-Type: application/json",
    "Accept: application/json",
  })
  NodeInheritedGeoCoordinatesResponse nodeInheritedGeoCoordinates(@Param("sessionId") String sessionId, NodeInheritedGeoCoordinatesRequest body);

  /**
   * Query inherited coordinates
   * Similar to <code>nodeInheritedGeoCoordinates</code> but it also returns the http response headers .
   * Query the own coordinates of an object or inherit them from parents
   * @param sessionId Session-ID (required)
   * @param body  (required)
   * @return A ApiResponse that wraps the response boyd and the http headers.
  ...
  ApiResponse<NodeInheritedGeoCoordinatesResponse> nodeInheritedGeoCoordinatesWithHttpInfo(@Param("sessionId") String sessionId, NodeInheritedGeoCoordinatesRequest body);


  /**
   * Query inherited coordinates
   * Query the own coordinates of an object or inherit them from parents
   * Note, this is equivalent to the other <code>nodeInheritedGeoCoordinates</code> method,
   * but with the query parameters collected into a single Map parameter. This
   * is convenient for services with optional query parameters, especially when
   * used with the {@link NodeInheritedGeoCoordinatesQueryParams} class that allows for
   * building up this map in a fluent style.
   * @param body  (required)
   * @param queryParams Map of query parameters as name-value pairs
   *   <p>The following elements may be specified in the query map:</p>
  ...
  NodeInheritedGeoCoordinatesResponse nodeInheritedGeoCoordinates(NodeInheritedGeoCoordinatesRequest body, @QueryMap(encoded=true) NodeInheritedGeoCoordinatesQueryParams queryParams);

  /**
  * Query inherited coordinates
  * Query the own coordinates of an object or inherit them from parents
  * Note, this is equivalent to the other <code>nodeInheritedGeoCoordinates</code> that receives the query parameters as a map,
  * but this one also exposes the Http response headers
              * @param body  (required)
      * @param queryParams Map of query parameters as name-value pairs
      *   <p>The following elements may be specified in the query map:</p>
   ...
   ApiResponse<NodeInheritedGeoCoordinatesResponse> nodeInheritedGeoCoordinatesWithHttpInfo(NodeInheritedGeoCoordinatesRequest body, @QueryMap(encoded=true) NodeInheritedGeoCoordinatesQueryParams queryParams);


   /**
   * A convenience class for generating query parameters for the
   * <code>nodeInheritedGeoCoordinates</code> method in a fluent style.
   */
  public static class NodeInheritedGeoCoordinatesQueryParams extends HashMap<String, Object> {
    public NodeInheritedGeoCoordinatesQueryParams sessionId(final String value) {
      put("sessionId", EncodingUtils.encode(value));
      return this;
    }
  }
  ...
  * but this one also exposes the Http response headers
  ...
  /**
   * Query logical objects
   * Supplies all logical objects that are linked to a specific node.
   * @param sessionId Session-ID (required)
   * @param body  (required)
   * @return NodeQueryLogicalCisResponse
   */
  @RequestLine("POST /api/rest/entity/node/queryLogicalCis?sessionId={sessionId}")
  @Headers({
    "Content-Type: application/json",
    "Accept: application/json",
  })
  NodeQueryLogicalCisResponse nodeQueryLogicalCis(@Param("sessionId") String sessionId, NodeQueryLogicalCisRequest body);

  /**
   * Query logical objects
   * Similar to <code>nodeQueryLogicalCis</code> but it also returns the http response headers .
   * Supplies all logical objects that are linked to a specific node.
   * @param sessionId Session-ID (required)
   * @param body  (required)
   * @return A ApiResponse that wraps the response boyd and the http headers.
  ...
  ApiResponse<NodeQueryLogicalCisResponse> nodeQueryLogicalCisWithHttpInfo(@Param("sessionId") String sessionId, NodeQueryLogicalCisRequest body);


  /**
   * Query logical objects
   * Supplies all logical objects that are linked to a specific node.
   * Note, this is equivalent to the other <code>nodeQueryLogicalCis</code> method,
   * but with the query parameters collected into a single Map parameter. This
   * is convenient for services with optional query parameters, especially when
   * used with the {@link NodeQueryLogicalCisQueryParams} class that allows for
   * building up this map in a fluent style.
   * @param body  (required)
   * @param queryParams Map of query parameters as name-value pairs
   *   <p>The following elements may be specified in the query map:</p>
  ...
  NodeQueryLogicalCisResponse nodeQueryLogicalCis(NodeQueryLogicalCisRequest body, @QueryMap(encoded=true) NodeQueryLogicalCisQueryParams queryParams);

  /**
  * Query logical objects
  * Supplies all logical objects that are linked to a specific node.
  * Note, this is equivalent to the other <code>nodeQueryLogicalCis</code> that receives the query parameters as a map,
  * but this one also exposes the Http response headers
              * @param body  (required)
      * @param queryParams Map of query parameters as name-value pairs
      *   <p>The following elements may be specified in the query map:</p>
   ...
   ApiResponse<NodeQueryLogicalCisResponse> nodeQueryLogicalCisWithHttpInfo(NodeQueryLogicalCisRequest body, @QueryMap(encoded=true) NodeQueryLogicalCisQueryParams queryParams);


   /**
   * A convenience class for generating query parameters for the
   * <code>nodeQueryLogicalCis</code> method in a fluent style.
   */
  public static class NodeQueryLogicalCisQueryParams extends HashMap<String, Object> {
    public NodeQueryLogicalCisQueryParams sessionId(final String value) {
      put("sessionId", EncodingUtils.encode(value));
      return this;
    }
  }
  ...
  /**
   * Query node sides
   * Supplies all available node sides for the specified node.
   * @param sessionId Session-ID (required)
   * @param body  (required)
   * @return NodeQueryNodeSidesResponse
   */
  @RequestLine("POST /api/rest/entity/node/queryNodeSides?sessionId={sessionId}")
  @Headers({
    "Content-Type: application/json",
    "Accept: application/json",
  })
  NodeQueryNodeSidesResponse nodeQueryNodeSides(@Param("sessionId") String sessionId, NodeQueryNodeSidesRequest body);

  /**
   * Query node sides
   * Similar to <code>nodeQueryNodeSides</code> but it also returns the http response headers .
   * Supplies all available node sides for the specified node.
   * @param sessionId Session-ID (required)
   * @param body  (required)
   * @return A ApiResponse that wraps the response boyd and the http headers.
  ...
  ApiResponse<NodeQueryNodeSidesResponse> nodeQueryNodeSidesWithHttpInfo(@Param("sessionId") String sessionId, NodeQueryNodeSidesRequest body);


  /**
   * Query node sides
   * Supplies all available node sides for the specified node.
   * Note, this is equivalent to the other <code>nodeQueryNodeSides</code> method,
   * but with the query parameters collected into a single Map parameter. This
   * is convenient for services with optional query parameters, especially when
   * used with the {@link NodeQueryNodeSidesQueryParams} class that allows for
   * building up this map in a fluent style.
   * @param body  (required)
   * @param queryParams Map of query parameters as name-value pairs
   *   <p>The following elements may be specified in the query map:</p>
  ...
  NodeQueryNodeSidesResponse nodeQueryNodeSides(NodeQueryNodeSidesRequest body, @QueryMap(encoded=true) NodeQueryNodeSidesQueryParams queryParams);

  /**
  * Query node sides
  * Supplies all available node sides for the specified node.
  * Note, this is equivalent to the other <code>nodeQueryNodeSides</code> that receives the query parameters as a map,
  * but this one also exposes the Http response headers
              * @param body  (required)
      * @param queryParams Map of query parameters as name-value pairs
      *   <p>The following elements may be specified in the query map:</p>
   ...
   ApiResponse<NodeQueryNodeSidesResponse> nodeQueryNodeSidesWithHttpInfo(NodeQueryNodeSidesRequest body, @QueryMap(encoded=true) NodeQueryNodeSidesQueryParams queryParams);


   /**
   * A convenience class for generating query parameters for the
   * <code>nodeQueryNodeSides</code> method in a fluent style.
   */
  public static class NodeQueryNodeSidesQueryParams extends HashMap<String, Object> {
    public NodeQueryNodeSidesQueryParams sessionId(final String value) {
      put("sessionId", EncodingUtils.encode(value));
      return this;
    }
  }
  ...
  /**
   * Query physical objects
   * Supplies all physical objects linked to a specific node.
   * @param sessionId Session-ID (required)
   * @param body  (required)
   * @return NodeQueryPhysicalCisResponse
   */
  @RequestLine("POST /api/rest/entity/node/queryPhysicalCis?sessionId={sessionId}")
  @Headers({
    "Content-Type: application/json",
    "Accept: application/json",
  })
  NodeQueryPhysicalCisResponse nodeQueryPhysicalCis(@Param("sessionId") String sessionId, NodeQueryPhysicalCisRequest body);

  /**
   * Query physical objects
   * Similar to <code>nodeQueryPhysicalCis</code> but it also returns the http response headers .
   * Supplies all physical objects linked to a specific node.
   * @param sessionId Session-ID (required)
   * @param body  (required)
   * @return A ApiResponse that wraps the response boyd and the http headers.
  ...
  ApiResponse<NodeQueryPhysicalCisResponse> nodeQueryPhysicalCisWithHttpInfo(@Param("sessionId") String sessionId, NodeQueryPhysicalCisRequest body);


  /**
   * Query physical objects
   * Supplies all physical objects linked to a specific node.
   * Note, this is equivalent to the other <code>nodeQueryPhysicalCis</code> method,
   * but with the query parameters collected into a single Map parameter. This
   * is convenient for services with optional query parameters, especially when
   * used with the {@link NodeQueryPhysicalCisQueryParams} class that allows for
   * building up this map in a fluent style.
   * @param body  (required)
   * @param queryParams Map of query parameters as name-value pairs
   *   <p>The following elements may be specified in the query map:</p>
  ...
  NodeQueryPhysicalCisResponse nodeQueryPhysicalCis(NodeQueryPhysicalCisRequest body, @QueryMap(encoded=true) NodeQueryPhysicalCisQueryParams queryParams);

  /**
  * Query physical objects
  * Supplies all physical objects linked to a specific node.
  * Note, this is equivalent to the other <code>nodeQueryPhysicalCis</code> that receives the query parameters as a map,
  * but this one also exposes the Http response headers
              * @param body  (required)
      * @param queryParams Map of query parameters as name-value pairs
      *   <p>The following elements may be specified in the query map:</p>
   ...
   ApiResponse<NodeQueryPhysicalCisResponse> nodeQueryPhysicalCisWithHttpInfo(NodeQueryPhysicalCisRequest body, @QueryMap(encoded=true) NodeQueryPhysicalCisQueryParams queryParams);


   /**
   * A convenience class for generating query parameters for the
   * <code>nodeQueryPhysicalCis</code> method in a fluent style.
   */
  public static class NodeQueryPhysicalCisQueryParams extends HashMap<String, Object> {
    public NodeQueryPhysicalCisQueryParams sessionId(final String value) {
      put("sessionId", EncodingUtils.encode(value));
      return this;
    }
  }
